...
-- onde irá considerar as empresas da cooperativa 13 - Civia e 
        ...
        INSERT INTO  tbcadast_emp_consig_param
          ...
          VALUES(--vr_idemprconsig                    --IDEMPRCONSIGPARAM 
                ...
                ,trunc(to_date(rg_crapemp.dtfchfol - 7||'/'||
                 vr_mes_novo_de||'/2999','dd/mm/yyyy'))  --DTINCLPROPOSTADE  
                ,trunc(to_date(rg_crapemp.dtfchfol -8||'/'||
                 vr_mes_novo_ate||'/2999','dd/mm/yyyy')) --DTINCLPROPOSTAATE 
                ,trunc(to_date(rg_crapemp.dtfchfol -7||'/'||
                 vr_mes_novo_arq||'/2999','dd/mm/yyyy')) --DTENVIOARQUIVO    
                ,trunc(to_date(rg_crapemp.dtfchfol||'/'||
                 vr_mes_novo_venc||'/2999','dd/mm/yyyy')) --DTVENCIMENTO)      
                 )
