...
alter table CECRED.TBCADAST_EMP_CONSIG_PARAM
  add constraint TBCADAST_EMP_CONSIG_PARAM_FK01 foreign key (IDEMPRCONSIG)
  references CECRED.TBCADAST_EMPRESA_CONSIG (IDEMPRCONSIG);
