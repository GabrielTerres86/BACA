declare 
  ...
  vr_refaca varchar(100) := 'CONDEB_VALIDA_PA'; -- nome de referencia da acao, que será chamada no front
  vr_nomprc varchar(100) := 'pc_valida_pa'; -- nome da procedure dentro da package
  vr_params varchar(300) := 'pr_cdcooper,pr_cdagenci'; -- parametros da package
