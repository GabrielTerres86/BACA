declare 
  ...
  vr_refaca varchar(100) := 'CONDEB_LISTA_PROGRAMAS'; -- nome de referencia da acao, que será chamada no front
  vr_nomprc varchar(100) := 'pc_busca_progra_debitador'; -- nome da procedure dentro da package
  vr_params varchar(300) := ''; -- parametros da package
