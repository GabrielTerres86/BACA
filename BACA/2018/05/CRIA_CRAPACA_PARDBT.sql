...
begin
  ...
  OPEN cr_crapaca(pr_nmdeacao => 'DEBITADOR_VALIDAR_EX_PROC'
                 ,pr_nmpackag => 'TELA_DEBITADOR_UNICO'
                 ,pr_nmproced => 'pc_valida_debitador_proc_exec'
                 ,pr_nrseqrdr => rw_craprdr.nrseqrdr);
  ...
  IF cr_crapaca%NOTFOUND THEN
    ...
    INSERT INTO crapaca(nmdeacao, 
                        ...
                        lstparam, 
                        nrseqrdr) 
                 VALUES('DEBITADOR_VALIDAR_EX_PROC',
                        'TELA_DEBITADOR_UNICO',
                        'pc_valida_debitador_proc_exec',
                        'pr_cdcooper, pr_cdprocesso',
                        rw_craprdr.nrseqrdr);
                             
    dbms_output.put_line('Insere CRAPACA -> DEBITADOR_VALIDAR_EX_PROC -> TELA_DEBITADOR_UNICO.pc_valida_debitador_proc_exec');
