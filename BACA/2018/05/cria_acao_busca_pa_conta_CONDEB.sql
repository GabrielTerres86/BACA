declare 
  vr_nompkg varchar(100) := 'TELA_DEB_PEN_EFETIVADOS'; -- nome da package
  vr_refaca varchar(100) := 'CONDEB_BUSCA_PA_CONTA'; -- nome de referencia da acao, que será chamada no front
  vr_nomprc varchar(100) := 'pc_busca_pa_conta'; -- nome da procedure dentro da package
  vr_params varchar(300) := 'pr_cdcooper,pr_nrdconta'; -- parametros da package
