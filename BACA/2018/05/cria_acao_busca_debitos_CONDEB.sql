declare 
  ...
  vr_refaca varchar(100) := 'CONDEB_BUSCA_DEBITOS'; -- nome de referencia da acao, que será chamada no front
  vr_nomprc varchar(100) := 'pc_busca_debitos'; -- nome da procedure dentro da package
  vr_params varchar(300) := 'pr_tipoexec,pr_cdcooper,pr_cdagenci,pr_ds_cdprocesso,pr_nrdconta,pr_dtmvtolt,pr_pagina'; -- parametros da package
