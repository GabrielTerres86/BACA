...
begin
  ...
  Insert into crapaca (NMDEACAO,NMPACKAG,NMPROCED,LSTPARAM,NRSEQRDR) Values ('IMPRIME_TERMO_ADESAO_APL_PROG','APLI0008','pc_impres_termo_adesao_ap_web','pr_nrdconta,pr_nrctrrpp,pr_dtmvtolt,pr_flgerlog',v_NRSEQRDR);
  commit;
end;
