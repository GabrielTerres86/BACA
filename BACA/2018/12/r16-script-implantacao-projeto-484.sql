...
begin
  ...
  for rw_crapcop in cr_crapcop loop
    ...
    begin
      ...
      insert into crapprm (nmsistem,cdcooper,cdacesso,dstexprm,dsvlrprm) values ('CRED',rw_crapcop.cdcooper,'TELA_CADGRP_OPCAO_P','Registro para controle das variaveis de fracao ideal e maxima utilizadas na Opcao P da tela CADGPR.',2550||';'||2500||';'||50);
    exception
      when others then
