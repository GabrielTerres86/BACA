...
/* Parameters Definitions ---      
                                     */
DEFINE INPUT    PARAM   par_dsageban    AS CHAR                 NO-UNDO.
...
RECT-130 ed_dsageban ed_dsagenda ed_vllanaut ed_dtmvtopg Btn_D Btn_H ~
ed_cdagectl ed_nmrescop ed_nrdconta ed_nmextttl 
&Scoped-Define DISPLAYED-OBJECTS ed_dsageban ed_dsagenda ed_vllanaut ~
...
DEFINE VARIABLE ed_dsageban AS CHARACTER FORMAT "X(256)":U INITIAL "0" 
     VIEW-AS FILL-IN 
     SIZE 109.6 BY 1.43
     FONT 14 NO-UNDO.
...
DEFINE VARIABLE ed_vllanaut AS DECIMAL FORMAT "zz,zz9.99":U INITIAL 0 
     VIEW-AS FILL-IN 
     SIZE 23 BY 1.43
     FONT 14 NO-UNDO.
...
DEFINE FRAME f_agen_exclusao_transf
     ed_dsageban AT ROW 9.43 COL 30.4 COLON-ALIGNED NO-LABEL WIDGET-ID 256
     ed_dsagenda AT ROW 11.86 COL 30.4 COLON-ALIGNED NO-LABEL WIDGET-ID 104
     ed_vllanaut AT ROW 14.29 COL 30.4 COLON-ALIGNED NO-LABEL WIDGET-ID 106
     ed_dtmvtopg AT ROW 16.76 COL 30.4 COLON-ALIGNED NO-LABEL WIDGET-ID 250
     ...
     "Cooperativa:" VIEW-AS TEXT
          SIZE 22 BY 1.19 AT ROW 10 COL 7.2 WIDGET-ID 260
          FONT 14
     "Data:" VIEW-AS TEXT
          SIZE 9 BY 1.38 AT ROW 16.81 COL 19.2 WIDGET-ID 254
          FONT 14
     "Conta:" VIEW-AS TEXT
          SIZE 13 BY 1.1 AT ROW 12 COL 17.4 WIDGET-ID 108
          FONT 14
...
OCXFile = SEARCH( "cartao_agendamento_exclusao_transferencia.wrx":U ).
IF OCXFile = ? THEN
...
END.
ELSE MESSAGE "cartao_agendamento_exclusao_transferencia.wrx":U SKIP(1)
...
------------------------------------------------------------------------------*/
  RUN control_load.
  DISPLAY ed_dsageban ed_dsagenda ed_vllanaut ed_dtmvtopg ed_cdagectl 
          ed_nmrescop ed_nrdconta ed_nmextttl 
      WITH FRAME f_agen_exclusao_transf.
  ENABLE RECT-127 RECT-128 IMAGE-37 IMAGE-40 RECT-129 RECT-130 ed_dsageban 
         ed_dsagenda ed_vllanaut ed_dtmvtopg Btn_D Btn_H ed_cdagectl 
         ed_nmrescop ed_nrdconta ed_nmextttl 
      WITH FRAME f_agen_exclusao_transf.
...
tmp_tximpres = tmp_tximpres +               
               "                                                " +
               "PARA                                            " +
               "COOPERATIVA: " + STRING(par_dsageban,"x(35)")     + 
               "CONTA:       " + STRING(ed_dsagenda,"x(35)")      +
               "                                                " +
               "      DATA: " + STRING(ed_dtmvtopg, "99/99/9999") +
                                     "                          " +
               "                                                " +
               "     VALOR: " + STRING(ed_vllanaut,"zz,zz9.99")   +
                                    "                           " +
               "                                                " +
