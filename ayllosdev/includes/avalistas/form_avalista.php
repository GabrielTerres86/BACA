...
<fieldset class="fsAvalista">
	<legend><? echo utf8ToHtml('Avalista/Fiadores 1') ?></legend>

	<label for="nrctaav1"><? echo utf8ToHtml('Conta/dv:') ?></label>
...
<fieldset class="fsAvalista">
	<legend><? echo utf8ToHtml('Avalista/Fiadores 2') ?></legend>		

	<label for="nrctaav2"><? echo utf8ToHtml('Conta/dv:') ?></label>
	...
	<select name="tpdocav2" class="campo" id="tpdocav2">	
		<option value=""   <? if (getByTagName($registros[1]->tags,'tpdocava') == ""  ){ echo " selected"; } ?>> </option>
		<option value="CH" <? if (getByTagName($registros[1]->tags,'tpdocava') == "CH"){ echo " selected"; } ?>>CH</option>
		<option value="CI" <? if (getByTagName($registros[1]->tags,'tpdocava') == "CI"){ echo " selected"; } ?>>CI</option>
		<option value="CP" <? if (getByTagName($registros[1]->tags,'tpdocava') == "CP"){ echo " selected"; } ?>>CP</option>
		<option value="CT" <? if (getByTagName($registros[1]->tags,'tpdocava') == "CT"){ echo " selected"; } ?>>CT</option>
		<option value="TE" <? if (getByTagName($registros[1]->tags,'tpdocava') == "TE"){ echo " selected"; } ?>>TE</option>
	</select>
	...
	<select name="tdccjav2" class="campo" id="tdccjav2">
		...
		<option value="CP" <? if (getByTagName($registros[1]->tags,'tpdoccjg') == "CP"){ echo " selected"; } ?>>CP</option>
		<option value="CT" <? if (getByTagName($registros[1]->tags,'tpdoccjg') == "CT"){ echo " selected"; } ?>>CT</option>
		<option value="TE" <? if (getByTagName($registros[1]->tags,'tpdoccjg') == "TE"){ echo " selected"; } ?>>TE</option>
	</select>
