<?php 
	...
	if (isset($ServerMonitoracao) && trim($ServerMonitoracao) <> '') {
		$url_webspeed_ayllosweb = 'https://'.$ServerMonitoracao.'.cecred.coop.br/cgi-bin/cgiip.exe/WService=ws_ayllos/';
	} else {
	...
	define("SERVERNAMEAPP",$_ENV['HOSTNAME']);       
