...
<div class="condensado" style="padding-top: 15px;">
	<fieldset>
		...
		<div id="divNmimagem_banner" id="divNmimagem_banner" style="float:left; width:310px; height: 192px; border: 1px solid gray; margin-right: 10px;">
		...
		<div id="divBannerObs" name="divBannerObs" style="padding-left: 30px;">
			...
			- N&atilde;o &eacute; possível fazer upload de arquivo de imagem com nome j&aacute; existente no servidor.
			</br></br>
