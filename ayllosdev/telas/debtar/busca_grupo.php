...
<?	
	...
	$retornoAposErro = 'focaCampoErro(\'cddgrupo\', \'frmDebtar\');';
	...
	echo "$('#dsdgrupo','#frmDebtar').val('$dsdgrupo');";
	echo "$('#cddgrupo','#frmDebtar').desabilitaCampo();";
	echo "$('#cdsubgru','#frmDebtar').focus();";		
