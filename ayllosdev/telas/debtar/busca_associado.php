...
<?	
	...
	echo "$('#cdagenci','#frmDebtar').val('$cdagenci');";
	echo "$('#cdagenci','#frmDebtar').desabilitaCampo();";
	echo "$('#nmresage','#frmDebtar').val('$nmresage');";
	echo "$('#nmprimtl','#frmDebtar').val('$nmprimtl');";
	echo "$('#nrdconta','#frmDebtar').desabilitaCampo();";
	echo "$('#inpessoa','#frmDebtar').desabilitaCampo();";
	echo "$('#dtinicio','#frmDebtar').focus();";
