 ...
 */
    ...
    // var_dump($cddopcao, $cdcodigo, $tdesconto);
    ...
    $xmlResult = mensageria($xml, "TELA_LROTAT", "BLOQLIBLROTAT", $glbvars["cdcooper"], $glbvars["cdagenci"], $glbvars["nrdcaixa"], $glbvars["idorigem"], $glbvars["cdoperad"], "</Root>");
    $xmlObjMotivos = getObjectXML($xmlResult);

    var_dump($xmlObjMotivos->roottag->tags[0]->name);
...
<script type="text/javascript">	
    buscaLinhaRotativo(<?php echo $cdcodigo + "," + $tdesconto; ?>);
</script>
