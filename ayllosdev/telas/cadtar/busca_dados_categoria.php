 ...
 * OBJETIVO     : Rotina para buscar categoria na tela CADTAR
 * --------------
 * ALTERAÇÕES   : 20/08/2013 - Incluso echo do tipo da categoria (Daniel).
 
				  27/04/2016 - Migração da procedure b1wgen0153.busca-cadcat para Oracle:
...
<?	
	...
	echo "$('#cdtarifa','#frmCab').focus();";

	if ( $cddopcao == 'I' ) {
		echo "$('#dstarifa','#frmCab').focus();";
	}
