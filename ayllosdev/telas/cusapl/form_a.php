...
//***                                                                  						          ***//
//*** Objetivo  : Monta a tela A - Log dos Arquivos de Custódia		                          ***//
//***                                                                  						          ***//
//*** Alterações: 																			                                    ***//
//*********************************************************************************************//
?>
	...
	<div id="divConsulta" >
      ...
      <table border="1">
				<tr>
					...
					<td>
						<input tabindex="2" type="text" id="nrdconta" name="nrdconta" class="conta pesquisa campo filtroconta" value="<? echo formataContaDV($_SESSION["glbvars"][$glbvars["sidlogin"]]['CRM_NRDCONTA']); ?>" autocomplete="off" class='campo' onchange="buscaConta();consultaAplicacoes();" readonly="readonly" />
			 <!-- <input type="text" id="nrdconta" name="nrdconta" value="<? /*echo formataContaDV($nrdconta);*/ ?>" /> -->
					...
					<td>
						<select tabindex="3" name="nraplica" class="campo" id="nraplica" style="width:120px;">
							<option value="0">Todos</option>
					</select>
				</td>
					<td>
				...
				<tr>
					...
					<td>
						<a href="#" class="botao" id="btnConsulta" name="btnConsulta" onClick="btnconsulta(); return false;">Consulta</a>
					</td>
				</tr>
			</table>
		</fieldset>
