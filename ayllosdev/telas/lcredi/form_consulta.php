...
<form id="frmConsulta" name="frmConsulta" class="formulario" style="display:none;">
	...
	<fieldset id="fsetConsulta" name="fsetConsulta" style="padding:0px; margin:0px; padding-bottom:10px;">
		...
		<select  id="tpctrato" name="tpctrato" value="<?echo getByTagName($linha->tags,'tpctrato'); ?>">
			...
			<option value="2">Aliena&ccedil;&atilde;o fiduciaria</option>
		...
		<select  id="dsorgrec" name="dsorgrec" value="<?echo getByTagName($linha->tags,'dsorgrec'); ?>">
			<option value="0">Recurso pr&oacute;prio</option>
			<option value="1">Microcr&eacute;dito ABN</option>
			<option value="2">Microcr&eacute;dito PNMPO ABN</option>
			<option value="3">Microcr&eacute;dito PNMPO BB</option>
			<option value="4">Microcr&eacute;dito PNMPO BNDES</option>
			<option value="5">Microcr&eacute;dito PNMPO BNDES CECRED</option>
			<option value="6">Microcr&eacute;dito PNMPO BRDE</option>
			<option value="7">Microcr&eacute;dito PNMPO CAIXA</option>
			<option value="8">Microcr&eacute;dito PNMPO DIM</option>
			<option value="9">Microcr&eacute;dito DIM</option>
		</select>
