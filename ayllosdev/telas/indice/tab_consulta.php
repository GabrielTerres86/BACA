...
?>
		...
		<div id="tabIndice">
			<div class="divRegistros">
				<table class="tituloRegistros">
					<thead>
						<tr>
							<th><?php echo utf8ToHtml('Data Per&iacute;odo'); ?></th>
							<th><?php echo utf8ToHtml('Taxa do Dia'); ?></th>
							<th><?php echo utf8ToHtml('Taxa M&ecirc;s'); ?></th>
							<th><?php echo utf8ToHtml('Taxa Ano'); ?></th>
							<th><?php echo utf8ToHtml('Taxa Acumulada'); ?></th>
						</tr>
					</thead>
					<tbody>
	...
	<div id="divPesquisaRodape" class="divPesquisaRodape">
        ...
        <div id="divBotoes">
            <a href="#" class="botao" id="btVoltar" name="btVoltar" onclick="fechaConsulta(); return false;" ><?php echo utf8ToHtml('Voltar'); ?></a>
		</div>
