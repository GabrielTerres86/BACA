<?
/*!
 * FONTE        : detalhamento_faixa.php
 * CRIAÇÃO      : Dionathan Henchel
 * DATA CRIAÇÃO : 04/12/2015
 * OBJETIVO     : Tela do formulario de detalhamento de faixas
 */	 
?>
					...
					<td>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td class="txtBrancoBold ponteiroDrag" background="<?php echo $UrlImagens; ?>background/tit_tela_fundo.gif"><? echo utf8ToHtml('Detalhamento das Faixas de IRRF') ?></td>
