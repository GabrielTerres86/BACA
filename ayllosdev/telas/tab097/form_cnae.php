...
<script type="text/javascript">
    $('#cdcnae','#frmCNAE').css('width', '80px').setMask('INTEGER', 'zzzzzzzzzz', '', '');
    $('#dscnae','#frmCNAE').css('width', '345px').desabilitaCampo();

	function carregaNomeCNAE() {
		procedure	= 'BUSCA_CNAE';
		titulo      = 'CNAE';		
		filtrosDesc = 'flserasa|2';
		buscaDescricao('MATRIC',procedure,titulo,$('#cdcnae','#frmCNAE').attr('name'),'dscnae',$('#cdcnae','#frmCNAE').val(),'dscnae',filtrosDesc,'frmCNAE');
							...
							<tr>
								<td align="center" style="border: 2px solid #969FA9; background-color: #F4F3F0; padding: 2px 2px 8px;">
									<div id="divConteudoOpcao">
                                        <form name="frmCNAE" id="frmCNAE" class="formulario" onsubmit="javascript:confirmaInclusao('CNAE'); return false;">
                                            <table>
                                            <tr>
                                                <td>
                                                    <label for="cdcnae"><? echo utf8ToHtml('C&oacute;digo:') ?></label>
                                                    <input type="text" class="campo" name="cdcnae" id="cdcnae" onblur="carregaNomeCNAE();" />	
                                        ...
                                        <div id="divBotoes">
                                            ...
                                            <a href="#" class="botao" id="btCNAEIncluir" onClick="confirmaInclusao('CNAE');">Incluir</a>
                                        </div>
									</div>
								</td>
							</tr>
