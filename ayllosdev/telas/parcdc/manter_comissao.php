...
<?	
	...
	switch($cddopcao) {
		case 'I': 
            ...
            $xml .= "  <nmcomissao>".$dscomissao."</nmcomissao>";
            ...
            if (strtoupper($xmlObjeto->roottag->tags[0]->name) == "ERRO") {			
                ...
                echo 'showError("inform","Comiss&atilde;o inclu&iacute;da com sucesso.","Notifica&ccedil;&atilde;o - Ayllos","blockBackground(parseInt($(\'#divRotina\').css(\'z-index\')));controlaCamposInclusao();");';				
                echo "carregaDetalhamento();";	
                echo "$('#cdcomissao','#frmComissao').val(".$idRetorno.");";
                exit();
            }
