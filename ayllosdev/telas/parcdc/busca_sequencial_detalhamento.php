...
<?	
    ...
    $cdcomissao = (isset($_POST['cdcomissao'])) ? $_POST['cdcomissao'] : '' ; 
    $dscomissao = (isset($_POST['dscomissao'])) ? $_POST['dscomissao'] : '' ; 
    ...
    if (strtoupper($xmlObjeto->roottag->tags[0]->name) == "ERRO") {
        ...
        echo "$('#cdcomissao','#frmDetalheComissao').val(glbTabCdcomissao);";
	    echo "$('#dscomissao','#frmDetalheComissao').val(glbTabDscomissao);";
