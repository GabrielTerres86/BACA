			...
			<table cellpadding="0" cellspacing="0" border="0" width="750">
				...
				<tr> 
					<td class="tdConteudoTela" align="center">
								...
								<td>
									<table border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td align="center" style="background-color: #C6C8CA;" id="imgAbaCen0"><a href="#" id="linkAba0" class="txtNormalBold" onClick="acessaOpcaoAba(0);return false;">Integra&ccedil;&atilde;o Ibracred</a></td>
											...
											<td align="center" style="background-color: #C6C8CA;" id="imgAbaCen2"><a href="#" id="linkAba2" class="txtNormalBold" onClick="acessaOpcaoAba(2);return false;">Comiss&atilde;o</a></td>
								...
								<td align="center" style="border: 2px solid #969FA9; background-color: #F4F3F0; padding: 2px;">
									...
									<div id="divAba1" class="clsAbas">
										<form id="frmLista" name="frmLista" class="formulario">	
											...
											<div id="divBotoesSubsegmentos" name="divBotoesSubsegmentos" style="margin-left: 315px;">
									...
									<div id="divAba2" class="clsAbas" align="center">
										<br/>			
										<div id="divTelaComissao">																	
											<form id="frmComissao" name="frmComissao" class="formulario" onSubmit="return false;" >
												<fieldset>
												...
												<table width="100%" class="tituloRegistros" style="table-layout: fixed;">
													<tr>		
														<td> 
															<br/>	
															<label class="txtNormalBold" style="width: 95px;" for="cddopcao">Op&ccedil;&atilde;o:</label>
															<select id="cddopcao" tabindex="-1" class="campo" id="cddopcao" style="width: 540px;">
																<option value="C"> C - Consultar Regra </option> 
																<option value="A"> A - Alterar Regra </option>
																<option value="E"> E - Excluir Regra </option>
																<option value="I"> I - Incluir Regra </option>															
															</select>
															<a href="#" class="botao" id="btnOK" name="btnOK" onClick="LiberaCampos(); return false;" style = "text-align:right;">OK</a>
														</td>
													</tr>
													<div id="camposComissao" name="camposComissao">
													<tr>
														<td>
															<label class="txtNormalBold" style="width: 95px;" for="idcomissao"><? echo utf8ToHtml('Código:') ?></label>
															<input type="text" id="idcomissao" name="idcomissao" value="<? echo $idcomissao == 0 ? '' : $idcomissao ?>" 
																tabindex="-1" disabled="" class="campoTelaSemBorda" style="width: 90px;" maxlength="9" readonly="" aux="1" />	
															<a style="padding: 3px 0 0 3px;" href="#" onClick="controlaPesquisa();return false;"><img src="<? echo $UrlImagens; ?>geral/ico_lupa.gif"/></a>																			
															<input type="text" name="nmcomissao" id="nmcomissao" value="<? echo $nmcomissao; ?>" tabindex="-1" 
																disabled="" class="campoTelaSemBorda" style="width: 460px;" readonly=""/>														
														</td>
													</tr>
													<tr>
														<td>
															<label class="txtNormalBold" style="width: 95px;" for="tpvalor">Tipo:</label>
															<select name="tpvalor" id="tpvalor" tabindex="-1" disabled="" class="campoTelaSemBorda" style="width: 360px;">
													...
													<tr>
														<td>
															<label class="txtNormalBold" style="width: 95px;" for="dtcriacao"><? echo utf8ToHtml('Data Criação:') ?></label>
															<input type="text" id="dtcriacao" style="width: 90px;" name="dtcriacao" maxlength="9" readonly="" tabindex="-1" 
																disabled="" class="campoTelaSemBorda" value="<? echo $dtcriacao == '' ? '' : $dtcriacao ?>" aux="1" />	
															
															<label class="txtNormalBold" style="width: 105px;" for="dtalteracao"><? echo utf8ToHtml('Data Alteração:') ?></label>
															<input type="text" id="dtalteracao" style="width: 90px;" name="dtalteracao" maxlength="9" readonly="" tabindex="-1" 
																disabled="" class="campoTelaSemBorda" value="<? echo $dtalteracao == '' ? '' : $dtalteracao ?>" aux="1" />	

															<label for="flgativo" style="margin-left:23px;margin-right:3px;">Ativo</label>
															<input type="checkbox" id="flgativo" name="flgativo" style="margin-left:2px;margin-right:3px;" value="<? echo $flgativo == 0 ? false : true ?>" disabled=""/>															
														</td>
													</tr>																						
													</div>
												</table>
											...
											<div id="divBotoesComissao" style="margin-top:5px; margin-bottom :10px;display:none">
						...
						<div id="botoesAba2" name="botoesAba2" style="display: none;">
							<a href="#" class="botao" id="btVoltar" onClick="fechaRotina($('#divRotina')); btnVoltar(); return false;">Voltar</a>
						</div>
					</td>        
				</tr>   
