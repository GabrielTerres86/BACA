										...
										<div id="divTelaComissao">																	
											<form id="frmComissao" name="frmComissao" class="formulario" onSubmit="return false;" >
												...
												<table width="100%" class="tituloRegistros" style="table-layout: fixed;">
													...
													<tr>
														<td>
															<label class="txtNormalBold" style="width: 95px;" for="cdcomissao"><? echo utf8ToHtml('Código:') ?></label>
															<input type="text" id="cdcomissao" name="cdcomissao" value="<? echo $cdcomissao == 0 ? '' : $cdcomissao ?>" 
															...
															<input type="text" name="dscomissao" id="dscomissao" value="<? echo $dscomissao; ?>" tabindex="-1" 
