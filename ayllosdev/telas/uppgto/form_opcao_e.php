 ...
 * CRIAÇÃO      : Anderson Schloegel - Mouts - P500
 * DATA CRIAÇÃO : Maio/2019
 * OBJETIVO     : Formulario de upload de arquivo para tela UPPGTO - E - Efetivação do arquivo de Transferência/TED
 * --------------
 * ALTERAÇÕES   : 
 * --------------
 */
...
<center>
<div id="divArquivosTed" name="divArquivosTed" style="width: 620px;">
	<form id="frmArquivoTed" name="frmArquivoTed" class="formulario" enctype="multipart/form-data"  target="blank" method="POST">
		<fieldset style="height: 85px;">
			<legend>E - Efetiva&ccedil;&atilde;o do arquivo de Transfer&ecirc;ncia/TED</legend>
			<table width="100%" >
				<tr>
					<td>
		...
		<fieldset id="fCriticasTed">
			<div id="divtbcriticasted" class="divRegistros" center>
				<!-- conteúdo das críticas -->
			</div>
		</fieldset>
		<fieldset id="fRemessasTed">
			<div id="divtbremessasted" class="divRegistros" center>
				<!-- conteúdo dos histórico de arquivos -->
			</div>
		</fieldset>
		<br />
	</form>
