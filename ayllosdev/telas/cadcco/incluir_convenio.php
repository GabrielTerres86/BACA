<?php 
	/*******************************************************************************
	 ...
	 Autor: Jonathan - RKAM                                                    
	  Data : Fevereiro/2016                   Última Alteração: 12/09/2017
	...
	********************************************************************************/
	...
	if (strtoupper($xmlObjInclui->roottag->tags[0]->name) == "ERRO") {
		...
		exibirErro('error',utf8_encode($msgErro),'Alerta - Ayllos','$(\'input,select\',\'#frmCadcco\').habilitaCampo();focaCampoErro(\''.$nmdcampo.'\',\'frmCadcco\');',false);		
