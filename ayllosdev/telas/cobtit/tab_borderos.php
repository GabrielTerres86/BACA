 ...
 * ALTERAÇÃO    : 03/10/2018 - Adicionado coluna Cob para indicar prejuízo - Cássia de Oliveira(GFT)
 *                16/10/2018 - Adicionado quantiade de titulos em acordo - Cássia de Oliveira (GFT)
 * --------------
 */
?>
