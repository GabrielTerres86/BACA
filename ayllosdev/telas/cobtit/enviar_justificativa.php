<?php
/* !
 * FONTE        : enviar_justificativa.php
 * CRIAÇÃO      : Vitor Shimada Assanuma
 * DATA CRIAÇÃO : 04/06/2018
 * OBJETIVO     : Tela do formulario de justificativa de baixa
 */
?>
                    ...
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td class="txtBrancoBold ponteiroDrag" background="<?php echo $UrlImagens; ?>background/tit_tela_fundo.gif"><?php echo utf8ToHtml('Manutenção - Baixa Boleto') ?></td>
