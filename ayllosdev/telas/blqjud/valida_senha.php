 ...
 * --------------
 * ALTERAÇÕES   : 10/12/2014 - Adicionado funcao de retorno segueBotaoOK2()
 * 							   melhoramento do fluxo do sistema. (Jorge/Rosangela) - SD 228463
 * -------------- 
 */
?> 
...
<?	
	...
	*/
	...
	if (strtoupper($xmlObjeto->roottag->tags[0]->name) == "ERRO") {	
		...
		echo "hideMsgAguardo();";
		echo "segueBotaoOK2();";
		echo "$('#nroficio','#frmAcaojud').focus()";
	}
