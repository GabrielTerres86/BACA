<?php
/*!
 * FONTE        : exclui_remessa
 * CRIAÇÃO      : Lucas Reinert
 * DATA CRIAÇÃO : 10/10/2016
 * OBJETIVO     : Rotina para excluir remessa
 * --------------
 * ALTERAÇÕES   : 
 * -------------- 
 */		
...
$xmlResult = mensageria($xml, "TELA_CUSTOD", "CUSTOD_EXCLUI_REMESSA", $glbvars["cdcooper"], $glbvars["cdagenci"], $glbvars["nrdcaixa"], $glbvars["idorigem"], $glbvars["cdoperad"], "</Root>");
