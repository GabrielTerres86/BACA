<?php
/*!
 * FONTE        : concilia_cheques.php
 * CRIAÇÃO      : Lucas Reinert
 * DATA CRIAÇÃO : 30/09/2016
 * OBJETIVO     : Rotina para conciliar cheques da remessa
 * --------------
 * ALTERAÇÕES   : 
 * -------------- 
 */		
...
$xmlResult = mensageria($xml, "TELA_CUSTOD", "CUSTOD_CONCILIA_CHEQUES", $glbvars["cdcooper"], $glbvars["cdagenci"], $glbvars["nrdcaixa"], $glbvars["idorigem"], $glbvars["cdoperad"], "</Root>");
