 ...
 * OBJETIVO     	: Alterar parametro de indicador de reciprocidade
 * ÚLTIMA ALTERAÇÃO : --/--/----
 * --------------
 * ALTERAÇÕES   	: 
 * --------------
...
$xmlResult = mensageria($xml, "TELA_PARIDR", "ALTERA_PAR_IND", $glbvars["cdcooper"], $glbvars["cdagenci"], $glbvars["nrdcaixa"], $glbvars["idorigem"], $glbvars["cdoperad"], "</Root>");
