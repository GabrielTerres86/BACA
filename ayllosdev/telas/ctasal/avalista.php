 ...
 * OBJETIVO     : Tela de busca pelo nome do avalista
 */	 
?>
					...
					<td>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td class="txtBrancoBold ponteiroDrag" background="<?php echo $UrlImagens; ?>background/tit_tela_fundo.gif"><? echo utf8ToHtml('AVALISTA') ?></td>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								<td align="center" style="border: 2px solid #969FA9; background-color: #F4F3F0; padding: 2px;">
									...
									<form id="frmAvalis" name="frmAvalis" class="formulario">
									
										<fieldset>
				
											<label for="nmprimtl"><? echo utf8ToHtml('Nome a pesquisar:') ?></label>
											<input id="nmprimtl" name="nmprimtl" type="text"/>
											<a href="#" class="botao" onclick="buscaAvalista();" id="btnOK" >OK</a>
