<?
/*!
 * FONTE        : busca_lancamento.php						Último ajuste: 08/12/2015
 * CRIAÇÃO      : Jéssica - DB1
...
<?
	...
	$flgvalid = (isset($_POST["flgvalid"])) ? $_POST["flgvalid"] : '';
	...
	if (strtoupper($xmlObjeto->roottag->tags[0]->name) == 'ERRO') {
		...
		exibirErro('error',$msgErro,'Alerta - Ayllos','$(\'input\',\'#frmConsulta\').removeClass(\'campoErro\'); $(\'input\',\'#frmConsulta\').habilitaCampo(); focaCampoErro(\'dtsolici\',\'frmConsulta\');',false);				
