<div id="divFiltroGrid">
	<form id="frmFiltroGrid" name="frmFiltroGrid" class="formulario" style="display:block;">
		...
		<table width="100%">
			<tr>
				<td>
					<label for="cddgrupo" class="txtNormalBold" style="width:165px">Grupo:</label>
			...
			<tr>
				<td>
					<label for="cdtarifa" class="txtNormalBold" style="width:165px">Tarifa:</label>
			...
			<tr id="linha-convenio" style="display:none">
				<td>
					<label for="nrconven" class="txtNormalBold" style="width:165px">Conv&ecirc;nio:</label>
			...
			<tr id="linha-credito" style="display:none">
				<td>
					<label for="cdlcremp" class="txtNormalBold" style="width:165px">Linha de Cr&eacute;dito:</label>
