...
<tr>	
	<td><label for="avencer1"><? echo utf8ToHtml('A VENCER:') ?></label></td>
	<td><label for="valor111"><? echo utf8ToHtml('VALOR') ?></label></td>
	<td><label for="vencidos"><? echo utf8ToHtml('LIMITE CREDITO:') ?></label></td>
	<td><label for="valor222"><? echo utf8ToHtml('VALOR') ?></label></td>
</tr>	
