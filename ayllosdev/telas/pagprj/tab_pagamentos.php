				...
				?>
					<tr >
					  ...
					  <input type="hidden" id="idtipo" name="idtipo" value = "<? echo getByTagName($oEstorno->tags,'idtipo') ?>"/>
						<a href="#" class="botao" id="btEstornar" onClick="carregaTelaEstornar(<? echo getByTagName($oEstorno->tags,'nrdconta') ?>, <? echo getByTagName($oEstorno->tags,'nrctremp') ?>,'<? echo getByTagName($oEstorno->tags,'dtpagto') ?>','<? echo getByTagName($oEstorno->tags,'idtipo') ?>');">Estornar</a></td>
