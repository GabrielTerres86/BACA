<? 
/*!
 * FONTE        : forcar_pagto_cc.php
 * CRIAÇÃO      : Jean Calao (Mout´S)
 * DATA CRIAÇÃO : 05/08/2017
 * OBJETIVO     : Rotina para forçar pagamento de prejuízo de conta corrente
 * --------------
 * ALTERAÇÕES   : 
 * -------------- 
 */
	...
	$xmlResult = mensageria($xml, "PAGPRJ", "EFETUA_PAGTO_CC", $glbvars["cdcooper"], $glbvars["cdagenci"], $glbvars["nrdcaixa"], $glbvars["idorigem"], $glbvars["cdoperad"], "</Root>");
