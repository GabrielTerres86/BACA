...
<?	
	...
	if ( $operacao == 'BA' ) {
		...
		if ( $cddopcao == 'C' and $consulta == 8 ) {
			...
			echo 'showConfirmacao("Deseja visualizar a impress&atilde;o?","Confirma&ccedil;&atilde;o - Ayllos","Gera_Impressao();controlaPesquisas();","hideMsgAguardo();controlaPesquisas();","sim.gif","nao.gif");';
			exit();
		}
