...
function controlaLayoutC() {
    ...
    if (consulta > 0) {
        ...
        if (consulta == '1') {
            ...
            formataTipo2();
            cIninrdoc.habilitaCampo().focus();

        } else if (consulta == '3') {
            formataTipo3();
            cInidtmvt.habilitaCampo().focus();
            cFimdtmvt.habilitaCampo();

        } else if (consulta == '4') {
            formataTipo4();
            cInidtdpa.habilitaCampo().focus();
            cFimdtdpa.habilitaCampo();

        } else if (consulta == '5') {
            formataTipo5();
            cInidtven.habilitaCampo().focus();
            cFimdtven.habilitaCampo();

        } else if (consulta == '6') {
            formataTipo6();
            cNmprimtl.habilitaCampo().focus();
...
function btnVoltar() {
    ...
    if (cddopcao === 'C' && $('#frmTabela').length) {
        ...
        $('input, select', '#' + frmOpcao + ' fieldset:eq(' + ni + ')').limpaFormulario();
        $('fieldset:eq(' + ni + ')', '#' + frmOpcao).css({ 'display': 'none' });
        tipoOptionC();
