<?php
	 ...
	 * OBJETIVO     : Rotina de validacao para desativar pacotes de tarifas da tela PACTAR
	 * --------------
	 * ALTERAÇÕES   : 
	 * -------------- 
	 */		
	...
	$xmlResult = mensageria($xml, "PACTAR", "DESATIVA_PACOTE", $glbvars["cdcooper"], $glbvars["cdagenci"], $glbvars["nrdcaixa"], $glbvars["idorigem"], $glbvars["cdoperad"], "</Root>");
	...
	if(strtoupper($xmlObj->roottag->tags[0]->name == 'ERRO')){	
		...
		echo 'showConfirmacao("Confirma a desativa&ccedil;&atilde;o do pacote de tarifas?", "Confirma&ccedil;&atilde;o - Ayllos", "efetivaDesativar()", "", "sim.gif", "nao.gif");';	
	}	
?>