<?php
	...
	$xmlResult = mensageria($xml, "PACTAR", "CONSULTA_CODIGO", $glbvars["cdcooper"], $glbvars["cdagenci"], $glbvars["nrdcaixa"], $glbvars["idorigem"], $glbvars["cdoperad"], "</Root>");
	...
	if(strtoupper($xmlObj->roottag->tags[0]->name == 'ERRO')){	
		...
		echo 'cCdpacoteInc.val('.$xmlObj->roottag->tags[0]->tags[0]->cdata.');';
		echo 'cCdpacoteInc.attr("readonly", true);';
		echo 'cDspacoteInc.focus();';
	}	
?>