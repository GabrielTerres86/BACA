...
function calculoDigito(operacao, nomcampo) {
	...
	var flgmanua = $('#flgmanua','#frmAutori').val();
	if (flgmanua == 'S') {
		var fatura01 = normalizaNumero($('#fatura01','#frmAutori').val());
		var fatura02 = normalizaNumero($('#fatura02','#frmAutori').val());
		var fatura03 = normalizaNumero($('#fatura03','#frmAutori').val());
		var fatura04 = normalizaNumero($('#fatura04','#frmAutori').val());
	} else {
