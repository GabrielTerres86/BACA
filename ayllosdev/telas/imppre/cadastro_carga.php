<?php
/* !
 * FONTE        : cadastro_carga.php
 * CRIAÇÃO      : Christian Grauppe - ENVOLTI
 * DATA CRIAÇÃO : Janeiro/2019
 * OBJETIVO     : Mostrar tela de cadastro e alteracao - IMPPRE
 * --------------
 * ALTERAÇÕES   :
 * --------------
 */
                    ...
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" >
                            <tr>
                                ...
                                <td class="txtBrancoBold ponteiroDrag" background="<?php echo $UrlImagens; ?>background/tit_tela_fundo.gif"> Carga SAS </td>
                        ...
                        <table width="480" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td align="center" style="border: 2px solid #969FA9; background-color: #F4F3F0; padding: 2px;">
                                    <div id="divConteudoOpcao"><? include('form_cargas_sas_just.php'); ?></div>
                                </td>
                            </tr>
                        </table>
                    </td>
