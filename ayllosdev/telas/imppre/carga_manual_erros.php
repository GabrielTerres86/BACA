<?php
/* !
 * FONTE        : carga_manual_erros.php
 * CRIAÇÃO      : Christian Grauppe - ENVOLTI
 * DATA CRIAÇÃO : Janeiro/2019
 * OBJETIVO     : Mostrar lista de erros da carga - IMPPRE
 * --------------
 * ALTERAÇÕES   :
 * --------------
 */
                    ...
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" >
                            <tr>
                                ...
                                <td class="txtBrancoBold ponteiroDrag" background="<?php echo $UrlImagens; ?>background/tit_tela_fundo.gif"> Detalhes da Carga </td>
                            ...
                            <tr>
                                <td align="center" style="border: 2px solid #969FA9; background-color: #F4F3F0; padding: 2px;">
                                    <div id="divConteudoOpcao">
										<? if ($operacao="D") { include('form_detalhe_vari_carga.php'); } ?>
									</div>
