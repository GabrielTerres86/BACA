 ...
 * 011: [19/09/2016] - Alteraçoes pagamento/agendamento de DARF/DAS pelo InternetBanking (Projeto 338 - Lucas Lunelli) 
 */
                                    ...
                                    <div id="divConteudo">
                                        ...
                                        <form name="frmVerpro" id="frmVerpro" class="formulario">	
                                            ...
                                            <fieldset>
												...
												<label for="nrdocmto"><? echo utf8ToHtml('Numero do Documento:') ?></label>
                                                <input name="nrdocmto" id="nrdocmto" type="text" value="<? echo $nrdocmto ?>" />
												
												<br style="clear:both" />
												
												<label for="nrseqaut"><? echo utf8ToHtml('Seq da Autenticacao:') ?></label>
