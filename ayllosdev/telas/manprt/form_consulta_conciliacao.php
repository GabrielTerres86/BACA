			...
			<tbody>
				<? for ($x = 0; $x <= ($qtregist - 1); $x++) { ?>
					<tr>
						...
						<td><span><? echo getByTagName($registro[$x]->tags,'nmcartorio') ?></span>
							      <? echo getByTagName($registro[$x]->tags,'nmcartorio') ?>
  								  <input type="hidden" id="cartorio" value="<? echo getByTagName($registro[$x]->tags,'nmcartorio') ?>" />
								  <input type="hidden" id="valorted" value="<? echo getByTagName($registro[$x]->tags,'vllanmto') ?>" />
								  <input type="hidden" id="convenio" value="<? echo getByTagName($registro[$x]->tags,'nrcnvcob') ?>" />
								  <input type="hidden" id="cooperativa" value="<? echo getByTagName($registro[$x]->tags,'nmrescop') ?>" />
								  <input type="hidden" id="conta" value="<? echo getByTagName($registro[$x]->tags,'nrdconta') ?>" />
								  <input type="hidden" id="dataconc" value="<? echo getByTagName($registro[$x]->tags,'dtconcilicao') ?>" />
								  <input type="hidden" id="valortit" value="<? echo getByTagName($registro[$x]->tags,'vltitulo') ?>" />
								  <input type="hidden" id="datacomp" value="<? echo getByTagName($registro[$x]->tags,'dtdproc') ?>" />
								  <input type="hidden" id="banco" value="<? echo getByTagName($registro[$x]->tags,'cdbccxlt') ?>" />
						...
						<td><span><? echo getByTagName($registro[$x]->tags,'nrcnvcob') ?></span>
							      <? echo getByTagName($registro[$x]->tags,'nrcnvcob') ?>
						</td>						<td><span><? echo getByTagName($registro[$x]->tags,'nrdconta') ?></span>
							      <? echo getByTagName($registro[$x]->tags,'nrdconta') ?>
						</td>
						<td><span><? echo getByTagName($registro[$x]->tags,'dtconcilicao') ?></span>
