...
***********************************************************************/
	...
	$xmlResult = mensageria($xml, "TELA_MANPRT", "EXPORTA_CONSULTA_TED_PDF", $glbvars["cdcooper"], $glbvars["cdagenci"], $glbvars["nrdcaixa"], $glbvars["idorigem"], $glbvars["cdoperad"], "</Root>");
