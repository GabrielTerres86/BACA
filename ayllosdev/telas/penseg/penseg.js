...
// Variaveis
var cregNrproposta,cregNrapolice,cregNrendosso,cregDtinivig,cregDtfimvig,cregNmsegura,cregNmmarca,cregDsmodelo,cregDschassi
   ,cregDsplaca,cregNranofab,cregNranomod,cregCdcooper,cregNrdconta,cnewCdcooper,cnewNrdconta,cnewNmrescop,cnewNmprimtl
    ;

var rregNrproposta,rregNrapolice,rregNrendosso,rregDtinivig,rregDtfimvig,rregNmsegura,rregNmmarca,rregDsmodelo,rregDschassi
...
// Monta Grid Inicial
function buscaSegurosPendentes() {
...
function formataTabela() {
    ...
    divRegistro.css({'height':'240px','padding-bottom':'1px'});
        ...
        success: function(response) {
            ...
            try {
                if ( response.indexOf('showError("error"') == -1 && response.indexOf('XML error:') == -1 && response.indexOf('#frmErro') == -1 ) {
                    try {
                        showError("inform","Seguro atualizado com sucesso!","Alerta - Ayllos","encerraRotina(true);buscaSegurosPendentes();");
                    } catch(error) {
                        showError('error','N&atilde;o foi poss&iacute;vel concluir a requisi&ccedil;&atilde;o.','Alerta - Ayllos',"blockBackground(parseInt($('#divRotina').css('z-index')))");
                    }
                } else {
