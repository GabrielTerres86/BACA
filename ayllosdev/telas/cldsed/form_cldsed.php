 ...
 *
 *				  06/06/2016 - Limitado quantidade de caracteres nos campos e desabilitado a lupa
 *							   caso não tenha dado dois clicks, conforme solicitado no chamado 461240 (Kelvin)
 *
			...
			<div id ="divTabMovimentacao"></div>
				...
				<tr>		
					<td>
						...
						<input name="dsdjusti" type="text"  id="dsdjusti" class='campo' maxlength="60"/>	
					</td>
				</tr>
				<tr>		
					<td>
						<label for="dsobserv"><? echo utf8ToHtml('Comp.Jusi:') ?></label>	
						<input name="dsobserv" type="text"  id="dsobserv" class='campo' maxlength="60"/>	
					</td>
				</tr>
				<tr>		
					<td>
				...
				<tr>		
					<td>
						...
						<input name="dsobsctr" type="text"  id="dsobsctr" class='campo' maxlength="60"/>
					</td>
				</tr>
			</table>	
		</fieldset>		
