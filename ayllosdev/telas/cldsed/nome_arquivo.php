								...
								<td align="center" style="border: 2px solid #969FA9; background-color: #F4F3F0; padding: 2px;">
									<div id="divConteudo">
										...
										<? if (isset($_POST["cddopcao"]) && $_POST["cddopcao"] == "P") { ?>
											<a href="#" class="botao" onClick="geraArquivo('gera_imprime_arq_pesquisa');">OK</a>
										<? } else { ?>
											<a href="#" class="botao" onClick="geraArquivo('gera_imprime_arq_atividade','<?php echo isset($_POST["excel"]) ? $_POST["excel"] : "" ?>');">OK</a>
										<? } ?>
									</div>
								</td>
							</tr>
