...
function montaListaFiltro(personas){
    ...
    personas.forEach(function(persona){
        ...
        //foreach CATEGORIAS
        var categorias = makeArray(persona.categorias.categoria);
        categorias.forEach(function(categoria){
            ...
            var subcategorias = makeArray(categoria.subcategorias.subcategoria);
            subcategorias.forEach(function(subcategoria){
                ...
                if(typeof subcategoria.separador === "undefined"){
                    ...
                    // if(typeof subcategoria.erros !== 'undefined'){
                    // }
                    if(typeof subcategoria.campos !== "undefined"){

                        var campos = makeArray(subcategoria.campos.campo);
