...
<!-- 				        	<li>
							<a href="#"><button class="btn btn-info btn-gerar-pdf-js col-10" style="margin-left:9%; color: #fff;"><i class="fas fa-file-pdf" style="color: #fff !important;"></i> Gerar PDF JS</button></a>
							</li> -->
				        </ul>
