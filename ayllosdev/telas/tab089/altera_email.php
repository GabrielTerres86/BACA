<?php
	/*!
	 * FONTE        : altera_email.php
	 * CRIAÇÃO      : Mateus Zimmermann (Mouts)
	 * DATA CRIAÇÃO : 27/08/2018
	 * OBJETIVO     : Rotina para alterar email
	 * --------------
	 * ALTERAÇÕES   : 
	 * -------------- 
	 */		
	...
	$xmlResult = mensageria($xml, "TELA_TAB089", "ATUALIZA_EMAIL_PROPOSTA", $glbvars["cdcooper"], $glbvars["cdagenci"], $glbvars["nrdcaixa"], $glbvars["idorigem"], $glbvars["cdoperad"],"</Root>");
	...
	exibirErro('inform','E-mail atualizado com sucesso.' ,'Alerta - Ayllos','buscaEmails();',false);
?>