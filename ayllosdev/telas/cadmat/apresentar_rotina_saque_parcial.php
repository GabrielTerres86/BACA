...
<?
    ...
    $xmlResult = mensageria($xml, "TELA_CADMAT", "BUSCA_DADOS_SAQUE_PARCIAL", $glbvars["cdcooper"], $glbvars["cdagenci"], $glbvars["nrdcaixa"], $glbvars["idorigem"], $glbvars["cdoperad"], "</Root>");
    ...
    // Executa script para envio do XML
    $xmlResult = mensageria($xml, "TELA_CADMAT", "BUSCA_COTAS_LIBERADA", $glbvars["cdcooper"], $glbvars["cdagenci"], $glbvars["nrdcaixa"], $glbvars["idorigem"], $glbvars["cdoperad"], "</Root>");
