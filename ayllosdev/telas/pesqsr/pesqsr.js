/*!
 * FONTE        : pesqsr.js
 * CRIAÇÃO      : Gabriel Capoia (DB1)             Úlimta alteração: 24/06/2016
...
function formataFiltro() {
	...
	rNrdctabb.addClass('rotulo-linha').css({ 'margin-left': '2px', 'width': '100px' });
	rCdbaninf.addClass('rotulo-linha').css({ 'margin-left': '2px', 'width': '85px' });

	rDtmvtolt.addClass('rotulo').css({ 'margin-left': '2px', 'width': '74px' });
	rNrdconta.addClass('rotulo-linha').css({ 'margin-left': '2px', 'width': '100px' });
	rCdbccxlt.addClass('rotulo-linha').css({ 'margin-left': '2px', 'width': '85px' });

	rNrdolote.addClass('rotulo').css({ 'margin-left': '2px', 'width': '74px' });
	rCdagenci.addClass('rotulo-linha').css({ 'margin-left': '2px', 'width': '100px' });
	rVllanmto.addClass('rotulo-linha').css({ 'margin-left': '2px', 'width': '85px' });
	...
	cNrdconta.unbind('keypress').bind('keypress', function(e) {
	    ...
	    if (e.keyCode == 13) {
			...
			if (cCddopcao.val() == 'C') {			
			    ...
			    showConfirmacao('Deseja confirmar opera&ccedil;&atilde;o?', 'Confirma&ccedil;&atilde;o - Ayllos', 'btnContinuar()', '$("#btVoltar","#divBotoesConsulta").focus();', 'sim.gif', 'nao.gif');
			}
			return false;
		}
	});
