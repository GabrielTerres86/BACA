<?
/*!
 * FONTE        : frame_resultados.php
 * CRIAÇÃO      : Guilherme / SUPERO
 * DATA CRIAÇÃO : 01/08/2013
 * OBJETIVO     : Tela de resultados da pesquisa de Logs de Acesso
 */	 
?>
					...
					<td>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td class="txtBrancoBold ponteiroDrag" background="<?php echo $UrlImagens; ?>background/tit_tela_fundo.gif"><? echo utf8ToHtml('Detalhes da Pesquisa') ?></td>
