...
<?	
	...
	switch($operacao) {
		...
		case 'B1': $procedure = 'Busca_Agencia'; $mtdErro = "cBanco.habilitaCampo(); cAgencia.val('0');"; 	break;
		case 'D1': $procedure = 'Busca_Agencia'; $mtdErro = "cBanco.habilitaCampo(); cAgencia.val('0');"; 	break;

		case 'B2': $procedure = 'Valida_Dados';  $mtdErro = "cNrChequeFim.habilitaCampo();";				break;
		case 'D2': $procedure = 'Valida_Dados';  $mtdErro = "cNrChequeFim.habilitaCampo();";				break;
