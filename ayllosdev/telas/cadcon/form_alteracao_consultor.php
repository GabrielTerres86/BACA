...
<div id="divAlteracaoConsultor">
	<form id="frmAltConsultor" name="frmAltConsultor" class="formulario" onSubmit="return false;" style="display:block">
		...
		<a href="#" class="botao" id="btnIncluirAgencia" name="btnIncluirAgencia" style = "text-align:right;" onclick="incluirAgenciaAlt(); return false;"><? echo utf8ToHtml("Incluir Ag&ecirc;ncia");?></a>
		<br style="clear:both" />
		<label for="tbAltcon"><? echo utf8ToHtml("Ag&ecirc;ncias atendidas pelo Consultor:") ?></label>
		<br style="clear:both" />
