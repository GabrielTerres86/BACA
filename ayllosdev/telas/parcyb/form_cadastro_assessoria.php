...
<form id="frmAssessoria" name="frmAssessoria" class="formulario" onSubmit="return false;" style="display:block">
  <label for="cdassessoria">
    <? echo utf8ToHtml("C&oacute;digo:") ?>
  </label>
  <input name="cdassessoria" type="text"  id="cdassessoria" class="campo"/>
  <a id="pesqassess" name="pesqassess" href="#" onClick="mostrarPesquisaAssessoria('#frmAssessoria,#divBotoes');return false;" >
  ...
  <br>
    <label for="cdsigcyb">
      <? echo utf8ToHtml("Sigla no Cyber:")?>
    </label>
