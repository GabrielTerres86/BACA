...
<div id="divTelaParametrizarHistorico">
  <form id="frmCabParametrizarHistorico" name="frmCabParametrizarHistorico" class="formulario" style="display:none">
    <table width="100%">
      <tr>
        <td>
          <label for="cddopcao_parametrizar_historico">
            <? echo utf8ToHtml("Op&ccedil;&atilde;o") ?>
          </label>
      ...
      <table width="100%">
        ...
        <tr>
          <td id="tdFiltrarHistorico">
            <input type="radio" id="rdfiltro1" class="campo" name="rdfiltro" value="1"/>
            <label for="rdfiltro1">
              <? echo utf8ToHtml("C&aacute;lculo Empr&eacute;stimo");?>
            </label>
            <input type="radio" id="rdfiltro2" class="campo" name="rdfiltro" value="2"/>
            <label for="rdfiltro2">
              <? echo utf8ToHtml("C&aacute;lculo Conta Corrente");?>
            </label>
            <input type="radio" id="rdfiltro3" class="campo" name="rdfiltro" value="3"/>
            <label for="rdfiltro3">
              <? echo utf8ToHtml("Ambos");?>
            </label>
        ...
        <table class="tituloRegistros" id="tbParhis">
          <thead>
            <tr>
              ...
              <th>
                <? echo utf8ToHtml("C&oacute;digo Trans.CYBER");?>
              </th>
            </tr>
          </thead>
          <tbody>
