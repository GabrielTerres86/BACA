<?
/*
 * FONTE        : form_fluxo_saida.php
 * CRIAÇÃO      : Tiago Machado 
 * DATA CRIAÇÃO : 01/08/2012											ÚLTIMA ALTERAÇÃO: 25/09/2012
 * OBJETIVO     : form de saida('S') da opcao fluxo na tela PREVIS.
 * --------------
...
?>
	...
	<fieldset id="fsetsaida" name="fsetsaida" style="padding:0px; margin:0px; padding-bottom:10px;">
		...
		<label for="vltottit">NR T&Iacute;TULOS:</label>
		...
		<label for="vlfatbra">FAT. CART&Atilde;O BRADESCO:</label>
		<label for="vlfatbra1"></label>
		<input name="vlfatbra1" id="vlfatbra1" type="text" value="<?php echo formataMoeda(getByTagName($vlfatbra,'vlfatbra.1')) ?>" />
		<label for="vlfatbra2"></label>
		<input name="vlfatbra2" id="vlfatbra2" type="text" value="<?php echo formataMoeda(getByTagName($vlfatbra,'vlfatbra.2')) ?>" />
		<label for="vlfatbra3"></label>
		<input name="vlfatbra3" id="vlfatbra3" type="text" value="<?php echo formataMoeda(getByTagName($vlfatbra,'vlfatbra.3')) ?>" />
		<label for="vlfatbra4"></label>
		<input name="vlfatbra4" id="vlfatbra4" type="text" value="<?php echo formataMoeda(getByTagName($vlfatbra,'vlfatbra.4')) ?>" />

		<br />

		<label for="vlconven">CONV&Ecirc;NIOS:</label>
		<label for="vlconven1"></label>
		<input name="vlconven1" id="vlconven1" type="text" value="<?php echo formataMoeda(getByTagName($vlconven,'vlconven.1')) ?>" />
		<label for="vlconven2"></label>
		<input name="vlconven2" id="vlconven2" type="text" value="<?php echo formataMoeda(getByTagName($vlconven,'vlconven.2')) ?>" />
		<label for="vlconven3"></label>
		<input name="vlconven3" id="vlconven3" type="text" value="<?php echo formataMoeda(getByTagName($vlconven,'vlconven.3')) ?>" />
		<label for="vlconven4"></label>
		<input name="vlconven4" id="vlconven4" type="text" value="<?php echo formataMoeda(getByTagName($vlconven,'vlconven.4')) ?>" />

		<br />
		
		<fieldset id="fsetDiversosSaida" name="fsetDiversosSaida" style="border-right:none; border-left:none; width:100%; padding:0px; padding-bottom:10px; margin:0px;">
			...
			<label for="vlrfolha">SAQUE NUMER&Aacute;RIO:</label>
			...
			<label for="vlnumera">AL&Iacute;VIO NUMER&Aacute;RIO:</label>
		...
		<label for="vlttcrdb">TOTAL D&Eacute;BITO:</label>
