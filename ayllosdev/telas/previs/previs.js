...
function controlaLayout() {
	...
	if ( cddopcao == 'A' || cddopcao == 'I' ) {
		...
		$('#divBotoesFluxo').css({ 'display': 'block', 'padding-bottom': '15px' });
		$('#btVoltar', '#divBotoesFluxo').css({ 'display': 'inline' });
		cDtmvtolt.desabilitaCampo();
		...
		if (cdcoplog != 3) {
		    ...
		    if (hrpermit) {
		        ...
		        if (cdmovmto == "E" || cdmovmto == "S") {
		            $('#divBotoesFluxo').append('<a href="#" class="botao" id="btSalvar" onClick="showConfirmacao(\'Deseja confirmar opera&ccedil;&atilde;o?\',\'Confirma&ccedil;&atilde;o - Ayllos\',\'gravaDiversos();\',\'\',\'sim.gif\',\'nao.gif\'); return false;">Prosseguir<a/>');

		        } else if (cdmovmto == "R") {
		            $('#divBotoesFluxo').append('<a href="#" class="botao" id="btSalvar" onClick="showConfirmacao(\'Deseja confirmar opera&ccedil;&atilde;o?\',\'Confirma&ccedil;&atilde;o - Ayllos\',\'gravaApliResg();\',\'\',\'sim.gif\',\'nao.gif\'); return false;">Prosseguir<a/>');
	    ...
	    formataLiquidacao();
	    cCdcooper.desabilitaCampo(); // Daniel
	    cDtmvtolt.desabilitaCampo(); // Daniel
	    $('#divBotoesLiquidacoes').css('display', 'block');
	    divBotoesLiquidacoes
	}	
...
function formataFluxo() {
	...
	******************/
	...
	for(var i = 0; i < qtcopapl; i++){
		...
		eval('cVlresapl'+i+'.css(\'width\',\'100px\').addClass(\'moeda\');');
	...
	******************/
	...
	rTodostit.css({'width':'160px'}).addClass('rotulo');
	...
	*********************/
	...
	rTodossai.css({ 'width': '160px' }).addClass('rotulo');
	...
	*********************/
	...
	rTodosrel.css({'width':'190px'}).addClass('rotulo-linha');
	...
	rNmoperad.addClass('rotulo').css({'width':'192px'});
	...
	cTodosrel.css({'width':'100px'}).addClass('monetario');	
