 ...
 * DATA CRIAÇÃO : 01/08/2012											ÚLTIMA ALTERAÇÃO: 31/08/2012
...
?>
	...
	<fieldset id="fsetentrada" name="fsetentrada" style="padding:0px; margin:0px; padding-bottom:10px;">
		...
		<input name="vltotted1" id="vltotted1" type="text" value="<?php echo formataMoeda(getByTagName($vltottedr,'vltotted.1')); ?>" />
		<label for="vltotted2"></label>
		<input name="vltotted2" id="vltotted2" type="text" value="<?php echo formataMoeda(getByTagName($vltottedr,'vltotted.2')); ?>" />
		<label for="vltotted3"></label>
		<input name="vltotted3" id="vltotted3" type="text" value="<?php echo formataMoeda(getByTagName($vltottedr,'vltotted.3')); ?>" />
		<label for="vltotted4"></label>
		<input name="vltotted4" id="vltotted4" type="text" value="<?php echo formataMoeda(getByTagName($vltottedr,'vltotted.4')); ?>" />
