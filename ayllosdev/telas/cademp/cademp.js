...
function formataCabecalho() {
    ...
    cDtfchfol.addClass('campo').css({'width':'130px'}).attr('maxlength', '2').setMask("INTEGER", "99");
...
function formataInfEmpresas() {
    ...
    var rDtfchfol = $('label[for="dtfchfol"]', '#frmInfTarifa');
    ...
    cDtfchfol = $('#dtfchfol', '#frmInfTarifa');
    ...
    var rTpdebppr = $('label[for="tpdebppr"]', '#frmInfEmprestimo');
    var rDtavsppr = $('label[for="dtavsppr"]', '#frmInfEmprestimo');
    ...
    rTpdebppr.css({width: '150px'});
    rDtavsppr.css({width: '152px'});
    ...
    cTpdebppr = $('#tpdebppr', '#frmInfEmprestimo');
    cDtavsppr = $('#dtavsppr', '#frmInfEmprestimo');
    ...
    cTpdebppr.css({width: '120px'});
    cDtavsppr.addClass('data').css({'width': '80px', 'float': 'left'});
...
function controlaOperacao() {
    ...
    if (($('#frmInfTarifa').css('display') == "block") && cddopcao) {
        ...
        if (cddopcao == 'I' || cddopcao == 'A') {
			...
			if (cFlgpagto.is(":checked") && (cDtfchfol.val()=="" || (cDtfchfol.val() <= 0 || cDtfchfol.val() > 28))){
				showError('error','Dia Fechamento Folha deve ser entre 1 e 28.','Campo obrigat&oacute;rio','$("#dtfchfol","#frmInfTarifa").focus();');
                return false;
			}
...
function controlaFocoFormulariosEmpresa() {
    ...
    if (cddopcao == "A" || cddopcao == "I") {
        ...
        cNrdconta.unbind('keypress').bind('keypress', function(e) {
            if (e.keyCode == 9 || e.keyCode == 13) {
                if (normalizaNumero(cNrdconta.val()) > 0 && cFlgpgtib.is(":checked")) {
					showError('error','Conta d&eacutebito da empresa deve ser informado!',
                              'Campo Obrigat&oacute;rio!',
                              '$("#nrdconta","#frmInfEmpresa").focus();');
        ...
        cTpdebcot.unbind('keypress').bind('keypress', function(e) {
            ...
            cDtavscot.val($('#data-' + $(this).val(), '#frmInfEmprestimo').val());
        });
        cTpdebemp.unbind('keypress').bind('keypress', function(e) {
            ...
            cDtavsemp.val($('#data-' + $(this).val(), '#frmInfEmprestimo').val());
        });
        cTpdebppr.unbind('keypress').bind('keypress', function(e) {
            if (e.keyCode == 9 || e.keyCode == 13) {
                controlaOperacao();
                return false;
            }
        }).change(function() {
            cDtavsppr.val($('#data-' + $(this).val(), '#frmInfEmprestimo').val());
        });
        /*Formulario Emprestimo */
    }
}
    ...
    if ($('table > tbody > tr', 'div#divTabEmpresas div.divRegistros').hasClass('corSelecao')) {
        ...
        $('table > tbody > tr', 'div#divTabEmpresas div.divRegistros').each(function() {
            if ($(this).hasClass('corSelecao')) {
                ...
                cTpdebppr.val($('#htpdebppr', $(this)).val());
                ...
                cDtavsppr.val($('#hdtavsppr', $(this)).val());
                ...
                old_cTpdebppr = $('#htpdebppr', $(this)).val();
                ...
                old_cDtavsppr = $('#hdtavsppr', $(this)).val();
