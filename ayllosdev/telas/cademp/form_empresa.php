...
<div id="divEmpresa" name="divEmpresa">
	<form id="frmInfEmpresa" name="frmInfEmpresa" class="formulario" onSubmit="return false;" style="display:block"> <!-- ALTERAR PARA NONE -->
		...
		<fieldset>
			...
			<label for="cdempres"><? echo utf8ToHtml('C&oacute;digo:') ?></label>
			...
			<label for="idtpempr"><? echo utf8ToHtml('Tipo Empresa:') ?></label>
			...
			<label for="nmextemp"><? echo utf8ToHtml('Razao Social:') ?></label>
			<input name="nmextemp" type="text"  id="nmextemp" class='campo' />

			<br style="clear:both" />

			<label for="nmresemp"><? echo utf8ToHtml('Nome&nbsp;Fantasia:') ?></label>
			<input name="nmresemp" type="text"  id="nmresemp" class='campo' />

			<br style="clear:both" />
			<br style="clear:both" />

			<label for="nrdconta"><? echo utf8ToHtml('Conta D&eacute;bito:') ?></label>
			...
			<label for="nmcontat"><? echo utf8ToHtml('Contato:') ?></label>
			...
			<label for="dsendemp"><? echo utf8ToHtml('Endere&ccedil;o:') ?></label>
			<input name="dsendemp" type="text"  id="dsendemp" class='campo' />

			<label for="nrendemp"><? echo utf8ToHtml('N&uacute;mero:') ?></label>
			...
			<label for="cdufdemp"><? echo utf8ToHtml('UF:') ?></label>
			...
			<label for="nrfonemp"><? echo utf8ToHtml('Telefone:') ?></label>
			<input name="nrfonemp" type="text"  id="nrfonemp" class='campo' />

			<label for="nrfaxemp"><? echo utf8ToHtml('Fax:') ?></label>
	...
	<form id="frmInfTarifa" name="frmInfTarifa" class="formulario" onSubmit="return false;" style="display:none"> <!-- ALTERAR PARA NONE -->
		...
		<fieldset>
			<legend>Folha E-mail</legend>
				...
				<label for="flgpagto"><? echo utf8ToHtml('Integra Folha:') ?></label>
				<input type="checkbox" id = "flgpagto" name="flgpagto"/>
				
				<br style="clear:both" />
				<br style="clear:both" />
				
				<label for="cdempfol"><? echo utf8ToHtml('C&oacute;digo da Empresa Sistema Folha:') ?></label>
				<input name="cdempfol" type="text"  id="cdempfol" class='campo' />
			
			    <br style="clear:both" />

				<label for="vltrfsal"><? echo utf8ToHtml('Tarifa para Cr&eacute;dito de Sal&aacute;rios:') ?></label>
				...
				<label for="ddpgtmes"><? echo utf8ToHtml('Dia do Pagamento de Mensalista:') ?></label>
				<input name="ddpgtmes" type="text"  id="ddpgtmes" class='campo' />

				<br style="clear:both" />

				<label for="ddpgthor"><? echo utf8ToHtml('Dia do Pagamento de Horista:') ?></label>
	...
	<form id="frmInfIb" name="frmInfIb" class="formulario" onSubmit="return false;" style="display:none"> <!-- ALTERAR PARA NONE -->
		<fieldset>
			...
			<label for="flgpgtib"><? echo utf8ToHtml('Libera&ccedil;&atilde;o Folha IB?:') ?></label>
			<input type="checkbox" id = "flgpgtib" name="flgpgtib"/>

			<br style="clear:both" />
			<br style="clear:both" />
			
			<label for="cdcontar"><? echo utf8ToHtml('Conv&ecirc;nio Tarif&aacute;rio:') ?></label>
			...
			<label for="vllimfol"><? echo utf8ToHtml('Valor Limite Di&aacute;rio:') ?></label>
	...
	<form id="frmInfEmprestimo" name="frmInfEmprestimo" class="formulario" onSubmit="return false;" style="display:none"> <!-- ALTERAR PARA NONE -->
		...
		<fieldset>
			<legend>Informacoes Complementares</legend>
				...
				<label for="indescsg"><? echo utf8ToHtml('Empr&eacute;stimo Consignado:') ?></label>
				<input type="checkbox" id = "indescsg" name="indescsg"/>				

				<br style="clear:both" />
				
				<label for="flgarqrt"><? echo utf8ToHtml('Gera arq. retorno:') ?></label>
				<input type="checkbox" id = "flgarqrt" name="flgarqrt"/>

				<br style="clear:both" />
				
				<label for="flgvlddv"><? echo utf8ToHtml('Valida DV Cad.Emp:') ?></label>
				<input type="checkbox" id = "flgvlddv"  name="flgvlddv"/>
				
				<br style="clear:both" />
				<br style="clear:both" />
				
				<label for="ddmesnov"><? echo utf8ToHtml('Dia M&ecirc;s Novo para Empr&eacute;stimo:') ?></label>
				<input name="ddmesnov" type="text"  id="ddmesnov" class='campo' />
				
				<br style="clear:both" />
				
				<label for="tpconven"><? echo utf8ToHtml('Impress&atilde;o do Aviso:') ?></label>
				...
				<label for="nrlotcot"><? echo utf8ToHtml('Lote Cotas:') ?></label>
				<input name=" nrlotcot" type="text"  id="nrlotcot" class='campo' />

				<label for="nrlotemp"><? echo utf8ToHtml('Lote Empr&eacute;stimo:') ?></label>
				<input name="nrlotemp" type="text"  id="nrlotemp" class='campo' />

				<label for="nrlotfol"><? echo utf8ToHtml('Lote Folha:') ?></label>
				<input name="nrlotfol" type="text"  id="nrlotfol" class='campo' />

				<br style="clear:both" />
				<br style="clear:both" />

				<label for="tpdebemp"><? echo utf8ToHtml('Gera Aviso Empr&eacute;stimo:') ?></label>
				...
				<label for="dtavsemp"><? echo utf8ToHtml('Data Gera&ccedil;&atilde;o:') ?></label>
				<input name="dtavsemp" type="text"  id="dtavsemp" class='campo'/>

				<br style="clear:both" />

				<label for="tpdebcot"><? echo utf8ToHtml('Gera Aviso Cotas:') ?></label>
				<select name="tpdebcot" id="tpdebcot" class="campo">
					<option value="1" selected>N&Atilde;O DEBITA</option>
					<option value="2">5 DIAS ANTES</option>
					<option value="3">3 DIAS ANTES</option>
				</select>
				<label for="dtavscot"><? echo utf8ToHtml('Data Gera&ccedil;&atilde;o:') ?></label>
				<input name="dtavscot" type="text"  id="dtavscot" class='campo' />

				<br style="clear:both" />

				<label for="tpdebppr"><? echo utf8ToHtml('Gera Aviso Poup.Prog:') ?></label>
				<select name="tpdebppr" id="tpdebppr" class="campo">
					<option value="1" selected>N&Atilde;O DEBITA</option>
					<option value="2">5 DIAS ANTES</option>
					<option value="3">3 DIAS ANTES</option>
				</select>
				<label for="dtavsppr"><? echo utf8ToHtml('Data Gera&ccedil;&atilde;o:') ?></label>
				<input name="dtavsppr" type="text"  id="dtavsppr" class='campo' />
				<!-- CAMPOS LOG -->
				<?
					$arrayParam = array('cdcooper' => $glbvars["cdcooper"],
										...
										'cdprogra' => $glbvars["cdprogra"],
										'nmdbusca' => $glbvars["nmdbusca"],
										'cdpesqui' => $glbvars["cdpesqui"]);
				?>
				...
				<input type='hidden' name='old_tpdebppr' id='old_tpdebppr'>
				<input type='hidden' name='old_dtavsppr' id='old_dtavsppr'>				
				<input type='hidden'  id='data-2' value='<?php echo valida_feriado($glbvars['dtmvtolt'],5, $arrayParam);?>'>
				<input type='hidden'  id='data-3' value='<?php echo valida_feriado($glbvars['dtmvtolt'],3, $arrayParam);?>'>
				<!-- CAMPOS LOG -->
			</fieldset>
	</form>
</div>
