 ...
 */
    ...
    $idtpempr = $_POST["idtpempr"]; /* aqui */
    $nmresemp = substr($_POST["nmresemp"],0,15);
    $nrdconta = $_POST["nrdconta"]; /* aqui */
    $nmcontat = $_POST["nmcontat"]; /* aqui */
    $dsendemp = $_POST["dsendemp"];
    $nrendemp = $_POST["nrendemp"];
    $dscomple = $_POST["dscomple"];
    $nmbairro = substr($_POST["nmbairro"],0,15);
    $nmcidade = $_POST["nmcidade"];
    $cdufdemp = $_POST["cdufdemp"];
    $nrcepend = str_replace(array('-','.'),'',$_POST["nrcepend"]);
    $nrdocnpj = trim(str_replace(array('-','.','/'),'',$_POST["nrdocnpj"]));
    $nrfonemp = $_POST["nrfonemp"];
    $nrfaxemp = $_POST["nrfaxemp"];
    $dsdemail = $_POST["dsdemail"];
    $ddmesnov = $_POST["ddmesnov"];
    $dtlimdeb = $_POST["dtlimdeb"];
    $ddpgtmes = $_POST["ddpgtmes"];
    $ddpgthor = $_POST["ddpgthor"];
    $flgpgtib = $_POST["flgpgtib"]; /* aqui */
    $cdcontar = $_POST["cdcontar"]; /* aqui */
    $vllimfol = $_POST["vllimfol"]; /* aqui */
    $nrlotfol = $_POST["nrlotfol"];
    $nrlotemp = $_POST["nrlotemp"];
    $nrlotcot = $_POST["nrlotcot"];
    $vltrfsal = str_replace(array('.'),',',$_POST["vltrfsal"]);
    $flgvlddv = $_POST["flgvlddv"];
    $tpconven = $_POST["tpconven"];
    $tpdebemp = $_POST["tpdebemp"];
    $tpdebcot = $_POST["tpdebcot"];
    $tpdebppr = $_POST["tpdebppr"];
    $indescsg = $_POST["indescsg"];
    $flgpagto = $_POST["flgpagto"];
    $flgarqrt = $_POST["flgarqrt"];
    $dtfchfol = $_POST["dtfchfol"];
    $cdempfol = $_POST["cdempfol"];
    $dtavsemp = $_POST["dtavsemp"];
    $dtavscot = $_POST["dtavscot"];
    $dtavsppr = $_POST["dtavsppr"];

    /*VALORES ANTIGOS PARA GRAVAR NO LOG*/
    $old_idtpempr = $_POST["old_idtpempr"]; /* aqui */
    $old_nrdconta = $_POST["old_nrdconta"]; /* aqui */
    $old_nmcontat = $_POST["old_nmcontat"]; /* aqui */
    $old_flgpgtib = $_POST["old_flgpgtib"]; /* aqui */
    $old_cdcontar = $_POST["old_cdcontar"]; /* aqui */
    $old_vllimfol = $_POST["old_vllimfol"]; /* aqui */
    $old_cdempres = $_POST["old_cdempres"];
    $old_nmextemp = $_POST["old_nmextemp"];
    $old_nmresemp = $_POST["old_nmresemp"];
    $old_dsendemp = $_POST["old_dsendemp"];
    $old_nrendemp = $_POST["old_nrendemp"];
    $old_dscomple = $_POST["old_dscomple"];
    $old_nmbairro = $_POST["old_nmbairro"];
    $old_nmcidade = $_POST["old_nmcidade"];
    $old_cdufdemp = $_POST["old_cdufdemp"];
    $old_nrcepend = str_replace(array('-','.'),'',$_POST["old_nrcepend"]);
    $old_nrdocnpj = trim(str_replace(array('-','.','/'),'',$_POST["old_nrdocnpj"]));
    $old_nrfonemp = $_POST["old_nrfonemp"];
    $old_nrfaxemp = $_POST["old_nrfaxemp"];
    $old_dsdemail = $_POST["old_dsdemail"];
    $old_ddmesnov = $_POST["old_ddmesnov"];
    $old_dtlimdeb = $_POST["old_dtlimdeb"];
    $old_ddpgtmes = $_POST["old_ddpgtmes"];
    $old_ddpgthor = $_POST["old_ddpgthor"];
    $old_nrlotfol = $_POST["old_nrlotfol"];
    $old_nrlotemp = $_POST["old_nrlotemp"];
    $old_nrlotcot = $_POST["old_nrlotcot"];
    $old_vltrfsal = $_POST["old_vltrfsal"];
    $old_flgvlddv = $_POST["old_flgvlddv"];
    $old_tpconven = $_POST["old_tpconven"];
    $old_tpdebemp = $_POST["old_tpdebemp"];
    $old_tpdebcot = $_POST["old_tpdebcot"];
    $old_tpdebppr = $_POST["old_tpdebppr"];
    $old_indescsg = $_POST["old_indescsg"];
    $old_flgpagto = $_POST["old_flgpagto"];
    $old_flgarqrt = $_POST["old_flgarqrt"];
    $old_dtfchfol = $_POST["old_dtfchfol"];
    $old_cdempfol = $_POST["old_cdempfol"];
    $old_dtavsemp = $_POST["old_dtavsemp"];
    $old_dtavscot = $_POST["old_dtavscot"];
    $old_dtavsppr = $_POST["old_dtavsppr"];
    /*VALORES ANTIGOS PARA GRAVAR NO LOG*/
