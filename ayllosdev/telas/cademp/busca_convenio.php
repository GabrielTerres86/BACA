 ...
 * OBJETIVO     : Busca os convenios tarifarios
 * --------------
 * ALTERAÇÕES   :
 * --------------
 */
				    ...
				    <td>
						<table width="100%" border="0" cellspacing="0" cellpadding="0" >
							<tr>
								...
								<td class="txtBrancoBold ponteiroDrag" background="<?php echo $UrlImagens; ?>background/tit_tela_fundo.gif"> Conv&ecirc;nio Tarif&aacute;rio </td>
