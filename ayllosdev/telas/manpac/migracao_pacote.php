...
<div id="divDadosMigracao" name="divDadosMigracao" style="display: block;" > 
	...
	<br/>
	<fieldset>
		<legend>&nbsp;Migra&ccedil;&atilde;o do Pacote&nbsp;</legend>
			<label for="cdpacoteMig"><?php echo utf8ToHtml('Pacote:') ?></label>	
	...
	$('#cdpacoteMig', '#frmDados').unbind('keypress').bind('keydown', function (e) {
        ...
        if ($('#cdpacoteMig', '#frmDados').hasClass('campoTelaSemBorda')) { return false; }
			...
			if (e.keyCode == 9 || e.keyCode == 13) {
				...
				showError("error", "C&oacute;digo do novo pacote deve ser diferente do pacote atual.", "Alerta - Ayllos","$('#cdpacoteMig').val('');$('#cdpacoteMig').focus();");
				return false;
			}
