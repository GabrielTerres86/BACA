<?php
	...
	if(strtoupper($xmlObj->roottag->tags[0]->name == 'ERRO')){	
		...
		echo 'showConfirmacao("Confirma a desativa&ccedil;&atilde;o e migra&ccedil;&atilde;o do pacote de tarifas?", "Confirma&ccedil;&atilde;o - Ayllos", "migracaoPacote();aux_manpac = 6;", "cBtnConcluir.focus()", "sim.gif", "nao.gif");';		
	}	
?>