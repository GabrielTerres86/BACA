...
function verificaAcao(strAcao) {
    ...
    if (strAcao == 'C') {
        if (cCddopcao.val() == 'C') {
            ...
            $("fieldSet.fldPacote legend").text('Pacote Atual');
            ...
            if (!$('#divDadosMANPAC').is(':visible')) {
                ...
                if (aux_manpac == 0) {
                    ...
                    if (cCdpacote.val() == "" || cCdpacote.val() == 0) {
                        cDspacote.val("");
                        showError("error", "Informe um pacote de tarifas v&aacute;lido.", "Alerta - Ayllos", "cTodosCabecalho.limpaFormulario();cCdpacote.val(\"\");cCdpacote.focus();");
                        return false;
                    }
                    ...
                    if (cCdpacote.val() == "" || cCdpacote.val() == 0) {
                        cTodosCabecalho.limpaFormulario();
                        showError("error", "Informe um pacote de tarifas v&aacute;lido.", "Alerta - Ayllos", "cCdpacote.val(\"\");cCdpacote.focus();");
                        return false;
                    }
                    ...
                    if (cCdpacoteMig.val() == "" || cCdpacoteMig.val() == 0) {
                        cDspacoteMig.val("");
                        showError("error", "Informe um pacote de tarifas v&aacute;lido.", "Alerta - Ayllos", "cCdpacoteMig.val(\"\");cCdpacoteMig.focus();");
                        return false;
                    }                    
                    ...
                    if (cCdpacoteMig.val() == cCdpacote.val()) {
                        showError("error", "C&oacute;digo do novo pacote deve ser diferente do pacote atual.", "Alerta - Ayllos", "cCdpacoteMig.val(\"\");cTppessoaMig.val(0);cVlpacoteMig.val(\"\");cDspacoteMig.val(\"\");cCdpacoteMig.focus();");
                        return false;
                    }
                    ...
                    if (cCdpacoteMig.val() != aux_codantMig && aux_codantMig != 0) {
                        ...
                        if(cTppessoa.val() == cTppessoaMig.val()){
                            ...
                            showError("error", "Tipo de pessoa do novo pacote n&atilde;o confere com o pacote atual.", "Alerta - Ayllos", "cCdpacoteMig.val(\"\");cTppessoaMig.val(0);cVlpacoteMig.val(\"\");cDspacoteMig.val(\"\");cCdpacoteMig.focus();");
                            return false;
                        }                        
                    }
                    aux_pesq = 0;
            ...
            $("fieldSet.fldPacote legend").text('Pacote de Tarifas');
...
function consultaDados() {
    ...
    if (cCddopcao.val() != "C") {
        ...
        if (cCdpacote.val() == "" || cCdpacote.val() == 0) {
            showError("error", "Informe um pacote de tarifas v&aacute;lido.", "Alerta - Ayllos", "cTodosCabecalho.limpaFormulario();cCdpacote.focus();");
            return false;
        }
    }
...
function consultaTarifasDesativar(tipoBusca) {
    ...
    if (tipoBusca == 1) {
        ...
        if (cCdpacoteMig.val() == "") {
            cDspacoteMig.val("");
            showError("error", "Informe um pacote de tarifas v&aacute;lido.", "Alerta - Ayllos", "cCdpacoteMig.focus();");
            return false;
        }
        cdpacote = cCdpacoteMig.val();
    }    
...
function validaDesativar() {
    if (cCdpacote.val() == "") {
        showError("error", "Informe um pacote de tarifas v&aacute;lido.", "Alerta - Ayllos", "estadoInicial();");
        return false;
    }
...
function efetivaDesativar() {
    ...
    if (cCdpacote.val() == 0 || cCdpacote.val() == "") {
        showError("error", "Informe um pacote de tarifas v&aacute;lido.", "Alerta - Ayllos", "cCdpacote.habilitaCampo();cCdpacote.addClass('inteiro');cTodosCabecalho.limpaFormulario();cCdpacote.focus();");
    }
...
function controlaPesquisaPacote() {
    ...
    dspacote = '';
    titulo_coluna = "Pacotes de Tarifas";
    
    bo = 'b1wgen0153.p';
    procedure = 'consulta_pacote_manpac';
    titulo = 'Pacotes de Tarifas';
    qtReg = '20';
    aux_pesq = 99;
...
function consultaHabilitar() {
    if (cCdpacote.val() == 0 || cCdpacote.val() == "") {
        showError("error", "Informe um pacote de tarifas v&aacute;lido.", "Alerta - Ayllos", "cCdpacote.habilitaCampo();cCdpacote.addClass('inteiro');cTodosCabecalho.limpaFormulario();$('#lupaCons').show();cCdpacote.focus();");
        return false;
    }
    ...
    // Mostra mensagem de aguardo
    showMsgAguardo("Aguarde, consultando pacote de tarifas...");
...
function validaHabilitar() {
    ...
    if (cDtvigencHab.val() == "") {
        showError("error", "Informe a Data de in&iacute;cio da vig&ecirc;ncia do pacote.", "Alerta - Ayllos", "cDtvigencHab.focus();");
        return false;
    }
    
    // Mostra mensagem de aguardo
    showMsgAguardo("Aguarde, validando habilita&ccedil;&atilde;o de pacote de tarifas...");
...
function efetivaHabilitar() {
    ...
    // Mostra mensagem de aguardo
    showMsgAguardo("Aguarde, habilitando de pacote de tarifas...");
...
function formularioMigracao() {
    // Mostra mensagem de aguardo
    showMsgAguardo("Aguarde, habilitando migra&ccedil;&atilde;o de pacote de tarifas...");
