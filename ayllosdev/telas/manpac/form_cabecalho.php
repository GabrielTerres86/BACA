...
<form id="frmCab" name="frmCab" class="formulario cabecalho" > 
	<div id="divCab">
		...
		<select id="cddopcao" name="cddopcao">
			<option value="C" <? echo $cddopcao == 'C' ? 'selected' : '' ?> > C - Consultar Pacote</option>
			<option value="D" <? echo $cddopcao == 'D' ? 'selected' : '' ?> > D - Desativar Pacote</option>
			<option value="H" <? echo $cddopcao == 'H' ? 'selected' : '' ?> > H - Habilitar Pacote</option>
		</select>	
