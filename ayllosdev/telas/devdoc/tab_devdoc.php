...
<div id="tabDevdoc">
	...
	<div class="divRegistros">
		<table class="tituloRegistros">
			<thead>
				<tr>
					<th><? echo utf8ToHtml('Dev'); 		?></th>
                	<th><? echo utf8ToHtml('Mot');  	?></th>
					<th><? echo utf8ToHtml('Doc');  	?></th>
					<th><? echo utf8ToHtml('Valor');  	?></th>
					<th><? echo utf8ToHtml('Ag Fav');  	?></th>
					<th><? echo utf8ToHtml('Cta Fav');  ?></th>
					<th><? echo utf8ToHtml('Nome Favorecido');  ?></th>
