<?php
/*!
 * FONTE        : incluir_movimento.php                    Última alteração: 25/06/2017
 * CRIAÇÃO      : Jonata (RKAM)
 * DATA CRIAÇÃO : Maio/2017
 * OBJETIVO     : Rotina para inclusão de movimentos da tela MOVRGP
 * --------------
...
<?php
	...
	$xmlResult = mensageria($xmlAlterar, "TELA_MOVRGP", "INCLUIRMOVTO", $glbvars["cdcooper"], $glbvars["cdagenci"], $glbvars["nrdcaixa"], $glbvars["idorigem"], $glbvars["cdoperad"], "</Root>");
	...
	exibirErro('inform','Movimento inclu&iacute;do com sucesso.','Alerta - Ayllos','fechaRotina($(\'#divRotina\'));estadoInicial();',false);		
