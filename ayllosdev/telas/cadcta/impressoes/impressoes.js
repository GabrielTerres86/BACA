...
function acessaOpcaoAba(nrOpcoes, id, opcao) {
    ...
    $.ajax({
        type: "POST",
        dataType: "html",
        url: UrlSite + "telas/cadcta/impressoes/principal.php",
        data: {
            nrdconta: nrdconta,
            idseqttl: idseqttl,
            inpessoa: inpessoa,
...
function telaCartaoAssinatura(inpessoa) {
    $.ajax({
        type: "POST",
        dataType: "html",
        url: UrlSite + "telas/cadcta/impressoes/cartao_assinatura.php",
        data: {
            nrdconta: nrdconta,
            idseqttl: idseqttl,
            inpessoa: inpessoa,
...
function impressaoCartaoAssinatura(inpessoa, tpimpressao) {
    ...
    if (tpimpressao == 'todos') {
        ...
        $.ajax({
            type: "POST",
            dataType: "html",
            url: UrlSite + "telas/cadcta/impressoes/consulta_impressao.php",
            data: {
                nrdconta: nrdconta,
                idseqttl: idseqttl,
                inpessoa: inpessoa,
...
function imprimeCartaoAssinatura(tppessoa) {
    ...
    var action = UrlSite + 'telas/cadcta/impressoes/imprime_cartao_ass.php';
    var callafter = "bloqueiaFundo(divRotina);";
