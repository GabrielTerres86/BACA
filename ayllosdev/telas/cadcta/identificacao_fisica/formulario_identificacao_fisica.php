...
<form name="frmDadosIdentFisica" id="frmDadosIdentFisica" class="formulario condensado">
	...
	<fieldset>
		...
		<select name="cdgraupr" id="cdgraupr">
			<option value=""> - </option>
		    <!-- opcao nao sera mais exibida, pois carrega tela apenas para inclusao	
...
<div id="divBotoes">
	...
	<input type="image" id="btVoltar"  class="opConsulta" src="<? echo $UrlImagens; ?>botoes/voltar.gif"  onClick="fechaRotina(divRotina,'','obtemCabecalho();')" />
	<!--
    // tela CADCTA não possui opcao de alteracao de dados pessoais, alteracao ocorre no CRM
	...
	<? } else { ?>
		<input type="image" id="btCancelarAlt"  class="opAlteracao opAlterar"  src="<? echo $UrlImagens; ?>botoes/voltar.gif"    onClick="fechaRotina(divRotina,'','obtemCabecalho();');" />
	<? } ?>
	
	<!--<input type="image" id="btContinuar"  class="opContinuar" src="<? echo $UrlImagens; ?>botoes/continuar.gif" onClick="controlaContinuar();"  />-->
	
	<input type="image" id="btCancelarInc"   class="opInclusao opIncluir"	src="<? echo $UrlImagens; ?>botoes/cancelar.gif"	onClick="fechaRotina(divRotina,'','obtemCabecalho();')" />			
	...
	<input type="image" id="btProsseguirInc" class="opIncluir" 			    src="<? echo $UrlImagens; ?>botoes/concluir.gif"	onClick="keypressCPF()"/>			
