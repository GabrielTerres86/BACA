...
function acessaOpcaoAba(nrOpcoes,id,opcao) {
	...
	$.ajax({		
		type: "POST", 
		dataType: "html",
		url: UrlSite + "telas/cadcta/fatca_crs_pj/principal.php",
		data: {
			nrcpfcgc: nrcpfcgc,
			redirect: "html_ajax"
		},
...
function manterRotina(operacao) {
	...
	$.ajax({		
		type: 'POST',
		url: UrlSite + 'telas/cadcta/fatca_crs_pj/manter_rotina.php', 		
		data: {
			nrcpfcgc: 			  nrCPF,
...
function formatarTabela(){
	...
	//Formata Tabela
	var divRegistro = $('#divTableSocios');
...
function alterarSocioSelecionado(){
    ...
    $('table > tbody > tr', '#divTableSocios').each( function() {
