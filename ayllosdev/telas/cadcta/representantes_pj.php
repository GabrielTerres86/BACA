<?php
/*!
 * FONTE        : representante_pj.php
 * CRIAÇÃO      : Odirlei Busana - AMcom
 * DATA CRIAÇÃO : Setembro/2017
 * OBJETIVO     : Listar representantes de pessoas juridicas na tela CADCTA
 * --------------
 * ALTERAÇÕES   :
 * --------------
 */
				...
				<tbody>
					...
					<?foreach($registros as $procuracao) { $qtRegistros++; 
						...
						<tr >
							...
							<td>
								<? echo stringTabela(getByTagName($procuracao->tags,'nmdavali'),24,'maiuscula') ?>
							</td> 
							<td>
							...
							<td>
								<? echo stringTabela(getByTagName($procuracao->tags,'dsproftl'),18,'maiuscula') ?>
							</td>
						</tr>	
