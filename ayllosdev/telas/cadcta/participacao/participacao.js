...
function acessaOpcaoAba(nrOpcoes,id,opcao) { 
	...
	$.ajax({		
		type: 'POST', 
		dataType: 'html',
		url: UrlSite + 'telas/cadcta/participacao/principal.php',
		data: {
			nrdconta: nrdconta,
			idseqttl: idseqttl,
			nrcpfcgc: nrcpfcgc,
...
function controlaOperacao( operacao ){
	...
	if ( in_array(operacao,['TC','TA','TX']) ) {
		...
		nrdctato 	= '';
		nrdrowid 	= '';
		$('table > tbody > tr', 'div.divRegistrosParticipacaoEmpresa').each( function() {
	...
	$('.divRegistrosParticipacaoEmpresa').remove();
...
function manterRotina(operacao) {
	...
	$.ajax({		
		type: 'POST',
		url: UrlSite + 'telas/cadcta/participacao/manter_rotina.php', 		
		data: {			
			nrcpfcgc: nrcpfcgc,	
			nrdctato: nrdctato,
			nmprimtl: nmprimtl,
...
function controlaLayout( operacao ) {
	...
	if ( operacao == 'CT' ) {
		...
		var divRegistro = $('div.divRegistrosParticipacaoEmpresa');		
