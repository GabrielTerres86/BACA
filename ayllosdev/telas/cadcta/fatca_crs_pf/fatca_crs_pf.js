...
function acessaOpcaoAba(nrOpcoes,id,opcao) {  
	...
	$.ajax({		
		type: "POST", 
		dataType: "html",
		url: UrlSite + "telas/cadcta/fatca_crs_pf/principal.php",
		data: {
			nrcpfcgc: nrcpfcgc,
			redirect: "html_ajax"
		},
...
function manterRotina(operacao) {
	...
	$.ajax({		
		type: 'POST',
		url: UrlSite + 'telas/cadcta/fatca_crs_pf/manter_rotina.php', 		
		data: {
			nrcpfcgc: 			  nrcpfcgc,
...
function controlaLayout() {	
	...
	$('#divConteudoOpcao').hide(0, function() {
		...
		cNmlogradouro.addClass('alphanum').css('width','290');
...
function validaPais(campo){
	...
	$.ajax({		
		type: 'POST',
		dataType: 'html',
		url: UrlSite + 'telas/cadcta/fatca_crs_pf/valida_pais.php', 
		data: {
			cdpais: cdpais,
			redirect: "html_ajax"
		},  
