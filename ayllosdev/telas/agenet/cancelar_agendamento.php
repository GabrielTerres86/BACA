<?php
	...
	function validaDados(){
		...
		IF($GLOBALS["nrdconta"] == 0 ){ 
			exibirErro('error','Conta inv&acute;lida.','Alerta - Ayllos','focaCampoErro(\'btVoltar\',\'divBotoes\');',false);
		}
			
		IF($GLOBALS["dtmvtolt"] == "" ){ 
			exibirErro('error','Data do agendamento inv&acute;lida.','Alerta - Ayllos','focaCampoErro(\'btVoltar\',\'divBotoes\');',false);
		}

		IF($GLOBALS["nrdocmto"] == 0 ){ 
			exibirErro('error','N&uacute;mero do documento inv&acute;lido.','Alerta - Ayllos','focaCampoErro(\'btVoltar\',\'divBotoes\');',false);
		}
