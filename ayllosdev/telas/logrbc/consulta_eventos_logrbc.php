...
<?
	...
	$dtmvtolt  = $xmlObjeto->roottag->tags[0]->attributes['DTMVTOLT'];
	$idopreto  = $xmlObjeto->roottag->tags[0]->attributes['IDOPRETO'];
	$qtarquiv  = $xmlObjeto->roottag->tags[0]->attributes['QTARQUIV'];
	$lsarquiv  = $xmlObjeto->roottag->tags[0]->attributes['LSARQUIV'];
	...
	$eventos 	= $xmlObjeto->roottag->tags[0]->tags;
	...
	if ($idopreto == "M") {
		...
		$arrayArq = split(',',str_replace('nbsp','&nbsp;',$lsarquiv));
