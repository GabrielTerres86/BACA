...
<form id="frmCab" name="frmCab" class="formulario cabecalho" onSubmit="return false;" style="display:none">
	...
	<div id="divConsulta">
		...
		<label for="idpenden"><? echo utf8ToHtml('Pendentes:') ?></label>
	...
	<div id="divEventos">
	    ...
	    <div id="divCab" style="display:none">
			<label for="lsarquiv1"><? echo utf8ToHtml('Envio &nbsp;&nbsp; &nbsp; &nbsp; Retorno &nbsp;&nbsp; &nbsp; Devolu&ccedil;&atilde;o') ?></label>
			<br />
			<br />
		</div>
		<label for="tpremess"><? echo utf8ToHtml('Bureaux:') ?></label>
		<input name="tpremess" id="tpremess" type="text" value="" />

		<label for="dtremess"><? echo utf8ToHtml('Data:') ?></label>
		<input name="dtremess" id="dtremess" type="text" value="" autocomplete="off" />

		<div id="divArquivos" style="display:none">
			<label for="lsarquiv"><? echo utf8ToHtml('Remessa:') ?></label>
		...
		<div id="divArquivosCancel" style="display:none">
			<label for="lsarqcan"><? echo utf8ToHtml('Remessa:') ?></label>
		...
		<div id="divCancelamento">
			<br /><br /><br />
			<label for="dscancel"><? echo utf8ToHtml('Motivo do Cancelamento:') ?></label>
