<? 
/*!
 * FONTE        : consultar_historicos_outros.php
...
<?
	...
	echo "$('a.paginacaoAnt').unbind('click').bind('click', function() { consultarHistoricosOutros('".($nriniseq - $nrregist)."',true);});";
	echo "$('a.paginacaoProx').unbind('click').bind('click', function() { consultarHistoricosOutros('".($nriniseq + $nrregist)."',true);});";
