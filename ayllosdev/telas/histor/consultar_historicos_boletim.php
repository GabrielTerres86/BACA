<? 
/*!
 * FONTE        : consultar_historicos_boletim.php
...
<?
	...
	echo "formataTabelaHistoricos();";
	
	echo "$('#divPesquisaRodape','#divHistoricos').formataRodapePesquisa();";
	echo "$('a.paginacaoAnt').unbind('click').bind('click', function() { consultarHistoricosBoletim('".($nriniseq - $nrregist)."',true);});";
	echo "$('a.paginacaoProx').unbind('click').bind('click', function() { consultarHistoricosBoletim('".($nriniseq + $nrregist)."',true);});";
