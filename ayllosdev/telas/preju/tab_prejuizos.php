	...
	<fieldset>
		...
		<div id="divEstornos" class="divRegistros">
			<table width="100%">
				...
				?>
					<tr>
						<td><? echo getByTagName($oEstorno->tags,'dtprejuz') ?></td>
						...
						<td><? echo getByTagName($oEstorno->tags,'idtipo') ?>&nbsp;-&nbsp;
							<? echo getByTagName($oEstorno->tags,'dstipo') ?>
						</td>
						<td>
							<input type="hidden" id="nrdconta1" name="nrdconta1" value="<? echo getByTagName($oEstorno->tags,'nrdconta') ?>" />
							<input type="hidden" id="nrctremp1" name="nrctremp1" value="<? echo getByTagName($oEstorno->tags,'nrctremp') ?>" />
							<a href="#" class="botao" id="btEstornar" onClick="carregaTelaEstornar(<? echo getByTagName($oEstorno->tags,'nrdconta') ?>, <? echo getByTagName($oEstorno->tags,'nrctremp') ?>, 0, 0);">Estornar</a>
						</td>
					</tr>
				<?php
					}				
