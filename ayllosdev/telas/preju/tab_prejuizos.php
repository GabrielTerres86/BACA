				...
				?>
					<tr >
					  ...
					  <input type="hidden" id="nrctremp1" name="nrctremp1" value="<? echo getByTagName($oEstorno->tags,'nrctremp') ?>"/>
						<a href="#" class="botao" id="btEstornar" onClick="carregaTelaEstornar(<? echo getByTagName($oEstorno->tags,'nrdconta') ?>, <? echo getByTagName($oEstorno->tags,'nrctremp') ?>,0);">Estornar</a></td>
