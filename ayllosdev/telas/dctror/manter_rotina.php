...
<?	
	...
	//exibirErro('inform',$flprovis,'Alerta - Ayllos','',false);

	//echo 'alert("'. $flprovis . '");' ; //Chegou aqui com TRUE - 07/03/12
	...
	// Alteração - Grava-dados
	if ( $operacao == 'A26' ) {
		exibirErro('inform','Alteração efetuada com sucesso.','Alerta - Ayllos','estadoInicial();',false);
	}
		...
		if ( $aux_pedsenha == 'yes' ) {
			...
			**************************/
			...
			for ( $i = 0; $i < $total_cheques; $i++ ) {
				...
				//echo "alert('" . getByTagName($registro,'nrdconta') . "');";
				//echo "alert('I25-hist:" . getByTagName($registro,'cdhistor') . "');"; 
				//echo "alert('I25-prov:" . getByTagName($registro,'flprovis') . "');"; 
