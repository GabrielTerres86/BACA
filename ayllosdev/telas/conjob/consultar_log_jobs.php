			...
			<table>
				...
				<tbody>
					<? foreach( $registros as $log ) {    ?>
						<tr>	
							<td><? echo getByTagName($log->tags,'dscooper'); ?> </td>
							<td><? echo stringTabela(getByTagName($log->tags,'nmjob'), 35, 'maiuscula'); ?> </td>
							<td><? echo getByTagName($log->tags,'dtlog_ini'); ?> </td>
							<td><? echo getByTagName($log->tags,'dtlog_fim'); ?> </td>
							<td><? echo getByTagName($log->tags,'dsresult'); ?> </td>
							<td><? echo getByTagName($log->tags,'dtocorre'); ?> </td>
							<td><? echo getByTagName($log->tags,'dslog'); ?> </td>
						</tr>	
					<? } ?>
				</tbody>	
			</table>
