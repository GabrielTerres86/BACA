...
function formataConsulta(){
    ...
    cCb_domingo.css({'width':'23px','margin-right':'2px'});
    cCb_segunda.css({'width':'23px','margin-right':'2px'});
    cCb_terca.css({'width':'23px','margin-right':'2px'});
    cCb_quarta.css({'width':'23px','margin-right':'2px'});
    cCb_quinta.css({'width':'23px','margin-right':'2px'});
    cCb_sexta.css({'width':'23px','margin-right':'2px'});
    cCb_sabado.css({'width':'23px','margin-right':'2px'});
    cDtprox_execucao.css({'width':'75px'});
    cHrprox_execucao.css({'width':'50px'});
    cFlexecuta_feriado.css({'width':'20px'});
    cFlsaida_email.css({'width':'20px'});
    cDsdestino_email.css({'width':'200px'});
    cFlsaida_log.css({'width':'20px'});
	...
	if($('#cddopcao','#frmCabConjob').val() == 'A'){
		...
		if(cIdperiodici_execucao.val() == 'R') {
			...
			cQtintervalo.desabilitaCampo();
			cTpintervalo.desabilitaCampo();
		}
