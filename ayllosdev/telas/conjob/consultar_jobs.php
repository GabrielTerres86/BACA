...
<form id="frmConsulta" name="frmConsulta" class="formulario" style="display:none;">
	...
	<fieldset id="fsetConsulta" name="fsetConsulta" style="padding:0px; margin:0px; padding-bottom:10px;">
		...
		<input id="cb_domingo" type="checkbox" class="checkbox" <? echo $dsdias_habilitados_domingo == '1' ? 'checked' : ''; ?> />
		<input id="cb_segunda" type="checkbox" class="checkbox" <? echo $dsdias_habilitados_segunda == '1' ? 'checked' : ''; ?> />
		<input id="cb_terca" type="checkbox" class="checkbox"   <? echo $dsdias_habilitados_terca   == '1' ? 'checked' : ''; ?> />
		<input id="cb_quarta" type="checkbox" class="checkbox"  <? echo $dsdias_habilitados_quarta  == '1' ? 'checked' : ''; ?> />
		<input id="cb_quinta" type="checkbox" class="checkbox"  <? echo $dsdias_habilitados_quinta  == '1' ? 'checked' : ''; ?> />
		<input id="cb_sexta" type="checkbox" class="checkbox"   <? echo $dsdias_habilitados_sexta   == '1' ? 'checked' : ''; ?> />
		<input id="cb_sabado" type="checkbox" class="checkbox"  <? echo $dsdias_habilitados_sabado  == '1' ? 'checked' : ''; ?> />
		...
		<input type="text" id="hrprox_execucao" name="hrprox_execucao" value="<? echo getByTagName($registros,'hrprox_execucao'); ?>" />

		<label for="flexecuta_feriado">Executar em Feriados?</label>
		<input type="checkbox" id="flexecuta_feriado" name="flexecuta_feriado" class="checkbox" <? echo getByTagName($registros,'flexecuta_feriado') == 1 ? 'checked' : ''; ?> />

		<label for="lbltpaviso"><? echo utf8ToHtml('Tipo de Aviso / Saída Habilitada:') ?></label>
		<input type="checkbox" id="flsaida_email" name="flsaida_email" class="checkbox" <? echo getByTagName($registros,'flsaida_email') == 'S' ? 'checked' : ''; ?> />
		...
		<input type="checkbox" id="flsaida_log" name="flsaida_log" class="checkbox" <? echo getByTagName($registros,'flsaida_log') == 'S' ? 'checked' : ''; ?> />
