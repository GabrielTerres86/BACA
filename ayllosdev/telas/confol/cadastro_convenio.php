<?php
/*!
 * FONTE        : cadastro_convenio.php
 * CRIAÇÃO      : Andre Santos - SUPERO
 * DATA CRIAÇÃO : Maio/2015
 * OBJETIVO     : Mostrar tela de cadastro e alteracao - CONFOL
 * --------------
 * ALTERAÇÕES   :
 * --------------
 */
				    ...
				    <td>
						<table width="100%" border="0" cellspacing="0" cellpadding="0" >
							<tr>
								...
								<td class="txtBrancoBold ponteiroDrag" background="<?php echo $UrlImagens; ?>background/tit_tela_fundo.gif"> Inclus&atilde;o/edi&ccedil;&atilde;o de conv&ecirc;nio </td>
