 ...
 * OBJETIVO     : Biblioteca de funções na rotina CLIENTE FINANCEIRO da tela de CONTAS
 * --------------
 * ALTERAÇÕES   :
 * --------------
...
function acessaOpcaoAba(nrOpcoes,id,opcao,operacao) {  
	...
	$.ajax({		
		type: 'POST', 
		dataType: 'html',
		url: UrlSite + 'telas/contas/cliente_financeiro/principal.php',
		data: {
			nrdconta: nrdconta,
			idseqttl: idseqttl,
			tpregist: tpregist,
...
function imprimeFichaCadastralCF(){	
	...
	var action = UrlSite + 'telas/contas/cliente_financeiro/imp_fichacadastral.php';
