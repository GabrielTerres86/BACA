								...
								<td>
									<table border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td align="center" style="background-color: #C6C8CA;" id="imgAbaCen0"><a href="#" id="linkAba0" onClick=<? echo "acessaOpcaoAbaDados(3,0,'".$opcoesTela[0]."');"; ?> class="txtNormalBold">Endere&ccedil;o</a></td>
											<td><img src="<?php echo $UrlImagens; ?>background/mnu_nld.gif" width="4" height="21" id="imgAbaDir0"></td>
											<td width="1"></td>
											<!-- Telefones -->
											<td><img src="<?php echo $UrlImagens; ?>background/mnu_nle.gif" width="4" height="21" id="imgAbaEsq1"></td>
											<td align="center" style="background-color: #C6C8CA;" id="imgAbaCen1"><a href="#" id="linkAba1" onClick=<? echo "acessaOpcaoAbaDados(3,1,'".$opcoesTela[0]."');"; ?> class="txtNormalBold">Telefones</a></td>
											...
											<td align="center" style="background-color: #C6C8CA;" id="imgAbaCen2"><a href="#" id="linkAba2" onClick=<? echo "acessaOpcaoAbaDados(6,2,'".$opcoesTela[0]."');"; ?> class="txtNormalBold">E-mail</a></td>
