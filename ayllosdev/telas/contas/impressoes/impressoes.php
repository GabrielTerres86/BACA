<?
/*!
 * FONTE        : impressoes.php
 * CRIAÇÃO      : Gabriel Capoia (DB1)
 * DATA CRIAÇÃO : 05/05/2010 
 * OBJETIVO     : Mostra rotina de Impressões da tela de CONTAS
 *
 * ALTERACOES   : 23/07/2013 - Inclusão de tabela p/ opções de impressoes (Jean Michel).
 */	 
?>
...
<?
	...
	if ($flgAcesso == "") exibirErro('error','Seu usu&aacute;rio n&atilde;o possui permiss&atilde;o de acesso a tela de C&ocirc;njuge.','Alerta - Aimaro','');
?>

<table id="tabelaImpressoes" cellpadding="0" cellspacing="0" border="0" width="100%">
	<tr>
		<td align="center">		
			<table border="0" cellpadding="0" cellspacing="0" width="500" class="tableImp">
				<tr>
					<td>
