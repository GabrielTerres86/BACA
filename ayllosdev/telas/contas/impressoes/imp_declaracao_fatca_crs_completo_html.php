<?php
/*!
 * FONTE        : imp_declaracao_facta_crs_completo_html.php
 * CRIACAO      : Rodrigo Costa (Mouts)
 * DATA CRIACAO : 19/04/2018 
 * OBJETIVO     : Responsavel por fazer a impressao completa do documento fatca crs.
 *
 * ALTERACOES   :
 */	 
...
<?
	...
	foreach($registrosTtl as $registroTtl){
		...
		// Imprimir apenas se a flag inreportavel for S
		if ($inreportavel == 'S') {		
