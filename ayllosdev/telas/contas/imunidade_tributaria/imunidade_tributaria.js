 ...
 * OBJETIVO     : Biblioteca de funções da rotina imunidade tributaria da tela de CONTAS
 * --------------
...
var nrcpfcgc = $("#nrcpfcgc","#frmCabContas").val();
...
function acessaOpcaoAba(nrOpcoes,id,opcao) {  
	...
	$.ajax({		
		type: "POST", 
		dataType: "html",
		url: UrlSite + "telas/contas/imunidade_tributaria/principal.php",
		data: {
			cddopcao: opcao,
			nrcpfcgc: nrcpfcgc,
			flgcadas: flgcadas,
...
function manterRotina() {
	...
	$.ajax({		
		type: 'POST',	
		dataType: "html",		
		url: UrlSite + 'telas/contas/imunidade_tributaria/manter_rotina.php', 
		data: {
			nrcpfcgc: nrcpfcgc,
			cddentid: cddentid,
			cdsitcad: cdsitcad,
...
function btnImprimir() {
	...
	var action    = UrlSite + 'telas/contas/imunidade_tributaria/imprime_imunidade.php';	
