									...
									<table border="0" cellspacing="0" cellpadding="0">
										<tr style="height:22px;">
											...
											<td align="center" style="background-color: #C6C8CA; border-radius:3px;" id="imgAbaCen0">
												<a href="#" id="linkAba0" onClick=<? echo "acessaOpcaoAbaDados(6,0,'".$opcoesTela[0]."');"; ?> class="txtNormalBold">&nbsp; Identifica&ccedil;&atilde;o &nbsp; </a>
											</td>
											<td width="1px"></td>
											<!-- Responsavel Legal -->
											<td align="center" style="background-color: #C6C8CA; border-radius:3px; " id="imgAbaCen1">
												<a href="#" id="linkAba1" onClick=<? echo "acessaOpcaoAbaDados(6,1,'".$opcoesTela[0]."');"; ?> class="txtNormalBold">&nbsp; Respons&aacute;vel Legal &nbsp; </a>
											</td>
											<td width="1px"></td>
											<!-- Pessoas de Relacionamento -->
											<td align="center" style="background-color: #C6C8CA; border-radius:3px;" id="imgAbaCen2">
												<a href="#" id="linkAba2" onClick=<? echo "acessaOpcaoAbaDados(6,2,'".$opcoesTela[0]."');"; ?> class="txtNormalBold">&nbsp; Pessoas de Relacionamento &nbsp;</a>
											</td>
											<td width="1px"></td>
											<!-- Conjuge -->
											<td align="center" style="background-color: #C6C8CA;border-radius:3px;" id="imgAbaCen6">
												<a href="#" id="linkAba6" onClick=<? echo "acessaOpcaoAbaDados(6,6,'".$opcoesTela[0]."');"; ?> class="txtNormalBold">&nbsp; C&ocirc;njuge &nbsp;</a>
											</td>
											<td width="1px"></td>
										</tr>
									</table>
...
<script type="text/javascript">
	...
	acessaOpcaoAbaDados(6,0,"<? echo $opcoesTela[0]; ?>");
