<?
/*!
 * FONTE        : inclusao_grupo_economico.php
 * CRIAÇÃO      : Mauro (MOUTS)
					...
					<td>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td class="txtBrancoBold ponteiroDrag" background="<?php echo $UrlImagens; ?>background/tit_tela_fundo.gif"><?= utf8ToHtml('Incluir Grupo Econômico') ?></td>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								<td align="center" style="border: 2px solid #969FA9; background-color: #F4F3F0; padding: 2px;">
									<? require_once("form_inclusao_grupo_economico.php") ?>
								</td>
							</tr>
						</table>			    
					</td> 
