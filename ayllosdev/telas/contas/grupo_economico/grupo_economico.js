...
function solicitaExclusaoIntegrante(){
	showConfirmacao('Confirma a exclus&atilde;o do integrante?','Confirma&ccedil;&atilde;o - Aimaro','excluirIntegranteGrupoEconomico();','bloqueiaFundo(divRotina)','sim.gif','nao.gif');	
}
