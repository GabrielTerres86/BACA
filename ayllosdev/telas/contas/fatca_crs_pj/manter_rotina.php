...
<?	
	...
	if( $operacao == 'AV' ) { // Se é Validação
		...
		exibirConfirmacao('Deseja confirmar alteração?','Confirmação - Aimaro','controlaOperacao(\'VAS\')','bloqueiaFundo(divRotina)',false);
	...
	function validaDados() {
		...
		if($GLOBALS["operacao"] == 'AV' && $GLOBALS["insocio_obrigacao"] == ''){
			exibirErro('error','Favor informar o campo: Possui algum s&oacute;cio com 10% ou mais de capital e obrigac&ccedil;&atilde;o fiscal fora do Brasil?.','Alerta - Aimaro','$(\'input, select\',\'#frmDetalhes\').removeClass(\'campoErro\');focaCampoErro(\'dsnacion\',\'frmDetalhes\');',false);
		}
