<? 
/*!
 * FONTE        : formulario_fatca_crs_socio.php
 * CRIAÇÃO      : Mateus Z (Mouts)
 * DATA CRIAÇÃO : 17/04/2018 
...
<div id="divBotoes">
	...
	<input type="image" id="btSalvar"  src="<? echo $UrlImagens; ?>botoes/concluir.gif" onClick="controlaOperacao('AVS');" />
