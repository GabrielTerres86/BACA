...
<?	
	...
	$xmlResult = mensageria($xml, "TELA_FATCA_CRS", "BUSCA_DADOS_SOCIO_FATCA_CRS", $glbvars["cdcooper"], $glbvars["cdagenci"], $glbvars["nrdcaixa"], $glbvars["idorigem"], $glbvars["cdoperad"], "</Root>");
	$xmlObj    = getObjectXML($xmlResult);
	...
	if ($operacao == 'CAS') {
		include('formulario_fatca_crs_socio.php');
	} else {
