...
$linha = '|'.preencheString('DECLARAÇÃO DE ISENÇÃO',74,' ','C').'|';
escreveLinha( $linha );

escreveLinha( '+--------------------------------------------------------------------------+' );
//**********************************************************IDENTIFICACAO**********************************************************

$GLOBALS['titulo'] = 'DECLARAÇÃO DE ISENÇÃO';
escreveLinha( ' ' );
escreveLinha( ' ' );
...
$linha = preencheString('com sede '.getByTagName($identificacao,'dsendweb'),76, '.');
escreveLinha( $linha );
...
$linha = preencheString( 'b) que o(a) signatário é representante legal desta entidade, assumindo o ' ,76);
escreveLinha( $linha );
