...
<script type="text/javascript">
	...
	if ( msgConta != '' && operacao == 'SC' ){
		showError('inform',msgConta,'Alerta - Ayllos','bloqueiaFundo(divRotina);controlaFocoDependentes(\''+operacao+'\');'); 
	}else if ( msgAlert != ''   ){ 
		showError('inform',msgAlert,'Alerta - Ayllos','bloqueiaFundo(divRotina);controlaFocoDependentes(\''+operacao+'\');'); 
	}
