...
function mostraSenha() {
	...
	$.ajax({		
		type: 'POST',		
		dataType: 'html',
		url: UrlSite + 'telas/contas/conta_corrente/senha.php', 
		data: {
			redirect: 'html_ajax'			
			}, 
		error: function(objAjax,responseError,objExcept) {
...
function buscaSenha() {
	...
	$.ajax({		
		type: 'POST',		
		dataType: 'html',
		url: UrlSite + 'telas/contas/conta_corrente/form_senha.php', 
		data: {
			redirect: 'script_ajax'			
			}, 
		error: function(objAjax,responseError,objExcept) {
...
function validarSenha() {
	...
	$.ajax({		
			type  : 'POST',
			async : false ,
			url   : UrlSite + 'telas/contas/conta_corrente/valida_senha.php', 		
			data: {                
				operauto	: operauto,		
				codsenha	: codsenha,
				redirect	: 'script_ajax'
...
function btnVoltar(){
	...
	if (flgdevolu_autom == 1){ 
		$("#flgdevolu_automOp1").attr('checked', true);
	}else{ 
	    $("#flgdevolu_automOp2").attr('checked', true);		
	}	
