 ...
 * 009: [20/07/2016] Kelvin 	  (CECRED): Ajuste para não mostrar zero no campo de nr da licença SD 449299
 */
?>
...
<form name="frmDadosIdentJuridica" id="frmDadosIdentJuridica" class="formulario">		
	...
	<input name="nrlicamb" id="nrlicamb" type="text" class="pesquisa" maxlength="15" value="<? echo getByTagName($identificacao,'nrlicamb') == 0 ? '' : getByTagName($identificacao,'nrlicamb') ?>" />
	<br />
