 ...
 * OBJETIVO     : Mostra rotina de Registro da tela de CONTAS
 *
					...
					<td>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td class="txtBrancoBold ponteiroDrag" background="<?php echo $UrlImagens; ?>background/tit_tela_fundo.gif">REGISTRO</td>
...
<script type="text/javascript">
	...
	if (flgcadas == 'M') { // Se vem do cadastro da MATRIC
		controlaOperacao('CA');
	} else {
