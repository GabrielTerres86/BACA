									...
									<table border="0" cellspacing="0" cellpadding="0">
										<tr style="height:22px;">
											...
											<td align="center" style="background-color: #C6C8CA; border-radius: 3px;" 
												...
												onClick=<? echo "acessaOpcaoAbaDados(3,0,'".$opcoesTela[0]."');"; ?> 
											...
											<td align="center" style="background-color: #C6C8CA; border-radius: 3px;" id="imgAbaCen2">
												<a href="#" 
												   id="linkAba2" 
												   onClick="acessaOpcaoAbaDados(3,2,'<?php echo ($flgcadas == 'M')? 'A' : $opcoesTela[0]?>')"
											...
											<td align="center" style="background-color: #C6C8CA; border-radius: 3px;" 
												...
												onClick=<? echo "acessaOpcaoAbaDados(3,1,'".$opcoesTela[0]."');"; ?> 
...
<script type="text/javascript">
	...
	acessaOpcaoAbaDados(3,0,"<? echo $opcoesTela[0]; ?>");
</script>