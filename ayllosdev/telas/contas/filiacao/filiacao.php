 ...
 * ALTERAÇÕES   :
 * --------------
 * 001: [02/04/2010] Rodolpho Telmo  (DB1): Adequação da tela ao novo padrão
					...
					<td>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td class="txtBrancoBold ponteiroDrag" background="<?php echo $UrlImagens; ?>background/tit_tela_fundo.gif">FILIAÇÃO</td>
