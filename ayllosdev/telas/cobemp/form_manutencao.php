...
<form id="frmManutencao" name="frmManutencao" class="formulario" onSubmit="return false;" >
    ...
    <label for="dtemissi"><?php echo utf8ToHtml('Data Emiss&atilde;o De:') ?></label>
    <input type="text" id="dtemissi" name="dtemissi" />	
    <label for="dtemissf"><?php echo utf8ToHtml('Ate:') ?></label>
    ...
    <label for="dtvencti"><?php echo utf8ToHtml('Data Vencimento De:') ?></label>
    <input type="text" id="dtvencti" name="dtvencti" />	
    <label for="dtvenctf"><?php echo utf8ToHtml('Ate:') ?></label>
    <input type="text" id="dtvenctf" name="dtvenctf" />	

    <br style="clear:both" />

    <label for="dtbaixai"><?php echo utf8ToHtml('Data Baixa De:') ?></label>
    <input type="text" id="dtbaixai" name="dtbaixai" />	
    <label for="dtbaixaf"><?php echo utf8ToHtml('Ate:') ?></label>
    <input type="text" id="dtbaixaf" name="dtbaixaf" />	

    <label for="dtpagtoi"><?php echo utf8ToHtml('Data Pagamento De:') ?></label>
    <input type="text" id="dtpagtoi" name="dtpagtoi" />	
    <label for="dtpagtof"><?php echo utf8ToHtml('Ate:') ?></label>
