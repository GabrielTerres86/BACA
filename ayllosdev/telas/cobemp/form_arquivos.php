...
<div id="divBotoesfrmArquivos" style="display:none; margin-bottom: 15px; text-align:center; margin-top: 15px;" >
    ...
    <a href="#" class="botao" id="btImprimir" onClick="btnVoltar(); return false;">Imprimir</a>
    <a href="#" class="botao" id="btBaixar"   onClick="abreImportacao(); return false;" style="margin-left: 30px;">Importar Arquivo</a>
    <a href="#" class="botao" id="btEmails"   onClick="btnVoltar(); return false;">Gerar Boletos</a>
</div>