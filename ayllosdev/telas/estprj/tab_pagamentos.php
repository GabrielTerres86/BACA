				...
				?>
					<tr>
						...
						<td>
							...
							<a href="#" class="botao" id="btEstornar" onClick="carregaTelaEstornar(<? echo getByTagName($oEstorno->tags,'nrdconta') ?>, <? echo getByTagName($oEstorno->tags,'nrctremp') ?>,'<? echo getByTagName($oEstorno->tags,'dtpagto') ?>','<? echo getByTagName($oEstorno->tags,'idtipo') ?>', '0');">Estornar</a>
						</td>
					</tr>
				<?php
					}
