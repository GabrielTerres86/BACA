...
<form id="frmOpcaoI" name="frmOpcaoI" class="formulario" style="display:block;">
	...
	<input name="idpacote" id="idpacote" class="registroinput" type="text" style="margin-right: 5px" />
	...
	<input name="cdtarifa" id="cdtarifa" class="registroinput" type="text" style="margin-right: 5px" onchange="FormularioPacote.calcularTarifa();" />
    ...
    <select id="inpessoa" name="inpessoa" style="width:115px" >                      
	...
	<input name="vlsms" id="vlsms" class="registroinput" type="text" style="margin-right: 5px" />    

    <br style="clear:both" />	   

    <label for="vlsmsad" class="labelNomeParametro"><? echo utf8ToHtml('Valor da SMS/Adicional:') ?></label>                        
	<input name="vlsmsad" id="vlsmsad" class="registroinput" type="text" style="margin-right: 5px" /> 

    <br style="clear:both" />	   

    <label for="vlpacote" class="labelNomeParametro"><? echo utf8ToHtml('Valor do Pacote:') ?></label>                        
	<input name="vlpacote" id="vlpacote" class="registroinput" type="text" style="margin-right: 5px" />           
