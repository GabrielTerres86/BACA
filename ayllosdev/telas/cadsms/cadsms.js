 ...
 * OBJETIVO     : Biblioteca de fun��es da tela CADSMS
 * --------------
 * ALTERA��ES   : 
 *								 
 *				  
...
function FormularioPacote() {
    ...
    var formatarCamposNumericos = function() {
        ...
        $("#idpacote").setMask('INTEGER', 'zzzzzzzz', '', '');
    }
...
function estadoInicial() {
    ...
    // habilita foco no formul�rio inicial
...
// Fun��o para buscar anota��es do associado
