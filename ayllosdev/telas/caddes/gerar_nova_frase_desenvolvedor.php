<? 
/*!
 * FONTE        : gerar_nova_frase_desenvolvedor.php
 * CRIAÇÃO      : Andrey Formigari - Supero
 * DATA CRIAÇÃO : Fevereiro/2019
 * OBJETIVO     : Gerar Frase para o Desenvolvedor.
 */
...
$xmlResult = mensageria($xml, "CADDES", "ALTERA_FRASE_DESENVOLVEDOR", $glbvars["cdcooper"], $glbvars["cdagenci"], $glbvars["nrdcaixa"], $glbvars["idorigem"], $glbvars["cdoperad"], "</Root>");
...
exibirErro('inform','Nova frase gerada com sucesso.','Alerta - Aimaro','$(\'#dsfrase\',\'#frmFraseDesenvolvedor\').val(\''.$dsfrase.'\');',false);
