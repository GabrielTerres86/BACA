<? 
/*!
 * FONTE        : enviar_chave_email.php
 * CRIAÇÃO      : Andrey Formigari - Supero
 * DATA CRIAÇÃO : Fevereiro/2019
 * OBJETIVO     : Enviar chave do desenvolvedor por e-mail.
 */
...
$xmlResult = mensageria($xml, "CADDES", "ENVIA_UUID_DESENVOLVEDOR", $glbvars["cdcooper"], $glbvars["cdagenci"], $glbvars["nrdcaixa"], $glbvars["idorigem"], $glbvars["cdoperad"], "</Root>");
...
exibirErro('inform','E-mail enviado com sucesso.','Alerta - Aimaro','',false);