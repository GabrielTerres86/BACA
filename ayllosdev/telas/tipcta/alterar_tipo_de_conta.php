 ...
 * ********************************************************************* */
    ...
    $xmlResult = mensageria($xml, "TELA_TIPCTA", "ALTERAR_TIPO_DE_CONTA", $glbvars["cdcooper"], $glbvars["cdagenci"], $glbvars["nrdcaixa"], $glbvars["idorigem"], $glbvars["cdoperad"], "</Root>");
	...
	exibirErro('inform','Tipo de Conta alterado com sucesso.','Alerta - Ayllos','$(\"#cddopcao\", \"#frmCab\").val(\"C\");mostrarConteudo('.$inpessoa.','.$cdtipo_conta.');', false);
