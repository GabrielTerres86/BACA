...
/*!
 * FONTE        : titular.php
 * CRIAÇÃO      : Gabriel Capoia - DB1 Informática
 * DATA CRIAÇÃO : 21/01/2013
 * OBJETIVO     : Tela de selação do titular
 */	 
?>
					...
					<td>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td class="txtBrancoBold ponteiroDrag" background="<?php echo $UrlImagens; ?>background/tit_tela_fundo.gif"><? echo utf8ToHtml('TITULAR') ?></td>
