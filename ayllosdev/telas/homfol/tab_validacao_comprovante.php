...
<div id="dadosEmpresa" style="display:block">	
		...
		<table >
			...
			<tr>
				...
				<td colspan="3">
					<input name="nmagenci" type="text"  id="nmagenci" class='campoTelaSemBorda' size="100" value="<? echo $nmagenci; ?>"  readOnly />
				</td>
			</tr>
			<tr>
				<td width="160px" class="txtNormalBold" style="text-align:right;">
				...
				<td>
					<input name="nmconspj" type="text"  id="nmconspj" class='campoTelaSemBorda' size="35" value="<? echo $nmconspj; ?>"  readOnly />
				</td>
			</tr>
		</table>
		</fieldset>	
