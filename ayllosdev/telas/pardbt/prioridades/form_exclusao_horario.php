 ...
 */	  
    ...
    $xmlResult = mensageria($xml, "DEBITADOR_UNICO", "DEBITADOR_PR_BUSCA_HOR_EXC", 
						...
						<td>
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<td class="txtBrancoBold ponteiroDrag" background="<?php echo $UrlImagens; ?>background/tit_tela_fundo.gif">Excluir</td>
										...
										<div id="divConteudoOpcao">
											<form name="frmDet" id="frmDet" class="formulario condensado">
												...
												<fieldset style="text-align: left; padding: 10px;">
													<legend><?php echo utf8ToHtml('Remover horÃ¡rio(s)'); ?></legend>
                                                    ...
                                                    ?>
                                                        <tr>	
                                                        	<td><input type="hidden" value="<?php echo getByTagName($horario->tags, 'idhora_processamento');?>"><input type="checkbox" class="checkboxDelHorario">&nbsp;&nbsp;<?php echo getByTagName($horario->tags, 'dhprocessamento');?> </td>
                                                        </tr>
                                                    <?php
                                                    } 	
                                                    ?>
												...
												<div id="divBotoes">													                                        
													<a href="javascript:;" class="botao" style="width:65px;" id="btGravar" onClick="excluirHorariosProc();">Excluir</a>
