 ...
 * CRIA플O       : Leticia Terres (AMcom)
 * DATA CRIA플O : 17/01/2018
										...
										<div id="divConteudoOpcao">
											<form name="frmDet" id="frmDet" class="formulario condensado">
												...
												<fieldset style="text-align: left; padding: 10px;">
													<legend><?php echo utf8ToHtml('Adicionar horário'); ?></legend>
													...
													<label for="idhora_processamento" style="width: 120px;"><?php echo utf8ToHtml('Horário:');?></label>
...
<script type="text/javascript">
	...
	// Bloqueia conte?ºdo que est?¡ ?¡tras do div da rotina
