<?
/*!
 * FONTE        : form_tipo_declarado.php
 * CRIAÇÃO      : Mateus Zimmermann - Mouts
 * DATA CRIAÇÃO : 02/05/2018
 * OBJETIVO     : Tela para inclusão/alteração do tipo declarado
 * ALTERAÇÕES   : 
 */	 
?>
					...
					<td>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td class="txtBrancoBold ponteiroDrag" background="<?php echo $UrlImagens; ?>background/tit_tela_fundo.gif">Tipo Declarado</td>
							...
							<tr>
								<td align="center" style="border: 2px solid #969FA9; background-color: #F4F3F0; padding: 2px;">
									...
									<form id="frmTipoDeclarado" name="frmTipoDeclarado" class="formulario">
										...
										<label for="inexige_proprietario"><? echo utf8ToHtml('Digita Proprietário'); ?></label>
										<select id="inexige_proprietario" name="inexige_proprietario">
											<option value="S" <? echo $inexige_proprietario == 'S' ? 'selected' : '' ?> >Sim</option>
											<option value="N" <? echo $inexige_proprietario == 'N' ? 'selected' : '' ?> ><? echo utf8ToHtml('Não'); ?></option>
										</select>
									...
									<div id="divBotoes" style="margin-bottom:10px">
										...
										<? if( $cddopcao == 'A'){ ?>
											<a href="#" class="botao" id="btSalvar" onclick="manterRotina('AD'); return false;">Concluir</a>
										<? } else { ?>
											<a href="#" class="botao" id="btSalvar" onclick="manterRotina('ID'); return false;">Concluir</a>
										<? } ?>	
									</div>
