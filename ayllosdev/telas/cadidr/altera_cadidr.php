<?
/*!
 * FONTE        	: altera_cadidr.php
 * CRIAÇÃO      	: Lucas Reinert
 * DATA CRIAÇÃO 	: Fevereiro/2016
 * OBJETIVO     	: Alterar novo indicador/vinculação de reciprocidade
 * ÚLTIMA ALTERAÇÃO : --/--/----
 * --------------
 * ALTERAÇÕES   	: 
 * --------------
...
if ($idaba === 1) {
	...
	$xmlResult = mensageria($xml, "TELA_CADIDR", "ALTERA_VINCULACAO", $glbvars["cdcooper"], $glbvars["cdagenci"], $glbvars["nrdcaixa"], $glbvars["idorigem"], $glbvars["cdoperad"], "</Root>");
	...
	$xmlResult = mensageria($xml, "TELA_CADIDR", "ALTERA_IND", $glbvars["cdcooper"], $glbvars["cdagenci"], $glbvars["nrdcaixa"], $glbvars["idorigem"], $glbvars["cdoperad"], "</Root>");
	$xmlObj = getObjectXML($xmlResult);
}
...
if ( strtoupper($xmlObj->roottag->tags[0]->name) == 'ERRO' ) {
	...
	echo "showError('inform', 'Registro atualizado com sucesso!', 'Alerta - Ayllos', 'trocaVisao(\'\');');";
}
