<?php
	 ...
	 * OBJETIVO     : Rotina para buscar os motivos de saque parcial
	 * --------------
	 * ALTERAÇÕES   : 
	 * -------------- 
	 */		
	...
	$xmlResult = mensageria($xml, "TELA_CADMSP", "BUSCA_MOTIVOS_SP", $glbvars["cdcooper"], $glbvars["cdagenci"], $glbvars["nrdcaixa"], $glbvars["idorigem"], $glbvars["cdoperad"], "</Root>");
		...
		<tbody>
			...
			?>
				<tr style="text-align: center !important">
					<td>Motivos n&atilde;o cadastrados</td>
				</tr>
			<?
			}else{
