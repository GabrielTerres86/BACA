...
<form name="frmNovaProp" id="frmNovaProp" class="formulario condensado">	
	...
	<fieldset>
		<legend>Nova Proposta de <? echo utf8ToHtml('Empr̩stimo') ?></legend>
...
<div id="divBotoes">
	...
	<? } else if ($operacao == 'TI' || $operacao == 'I_INICIO' ) { 
	    ...
	    //Se esta tela foi chamada atrav̩s da rotina "Produtos" enṭo ao clicar em voltar deve retornar diretamente para a tela de Produtos
