	...
	if (in_array($operacao,array('A_NOVA_PROP','A_NUMERO','A_VALOR','A_AVALISTA','TI','TE','TC',''))) {
		...
		if ($operacao == "TI") {
			...
			if (strtoupper($xmlObj->roottag->tags[0]->name) == "ERRO") { 
				exibirErro('inform','Conta n&atilde;o permite empr&eacute;stimo. Permitido apenas inclus&atilde;o de propostas de CDC, empr&eacute;stimo consignado e linhas 100, 800, 900 e 6901.','Alerta - Ayllos',"bloqueiaFundo(divRotina);",true);
			}
		}
