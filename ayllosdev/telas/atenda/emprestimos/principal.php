...
<?
	...
	$procedure = (in_array($operacao,array('A_NOVA_PROP','A_VALOR','A_NUMERO','TE','TI','TC'))) ? 'obtem-dados-proposta-emprestimo' : 'obtem-propostas-emprestimo';

	if (in_array($operacao,array('A_NOVA_PROP','A_NUMERO','A_VALOR','TI','TE','TC',''))) {
		...
		}else if (in_array($operacao,array('A_NOVA_PROP','A_VALOR','A_NUMERO','TE','TI','TC'))){
...
<?
	...
	} else if(in_array($operacao,array('A_INICIO','I_INICIO','A_FINALIZA','I_FINALIZA','A_NOVA_PROP','A_VALOR','A_NUMERO','I_CONTRATO','TI','TE','TC','CF'))) {
