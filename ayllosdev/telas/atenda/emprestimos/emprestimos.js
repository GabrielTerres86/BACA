 ...
 * 099: [16/01/2018] Inclu�do novo campo em Empr�stimos (Qualif Oper. Controle) (Diego Simas - AMcom)
 * ##############################################################################
...
function manterRotina(operacao) {
    ...
    // Inclus�o de novo campo Qualif. Oper. Controle
    ...
    $.ajax({
        ...
        data: {
            ...
            //Inclus�o novo campo Qualif. Oper. Controle 
            idquaprc: idquaprc, 
...
function controlaLayout(operacao) {
    ...
    if (in_array(operacao, ['AT', 'IT', 'FI', 'FA', 'FE', 'SC', ''])) {
        ...
        // Inclus�o do campo (Qualif. Oper. Controle)
...
function copiaProposta(novaOp) {
    ...
    // Inclus�o campo (Qualif. Oper. Controle)
