 ...
 * 076: [01/02/2016] Ajustado para recarregar o campo tipo emprestimo com a opcao selecionada com operacao for VI (Tiago/Gielow SD384504)
 * ##############################################################################
...
function controlaOperacao(operacao) {
    ...
    if (in_array(operacao, ['TA', 'TE', 'TC', 'A_NOVA_PROP', 'A_NUMERO', 'A_VALOR', 'IMP', 'REG_GRAVAMES', 'VAL_GRAVAMES', 'PORTAB_CRED_C', 'VAL_RECALCULAR_EMPRESTIMO','RECALCULAR_EMPRESTIMO', 'PORTAB_CRED_A', 'PORTAB_CRED_I'])) {
...
function controlaLayout(operacao) {
    ...
    if (in_array(operacao, ['AT', 'IT', 'FI', 'FA', 'FE', 'SC', ''])) {
    ...
    } else if (in_array(operacao, ['TI', 'TE', 'TC', 'TA', 'CF', 'A_NOVA_PROP', 'A_NUMERO', 'I_CONTRATO', 'I_FINALIZA', 'A_FINALIZA', 'I_INICIO', 'A_INICIO', 'A_VALOR'])) {
        ...
        if (in_array(operacao, ['TI', 'I_INICIO', 'A_VALOR', 'A_NOVA_PROP', 'A_INICIO', 'TC', 'CF'])) {
        ...
        if (in_array(operacao, ['TI', 'TE', 'TC', 'TA', 'CF', 'A_NOVA_PROP', 'A_NUMERO', 'A_VALOR', 'I_CONTRATO', 'A_FINALIZA', 'A_INICIO', 'I_INICIO'])) {
...
function attArray(novaOp, cdcooper) {
    ...
    if (in_array(operacao, ['TI', 'TA', 'A_NOVA_PROP', 'A_VALOR', 'I_INICIO', 'A_INICIO', 'I_PARCELAS'])) {
...
function atualizaTela() {
    ...
    if (in_array(operacao, ['TI', 'TE', 'TC', 'TA', 'CF', 'A_NOVA_PROP', 'A_NUMERO', 'A_VALOR', 'I_CONTRATO', 'I_FINALIZA', 'A_FINALIZA', 'A_INICIO', 'I_INICIO'])) {
...
function validaDados(cdcooper) {
    ...
    if (in_array(operacao, ['TA', 'A_NOVA_PROP', 'A_INICIO', 'A_VALOR', 'TI', 'I_INICIO'])) {
...
function controlaLayoutLiq(operacao) {
    ...
    for (var i in arrayLiquidacoes) {
        ...
        if (arrayLiquidacoes[i]['tpemprst'] == 0) {
            aux_tpemprst = 'TR';
        } else {
            aux_tpemprst = 'PP';
        }
...
function controlaPesquisas() {
    ...
    var campoAnterior = '';
    var nomeCampo = '';
    var bo, procedure, titulo, qtReg, filtros, colunas, varAux, varMod, nrtopico, nritetop;
        ...
        $(this).unbind('click').bind('click', function() {
            ...
            if ($(this).prev().hasClass('campoTelaSemBorda')) {
                ...
                if (campoAnterior == 'dsnacion') {
                    ...
                    filtros = 'C&oacuted. Linha Cr&eacutedito;cdlcremp;30px;S;0|Descri&ccedil&atildeo;dslcremp;200px;S|;' + null + ';;N;;N|;' + null + ';;N;;N|;' + null + ';;N;;N|;cdfinemp;;;' + varAux + ';N|;cdmodali;;;' + varMod + ';N|;flgstlcr;;;yes;N';
...
function efetuar_consultas(insolici) {
