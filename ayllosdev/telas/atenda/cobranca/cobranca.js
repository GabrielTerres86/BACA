/***********************************************************************
      Fonte: cobranca.js
      Autor: Gabriel
      Data : Dezembro/2010             Ultima atualizacao : 18/02/2016
...
function verificaSenhaCoordenador() {
    ...
    var tot_percdesc_banco = $('#tot_percdesc','#frmConsulta').val();
    ...
    // Se foi alterado o valor
    if (tot_percdesc_campo != tot_percdesc_banco) {
        flsolicita = true;
    }

    // Solicitar senha do coordenador
    if (flgapvco == 1 && flsolicita) {
