<?php
	 ...
	 *               
	 *                04/05/2018 - Iclusão de novos campos e funcionalidades 
...
<form name="frmConvenioCdc" id="frmConvenioCdc" class="formulario">
    ...
    <fieldset style="padding: 5px">
			...
			<br/>  
				<label for="idcomissao">Comissão:</label>
        <input type="text" id="idcomissao" name="idcomissao" value="<?php echo $idcomissao; ?>"  class="clsCampos"/>
				<a><img src="<? echo $UrlImagens; ?>geral/ico_lupa.gif"></a>	
				<input type="text" id="dscomissao" name="dscomissao" class="clsCampos" value="<?php echo $dscomissao; ?>" />	
			<br/>      
