...
function manterRotina(operacao) {
	...
	console.log('normalizaNumero(idcomissao) -> ' + normalizaNumero(idcomissao));
...
function controlaLayout(operacao) {
	...
	var cDscomissao = $('#dscomissao', '#frmConvenioCdc');
	...
	//rFlgconve.css('width','0px');		
	rDtinicon.css('width', '69px');
	rInmotcan.css('width', '134px');
	rDtcancon.css('width', '173px');
	rDsmotcan.css('width', '134px');
	rDtrencon.css('width', '173px');
	rDttercon.css('width', '420px');
	...
	cDtacectr.addClass('campo').addClass('data').css({ 'width': '85px' });	
	...
	cIdcomissao.addClass('campo pesquisa').css({ 'width': '60px' }).attr('maxlength', '10');
	cDscomissao.addClass('campo').css({ 'width': '287px' }).attr('maxlength', '200');
	...
	cDtacectr.unbind('keypress').bind('keypress', function (e) {
		if (e.keyCode == 9 || e.keyCode == 13) {
			cNmfantasia.focus();
			return false;
		}
		...
		$(this).unbind("click").bind("click", (function () {
			if ($(this).prev().hasClass('campoTelaSemBorda')) {
				...
				if (campoAnterior == 'cdcnae') {
					...
					var idcomissao = $('#idcomissao', '#frmConvenioCdc').val();
    				var dscomissao = $('#dscomissao', '#frmConvenioCdc').val();

					pck = 'zoom0001';
					acao = 'BUSCA_REGRA_COMISSAO';
					titulo = 'Comiss&atildeo';
					qtReg = '';
					filtros = 'C&oacuted. Comiss&atildeo;idcomissao;30px;S;' + idcomissao + ';S|Comiss&atildeo;dscomissao;200px;S;' + dscomissao + ';S';
					colunas = 'C&oacuted. Comiss&atildeo;idcomissao;20%;center' +
							  '|Comiss&atildeo;dscomissao;48%;left'+
							  '|Valor Inicial;vlinicial;15%;left'+
							  '|Valor Final;vlfinal;15%;left'+
							  '|Valor Comiss&atildeo;vlcomissao;15%;left';
