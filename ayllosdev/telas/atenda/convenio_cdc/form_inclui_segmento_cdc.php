 ...
 * OBJETIVO     : Formulário para inclusão de Segmentos de Convenio CDC da tela de CONTAS 
 * --------------
 * ALTERAÇÕES   : 
 * --------------
 */	 
...
<div id="divBotoes">	
	<input type="image" id="btVoltar" src="<? echo $UrlImagens; ?>botoes/cancelar.gif" onClick="controlaOperacao('SCI'); return false;" />
