<?php 
	...
	// Confirma operação
	echo 'showConfirmacao("Deseja suspender a poupan&ccedil;a programada?","Confirma&ccedil;&atilde;o - Ayllos","suspenderAplicacao('.$nrmesusp.')","blockBackground(parseInt($(\'#divRotina\').css(\'z-index\')))","sim.gif","nao.gif");';	
