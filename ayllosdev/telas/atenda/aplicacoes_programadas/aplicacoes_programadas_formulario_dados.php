...
<div id="divDadosPoupanca">
	<form action="" class="condensado" method="post" name="frmDadosPoupanca" id="frmDadosPoupanca">
		<fieldset>
			...
			<label for="dtvctopp"><? echo utf8ToHtml('Vencimento:') ?></label>
			<input name="dtvctopp" type="text" class="campoTelaSemBorda" id="dtvctopp" value="<?php echo $poupanca[5]->cdata; ?>" readonly>
...
var width = "290px";
<?php } else { ?>
var width = "<?php if (trim($poupanca[23]->cdata) <> "") { echo "290px"; } else { echo "265px"; } ?>";
<?php } ?>
