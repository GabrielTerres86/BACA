...
function acessaOpcaoAba(nrOpcoes, id, opcao) {
	...
	$.ajax({
		type: "POST", 
		dataType: "html",
		url: UrlSite + "telas/atenda/cartao_credito_prod/principal.php",
		data: {
			nrdconta: nrdconta,
			inpessoa: inpessoa,
...
function validarAvalistas(tipoacao) {
	...
	$.ajax({		
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/avalistas_validadados.php",
		data: {
...
function opcaoNovo(cdcooper) {	
	...
	$.ajax({		
		type: "POST", 
		dataType: "html",
		url: UrlSite + "telas/atenda/cartao_credito_prod/novo.php",
		data: {
			nrdconta: nrdconta,
			inpessoa: inpessoa,
			redirect: "html_ajax"
...
function validarNovoCartao() {
	...
	$.ajax({
		type: "POST",
		url: UrlSite + "telas/atenda/cartao_credito_prod/validar_novo.php",
		data: {
			nrdconta: nrdconta,
			inpessoa: inpessoa,
			dsgraupr: dsgraupr,
...
function cadastrarNovoCartao() {
	...
	$.ajax({
		type: 'POST',
		url: UrlSite + 'telas/atenda/cartao_credito_prod/cadastrar_novo_cartao.php',
		data: {
...
function opcaoImprimir() {
	...
	$.ajax({		
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/imprimir.php",
		dataType: "html",
		data: {
			cdadmcrd: cdadmcrd,
			inpessoa: inpessoa,
...
function consultaCartao() {
	...
	$.ajax({		
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/consultar_dados_cartao.php",
		dataType: "html",
		data: {
			nrdconta: nrdconta,
			nrctrcrd: nrctrcrd,
...
function mostraAvais() {
	...
	$.ajax({		
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/consultar_dados_cartao_avais.php",
		dataType: "html",
		data: {
			nrdconta: nrdconta,
			nrctrcrd: nrctrcrd,
...
function mostraUltDebitos() {
	...
	$.ajax({		
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/consultar_dados_cartao_ultimos_debitos.php",
		dataType: "html",
		data: {
			nrdconta: nrdconta,
...
function opcaoLiberar() {
	...
	$.ajax({		
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/liberar.php",
		dataType: "html",
		data: {
			nrdconta: nrdconta,
			cdadmcrd: cdadmcrd,
...
function liberacaoCartao(idconfir) {
	...
	$.ajax({		
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/liberar_liberacao.php",
		dataType: "html",
		data: {
			nrdconta: nrdconta,
			nrctrcrd: nrctrcrd,
...
function desfazLiberacaoCartao() {
	...
	$.ajax({
		type: "POST",
		url: UrlSite + "telas/atenda/cartao_credito_prod/liberar_desfaz_liberacao.php",
		data: {
			nrdconta: nrdconta,
			nrctrcrd: nrctrcrd,
			redirect: "script_ajax"
...
function opcaoEntregarCartaoBancoob() {
	...
	$.ajax({		
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/entregar_cartao_bancoob.php",
		dataType: "html",		
        error: function (objAjax, responseError, objExcept) {
			hideMsgAguardo();
            showError("error", "N&atilde;o foi poss&iacute;vel concluir a requisi&ccedil;&atilde;o.", "Alerta - Aimaro", "blockBackground(parseInt($('#divRotina').css('z-index')))");
...
function opcaoEntregarCartaoNormal() {
	...
	$.ajax({		
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/entregar.php",
		dataType: "html",
		data: {
			nrdconta: nrdconta,
			nrctrcrd: nrctrcrd,
...
function dadosEntrega() {
	...
	$.ajax({		
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/entregar_dados.php",
		dataType: "html",
		data: {
			nrdconta: nrdconta,
			inpessoa: inpessoa,
...
function confirmaDadosEntrega() {
	...
	$.ajax({		
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/entregar_dados_confirma.php",
		dataType: "html",
		data: {
			nrdconta: nrdconta,
			nrctrcrd: nrctrcrd,
...
function entregaCartao() {
	...
	$.ajax({
		type: "POST",
		url: UrlSite + "telas/atenda/cartao_credito_prod/entregar_valida_entrega.php",
		data: {
			nrdconta: nrdconta,
			nrctrcrd: nrctrcrd,
			repsolic: repsolic,
...
function efetuaEntregaCartao() {
	...
	$.ajax({
		type: "POST",
		url: UrlSite + "telas/atenda/cartao_credito_prod/entregar_entregarcartao.php",
		data: {
			nrdconta: nrdconta,
			inpessoa: inpessoa,
			nrctrcrd: nrctrcrd,
...
function desfazEntregaCartao(idconfir) {
	...
	$.ajax({
		type: "POST",
		url: UrlSite + "telas/atenda/cartao_credito_prod/entregar_desfazentrega.php",
		data: {
			nrdconta: nrdconta,
			nrctrcrd: nrctrcrd,
			inconfir: idconfir,
...
function opcaoAlterar() {
	...
	$.ajax({		
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/alterar.php",
		dataType: "html",
		data: {
			nrdconta: nrdconta,
			nrctrcrd: nrctrcrd,
...
function alteraLimiteDebito() {
	...
	$.ajax({
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/alterar_limitedebito_carregadados.php",
		dataType: "html",
		data: {
			nrdconta: nrdconta,
			nrctrcrd: nrctrcrd,
...
function alteraLimDeb() {
	...
	$.ajax({		
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/alterar_limitedebito_alterar.php",
		data: {
			nrdconta: nrdconta,
			nrctrcrd: nrctrcrd,
...
function alteraLimiteCredito() {
	...
	$.ajax({		
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/alterar_limitecredito_carregadados.php",
		dataType: "html",
		data: {
			nrdconta: nrdconta,
			inpessoa: inpessoa,
...
function validaLimCre() {
	...
	$.ajax({		
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/alterar_limitecredito_validalimite.php",
		data: {
			nrdconta: nrdconta,
			inpessoa: inpessoa,
			nrctrcrd: nrctrcrd,
...
function alteraLimCre() {	 
	...
	$.ajax({
		type: "POST",
		url: UrlSite + "telas/atenda/cartao_credito_prod/alterar_limitecredito_alterar.php",
		data: {
			nrdconta: nrdconta,
			inpessoa: inpessoa,
			nrctrcrd: nrctrcrd,
...
function alteraDtVencimento(segundaVia) {
	...
	$.ajax({		
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/alterar_dtvenc_carregadados.php",
		dataType: "html",
		data: {
			nrdconta: nrdconta,
			nrctrcrd: nrctrcrd,
...
function alterarDataDeVencimento() {    
	...
	$.ajax({		
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/alterar_dtvenc_alterar.php",
		data: {
			nrdconta: nrdconta,
			inpessoa: inpessoa,
			nrctrcrd: nrctrcrd,
...
function opcao2via() {
	...
	$.ajax({		
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/2via.php",
		dataType: "html",
		data: {
			nrdconta: nrdconta,
			nrctrcrd: nrctrcrd,
...
function opcao2viaCartao() {
	...
	$.ajax({		
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/2via_cartao.php",
		dataType: "html",
		data: {
			redirect: "html_ajax"
		},		
...
function opcao2viaSenhaNormal() {
	...
	$.ajax({
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/2via_senha.php",
		dataType: "html",
		data: {
			inpessoa: inpessoa,
			redirect: "html_ajax"
...
function opcao2viaSenhaCartaoChip() {
	...
	$.ajax({		
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/2via_senha_cartao_chip.php",
		dataType: "html",		
        error: function (objAjax, responseError, objExcept) {
			hideMsgAguardo();
            showError("error", "N&atilde;o foi poss&iacute;vel concluir a requisi&ccedil;&atilde;o.", "Alerta - Aimaro", "blockBackground(parseInt($('#divRotina').css('z-index')))");
...
function solicitar2viaSenha() {
	...
	$.ajax({		
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/2via_senha_solicitacao_carregadados.php",
		dataType: "html",
		data: {
			nrdconta: nrdconta,
			redirect: "html_ajax"
...
function efetuaSolicitacao2viaSenha() {
	...
	$.ajax({		
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/2via_senha_solicitacao_efetuar.php",
		data: {
			nrdconta: nrdconta,
			cdadmcrd: cdadmcrd,
			nrctrcrd: nrctrcrd,
...
function solicita2viaCartao() {
	...
	$.ajax({		
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/2via_solicitacao_carregadados.php",
		data: {
			nrdconta: nrdconta,
			nrctrcrd: nrctrcrd,
			inpessoa: inpessoa,
...
function efetuaSolicitacao2viaCartao(motivo) {
	...
	$.ajax({		
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/2via_solicitacao_efetuar.php",
		data: {
			nrdconta: nrdconta,
			nrctrcrd: nrctrcrd,
			inpessoa: inpessoa,
...
function entrega2viaCartao() {
	...
	$.ajax({		
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/2via_entrega_carregadados.php",
		data: {
			nrdconta: nrdconta,
			nrctrcrd: nrctrcrd,
			inpessoa: inpessoa,
...
function validaMostraavaisEntrega2viaCartao() {	 
	...
	$.ajax({		
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/2via_entrega_validadados.php",
		data: {
			nrdconta: nrdconta,
			nrctrcrd: nrctrcrd,	
			inpessoa: inpessoa,			
...
function efetuaEntrega2viaCartao() {	 
	...
	$.ajax({		
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/2via_entrega_efetuar.php",
		data: {
			nrdconta: nrdconta,
			nrctrcrd: nrctrcrd,
			inpessoa: inpessoa,
...
function desfazSolicitacao2viaCartao() {
	...
	$.ajax({		
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/2via_desfazsolicitacao.php",
		data: {
			nrdconta: nrdconta,
			nrctrcrd: nrctrcrd,
			redirect: "html_ajax"
...
function desfazSolicitacao2viaSenha() {
	...
	$.ajax({		
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/2via_senha_desfazsolicitacao.php",
		data: {
			nrdconta: nrdconta,
			nrctrcrd: nrctrcrd,
			redirect: "script_ajax"
...
function opcaoRenovar() {
	...
	$.ajax({		
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/renovar_carregadados.php",
		dataType: "html",
		data: {
			nrdconta: nrdconta,
			nrctrcrd: nrctrcrd,
...
function validaDadosRenovacao() {
	...
	$.ajax({		
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/renovar_valida_mostraavais.php",
		data: {
			nrdconta: nrdconta,
			nrctrcrd: nrctrcrd,
			inpessoa: inpessoa,
...
function efetuaRenovacaoCartao() {    
	...
	$.ajax({		
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/renovar_efetuarenovacao.php",
        data: {
...
function opcaoEncerrar() {
	...
	$.ajax({		
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/encerramento.php",
		dataType: "html",
		data: {
			nrdconta: nrdconta,
			nrctrcrd: nrctrcrd,			
...
function desfazEncCartao(indposic) {
	...
	$.ajax({
		type: "POST",
		url: UrlSite + "telas/atenda/cartao_credito_prod/encerramento_desfazer.php",
		data: {
			nrdconta: nrdconta,
			nrctrcrd: nrctrcrd,
			indposic: indposic,
...
function encerrarCart(indposic) {
	...
	$.ajax({		
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/encerramento_infos.php",
		dataType: "html",
		data: {
			nrcrcard: nrcrcard,
			nrctrcrd: nrctrcrd,
...
function encerramentoCartao(indposic) {
	...
	$.ajax({
		type: "POST",
		url: UrlSite + "telas/atenda/cartao_credito_prod/encerramento_cartao.php",
		data: {
			nrdconta: nrdconta,
			nrctrcrd: nrctrcrd,
			inpessoa: inpessoa,
...
function opcaoCancBloq() {
	...
	$.ajax({		
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/cancelamento_bloqueio.php",
		dataType: "html",
		data: {
			nrdconta: nrdconta,
			nrctrcrd: nrctrcrd,			
...
function tipoCancBlq(cancbloq) {
	...
	$.ajax({		
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/cancelamento_bloqueio_tipodecancblq.php",
		dataType: "html",
		data: {
			nrcrcard: nrcrcard,
			nrctrcrd: nrctrcrd,
...
function cancelarBloquearCartao(indposic) {
	...
	$.ajax({
		type: "POST",
		url: UrlSite + "telas/atenda/cartao_credito_prod/cancelamento_bloqueio_cancelabloqueia.php",
		data: {
			nrdconta: nrdconta,
			nrctrcrd: nrctrcrd,
			inpessoa: inpessoa,
...
function desfazCancBlqCartao(indposic) {
	...
	$.ajax({
		type: "POST",
		url: UrlSite + "telas/atenda/cartao_credito_prod/cancelamento_bloqueio_desfazcancblq.php",
		data: {
			nrdconta: nrdconta,
			nrctrcrd: nrctrcrd,
			indposic: indposic,
...
function excluiCartao() {
	...
	$.ajax({
		type: "POST",
		url: UrlSite + "telas/atenda/cartao_credito_prod/excluir_cartao.php",
		data: {
			nrdconta: nrdconta,
			nrctrcrd: nrctrcrd,
			redirect: "script_ajax"
...
function opcaoHabilitar() {	
	...
	$.ajax({		
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/habilitar.php",
		dataType: "html",
		data: {
			nrdconta: nrdconta,			
			redirect: "html_ajax"
...
function carregarRepresentante(cddopcao, idrepres, nrcpfrep) {
	...
	$.ajax({		
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/representantes_carregar.php",		
		data: {
			cddopcao: cddopcao,
			idrepres: idrepres,
...
function validarDadosHabilita() {	
	...
	$.ajax({		
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/habilitar_validar.php",		
		data: {
			nrdconta: nrdconta,
			vllimglb: vllimglb,
			flgativo: flgativo,
...
function gravarDadosHabilitacao() {
	...
	$.ajax({		
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/habilitar_gravar.php",		
		data: {
			nrdconta: nrdconta,
...
/*	if (situacaoAnt != 'Em uso'){
	...
	$.ajax({		
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/extrato_parametros.php",
		dataType: "html",
		data: {
			nrdconta: nrdconta,
			nrcrcard: nrcrcard,
...
function validaDadosExtrato(anoHoje) {
    ...
    if ((dtArr[0] == 0) || (dtArr[0] > 12) || (dtArr[1] > (anoHoje + 1))) {
		...
		$.ajax({		
			type: "POST", 
			url: UrlSite + "telas/atenda/cartao_credito_prod/extrato_exibir.php",
			data: {
					nrdconta: nrdconta,
					nrcrcard: nrcrcard,
					dtextrat: dtextrat,
...
function validaTitular() {
	...
	$.ajax({		
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/validar_titular.php",
		dataType: "html",
		data: {
			nrdconta: nrdconta,
			redirect: "html_ajax"
...
function buscaDadosCartao(cdadmcrd, nrcpfcgc, nmtitcrd, inpessoa, floutros) {
	...
	$.ajax({		
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/valida_dados_cartao.php",
		dataType: "html",
		data: {
			nrdconta: nrdconta,
			cdadmcrd: cdadmcrd,
...
function opcaoAlteraAdm() {
	...
	$.ajax({		
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/upgrade_downgrade.php",
		dataType: "html",
		data: {
			nrdconta: nrdconta,
			nrcrcard: nrcrcard,
...
function validarUpDown() {
	...
	$.ajax({		
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/altera_administradora.php",
		dataType: "html",
		data: {
			codaadmi: codaadmi,
			codnadmi: codnadmi,
...
function buscaTitulares(nrdconta, escolha) {
	...
	$.ajax({		
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/busca_titulares.php",
		dataType: "html",
		data: {
			nrdconta: nrdconta,
			idseqttl: idseqttl,
...
function carregaRepresentantes() {
	...
	$.ajax({		
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/busca_representantes.php",
		dataType: "html",
		data: {
			tpctrato: 6,
			nrdconta: nrdconta,
...
function opcaoTAA() {
	...
	$.ajax({		
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/verifica_acesso_tela_taa.php",
		dataType: "html",
		data: {
			nrdconta: nrdconta,
			nrcrcard: nrcrcard,
    ...
    setTimeout(function () {
        ...
        try {
            ...
            setTimeout(function () {
				...
				$.ajax({
					type: "POST", 
					url: UrlSite + "telas/atenda/cartao_credito_prod/processa_leitura_cartao_chip.php",
					async: false,
					dataType: "html",
					data: {
...
function valida_dados_cartao_bancoob() {
	...
	$.ajax({
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/valida_dados_cartao_bancoob.php",
        async: false,
		data: {
...
function altera_senha_pinpad() {
    ...
    setTimeout(function () {
        try {
            ...
            $.ajax({
                type: "POST",
					url: UrlSite + "telas/atenda/cartao_credito_prod/retorna_ct.php",
                async: false,
                error: function (objAjax, responseError, objExcept) {
                ...
                try {
                    ...
                    setTimeout(function () {
                        ...
                        try {
                            ...
                            $.ajax({
                                type: "POST",
									url: UrlSite + "telas/atenda/cartao_credito_prod/retorna_pi.php",
                                async: false,
									data: {
...
function altera_cb(oPinpad, sAID, sNTexto4, sNumeroCartao) {
	...
	$.ajax({
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/retorna_cb.php",
        async: false,
		data: {
...
function confirma_cb(sIdentificadorTransacao, sNumeroCartao) {
	...
	$.ajax({
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/retorna_co.php",
        async: false,
		data: {
...
function grava_dados_cartao_nao_gerado() {
	...
	$.ajax({
		type: "POST",
		url: UrlSite + "telas/atenda/cartao_credito_prod/cadastrar_cartao_nao_gerado.php",
		data: {
			nrdconta: nrdconta,
			nrctrcrd: nrctrcrd,
...
function validaDadosLiberacaoTAA(operacao) {
	...
	$.ajax({		
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/valida_liberacao_taa.php",
		dataType: "html",
		data: {
			nrdconta: nrdconta,
			nrcrcard: nrcrcard,
...
function liberarCartaoCreditoTAA(operacao) {
	...
	$.ajax({
		type: "POST",
		url: UrlSite + "telas/atenda/cartao_credito_prod/liberar_cartao_credito_taa.php",
		data: {
			nrdconta: nrdconta,
			nrctrcrd: nrctrcrd,
			nrcrcard: nrcrcard,
...
function validaDadosBloqueioTAA() {
	...
	$.ajax({
		type: "POST",
		url: UrlSite + "telas/atenda/cartao_credito_prod/valida_bloqueio_taa.php",
		data: {
			nrdconta: nrdconta,
			nrcrcard: nrcrcard,
			nrctrcrd: nrctrcrd,
...
function bloquearCartaoCreditoTAA() {
	...
	$.ajax({
		type: "POST",
		url: UrlSite + "telas/atenda/cartao_credito_prod/bloquear_cartao_credito_taa.php",
		data: {
			nrdconta: nrdconta,
			nrctrcrd: nrctrcrd,
			nrcrcard: nrcrcard,
...
function validaDadosSenhaNumericaTAA(operacao) {
	...
	$.ajax({		
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/valida_senha_numerica_taa.php",
		dataType: "html",
		data: {
			nrdconta: nrdconta,
			nrcrcard: nrcrcard,
...
function alteraSenhaNumericaTAA() {
	...
	$.ajax({
		type: "POST",
		url: UrlSite + "telas/atenda/cartao_credito_prod/alterar_senha_numerica_taa.php",
		data: {
			nrdconta: nrdconta,
			nrctrcrd: nrctrcrd,
			nrcrcard: nrcrcard,
...
function validaDadosSenhaLetrasTAA(operacao) {
	...
	$.ajax({		
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/valida_senha_letras_taa.php",
		dataType: "html",
		data: {
			nrdconta: nrdconta,
			nrcrcard: nrcrcard,
...
function alteraSenhaLetrasTAA(operacao) {
	...
	$.ajax({
		type: "POST",
		url: UrlSite + "telas/atenda/cartao_credito_prod/alterar_senha_letras_taa.php",
		data: {
			nrdconta: nrdconta,
			nrctrcrd: nrctrcrd,
			nrcrcard: nrcrcard,
...
function entregaCartaoCarregaTelaSenhaNumericaTaa() {
	...
	$.ajax({		
		type: "POST", 
		url: UrlSite + "telas/atenda/cartao_credito_prod/carrega_tela_senha_numerica_taa.php",
		dataType: "html",
		data: {
			nrdconta: nrdconta,
			nrctrcrd: nrctrcrd,
...
function entregaCartaoCarregaTelaSenhaLetrasTaa() {
	...
	$.ajax({
		type: "POST",
		url: UrlSite + "telas/atenda/cartao_credito_prod/carrega_tela_senha_letras_taa.php",
		dataType: "html",
		data: {
			nrdconta: nrdconta,
			nrctrcrd: nrctrcrd,
...
function carregaSelecionarRepresentantes() {
	...
	$.ajax({
		type: 'POST',
		dataType: 'html',
		url: UrlSite + 'telas/atenda/cartao_credito_prod/carrega_representante.php',
		data: {
			nrdconta: nrdconta,			
			redirect: 'html_ajax'
		},
...
function mostraHisLimite() {
    ...
    $.ajax({
        type: "POST",
        url: UrlSite + "telas/atenda/cartao_credito_prod/consultar_historico_limite.php",
        dataType: "html",
        data: {
            nrdconta: nrdconta,
            nrcctitg: nrcctitg,
