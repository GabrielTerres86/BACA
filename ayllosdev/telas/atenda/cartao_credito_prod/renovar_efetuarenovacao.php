<?php 
	...
	/************************************************************************
	 Fonte: renovar_efetuarenovacao.php                                                 
	 Autor: Guilherme                                                     
	 Data : Maio/2008               Última Alteração: 12/04/2013
	                                                               
	 Objetivo  : Renovar a data de validade do cartão e os avalistas
	 ...
	 Alterações: 14/05/2009 - Tirar validação de data para parâmetro  
			     ...
			     09/09/2011 - Ajuste para Lista Negra (Adriano).	

				 18/06/2012 - Adicionado confirmacao de impressao do contrato 
							  de renovacao. (Jorge)
							  
				 12/04/2013 - Retirado a chamada da procedure alerta_fraude
						      (Adriano)
	...
	************************************************************************/
	...
	$params = array("nrdconta","nrctrcrd","dtvalida","flgimpnp","inpessoa",
	...
	$xmlSetCartao .= "		<Proc>renova_cartao</Proc>";
	$xmlSetCartao .= "	</Cabecalho>";
	$xmlSetCartao .= "	<Dados>";
