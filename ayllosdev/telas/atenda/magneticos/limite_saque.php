<?php 
	...
	//************************************************************************//
	//*** Fonte: limite_saque.php                                          ***//
	//*** Autor: David                                                     ***//
	//*** Data : Outubro/2008                 &Uacute;ltima Altera&ccedil;&atilde;o: 00/00/0000 ***//
	//***                                                                  ***//
	//*** Objetivo  : Mostrar opcao para alterar o Limite de Saque         ***//
	//***                                                                  ***//	 
	...
	$xmlDadosCartao .= "		<Proc>obtem-limite-saque</Proc>";
	$xmlDadosCartao .= "	</Cabecalho>";
...
$("#vlsaqmax","#frmDadosCartaoMagnetico").setMask("DECIMAL","zzz.zzz.zz9,99","","");
