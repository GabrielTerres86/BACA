...
/*************************************************************************
	...
	Objetivo: Efetua inclusao do convenio.
...
if( $lstemail == '' && $idretorn == 1){
	//exibeErro('N&atilde;o &eacute; permitido incluir conv&ecirc;nio sem pelo menos um email!');	
	exibeErro('Para forma de envio de arquivos Internet Banking &eacute; obrigat&oacute;rio informar endere&ccedil;o de e-mail.!');		
}
...
$xmlResult = mensageria($xml, "PGTA0001", "INCLUIRCONVENIO", $glbvars["cdcooper"], $glbvars["cdagenci"], $glbvars["nrdcaixa"], $glbvars["idorigem"], $glbvars["cdoperad"], "</Root>");
