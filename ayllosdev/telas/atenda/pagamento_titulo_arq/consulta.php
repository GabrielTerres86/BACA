...
function fnConfirmaInclusao(){
	confirmaInclusao($('#nrconven','#frmConsulta').val(), $('#flghomol','#frmConsulta').val(), '<?php echo $glbvars['cdoperad'] ?>', $('#idretorn','#frmConsulta').val(), $('#flgativo','#frmConsulta').val());
	return false;
}

function fnConfirmaAlteracao(){
	confirmaAlteracao($('#nrconven','#frmConsulta').val(), $('#flghomol','#frmConsulta').val(), '<?php echo $glbvars['cdoperad'] ?>', $('#idretorn','#frmConsulta').val(), $('#flgativo','#frmConsulta').val());
	return false;
}
...
<form action="" name="frmConsulta" id="frmConsulta" method="post">
	...
	<div id="divBotoes">
		<a href="#" class="botao" onClick="acessaOpcaoAba();return false;" >Voltar</a>			
		<?php if($cddopcao == 'I'){ ?>
		<a href="#" class="botao" onClick="fnConfirmaInclusao();" >Incluir</a>
		<?php }?>
		<?php if($cddopcao == 'A'){ ?>
		<a href="#" class="botao" onClick="fnConfirmaAlteracao();" >Alterar</a>
		<?php }?>
