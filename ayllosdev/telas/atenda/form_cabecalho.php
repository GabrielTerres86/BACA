...
<form action="" method="post" name="frmCabAtenda" id="frmCabAtenda" class="formulario condensado cabecalho">
	...
	<input type="image" src="<?php echo $UrlImagens; ?>/botoes/ok.gif" onClick="obtemCabecalho();return false;">
		
	<a href="#" onClick="mostraPesquisaAssociado('nrdconta','frmCabAtenda','');return false;" style="margin-left: 1px">Pesquisa</a>
	<a href="#" onClick="mostraPesquisaAssociado('nrdconta','frmCabAtenda','');return false;" ><img src="<?php echo $UrlImagens; ?>geral/ico_lupa.gif" width="14" height="14" border="0"></a>
	<a href="#" onClick="buscaAnotacoes();return false;" style="margin-left: 1px">&nbsp;&nbsp;Anota&ccedil;&otilde;es</a>
	
	<div id="divSemCartaoAss"><a style="margin-left: 1px; cursor:default">&nbsp;&nbsp;Cart&atilde;o Ass.</a> </div>
			
	
	<br style="clear:both;" />
	<hr style="background-color:#666; height:1px;" />

	<label for="nrmatric"><? echo utf8ToHtml('Matr&iacute;cula:') ?></label>	
	...
	<label for="nrctainv"><? echo utf8ToHtml('Conta/Invest.:') ?></label>	
	<input name="nrctainv" type="text"  id="nrctainv" />

	<label for="dtadmiss"><? echo utf8ToHtml('Admiss&atilde;o:') ?></label>	
	<input name="dtadmiss" type="text"  id="dtadmiss" />

	<br />

	<label for="dtadmemp"><? echo utf8ToHtml('Admiss&atilde;o Empresa:') ?></label>	
	<input name="dtadmemp" type="text"  id="dtadmemp" />

	<label for="dtaltera"><? echo utf8ToHtml('Atualiza&ccedil;&atilde;o Cadastral:') ?></label>	
	<input name="dtaltera" type="text"  id="dtaltera" />

	<label for="dtdemiss"><? echo utf8ToHtml('Demiss&atilde;o:') ?></label>	
	...
	<label for="dsnatopc"><? echo utf8ToHtml('Ocupa&ccedil;&atilde;o:') ?></label>	
	<input name="dsnatopc" type="text"  id="dsnatopc" />

	<label for="nrramfon"><? echo utf8ToHtml('Telefone:') ?></label>	
	<input name="nrramfon" type="text"  id="nrramfon" />

	<br />
	
	<label for="dsnatura"><? echo utf8ToHtml('Naturalidade:') ?></label>	
	...
	<label for="dssitdct"><? echo utf8ToHtml('Situa&ccedil;&atilde;o:') ?></label>	
	<input name="dssitdct" type="text"  id="dssitdct" />

	<br />

	<label for="indnivel"><? echo utf8ToHtml('N&iacute;vel:') ?></label>	
	...
	<label for="cdsecext"><? echo utf8ToHtml('Se&ccedil;&atilde;o:') ?></label>	
	<input name="cdsecext" type="text"  id="cdsecext" />

	<label for="cdturnos"><? echo utf8ToHtml('Turno:') ?></label>	
	<input name="cdturnos" type="text"  id="cdturnos" />
	
	<label for="cdtipsfx"><? echo utf8ToHtml('Tipo Sal&aacute;rio:') ?></label>	
	<input name="cdtipsfx" type="text"  id="cdtipsfx" />
	
	<br style="clear:both" />
	<hr style="background-color:#666; height:1px;" />
	
	<label for="qtdevolu"><? echo utf8ToHtml('Devolu&ccedil;&otilde;es:') ?></label>	
	<input name="qtdevolu" type="text"  id="qtdevolu" />

	<label for="qtdddeve"><? echo utf8ToHtml('Cred Liq/Estouro:') ?></label>	
	<input name="qtdddeve" type="text"  id="qtdddeve" />

	<label for="dtabtcct"><? echo utf8ToHtml('Data SFN:') ?></label>	
	<input name="dtabtcct" type="text"  id="dtabtcct" />

	<br />
	
	<label for="ftsalari"><? echo utf8ToHtml('Ft. Salarial:') ?></label>	
	<input name="ftsalari" type="text"  id="ftsalari" />

	<label for="vlprepla"><? echo utf8ToHtml('Plano de Capital:') ?></label>	
	<input name="vlprepla" type="text"  id="vlprepla" />

	<label for="qttalret"><? echo utf8ToHtml('Fs Retiradas:') ?></label>	
