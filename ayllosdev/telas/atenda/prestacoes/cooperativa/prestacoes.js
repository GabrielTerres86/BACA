 ...
 * 043: [17/01/2018] Inclu�do novo campo (Qualif Oper. Controle) (Diego Simas - AMcom)
 * 044: [24/01/2018] Inclu�do tratamento para o n�vel de risco original (Reginaldo - AMcom)
 */
...
/**
* Fun��o para recarregar as informa��es dos contratos aprovados (Empr�stimos)
* 
*/
...
function atribuiDescControle (idQuaPrc) {
	switch(idQuaPrc){		
		case 1:
			return "Opera��o Normal";
			break;
		case 2:
			return "Renova��o Cr�dito";
			break;
		case 3:
			return "Renegocia��o Cr�dito";
			break;
		case 4:
			return "Composi��o D�vida";
			break;
		case 5:
			return "Cess�o de Cart�o";
			break;
		default:
			return "Opera��o Inexistente";
			break;
	}
}
