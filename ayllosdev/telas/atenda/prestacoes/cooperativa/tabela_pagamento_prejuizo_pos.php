<? 
/*!
 * FONTE        : tabela_pagamento_prejuizo_pos.php
 * CRIAÇÃO      : Nagasava (Supero)
 * DATA CRIAÇÃO : 21/01/2019
 * OBJETIVO     : Realizar pagamento de prejuizo de contrato pos.
...
<div id="divBotoes">
	...
	<input type="image" id="btSalvar" src="<?php echo $UrlImagens; ?>botoes/continuar.gif" onClick="validaPagamentoPrejuPos(); return false;" />
</div>
