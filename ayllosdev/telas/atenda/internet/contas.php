<?php 
	...
	//*** Fonte: contas.php      	    			                           ***//
	//*** Autor: Lucas                                                    	   ***//
	//*** Data : Maio/2012                   Última Alteração: 18/12/2014      ***//
	//***                                                                      ***//
	...
	$cntrgpen = $xmlObjPendentes->roottag->tags[0]->attributes["CNTRGPEN"];	
...
<div id="divOpContas">
	<form action="" method="post" name="frmOpContas" id="frmOpContas" onSubmit="return false;">
		<fieldset>
			...
			<div id="divBotoes">
				<table width="0" border="0" cellpadding="0" cellspacing="0" align = "center" style = "padding-left:15px;">
					<tr>
						<td align ="center">
							<input type="image" src="<? echo $UrlImagens; ?>botoes/pendentes_confirmacao.gif" onClick="obtemCntsPendentes('1','10');return false;" />
						</td>
						<td align ="left">
							<input class="campo" value = "<? echo utf8ToHtml($cntrgpen) ?>" type="text" style="width:30px;"/>
						</td>
					</tr>
					<tr>
						<td align ="center">
