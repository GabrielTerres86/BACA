                ...
                <td>
                  <table border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td align="center" style="background-color: #C6C8CA;" id="imgAbaCen<?php echo $i; ?>"><a href="#" id="linkAba<?php echo $i; ?>" onClick="redimensiona(); acessaOpcaoAba(<?php echo count($opcoesTela); ?>,<?php echo $i; ?>,'<?php echo $opcoesTela[$i]; ?>');return false;" class="txtNormalBold"><?php echo $nameOpcao; ?>
                        </a>
                      </td>
                      <td>
