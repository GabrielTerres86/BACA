...
showConfirmacao(' <?php echo $mensagem ?> ','Confirma&ccedil;&atilde;o - Ayllos','desfazEntregaCartao(<?php echo $idconfir ?>)','blockBackground(parseInt($(\'#divRotina\').css(\'z-index\')))','sim.gif','nao.gif');