 ...
 * 035: [14/10/2015] Evandro       (RKAM)   : Alterado o width dos campo e label nmopetaa PRJ 215. 
 */
...
function ImprimeExtratoCartao2(idImpres, nrConta, nrCartao, DtVctIni, DtVctFim) {
    ...
    $("#nrdconta", "#frmImprimir").val(nrConta);
    $("#nrcrcard", "#frmImprimir").val(nrCartao);
    $("#dtvctini", "#frmImprimir").val(DtVctIni);
    $("#dtvctfim", "#frmImprimir").val(DtVctFim);
