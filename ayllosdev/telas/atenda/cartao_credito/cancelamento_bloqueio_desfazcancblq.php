<?php 
	...
	/**********************************************************************
	  Fonte: cancelamento_bloqueio_desfazcancblq.php
	  Autor: Guilherme
	  Data : Abril/2007                      Última Alteração: 30/07/2010

	  Objetivo  : Desfazer Cancelamento ou o Bloqueio do Cartão de Crédito  				  

	  Alterações: 30/07/2010 - Apresentar mensagem de aviso referente ao
	                           0800 do BB (David).
	***********************************************************************/
	...
	$xmlSetCartao .= "		<Proc>desfaz_cancblq_cartao</Proc>";
	$xmlSetCartao .= "	</Cabecalho>";
	$xmlSetCartao .= "	<Dados>";
	...
	if ($msgalert == "") {
		...
		echo 'showError("inform","'.$msgalert.'","Notifica&ccedil;&atilde;o - Ayllos","blockBackground(parseInt($(\'#divRotina\').css(\'z-index\')));'.$fncReload.'");';
	}
