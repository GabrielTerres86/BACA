<?php 
	 ...
	 * 003: [10/07/2012] Guilherme Maba: Alimentar campo nmextttl no formul�rio.
	...
	// Verifica se identificador do representante � um inteiro v�lido
	...
	if ($cddopcao == "N") { // Op��o NOVO
		// Alimenta e configura campos	
		if ($bfexiste == "yes") { // CPF pertence a um associado			
			echo '$("#nmtitcrd","#frmNovoCartao").val("'.$nmprimtl.'").attr("class","campo");';
			echo '$("#nmextttl","#frmNovoCartao").val("'.$nmprimtl.'").attr("class","campo");';
			echo '$("#dtnasccr","#frmNovoCartao").val("'.$dtnasctl.'").attr("class","campoTelaSemBorda");';
			$dsidfoco = "dsadmcrd";
		} else {					
			echo '$("#nmtitcrd","#frmNovoCartao").val("").attr("class","campo");';
			echo '$("#nmextttl","#frmNovoCartao").val("").attr("class","campo");';
			echo '$("#dtnasccr","#frmNovoCartao").val("").attr("class","campo");';		
			$dsidfoco = "dtnasccr";
		}
	...
	echo "$('#dtnasccr').removeAttr('disabled');";
	echo 'hideMsgAguardo();';	
