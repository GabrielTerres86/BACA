	...
	<div id="divDadosNovoCartao">
		<fieldset>
			...
			<div id="titularidade">
				...
				<select name="dsgraupr" id="dsgraupr" onblur="buscaDados('<?echo $cdtipcta;?>','<?echo formataNumericos("999.999.999-99",$nrcpfstl,".-");?>','<?echo $inpessoa;?>','<?echo $dtnasstl ;?>','<?echo $nrdocstl ;?>','<?echo str_replace($nmconjug,'\'',''); ?>','<?echo $dtnasccj ;?>','<?echo $nmtitcrd ;?>','<?echo formataNumericos("999.999.999-99",$nrcpfcgc,".-");?>','<?echo $dtnasctl;?>','<?echo $nrdocptl;?>','<?echo number_format(str_replace(",",".",$vlsalari),2,",","."); ?>','<?echo $nmsegntl;?>');" class="campo" style="width: 100px;">
				<?php
