<?php 
	...
	***********************************************************************/
	...
	if ($mensagem == "") {		
		...
		echo 'showConfirmacao("'.$mensagem.'","Confirma&ccedil;&atilde;o - Ayllos","efetuaEntregaCartaoNormal()","blockBackground(parseInt($(\'#divRotina\').css(\'z-index\')))","sim.gif","nao.gif");';
	}
