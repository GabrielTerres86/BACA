<?php 
	...
	/************************************************************************
	 ...
	 Objetivo  : Consultar a situa&ccedil;&atilde;o da inscri&ccedil;&atilde;o do evento
	...
	************************************************************************/
	...
	$eventos = $xmlObjSituacaoInscricao->roottag->tags[0]->tags;
			...
			<table>
				<thead>
					<tr>
						...
						<th><? echo utf8ToHtml('Inscrito');  ?></th>
					</tr>
				</thead>
				<tbody>
					<? 
...
<li><? echo utf8ToHtml('Confirm:') ?></li>
<li id="confirm"><?php echo $eventos[0]->tags[5]->cdata; ?></li>
<li><? echo utf8ToHtml('Int:') ?></li>
...
<div id="divBotoes">
	...
	<input type="image" src="<?php echo $UrlImagens; ?>botoes/desistente.gif" <?php if (!in_array("A",$glbvars["opcoesTela"])) { echo 'style="cursor: default" onClick="return false;"'; } else { echo 'onClick="msgConfirmaStatus(3,\''.$imptermo.'\');return false;"'; } ?>>
	<input type="image" src="<?php echo $UrlImagens; ?>botoes/excluido.gif" <?php if (!in_array("A",$glbvars["opcoesTela"])) { echo 'style="cursor: default" onClick="return false;"';   } else { echo 'onClick="msgConfirmaStatus(4,\''.$imptermo.'\');return false;"'; } ?>>
	<input type="image" src="<?php echo $UrlImagens; ?>botoes/excedente.gif" <?php if (!in_array("A",$glbvars["opcoesTela"])) { echo 'style="cursor: default" onClick="return false;"';  } else { echo 'onClick="msgConfirmaStatus(5,\''.$imptermo.'\');return false;"'; } ?>>					
