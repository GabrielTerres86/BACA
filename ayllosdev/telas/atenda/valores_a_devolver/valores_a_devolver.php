<?php 
	...
	/************************************************************************
	 Fonte: valores_a_devolver.php                                  
	 Autor: Jonata - RKAM                                                   
	 Data : Dezembro/2017                  Ultima Alteracao         
	                                                                
	 Objetivo  : Mostrar rotina de Valores a Devolver da tela ATENDA 
					...
					<td>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td class="txtBrancoBold ponteiroDrag" background="<?php echo $UrlImagens; ?>background/tit_tela_fundo.gif">Valores a Devolver</td>
								...
								<td>
									<table border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											// Mostrar op&ccedil;&otilde;es da rotina no layer conforme permiss&atilde;o do operador
