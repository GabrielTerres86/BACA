...
$xml .= "   <boletos_liquidados>".floatval($boletos_liquidados)."</boletos_liquidados>";
$xml .= "   <volume_liquidacao>".floatval($volume_liquidacao)."</volume_liquidacao>";
$xml .= "   <qtdfloat>".$qtdfloat."</qtdfloat>";
$xml .= "   <vlaplicacoes>".floatval($vlaplicacoes)."</vlaplicacoes>";
$xml .= "   <vldeposito>".floatval($vldeposito)."</vldeposito>";
$xml .= "   <dtfimcontrato>".$dtfimcontrato."</dtfimcontrato>";
$xml .= "   <flgdebito_reversao>".$flgdebito_reversao."</flgdebito_reversao>";
$xml .= "   <vldesconto_coo>".floatval($vldesconto_coo)."</vldesconto_coo>";
$xml .= "   <dtfimadicional_coo>".$dtfimadicional_coo."</dtfimadicional_coo>";
$xml .= "   <vldesconto_cee>".floatval($vldesconto_cee)."</vldesconto_cee>";
...
$xml .= "   <vldescontoconcedido_coo>".floatval($vldescontoconcedido_coo)."</vldescontoconcedido_coo>";
