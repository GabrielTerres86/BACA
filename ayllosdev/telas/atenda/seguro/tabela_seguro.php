            ...
            <? foreach( $seguros as $seguro ) {
				...
				<tr>
					<td>
                        ...
                        <input type="hidden" id="nmsispar"   name="dsstatus"   value="<? echo getByTagName($seguro->tags,'nmParceiro'); ?>" />

                        <input type="hidden" id="dsseguro" name="dsseguro" value="<? echo getByTagName($seguro->tags,'dsTpSeguro'); ?>" />
                        ...
                        <input type="hidden" id="cdsitseg" name="cdsitseg" value="<? echo getByTagName($seguro->tags,'dsSituac'); ?>" />
