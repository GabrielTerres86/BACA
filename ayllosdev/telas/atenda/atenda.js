		...
		success: function(response) {			
			try {
				...
				if (flgdigit == "yes" || flgdigit == "S"){
					$("#divSemCartaoAss").html("<a tabindex='6'  class='txtNormal SetFocus' href='http://" + dscsersm + "/smartshare/Clientes/ViewerExterno.aspx?pkey=8O3ky&conta=" + aux_nrdconta + "&cooperativa=" + cdcooper + "' target='_blank' >&nbsp;Cart&atilde;o Ass.</a>");
				}else{
					$("#divSemCartaoAss").html("<a tabindex='6' class='txtNormal SetFocus' style='margin-left: 1px; cursor:default' >&nbsp;Cart&atilde;o Ass.</a>");
				}
