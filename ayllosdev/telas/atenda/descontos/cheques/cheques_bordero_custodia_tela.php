<?
/*!
 * FONTE        : cheques_bordero_custodia_tela.php
 * CRIAÇÃO      : Lucas Reinert
 * DATA CRIAÇÃO : 25/10/2016
 * OBJETIVO     : Tela do formulario de cheques em custodia
 */	 
					...
					<td>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td class="txtBrancoBold ponteiroDrag" background="<?php echo $UrlImagens; ?>background/tit_tela_fundo.gif"><? echo utf8ToHtml('Detalhamento do Cheque') ?></td>
