<?php
	...
	$xmlResult = mensageria($xml, "TELA_ATENDA_DESCONTO", "VERIFICA_EMITENTES", $glbvars["cdcooper"], $glbvars["cdagenci"], $glbvars["nrdcaixa"], $glbvars["idorigem"], $glbvars["cdoperad"], "</Root>");
