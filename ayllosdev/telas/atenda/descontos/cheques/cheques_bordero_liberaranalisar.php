<?php 
	...
	/************************************************************************
	 ...
	 Autor: Guilherme                                                 
	 Data : Novembro/2008                Última Alteração: 28/03/2013
	...
	************************************************************************/
	...
	?>	
		...
		showConfirmacao("<?php echo $mensagem; ?>","Confirma&ccedil;&atilde;o - Ayllos","liberaAnalisaBorderoDscChq('<?php echo $cddopcao; ?>',aux_inconfir,aux_inconfi2,aux_inconfi3,aux_inconfi4,aux_inconfi5,'<?php echo $indentra; ?>','<?php echo $indrestr; ?>')","metodoBlock()","sim.gif","nao.gif");
	...
	<?php
		...
		showConfirmacao("<?php echo $mensagem; ?>","Confirma&ccedil;&atilde;o - Ayllos","liberaAnalisaBorderoDscChq('<?php echo $cddopcao; ?>',aux_inconfir,aux_inconfi2,aux_inconfi3,aux_inconfi4,aux_inconfi5,'<?php echo $indentra; ?>','<?php echo $indrestr; ?>')","blockBackground(parseInt($('#divRotina').css('z-index')))","sim.gif","nao.gif");
	...
	<?php
		...
		showError("inform","<?php echo $mensagem; ?>","Alerta - Ayllos","blockBackground(parseInt($(\'#divRotina\').css(\'z-index\')));liberaAnalisaBorderoDscChq('<?php echo $cddopcao; ?>',aux_inconfir,aux_inconfi2,aux_inconfi3,aux_inconfi4,aux_inconfi5,'<?php echo $indentra; ?>','<?php echo $indrestr; ?>')");
