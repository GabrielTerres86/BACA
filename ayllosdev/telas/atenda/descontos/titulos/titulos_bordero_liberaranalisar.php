<?php 
	...
	/************************************************************************
	 ...
	 Autor: Guilherme                                                 
	 Data : Novembro/2008                Última Alteração: 26/03/2013
	...
	************************************************************************/
	...
	$xmlLiberacao .= "		<cdagenci>".$glbvars["cdagenci"]."</cdagenci>";
	...
	if ($inconfir == 88 ) {?>
		...
		/*Existe uma mensagem vindo do progress com \n. Preciso retira-lo por que senão, ao mostrar essa mensagem
		 através da função exibirMensagens vair dar erro de unterminated string literal.*/
		$msg = str_replace("\n","",$mensagem);
				 
		?>
		showError("inform","<?php echo $msg; ?>","Alerta - Ayllos","blockBackground(parseInt($(\'#divRotina\').css(\'z-index\')));carregaBorderosTitulos();voltaDiv(3,2,4,\"DESCONTO DE T&Iacute;TULOS - BORDER&Ocirc;S\");");
		<?
		...
		showConfirmacao("<?php echo $mensagem; ?>","Confirma&ccedil;&atilde;o - Ayllos","liberaAnalisaBorderoDscTit('<?php echo $cddopcao; ?>',aux_inconfir,aux_inconfi2,aux_inconfi3,aux_inconfi4,aux_inconfi5,'<?php echo $indentra; ?>','<?php echo $indrestr; ?>')","blockBackground(parseInt($('#divRotina').css('z-index')))","sim.gif","nao.gif");
	...
	<?php
		...
		showError("inform","<?php echo $mensagem; ?>","Alerta - Ayllos","blockBackground(parseInt($(\'#divRotina\').css(\'z-index\')));liberaAnalisaBorderoDscTit('<?php echo $cddopcao; ?>',aux_inconfir,aux_inconfi2,aux_inconfi3,aux_inconfi4,aux_inconfi5,'<?php echo $indentra; ?>','<?php echo $indrestr; ?>')");
