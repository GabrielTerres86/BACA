...
<?php if ($cddopcao == "N") { ?>
			...
			aux_inconfi4 = 71; 
			aux_inconfi5 = 30;
			liberaAnalisaBorderoDscTit('N','1','11','21','71','30','1','0');
<?php } elseif ($cddopcao == "L") { ?>
			...
			aux_inconfi4 = 71; 
			aux_inconfi5 = 30;
			showConfirmacao("Deseja liberar o border&ocirc; de desconto de t&iacute;tulos?","Confirma&ccedil;&atilde;o - Ayllos","liberaAnalisaBorderoDscTit('L','1','11','21','71','30','1','0')","metodoBlock()","sim.gif","nao.gif");
