<?php 
	...
	************************************************************************/
	...
	if ($inconfir == 2) {
		...
		echo 'showConfirmacao("'.$mensagem.'","Confirma&ccedil;&atilde;o - Ayllos","validaLimiteDscTit(\''.$cddopcao.'\',aux_inconfir,aux_inconfi2,aux_inconfi5)","metodoBlock()","sim.gif","nao.gif");';
		exit();
