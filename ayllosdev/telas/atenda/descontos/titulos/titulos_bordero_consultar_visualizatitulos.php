...
<form class="formulario">
  <div id="divTitulosBorderos">
    ...
    <fieldset>
      <legend>
        N. Border&ocirc;: <?=formataNumericos('z.zzz.zz9',$nrborder,'.')?>
      </legend>
          ...
          <tbody>
            ...
            <tr
              ...
              onFocus="<? echo $mtdClick; ?>"
									...
									>
									<td>
                <input type='hidden' name='selecionados' value=''
                <? echo $t->tags[0]->cdata; ?>;
                <? echo $t->tags[7]->cdata; ?>;
                <? echo $t->tags[6]->cdata; ?>;
                <? echo $t->tags[2]->cdata; ?>'/>
              ...
              <td>
                <?php echo $t->tags[10]->cdata; ?>
              </td>
              <td>
                <?php echo number_format(str_replace(",",".",$t->tags[8]->cdata),2,",",".");?>
              </td>
              <td>
                <?php echo number_format(str_replace(",",".",$t->tags[9]->cdata),2,",","."); ?>
              </td>
              <td>
                <?php 
              ...
              <td>
                <?php echo number_format(str_replace(",",".",$t->tags[16]->cdata),2,",",".");?>
              </td>
              <td>
                <?php echo $t->tags[17]->cdata; ?>
              </td>
            </tr>
            <?php 
								}
  ...
  <table width="95%" border="0" cellpadding="1" cellspacing="2" style="margin: 10px 0 0 0">
    <tbody>
      <tr>
        ...
        <td width="65"  align="center"   class="txtNormal">
          <?php if($qtTitulos_cr <= 1){ echo $qtTitulos_cr." T&Iacute;TULO";}else{ echo $qtTitulos_cr." T&Iacute;TULOS";};?>
        </td>
        <td width="65"  align="center"  class="txtNormal">
          <?php echo number_format(str_replace(",",".",$vlrtotal_cr),2,",","."); ?>
        </td>
        <td width="80"  align="right"  class="txtNormal">
          <?php echo number_format(str_replace(",",".",$vltotliq_cr),2,",","."); ?>
        </td>
        <td 			align="right"  class="txtNormal"></td>
        <td width="100" align="right"  class="txtNormal">
          VAL. M&Eacute;DIO: <?php echo number_format(str_replace(",",".",$vlmedtit_cr),2,",","."); ?>
        </td>
      </tr>
    </tbody>
  </table>
  ...
  <div id="divcr" style="display:block;">
    <table width="860px" border="0" cellpadding="1" cellspacing="2">
      ...
      <tr style="background-color:"
        <?php echo $cor; ?>;" >
        <td width="60"  align="center" class="txtNormal">
          <?php echo $titulos[$i]->tags[3]->cdata; ?>
        </td>
        <td width="130" class="txtNormal">
          <?php echo $titulos[$i]->tags[10]->cdata; ?>
        </td>
        <td width="80"  align="right"  class="txtNormal">
          <?php echo number_format(str_replace(",",".",$titulos[$i]->tags[8]->cdata),2,",","."); ?>
        </td>
        <td width="80"  align="right"  class="txtNormal">
          <?php echo number_format(str_replace(",",".",$titulos[$i]->tags[9]->cdata),2,",","."); ?>
        </td>
        <td width="30"  align="right"  class="txtNormal">
          <?php if (trim($titulos[$i]->tags[4]->cdata) != "") echo diffData($titulos[$i]->tags[3]->cdata,$titulos[$i]->tags[4]->cdata); else echo diffData($titulos[$i]->tags[3]->cdata,$glbvars["dtmvtolt"]); ?>
        </td>
        <td width="250" align="left"   class="txtNormal">
          <?php echo $titulos[$i]->tags[11]->cdata; ?>
        </td>
        <td width="110" align="right"  class="txtNormal">
          <?php if (strlen($titulos[$i]->tags[5]->cdata) > 11){ echo formataNumericos('99.999.999/9999-99',$titulos[$i]->tags[5]->cdata,'./-'); }else{ echo formataNumericos('999.999.999-99',$titulos[$i]->tags[5]->cdata,'.-'); } ?>
        </td>
        <td class="txtNormal">
          <?php switch ($titulos[$i]->tags[12]->cdata){ case 0: echo "Pendente";break; case 1: echo "Resgatado";break; case 2: echo "Pago";break; case 3: echo "Vencido";break; case 4: echo "Liberado";break; default: "------";break; }?>
        </td>
      </tr>
      ...
      <tr style="background-color:"
        ...
        <td class="txtNormal" colspan="7">
          <?php echo $restricoes[$j]->tags[0]->cdata; ?>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td width="130" align="left"   class="txtNormal">
          <?php if($qtTitulos_cr <= 1){ echo $qtTitulos_cr." T&Iacute;TULO";}else{ echo $qtTitulos_cr." T&Iacute;TULOS";};?>
        </td>
        <td width="80"  align="right"  class="txtNormal">
          <?php echo number_format(str_replace(",",".",$vlrtotal_cr),2,",","."); ?>
        ...
        <td width="85"  align="right"  class="txtNormal">
          <?php if($qtRestricoes_cr <= 1){echo $qtRestricoes_cr." RESTRI&Ccedil;&Atilde;O";}else{echo $qtRestricoes_cr." RESTRI&Ccedil;&Otilde;ES";} ?>
        </td>
  ...
  <div id="divsr" style="display:block;">
    <table width="860px" border="0" cellpadding="1" cellspacing="2">
      ...
      <tr>
        ...
        <td width="130" align="left"   class="txtNormal">
          <?php if($qtTitulos_sr <= 1){ echo $qtTitulos_sr." T&Iacute;TULO";}else{ echo $qtTitulos_sr." T&Iacute;TULOS";};?>
        </td>
        <td width="80"  align="right"  class="txtNormal">
          <?php echo number_format(str_replace(",",".",$vlrtotal_sr),2,",","."); ?>
        </td>
        <td width="80"  align="right"  class="txtNormal">
          <?php echo number_format(str_replace(",",".",$vltotliq_sr),2,",","."); ?>
        </td>
        <td 			align="right"  class="txtNormal"></td>
        <td width="100" align="right"  class="txtNormal">
          VAL. M&Eacute;DIO: <?php echo number_format(str_replace(",",".",$vlmedtit_sr),2,",","."); ?>
        </td>
        <td width="85"  align="right"  class="txtNormal">
          <?php if($qtRestricoes_sr <= 1){echo $qtRestricoes_sr." RESTRI&Ccedil;&Atilde;O";}else{echo $qtRestricoes_sr." RESTRI&Ccedil;&Otilde;ES";} ?>
        </td>
        <td class="txtNormal"></td>
      </tr>
      ...
      <tr>
        ...
        <td width="130" align="left"   class="txtNormal">
          <?php if($qtTitulos <= 1){ echo $qtTitulos." T&Iacute;TULO";}else{ echo $qtTitulos." T&Iacute;TULOS";};?>
        </td>
        <td width="80"  align="right"  class="txtNormal">
          <?php echo number_format(str_replace(",",".",$vlrtotal),2,",","."); ?>
        </td>
        <td width="80"  align="right"  class="txtNormal">
          <?php echo number_format(str_replace(",",".",$vltotliq),2,",","."); ?>
        </td>
        <td 			align="right"  class="txtNormal"></td>
        <td width="100" align="right"  class="txtNormal">
          VAL. M&Eacute;DIO: <?php echo number_format(str_replace(",",".",$vlmedtit),2,",","."); ?>
        </td>
        <td width="85"  align="right"  class="txtNormal">
          <?php echo $qtRestricoes; ?> <? if($qtRestricoes <= 1){echo "RESTRI&Ccedil;&Atilde;O";}else{echo "RESTRI&Ccedil;&Otilde;ES";} ?>
        </td>
        <td class="txtNormal"></td>
