<?php 
	...
	************************************************************************/
	...
	$xmlGetRestricoes .= "		<Bo>b1wgen0030.p</Bo>";
			...
			<tbody>
				<?php
                    for ($i = 0; $i < $qtRestricoes; $i++) {
						?>
                        <tr>
                            <td><span><?php echo $restricoes[$i]->tags[0]->cdata; ?></span><?php echo $restricoes[$i]->tags[0]->cdata; ?></td>
...
formataLayout('divRestricoesTit');
