<?php 
	...
	************************************************************************/
	...
	echo 'hideMsgAguardo();';
	echo 'showConfirmacao("Deseja incluir o limite de desconto de t&iacute;tulos?","Confirma&ccedil;&atilde;o - Aimaro","gravaLimiteDscTit(\'I\', \''.$tipo.'\');","blockBackground(parseInt($(\'#divRotina\').css(\'z-index\')))","sim.gif","nao.gif");';
