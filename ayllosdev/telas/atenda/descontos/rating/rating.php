...
#frmRatingManutencao textarea#campoJustificativa { width: 220px; height:60px; margin: 0px 0px 0px 3px;}
...
<div id="divAlteracaoRating">
    <form name="frmRatingManutencao" id="frmRatingManutencao" class="formulario">
        <fieldset>
            ...
            <span class="contadorJustificativa" id="contadorJustificativa" style="font-size: 10px; float: right; margin-right: 45px; color: red;">0 caracter</span>
        </fieldset>
    </form>
    <div id="divBotoesFormRatingManutencao" style="margin-top:5px; margin-bottom:5px;" data-cdcooper="<?=$cdcooper?>" data-nrcpfcgc="<?=$nrcpfcgc?>" data-nrdconta="<?=$nrdconta?>" data-contrato="<?=$contrato?>">
        ...
        <a href="javascript:void(0);" class="botao" id="btSalvar" data-tipoproduto="<?=$tipoProduto?>">Continuar</a>
    </div>
</div>
