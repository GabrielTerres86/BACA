/***********************************************************************
   ...
   Altera??es: 02/10/2009 - Tratamento para listagem de depositos identificados no extrato (David).
               02/09/2010 - Ajuste na fun��o obtemSaldos (David).
               29/06/2011 - Imprimir Extrato - Alterado para layout padr�o (Rogerius - DB1).
               ...
               27/08/2015 - Ajuste para inclus�o da nova rotina "Cr�ditos Recebidos" (Gabriel - RKAM -> Projeto 127).
               14/10/2015 - Adicionado novos campos m�dia do m�s atual e dias �teis decorridos. SD 320300 (Kelvin).
               25/07/2016 - Adicionado fun��o controlaFoco (Evandro - RKAM)
               06/10/2016 - Incluido campo de valores bloqueados em acordos de empr�stimos "vlblqaco", Prj. 302 (Jean Michel).
               11/07/2017 - Novos campos Limite Pr�-aprovado dispon�vel e �ltima Atu. Lim. Pr�-aprovado na aba Principal, Melhoria M441. ( Mateus Zimmermann/MoutS )
               ...
               24/01/2018 - Na funcao controlaLayout havia erros de sintaxe ocasionando problemas na
                            formata��o da tela (Tiago #824708)
...
var contWin = 0;  // Vari�vel para contagem do n�mero de janelas abertas para impress�o de extratos
var dtiniper = "";
var dtfimper = "";
...
// Fun��o para confirmar saque na conta investimento
function obtemSaldos() {
	...
	// Executa script de saldos atrav�s de ajax
	$.ajax({
		type: "POST",
...
// Fun��o para validar impress�o do extrato
...
// Fun��o para imprimir extrato da conta em PDF
...
function validaLiberacaoSaque() {
	...
	if (vlpagto <= 0) {
		showError("inform", 'Informe o valor a ser liberado para saque.', "Alerta - Ayllos");
		return false;
	} else {
		return true;
	}
