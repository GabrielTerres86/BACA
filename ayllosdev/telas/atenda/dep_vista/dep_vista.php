					...
					<td>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td class="txtBrancoBold ponteiroDrag" background="<?php echo $UrlImagens; ?>background/tit_tela_fundo.gif">DEP&Oacute;SITOS &Agrave; VISTA</td>
								...
								<td>
									<table border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td align="center" style="background-color: #C6C8CA;" id="imgAbaCen1"><a href="#" id="linkAba1" class="txtNormalBold" onClick="acessaOpcaoAba(7,1,1);return false;">Extrato</a></td>
											...
											<td align="center" style="background-color: #C6C8CA;" id="imgAbaCen2"><a href="#" id="linkAba2" class="txtNormalBold" onClick="acessaOpcaoAba(7,2,2);return false;">M&eacute;dias</a></td>
											...
											<td align="center" style="background-color: #C6C8CA;" id="imgAbaCen3"><a href="#" id="linkAba3" class="txtNormalBold" onClick="acessaOpcaoAba(7,3,3);return false;">CPMF</a></td>
											...
											<td align="center" style="background-color: #C6C8CA;" id="imgAbaCen4"><a href="#" id="linkAba4" class="txtNormalBold" onClick="acessaOpcaoAba(7,4,4);return false;">Imprimir Extrato</a></td>
											...
											<td align="center" style="background-color: #C6C8CA;" id="imgAbaCen5"><a href="#" id="linkAba5" class="txtNormalBold" onClick="acessaOpcaoAba(7,5,5);return false;">Saldos Anteriores</a></td>
											...
											<td align="center" style="background-color: #C6C8CA;" id="imgAbaCen6"><a href="#" id="linkAba6" class="txtNormalBold" onClick="acessaOpcaoAba(7,6,6);return false;">Cash</a></td>
											...
											<td align="center" style="background-color: #C6C8CA;" id="imgAbaCen6"><a href="#" id="linkAba6" class="txtNormalBold" onClick="acessaOpcaoAba(7,7,7);return false;">Cr&eacute;d. Rec.</a></td>
