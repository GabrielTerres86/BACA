...
function acessaOpcaoCancelar() {
    ...
    showConfirmacao("Deseja cancelar a poupan&ccedil;a programada?", "Confirma&ccedil;&atilde;o - Aimaro", "cancelarPoupanca()", "blockBackground(parseInt($('#divRotina').css('z-index')))", "sim.gif", "nao.gif");
}
...
// Função para acessar opção para reativação da poupança
function acessaOpcaoReativar() {
    ...
    showConfirmacao("Deseja reativar a poupan&ccedil;a programada?", "Confirma&ccedil;&atilde;o - Aimaro", "reativarPoupanca()", "blockBackground(parseInt($('#divRotina').css('z-index')))", "sim.gif", "nao.gif");
}
...
// Função para acessar opção para suspender a poupança
...
// Função para validar resgate da poupança programada
...
// Função para consultar resgates da poupança programada
...
// Função para acessar opção para alterar a poupança
...
// Função para acessar opção para incluir poupança
...
// Função para validar inclusão de poupança programada
