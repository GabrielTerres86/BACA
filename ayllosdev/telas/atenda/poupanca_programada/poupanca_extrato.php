<?php 
	...
	//************************************************************************//
	//*** Fonte: poupanca_extrato.php                                      ***//
	//*** Autor: David                                                     ***//
	//*** Data : Março/2010                   Última Alteração: 13/07/2011 ***//
	//***                                                                  ***//
	//*** Objetivo  : Mostrar extrato da poupança programada               ***//	
	//***                                                                  ***//	 
...
<form action="" name="frmExtrato" id="frmExtrato" method="post">
	<fieldset>
		<legend><? echo utf8ToHtml('Poupança Programada:') ?></legend>
		...
		<input type="image" src="<?php echo $UrlImagens; ?>botoes/pesquisar.gif" onClick="extratoPoupanca();return false;" />
		<br style="clear:both;">
