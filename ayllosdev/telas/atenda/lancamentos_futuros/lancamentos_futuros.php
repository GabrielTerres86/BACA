          ...
          <td>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td id="<?php echo $labelRot; ?>" class="txtBrancoBold ponteiroDrag SetWindow SetFoco" background="<?php echo $UrlImagens; ?>background/tit_tela_fundo.gif">LAN&Ccedil;AMENTOS FUTUROS
                </td>
