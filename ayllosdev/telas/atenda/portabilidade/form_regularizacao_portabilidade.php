<?php
	/*!
	* FONTE        : form_regularizacao_portabilidade.php
	* CRIAÇÃO      : Andrey Formigari
	* DATA CRIAÇÃO : Janeiro/2019
	* OBJETIVO     : Mostrar rotina para regularizar portabilidade.
	* --------------
	* ALTERAÇÕES   :
	* --------------
	*/
	...
	$xml  = "<Root>";
	$xml .= " <Dados>";
	$xml .= "	<idsituacao>".$idstatus."</idsituacao>";
	$xml .= " </Dados>";
	$xml .= "</Root>";

	$xmlResult = mensageria($xml, "ATENDA", "BUSCA_MOTIVOS_REGULARIZA_PORTABILIDADE", $glbvars["cdcooper"], $glbvars["cdagenci"], $glbvars["nrdcaixa"], $glbvars["idorigem"], $glbvars["cdoperad"], "</Root>");
                    ...
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td class="txtBrancoBold ponteiroDrag" background="<?php echo $UrlImagens; ?>background/tit_tela_fundo.gif">REGULARIZAR PORTABILIDADE</td>
                        ...
                        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td align="center" style="border: 2px solid #969FA9; background-color: #F4F3F0; padding: 2px;">
                                    <form action="" method="post" name="frmRegularizarPortabilidade" id="frmRegularizarPortabilidade" class="formulario">
										...
										<div id="divDados" class="clsCampos">
											...
											<fieldset style="padding: 5px">
												...
												<label for="cdmotivo" class="clsCampos" style="width:145px">Motivo:</label>
									...
									<div id="divBotoes" style="padding: 5px">	
										<a class="botao" id="btConfirmar" href="#" onclick="confirmaRegularizarPortabilidade(false,'<?php echo $dsrowid; ?>')">Confirmar</a>
