<?php
	...
	*/
	...
	$dsmotivo  =  ( ( !empty($_POST['dsmotivo']) )   ? $_POST['dsmotivo']   : '' );
                                    ...
                                    <form action="" method="post" name="frmResponderContestacao" id="frmResponderContestacao" class="formulario">
										...
										<div id="divDados" class="clsCampos">
											...
											<fieldset style="padding: 5px">
												...
												<textarea style="width: 320px;height: 60px;margin-right: 37px;" id="dsmotivo" class="campoTelaSemBorda" readonly disabled><?=utf8_decode($dsmotivo);?></textarea>
												...
												<select id="cdmotivo" name="cdmotivo" class="campo FirstInput" style="width:320px">
													<option value=""></option>
												<?php
