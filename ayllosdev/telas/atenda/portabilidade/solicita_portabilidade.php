...
if (strtoupper($xmlObject->roottag->tags[0]->name) == "ERRO") {
	...
	exibirErro('error',addslashes($msgErro),'Alerta - Aimaro','bloqueiaFundo(divRotina)',false);
}

exibirErro('inform','Solicita&ccedil;&atilde;o de Portabilidade registrada com sucesso.','Alerta - Aimaro','acessaOpcaoAba(2,0,\"0\");bloqueiaFundo(divRotina)',false);
