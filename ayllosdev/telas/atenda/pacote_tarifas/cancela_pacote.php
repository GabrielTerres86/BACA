 ...
 **************************************************************************************/
	...
	if ($dtcancel >= $dtinivig){
		 exibirErro('inform','Opera&ccedil;&atilde;o efetuada com sucesso! </br> Os servi&ccedil;os contemplados no pacote permanecer&atilde;o vigentes at&eacute; o final deste m&ecirc;s.', 'Alerta - Ayllos', 'acessaOpcaoAba(1,0,0);', false);
	}else{
