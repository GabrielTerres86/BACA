          ...
          <td>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td id="<?php echo $labelRot; ?>" class="txtBrancoBold ponteiroDrag SetWindow SetFoco" background="<?php echo $UrlImagens; ?>background/tit_tela_fundo.gif">OCORRENCIAS
                </td>
                  ...
                  <table border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td align="center" style="background-color: #C6C8CA;" id="imgAbaCen0">
                        <a href="#" id="linkAba0" class="txtNormalBold" onClick="acessaOpcaoAba(6,0,0);return false;">Principal</a>
                      </td>
                      <td>
                      ...
                      <td align="center" style="background-color: #C6C8CA;" id="imgAbaCen1">
                        <a href="#" id="linkAba1" class="txtNormalBold" onClick="acessaOpcaoAba(6,1,1);return false;">Contra ordens</a>
                      </td>
                      <td>
                      ...
                      <td align="center" style="background-color: #C6C8CA;" id="imgAbaCen2">
                        <a href="#" id="linkAba2" class="txtNormalBold" onClick="acessaOpcaoAba(6,2,2);return false;">Empr&eacute;stimos</a>
                      </td>
                      <td>
                      ...
                      <td align="center" style="background-color: #C6C8CA;" id="imgAbaCen3">
                        <a href="#" id="linkAba3" class="txtNormalBold" onClick="acessaOpcaoAba(6,3,3);return false;">Preju&iacute;zos</a>
                      </td>
                      <td>
                      ...
                      <td align="center" style="background-color: #C6C8CA;" id="imgAbaCen4">
                        <a href="#" id="linkAba4" class="txtNormalBold" onClick="acessaOpcaoAba(6,4,4);return false;">SPC</a>
                      </td>
                      <td>
                      ...
                      <td align="center" style="background-color: #C6C8CA;" id="imgAbaCen5">
                        <a href="#" id="linkAba5" class="txtNormalBold" onClick="acessaOpcaoAba(6,5,5);return false;">Estouros</a>
                      </td>
                      <td>
                      ...
                      <td align="center" style="background-color: #C6C8CA;" id="imgAbaCen6">
                        <a href="#" id="linkAba6" class="txtNormalBold" onClick="acessaOpcaoAba(6,6,6);return false;">Grupo Economico</a>
                      </td>
                      <td>
                      ...
                      <td width="1"></td>
											...
											<td align="center" style="background-color: #C6C8CA;" id="imgAbaCen7">
												<a href="#" id="linkAba7" class="txtNormalBold" onClick="acessaOpcaoAba(7,7,7);return false;">Acordos</a>
											</td>
											<td>
