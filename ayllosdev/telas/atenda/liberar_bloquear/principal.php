 ...
 * OBJETIVO     : Mostrar opcao Principal da rotina de Liberar/Bloquear da tela ATENDA
 * --------------
...
<?	
	...
	$xmlResult = mensageria($xml, "ATENDA", "DESOPE_BUSCA", $glbvars["cdcooper"], $glbvars["cdagenci"], $glbvars["nrdcaixa"], $glbvars["idorigem"], $glbvars["cdoperad"], "</Root>");
