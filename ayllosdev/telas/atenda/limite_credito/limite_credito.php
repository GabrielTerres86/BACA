					...
					<td>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td id="tdTitRotina" class="txtBrancoBold  ponteiroDrag" background="<?php echo $UrlImagens; ?>background/tit_tela_fundo.gif">LIMITE DE CR&Eacute;DITO</td>
								...
								<td>
									<table border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td align="center" style="background-color: #C6C8CA;" id="imgAbaCen<?php echo $i; ?>"><a href="#" id="linkAba<?php echo $i; ?>" onClick="acessaOpcaoAba(<?php echo count($opcoesTela); ?>,<?php echo $i; ?>,'<?php echo $opcoesTela[$i]; ?>');return false;" class="txtNormalBold" name="<?php echo $opcoesTela[$i]; ?>"><?php echo $nameOpcao; ?></a></td>
