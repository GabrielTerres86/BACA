					...
					<td>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td class="txtBrancoBold ponteiroDrag" background="<?php echo $UrlImagens; ?>background/tit_tela_fundo.gif">LIMITE DE CREDITO</td>
...
<div id="divAlteracaoRating">
    ...
    <div id="divBotoesFormRatingManutencao" style="margin-top:5px; margin-bottom:5px; text-align: center;" data-nrdconta="<?=$nrdconta?>" data-nrcontrato="<?=$contrato?>">
