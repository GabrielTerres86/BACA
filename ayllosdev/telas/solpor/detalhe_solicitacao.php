                                    ...
                                    <div id="divCabecalho">
                                        <form class="formulario">
											...
											<fieldset style="margin-top:10px">
												...
												<label style="margin-left: 15px;width: 165px;" for="dt_regularizacao" class="clsCampos">Data:</label>
												<input style="margin-right: 5px;width: 115px;" type="text" id="dt_regularizacao" name="dt_regularizacao" readonly="readonly" class="campoTelaSemBorda" value="<?=$dtregularizacao?>" />
