 ...
 */ 
 ...
 $nrbanco = $_POST['nrbanco'];
 $nragencia = $_POST['nragencia'];
 $nrdconta = $_POST['nrdconta'];
 $datinicial  = $_POST['dtinicial'];
 $datfinal    = $_POST['dtfinal'];
 ...
 if($cdtipchq == 'I'){
	 ...
	 $qtregist  = getByTagName($registros[0]->tags,'qtregist');
	...
	<table class="tituloRegistros" id="tbChqsin" style="border: 1px solid #777; border-bottom: 0px;">
		<thead>
			<tr>
				...
				<? } ?>
				<th width="100px;"><? echo utf8ToHtml('Data') ?></th>
				<th width="100px;"><? echo utf8ToHtml('Bco. Sinistro') ?></th>
				<th width="100px;"><? echo utf8ToHtml('Agencia') ?></th>
				<th width="100px;"><? echo utf8ToHtml('Nr. da Conta') ?></th>
				<th width="130px;" id="nrcheque"><? echo utf8ToHtml('Nr. do Cheque') ?></th>
					...
					<tr style="text-align: center;" class="<?php echo $class; ?>" >
					   <? if( ($cdtipchq == 'O') && ($cddopcao == 'E1') ){ ?>
						...
						<?  if( ($cdtipchq == 'O') && ($cddopcao == 'E1') ){ ?>
							...
							<td width="110px;"  ><? echo mascara($nrctachq,'#.###.###-#');?></td>
							<td width="145px;"  id="nrcheque" ><? echo mascara($nrcheque,'####.###');?></td>
						<? }elseif(($cdtipchq == 'I') && (($cddopcao == 'E1') || ($cddopcao == 'C')) ) {?>
							...
							<td width="145px;" style="cursor: pointer" onclick="carregaBusca('<?php echo $datinclusao?>',<?php echo $codbanco; ?>, <?php echo $codagencia; ?>,<?php echo $nrctachq; ?>,'<?php echo $dscmotivo; ?>', '<?php echo $nrcheque; ?>')"><? echo mascara($nrctachq,'#.###.###-#');?></td>							
							<td width="145px;" style="cursor: pointer" id="nrcheque" onclick="carregaBusca('<?php echo $datinclusao?>',<?php echo $codbanco; ?>, <?php echo $codagencia; ?>,<?php echo $nrctachq; ?>,'<?php echo $dscmotivo; ?>', '<?php echo $nrcheque; ?>')"><? echo mascara($nrcheque,'####.###');?></td>
						<? }elseif( ($cdtipchq == 'O') && ($cddopcao == 'C') ){ ?>
							...
							<td width="110px;" style="cursor: pointer" onclick="carregaBusca('<?php echo $datinclusao?>',<?php echo $codbanco; ?>, <?php echo $codagencia; ?>,<?php echo $nrctachq; ?>,'<?php echo $dscmotivo; ?>', '<?php echo $nrcheque; ?>')"><? echo mascara($nrctachq,'#.###.###-#');?></td>
							<td width="145px;" style="cursor: pointer" id="nrcheque" onclick="carregaBusca('<?php echo $datinclusao?>',<?php echo $codbanco; ?>, <?php echo $codagencia; ?>,<?php echo $nrctachq; ?>,'<?php echo $dscmotivo; ?>', '<?php echo $nrcheque; ?>')"><? echo mascara($nrcheque,'####.###');?></td>
						<? } ?>
