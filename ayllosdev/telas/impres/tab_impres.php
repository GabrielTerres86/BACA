        ...
        <table class="tituloRegistros">
			<thead>
				<tr>
					...
					<th><? echo utf8ToHtml('Dt. Inic');  ?></th>
					<th><? echo utf8ToHtml('Dt. Final');  ?></th>
					<th><? echo utf8ToHtml('Trf');  ?></th>
					<th><? echo utf8ToHtml('Lista');  ?></th>
					<th><? echo utf8ToHtml('Sel');  ?></th>
					<th><? echo utf8ToHtml('Contrato');  ?></th>
					<th><? echo utf8ToHtml('Aplicac');  ?></th>
					<th><? echo utf8ToHtml('Ano');  ?></th>
					<th><? echo utf8ToHtml('Quando');  ?></th>
				</tr>
			</thead>
			<tbody>
				<? 
