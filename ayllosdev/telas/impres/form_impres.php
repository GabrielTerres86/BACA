...
<form name="frmImpres" id="frmImpres" class="formulario" onSubmit="return false;" style="display:none" >
  <fieldset>
    ...
    <div id='divTodos0'>
      <label for="tpmodelo">
        <? echo utf8ToHtml('Modelo:') ?>
      </label>
      <select name="tpmodelo" id="tpmodelo">
        <option value="1">Demonstrativo</option>
        <option value="2">
          <? echo utf8ToHtml('Extrato Analítico') ?>
        </option>
        <option value="3">
          <? echo utf8ToHtml('Extrato Sintético') ?>
        </option>
      </select>
      <br />
    </div>
    <label for="dtrefere">
      <? echo utf8ToHtml('Dt. Inic.:') ?>
    </label>
    <input name="dtrefere" id="dtrefere" type="text" value=""
    <? echo $dtrefere ?>" value="" />
		
    <label for="dtreffim">
      <? echo utf8ToHtml('Dt. Final:') ?>
    </label>
    <input name="dtreffim" id="dtreffim" type="text" value=""
    <? echo $dtreffim ?>" value="" />
    ...
    <div id='divTodos1'>
      ...
      <label for="nrctremp">
        <? echo utf8ToHtml('Contrato:') ?>
      </label>
      <input name="nrctremp" id="nrctremp" type="text" value=""
      <? echo $nrctremp ?>" value="" />
			
      <a style="margin-top:5px">
        <img id="lnrctremp" src=""
        <? echo $UrlImagens; ?>geral/ico_lupa.gif" />
      </a>
    ...
    <label for="nraplica">
      <? echo utf8ToHtml('Aplicac.:') ?>
    </label>
    <input name="nraplica" id="nraplica" type="text" value=""
    <? echo $nraplica ?>" value="" />
    ...
    <div id='divTodos2'>
      ...
      <input name="nranoref" id="nranoref" type="text" value=""
      <? echo $nranoref ?>" value="" />
