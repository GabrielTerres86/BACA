...
<form id="frmCab" name="frmCab" class="formulario cabecalho">
	...
	<select id="cddopcao" name="cddopcao">
		<?php if(in_array('H', $glbvars['opcoesTela']) && in_array($glbvars['cddepart'], $permisDptos['Historico'])) : ?>
			<option value="H" <?php echo $cddopcao == 'H' ? 'selected' : '' ?> >H - Hist&oacute;rico de envios para o BACEN</option>
		<?php endif; ?>
		<?php if(in_array('C', $glbvars['opcoesTela']) && in_array($glbvars['cddepart'], $permisDptos['Consultar'])) : ?>
