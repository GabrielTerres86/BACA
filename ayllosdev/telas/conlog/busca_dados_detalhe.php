<?php
  ...
  session_start();
	...
	$idprglog = isset($_POST["idprglog"]) ? $_POST["idprglog"] : '';
	...
	$xml .= "   <idprglog>".$idprglog."</idprglog>"; 
	...
	$xmlResult = mensageria($xml, "CONLOG", "CONSULTA_LOG_DET", $glbvars["cdcooper"], $glbvars["cdagenci"], $glbvars["nrdcaixa"], $glbvars["idorigem"], $glbvars["cdoperad"], "</Root>");
	...
	$detalhes = $xmlObj->roottag->tags[0]->tags;
	include('tab_log_detalhes.php');
