<?php 
	/**************************************************************************
	  Fonte: gera_impressao_ct.php
	  Autor: Diego Simas (AMcom)
	  Data : Setembro/2018                   Última Alteração:

	  Objetivo  : Gera o relatorio de estorno de pagamento de prejuizo de conta corrente.
	...
	**************************************************************************/
	...
	if (($msgError = validaPermissao($glbvars["nmdatela"], $glbvars["nmrotina"], "RCT")) <> "") {		
		exibeErro($msgError);
	}
	...
	$xmlResult = mensageria($xml, "PREJ0003", "ESTORNO_RELATORIO_PREJUIZO", $glbvars["cdcooper"], $glbvars["cdagenci"], $glbvars["nrdcaixa"], $glbvars["idorigem"], $glbvars["cdoperad"], "</Root>");
