...
function formataCampos() {
	...
	switch (cddopcao) {
		...
		case 'E':
			...
			cNrctremp.addClass('pesquisa').css({
				'width': '80px',
				'text-align': 'right'
			}).setMask('INTEGER', 'z.zzz.zzz.zzz', '.', '');

			rNrdconta.addClass('rotulo').css({
				width: "60px"
			});
			rNrctremp.addClass('rotulo-linha').css({
				width: "80px"
			});
		...
		case 'R':
			...
			rCdagenci.addClass('rotulo-linha').css({
				'width': '90px'
			});
...
function controlaPesquisas() {
	...
	if (linkContrato.prev().hasClass('campoTelaSemBorda')) {
		linkContrato.addClass('lupa').css('cursor', 'auto').unbind('click').bind('click', function () {
			return false;
		});
	} else {
...
function formataDetalhesEstorno() {
	...
	cCdestorno.addClass('campo').css({
		'width': '80px'
	});
	cNmoperad.addClass('campo').css({
		'width': '220px'
	});
	cDtestorno.addClass('campo').css({
		'width': '80px'
	});
	cHrestorno.addClass('campo').css({
		'width': '70px'
	});
	cDsjustif.addClass('alphanum').css({
		'width': '562px',
	...
	rCdestorno.addClass('rotulo').css({
		'width': '80px'
	});
	rNmoperad.addClass('rotulo').css({
		'width': '80px'
	});
	rDtestorno.addClass('rotulo-linha').css({
		'width': '50px'
	});
	rHrestorno.addClass('rotulo-linha').css({
		'width': '50px'
	});
	rDsjustif.addClass('rotulo').css({
		width: "80px"
