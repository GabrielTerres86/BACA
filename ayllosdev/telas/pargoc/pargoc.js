 ...
 * OBJETIVO     : Biblioteca de funções da tela PARGOC
 * --------------
 * ALTERAÇÕES   : 
 *
 * --------------
...
function formataCabecalho() {
	...
	// Campos
	$("#cddopcao","#frmCab").css("width","200px").habilitaCampo();
	$("#cdcooper","#frmCab").css("width","120px");
	...
	$.ajax({		
		...
		data:
			{ 
				...
				inresgate_automatico : inresgate_automatico,  // Resgate Automático
				qtdias_atraso_permitido : qtdias_atraso_permitido,  // Dias de atraso p/ resgate automático
				peminimo_cobertura : peminimo_cobertura.replace(',','.'),  // % Mín Cobertura p/ Garantia
				redirect : 'script_ajax'
			},
		error: function(objAjax,responseError,objExcept) {
			hideMsgAguardo();
...
/**
 * Funcao para habilitar ou desabilitar o campo "Dias de atraso p/ resgate automático"
 */
