<?php
	...
	*/
	...
	$cdcooper   = (isset($_POST["cdcooper"]))    ? $_POST["cdcooper"]    : ""; // conta contabil a ser validada
	...
	$xmlResult = mensageria($xml, "SLIP", "BUSCA_SEQ", $glbvars["cdcooper"], $glbvars["cdagenci"], $glbvars["nrdcaixa"], $glbvars["idorigem"]                    , $glbvars["cdoperad"],  "</Root>");
	...
	// Se ocorrer um erro, mostra crítica
 	if ($dscritic != "") {
		...
		foreach($xmlObjeto->seq as $seq){

			$flgconsulta = True;
			$command .=  "setSeq(".$seq->nrseq.");";
		}
