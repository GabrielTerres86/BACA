...
function formataFormulario() {
	...
	rDtrecped.css('width','100px').addClass('rotulo-linha');
	...
	rVlcheque.css('width','100px').addClass('rotulo-linha');
	...
	rNrctadep.css('width','100px').addClass('rotulo-linha');
	...
	rDtlibtic.css('width','100px').addClass('rotulo-linha');	
	
	
	cTodos.desabilitaCampo();
	cNrpedido.css({'width': '98px'});
	cDtsolped.css({'width': '98px'}).addClass('data');
	cDtrecped.css({'width': '98px'}).addClass('data');	
