<?php
/*!
 * FONTE        : busca_contratos_gravames.php                  Última alteração: 14/07/2016
 * CRIAÇÃO      : Andrei (RKAM)
 * DATA CRIAÇÃO : Maio/2016 
 * OBJETIVO     : Rotina para buscar os contratos/gravames
 * --------------
 * ALTERAÇÕES   :  14/07/2016 - Ajuste para este fonte considerar apenas a busca de contratos
                                (Andrei - RKAM).
 */
?> 
...
<?php	
  ...
  $xml 	   .= "     <nriniseq>".$nriniseq."</nriniseq>";
	...
	$xmlResult = mensageria($xml, "TELA_GRAVAM", "BUSCACONTRATOS", $glbvars["cdcooper"], $glbvars["cdagenci"], $glbvars["nrdcaixa"], $glbvars["idorigem"], $glbvars["cdoperad"], "</Root>");
					...
					<td>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td class="txtBrancoBold ponteiroDrag" background="<?php echo $UrlImagens; ?>background/tit_tela_fundo.gif">Contratos</td>
				...
				<tr>
					<td class="tdConteudoTela" align="center">	
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
                          ...
                          $nrctrpro = getByTagName($contratos[$i]->tags,'nrctrpro');
                                                         
                          ?>
                          <tr>
														  <td><span><? echo $nrctrpro ?></span>
															  <? echo $nrctrpro; ?>
															
														  </td>
														  <input type="hidden" id="nrctrpro" value="<?echo $nrctrpro;?>"/>
...
<script type="text/javascript">
  ...
  formataTabelaContratosGravames('C');
