<? 
/*!
 * FONTE        : form_reltar.php
 * CRIAÇÃO      : Daniel Zimmermann
 * DATA CRIAÇÃO : 19/03/2013 
 * OBJETIVO     : Form da tela RELTAR
 * --------------
...
<form id="frmReltar" name="frmReltar" style="display:none" class="formulario">
	...
	<table width="100%">
		...
		<tr>		
			<td>					
				<label for="cddgrupo">SubGrupo:</label>
	...
	<table width="100%">
			...
			<tr> 
				<td>
					<label for="flgresum">Resumido:</label>
					<input type="checkbox" id="flgresum" name="flgresum" />
				</td>
			</tr>			
			<tr>		
				<td>
