...
<?	
	...
	$retornoAposErro = 'focaCampoErro(\'cddgrupo\', \'frmReltar\');';
	...
	echo "$('#dsdgrupo','#frmReltar').val('$dsdgrupo');";
	echo "$('#cddgrupo','#frmReltar').desabilitaCampo();";
	echo "$('#cdsubgru','#frmReltar').focus();";		
