 ...
 * 
 * @autor: Amasonas Borges Vieira Junior(Supero)
 */
require_once('../class/class_rest_server_json.php');
class RestCartao extends RestServerJson{
    
    private $aParamsRequired;
    
    public function __construct(){
        $this->aParamsRequired = array('protocolo','indicadoresGeradosRegra','sugestaoCartaoCecred');
            ...
            if (!$this->validaParametrosRecebidos($oDados)){
               // return false;            
			    ...
			    //  $xml .= "   <dsprotoc>".$oDados->protocolo."</dsprotoc>";
                 ...
                 /* $xml .= "   <cartoes> ";
                  foreach($oDados->sugestaoCartaoCecred as $sugestao){

                    $xml .= "   <cartao> ";   
                        $xml .= "   <codigoCategoria>".$sugestao->codigoCategoria." </codigoCategoria>";
                        $xml .= "   <descricaoCategoria>".$sugestao->descricaoCategoria."</descricaoCategoria>";
                        $xml .= "   <vlLimite>".$sugestao->vlLimite."</vlLimite>";
                    $xml .= "   </cartao> ";                      
                  }               
                  $xml .= "   </cartoes> ";*/
			      $xml .= " </Dados>";
			      ...
			      $sXmlResult = mensageria($xml, "WEBS0001", "WEBS0001_CARTAO_MOTOR", 0, 0, 0, 5, 0, "</Root>");
