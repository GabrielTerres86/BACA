...
/*****************************************************************
  ...
  Objetivo     : Mostrar os filtros para da tela CADNAC
  --------------
	Alterações   :  
...
<form id="frmFiltro" name="frmFiltro" class="formulario" style="display:none;">	
	...
	<fieldset id="fsetFiltro" name="fsetFiltro" style="padding:0px; margin:0px; padding-bottom:10px;">
        ...
        <input name="cdnacion" id="cdnacion" type="text" class="codigo pesquisa" />        
		<a><img src="<? echo $UrlImagens; ?>geral/ico_lupa.gif"></a>
        <input name="dsnacion" id="dsnacion" type="text" />
