...
<center>
<div id="divConsulta" name="divConsulta" style="width: 800px;">
	<form id="frmConsulta" name="frmConsulta" class="formulario" target="blank" method="POST">
		<fieldset>
			<legend>Consultar T&iacute;tulos Agendados</legend>
			<table width="100%" >
				<tr>
					<td>
