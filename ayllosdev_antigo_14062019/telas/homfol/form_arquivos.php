<?
/*!
 * FONTE        : form_adrquivos.php
 * CRIAÇÃO      : Renato Darosci
 * DATA CRIAÇÃO : Julho/2015
 * OBJETIVO     : Formulario para tela HOMFOL
 * --------------
 * ALTERAÇÕES   : 
 * --------------
...
?>
<center>
<div id="divArquivos" name="divArquivos" style="width: 750px;">
	<form id="frmArquivo" name="frmArquivo" class="formulario" enctype="multipart/form-data" style="display:none">
		<fieldset>
			<legend>Enviar Arquivo de Folha de Pagamento</legend>
			<table width="100%" >
				<tr>		
					<td>
	...
	<form id="frmComprovante" name="frmComprovante" class="formulario" enctype="multipart/form-data" style="display:none">
		<fieldset>
			<legend>Enviar Comprovante de Folha de Pagamento</legend>
			<table width="100%" >
				<tr>		
					<td>
						<div id="divuploadfile" style="height: 30px;" center>
