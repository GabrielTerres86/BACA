...
/* !
 * FONTE        : db_alterar_dados.php
 * CRIAÇÃO      : Renato Darosci (Supero)
 * DATA CRIAÇÃO : 08/11/2016
 * OBJETIVO     : Rotina para alterar os dados do PA Administrativo. 
 * --------------
 * ALTERAÇÕES   : 
 * -------------- 
 */
...
$xmlResult = mensageria($xml, "TELA_CADPAA", "ALTERA_PA_ADMIN", $glbvars["cdcooper"], $glbvars["cdagenci"], $glbvars["nrdcaixa"], $glbvars["idorigem"], $glbvars["cdoperad"], "</Root>");	
