 ...
 * OBJETIVO     : Biblioteca de funções da tela estprj
 * --------------
...
function carregaTelaFiltrarContrato(){
	...
	$.ajax({
		type: "POST",
		url: UrlSite + "telas/estprj/carrega_tela_estorno_pagto.php",
		dataType: "html",
		data: {			
...
function manterRotina(operacao){
	...
	$.ajax({
		type: "POST",
		url: UrlSite + "telas/estprj/manter_rotina.php", 
		data: {
			operacao: operacao,
...
function carregaTelaConsultarPagto(){
    ...
    $.ajax({
        type: 'POST',
        dataType: 'html',
        url: UrlSite + 'telas/estprj/carrega_consulta_pagto.php',
        data:{
			cddopcao: cCdopcao.val(),
		    dtpagto:  cDtpagto.val(),
		    nrdconta: normalizaNumero(cNrdconta.val()),
            nrctremp: normalizaNumero(cNrctremp.val()),
            redirect: 'script_ajax'
...
function carregaTelaEstornar(cNrdconta1, cNrctremp1, cDtmvtolt, cIdtipo, confirm){
    ...
    $.ajax({
        type: 'POST',
        dataType: 'html',
        url: UrlSite + 'telas/estprj/estornar_pagto.php',
        data:{
			nrdconta1: cNrdconta1,
...
function carregaEstornarTodos(){
    ...
    $.ajax({
        type: 'POST',
        dataType: 'html',
        url: UrlSite + 'telas/estprj/estornar_todos_pagto.php',
...
/*function carregaPagtoEpr(cNrdconta, cNrctremp, cVlpagto, cVlabono){
    ...
    $.ajax({
        type: 'POST',
        dataType: 'html',
        url: UrlSite + 'telas/estprj/forcar_pagto.php',
...
function mostraContrato() {
	...
	$.ajax({		
		type: 'POST',
		dataType: 'html',
		url: UrlSite + 'telas/estprj/contrato.php', 
		data: {
			redirect: 'html_ajax'			
		}, 
		error: function(objAjax,responseError,objExcept) {
...
function buscaContrato() {
    ...
    $.ajax({
        type: 'POST',
        dataType: 'html',
        url: UrlSite + 'telas/estprj/busca_contrato.php',
        data: {
            nrdconta: nrdconta,
            redirect: 'script_ajax'
        },
