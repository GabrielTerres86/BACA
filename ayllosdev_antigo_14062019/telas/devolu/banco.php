 ...
 * OBJETIVO     : Exibe a tela de Opcoes de Banco - Tela DEVOLU
 * --------------
 * ALTERAÇÕES   : 
 * --------------
 */	 
					...
					<td>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td class="txtBrancoBold ponteiroDrag" background="<?php echo $UrlImagens; ?>background/tit_tela_fundo.gif"><? echo utf8ToHtml('ESCOLHA UMA DAS OPCOES:') ?></td>
