...
function acessaOpcaoAba(nrOpcoes, id, opcao) {
    ...
    $.ajax({
        type: 'POST',
        dataType: 'html',
        url: UrlSite + 'telas/cadcta/comercial/principal.php',
        data: {
            nrdconta: nrdconta,
            idseqttl: idseqttl,
            flgcadas: flgcadas,
...
function manterRotina(operacao) {
    ...
    $.ajax({
        type: 'POST',
        url: UrlSite + 'telas/cadcta/comercial/manter_rotina.php',
        data: {
...
function controlaLayout(operacao) {
    ...
    if (operacao == 'CA' || operacao == 'CAE') {
        ...
        // TELA PERMITE ALTERAR APENAS CDEMPRESA
        ...
        if ((cCodNatOcupacao.val() != 11) && (cCodNatOcupacao.val() != 12) && (cTpCrtTrb.val() != 3 && cTpCrtTrb.val() != '')) {
...
function tabela(qtlinhas) {
    ...
    var divRegistro = $('#divRendimentos div.divRegistros');
...
function gravaRendimentos() {
    ...
    $.ajax({
        type: "POST",
        url: UrlSite + 'telas/cadcta/comercial/grava_rendimentos.php',
        data: {
            nrdconta: nrdconta, idseqttl: idseqttl,
...
function buscaRendimentos(nriniseq, nrregist) {
    ...
    $.ajax({
        type: "POST",
        url: UrlSite + 'telas/cadcta/comercial/busca_rendimentos.php',
        data: {
...
function buscaReferenciaFolha(nrdconta) {
    ...
    $.ajax({
        type: "POST",
        url: UrlSite + 'telas/cadcta/comercial/busca_rendas_automaticas.php',
        data: {
            nrdconta: nrdconta,
