<?php 
	...
	//************************************************************************//
	//*** Fonte: validar_novo_limite.php                                   ***//
	//*** Autor: David                                                     ***//
	//*** Data : Março/2007                   Última Alteração: 27/10/2010 ***//
	//***                                                                  ***//
	//*** Objetivo  : Validar Novo Limite de Crédito - rotina de Limite de ***//
	//***             Crédito da tela ATENDA                               ***//
	//***                                                                  ***//	 
	//*** Alterações: 27/10/2010 - Tratamento para projeto de linhas de    ***//
	/****                          crédito (David).                        
	
				      22/11/2012 - Ajustes refentes ao projeto GE (Adriano).
	...
	************************************************************************/
	...
	$xmlSetLimite .= "		<Proc>validar-novo-limite</Proc>";
	$xmlSetLimite .= "	</Cabecalho>";
	$xmlSetLimite .= "	<Dados>";
	...
	if (count($mensagem) > 0) {
		...
		// Se for aviso de consulta ao SCR, só mostra notificação e mostra mensagem de confirmação para cadastro do novo limite
		if ($inconfir == "3") {		
			...
			exibeConfirmacao($dsmensag);
			
		}else{
		
			echo 'aux_inconfir = "'.($inconfir + 1).'";';
			exibeConfirmacao($dsmensag);
