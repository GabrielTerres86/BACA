...
<div id="divAlteracaoRating">
    ...
    <div id="divBotoesFormRatingManutencao" style="margin-top:5px; margin-bottom:5px;" data-cdcooper="<?=$cdcooper?>" data-nrcpfcgc="<?=$nrcpfcgc?>" data-nrdconta="<?=$nrdconta?>" data-nrctremp="<?=$nrctremp?>">
