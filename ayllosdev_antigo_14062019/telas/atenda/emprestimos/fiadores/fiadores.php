 ...
 * OBJETIVO     : Mostra rotina de Fiadores da tela de CONTAS
 */	 
?>
...
?>
<table id="tbfiador" cellpadding="0" cellspacing="0" border="0" >
	<tr>
		<td align="center">		
					...
					<td>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td class="txtBrancoBold ponteiroDrag" background="<?php echo $UrlImagens; ?>background/tit_tela_fundo.gif">FIADOR = <? echo formataContaDV($nrctaava) ?> - <? echo $nmdavali ?></td>
