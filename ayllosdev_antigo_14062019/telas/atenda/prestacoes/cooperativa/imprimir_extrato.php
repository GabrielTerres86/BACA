 ...
 * 002: [31/10/2014] Alterado a chamada da procedure gera-impextepr para Gera_Impressao (Jean Michel). 
 * 003: [31/10/2014] Alterado o visualização do erro (Jean Michel). 
 * 004: [29/12/2014] Ajustato os parametros "intpextr" e "tpextrat" (Douglas/Gielow)
 */
	...
	$xml.= "		<flgtarif>?</flgtarif>";
	$xml.= "		<inrelext>?</inrelext>";
	$xml.= "		<inselext>1</inselext>";
	$xml.= "		<nrctremp>".$nrctremp."</nrctremp>";
	$xml.= "		<nraplica>?</nraplica>";
	$xml.= "		<nranoref>?</nranoref>";        
