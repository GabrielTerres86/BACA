<?
/*!
 * FONTE        : inf_adicionais.php
 * CRIAÇÃO      : Gabriel Capoia (DB1)
 * DATA CRIAÇÃO : Abril/2010 
 * OBJETIVO     : Mostrar rotina de Inf. Adicionais da tela CONTAS
 *
 * ALTERACOES   : 06/08/2015 - Reformulacao Cadastral (Gabriel-RKAM)
 */	
?>
					...
					<td>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td class="txtBrancoBold ponteiroDrag" background="<?php echo $UrlImagens; ?>background/tit_tela_fundo.gif">INF. ADICIONAIS</td>
