...
function acessaOpcaoAbaDados(nrOpcoes,id,opcao) {
	...
	for (var i = 0; i < nrOpcoes; i++) {
		...
		if (arr_guias_contacorrente[i] || flgcadas != 'M') { // Se ja passou por esta rotina, cor cinza senao vermelho (Quando vem da MATRIC)
	...
	switch (id) {
		...
		case 2: {
			nmdireto  = "informativos";
			nmrotina  = "Informativos";
			break;
		}
		case 3: {
			nmdireto  = "inf_adicionais";
			nmrotina  = "Financeiro-inf.adicionais";
			break;
		}
	} 
