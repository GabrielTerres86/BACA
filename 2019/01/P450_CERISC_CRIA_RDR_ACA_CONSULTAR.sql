...
declare 
  ...
  -- ALTERAR
  NOME_DA_ACAO VARCHAR2(40) := 'CERISC_CONSULTAR';
  PROCEDURE_DA_ACAO VARCHAR2(100) := 'pc_consultar';
  PACKAGE_DA_ACAO VARCHAR2(100) := 'TELA_CERISC';
  PARAMETROS_DA_ACAO VARCHAR2(1000):= '';
  -- FIM ALTERAR
