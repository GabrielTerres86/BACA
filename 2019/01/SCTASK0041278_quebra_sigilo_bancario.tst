...
BEGIN
  ...
  */
  ...
  vr_referencia := 'RITM0038970';
  -- Data que deve ocorrer a quebra de sigilo bancário
  vr_dtinicio   := TO_DATE('01/08/2018','DD/MM/YYYY');
  vr_dtfim      := TO_DATE('01/11/2018','DD/MM/YYYY'); 
  
  vr_tbconta_investigar('009_0000001619_082604042000104').cdcooper := 9;
  vr_tbconta_investigar('009_0000001619_082604042000104').nrdconta := 1619;
  vr_tbconta_investigar('009_0000001619_082604042000104').nrcpfcgc := 82604042000104;   
