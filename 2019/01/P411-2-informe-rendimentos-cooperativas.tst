...
declare 
  ...
  -- Roda para todas as cooperativas exceto a Viacredi
  ...
  vr_nmarqimp        VARCHAR2(100)  := 'cooper-log.txt';
  vr_nmarqimp2       VARCHAR2(100)  := 'cooper-sucesso.txt';
  vr_nmarqimp3       VARCHAR2(100)  := 'cooper-falha.txt';
  vr_nmarqimp4       VARCHAR2(100)  := 'cooper-backup.txt';
  ...
  select ass.cdcooper
        ...
        ,ass.inpessoa
    from crapass ass
   where ass.cdcooper <> 1 /* exceto viacredi */
     and exists (select 1 
                   from craprac rac
