...
Provavelmente, em alguma conta física de algum cooperado que trabalhava na Casas da água e agora está aposentado, foi informado no campo nome da empresa INSS, porém, não deve ter sido excluído o CNPJ da Casas da Água, 
e o sistema deve ter travado gravando esta informação.
...
begin
  ...
  UPDATE TBCADAST_PESSOA c
   SET c.NMPESSOA ='CASAS DA AGUA'
 WHERE c.NRCPFCGC =13501187000400;
