begin
  ...
  begin
    ...
    begin
		...
		delete tbgen_notif_push a where a.cdnotificacao in(select a.cdnotificacao from cecred.tbgen_notificacao a where a.cdmensagem in (1128,1129,1130,1131,1132,1133)  and trunc(a.dhcadastro) < to_date('16/12/2019','DD/MM/RRRR'));
		dbms_output.put_line('Sucesso ao executar delete de registros de PUSH da "tbgen_notif_push" ');
		delete cecred.tbgen_notificacao a where a.cdmensagem in (1128,1129,1130,1131,1132,1133)   and trunc(a.dhcadastro) < to_date('16/12/2019','DD/MM/RRRR');
