...
191
declare 
   pr_dtmvtolt  date := to_date('30/09/2019','dd/mm/rrrr');
   pr_dtmvtolt2 date := to_date('30/11/2019','dd/mm/rrrr');
...
begin
   ...
   IF vr_tab_utlz_crd.COUNT = 0 THEN
     ...
     raise vr_exc_erro;
   ELSE
     FOR idx IN vr_tab_utlz_crd.FIRST .. vr_tab_utlz_crd.LAST
         LOOP             
