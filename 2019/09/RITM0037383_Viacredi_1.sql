...
DECLARE 
  ...
  vr_arq_path  VARCHAR2(1000):= gene0001.fn_diretorio(pr_tpdireto => 'M', 
                                                      pr_cdcooper => 0, 
                                                      pr_nmsubdir => 'cpd/bacas/'); --'/usr/coopd3/sistemad3/equipe/tiago/'; --> Diretorio que sera criado o relatorio

--\\pkgdesen1\micros\cpd\bacas

  vr_nmarquiv  VARCHAR2(100) := 'Viacredi_ITG.txt';
  vr_nmarqbkp  VARCHAR2(100) := 'ROLLBACK_Viacredi_ITG.sql';
