 ...
 *
 * 
 * CCR30201165857522712201875632390126590005474080098880642ARTUR B GMIGUEL        09021966201020146970665968    010200                                                                                               00019722A16CF8C89A61300000        SSPSCARTUR BERNARDO GRANZOTTO MIGUEL                                                 7563239000002956845N
 *
 *  
 */
declare 
  ...
  CURSOR cr_crawcrd_ant (pr_cdcooper  IN crawcrd.cdcooper%TYPE
    ...
    SELECT crd.*
     ...
     WHERE crd.cdcooper = pr_cdcooper
       ...
       AND crd.nrcrcard = 5474080079207732; -- Cartao 
...
begin
  BEGIN
    vr_des_text := 'CCR30201165857522712201875632390126590005474080098880642ARTUR B GMIGUEL        09021966201020146970665968    010200                                                                                               00019722A16CF8C89A61300000        SSPSCARTUR BERNARDO GRANZOTTO MIGUEL                                                 7563239000002956845N';
    ...
    IF substr(vr_des_text,5,2) = '02'  THEN
      ...
      vr_nrctrcrd := 1311338;--fn_sequence('CRAPMAT','NRCTRCRD', vr_cdcooper);
      ...
      BEGIN
        ...
        VALUES
           (vr_nrdconta,                                      -- nrdconta
            ...
            to_date('30/04/2024','dd/mm/rrrr'),               -- dtvalida
            1,                                                -- flgimpnp
            1,                                                -- tpenvcrd
            1,                                                -- flgprcrd
            6)                                                -- insitcrd
