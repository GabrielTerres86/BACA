...
declare 
  ...
  -- ALTERAR
  NOME_DA_ACAO VARCHAR2(40) := 'SEGEMP_ALTERA_SEG';
  PROCEDURE_DA_ACAO VARCHAR2(100) := 'pc_editar_segmento';
  PACKAGE_DA_ACAO VARCHAR2(100) := 'TELA_SEGEMP';
  PARAMETROS_DA_ACAO VARCHAR2(1000):= 'pr_idsegmento, pr_dssegmento, pr_qtsimulacoes_padrao, pr_nrvariacao_parc, pr_nrmax_proposta, pr_nrintervalo_proposta, pr_dssegmento_detalhada, pr_qtdias_validade, pr_perm_pessoa_fisica, pr_perm_pessoa_juridica';
  -- FIM ALTERAR
