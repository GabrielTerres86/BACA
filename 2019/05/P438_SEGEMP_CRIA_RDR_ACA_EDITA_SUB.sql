...
declare 
  ...
  -- ALTERAR
  NOME_DA_ACAO VARCHAR2(40) := 'SEGEMP_ALTERA_SUB';
  PROCEDURE_DA_ACAO VARCHAR2(100) := 'pc_editar_Subsegmento';
  PACKAGE_DA_ACAO VARCHAR2(100) := 'TELA_SEGEMP';
  PARAMETROS_DA_ACAO VARCHAR2(1000):= 'pr_idsegmento, pr_idsubsegmento, pr_dssubsegmento, pr_cdlinha_credito, pr_cdfinalidade, pr_flggarantia, pr_tpgarantia, pr_pemax_autorizado, pr_peexcedente, pr_vlmax_proposta';
  -- FIM ALTERAR
