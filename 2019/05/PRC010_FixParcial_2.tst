...
957
-- Created on 24/05/2019 by T0031859 
declare 
-- Criticas
  ...
  SELECT bdt.cdcooper, bdt.cdagenci, bdt.cdbccxlt AS nrdcaixa, bdt.nrborder, 
         tdb.nrdconta, tdb.cdbandoc, tdb.nrdctabb, tdb.nrcnvcob, tdb.nrdocmto, tdb.nrtitulo,
         CASE 
           WHEN (tdb.cdcooper = 1 AND tdb.nrborder = 548804 AND tdb.nrdocmto = 3052147) THEN  183.88
           WHEN (tdb.cdcooper = 1 AND tdb.nrborder = 553375 AND tdb.nrdocmto = 3052151) THEN 6751.23
           WHEN (tdb.cdcooper = 1 AND tdb.nrborder = 558863 AND tdb.nrdocmto = 5541)    THEN 1671.66
           WHEN (tdb.cdcooper = 1 AND tdb.nrborder = 547167 AND tdb.nrdocmto = 251)     THEN 3366.11
             
           WHEN (tdb.cdcooper = 5 AND tdb.nrborder = 14229 AND tdb.nrdocmto = 866)      THEN 1071.18
           WHEN (tdb.cdcooper = 5 AND tdb.nrborder = 14229 AND tdb.nrdocmto = 869)      THEN 1567.84
           WHEN (tdb.cdcooper = 5 AND tdb.nrborder = 14350 AND tdb.nrdocmto = 696)      THEN 1722.93 
             
           WHEN (tdb.cdcooper = 9 AND tdb.nrborder = 60784 AND tdb.nrdocmto = 9038801)  THEN 400.00 
           WHEN (tdb.cdcooper = 9 AND tdb.nrborder = 60304 AND tdb.nrdocmto = 1718)     THEN 341.43 
           WHEN (tdb.cdcooper = 9 AND tdb.nrborder = 60849 AND tdb.nrdocmto = 1326)     THEN 719.75 
           WHEN (tdb.cdcooper = 9 AND tdb.nrborder = 60890 AND tdb.nrdocmto = 1339)     THEN 1332.63 
           WHEN (tdb.cdcooper = 9 AND tdb.nrborder = 60890 AND tdb.nrdocmto = 1340)     THEN 1332.63 
           WHEN (tdb.cdcooper = 9 AND tdb.nrborder = 60990 AND tdb.nrdocmto = 1342)     THEN 228.00 
           WHEN (tdb.cdcooper = 9 AND tdb.nrborder = 61176 AND tdb.nrdocmto = 1347)     THEN 528.00 
           WHEN (tdb.cdcooper = 9 AND tdb.nrborder = 61176 AND tdb.nrdocmto = 1350)     THEN 587.00 
           WHEN (tdb.cdcooper = 9 AND tdb.nrborder = 61176 AND tdb.nrdocmto = 1355)     THEN 570.00 
           WHEN (tdb.cdcooper = 13 AND tdb.nrborder = 38033 AND tdb.nrdocmto = 547)    THEN 2781.09
           WHEN (tdb.cdcooper = 13 AND tdb.nrborder = 38146 AND tdb.nrdocmto = 166)    THEN 2744.04
           WHEN (tdb.cdcooper = 13 AND tdb.nrborder = 38293 AND tdb.nrdocmto = 1149)    THEN 5266.10
           WHEN (tdb.cdcooper = 13 AND tdb.nrborder = 38390 AND tdb.nrdocmto = 1151)    THEN 1888.35
           WHEN (tdb.cdcooper = 13 AND tdb.nrborder = 38390 AND tdb.nrdocmto = 1153)    THEN 5270.11
           WHEN (tdb.cdcooper = 13 AND tdb.nrborder = 38390 AND tdb.nrdocmto = 1154)    THEN 1872.07
           WHEN (tdb.cdcooper = 13 AND tdb.nrborder = 38507 AND tdb.nrdocmto = 1155)    THEN 10885.28
           WHEN (tdb.cdcooper = 14 AND tdb.nrborder = 38104 AND tdb.nrdocmto = 1329)    THEN 438.10
         ELSE 0 END AS VLRPAGTO ,
         CASE 
           WHEN (tdb.cdcooper = 1 AND tdb.nrborder = 548804 AND tdb.nrdocmto = 3052147) THEN to_date('10/05/2019', 'DD/MM/RRRR')
           WHEN (tdb.cdcooper = 1 AND tdb.nrborder = 553375 AND tdb.nrdocmto = 3052151) THEN to_date('10/05/2019', 'DD/MM/RRRR')
           WHEN (tdb.cdcooper = 1 AND tdb.nrborder = 558863 AND tdb.nrdocmto = 5541)    THEN to_date('20/05/2019', 'DD/MM/RRRR')
           WHEN (tdb.cdcooper = 1 AND tdb.nrborder = 547167 AND tdb.nrdocmto = 251)     THEN to_date('17/05/2019', 'DD/MM/RRRR')
             
           WHEN (tdb.cdcooper = 5 AND tdb.nrborder = 14229 AND tdb.nrdocmto = 866)      THEN to_date('10/05/2019', 'DD/MM/RRRR')
           WHEN (tdb.cdcooper = 5 AND tdb.nrborder = 14229 AND tdb.nrdocmto = 869)      THEN to_date('10/05/2019', 'DD/MM/RRRR')
           WHEN (tdb.cdcooper = 5 AND tdb.nrborder = 14350 AND tdb.nrdocmto = 696)      THEN to_date('17/05/2019', 'DD/MM/RRRR')
             
           WHEN (tdb.cdcooper = 9 AND tdb.nrborder = 60784 AND tdb.nrdocmto = 9038801)  THEN to_date('07/05/2019', 'DD/MM/RRRR')
           WHEN (tdb.cdcooper = 9 AND tdb.nrborder = 60304 AND tdb.nrdocmto = 1718)     THEN to_date('17/05/2019', 'DD/MM/RRRR')
           WHEN (tdb.cdcooper = 9 AND tdb.nrborder = 60849 AND tdb.nrdocmto = 1326)     THEN to_date('15/05/2019', 'DD/MM/RRRR')
           WHEN (tdb.cdcooper = 9 AND tdb.nrborder = 60890 AND tdb.nrdocmto = 1339)     THEN to_date('06/05/2019', 'DD/MM/RRRR')
           WHEN (tdb.cdcooper = 9 AND tdb.nrborder = 60890 AND tdb.nrdocmto = 1340)     THEN to_date('10/05/2019', 'DD/MM/RRRR')
           WHEN (tdb.cdcooper = 9 AND tdb.nrborder = 60990 AND tdb.nrdocmto = 1342)     THEN to_date('17/05/2019', 'DD/MM/RRRR')
           WHEN (tdb.cdcooper = 9 AND tdb.nrborder = 61176 AND tdb.nrdocmto = 1347)     THEN to_date('20/05/2019', 'DD/MM/RRRR')
           WHEN (tdb.cdcooper = 9 AND tdb.nrborder = 61176 AND tdb.nrdocmto = 1350)     THEN to_date('17/05/2019', 'DD/MM/RRRR')
           WHEN (tdb.cdcooper = 9 AND tdb.nrborder = 61176 AND tdb.nrdocmto = 1355)     THEN to_date('20/05/2019', 'DD/MM/RRRR')
           WHEN (tdb.cdcooper = 13 AND tdb.nrborder = 38033 AND tdb.nrdocmto = 547)     THEN to_date('30/04/2019', 'DD/MM/RRRR')
           WHEN (tdb.cdcooper = 13 AND tdb.nrborder = 38146 AND tdb.nrdocmto = 166)     THEN to_date('30/04/2019', 'DD/MM/RRRR')
           WHEN (tdb.cdcooper = 13 AND tdb.nrborder = 38293 AND tdb.nrdocmto = 1149)    THEN to_date('17/05/2019', 'DD/MM/RRRR')
           WHEN (tdb.cdcooper = 13 AND tdb.nrborder = 38390 AND tdb.nrdocmto = 1151)    THEN to_date('17/05/2019', 'DD/MM/RRRR')
           WHEN (tdb.cdcooper = 13 AND tdb.nrborder = 38390 AND tdb.nrdocmto = 1153)    THEN to_date('17/05/2019', 'DD/MM/RRRR')
           WHEN (tdb.cdcooper = 13 AND tdb.nrborder = 38390 AND tdb.nrdocmto = 1154)    THEN to_date('17/05/2019', 'DD/MM/RRRR')
           WHEN (tdb.cdcooper = 13 AND tdb.nrborder = 38507 AND tdb.nrdocmto = 1155)    THEN to_date('07/05/2019', 'DD/MM/RRRR')
           WHEN (tdb.cdcooper = 14 AND tdb.nrborder = 38104 AND tdb.nrdocmto = 1329)    THEN to_date('27/05/2019', 'DD/MM/RRRR')
         ELSE NULL END AS DTOCORRE 
  FROM craptdb tdb
  ...
  WHERE ((tdb.cdcooper = 1 AND ((tdb.nrborder = 548804 AND tdb.nrdocmto = 3052147)
     ...
     --OR (tdb.cdcooper = 5 AND   tdb.nrborder = 14229 AND tdb.nrdocmto = 866) 
     --OR (tdb.cdcooper = 5 AND   tdb.nrborder = 14229 AND tdb.nrdocmto = 869) 
     OR (tdb.cdcooper = 9 AND ((tdb.nrborder = 60784 AND tdb.nrdocmto = 9038801)
                        OR (tdb.nrborder = 60304 AND tdb.nrdocmto = 1718) 
                        OR (tdb.nrborder = 60849 AND tdb.nrdocmto = 1326)
                        OR (tdb.nrborder = 60890 AND tdb.nrdocmto IN (1339, 1340))
                        OR (tdb.nrborder = 60990 AND tdb.nrdocmto = 1342)
                        OR (tdb.nrborder = 61176 AND tdb.nrdocmto IN (1347, 1350, 1355)))
        )   
     --OR (tdb.cdcooper = 13 AND (tdb.nrborder = 38146 AND tdb.nrdocmto = 166))   
     --OR (tdb.cdcooper = 13 AND (tdb.nrborder = 38033 AND tdb.nrdocmto = 547))
     OR (tdb.cdcooper = 13 AND ((tdb.nrborder = 38293 AND tdb.nrdocmto = 1149)
                         OR (tdb.nrborder = 38390 AND tdb.nrdocmto IN (1151, 1153, 1154))
                         OR (tdb.nrborder = 38507 AND tdb.nrdocmto = 1155))
        )
     OR (tdb.cdcooper = 14 AND tdb.nrborder = 38104 AND tdb.nrdocmto = 1329))
     AND tdb.insittit = 4
     ORDER BY tdb.cdcooper;
 ...
 BEGIN
    ...
    IF    btch0001.cr_crapdat%NOTFOUND THEN
          ...
          dbms_output.put_line('erro ao abrir crapdat');
          RETURN;
    END   IF;
    CLOSE btch0001.cr_crapdat;
   ...
   IF pr_indpagto = 0 THEN
     vr_cdhistor_opc := dsct0003.vr_cdhistordsct_pgtocompe; -- Compe
   ELSE
     vr_cdhistor_opc := dsct0003.vr_cdhistordsct_pgtocooper; -- Caixa/IB/TAA
   END IF;
   ...
   dbms_output.put_line('Lançamento de crédito na operação, histórico: '||vr_cdhistor_opc||' valor: '||vr_vlpagmto);
   ...
   IF rw_craptdb.vliofcpl_restante > 0 AND vr_vlpagmto > 0 AND vr_flgimune <= 0 THEN
     ...
     dsct0003.pc_inserir_lancamento_bordero(pr_cdcooper => pr_cdcooper
                                  ...
                                  ,pr_dscritic => vr_dscritic );
     dbms_output.put_line('Debito de IOF histórico: '||dsct0003.vr_cdhistordsct_iofcompleoper||' Valor: ' || vr_vlpagiof); --#REMOVER
   ...
   IF rw_craptdb.vlmtatit_restante > 0 AND vr_vlpagmto > 0 THEN
     ...
     dsct0003.pc_inserir_lancamento_bordero(pr_cdcooper => pr_cdcooper
                                  ...
                                  ,pr_dscritic => vr_dscritic );
     dbms_output.put_line('Apropriacao de Multa histórico: '||dsct0003.vr_cdhistordsct_apropjurmta||' Valor: ' || vr_vlpagmta); --#REMOVER
   ...
   IF rw_craptdb.vlmratit_restante > 0 AND vr_vlpagmto > 0 THEN
     ...
     dsct0003.pc_inserir_lancamento_bordero(pr_cdcooper => pr_cdcooper
                                  ...
                                  ,pr_dscritic => vr_dscritic );
     dbms_output.put_line('Apropriacao de Mora histórico: ' ||dsct0003.vr_cdhistordsct_apropjurmra||' Valor: '||(rw_craptdb.vlmratit - nvl(rw_lancboraprop.vllanmto,0))); --#REMOVER
   ...
   IF (vr_vlpagmto > 0) THEN
     ...
     dsct0003.pc_inserir_lancamento_bordero(pr_cdcooper => pr_cdcooper
                                  ...
                                  ,pr_vllanmto => vr_vlpagmto
                                  ,pr_dscritic => vr_dscritic );
     dbms_output.put_line('Débito na operação por valor pago a maior histórico: '||dsct0003.vr_cdhistordsct_deboppagmaior||' Valor: '||vr_vlpagmto);
     -- Condicao para verificar se houve critica
     IF NVL(vr_cdcritic,0) > 0 OR vr_dscritic IS NOT NULL THEN
       RAISE vr_exc_erro;
     END IF;
     ...
     dsct0003.pc_efetua_lanc_cc(pr_dtmvtolt => rw_crapdat.dtmvtolt
                      ...
                      ,pr_cdcritic => vr_cdcritic
                      ,pr_dscritic => vr_dscritic);
     dbms_output.put_line('Débito na CC por valor pago a maior histórico: '||dsct0003.vr_cdhistordsct_credpagmaior||' Valor: '||vr_vlpagmto);
     -- Condicao para verificar se houve critica
     IF NVL(vr_cdcritic,0) > 0 OR vr_dscritic IS NOT NULL THEN
       RAISE vr_exc_erro;
     END IF;
...
BEGIN
  -- Atualizar o título com caso específico de IOF
  UPDATE craptdb tdb SET tdb.vlpagiof = tdb.vlpagiof - 0.18 WHERE cdcooper = 9 AND nrborder = 60890 AND nrtitulo = 2;
  dbms_output.put_line('Retirado 0.18 centavos do valor de pagamento de IOF da Coop 9, Bordero 60890 e Título 1339');
  ...
  DSCT0003.pc_efetua_lanc_cc (pr_dtmvtolt => rw_crapdat.dtmvtolt
                             ...
                             ,pr_cdcritic => vr_cdcritic
                             ,pr_dscritic => vr_dscritic);
  dbms_output.put_line('Lançamento de abono de 0.18 centavos de IOF da Coop 9, Bordero 60890 e Título 1339');
  ...
  FOR rw_craptdb IN cr_craptdb() LOOP
    ...
    dbms_output.put_line('Coop      => ' || rw_craptdb.cdcooper);
    dbms_output.put_line('Nrdconta  => ' || rw_craptdb.nrdconta);
    dbms_output.put_line('Bordero   => ' || rw_craptdb.nrborder);
    dbms_output.put_line('Documento => ' || rw_craptdb.nrdocmto);
    dbms_output.put_line('Valor     => ' || rw_craptdb.vlrpagto);
    dbms_output.put_line('Data      => ' || rw_craptdb.dtocorre);
    
    -- Faz a chamada da procedure para calcular os valores de Multa, Mora e IOF na data passada
    cecred.dsct0003.pc_calcula_atraso_tit(pr_cdcooper => rw_craptdb.cdcooper,
                                          ...
                                          pr_nrdocmto => rw_craptdb.nrdocmto,
                                          pr_dtmvtolt => rw_craptdb.dtocorre,
                                          pr_vlmtatit => vr_vlmtatit,
                                          pr_vlmratit => vr_vlmratit,
                                          pr_vlioftit => vr_vlioftit,
                                          pr_cdcritic => vr_cdcritic,
                                          pr_dscritic => vr_dscritic);
  dbms_output.put_line('IOF calculado atraso tit => ' || vr_vlioftit);
    -- Condicao para verificar se houve critica                             
    IF NVL(vr_cdcritic,0) > 0 OR vr_dscritic IS NOT NULL THEN
      dbms_output.put_line('erro: - '||vr_cdcritic||' - '||vr_dscritic);
      RETURN;
    ...
    -- Remove os lançamentos de Mora dos meses a frente
    DELETE FROM tbdsct_lancamento_bordero
    WHERE cdcooper = rw_craptdb.cdcooper 
      AND nrborder = rw_craptdb.nrborder AND nrtitulo = rw_craptdb.nrtitulo 
      AND dtmvtolt > rw_craptdb.dtocorre AND cdhistor = 2668;
    
    -- Atualiza os valores da TDB
    UPDATE craptdb tdb
    SET tdb.vlmtatit = vr_vlmtatit, tdb.vlmratit = vr_vlmratit, tdb.vliofcpl = vr_vlioftit
    WHERE tdb.cdcooper = rw_craptdb.cdcooper AND tdb.nrborder = rw_craptdb.nrborder AND tdb.nrtitulo = rw_craptdb.nrtitulo;
    
    --Faz a chamada da procedure de pagamento de titulo dentro da operação
    pc_pagar_titulo_operacao(pr_cdcooper => rw_craptdb.cdcooper,
                             pr_cdagenci => rw_craptdb.cdagenci,
                             pr_nrdcaixa => rw_craptdb.nrdcaixa,
                             pr_idorigem => 2,
                             pr_cdoperad => 1,
                             pr_nrdconta => rw_craptdb.nrdconta,
                             pr_nrborder => rw_craptdb.nrborder,
                             ...
                             pr_inproces => NULL,
                             pr_indpagto => 1,
                             pr_vlpagmto => rw_craptdb.vlrpagto,
                             pr_cdcritic => vr_cdcritic,
                             pr_dscritic => vr_dscritic);
    -- Condicao para verificar se houve critica                             
    IF NVL(vr_cdcritic,0) > 0 OR vr_dscritic IS NOT NULL THEN
    ...
    --UPDATE tbdsct_lancamento_bordero SET dtmvtolt = '01/05/2019' WHERE cdcooper = 13 AND nrborder = 38146 AND nrdocmto = 166 AND cdhistor = 2673 AND dtmvtolt = '30/04/2019';
    --UPDATE tbdsct_lancamento_bordero SET dtmvtolt = '01/05/2019' WHERE cdcooper = 13 AND nrborder = 38033 AND nrdocmto = 547 AND cdhistor = 2673 AND dtmvtolt = '30/04/2019';
