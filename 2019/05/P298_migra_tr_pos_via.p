    ...
    */
    ...
    DO WHILE TRUE ON ENDKEY UNDO, LEAVE:
       ...
       ASSIGN tt-registro-arquivo.cdcooper = INTE(TRIM(ENTRY(1,aux_setlinha,";")))
              ...
              tt-registro-arquivo.dtdpagto = DATE(TRIM(ENTRY(7,aux_setlinha,";"))).
...
PROCEDURE valida_dados:
    ...
    /*IF crapepr.dtdpagto <  crapdat.dtmvtolt THEN
       DO:
           ASSIGN par_dscritic = "Emprestimo em atraso: " + STRING(par_nrctremp).
           RETURN "NOK".
       END.*/
...
PROCEDURE migrar_dados_tr:
    ...
    MIGRACAEMPR: DO TRANSACTION ON ERROR  UNDO MIGRACAEMPR, LEAVE MIGRACAEMPR
      ...
      FOR EACH tt-registro-arquivo EXCLUSIVE-LOCK:    
        ...
        IF aux_nrdconta = 8217556 THEN
           ASSIGN aux_nrctrnov = INTE("80" + STRING(aux_nrctremp)).
            ...
            IF AVAIL tt-dados-epr THEN
                DO:
                    ASSIGN aux_vlsdeved = tt-dados-epr.vlsdeved
                           aux_qtparatu = ROUND(tt-dados-epr.qtpreemp - tt-dados-epr.qtprecal,0)
                           aux_dtdpagto = tt-registro-arquivo.dtdpagto
