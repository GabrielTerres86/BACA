...
declare 
  ...
  -- ALTERAR
  NOME_DA_ACAO VARCHAR2(40) := 'SEGEMP_ALTERA_PERM';
  PROCEDURE_DA_ACAO VARCHAR2(100) := 'pc_editar_perm_canais';
  PACKAGE_DA_ACAO VARCHAR2(100) := 'TELA_SEGEMP';
  PARAMETROS_DA_ACAO VARCHAR2(1000):= 'pr_idsegmento, pr_cdcanal, pr_tppermissao, pr_vlmax_autorizado';
  -- FIM ALTERAR
