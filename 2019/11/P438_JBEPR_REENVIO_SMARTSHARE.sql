...
/*   
     ...
     Criação do Job JBEPR_REENVIO_FTP para reenvio dos contratos digitais 
     que tiveram erro na ultima tentativa de envio ao SMARTSHARE
     PRJ438 - Agilidade - AMcom
...
BEGIN
  ...
  vr_dsplsql := 'declare '||
                ...
                'BEGIN pc_crps786(pr_cdcooper => 0,'||
                                ' pr_dscritic => vr_dscritic ); END;';
                   
  -- Montar o prefixo do código do programa para o jobname
  vr_jobname := 'cecred.JBEPR_REENVIO_FTP';
  -- Faz a chamada ao programa paralelo atraves de JOB
  gene0001.pc_submit_job(pr_cdcooper  => 3 /*CECRED*/         --> Código da cooperativa
                        ,pr_cdprogra  => 'JBEPR_REENVIO_FTP'--> Código do programa
                        ...
                        ,pr_interva   => 'Freq=DAILY;ByDay=MON,TUE,WED,THU,FRI;ByHour=09;ByMinute=00;BySecond=00'                                         
  ...
  dbms_scheduler.set_attribute(name      => vr_jobname,
                               attribute => 'comments', 
                               value     => 'Rodar programa pc_crps786 - Responsavel por controlar '||
                                            'a geração e o envio do contrato digital de emprestimo ao SMARTSHARE ' ||
                                            'quando na ultima tentativa ocorreu erro e enviar relatório ao final, '||
                                            'rotina roda todo dia útil');
