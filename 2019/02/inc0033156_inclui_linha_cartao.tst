 ...
 *
 * 
 * CCR30201166546722812201875644490029570005156010026851121LEONAN FROHLICH        02022005201020106587290981    000200                                                                                               000D1ACB6A8BD1A45CA6539200        SSPSCLEONAN FROHLICH                                                                 7564449000000005150N
 *
 * Lucas Ranghetti 
 */
declare 
  ...
  CURSOR cr_crawcrd_ant (pr_cdcooper  IN crawcrd.cdcooper%TYPE
    ...
    SELECT crd.dddebito
     ...
     WHERE crd.cdcooper = pr_cdcooper
       ...
       AND crd.nrcrcard = 5156010026850651; -- Cartao 
...
begin
  BEGIN
    vr_des_text := 'CCR30201166546722812201875644490029570005156010026851121LEONAN FROHLICH        02022005201020106587290981    000200                                                                                               000D1ACB6A8BD1A45CA6539200        SSPSCLEONAN FROHLICH                                                                 7564449000000005150N';
    ...
    IF substr(vr_des_text,5,2) = '02'  THEN
      ...
      vr_cdadmcrd := 14; -- Platinum (nao vem no arquivo, foi identificado no SIPAG)
      vr_dddebito := 0;
      vr_vllimcrd := 0;
      vr_tpdpagto := 0;
      vr_flgdebcc := 0;
