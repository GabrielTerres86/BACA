...
CREATE OR REPLACE PROCEDURE CECRED.pc_quebra_sigilo_bancario_1 IS 
...
--136-8;          885-0;          62-0
--252.304.849-34; 342.108.069-00; 223.915.339-34
  
  vr_tbconta_investigar('008_0000001368_000025230484934').cdcooper := 8;
  vr_tbconta_investigar('008_0000001368_000025230484934').nrdconta := 1368;
  vr_tbconta_investigar('008_0000001368_000025230484934').nrcpfcgc := 25230484934;   
...
EXCEPTION
  ...
  WHEN OTHERS THEN
    ...
    -- Não altera nenhum dado    
    ROLLBACK;
END pc_quebra_sigilo_bancario_1;
/
