--MANTER_PARAMETROS_CDC
declare 
  
  -- ALTERAR
  NOME_DA_ACAO VARCHAR2(40) := 'REGISTRA_PUSH_PRP_CDC';
  PROCEDURE_DA_ACAO VARCHAR2(100) := 'pc_reg_push_sit_prop_cdc_web';
  PACKAGE_DA_ACAO VARCHAR2(100) := 'EMPR0012';
  PARAMETROS_DA_ACAO VARCHAR2(1000):= 'pr_cdcooper,pr_nrdconta,pr_nrctremp,pr_insitpro';
  -- FIM ALTERAR
