...
declare 
  ...
  pr_nrdconta crapass.nrdconta%TYPE := 6284337;
  pr_dtmvtolt crapdat.dtmvtolt%TYPE := to_date('08/02/2019','dd/mm/rrrr');
  vr_nraplica craprac.nraplica%TYPE := 9;
  pr_vlaplica craplcm.vllanmto%TYPE := 896;
