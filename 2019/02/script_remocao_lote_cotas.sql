DECLARE
  ...
  CURSOR cr_nrdolote IS
    SELECT 10002 nrdolote FROM dual UNION
    SELECT 10129 FROM dual UNION
    SELECT 8008 FROM dual UNION
    SELECT 8464 FROM dual UNION
    SELECT 600038 FROM dual UNION
    SELECT 600039 FROM dual;
