...
declare 
  ...
  pr_nrdconta crapass.nrdconta%TYPE := 8294160;
  pr_dtmvtolt crapdat.dtmvtolt%TYPE := to_date('18/02/2019','dd/mm/rrrr');
  vr_nraplica craprac.nraplica%TYPE := 8;
  pr_vlaplica craplcm.vllanmto%TYPE := 192.72;
