--INC0024022 - ajustar datas contratos TR Viacredi - volta
...
BEGIN
  ...
  update crapepr e set e.dtdpagto = to_date('15/06/2019','DD/MM/YYYY') where cdcooper = 1 and nrdconta = 847917  and  nrctremp = 292150;
  update crapepr e set e.dtdpagto = to_date('20/05/2019','DD/MM/YYYY') where cdcooper = 1 and nrdconta = 1200046 and  nrctremp = 553548;
  update crapepr e set e.dtdpagto = to_date('25/05/2019','DD/MM/YYYY') where cdcooper = 1 and nrdconta = 1830830 and  nrctremp = 236552;
  ...
  update crapepr e set e.dtdpagto = to_date('28/07/2019','DD/MM/YYYY') where cdcooper = 1 and nrdconta = 4375084 and  nrctremp = 241133;
  update crapepr e set e.dtdpagto = to_date('20/05/2019','DD/MM/YYYY') where cdcooper = 1 and nrdconta = 6218369 and  nrctremp = 280021;
  update crapepr e set e.dtdpagto = to_date('10/04/2019','DD/MM/YYYY') where cdcooper = 1 and nrdconta = 6226710 and  nrctremp = 565570;
  update crapepr e set e.dtdpagto = to_date('10/08/2019','DD/MM/YYYY') where cdcooper = 1 and nrdconta = 6674216 and  nrctremp = 758233;
  update crapepr e set e.dtdpagto = to_date('23/10/2018','DD/MM/YYYY') where cdcooper = 1 and nrdconta = 7004915 and  nrctremp = 987337;
  ...
  update crapepr e set e.dtdpagto = to_date('10/05/2019','DD/MM/YYYY') where cdcooper = 1 and nrdconta = 8041660 and  nrctremp = 897767;
  update crapepr e set e.dtdpagto = to_date('15/06/2019','DD/MM/YYYY') where cdcooper = 1 and nrdconta = 8225915 and  nrctremp = 1195867;
