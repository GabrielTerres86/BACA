...
--Coop: Civia
--Fazer um crédito no bloqueado prejuízo no valor de R$9,25
    pr_cdcooper  := 13;
    pr_nrdconta  := 90514 ;
    pr_vllanmto  := 9.25;
    pr_nrdctabb  := 56111;
...
dbms_output.put_line('Início   Conta: 345245');
--Coop: Alto Vale
--Rodar o histórico 2721 no valor de R$0,78
    pr_cdcooper   := 16;
    pr_nrdconta   := 345245;
    pr_vllanmto   := 0.78;
    vr_idprejuizo := null;
...
dbms_output.put_line('Início   Conta: 9768513');
--Coop: Viacredi
--Rodar o histórico 2721 no valor de R$0,92
    pr_cdcooper   := 1;
    pr_nrdconta   := 9768513;
    pr_vllanmto   := 0.92;
    vr_idprejuizo := null;
...
dbms_output.put_line('Início   Conta: 7711034');
--Coop: Viacredi
--Excluir o histórico 2408 no valor de R$500,00 do dia 20/09.
BEGIN
