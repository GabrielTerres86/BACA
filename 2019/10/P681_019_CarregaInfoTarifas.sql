  ...
  CURSOR cr_craptar IS
    SELECT DISTINCT t.cdtarifa
     ...
     WHERE r.cdtarifa = t.cdtarifa 
       AND (t.cdhistor IN ( 890,1267,1268,1275,1276,1279,1280,1287,1288,1289,1290,1347,1348,1349,1350,1355
                          ,1356,1357,1358,1359,1360,1361,1362,1377,1378,1742,1744,1746,1748,1760,1795,1798
                          ,1932,1933,1936,1941,1942,1943,1944,1945,1946,1948,1964,2015,2041,2042,2043,2044
                          ,2045,2046,2072,2073,2200,2202,2204,2206,2211,2212,2213,2214,2428,2431,2432,2609
                          ,2610,2611,2612,2613,2615,2616,2617,2618,2619,2695,2696,2832,2833)
        OR t.cdhisest IN ( 890,1267,1268,1275,1276,1279,1280,1287,1288,1289,1290,1347,1348,1349,1350,1355
                          ,1356,1357,1358,1359,1360,1361,1362,1377,1378,1742,1744,1746,1748,1760,1795,1798
                          ,1932,1933,1936,1941,1942,1943,1944,1945,1946,1948,1964,2015,2041,2042,2043,2044
                          ,2045,2046,2072,2073,2200,2202,2204,2206,2211,2212,2213,2214,2428,2431,2432,2609
                          ,2610,2611,2612,2613,2615,2616,2617,2618,2619,2695,2696,2832,2833) );
...
BEGIN
  ...
  vr_tbdepara(1267) := 3075;
  vr_tbdepara(1268) := 3076;
  vr_tbdepara(1275) := 3059;
  vr_tbdepara(1276) := 3060;
  vr_tbdepara(1279) := 3069;
  vr_tbdepara(1280) := 3070;
  vr_tbdepara(1287) := 3055;
  vr_tbdepara(1288) := 3056;
  vr_tbdepara(1289) := 3057;
  vr_tbdepara(1290) := 3058;
  ...
  vr_tbdepara(1377) := 3085;
  vr_tbdepara(1378) := 3086;
  ...
  vr_tbdepara(1948) := 3081;
  vr_tbdepara(1964) := 3082;
  ...
  vr_tbdepara(2832) := 3079;
  vr_tbdepara(2833) := 3080;
