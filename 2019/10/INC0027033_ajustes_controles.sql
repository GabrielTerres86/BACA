/* inc0027033 - Ajustes para permitir solicitação de processo para geração do arquivo 3040 no processo noturno
...
DELETE FROM crapris ris
 WHERE ris.cdcooper = 1
   AND ris.inddocto = 2
   AND ris.dtrefere = '30/09/2019'; -- Se atentar a data da mensal
