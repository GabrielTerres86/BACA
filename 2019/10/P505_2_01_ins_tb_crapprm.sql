...
values ('CRED', 0, 'IMP_ARQ_SINC_DIR', 'Diretorio de retorno arquivo controle de segurança sincronca ', '/usr/sistemas/Sincronica/recebe');
--Parametro do diretorio do conect para envio sincronica
insert into crapprm (NMSISTEM, CDCOOPER, CDACESSO, DSTEXPRM, DSVLRPRM)
values ('CRED', 0, 'IMP_ARQ_ENV_SINC_DIR', 'Diretorio do conect para envio sincronica ', '/usr/sistemas/Sincronica/envia');
--Parametro do Nome do servidor FTP ABBC
insert into crapprm (NMSISTEM, CDCOOPER, CDACESSO, DSTEXPRM, DSVLRPRM)
values ('CRED', 0, 'TRAN_BBC_SERV_FTP_CS', 'Nome do servidor FTP da 10.200.52.85', '10.200.52.85');
...
--Parametro do diretorio do conect para envio sincronica
insert into crapprm (NMSISTEM, CDCOOPER, CDACESSO, DSTEXPRM, DSVLRPRM)
values ('CRED', 0, 'DIR_ABBC_ENV_FTP_CS', 'Diretorio do conect para envio de arquivo ABBC ', '/usr/sistemas/Sincronica/envia');
--Parametro Senha do servidor FTP 
insert into crapprm (NMSISTEM, CDCOOPER, CDACESSO, DSTEXPRM, DSVLRPRM)
values ('CRED', 0, 'TRAN_BBC_PASS_FTP_CS', 'Senha do servidor FTP da 10.200.52.85', 'P487Mt74*');
--Parametro do diretorio de captura do arquivos logico e de imagem ABBC
insert into crapprm (NMSISTEM, CDCOOPER, CDACESSO, DSTEXPRM, DSVLRPRM)
values ('CRED', 0, 'TRAN_BBC_DIR_CS', 'Diretorio do FTP da Transabbc Cartao seguranca', '/085PSR');
--Parametro para script shell para downloud de arquivo SFTP ABBC'
insert into crapprm (NMSISTEM, CDCOOPER, CDACESSO, DSTEXPRM, DSVLRPRM)
values ('CRED', 0, 'BAIXA_ARQ_SFTP_ABBC', 'Script para downloud de arquivo SFTP ABBC', '/usr/local/cecred/bin/sftp-conecta.sh');
--Parametro Usuario do servidor FTP  
insert into crapprm (NMSISTEM, CDCOOPER, CDACESSO, DSTEXPRM, DSVLRPRM)
values ('CRED', 0, 'TRAN_BBC_USER_FTP_CS', 'Usuario do servidor FTP da 10.200.52.85', '085PSR');
