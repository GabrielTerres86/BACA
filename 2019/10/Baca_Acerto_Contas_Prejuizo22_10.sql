DECLARE
  ...
  -- Rodar o hist.. 2722 no valor de R$22,30
    pr_cdcooper   := 11;
    pr_nrdconta   := 436976;
    pr_vllanmto   := 22.30;
    vr_idprejuizo := null;
  ...
  -- Rodar o hist.. 2722 no valor de R$24,58
    pr_cdcooper   := 1;
    pr_nrdconta   := 8190798;
    pr_vllanmto   := 24.58;
    vr_idprejuizo := null;
  ...
  -- Cooperativa: Viacredi
  -- Rodar o hist.. 2722 no valor de R$30,80
    pr_cdcooper   := 1;
    pr_nrdconta   := 7614349;
    pr_vllanmto   := 30.80;
    vr_idprejuizo := null;
  ...
  -- Cooperativa: Viacredi
  -- Rodar o hist.. 2722 no valor de R$26,35
    pr_cdcooper   := 1;
    pr_nrdconta   := 7446250;
    pr_vllanmto   := 26.35;
    vr_idprejuizo := null;
  ...
  -- Cooperativa: Viacredi
  -- Rodar o hist.. 2722 no valor de R$12,11
    pr_cdcooper   := 1;
    pr_nrdconta   := 8890870;
    pr_vllanmto   := 12.11;
    vr_idprejuizo := null;
  ...
  -- Cooperativa: Viacredi
  -- Rodar o hist.. 2722 no valor de R$3,71
    pr_cdcooper   := 1;
  ...
  -- Cooperativa: Viacredi
  -- Rodar o hist.. 2722 no valor de R$18,68
    pr_cdcooper   := 1;
    pr_nrdconta   := 6171508;
    pr_vllanmto   := 18.68;
    vr_idprejuizo := null;
  ...
  -- Cooperativa: Viacredi
  -- Rodar o hist.. 2722 no valor de R$54,40
    pr_cdcooper   := 1;
    pr_nrdconta   := 8960372;
    pr_vllanmto   := 54.40;
    vr_idprejuizo := null;
  ...
  -- Cooperativa: Viacredi
  -- Rodar o hist.. 2722 no valor de R$35,00
    pr_cdcooper   := 1;
    pr_nrdconta   := 9427880;
    pr_vllanmto   := 35.00;
    vr_idprejuizo := null;
  ...
  ---------------------------------------------------------------------------------------------------  
    dbms_output.put_line('Início   Conta: 8031070');
  -- Cooperativa: Viacredi
  -- Rodar o hist.. 2721 no valor de R$0,01
    pr_cdcooper   := 1;
    pr_nrdconta   := 8031070;
    pr_vllanmto   := 0.01;
    vr_idprejuizo := null;
  ...
  dbms_output.put_line('Fim   Conta: 8031070');
  --------------------------------------------------------------------------------------------------- 
    dbms_output.put_line('Início   Conta: 331139');
  -- Cooperativa: Alto Vale
  -- Rodar o hist.. 2721 no valor de R$0,03
    pr_cdcooper   := 16;
    pr_nrdconta   := 331139;
    pr_vllanmto   := 0.03;
    vr_idprejuizo := null;
...
BEGIN
  ...
  dbms_output.put_line('Fim   Conta: 331139');
  --------------------------------------------------------------------------------------------------- 
  --
  COMMIT;
  --
