...
declare 
  ...
  -- ALTERAR
  NOME_DA_ACAO VARCHAR2(40) := 'CONSULTAR_CONTRATOS';
  PROCEDURE_DA_ACAO VARCHAR2(100) := 'pc_consultar_contratos';
  PACKAGE_DA_ACAO VARCHAR2(100) := 'TELA_ATENDA_PRESTACOES';
  PARAMETROS_DA_ACAO VARCHAR2(1000):= 'pr_cdcooper, pr_nrdconta, pr_ncrtremp';
  -- FIM ALTERAR
