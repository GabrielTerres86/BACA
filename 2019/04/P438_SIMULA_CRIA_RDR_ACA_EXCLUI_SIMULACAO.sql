...
declare 
  ...
  -- ALTERAR
  NOME_DA_ACAO VARCHAR2(40) := 'SIMULA_EXCLUI_SIMULACAO';
  PROCEDURE_DA_ACAO VARCHAR2(100) := 'pc_exclui_simulacao';
  PACKAGE_DA_ACAO VARCHAR2(100) := 'TELA_ATENDA_SIMULACAO';
  PARAMETROS_DA_ACAO VARCHAR2(1000):= 'pr_nrdconta, pr_idseqttl, pr_dtmvtolt, pr_nrsimula, pr_flgerlog';
  -- FIM ALTERAR
