...
declare 
  ...
  -- ALTERAR
  NOME_DA_ACAO VARCHAR2(40) := 'SIMULA_BUSCA_DADOS';
  PROCEDURE_DA_ACAO VARCHAR2(100) := 'pc_busca_dados_simulacao';
  PACKAGE_DA_ACAO VARCHAR2(100) := 'TELA_ATENDA_SIMULACAO';
  PARAMETROS_DA_ACAO VARCHAR2(1000):= 'pr_nrdconta, pr_idseqttl, pr_dtmvtolt, pr_flgerlog, pr_nrsimula';
  -- FIM ALTERAR
