...
declare 
  ...
  -- ALTERAR
  NOME_DA_ACAO VARCHAR2(40) := 'SIMULA_BUSCA_SIMULACOES';
  PROCEDURE_DA_ACAO VARCHAR2(100) := 'pc_busca_simulacoes';
  PACKAGE_DA_ACAO VARCHAR2(100) := 'TELA_ATENDA_SIMULACAO';
  PARAMETROS_DA_ACAO VARCHAR2(1000):= 'pr_nrdconta, pr_idseqttl, pr_dtmvtolt, pr_flgerlog';
  -- FIM ALTERAR
