...
declare 
  ...
  -- ALTERAR
  NOME_DA_ACAO VARCHAR2(40) := 'SIMULA_GRAVA_SIMULACAO';
  PROCEDURE_DA_ACAO VARCHAR2(100) := 'pc_grava_simulacao';
  PACKAGE_DA_ACAO VARCHAR2(100) := 'TELA_ATENDA_SIMULACAO';
  PARAMETROS_DA_ACAO VARCHAR2(1000):= 'pr_nrdconta ,pr_idseqttl ,pr_dtmvtolt ,pr_cddopcao ,pr_nrsimula ,pr_cdlcremp ,pr_vlemprst ,pr_qtparepr ,pr_dtlibera ,pr_dtdpagto ,pr_percetop ,pr_cdfinemp ,pr_idfiniof ,pr_flggrava ,pr_idpessoa ,pr_nrseq_email ,pr_nrseq_telefone ,pr_idsegmento ,pr_tpemprst ,pr_idcarenc ,pr_dtcarenc, pr_flgerlog';
  -- FIM ALTERAR
