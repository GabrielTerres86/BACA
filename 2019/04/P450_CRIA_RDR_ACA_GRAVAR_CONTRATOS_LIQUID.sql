...
declare 
  ...
  -- ALTERAR
  NOME_DA_ACAO VARCHAR2(40) := 'GRAVAR_CONTRATOS_LIQUID';
  PROCEDURE_DA_ACAO VARCHAR2(100) := 'pc_alterar_contratos_liquid';
  PACKAGE_DA_ACAO VARCHAR2(100) := 'TELA_ATENDA_PRESTACOES';
  PARAMETROS_DA_ACAO VARCHAR2(1000):= 'pr_nrdconta, pr_cdcooper, pr_nrctremp, pr_dsliquid';
  -- FIM ALTERAR
