...
BEGIN
  ...
  INSERT INTO crapaca (nmdeacao, nmpackag, nmproced, lstparam, nrseqrdr) VALUES ('BUSCA_PARAM_CONTA_CHEQUE', 'CADA0003', 'pc_busca_param_conta_cheque', 'pr_cdcooper,pr_nrdconta', vr_nrseqrdr);
