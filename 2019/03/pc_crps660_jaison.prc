CREATE OR REPLACE PROCEDURE CECRED.pc_crps660_jaison(pr_cdcooper IN crapcop.cdcooper%TYPE   --> Cooperativa solicitada
...
*/
    -- Atribui data
    vr_dtrefere := to_date('28/02/2019', 'DD/MM/RRRR');
