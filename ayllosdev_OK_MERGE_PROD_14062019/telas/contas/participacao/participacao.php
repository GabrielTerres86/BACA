<?
/*!
 * FONTE        : participacao.php
 * CRIAÇÃO      : Guilherme
 * DATA CRIAÇÃO : 31/08/2011
 * OBJETIVO     : Mostra rotina de empresas participantes da tela de CONTAS
 *
...
<?
	...
	// Carregas as opções da Rotina de Participantes na empresa
					...
					<td>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td class="txtBrancoBold ponteiroDrag" background="<?php echo $UrlImagens; ?>background/tit_tela_fundo.gif">PARTICIPA&Ccedil;&Atilde;O EMPRESAS</td>
