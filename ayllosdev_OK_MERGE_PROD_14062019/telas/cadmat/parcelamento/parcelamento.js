 ...
 * OBJETIVO     : Biblioteca de funções da rotina Parcelamento da tela CADMAT
 */
...
function carregaDadosParcelamento(dtdebito,qtparcel,vlparcel,msgRetor,operParc) {
	...
	$.ajax({		
		...
		dataType: 'html',
		async   : false ,
		url		: UrlSite + 'telas/cadmat/parcelamento/principal.php',
		data	: {
					nrdconta: nrdconta,
					operParc: operParc,
					dtdebito: dtdebito,
...
function exibeMsgRetorno(){
	...
	showConfirmacao(msgRetor,'Confirmação - CADMAT',metodo,'unblockBackground();','sim.gif','nao.gif');
