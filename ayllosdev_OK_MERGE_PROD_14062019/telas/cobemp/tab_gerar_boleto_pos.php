<?php
/* !
 * FONTE        : tab_gerar_boleto_pos.php
 * CRIAÇÃO      : Anderson-Alan (Supero)
 * DATA CRIAÇÃO : 15/01/2019
 * OBJETIVO     : Rotina para busca valores POS.
 * --------------
 * ALTERAÇÕES   : 
 * --------------
 */
...
<form id="frmGerarBoletoPOS" name="frmGerarBoletoPOS" class="formulario" onSubmit="return false;">
    ...
    <div id="divBotoesGerarBoletoPOS" style="margin-bottom: 5px; text-align:center;">
        <a href="#" class="botao" id="btVoltar" style="float:none" onClick="<?php echo 'fechaRotina($(\'#divRotina\')); '; ?> return false;">Voltar</a>
        <a href="#" class="botao" id="btEnviar" style="float:none" onClick="mostraValoresPOS(); return false;">Avancar</a>
    </div>
