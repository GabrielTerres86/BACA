 ...
 * OBJETIVO     : Rotina para buscar grupo RELTAR
 * --------------
 * ALTERAÇÕES   : 
 * -------------- 
 */
...
<?	
	...
	$retornoAposErro = 'focaCampoErro(\'cdsubgru\', \'frmReltar\');';
	...
	echo "$('#cddgrupo','#frmReltar').val('$cddgrupo');";
	echo "buscaGrupo();";
	echo "$('#dssubgru','#frmReltar').val('$dssubgru');";
	echo "$('#cdsubgru','#frmReltar').desabilitaCampo();";
	echo "$('#cdhistor','#frmReltar').focus();";		
