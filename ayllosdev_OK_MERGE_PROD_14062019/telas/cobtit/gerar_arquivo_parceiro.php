<?php
	/************************************************************************
	Fonte: gerar_arquivo_parceiro.php
	Autor: Luis Fernando (GFT)
	Data : 16/06/2018

	Objetivo  : Gerar os arquivos para parceiros
	...
	************************************************************************/
	...
	$xmlResult = mensageria($xml, "COBTIT", "COBTIT_GERA_ARQPAR", $glbvars["cdcooper"], $glbvars["cdagenci"], $glbvars["nrdcaixa"], $glbvars["idorigem"], $glbvars["cdoperad"], "</Root>");
	...
	exibirErro('inform', htmlentities($msg), 'Alerta - Ayllos','unblockBackground();', false);
?>
