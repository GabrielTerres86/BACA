<?
/*!
 * FONTE        : lista_pendentes.php
 * CRIAÇÃO      : Marcel Kohls - (AMCom)
 * DATA CRIAÇÃO : 23/03/2018
 * OBJETIVO     : Tabela que apresenta lista de registros pendentes
 * --------------
 * ALTERAÇÕES   :
 * --------------
 */
          ...
          <th><? echo utf8ToHtml('Historico');  ?></th>
			...
			<tbody>
				<?php foreach( $retornoRotina as $registro ): ?>
					<tr>
            <td data-campo="programa" title="<?= getByTagName($registro->tags,'dsprocesso'); ?>"><div class="fixalargura"><?= getByTagName($registro->tags,'dsprocReduzido'); ?></div></td>
            ...
            <td data-campo="prxhorar"><?= getByTagName($registro->tags,'proximohorario'); ?></td>
