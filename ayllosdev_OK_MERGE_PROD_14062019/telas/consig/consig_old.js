...
function Cancelar(idLinha){
	...
	'<td>'+dadosAtuais[4]+'</td>' +
	'<td>'+dadosAtuais[5]+'</td>' +
	'<td><a href="#" onclick="EditarLinha(\''+idLinha+'\',\'' + dadosAtuais[0] + '\');"><img src="/imagens/botoes/alterar.gif" alt="Editar" title="Editar"></a></td>' +
	'<td><a href="#" onclick="ExcluirLinha(\''+idLinha+'\',\'' + dadosAtuais[0] + '\');"><img src="/imagens/botoes/excluir.gif" alt="Excluir" title="Excluir"></a></td>' ;
	linhaEmEdicao = null;
}
				...
				success: function (response) {
					...
					try {
						...
						if (rCod == '-1') {
							...
							dadosAtuais[2] = rCod;																		
							var linha = document.getElementById(idLinha);											
							if (idLinha.indexOf("nova") >= 0) {
								idLinha = dadosAtuais[0];
								linha.setAttribute('id', dadosAtuais[0]);
								var total = document.getElementById('total');	
								total.value = Number(total.value) +1; 						
							}
							linha.innerHTML = '<tr id="'+idLinha+'">' + 						
							'<td class="linhas" align="center">'+dadosAtuais[1]+'</td>' +
							'<td class="linhas">'+dadosAtuais[2]+'</td>' +
							'<td class="linhas">'+dadosAtuais[3]+'</td>' +
							'<td class="linhas">'+dadosAtuais[4]+'</td>' +
							'<td class="linhas">'+dadosAtuais[5]+'</td>' +
							'<td class="linhas">'+dadosAtuais[6]+'</td>' +
							'<td class="linhas"><a href="#" onclick="EditarLinha(\''+idLinha+'\',\'' + dadosAtuais[1] + '\');"><img src="/imagens/botoes/alterar.gif" alt="Editar" title="Editar"></a></td>' +
							'<td class="linhas"><a href="#" onclick="ExcluirLinha(\''+idLinha+'\',\'' + dadosAtuais[1] + '\');"><img src="/imagens/botoes/excluir.gif" alt="Excluir" title="Excluir"></a></td>' ;
							linhaEmEdicao = null;	
						}
					} catch (error) {
						showError(
