<?php 
	...
	//************************************************************************//
	//*** Fonte: 2via_desfazsolicitacao.php                                ***//
	//*** Autor: Guilherme                                                 ***//
	//*** Data : Mar&ccedil;o/2008                   &Uacute;ltima Altera&ccedil;&atilde;o: 04/09/2008 ***//
	//***                                                                  ***//
	//*** Objetivo  : Desfazer solicita&ccedil;&atilde;o de segunda via                  ***//
	//***                                                                  ***//	 
	//*** Altera&ccedil;&otilde;es: 04/09/2008 - Adapta&ccedil;&atilde;o para solicita&ccedil;&atilde;o de 2 via de  ***//
	//***                          senha de cart&atilde;o de cr&eacute;dito (David)      ***//	
	//************************************************************************//		 
	...
	$xmlSetCartao .= "		<Proc>desfaz_solici2via_cartao</Proc>";
	$xmlSetCartao .= "	</Cabecalho>";
	$xmlSetCartao .= "	<Dados>";
