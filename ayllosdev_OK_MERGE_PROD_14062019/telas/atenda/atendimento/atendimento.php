<?php 
	...
	/************************************************************************
	 Fonte: atendimento.php                                              
	 Autor: Gabriel - Rkam                                                    
	 Data : Agosto/2015                   Última alteraçÃo: 
	                                                                  
	 Objetivo  : Mostrar rotina de Atendimento da tela ATENDA            
          ...
          <td>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td id="<?php echo $labelRot; ?>" class="txtBrancoBold ponteiroDrag SetFoco" background="<?php echo $UrlImagens; ?>background/tit_tela_fundo.gif">ATENDIMENTO
                </td>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td align="center" style="border: 2px solid #969FA9; background-color: #F4F3F0; padding: 2px;">
                  <div id="divConteudoOpcao" style="height: 240px;">&nbsp;</div>
                </td>
              </tr>
            </table>
          </td>
