...
exibirErro('inform','Resposta da contestação enviada com sucesso.','Alerta - Aimaro','fechaRotina($(\"#divUsoGenerico\")); acessaOpcaoAba(2,1,\"1\"); exibeRotina($(\"#divRotina\"));',false);
