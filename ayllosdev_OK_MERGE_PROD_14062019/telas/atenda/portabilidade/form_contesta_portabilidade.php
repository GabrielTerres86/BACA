<?php
	/*!
	* FONTE        : form_contesta_portabilidade.php
	* CRIAÇÃO      : Andrey Formigari
	* DATA CRIAÇÃO : Janeiro/2019
	* OBJETIVO     : Mostrar rotina de contestação de portabilidade.
	* --------------
	* ALTERAÇÕES   :
	* --------------
	*/
	...
	$xmlResult = mensageria($xml, "ATENDA", "BUSCA_MOTIVOS_CONTESTACAO", $glbvars["cdcooper"], $glbvars["cdagenci"], $glbvars["nrdcaixa"], $glbvars["idorigem"], $glbvars["cdoperad"], "</Root>");
                    ...
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td class="txtBrancoBold ponteiroDrag" background="<?php echo $UrlImagens; ?>background/tit_tela_fundo.gif">CONTESTAR A PORTABILIDADE</td>
                        ...
                        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td align="center" style="border: 2px solid #969FA9; background-color: #F4F3F0; padding: 2px;">
                                    <form action="" method="post" name="frmContestaPortabilidade" id="frmContestaPortabilidade" class="formulario">
	
										<div id="divDados" class="clsCampos">
										
											<fieldset style="padding: 5px">
												<legend>Motivo</legend>
												<label for="cdmotivo" class="clsCampos" style="width:45px">Motivo:</label>
												<select id="cdmotivo" name="cdmotivo" class="campo FirstInput" style="width:455px">
													<option value=""></option>
												<?php
									...
									<div id="divBotoes" style="padding: 5px">	
										<a class="botao" id="btConfirmar" href="#" onclick="confirmaCantestacaoPortabilidade(false)">Confirmar</a>
