<?
/*!
 * FONTE        : valida_liberacao_taa.php
 * CRIAÇÃO      : James Prust Júnior
 * DATA CRIAÇÃO : Agosto/2015
 * OBJETIVO     : Valida os dados para liberacao do cartao para o TAA
 * --------------
 * ALTERAÇÕES   :
 * --------------
 */
	...
	// Verifica permissão
	if (($msgError = validaPermissao($glbvars["nmdatela"],$glbvars["nmrotina"],"O")) <> "") {
	...
	$xmlSetCartao .= "		<Proc>valida_dados_liberacao_taa</Proc>";
	$xmlSetCartao .= "	</Cabecalho>";
	$xmlSetCartao .= "	<Dados>";
