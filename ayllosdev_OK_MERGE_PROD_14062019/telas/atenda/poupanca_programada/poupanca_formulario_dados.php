<?php 
	...
	/************************************************************************
	 Fonte: poupanca_formulario_dados.php                             
	 Autor: David                                                     
	 Data : Março/2010                   Última Alteração: 13/07/2011
	                                                                  
	 Objetivo  : Formulário para dados da Poupança Programada         
...
<div id="divDadosPoupanca">
	...
	<div id="divBotoes">
		...
		<?php if ($flgAlterar || $flgSuspender) { ?>
			<input type="image" src="<?php echo $UrlImagens; ?>botoes/concluir.gif" onClick="<?php if ($flgAlterar) { echo "validarAlteracaoPoupanca();"; } else { echo "validarSuspensaoPoupanca();"; } ?>return false;" />
		<?php } else { ?>
			<input type="image" src="<?php echo $UrlImagens; ?>botoes/extrato.gif" onClick="extratoPoupanca();return false;" />
		<?php } ?>
	</div>
</div>
