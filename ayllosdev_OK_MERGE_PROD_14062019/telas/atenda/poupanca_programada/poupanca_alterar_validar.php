<?php 
	...
	***************************************************************************/
	...
	// Confirma operação
	$executar .= "showConfirmacao(\"Deseja alterar a poupan&ccedil;a programada?\",\"Confirma&ccedil;&atilde;o - Aimaro\",\"alterarPoupanca(\\\"".$vlprerpp."\\\")\",\"blockBackground(parseInt($(\\\"#divRotina\\\").css(\\\"z-index\\\")))\",\"sim.gif\",\"nao.gif\");";
