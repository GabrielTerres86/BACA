<?php
/*!
 * FONTE        : cheques_limite_alterar_form.php
 * CRIAÇÃO      : Lucas Lunelli
 * DATA CRIAÇÃO : 16/12/2015 
 * OBJETIVO     : Tela para alteração do número da proposta de limite de desc de cheque. (Lunelli - SD 360072 [M175])
 * ALTERAÇÕES   : 
 * --------------
 * 000:
 *
							...
							<tr>
								<td align="center" style="border: 2px solid #969FA9; background-color: #F4F3F0; padding: 2px;">
									<div style="width: 240px; height: 100px;" id="divConteudoAltara" class="divBotoes">
										...
										<a href="#" class="botao" style="margin: 4px 0px 4px 0px; width:230px; " id="todaProp" onClick="fechaRotinaAltera();carregaDadosAlteraLimiteDscChq();return false;">Toda a proposta </a>
