<?php 
	...
	/************************************************************************
	 Fonte: titulos_limite_valida_proposta.php
	 Autor: David                                                 
	 Data : Junho/2010                          Última Alteração: 08/05/2013
	                                                                  
	 Objetivo  : Validar dados da proposta do limite				 
	                                                                  	 
	 Alterações: 05/11/2012 - Ajustes referente ao projeto GE (Adriano).
	 
				 08/05/2013 - Retirado o tratamento para quando o $inconfir = 33
							  (Adriano).
	************************************************************************/
	...
	$xmlValidaProposta .= "		<Bo>b1wgen0030.p</Bo>";
	...
	if ($inconfir == 2) {
		...
		echo 'showConfirmacao("'.$mensagem.'","Confirma&ccedil;&atilde;o - Aimaro","validaLimiteDscTit(\''.$cddopcao.'\',aux_inconfir,aux_inconfi2,aux_inconfi5)","metodoBlock()","sim.gif","nao.gif");';
		exit();
