<? 
/*!
 * FONTE        : titulos_limite_alterar_efetuainclusao.php
 * CRIAÇÃO      : Guilherme
 * DATA CRIAÇÃO : Janeiro/2009
 * OBJETIVO     : Validar número do contrato e efetuar a inclusão do novo limite de desconto	             		        				   
 * --------------
 * ALTERAÇÕES   :
 * --------------
...
<?php 
	...
	$xmlSetDadosLimIncluir .= "		<Bo>b1wgen0030.p</Bo>";
	...
	$xmlSetDadosLimIncluir .= "		<nrgarope>".$nrgarope."</nrgarope>";
	$xmlSetDadosLimIncluir .= "		<nrinfcad>".$nrinfcad."</nrinfcad>";
	$xmlSetDadosLimIncluir .= "		<nrliquid>".$nrliquid."</nrliquid>";
	$xmlSetDadosLimIncluir .= "		<nrpatlvr>".$nrpatlvr."</nrpatlvr>";
