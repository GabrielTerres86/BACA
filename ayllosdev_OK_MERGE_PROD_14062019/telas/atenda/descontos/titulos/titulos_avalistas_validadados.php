...
<?	
	...
	if ($cddopcao == "I") { // Incluir
		...
		//echo 'showConfirmacao("Deseja alterar os dados do limite de desconto de t&iacute;tulos?","Confirma&ccedil;&atilde;o - Aimaro","gravaLimiteDscTit(\'A\')","bloqueiaFundo(divRotina);","sim.gif","nao.gif");';
		echo 'showConfirmacao("Deseja alterar os dados da Proposta?","Confirma&ccedil;&atilde;o - Aimaro","gravaLimiteDscTit(\'A\', \''.$tipo.'\')","bloqueiaFundo(divRotina);","sim.gif","nao.gif");';
	}
?>
