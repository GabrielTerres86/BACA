<?php
	/*!
	 * FONTE        : altera_fase.php
	 * CRIAÇÃO      : Mateus Zimmermann (Mouts)
	 * DATA CRIAÇÃO : 18/07/2018
	 * OBJETIVO     : Rotina para alterar fase
	 * --------------
	 * ALTERAÇÕES   : 
	 * -------------- 
	 */		
	...
	$xmlResult = mensageria($xml, "TELA_SPBFSE", "ATUALIZA_TBSPB_FASE", $glbvars["cdcooper"], $glbvars["cdagenci"], $glbvars["nrdcaixa"], $glbvars["idorigem"], $glbvars["cdoperad"],"</Root>");
	...
	exibirErro('inform','Fase atualizada com sucesso.' ,'Alerta - Ayllos','buscaFases();',false);
?>