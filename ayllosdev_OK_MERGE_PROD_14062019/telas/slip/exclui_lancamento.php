<?php
	...
	*/
	...
	$xmlResult = mensageria($xml, "SLIP", "EXCLUI_LANCAMENTO", $glbvars["cdcooper"], $glbvars["cdagenci"], $glbvars["nrdcaixa"], $glbvars["idorigem"]                    
	...
	echo "hideMsgAguardo();concluirLancamentoExclusao();".$command;		
