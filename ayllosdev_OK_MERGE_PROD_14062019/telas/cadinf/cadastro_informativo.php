<?php
/*!
 * FONTE        : cadastro_informativo.php                       Última alteração: 29/10/2015
 * CRIAÇÃO      : Jéssica - DB1
 * DATA CRIAÇÃO : 18/08/2015
 * OBJETIVO     : Mostrar tela de cadastro e alteracao - CADINF
 * --------------
			...
			<table cellpadding="0" cellspacing="0" border="0" width="420">
				    ...
				    <td>
						<table width="100%" border="0" cellspacing="0" cellpadding="0" >
							<tr>
								...
								<td class="txtBrancoBold ponteiroDrag" background="<?php echo $UrlImagens; ?>background/tit_tela_fundo.gif"> Informativos e forma de envio </td>
			   ...
			   <tr >
					<td class="tdConteudoTela" align="center">
					  <table width="480" height="260px" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td>
