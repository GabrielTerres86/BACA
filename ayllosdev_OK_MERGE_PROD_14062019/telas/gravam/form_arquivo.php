	...
	<fieldset id="fsetFiltro" name="fsetFiltro" style="padding:0px; margin:0px; padding-bottom:10px;">
		...
		<div id="divFiltroArq">
			...
			<select id="tparquiv" name="tparquiv" >
				<option value="1"> <? echo utf8ToHtml('Inclus&atilde;o') ?> </option> 
				<option value="2"> <? echo utf8ToHtml('Baixa') ?> </option>	
				<option value="3"> <? echo utf8ToHtml('Cancelamento') ?> </option>	
				<option value="4"> <? echo utf8ToHtml('Todas') ?> </option>	
			</select>
