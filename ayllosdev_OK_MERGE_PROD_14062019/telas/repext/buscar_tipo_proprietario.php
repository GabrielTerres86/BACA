<?php
	/*!
	* FONTE        : buscar_tipo_proprietario.php
	* CRIAÇÃO      : Mateus Zimmermann - Mouts
	* DATA CRIAÇÃO : Abril/2018
	* OBJETIVO     : Rotina para realizar a busca dos tipos proprietario
	* --------------
	* ALTERAÇÕES   :
	* -------------- 
	*/		
	...
	$idtipo_dominio = 'P'; // proprietario
	$insituacao     = 'T'; // todos

	//Validar permissão de consulta do usuário
	if (($msgError = validaPermissao($glbvars["nmdatela"],$glbvars["nmrotina"],'P', false)) <> "") {
	...
	<form id="frmTipoProprietario" name="frmTipoProprietario" class="formulario">
		...
		<fieldset id="fsetTipoProprietario" name="fsetTipoProprietario" style="padding:0px; margin:0px; padding-bottom:10px;">
				...
				<table>
					<thead>
						<tr>
							...
							<th><? echo utf8ToHtml('Tipo Proprietário') ?></th>
					...
					<tbody>
						<? foreach( $dados as $dado ) {    ?>
							<tr>	
								...
								<td><? echo stringTabela(getByTagName($dado->tags,'dstipo_dominio'), 33, 'maiuscula'); ?> </td>
	...
	<div id="divBotoes" style='text-align:center; margin-bottom: 10px; margin-top: 10px;' >
		...
		<a href="#" class="botao" id="btIncluir" onClick="mostraFormTipoProprietario('I'); return false;">Incluir</a>
		<a href="#" class="botao" id="btAlterar" onClick="mostraFormTipoProprietario('A'); return false;">Alterar</a>
