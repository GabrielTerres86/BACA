<?php
/*!
 * FONTE        : incluir_cargo_funcao.php
 * CRIAÇÃO      : Jonata (Mouts)
 * DATA CRIAÇÃO : Setembro/2018 
 * OBJETIVO     : Rotina para incluir cargo/funcao
 * --------------
 * ALTERAÇÕES   : 
 */
?> 
...
<?php	
	...
	$xmlResult = mensageria($xml, "TELA_PESSOA", "INCLUIR_CARGO_FUN", $glbvars["cdcooper"], $glbvars["cdagenci"], $glbvars["nrdcaixa"], $glbvars["idorigem"], $glbvars["cdoperad"], "</Root>");
