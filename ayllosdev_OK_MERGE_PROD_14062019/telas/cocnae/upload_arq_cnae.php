 <?php
/*!
 * FONTE        : upload_arq_cnae.php
 * CRIAÇÃO      : Tiago Machado Flor
 * DATA CRIAÇÃO : 16/09/2016
 * OBJETIVO     : Rotina para upload de arquivo COCNAE
 * --------------
 * ALTERAÇÕES   : 
 * --------------
 */
	...
	$xml .= "   <flglimpa>".$flglimpa."</flglimpa>";  
	$xml .= "  </Dados>";
	$xml .= "</Root>";

	// Executa script para envio do XML
	$xmlResult = mensageria($xml, "COCNAE", 'IMPORTAR_ARQ_CNAE', $glbvars["cdcooper"], $glbvars["cdagenci"], $glbvars["nrdcaixa"], $glbvars["idorigem"], $glbvars["cdoperad"], "</Root>");
