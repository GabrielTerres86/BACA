<?
/*!
 * FONTE        : busca_historico.php								Último ajuste: 08/12/2015
 * CRIAÇÃO      : Jéssica - DB1
 * DATA CRIAÇÃO : 09/10/2015
 * OBJETIVO     : Rotina para buscar os dados dos historicos scr da tela CADSCR
 * --------------
...
<?
	...
	$xmlResult = mensageria($xml, "CADSCR", "BUSCAHISTORICO", $glbvars["cdcooper"], $glbvars["cdagenci"], $glbvars["nrdcaixa"], $glbvars["idorigem"], $glbvars["cdoperad"], "</Root>");
