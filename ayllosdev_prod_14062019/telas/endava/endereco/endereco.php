 ...
 * OBJETIVO     : Mostrar rotina de Endereço da tela CONTAS
 */	
?>
...
<?
	...
	if ($flgAcesso == "") exibirErro('error','Seu usu&aacute;rio n&atilde;o possui permiss&atilde;o de acesso a tela de Endere&ccedil;o.','Alerta - Ayllos','');
?>
					...
					<td>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td class="txtBrancoBold ponteiroDrag" background="<?php echo $UrlImagens; ?>background/tit_tela_fundo.gif">ENDEREÇO</td>
								...
								<td>
									<table border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<td align="center" style="background-color: #C6C8CA;" id="imgAbaCen0"><a href="#" id="linkAba0" onClick="<? echo "acessaOpcaoAba(".$qtOpcoesTela.",0,'".$opcoesTela[0]."');"; ?>" class="txtNormalBold">Principal</a></td>
