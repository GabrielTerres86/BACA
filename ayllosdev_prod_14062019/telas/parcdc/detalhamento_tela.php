<?
/*!
 * FONTE        : detalhamento_tela.php
 * CRIAÇÃO      : Diego Simas
 * DATA CRIAÇÃO : 30/04/2018
 * OBJETIVO     : Tela do formulário de detalhamento da aba comissão na tela PARCDC
 */	 
?>
					...
					<td>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td width="12" id="tdTitTela" background="<?php echo $UrlImagens; ?>background/tit_tela_fundo.gif"><a href="#" onClick="fechaRotina($('#divUsoGenerico')); carregaDetalhamento(); return false;"><img src="<?php echo $UrlImagens; ?>geral/excluir.jpg" width="12" height="12" border="0"></a></td>
