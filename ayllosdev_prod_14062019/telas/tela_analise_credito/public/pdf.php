...
*/
	...
	if (isset($_SESSION['params']['tpproduto'])) {
		switch ($_SESSION['params']['tpproduto']) {
				case '0'  : $aux = "Proposta de CDC - Diversos"; break;
				case '1'  : $aux = "Proposta de CDC - Veículos"; break;
				case '2'  : $aux = "Proposta de Empréstimo e Financiamento"; break;
				case '3'  : $aux = "Desconto de Cheques - Limite"; break;
				case '4'  : $aux = "Desconto de Cheques - Borderô"; break;
				case '5'  : $aux = "Proposta de Limite de Desconto de Títulos"; break;
				case '6'  : $aux = "Proposta de Borderô de Desconto de Títulos"; break;
				case '7'  : $aux = "Proposta de Cartão de Crédito"; break;
				case '8'  : $aux = "Limite de Crédito (Conta)"; break;
				case '9'  : $aux = "Consignado"; break;
				case '10' : $aux = "Rating"; break;
	...
	*/
    ...
    if (isset($_GET['token'])) {
        ...
        if (isset($_SESSION[$token])) {
        	...
        	// recebe os dados da sessão para gerar o PDF
    	...
    	// token de identificação não existe
        echo 'Sem acesso.';
        die();
    }
