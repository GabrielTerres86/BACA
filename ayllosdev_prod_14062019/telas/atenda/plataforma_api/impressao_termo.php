...
/***********************************************************************
  ...
  Data : Março/2019                       Última Alteração: XX/XX/XXXX
	                                                                   
  Objetivo  : Gerar o PDF do termo da PLATAFORMA API              
...
// craprdr / crapaca 
$xmlResult = mensageria($xml, "TELA_ATENDA_API", "IMPRIME_TERMO", $glbvars["cdcooper"], $glbvars["cdagenci"], $glbvars["nrdcaixa"], $glbvars["idorigem"], $glbvars["cdoperad"], "</Root>");
