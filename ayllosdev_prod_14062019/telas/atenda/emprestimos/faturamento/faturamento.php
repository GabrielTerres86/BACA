<?
/*!
 * FONTE        : faturamento.php
 * CRIAÇÃO      : Gabriel Capoia - DB1 Informatica
 * DATA CRIAÇÃO : 26/04/2010 
 * OBJETIVO     : Mostra rotina filha de Faturamento da rotina de Emprestimos
 * --------------
 * ALTERAÇÕES   :
...
?>
<table id="tbfat" cellpadding="0" cellspacing="0" border="0" width="100%" >
	<tr>
		<td align="center">		
					...
					<td>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td class="txtBrancoBold ponteiroDrag" background="<?php echo $UrlImagens; ?>background/tit_tela_fundo.gif">FATURAMENTO</td>
							...
							<tr>
								<td align="center" style="border: 2px solid #969FA9; background-color: #F4F3F0; padding: 2px;">
									<div id="divConteudoOpcao">
										<?
										include("tab_faturamento.php"); 
										include("form_faturamento.php"); 
										?>									
									</div>
								</td>
							</tr>
