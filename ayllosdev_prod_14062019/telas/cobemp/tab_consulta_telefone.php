...
$xmlResult = mensageria($xml, "TELA_COBEMP", "BUSCAR_TELEFONE", $glbvars["cdcooper"], $glbvars["cdagenci"], $glbvars["nrdcaixa"], $glbvars["idorigem"], $glbvars["cdoperad"], "</Root>");
        ...
        <table width="100%">
            ...
            <tbody>
                ...
                foreach ($registros as $r) {
                    $conta++;
                    ?> 
                    <tr><td><span><?php echo getByTagName($r->tags, 'nmopetfn'); ?></span>
                            <?php echo getByTagName($r->tags, 'nmopetfn'); ?>
                        </td>
                        <td><span><?php echo getByTagName($r->tags, 'nrdddtfc'); ?></span>
                            <?php echo getByTagName($r->tags, 'nrdddtfc'); ?>
                        </td>
                        <td><span><?php echo getByTagName($r->tags, 'nrtelefo'); ?></span>
                            <?php echo getByTagName($r->tags, 'nrtelefo'); ?>
                            <input type="hidden" id="nrtelefo" value="<?php echo getByTagName($r->tags, 'nrdddtfc').' '.getByTagName($r->tags, 'nrtelefo'); ?>"/>
                        </td>
                        <td><span><?php echo getByTagName($r->tags, 'nrdramal'); ?></span>
                            <?php echo getByTagName($r->tags, 'nrdramal'); ?>
                        </td>
                        <td><span><?php echo getByTagName($r->tags, 'tptelefo'); ?></span>
                            <?php echo getByTagName($r->tags, 'tptelefo'); ?>
                        </td>
                        <td>
                        </td>
