...
<form action="" method="post" id="frmTaxas" name="frmTaxas">
    <div class="tabModalidade">
        <div class="divRegistros">
            <table class="tituloRegistros"> 
                <thead>
                    <tr>
                        <?php if ($subopcao == 'E' || $subopcao == 'D' || $subopcao == 'B' || $subopcao == 'I') { ?>
                            <th align="left">
                    ...
                    <?php foreach ($registros as $registro) { ?>
                        <?php if ( $registro->tags[0]->cdata > 0 ) { ?>
                            <tr id="<?php echo($registro->tags[0]->cdata); ?>">
                                ...
                                <td>
                                    <?php echo $registro->tags[4]->cdata; ?>
                                </td>
                                <td>
                                    <?php
            ...
            <tr>
                ...
                <td id="nrRegistrosTabela">
                    <?php if (isset($nriniseq)) { ?> 
                        ...
                        at&eacute; 
                        <?php
                            echo (($nriniseq + $nrregist) > $qtdregist) ? $qtdregist : ($nriniseq + $nrregist - 1);
                        ?> 
                        de <?php
                        echo $qtdregist;
                    }
    ...
    <div id="divBotoes">
        ...
        <?php if ($subopcao == 'E' && $qtdregist > 0) { ?>
            <a href="javascript:void(0);" class="botao" id="btProseguir" onclick="validaOperacao('<?php echo $subopcao; ?>');" ><?php echo utf8ToHtml('Prosseguir'); ?></a>
        <?php } else if ($subopcao == 'D' && $qtdregist > 0) { ?>
            <a href="javascript:void(0);" class="botao" id="btProseguir" onclick="validaOperacao('<?php echo $subopcao; ?>');" ><?php echo utf8ToHtml('Prosseguir'); ?></a>
        <?php } else if ($subopcao == 'B' && $qtdregist > 0) { ?>
            <a href="javascript:void(0);" class="botao" id="btProseguir" onclick="validaOperacao('<?php echo $subopcao; ?>');" ><?php echo utf8ToHtml('Prosseguir'); ?></a>
        <?php } else if ($subopcao == 'I' && $qtdregist > 0) { ?>
            <a href="javascript:void(0);" class="botao" id="btProseguir" onclick="validaOperacao('<?php echo 'I'; ?>');" ><?php echo utf8ToHtml('Prosseguir'); ?></a>
        <?php } ?>
    </div>
...
<script type="text/javascript">
    $(function() {
        $('a.paginacaoAnt').unbind('click').bind('click', function() {
            consultaModalidade(<?php echo "'" . ($nriniseq - $nrregist) . "'"; ?>, <?php echo "'" . $nrregist . "'"; ?>);
        });
