 ...
 * OBJETIVO     : Opções Dossie DigiDoc
 * --------------
 * ALTERAÇÕES   :
 * --------------
 */
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td align="center" style="border: 2px solid #969FA9; background-color: #F4F3F0; padding: 2px;">
                  ...
                  <a href="#" class="botao" style="margin: 7px;" id="btDocContas" onclick="window.open('http://<?php echo $GEDServidor; ?>/smartshare/Cliente/ViewerExterno.aspx?pkey=9lODJ&CONTA=<? echo str_replace("-",".",formataContaDV($_POST['nrdconta']));?>&COOPERATIVA=<? echo $_POST['cdcooper']; ?>','_blank');">Documentos de Contas</a>
                </td>
              </tr>
            </table>
					</td>
