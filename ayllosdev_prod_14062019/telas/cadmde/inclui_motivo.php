<?php
	 ...
	 * OBJETIVO     : Rotina para incluir motivo de desligamento
	 * --------------
	 * ALTERAÇÕES   : 
	 * -------------- 
	 */		
	...
	$tpmotivo = (isset($_POST['tpmotivo'])) ? $_POST['tpmotivo'] : 0; 
	...
	$xml .= " <tpmotivo>".$tpmotivo."</tpmotivo>";
	$xml .= " </Dados>";
	$xml .= "</Root>";
	
	$xmlResult = mensageria($xml, "TELA_CADMDE", "INSERE_MOTIVO", $glbvars["cdcooper"], $glbvars["cdagenci"], $glbvars["nrdcaixa"], $glbvars["idorigem"], $glbvars["cdoperad"], "</Root>");
	...
	exibirErro('inform','Motivo cadastrado com o c&oacute;digo '.$cdmotivo .'.' ,'Alerta - Ayllos','estadoInicial();',false);
?>