 ...
 * OBJETIVO     : Mostra rotina de Dados Pessoais da tela de CADCTA
 *
 * ALTERACOES   :  Correcao no uso da constante $opcoesTela. SD 479874. (Carlos R.)
 *                 26/10/2017 - Replicado fonte da tela CONTAS para a tela CADCTA PRJ339 - CRM (Odirlei-AMcom)
 */	 
									...
									<table border="0" cellspacing="0" cellpadding="0">
										<tr style="height:22px;">
											...
											<td align="center" style="background-color: #C6C8CA; border-radius:3px; " id="imgAbaCen1">
												<a href="#" id="linkAba1" onClick=<?php echo "acessaOpcaoAbaDados(6,1,'".$vr_opcao."');"; ?> class="txtNormalBold">&nbsp; Comercial &nbsp; </a>
											</td>											
											<td width="1px"></td>
										</tr>
									</table>
...
<script type="text/javascript">
	...
	acessaOpcaoAbaDados(6,0,"<?php echo $opeaction; ?>");
</script>