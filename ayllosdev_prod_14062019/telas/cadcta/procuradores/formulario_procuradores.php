...
<div id="divProcuradores">
	...
	<form name="frmDadosProcuradores" id="frmDadosProcuradores" class="formulario condensado" >		
		<fieldset>
            ...
            <input type="hidden" id="nrdrowid" name="nrdrowid" value="<? echo getByTagName($registros[0]->tags,'nrdrowid') ?>" />
            <input type="hidden" id="dsproftl" name="dsproftl" value="<? echo getByTagName($registros[0]->tags,'dsproftl'); ?>" />
            <input type="hidden" id="dtadmsoc" name="dtadmsoc" value="<? echo getByTagName($registros[0]->tags,'dtadmsoc'); ?>" />
            <input type="hidden" id="persocio" name="persocio" value="<? echo getByTagName($registros[0]->tags,'persocio'); ?>" />
			...
			<br />
			<label for="cdoeddoc" class="rotulo rotulo-70">Org.Emi.:</label>
	...
	<div id="divBotoes">
        ...
        <?  
            if ($operacao == 'A') {
                ...
                $acaoVoltar =  'controlaOperacaoProcuradores(\'AT\'); return false;';
            } else if ($operacao == 'I') {
                $acaoVoltar =  'controlaOperacaoProcuradores(\'IT\'); return false;' ;           
            }    
            else {                
               $acaoVoltar =  'fechaRotina(divRotina,\'\',\'obtemCabecalho();\');';
            }?>
    
        <input type="image" id="btVoltar" src="<? echo $UrlImagens; ?>botoes/voltar.gif"   onClick="<? echo $acaoVoltar;?>" />	             
		<? if ( $operacao == 'CF' ) { ?>		
			...
			<input type="image" id="btExcluir"   src="<? echo $UrlImagens; ?>botoes/excluir.gif"   onClick="manterRotinaProcuradores('EV'); return false;" />    
