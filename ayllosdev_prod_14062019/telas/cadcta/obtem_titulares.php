<?php 
	...
	echo '$("#idseqttl","#frmCabCadcta").val("1");'; // fixo, tela não está respeitando o selected
	echo '$("#nrdconta","#frmCabCadcta").val("'.$nrdconta.'").formataDado("INTEGER","zzzz.zzz-z","",false);';
