<?php	
	/*!
	 * FONTE        : limpar_faturas.php
	 * CRIAÇÃO      : Gabriel Marcos (Mouts)
	 * DATA CRIAÇÃO : Novembro/2018 
	 * OBJETIVO     : Rotina para realizacao de limpeza de faturas para as cooperativas
	 * --------------
	 * ALTERAÇÕES   : 
	 */
	...
	$xmlResult = mensageria($xml, "TELA_HCONVE", "LIMPAR_FATURAS", $glbvars["cdcooper"], $glbvars["cdagenci"], $glbvars["nrdcaixa"], $glbvars["idorigem"], $glbvars["cdoperad"], "</Root>");
	...
	if (strtoupper($xmlObjParametros->roottag->tags[0]->name) == "ERRO") {
		...
		exibirErro('error',utf8_encode($msgErro),'Alerta - Aimaro','formataFormOpcaoF();$(\'#btVoltar\',\'#divBotoes\').focus();',false);		
