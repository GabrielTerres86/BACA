<?
/*!
 * FONTE        : tab_eventos_unico.php
 * CRIAÇÃO      : Andre Santos - SUPERO
 * DATA CRIAÇÃO : Novembro/2014
 * OBJETIVO     : Monta Tabela de eventos unico de remessa LOGRBC
 * --------------
 * ALTERAÇÕES   :
 * --------------
 */
...
<div id="tabEventoUnico" style="display:block" >
	<div class="divRegistros">
        <table class="tituloRegistros">
			<thead>
				<tr>
					<th><? echo utf8ToHtml('Data');  ?></th>
					<th><? echo utf8ToHtml('Est&aacute;gio');  ?></th>
