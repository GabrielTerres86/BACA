 ...
 * OBJETIVO     : Rotina para buscar historico estorno na tela RELTAR
 * --------------
 * ALTERAÇÕES   : 
 * -------------- 
 */
...
<?	
	...
	$retornoAposErro = 'focaCampoErro(\'cdhisest\', \'frmReltar\');';
	...
	echo "$('#dshisest','#frmReltar').val('$dshisest');";
	echo "$('#cdhisest','#frmReltar').desabilitaCampo();";
	echo "$('#cdmotest','#frmReltar').focus();";		
