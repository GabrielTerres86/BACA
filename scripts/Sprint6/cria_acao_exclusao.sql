declare 
  ...
  vr_refaca varchar(100) := 'ATVPRB_EXCLUSAO'; -- nome de referencia da acao, que será chamada no front
  vr_nomprc varchar(100) := 'pc_exclusao'; -- nome da procedure dentro da package
  vr_params varchar(300) := 'pr_cdcooper,pr_nrdconta,pr_nrctremp,pr_cdmotivo'; -- parametros da package
