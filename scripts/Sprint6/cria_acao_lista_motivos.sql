declare 
  ...
  vr_refaca varchar(100) := 'ATVPRB_LISTA_MOTIVOS'; -- nome de referencia da acao, que será chamada no front
  vr_nomprc varchar(100) := 'pc_busca_motivos_probl'; -- nome da procedure dentro da package
  vr_params varchar(300) := 'pr_tipo'; -- parametros da package
