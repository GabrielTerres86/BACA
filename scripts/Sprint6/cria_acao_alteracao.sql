declare 
  ...
  vr_refaca varchar(100) := 'ATVPRB_ALTERACAO'; -- nome de referencia da acao, que será chamada no front
  vr_nomprc varchar(100) := 'pc_alteracao'; -- nome da procedure dentro da package
