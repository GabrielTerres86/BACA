...
declare 
  ...
  -- ALTERAR
  NOME_DA_ACAO VARCHAR2(40) := 'GERA_LCM';
  PROCEDURE_DA_ACAO VARCHAR2(100) := 'pc_gera_lcm_cta_prj';
  PACKAGE_DA_ACAO VARCHAR2(100) := 'PREJ0003';
  PARAMETROS_DA_ACAO VARCHAR2(1000):= 'pr_cdcooper, pr_nrdconta, pr_tpope, pr_cdoperad, pr_vlrlanc';
  -- FIM ALTERAR
