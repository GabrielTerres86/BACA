...
declare 
  ...
  -- ALTERAR
  NOME_DA_ACAO VARCHAR2(40) := 'PAGA_PREJUIZO_CC';
  PROCEDURE_DA_ACAO VARCHAR2(100) := 'pc_paga_prejuz_cc';
  PACKAGE_DA_ACAO VARCHAR2(100) := 'TELA_ATENDA_DEPOSVIS';
  PARAMETROS_DA_ACAO VARCHAR2(1000):= 'pr_cdcooper, pr_nrdconta, pr_vlrpagto, pr_vlrabono';
  -- FIM ALTERAR
