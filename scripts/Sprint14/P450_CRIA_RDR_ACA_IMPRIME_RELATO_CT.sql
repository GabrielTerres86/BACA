...
declare 
  ...
  -- ALTERAR
  NOME_DA_ACAO VARCHAR2(40) := 'IMPRIME_RELATO_CT';
  PROCEDURE_DA_ACAO VARCHAR2(100) := 'pc_extrato_lanc_prej_relat_web';
  PACKAGE_DA_ACAO VARCHAR2(100) := 'PREJ0004';
  PARAMETROS_DA_ACAO VARCHAR2(1000):= 'pr_nrdconta, pr_dtiniper, pr_dtfimper';
  -- FIM ALTERAR
