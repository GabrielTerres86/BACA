...
begin
  ...
  OPEN cr_crapaca(pr_nmdeacao => 'CONSISTE_NOVO_LIMITE'
                 ,pr_nmpackag => 'ZOOM0001'
                 ,pr_nmproced => 'pc_consiste_novo_limite'
  ...
  IF cr_crapaca%NOTFOUND THEN
    ...
    INSERT INTO crapaca(nmdeacao, 
                        ...
                        lstparam, 
                        nrseqrdr) 
                 VALUES('CONSISTE_NOVO_LIMITE',
                        'ZOOM0001',
                        'pc_consiste_novo_limite',
                        'pr_cdcooper, pr_nrdconta',
                        rw_craprdr.nrseqrdr);
                             
    dbms_output.put_line('Insere CRAPACA -> CONSULTAR_CONTROLE -> ZOOM0001.pc_consiste_novo_limite');
