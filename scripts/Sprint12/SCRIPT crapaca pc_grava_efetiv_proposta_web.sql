...
-- PROCEDURE_DA_ACAO -> NOME DA ACAO NA CRAPACA
-- PACKAGE_DA_ACAO -> NOME DA PACKAGE NA CRAPACA
-- PARAMETROS_DA_ACAO -> PARÂMETROS DE ENTRADA

declare

  -- ALTERAR
  NOME_DA_ACAO VARCHAR2(40) := 'EFETIVA_PROPOSTA';
  PROCEDURE_DA_ACAO VARCHAR2(100) := 'pc_grava_efetiv_proposta_web';
  PACKAGE_DA_ACAO VARCHAR2(100) := 'EMPR0013';
  PARAMETROS_DA_ACAO VARCHAR2(1000):= 'pr_cdcooper,pr_cdagenci,pr_nrdcaixa,pr_cdoperad,pr_nmdatela
                                      ,pr_idorigem,pr_nrdconta,pr_idseqttl,pr_dtmvtolt,pr_flgerlog
                                      ,pr_nrctremp,pr_insitapr,pr_dsobscmt,pr_dtdpagto,pr_cdbccxlt
                                      ,pr_nrdolote,pr_dtmvtopr,pr_inproces,pr_nrcpfope';
  -- FIM ALTERAR
