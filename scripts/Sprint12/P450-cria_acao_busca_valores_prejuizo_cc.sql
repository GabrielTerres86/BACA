declare 
  ...
  vr_refaca varchar(100) := 'BUSCA_VLRS_PGTO_PREJUZ_CC'; -- nome de referencia da acao, que será chamada no front
  vr_nomprc varchar(100) := 'pc_busca_vlrs_prejuz_cc'; -- nome da procedure dentro da package
