declare 
  vr_nompkg varchar(100) := 'TELA_ATENDA_DEPOSVIS'; -- nome da package
  vr_refaca varchar(100) := 'PAGA_PREJUZ_CC'; -- nome de referencia da acao, que será chamada no front
  vr_nomprc varchar(100) := 'pc_paga_prejuz_cc'; -- nome da procedure dentro da package
  vr_params varchar(300) := 'pr_cdcooper,pr_nrdconta,pr_vlrpagto,pr_vlrabono'; -- parametros da package
