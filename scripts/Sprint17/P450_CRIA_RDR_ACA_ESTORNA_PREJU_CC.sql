...
declare 
  ...
  -- ALTERAR
  NOME_DA_ACAO VARCHAR2(40) := 'ESTORNA_PREJU_CC';
  PROCEDURE_DA_ACAO VARCHAR2(100) := 'pc_grava_estorno_preju';
  PACKAGE_DA_ACAO VARCHAR2(100) := 'PREJ0003';
  PARAMETROS_DA_ACAO VARCHAR2(1000):= 'pr_cdcooper, pr_nrdconta, pr_totalest, pr_justific';
  -- FIM ALTERAR
