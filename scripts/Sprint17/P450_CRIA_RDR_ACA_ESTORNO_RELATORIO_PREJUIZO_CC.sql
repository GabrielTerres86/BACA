...
declare 
  ...
  -- ALTERAR
  NOME_DA_ACAO VARCHAR2(40) := 'ESTORNO_RELATORIO_PREJUIZO';
  PROCEDURE_DA_ACAO VARCHAR2(100) := 'pc_tela_imprimir_relatorio';
  PACKAGE_DA_ACAO VARCHAR2(100) := 'PREJ0003';
  PARAMETROS_DA_ACAO VARCHAR2(1000):= 'pr_nrdconta, pr_dtmvtolt, pr_dtiniest, pr_dtfinest';
  -- FIM ALTERAR
