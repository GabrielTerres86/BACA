...
declare 
  ...
  -- ALTERAR
  NOME_DA_ACAO VARCHAR2(40) := 'CONSULTA_SIT_EMPR';
  PROCEDURE_DA_ACAO VARCHAR2(100) := 'pc_consulta_sit_empr';
  PACKAGE_DA_ACAO VARCHAR2(100) := 'TELA_ATENDA_DEPOSVIS';
  PARAMETROS_DA_ACAO VARCHAR2(1000):= 'pr_cdcooper, pr_nrdconta, pr_nrctremp';
  -- FIM ALTERAR
