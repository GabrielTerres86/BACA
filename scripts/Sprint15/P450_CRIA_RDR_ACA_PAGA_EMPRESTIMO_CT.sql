...
declare 
  ...
  -- ALTERAR
  NOME_DA_ACAO VARCHAR2(40) := 'PAGA_EMPRESTIMO_CT';
  PROCEDURE_DA_ACAO VARCHAR2(100) := 'pc_paga_emprestimo_ct';
  PACKAGE_DA_ACAO VARCHAR2(100) := 'TELA_ATENDA_DEPOSVIS';
  PARAMETROS_DA_ACAO VARCHAR2(1000):= 'pr_cdcooper, pr_nrdconta, pr_nrctremp, pr_vlrabono, pr_vlrpagto';
  -- FIM ALTERAR
