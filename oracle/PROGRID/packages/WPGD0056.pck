CREATE OR REPLACE PACKAGE PROGRID.WPGD0056 is
 ---------------------------------------------------------------------------------------------------------------
  --
  --  Programa : WPGD0020
  ...
  --                          ao usuario conforme especificacao da tela WPGD0020. (Carlos Rafael Tanholi)
  --
  ---------------------------------------------------------------------------------------------------------------
  
  -- Rotina geral de insert, update, select e delete da tela WPGD0020
...
END WPGD0056;
/
CREATE OR REPLACE PACKAGE BODY PROGRID.WPGD0056 IS
  ---------------------------------------------------------------------------------------------------------------
  --
  --  Programa : WPGD0056
  --  Sistema  : Rotinas para tela de Envio de Sugestoes
  ...
  --                          ao usuario conforme especificacao da tela WPGD0020. (Carlos Rafael Tanholi) 
  --
  --             31/05/2016 - Replace para tratar o envio do email com formatação (Vanessa)                         
  --
  --             02/06/2016 - Ajustes na rotina pc_crapsde para atualizar a qtd de datas na tabela
  --                          crapeap.qtocoeve. E reordernar a tabela crapsde para nao deixar furos.
   ...
   -- Consulta de eventos por cooperativa
    ...
    EXCEPTION
      ...
      WHEN OTHERS THEN
        ...
        pr_cdcritic := vr_cdcritic;
        pr_dscritic := 'Erro geral em PC_WPGD0056: ' || SQLERRM;
