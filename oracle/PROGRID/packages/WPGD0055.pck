CREATE OR REPLACE PACKAGE PROGRID.WPGD0055 is
 ---------------------------------------------------------------------------------------------------------------
  --
  --  Programa : WPGD0055
  ...
  --                          ao usuario conforme especificacao da tela WPGD0055. (Carlos Rafael Tanholi)
  --
  ---------------------------------------------------------------------------------------------------------------
  
  -- Rotina geral de insert, update, select e delete da tela WPGD0055
...
END WPGD0055;
/
CREATE OR REPLACE PACKAGE BODY PROGRID.WPGD0055 IS
  ---------------------------------------------------------------------------------------------------------------
  --
  --  Programa : WPGD0055
  --  Sistema  : Rotinas para tela de Envio de Sugestoes
   ...
   -- Consulta de eventos por cooperativa
    ...
    EXCEPTION
      ...
      WHEN OTHERS THEN
        ...
        pr_cdcritic := vr_cdcritic;
        pr_dscritic := 'Erro geral em PC_WPGD0055: ' || SQLERRM;
