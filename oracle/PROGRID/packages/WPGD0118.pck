        ...
        WHEN 'C' THEN -- Consulta
          ...
          FOR rw_craprcp IN cr_craprcp(pr_cdcooper => pr_cdcooper
            ...
            IF ((pr_nriniseq <= rw_craprcp.nrdseque) AND (rw_craprcp.nrdseque <= (pr_nriniseq + (pr_qtregist - 1)))) THEN
              ...
              GENE0007.pc_insere_tag(pr_xml => pr_retxml, pr_tag_pai => 'inf', pr_posicao => vr_contador, pr_tag_nova => 'nrtelct1', pr_tag_cont => TRIM(GENE0002.fn_mask(rw_craprcp.nrtelct1,'z9999-9999')), pr_des_erro => vr_dscritic);
              ...
              GENE0007.pc_insere_tag(pr_xml => pr_retxml, pr_tag_pai => 'inf', pr_posicao => vr_contador, pr_tag_nova => 'numtele1', pr_tag_cont => TRIM(GENE0002.fn_mask(rw_craprcp.nrdddct1,'99') || ' ' || GENE0002.fn_mask(rw_craprcp.nrtelct1,'z9999-9999')), pr_des_erro => vr_dscritic);
