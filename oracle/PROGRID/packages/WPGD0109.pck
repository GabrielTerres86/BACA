...
---------------------------------------------------------------------------------------------------------------
  ...
  PROCEDURE pc_lista_eventos(pr_cdcooper IN crapcop.cdcooper%TYPE --> Codigo da Cooperativa
    ...
    Data    : Dezembro/15.                    Ultima atualizacao: 02/12/2015
    ...
    DECLARE
      ...
      CURSOR cr_relatorio(pr_cdcooper IN crapcop.cdcooper%TYPE
        ...
        SELECT DISTINCT ge.dseixtem Eixo,
                        ct.dstemeix Tema,
                        ...
                        NVL(cp.DSPUBALV, g.dspublic) dspubalv,
                        c.qtmaxtur,
                        REPLACE(to_char(g.qtcarhor,'FM900D00'), '.', ':') qtcarhor
                  FROM crapedp c, gnappdp g, craptem ct, gnapetp ge, crappap cp 
                 WHERE (c.cdcooper = 0)  
    ...
    BEGIN
      ...
      LOOP
        ...
        GENE0007.pc_insere_tag(pr_xml => pr_retxml, pr_tag_pai => 'inf',  pr_posicao => vr_contador, pr_tag_nova => 'dspubalv', pr_tag_cont => rw_relatorio.dspubalv, pr_des_erro => vr_dscritic);                         
