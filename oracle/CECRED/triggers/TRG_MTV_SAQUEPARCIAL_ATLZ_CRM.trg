CREATE OR REPLACE TRIGGER CECRED.TRG_MTV_SAQUEPARCIAL_ATLZ_CRM
  AFTER INSERT OR UPDATE OR DELETE ON TBCOTAS_MOTIVO_SAQUEPARCIAL
  FOR EACH ROW
  /* ..........................................................................

     Programa : TRG_MTV_SAQUEPARCIAL_ATLZ_CRM
...
DECLARE
  ...
  vr_nmtabela   CONSTANT VARCHAR2(50) := 'TBCOTAS_MOTIVO_SAQUEPARCIAL';
  ...
  rw_dados      TBCOTAS_MOTIVO_SAQUEPARCIAL%ROWTYPE;
  rw_dados_ant  TBCOTAS_MOTIVO_SAQUEPARCIAL%ROWTYPE;
  vr_tpoperac   INTEGER;
...
BEGIN
  ...
  CADA0013.pc_processa_mtv_saque_parcial ( pr_rw_dados     => rw_dados         --> Rowtipe contendo os dados dos Campos da tabela
...
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE <> -20500 THEN
      vr_dscritic := 'Erro nao tratado na TRG_MTV_SAQUEPARCIAL_ATLZ_CRM: '||SQLERRM;
      
    ELSE
      vr_dscritic := SQLERRM;
    END IF;
    raise_application_error(-20500,vr_dscritic);
END TRG_MTV_SAQUEPARCIAL_ATLZ_CRM;
/
