CREATE OR REPLACE TRIGGER CECRED.TRG_TBCADAST_PF_RESP_HST
  AFTER INSERT OR UPDATE OR DELETE ON TBCADAST_PESSOA_FISICA_RESP
  FOR EACH ROW
  /* ..........................................................................

     Programa : TRG_TBCADAST_PF_RESP_HST
...
BEGIN
  ...
  IF INSERTING THEN
    ...
    vr_nrsequen := :new.NRSEQ_RESP_LEGAL;    
  ELSIF UPDATING THEN
  ...
  ELSIF DELETING THEN
    ...
    vr_nrsequen := :old.NRSEQ_RESP_LEGAL;
   ...
   ****** TBCADAST_CAMPO_HISTORICO ******
            147	IDPESSOA
            148	NRSEQ_RESP_LEGAL
            149	IDPESSOA_RESP_LEGAL
            150	CDRELACIONAMENTO
            151	CDOPERAD_ALTERA
