CREATE OR REPLACE TRIGGER CECRED.TRG_CRAPBEM_ATLZ
  AFTER INSERT OR UPDATE OR DELETE ON CRAPBEM
  FOR EACH ROW  
  /* ..........................................................................
    
     Programa : TRG_CRAPBEM_ATLZ
...
DECLARE
  ...
  vr_nmtabela   CONSTANT VARCHAR2(50) := 'CRAPBEM';
  vr_cdcooper   NUMBER;
  vr_nrdconta   NUMBER;
  vr_idseqttl   NUMBER;
...
BEGIN
  ...
  IF deleting THEN
    ...
    vr_dschave  := :old.CDCOOPER||';'||:old.NRDCONTA||';'||:old.IDSEQTTL||';'||:old.IDSEQBEM;
  ELSE
    vr_cdcooper := :new.cdcooper;
    vr_nrdconta := :new.nrdconta;
    vr_idseqttl := :new.idseqttl;
    vr_dschave  := :new.CDCOOPER||';'||:new.NRDCONTA||';'||:new.IDSEQTTL||';'||:new.IDSEQBEM;
  END IF;
...
EXCEPTION
  WHEN OTHERS THEN
    vr_dscritic := 'Erro nao tratado na TRG_CRAPBEM_ATLZ: '||SQLERRM;
    raise_application_error(-20500,vr_dscritic);
END TRG_CRAPBEM_ATLZ;
/
