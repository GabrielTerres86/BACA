CREATE OR REPLACE TRIGGER CECRED.TRG_CRAPOPI_ATLZ
  AFTER INSERT OR UPDATE OR DELETE
  OF dsdcargo, nmoperad, flgsitop
  ON CRAPOPI
  FOR EACH ROW  
 
  /* ..........................................................................
    
     Programa : TRG_CRAPOPI_ATLZ
...
DECLARE
  ...
  vr_nmtabela   CONSTANT VARCHAR2(50) := 'CRAPOPI';
  vr_cdcooper   NUMBER;
  vr_nrdconta   NUMBER;
  vr_idseqttl   NUMBER;
...
EXCEPTION
  WHEN OTHERS THEN
    vr_dscritic := 'Erro nao tratado na TRG_CRAPOPI_ATLZ: '||SQLERRM;
    raise_application_error(-20500,vr_dscritic);
END TRG_CRAPAVT_ATLZ;
/
