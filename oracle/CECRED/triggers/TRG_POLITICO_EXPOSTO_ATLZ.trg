CREATE OR REPLACE TRIGGER CECRED.TRG_POLITICO_EXPOSTO_ATLZ
  AFTER INSERT OR UPDATE OR DELETE ON TBCADAST_POLITICO_EXPOSTO
  FOR EACH ROW  
  /* ..........................................................................
    
     Programa : TRG_POLITICO_EXPOSTO_ATLZ
...
DECLARE
  ...
  vr_nmtabela   CONSTANT VARCHAR2(50) := 'TBCADAST_POLITICO_EXPOSTO';
  vr_cdcooper   NUMBER;
  vr_nrdconta   NUMBER;
  vr_idseqttl   NUMBER;
...
EXCEPTION
  WHEN OTHERS THEN
    vr_dscritic := 'Erro nao tratado na TRG_POLITICO_EXPOSTO_ATLZ: '||SQLERRM;
    raise_application_error(-20500,vr_dscritic);
END TRG_POLITICO_EXPOSTO_ATLZ;
/
