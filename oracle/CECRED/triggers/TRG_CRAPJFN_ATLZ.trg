CREATE OR REPLACE TRIGGER CECRED.TRG_CRAPJFN_ATLZ
  AFTER INSERT OR UPDATE OR DELETE ON CRAPJFN
  FOR EACH ROW  
  /* ..........................................................................
    
     Programa : TRG_CRAPJFN_ATLZ
...
DECLARE
  ...
  vr_nmtabela   CONSTANT VARCHAR2(50) := 'CRAPJFN';
  vr_cdcooper   NUMBER;
  vr_nrdconta   NUMBER;
  vr_idseqttl   NUMBER;
...
EXCEPTION
  WHEN OTHERS THEN
    vr_dscritic := 'Erro nao tratado na TRG_CRAPJFN_ATLZ: '||SQLERRM;
    raise_application_error(-20500,vr_dscritic);
END TRG_CRAPJFN_ATLZ;
/
