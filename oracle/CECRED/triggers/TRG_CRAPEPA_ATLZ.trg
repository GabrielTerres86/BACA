CREATE OR REPLACE TRIGGER CECRED.TRG_CRAPEPA_ATLZ
  AFTER INSERT OR UPDATE OR DELETE ON CRAPEPA
  FOR EACH ROW  
  /* ..........................................................................
    
     Programa : TRG_CRAPEPA_ATLZ
...
DECLARE
  ...
  vr_nmtabela   CONSTANT VARCHAR2(50) := 'CRAPEPA';
  vr_cdcooper   NUMBER;
  vr_nrdconta   NUMBER;
  vr_idseqttl   NUMBER;
...
BEGIN
  ...
  IF deleting THEN
    ...
    vr_idseqttl := 1;
    vr_dschave  := :old.CDCOOPER||';'||:old.NRDOCSOC||';'||
                   :old.NRDCONTA;
  ELSE
    vr_cdcooper := :new.cdcooper;
    vr_nrdconta := :new.nrdconta;
    vr_idseqttl := 1;
    vr_dschave  := :new.CDCOOPER||';'||:new.NRDOCSOC||';'||
                   :new.NRDCONTA;
  END IF;
...
EXCEPTION
  WHEN OTHERS THEN
    vr_dscritic := 'Erro nao tratado na TRG_CRAPEPA_ATLZ: '||SQLERRM;
    raise_application_error(-20500,vr_dscritic);
END TRG_CRAPEPA_ATLZ;
/
