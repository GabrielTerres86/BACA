CREATE OR REPLACE TRIGGER CECRED.TRG_CRAPAVT_ATLZ
  AFTER INSERT OR UPDATE OR DELETE ON CRAPAVT
  FOR EACH ROW  
  /* ..........................................................................
    
     Programa : TRG_CRAPAVT_ATLZ
...
DECLARE
  ...
  vr_nmtabela   CONSTANT VARCHAR2(50) := 'CRAPAVT';
  vr_cdcooper   NUMBER;
  vr_nrdconta   NUMBER;
  vr_idseqttl   NUMBER;
...
BEGIN
  ...
  IF :new.Tpctrato IN (5,6) OR
     :old.Tpctrato IN (5,6) THEN
    IF deleting THEN
...
EXCEPTION
  WHEN OTHERS THEN
    vr_dscritic := 'Erro nao tratado na TRG_CRAPAVT_ATLZ: '||SQLERRM;
    raise_application_error(-20500,vr_dscritic);
