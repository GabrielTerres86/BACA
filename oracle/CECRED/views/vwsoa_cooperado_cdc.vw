CREATE OR REPLACE VIEW CECRED.VWSOA_COOPERADO_CDC AS
   select cdc.cdcooper
     ...
     left join tbepr_cdc_subsegmento_coop subcoop on subcoop.idsubsegmento_coop=loj.idsubsegmento_coop
     left join tbepr_cdc_subsegmento sub on sub.cdsubsegmento=subcoop.cdsubsegmento
