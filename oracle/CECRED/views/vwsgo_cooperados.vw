---------------------------------------------------------------------------------------------------------------
--  Programa : VWSGO_COOPERADOS
--  Alteracoes: 17/10/2018 - Aplicada a alteração para considerar a listagem registro 
--                           do primeiro titular cooperado PJ
--              INC0013317 - Jackson
--
--              XX/XX/XXXX - 
---------------------------------------------------------------------------------------------------------------
...
SELECT ass.cdcooper cooperativa,
  ...
  FROM crapcop cop, crapass ass, crapage age, crapttl ttl, crapenc enc
...
SELECT ass.cdcooper,
       ...
       enc.cdufende,
       enc.complend
  FROM crapcop cop, crapass ass, crapage age, crapenc enc
 WHERE cop.flgativo = 1
   AND ass.cdcooper = cop.cdcooper
   AND ass.inpessoa = 2
   AND age.cdcooper = cop.cdcooper
