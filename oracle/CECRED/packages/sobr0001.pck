...
CREATE OR REPLACE PACKAGE BODY CECRED.sobr0001 AS
  ...
  /* ..........................................................................
   ...
   Sigla   : CRED
   Autor   : Edson
   Data    : Fevereiro/2005                      Ultima atualizacao: 09/11/2015
...
............................................................................. */
  ...
  PROCEDURE pc_verifica_conta_capital (pr_cdcooper IN crapcop.cdcooper%TYPE		  --> Cód. cooperativa
   ...
   Sigla   : CRED
   Autor   : Lucas Reinert
   Data    : Fevereiro/2015                      Ultima atualizacao: 02/03/2015
   ...
   Objetivo  : Procedure para verificar a data em que o cooperado deve ser 
    ...
    BEGIN
      ...
      END IF;
			...
			-- Abre tabela de parametrização
			OPEN cr_craptab;
			-- Insere resultado no rowtype
			FETCH cr_craptab INTO rw_craptab;
			
			-- Se não encontrou gera exceção
      ...
      END IF;				
        ...
        -- Captura data de comunicação a partir do resultado da consulta
			  vr_dtcomuni := to_date(SUBSTR(rw_craptab.dstextab,67,10), 'dd/mm/rrrr');  
        EXCEPTION
          WHEN OTHERS THEN
            pr_cdcritic := 0;
