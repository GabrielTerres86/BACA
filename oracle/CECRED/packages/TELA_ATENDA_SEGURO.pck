...
CREATE OR REPLACE PACKAGE BODY CECRED.TELA_ATENDA_SEGURO IS
  ...
  BEGIN
    ...
    Sistema : Ayllos Web
    Autor   : Marcos Martini - Supero
    Data    : Junho/2016                 Ultima atualizacao: 05/06/2018
      ...
      vr_ctx := 
         dbms_xmlgen.newcontext(' SELECT dsTipo        as "dsTipo"
                                    ...
                                    FROM (SELECT decode(seg.tpseguro,1,''CASA''
                                                ...
                                                ,to_char(seg.vlpreseg,''fm999g999g990d00'',''NLS_NUMERIC_CHARACTERS=,.'') vlpreseg
                                                ,seg.qtprepag                                        qtprepag
                                                ,to_char(seg.vlprepag,''fm999g999g990d00'',''NLS_NUMERIC_CHARACTERS=,.'') vlprepag
