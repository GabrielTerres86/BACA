...
DECLARE
    ...
    CURSOR cr_contratos_lc100(pr_nracordo tbrecup_acordo.nrdconta%TYPE
                            , pr_cdcooper tbrecup_acordo.cdcooper%TYPE) IS
    SELECT c.nrctremp
         , c.dtmvtolt
         , c.vlemprst
...
BEGIN
    ...
    FOR rw_contratos_lc100
      IN cr_contratos_lc100(pr_cdcooper, pr_nracordo) LOOP
        gene0007.pc_insere_tag(pr_xml      => pr_retxml,
    ...
    FOR rw_contratos_acordo
      IN cr_contratos_acordo(pr_cdcooper, pr_nracordo) LOOP
        ...
        gene0007.pc_insere_tag(pr_xml      => pr_retxml,
                               ...
                               pr_posicao  => 0,
                               pr_tag_nova => 'nrctremp',
                               pr_tag_cont => rw_contratos_acordo.nrctremp,
                               pr_des_erro => pr_dscritic);
        ...
        -- Código do cooperado que incluir o contrato no acordo (Se foi incluído manualmente)
        gene0007.pc_insere_tag(pr_xml      => pr_retxml,
                               pr_tag_pai  => 'Contrato',
                               pr_posicao  => 0,
