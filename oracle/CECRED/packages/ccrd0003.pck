CREATE OR REPLACE PACKAGE cecred.ccrd0003 AS
    ...
    TYPE typ_reg_fatura_pend IS RECORD(
    ...
    TYPE typ_tab_fatura_pend IS TABLE OF typ_reg_fatura_pend INDEX BY PLS_INTEGER;
...
CREATE OR REPLACE PACKAGE BODY cecred.ccrd0003 AS
    ...
    CURSOR cr_crapscb(pr_tparquiv IN crapscb.tparquiv%TYPE) IS
        ...
        SELECT scb.tparquiv AS tparquiv
          ...
          FROM crapscb scb
         WHERE (scb.tparquiv = pr_tparquiv OR pr_tparquiv = 0);
    ...
    BEGIN
        ...
        ayma0001.pc_consumir_ws_rest_aymaru(pr_rota       => '/Comunicacao/Sms/EnviarLote'
        ...
        BEGIN
            ...
            LOOP
                ...
                gene0007.pc_insere_tag(pr_xml      => pr_retxml
                                      ...
                                      ,pr_tag_nova => 'tparquiv'
                                      ,pr_tag_cont => rw_crapscb.tparquiv
                                      ,pr_des_erro => vr_dscritic);
                gene0007.pc_insere_tag(pr_xml      => pr_retxml
                                      ,pr_tag_pai  => 'inf'
                                      ,pr_posicao  => vr_contador
                                      ,pr_tag_nova => 'dsarquiv'
                                      ,pr_tag_cont => rw_crapscb.dsarquiv
                                      ,pr_des_erro => vr_dscritic);
            ...
            CASE pr_cddopcao
                ...
                WHEN 'A' THEN
                    ...
                    BEGIN
                        ...
                        UPDATE crapacb
                           SET crapacb.cdcooper = pr_cdcopgru, crapacb.cdadmcrd = pr_cdadmcrd
                         WHERE crapacb.cdgrafin = pr_cdgrafin;
                        ...
                        IF rw_crapacb.cdcooper <> pr_cdcopgru THEN
                            vr_dsmsglog := vr_dsmsglog || ', de cooperativa: ' || rw_crapacb.cdcooper ||
                                           ' para cooperativa: ' || pr_cdcopgru;
                        END IF;
                    
                        IF rw_crapacb.cdadmcrd <> pr_cdadmcrd THEN
                            vr_dsmsglog := vr_dsmsglog || ', de Administradora: ' || rw_crapacb.cdadmcrd ||
                                           ' para Administradora: ' || pr_cdadmcrd;
                        END IF;
                ...
                WHEN 'C' THEN
                    ...
                    gene0007.pc_insere_tag(pr_xml      => pr_retxml
                                          ,pr_tag_pai  => 'inf'
                                          ,pr_posicao  => 0
                                          ,pr_tag_nova => 'cdgrafin'
                                          ,pr_tag_cont => rw_crapacb.cdgrafin
                                          ,pr_des_erro => vr_dscritic);
                    gene0007.pc_insere_tag(pr_xml      => pr_retxml
                                          ,pr_tag_pai  => 'inf'
                                          ,pr_posicao  => 0
                                          ,pr_tag_nova => 'cdcooper'
                                          ,pr_tag_cont => rw_crapacb.cdcooper
                                          ,pr_des_erro => vr_dscritic);
                    gene0007.pc_insere_tag(pr_xml      => pr_retxml
                                          ,pr_tag_pai  => 'inf'
                                          ,pr_posicao  => 0
                                          ,pr_tag_nova => 'nmrescop'
                                          ,pr_tag_cont => rw_crapacb.nmrescop
                                          ,pr_des_erro => vr_dscritic);
                    gene0007.pc_insere_tag(pr_xml      => pr_retxml
                                          ,pr_tag_pai  => 'inf'
                                          ,pr_posicao  => 0
                                          ,pr_tag_nova => 'cdagenci'
                                          ,pr_tag_cont => rw_crapacb.cdagenci
                                          ,pr_des_erro => vr_dscritic);
                    gene0007.pc_insere_tag(pr_xml      => pr_retxml
                                          ,pr_tag_pai  => 'inf'
                                          ,pr_posicao  => 0
                                          ,pr_tag_nova => 'cdadmcrd'
                                          ,pr_tag_cont => rw_crapacb.cdadmcrd
                                          ,pr_des_erro => vr_dscritic);
                ...
                WHEN 'I' THEN
                    ...
                    BEGIN
                        INSERT INTO crapacb
                            (cdgrafin, cdcooper, cdagenci, cdadmcrd)
                        VALUES
                            (pr_cdgrafin, pr_cdcopgru, 0, pr_cdadmcrd);
    ...
    BEGIN
        ...
        DECLARE
            ...
            CURSOR cr_tbcrd_his_vinculo_bancoob(pr_cdtrnbcb IN tbcrd_his_vinculo_bancoob.cdtrnbcb%TYPE) IS
                SELECT tbcrd.cdtrnbcb
                      ...
                      ,(SELECT his.dshistor
                          FROM craphis his
                         WHERE his.cdhistor = tbcrd.cdhistor
                           AND rownum = 1) dshistor
        ...
        BEGIN
            ...
            IF cr_craphcb%NOTFOUND THEN
                ...
                IF pr_cddopcao <> 'I' AND pr_cddopcao <> 'H' AND pr_cddopcao <> 'VT' AND pr_cddopcao <> 'I1' AND
                   pr_cddopcao <> 'E3' THEN
            ...
            FOR rw_tbcrd_his_vinculo_bancoob IN cr_tbcrd_his_vinculo_bancoob(rw_craphcb.cdtrnbcb) LOOP
                ...
                pr_retxml := xmltype.appendchildxml(pr_retxml
                                                   ,'/Dados/Historicos'
                                                   ,xmltype('<Historico>' || '  <cdtrnbcb>' ||
                                                            nvl(lpad(rw_craphcb.cdtrnbcb, 4, '0'), '') ||
                                                            '</cdtrnbcb>' || '  <dstrnbcb>' ||
                                                            nvl(rw_craphcb.dstrnbcb, '') || '</dstrnbcb>' ||
                                                            '  <cdhistor>' ||
                                                            nvl(rw_tbcrd_his_vinculo_bancoob.cdhistor, '') ||
                                                            '</cdhistor>' || '  <dshistor>' ||
                                                            nvl(rw_tbcrd_his_vinculo_bancoob.dshistor, '') ||
                                                            '</dshistor>' || '  <flgdebcc>' ||
                                                            nvl(rw_craphcb.flgdebcc, '') || '</flgdebcc>' ||
                                                            '  <tphistor>' ||
                                                            nvl(rw_tbcrd_his_vinculo_bancoob.tphistorico, '') ||
                                                            '</tphistor>' || '  <dstphistor>' ||
                                                            nvl(rw_tbcrd_his_vinculo_bancoob.dstphistor, '') ||
                                                            '</dstphistor>' || '</Historico>'));
            ...
            IF NOT vr_tbcrd THEN
                ...
                pr_retxml := xmltype.appendchildxml(pr_retxml
                                                   ...
                                                   ,xmltype('<Historico>' || '  <cdtrnbcb>' ||
                                                            nvl(lpad(rw_craphcb.cdtrnbcb, 4, '0'), '') ||
                                                            '</cdtrnbcb>' || '  <dstrnbcb>' ||
                                                            nvl(vr_dstrnbcb, '') || '</dstrnbcb>' ||
                                                            '  <cdhistor></cdhistor>' ||
                                                            '  <dshistor></dshistor>' || '  <flgdebcc>' ||
                                                            nvl(rw_craphcb.flgdebcc, '') || '</flgdebcc>' ||
                                                            '  <tphistor></tphistor>' ||
                                                            '  <dstphistor></dstphistor>' || '</Historico>'));
            END IF;
        
            vr_tphistor := CASE pr_tphistor
                               WHEN 0 THEN
                                'ONLINE'
                               WHEN 1 THEN
                                'OFFLINE'
            ...
            CASE pr_cddopcao
                ...
                WHEN 'I1' THEN
                    ...
                    IF cr_craphcb%NOTFOUND THEN
                        ...
                        BEGIN
                            -- Grava registro
                            INSERT INTO craphcb
                                (cdtrnbcb, dstrnbcb, flgdebcc)
                            VALUES
                                (pr_cdtrnbcb, pr_dstrnbcb, pr_flgdebcc);
                            -- Verifica se houve problema na insercao de registros
                        EXCEPTION
                            WHEN OTHERS THEN
                                -- Descricao do erro na insercao de registros
                    ...
                    ELSE
                        ...
                        BEGIN
                            ...
                            UPDATE craphcb
                               SET craphcb.dstrnbcb = upper(pr_dstrnbcb), craphcb.flgdebcc = pr_flgdebcc
                    ...
                    OPEN cr_tbcrd_his_vinculo_bancoob_2(pr_cdtrnbcb, pr_tphistor);
                    FETCH cr_tbcrd_his_vinculo_bancoob_2
                        INTO rw_tbcrd_his_vinculo_bancoob_2;
                    ...
                    BEGIN
                        ...
                        VALUES
                            (pr_cdtrnbcb, pr_cdhisest, pr_tphistor);
                    ...
                    vr_dsmsglog := to_char(SYSDATE, 'dd/mm/rrrr hh24:mi:ss') || ' Operador: ' || vr_cdoperad ||
                                   ' --- Inclusao de Vinculo de Transacao: ' || pr_cdtrnbcb || ', descricao: ' ||
                                   pr_dstrnbcb || ', historico: ' || pr_cdhisest || ', tipo historico: ' ||
                                   vr_tphistor || ', Movimenta C/C: ' || vr_flgdebcc || '.';
                
                WHEN 'A1' THEN
                    -- alterar historicos do vinculo                        
                    ...
                    vr_dsmsglog := to_char(SYSDATE, 'dd/mm/rrrr hh24:mi:ss') || ' Operador: ' || vr_cdoperad ||
                                   ' --- Inclusao de Vinculo de Transacao: ' || pr_cdtrnbcb || ', descricao: ' ||
                                   pr_dstrnbcb || ', Movimenta C/C: ' || vr_flgdebcc || '.';
                
                    IF rw_tbcrd_his_vinculo_bancoob_2.cdhistor <> pr_cdhisest THEN
                        vr_dsmsglog := vr_dsmsglog || ', historico: ' ||
                                       to_char(rw_tbcrd_his_vinculo_bancoob_2.cdhistor) || ' para: ' ||
                                       to_char(pr_cdhisest);
                    END IF;
                
                    vr_tphistortb := CASE rw_tbcrd_his_vinculo_bancoob_2.tphistorico
                                         WHEN 0 THEN
                                          'ONLINE'
                                         WHEN 1 THEN
                                          'OFFLINE'
                ...
                WHEN 'H' THEN
                    ...
                    gene0007.pc_insere_tag(pr_xml      => pr_retxml
                                          ,pr_tag_pai  => 'inf'
                                          ,pr_posicao  => 0
                                          ,pr_tag_nova => 'cdhisotr'
                                          ,pr_tag_cont => rw_craphis.cdhistor
                                          ,pr_des_erro => vr_dscritic);
                    gene0007.pc_insere_tag(pr_xml      => pr_retxml
                                          ,pr_tag_pai  => 'inf'
                                          ,pr_posicao  => 0
                                          ...
                                          ,pr_des_erro => vr_dscritic);
                WHEN 'E1' THEN
                    -- Exclusao historico da transacao
                    ...
                    BEGIN
                        ...
                        vr_dsmsglog := to_char(SYSDATE, 'dd/mm/rrrr hh24:mi:ss') || ' Operador: ' ||
                                       vr_cdoperad || ' --- Excluido Vinculo de Transacao: ' || pr_cdtrnbcb ||
                                       ', historico: ' || pr_cdhisest || ', tipo historico: ' || vr_tphistor || '.';
                        -- Verifica se houve problema na insercao de registros
                    EXCEPTION
                        WHEN OTHERS THEN
                            -- Descricao do erro na insercao de registros
                    ...
                    END;
                WHEN 'E' THEN
                    -- Exclui todo vinculo da transacao
                    BEGIN
                        -- Excluir vinculo
                        DELETE tbcrd_his_vinculo_bancoob
                         WHERE tbcrd_his_vinculo_bancoob.cdtrnbcb = pr_cdtrnbcb
                        ...
                        -- Excluir transacao
                        DELETE craphcb WHERE craphcb.cdtrnbcb = pr_cdtrnbcb;
                    
                        -- Gerar log da exclusao do registro
                        vr_dsmsglog := to_char(SYSDATE, 'dd/mm/rrrr hh24:mi:ss') || ' Operador: ' ||
                                       vr_cdoperad || ' --- Excluido Transacao: ' || pr_cdtrnbcb || ' - ' ||
                                       pr_dstrnbcb || '.';
                        -- Verifica se houve problema na insercao de registros
                    EXCEPTION
                        WHEN OTHERS THEN
                ...
                WHEN 'C' THEN
                    ...
                    NULL;
                WHEN 'A2' THEN
                    -- Alteracao da descricao e se movimenta c/c                         
                ...
                WHEN 'VT' THEN
                    ...
                    CLOSE cr_craphcb;
                WHEN 'E3' THEN
                    -- Exclui todo vinculo da transacao ao clicar no cancelar
                    BEGIN
                        -- Excluir vinculo
                        DELETE tbcrd_his_vinculo_bancoob
                         WHERE tbcrd_his_vinculo_bancoob.cdtrnbcb = pr_cdtrnbcb
    ...
    BEGIN
        ...
        BEGIN
            ...
            IF cr_crapscb%NOTFOUND THEN
                ...
                vr_dscritic := 'Erro ao consulta de Parametros de Integracao de Arquivos, Arquivo Tipo: ' ||
                               pr_tparquiv;
                RAISE vr_exc_saida;
            ELSE
                -- Fechar o cursor
            ...
            CASE pr_cddopcao
                WHEN 'A' THEN
                    BEGIN
                        ...
                        UPDATE crapscb
                           SET crapscb.nrseqarq = pr_nrseqarq, crapscb.dsdirarq = pr_dsdirarq
                        ...
                        IF rw_crapscb.nrseqarq <> pr_nrseqarq OR rw_crapscb.dsdirarq <> pr_dsdirarq THEN
                        
                            vr_dsmsglog := vr_dsmsglog ||
                                           ' --- Alteracao de Parametros de Integracao Arquivos Bancoob: ' ||
                                           pr_tparquiv || ', Sequencia alterada de: ' || rw_crapscb.nrseqarq ||
                                           ' para: ' || pr_nrseqarq || ', alterado diretorio de: ' ||
                                           rw_crapscb.dsdirarq || ' para: ' || pr_dsdirarq;
                        END IF;
                    ...
                    EXCEPTION
                        WHEN OTHERS THEN
                            -- Descricao do erro na insercao de registros
                            vr_dscritic := 'Problema ao atualizar Parametros de Integracao de Arquivos Bancoob: ' ||
                                           SQLERRM;
                            RAISE vr_exc_saida;
                    END;
                WHEN 'C' THEN
                    ...
                    gene0007.pc_insere_tag(pr_xml      => pr_retxml
                                          ...
                                          ,pr_tag_cont => rw_crapscb.nrseqarq
                                          ,pr_des_erro => vr_dscritic);
                    gene0007.pc_insere_tag(pr_xml      => pr_retxml
                                          ,pr_tag_pai  => 'inf'
                                          ,pr_posicao  => 0
                                          ,pr_tag_nova => 'dtultint'
                                          ,pr_tag_cont => to_char(rw_crapscb.dtultint, 'dd/mm/RRRR hh24:MI:ss')
                                          ,pr_des_erro => vr_dscritic);
                    gene0007.pc_insere_tag(pr_xml      => pr_retxml
                                          ,pr_tag_pai  => 'inf'
                                          ,pr_posicao  => 0
                                          ,pr_tag_nova => 'dsdirarq'
                                          ,pr_tag_cont => rw_crapscb.dsdirarq
                                          ,pr_des_erro => vr_dscritic);
                    gene0007.pc_insere_tag(pr_xml      => pr_retxml
                                          ,pr_tag_pai  => 'inf'
                                          ,pr_posicao  => 0
                                          ,pr_tag_nova => 'flgretpr'
                                          ,pr_tag_cont => rw_crapscb.flgretpr
                                          ,pr_des_erro => vr_dscritic);
                WHEN 'I' THEN
    ...
    BEGIN
        ...
        DECLARE
            ...
            CURSOR cr_crapadc(pr_cdadmcrd IN crapadc.cdadmcrd%TYPE
                ...
                SELECT adc.cdadmcrd
                      ,adc.nmadmcrd
                  FROM crapadc adc
                 WHERE adc.cdadmcrd BETWEEN 10 AND 80
        ...
        BEGIN
            ...
            OPEN cr_crapadc(pr_cdadmcrd, pr_cdcopaux);
            ...
            LOOP
                ...
                gene0007.pc_insere_tag(pr_xml      => pr_retxml
                                      ,pr_tag_pai  => 'inf'
                                      ,pr_posicao  => vr_contador
                                      ,pr_tag_nova => 'cdamdcrd'
                                      ,pr_tag_cont => rw_crapadc.cdadmcrd
                                      ,pr_des_erro => vr_dscritic);
                gene0007.pc_insere_tag(pr_xml      => pr_retxml
                                      ,pr_tag_pai  => 'inf'
                                      ,pr_posicao  => vr_contador
                                      ,pr_tag_nova => 'nmamdcrd'
                                      ,pr_tag_cont => rw_crapadc.nmadmcrd
                                      ,pr_des_erro => vr_dscritic);
                vr_contador := vr_contador + 1;
    ...
    BEGIN
        ...
        DECLARE
                        ...
                        (SELECT 1
                           ...
                           WHERE tbgen_batch_controle.cdcooper = pr_cdcooper -- Controle é gravado com a Coop Central
                             ...
                             AND tbgen_batch_controle.cdagrupador =
                                 (lpad(age.cdcooper, 3, '0') || lpad(age.cdagenci, 5, '0'))
                             AND tbgen_batch_controle.insituacao = 1
                             AND tbgen_batch_controle.dtmvtolt = pr_dtmvtolt)));
            ...
            CURSOR cr_crapscb IS
                SELECT crapscb.dsdirarq FROM crapscb WHERE crapscb.tparquiv = 1;
            rw_crapscb cr_crapscb%ROWTYPE;
        ...
        BEGIN
            ...
            IF pr_idparale = 0 THEN
                ...
                vr_nmrquivo := 'CSDC_756' || to_char(lpad(rw_crapcop.cdagebcb, 4, '0')) || '_' ||
                               to_char(rw_crabdat.dtmvtolt, 'YYYYMMDD') || '_' || lpad(vr_nrseqarq, 7, 0) ||
                               '.CCB';
                ...
                FOR rw_crapcol IN cr_crapcol(pr_cdprogra => vr_cdprogra
                    ...
                    FOR rw_crapage IN cr_crapage(pr_cdcoppar => rw_crapcol.cdcooper
                        ...
                        gene0001.pc_ativa_paralelo(pr_idparale => vr_idparale
                                                  ,pr_idprogra => (lpad(rw_crapcol.cdcooper, 3, '0') ||
                                                                  lpad(rw_crapage.cdagenci, 5, '0'))
                                                  ,pr_des_erro => vr_dscritic);
                        ...
                        vr_dsplsql := 'DECLARE' || chr(13) || '  wpr_cdcritic NUMBER;' || chr(13) ||
                                      ...
                                      '  ccrd0003.pc_gera_saldo_bancoob' || '            (' || pr_cdcooper ||
                                      '            ,' || rw_crapcol.cdcooper || '            ,' ||
                                      rw_crapage.cdagenci || '            ,' || vr_idparale || '            ,' || '''' ||
                                      pr_cdoperad || '''' || '            ,' || '''' || pr_nmdatela || '''' ||
                                      '            ,' || pr_qtdejobs ||
            ...
            ELSE
                ...
                gene0001.pc_grava_batch_controle(pr_cdcooper    => pr_cdcooper -- Codigo da Cooperativa
                                                ...
                                                ,pr_cdagrupador => lpad(pr_cdcoppar, 3, '0') ||
                                                                   lpad(pr_cdagepar, 5, '0') -- Codigo do agrupador conforme (tpagrupador)
                ...
                FOR rw_crapcol IN cr_crapcol(pr_cdcoppar) LOOP
                    ...
                    FOR rw_crapcrd IN cr_crapcrd_loop(rw_crapcol.cdcooper, pr_cdagepar) LOOP
                        ...
                        extr0001.pc_obtem_saldo_dia(pr_cdcooper   => rw_crapcol.cdcooper
                                                   ...
                                                   ,pr_tipo_busca => 'A'
                                                   , -- tipo de busca (Buscar saldo na crapsda, fltrando pela dtmvtoan)
                        ...
                        vr_dsdetalh := ('CSDC1756' || lpad(rw_crapcol.cdagebcb, 4, '0') ||
                                       lpad(rw_crapcrd.nrdconta, 12, '0') || vr_dessinal ||
                                       lpad((vr_vlsddisp * 100), 14, '0') ||
                                       lpad((vr_tab_sald(vr_ind_sald).vllimcre * 100), 15, '0') || '1');
                ...
                IF pr_cdcoppar > 0 AND vr_tab_texto.count > 0 THEN
                    ...
                    FOR idx IN vr_tab_texto.first .. vr_tab_texto.last LOOP
                        ...
                        EXCEPTION
                            WHEN OTHERS THEN
                                vr_dscritic := 'Erro ao inserir dados na tbgen_batch_relatorio_wrk[dados_arquivo]: ' ||
                                               SQLERRM;
                                RAISE vr_exc_saida;
                        END;
                    END LOOP;
            ...
            IF pr_idparale = 0 THEN
                ...
                FOR idx IN vr_tab_texto.first .. vr_tab_texto.last LOOP
                    ...
                    gene0002.pc_escreve_xml(pr_xml            => vr_clob_arq
                                           ...
                                           ,pr_texto_novo     => vr_tab_texto(idx)
                                                                 .destexto || chr(13) || chr(10));
                END LOOP;
                ...
                BEGIN
                    UPDATE crapscb SET nrseqarq = vr_nrseqarq, dtultint = SYSDATE WHERE crapscb.tparquiv = 1; -- Arquivo CSDC - Saldo Disponivel de Cooperados
            ...
            ELSE
                ...
                gene0001.pc_encerra_paralelo(pr_idparale => pr_idparale
                                            ,pr_idprogra => (lpad(pr_cdcoppar, 3, '0') ||
                                                            lpad(pr_cdagepar, 5, '0'))
                                            ,pr_des_erro => vr_dscritic);
                IF vr_dscritic IS NOT NULL THEN
                    RAISE vr_exc_saida;
                END IF;
            ...
            WHEN vr_exc_saida THEN
                ...
                IF nvl(pr_idparale, 0) <> 0 THEN
                    ...
                    pc_log_programa(pr_dstiplog   => 'F'
                                   ...
                                   , -- Tipo de execucao (0-Outro/ 1-Batch/ 2-Job/ 3-Online)
                                    pr_idprglog   => vr_idlog_ini_par
                                   ,pr_flgsucesso => 0);
                
                    -- Grava LOG de erro com as críticas retornadas                           
                    pc_log_programa(pr_dstiplog      => 'E'
                                   ,pr_cdprograma    => vr_cdprogra || '_' || pr_cdcoppar || '_' ||
                                                        pr_cdagepar
                                   ,pr_cdcooper      => pr_cdcooper
                                   ,pr_tpexecucao    => vr_tpexecucao
                                   ,pr_tpocorrencia  => 3
    ...
    BEGIN
        ...
        EXCEPTION
            WHEN vr_exc_saida THEN
                ...
                pr_retxml := xmltype.createxml('<?xml version="1.0" encoding="ISO-8859-1" ?><Root><Erro>' ||
                                               vr_dscritic || '</Erro><TpException>1</TpException></Root>');
    ...
    BEGIN
        ...
        DECLARE
            ...
            TYPE typ_tab_craplcm IS TABLE OF craplcm%ROWTYPE INDEX BY VARCHAR2(500); --CDCOOPER(10) + DTMVTOLT(8) + CDAGENCI(5) + CDBCCXLT(5) + NRDOLOTE(10) + NRDCTABB(10) + NRDOCMTO(25)
            vr_tab_craplcm typ_tab_craplcm;
        
            TYPE typ_rec_crapdcb IS RECORD(
                 det       crapdcb%ROWTYPE
                ,rowid_dcb ROWID
                ,operacao  VARCHAR2(1));
        
            -- Definicao de temptable para registros da crapdcb
            TYPE typ_tab_crapdcb IS TABLE OF typ_rec_crapdcb --crapdcb%ROWTYPE
            ...
            -- DAdos de Lote
            TYPE typ_reg_craplot IS RECORD(
            ...
            BEGIN
                INSERT INTO tbgen_batch_relatorio_wrk
                    (cdcooper, cdprograma, dsrelatorio, dtmvtolt, dschave, nrdconta, cdagenci, dscritic)
                VALUES
                    (pr_cdcooper
                    ,vr_cdprogra
                    ,'DADOS_RELAT'
                    ...
                    ,pr_cdcopreg
                    ,pr_cdagenci
                    ,pr_nmrescop || ';' || pr_nmresage || ';' || pr_nrdconta || ';' || pr_cdtrnbcb || ';' ||
                     pr_dstrnbcb || ';' || pr_cdhistor || ';' || pr_dshistor || ';' || pr_inpessoa || ';' ||
                     pr_cdorigem || ';' || to_char(pr_dtdtrans, 'ddmmrrrr') || ';' ||
                     to_char(pr_dtmvtooo, 'ddmmrrrr') || ';' || pr_flgdebcc || ';' ||
            ...
            BEGIN
                ...
                vr_idxlcm := lpad(pr_cdcooper, 10, 0) || to_char(pr_dtmvtolt, 'rrrrmmdd') ||
                             lpad(pr_cdagenci, 5, '0') || lpad(pr_cdbccxlt, 5, '0') ||
                             lpad(pr_nrdolote, 10, '0') || lpad(pr_nrdctabb, 10, '0') ||
                             lpad(pr_nrdocmto, 25, '0');
            
                IF vr_tab_craplcm.exists(vr_idxlcm) THEN
                    pr_dscritic := 'Registro para craplcm ja existe: nrdctabb ->' || pr_nrdctabb ||
        ...
        BEGIN
            ...
            gene0001.pc_informa_acesso(pr_module => vr_cdprogra, pr_action => 'CCRD0003.pc_crps670_process');
            ...
            FOR rw_arq IN cr_work_arq(pr_cdcooper, pr_nrseqexe, vr_cdprogra, 'DADOS_ARQ', pr_dtmvtolt) LOOP
                BEGIN
                    ...
                    FETCH cr_crapcop_cdagebcb
                        INTO rw_crapcop_cdagebcb;
                    ...
                    IF nvl(TRIM(substr(rw_arq.des_text, 27, 1)), ' ') <> 'M' THEN
                        ...
                        FOR rw_craphcb IN cr_craphcb(pr_cdtrnbcb => to_number(substr(rw_arq.des_text, 28, 3))) LOOP
                            ...
                            IF rw_craphcb.tphistorico = 0 THEN
                                -- Historico Online
                                vr_cdhistor_on := rw_craphcb.cdhistor;
                            ELSIF rw_craphcb.tphistorico = 1 THEN
                                -- Historico Offline
                            ...
                            IF cr_craphis%NOTFOUND THEN
                                ...
                                CLOSE cr_craphis;
                                -- Montar mensagem de critica
                                vr_dscritic := 'Historico ' || rw_craphcb.cdhistor || ' nao encontrado.';
                                RAISE vr_exc_rejeitado;
                            ELSE
                                -- fechar o cursor
                                CLOSE cr_craphis;
                        ...
                        IF vr_cdhistor_on = 0 THEN
                            vr_dscritic := 'Historico Online para a Transacao ' ||
                                           to_number(substr(rw_arq.des_text, 28, 3)) || ' nao cadastrado.';
                            RAISE vr_exc_rejeitado;
                        END IF;
                    
                        IF vr_cdhistor_off = 0 THEN
                            vr_dscritic := 'Historico Offline para a Transacao ' ||
                                           to_number(substr(rw_arq.des_text, 28, 3)) || ' nao cadastrado.';
                            RAISE vr_exc_rejeitado;
                        END IF;
                    END IF;
                    ...
                    EXCEPTION
                        WHEN OTHERS THEN
                            vr_dscritic := 'Numero de conta invalido nrdconta: ' ||
                                           substr(rw_arq.des_text, 171, 12) || ' !';
                            RAISE vr_exc_rejeitado;
                    END;
                    ...
                    IF rw_crapcop_cdagebcb.flgativo = 0 THEN
                        ...
                        FETCH cr_crapass_dest
                            INTO rw_crapass_dest;
                    ...
                    -- Buscar informações dos associados
                    OPEN cr_crapass(pr_cdcooper => rw_crapcop_cdagebcb.cdcooper, pr_nrdconta => vr_nrdconta);
                    FETCH cr_crapass
                        INTO rw_crapass;
                    -- caso não encontrar, levantar exception
                    ...
                    IF vr_flgdebcc = 1 THEN
                        ...
                        vr_dthstran := gene0002.fn_char_para_number(nvl(TRIM(substr(rw_arq.des_text, 204, 10))
                                                                       ,0));
                        -- TIPO DE TRANSAÇÃO
                        ...
                        IF nvl(vr_nrdocmto, 0) = 0 THEN
                            ...
                            vr_nrdocmto := ccrd0002.fn_busca_nsu_transacao(pr_tpmensag => TRIM(substr(rw_arq.des_text
                                                                                                     ,254
                                                                                                     ,4))
                                                                          ,pr_nrnsucap => TRIM(substr(rw_arq.des_text
                                                                                                     ,77
                                                                                                     ,6))
                                                                          ,pr_dtdtrgmt => TRIM(substr(rw_arq.des_text
                                                                                                     ,204
                                                                                                     ,10)));
                        ELSE
                            -- Chamar a rotina de geração do NSU
                        ...
                        ELSE
                            ...
                            FOR rw_crapdcb IN cr_crapdcb(pr_nrnsucap => vr_nsuredec
                                                        ...
                                                        ,pr_vldtrans => vr_vldtrans
                                                        ,pr_nrseqarq => pr_nrseqarq
                                                        ,pr_dtdtrgmt => to_date(TRIM(substr(rw_arq.des_text
                                                                                           ,204
                                                                                           ,4))
                                                                               ,'mmdd')) LOOP
                                ...
                                IF cr_craplcm_dia%NOTFOUND THEN
                                    -- se não encontrar NO DIA, verifica se existe outro lancamento correspondente ao nsu
                                    OPEN cr_craplcm(vr_cdcopban
                                                   ,rw_crapass.nrdconta
                                                   ,vr_cdpesqbb
                                                   ,rw_crapdcb.nrnsucap
                                    ...
                                    IF cr_craplcm%NOTFOUND THEN
                                        -- se não encontrar lancamento verifica se é necessário fazê-lo
                                        IF vr_tpmensag = '0200' AND vr_cdcrimsg <> '00' THEN
                                            vr_crialcmt := FALSE;
                                        ELSIF vr_tpmensag = '0220' AND vr_tpmsg200 THEN
                                            vr_crialcmt := FALSE;
                                        ELSIF vr_tpmensag = '0420' AND vr_tpmsg200 AND vr_cdcrimsg = '00' AND
                                              vr_indebcre = 'C' THEN
                                            vr_crialcmt := TRUE;
                                        ELSIF vr_tpmensag = '0420' AND NOT vr_tpmsg200 AND NOT vr_tpmsg220 AND
                                              vr_cdcrimsg <> '00' THEN
                                            vr_crialcmt := FALSE;
                                        ELSIF vr_tpmensag = '0420' AND vr_tpmsg220 AND vr_cdcrimsg = '00' AND
                                              vr_indebcre = 'C' THEN
                                            vr_crialcmt := TRUE;
                                        ...
                                        CLOSE cr_craplcm;
                                    ELSE
                                        -- se encontrar verifica se há necessidade de fazê-lo
                                        ...
                                        IF vr_indebcre = rw_craphis.indebcre AND vr_cdtrnbcb = vr_cdtrnbcb_ori THEN
                                            ...
                                            IF vr_indebcre = 'C' AND vr_cdcrimsg = '00' AND
                                               vr_tpmensag <> '0420' THEN
                                                vr_crialcmt := TRUE;
                                            ELSIF vr_tpmsg200 AND vr_tpmsg420 AND vr_cdcrimsg = '00' THEN
                                                -- tem a 200 e a 420 mas veio sem critica no arquivo
                                                vr_crialcmt := TRUE;
                                            ELSIF vr_tpmensag = '0200' AND
                                                  (vr_cdcrimsg <> '00' OR
                                                  vr_cdcrimsg <> nvl(TRIM(rw_crapdcb.cdtrresp), '00')) THEN
                                                vr_crialcmt := TRUE;
                                            ELSIF vr_tpmensag = '0220' AND vr_cdcrimsg <> '00' THEN
                                                vr_crialcmt := TRUE;
                                            ELSIF vr_tpmensag = '0420' AND vr_tpmsg200 AND vr_tpmsg220 AND
                                                  NOT vr_tpmsg420 AND vr_cdcrimsg <> '00' THEN
                                                vr_crialcmt := TRUE;
                                            ELSE
                                                vr_crialcmt := FALSE;
                                            END IF;
                                    ...
                                    END IF;
                                ELSE
                                    -- se encontrar o lançamento no dia, verifica se há necessidade de fazê-lo
                            ...
                            IF vr_crialcmt THEN
                                ...
                                IF rw_crapcop_cdagebcb.flgativo = 0 THEN
                                    ...
                                    pc_insert_craplcm(pr_cdcooper => rw_crapass_dest.cdcooper
                                                     ...
                                                     ,pr_nrdctabb => nvl(TRIM(substr(rw_arq.des_text, 171, 12))
                                                                        ,0)
                                                     ,pr_nrdocmto => vr_nrdocmto
                                                     ,pr_dtrefere => to_date(TRIM(substr(rw_arq.des_text
                                                                                        ,31
                                                                                        ,8))
                                                                            ,'ddmmyyyy')
                                                     ,pr_hrtransa => nvl(TRIM(substr(rw_arq.des_text, 208, 6))
                                                                        ,0)
                                                     ,pr_vllanmto => (nvl(TRIM(substr(rw_arq.des_text, 55, 11))
                                                                         ,0) / 100)
                                ...
                                ELSE
                                    vr_nrseqdig_lot := fn_sequence('CRAPLOT'
                                                                  ...
                                                                  ,'' || rw_crapcop_cdagebcb.cdcooper || ';' ||
                                                                   to_char(vr_dtmvtolt, 'dd/mm/yyyy') || ';' ||
                                                                   rw_crapass.cdagenci || ';' || vr_cdbccxlt || ';' ||
                                                                   vr_nrdolote || '');
                                    ...
                                    pc_insert_craplcm(pr_cdcooper => vr_cdcopban
                                                     ...
                                                     ,pr_vllanmto => (nvl(TRIM(substr(rw_arq.des_text, 55, 11))
                                                                         ,0) / 100)
                                                     ,pr_nrdconta => nvl(rw_crapass.nrdconta, 0)
                                                     , -- nrdconta
                                                      pr_cdhistor => vr_cdhistor_off
                                                     ,pr_nrseqdig => vr_nrseqdig_lot
                                                     ,pr_cdpesqbb => nvl(vr_cdpesqbb, ' ')
                        ...
                        ELSE
                            --ESTORNO DA CONTA = CRÉDITO NA CONTA
                            IF substr(rw_arq.des_text, 214, 2) <> '00' THEN
                                ...
                                IF vr_crialcmt THEN
                                    ...
                                    IF (vr_cdhistor < 100) THEN
                                        ...
                                        OPEN cr_craphcb_est(pr_cdtrnbcb => (to_number(substr(rw_arq.des_text
                                                                                            ,28
                                                                                            ,3)) + 100));
                                        FETCH cr_craphcb_est
                                            INTO rw_craphcb_est;
                                        ...
                                        IF cr_craphcb_est%NOTFOUND THEN
                                            ...
                                            -- Montar mensagem de critica
                                            vr_dscritic := 'Historico para a Transacao ' ||
                                                           to_number(substr(rw_arq.des_text, 28, 3)) ||
                                                           ' nao encontrado.';
                                            RAISE vr_exc_rejeitado;
                                        ELSE
                                            -- fechar o cursor
                                    ...
                                    IF rw_crapcop_cdagebcb.flgativo = 0 THEN
                                        ...
                                        pc_insert_craplcm(pr_cdcooper => rw_crapass_dest.cdcooper
                                                         ...
                                                         ,pr_cdbccxlt => vr_cdbccxlt
                                                         ,pr_nrdolote => vr_nrdolote
                                                         ,pr_nrdctabb => nvl(TRIM(substr(rw_arq.des_text
                                                                                        ,171
                                                                                        ,12))
                                                                            ,0)
                                                         ,pr_nrdocmto => vr_nrdocmto
                                                         ,pr_dtrefere => to_date(TRIM(substr(rw_arq.des_text
                                                                                            ...
                                                                                            ,4))
                                                                                ,'mmdd')
                                                         ,pr_hrtransa => nvl(TRIM(substr(rw_arq.des_text
                                                                                        ,208
                                                                                        ,6))
                                                                            ,0)
                                                         ,pr_vllanmto => (nvl(TRIM(substr(rw_arq.des_text
                                                                                         ,55
                                                                                         ,11))
                                                                             ,0) / 100)
                                                         ,pr_nrdconta => nvl(rw_crapass_dest.nrdconta, 0)
                        ...
                        IF vr_cdtrnbcb IN ('14', '50', '56') THEN
                            ...
                            IF rw_crapcop_cdagebcb.flgativo = 0 THEN
                                tari0001.pc_verifica_tarifa_operacao(pr_cdcooper => rw_crapass_dest.cdcooper
                                                                    ...
                                                                    ,pr_cdagenci => 1
                                                                    ,pr_cdbccxlt => 100
                                                                    ,pr_dtmvtolt => to_date(TRIM(substr(rw_arq.des_text
                                                                                                       ,31
                                                                                                       ,8))
                                                                                           ,'ddmmyyyy')
                                                                    ,pr_cdprogra => vr_cdprogra
                                                                    ,pr_idorigem => 4
                                                                    ,pr_nrdconta => nvl(rw_crapass_dest.nrdconta
                                                                                       ,0)
                                                                    ,pr_tipotari => 1
                    ...
                    IF cr_crapdcb_200%NOTFOUND THEN
                        ...
                        OPEN cr_crapdcb_200(pr_nrnsucap => substr(rw_arq.des_text, 198, 6)
                                           ,pr_dtdtrgmt => to_date(TRIM(substr(rw_arq.des_text, 204, 4))
                                                                  ,'mmdd')
                                           ,pr_hrdtrgmt => substr(rw_arq.des_text, 208, 6)
                                           ,pr_cdcooper => rw_crapcop_cdagebcb.cdcooper
                                           ,pr_nrdconta => rw_crapass.nrdconta
                    ...
                    IF cr_crapdcb_200%NOTFOUND THEN
                        ...
                        IF nvl(TRIM(substr(rw_arq.des_text, 27, 1)), 0) = 'C' AND
                           substr(rw_arq.des_text, 214, 2) = '00' THEN
                            vr_tpmensag := '0400';
                        ...
                        IF vr_criardcb THEN
                            ...
                            IF rw_crapcop_cdagebcb.flgativo = 0 THEN
                                pc_insert_crapdcb(pr_tpmensag  => vr_tpmensag
                                                 ...
                                                 ,pr_cdhistor  => vr_cdhistor_off
                                                 ,pr_dtdtrans  => to_date(TRIM(substr(rw_arq.des_text, 31, 8))
                                                                         ,'ddmmyyyy')
                                                 ,pr_dtpostag  => to_date(TRIM(substr(rw_arq.des_text, 39, 8))
                                                                         ,'ddmmyyyy')
                                                 ,pr_dtcnvvlr  => to_date(TRIM(substr(rw_arq.des_text, 47, 8))
                                                                         ,'ddmmyyyy')
                                                 ,pr_vldtrans  => (nvl(TRIM(substr(rw_arq.des_text, 55, 11))
                                                                      ,0) / 100)
                                                 ,pr_vldtruss  => (nvl(TRIM(substr(rw_arq.des_text, 66, 11))
                                                                      ,0) / 100)
                                                 ...
                                                 ,pr_cddmoeda  => nvl(TRIM(substr(rw_arq.des_text, 128, 3))
                                                                     ,' ')
                                                 ,pr_vlmoeori  => (nvl(TRIM(substr(rw_arq.des_text, 131, 11))
                                                                      ,0) / 100)
                                                 ,pr_cddreftr  => nvl(TRIM(substr(rw_arq.des_text, 142, 23))
                                                                     ,' ')
                                                 ,pr_cdagenci  => nvl(rw_crapass_dest.cdagenci, 0)
                                                 , -- cdagenci
                            ...
                            ELSE
                                pc_insert_crapdcb(pr_tpmensag  => vr_tpmensag
                                                 ...
                                                 ,pr_cddreftr  => nvl(TRIM(substr(rw_arq.des_text, 142, 23))
                                                                     ,' ')
                                                 ,pr_cdagenci  => nvl(rw_crapass.cdagenci, 0)
                                                 , -- cdagenci
                                                  pr_nridvisa  => nvl(TRIM(substr(rw_arq.des_text, 183, 15)), 0)
                                                 ,pr_cdtrresp  => nvl(TRIM(substr(rw_arq.des_text, 214, 2))
                                                                     ,' ')
                    ...
                    IF nvl(TRIM(substr(rw_arq.des_text, 27, 1)), ' ') <> 'M' THEN
                        ...
                        IF rw_crapcop_cdagebcb.flgativo = 0 THEN
                            ...
                            vr_index := lpad(rw_crapass_dest.cdcooper, 5, '0') || -- cdcooper(5)
                                        ...
                                        rw_crapass_dest.inpessoa || lpad(vr_cdtrnbcb_ori, 3, '0') ||
                                        lpad(vr_cdhistor_ori, 5, '0') || vr_cdorigem ||
                        ...
                        ELSE
                            ...
                            vr_index := lpad(rw_crapcop_cdagebcb.cdcooper, 5, '0') || -- cdcooper(5)
                                        ...
                                        rw_crapass.inpessoa || lpad(vr_cdtrnbcb_ori, 3, '0') ||
                                        lpad(vr_cdhistor_ori, 5, '0') || vr_cdorigem ||
                                        lpad(to_char(vr_dtmovtoo, 'ddmmyyyy'), 8, 0) ||
                                        lpad(TRIM(substr(rw_arq.des_text, 31, 8)), 8, 0);
                ...
                EXCEPTION
                    WHEN vr_exc_rejeitado THEN
                        ...
                        vr_dsmsglog := to_char(pr_dtmvtolt, 'dd/mm/yy') || ' as ' ||
                                       to_char(SYSDATE, 'hh24:mi:ss') || ' -> ' || ' ERRO - ' || ' cdcooper: ' ||
                                       lpad(rw_crapcop_cdagebcb.cdcooper, 2, 0) || ' nrdconta: ' ||
                                       nvl(TRIM(gene0002.fn_mask_conta(vr_nrdconta))
                                          ,substr(rw_arq.des_text, 171, 12)) || ' cdtrnbcb: ' ||
                                       nvl(vr_cdtrnbcb_ori, to_number(substr(rw_arq.des_text, 28, 3))) ||
                                       ' dstrnbcb: ' || vr_dstrnbcb || ' cdhistor: ' || vr_cdhistor_ori ||
                                       ' dshistor: ' || vr_dshistor_ori || ' dscritic: ' || vr_dscritic || '.';
            ...
            BEGIN
                ...
                WHILE vr_idxlcm IS NOT NULL LOOP
                    ...
                    EXCEPTION
                        WHEN OTHERS THEN
                            vr_dscritic := 'Erro ao inserir craplcm: ' || vr_tab_craplcm(vr_idxlcm).nrdconta ||
                                           SQLERRM;
                            RAISE vr_exc_saida;
                    END;
                
                    vr_dsmsglog := to_char(vr_tab_craplcm(vr_idxlcm).dtmvtolt, 'dd/mm/yy') || ' LCMT - ' ||
                                   ' cdcooper: ' || lpad(vr_tab_craplcm(vr_idxlcm).cdcooper, 2, 0) ||
                                   ' nrdconta: ' || lpad(vr_tab_craplcm(vr_idxlcm).nrdconta, 12, 0) ||
                                   ' cdpesqbb: ' || vr_tab_craplcm(vr_idxlcm).cdpesqbb || ' nrdocmto: ' || vr_tab_craplcm(vr_idxlcm)
                                  .nrdocmto || ' nrnsucap: ' ||
                                   substr(vr_tab_craplcm(vr_idxlcm).nrdocmto, 4, 6) || ' cdhistor: ' || vr_tab_craplcm(vr_idxlcm)
                                  .cdhistor || ' vllanmto: ' || vr_tab_craplcm(vr_idxlcm).vllanmto || '.';
                    ...
                    vr_idx_lot := lpad(vr_tab_craplcm(vr_idxlcm).cdcooper, 3, '0') ||
                                  lpad(vr_tab_craplcm(vr_idxlcm).cdagenci, 5, '0');
                    ...
                    vr_tab_craplot(vr_idx_lot).nrseqdig := greatest(vr_tab_craplot(vr_idx_lot).nrseqdig
                                                                   ,vr_tab_craplcm(vr_idxlcm).nrseqdig);
                    ...
                    vr_tab_craplot(vr_idx_lot).vlcompdb := vr_tab_craplot(vr_idx_lot)
                                                           .vlcompdb + vr_tab_craplcm(vr_idxlcm).vllanmto;
                    vr_tab_craplot(vr_idx_lot).vlinfodb := vr_tab_craplot(vr_idx_lot)
                                                           .vlinfodb + vr_tab_craplcm(vr_idxlcm).vllanmto;
            ...
            BEGIN
                ...
                WHILE vr_idxdcb IS NOT NULL LOOP
                    IF vr_tab_crapdcb(vr_idxdcb).operacao = 'I' THEN
                        ...
                        EXCEPTION
                            WHEN OTHERS THEN
                                vr_dscritic := 'Erro ao inserir crapdcb: ' || SQLERRM || 'nsu: ' || vr_tab_crapdcb(vr_idxdcb)
                                              .det.nrnsucap || 'cop: ' || vr_tab_crapdcb(vr_idxdcb)
                                              .det.cdcooper || 'con: ' || vr_tab_crapdcb(vr_idxdcb)
                                              .det.nrdconta;
                                RAISE vr_exc_saida;
                        END;
                    ELSE
            ...
            LOOP
                ...
                BEGIN
                    INSERT INTO tbgen_batch_relatorio_wrk
                        (cdcooper, cdprograma, dsrelatorio, dtmvtolt, dschave, cdagenci, dscritic)
                    VALUES
                        (pr_cdcooper
                        ,vr_cdprogra
                        ,'CRAPLOT_CET'
                        ...
                        , ';' || vr_tab_craplot(vr_idx_lot).nrseqdig || ';' || vr_tab_craplot(vr_idx_lot)
                         .qtcompln || ';' || vr_tab_craplot(vr_idx_lot).qtinfoln || ';' || vr_tab_craplot(vr_idx_lot)
                         .vlcompdb || ';' || vr_tab_craplot(vr_idx_lot).vlinfodb || ';');
    ...
    BEGIN
        ...
        DECLARE
            ...
            CURSOR cr_crapccb IS
                SELECT ccb.rowid FROM crapccb ccb;
            ...
            CURSOR cr_work_lot(pr_cdcooper    tbgen_batch_relatorio_wrk.cdcooper%TYPE
                ...
                SELECT a.dschave cdcooper
                      ,a.cdagenci cdagenci
                      ,MAX(to_number(substr(a.dscritic
                                           ,instr(a.dscritic, ';', 1, 1) + 1
                                           ,instr(a.dscritic, ';', 1, 2) - instr(a.dscritic, ';', 1, 1) - 1))) nrseqdig
                      ,SUM(to_number(substr(a.dscritic
                                           ,instr(a.dscritic, ';', 1, 2) + 1
                                           ,instr(a.dscritic, ';', 1, 3) - instr(a.dscritic, ';', 1, 2) - 1))) qtcompln
                      ,SUM(to_number(substr(a.dscritic
                                           ,instr(a.dscritic, ';', 1, 3) + 1
                                           ,instr(a.dscritic, ';', 1, 4) - instr(a.dscritic, ';', 1, 3) - 1))) qtinfoln
                      ,SUM(to_number(substr(a.dscritic
                                           ,instr(a.dscritic, ';', 1, 4) + 1
                                           ,instr(a.dscritic, ';', 1, 5) - instr(a.dscritic, ';', 1, 4) - 1))) vlcompdb
                      ,SUM(to_number(substr(a.dscritic
                                           ,instr(a.dscritic, ';', 1, 5) + 1
                                           ,instr(a.dscritic, ';', 1, 6) - instr(a.dscritic, ';', 1, 5) - 1))) vlinfodb
                  FROM tbgen_batch_relatorio_wrk a
                 WHERE a.cdcooper = pr_cdcooper
                   AND a.cdprograma = pr_cdprograma
                   AND a.dsrelatorio = pr_dsrelatorio
            ...
            PROCEDURE pc_relatorio_crrl685(pr_dscritic OUT VARCHAR2) IS
                ...
                TYPE typ_tab_relat IS TABLE OF typ_tab_reg_relat INDEX BY VARCHAR2(38); --cdcooper(5) + cdagenci(5) + nrdconta(10) + cdhistor(5) +  nsuredec(6) + vr_nrdocmto(6) + vr_vldtrans(10) + dtmvtolt(8)
                ...
                BEGIN
                    ...
                    WHILE vr_idxcop IS NOT NULL LOOP
                        ...
                        gene0002.pc_escreve_xml(vr_des_xml
                                               ...
                                               , '<detalhes>
                          <cdtrnbcb>' ||
                                                 lpad(vr_tab_relat_rescop(vr_idxcop).cdtrnbcb, 3, '0') ||
                                                 '</cdtrnbcb>
                          <dstrnbcb>' ||
                                                 lpad(vr_tab_relat_rescop(vr_idxcop).cdtrnbcb, 3, '0') ||
                                                 ' - ' || vr_tab_relat_rescop(vr_idxcop).dstrnbcb ||
                                                 '</dstrnbcb>
                          <dshistor>' || vr_tab_relat_rescop(vr_idxcop)
                                                .dshistor || '</dshistor>
                          <inpessoa>' || vr_tab_relat_rescop(vr_idxcop)
                                                .inpessoa || '</inpessoa>
                          <dspessoa>' || vr_dspessoa ||
                                                 '</dspessoa>
                          <cdorigem>' || vr_tab_relat_rescop(vr_idxcop)
                                                .cdorigem || '</cdorigem>
                          <dsorigem>' || vr_dsorigem ||
                                                 '</dsorigem>
                          <flgdebcc>' || vr_tab_relat_rescop(vr_idxcop)
                                                .flgdebcc || '</flgdebcc>                          
                          <dtdtrans>' ||
                                                 to_char(vr_tab_relat_rescop(vr_idxcop).dtdtrans, 'dd/mm/yyyy') ||
                                                 '</dtdtrans>
                          <dtmvtolt>' ||
                                                 to_char(vr_tab_relat_rescop(vr_idxcop).dtmvtolt, 'dd/mm/yyyy') ||
                                                 '</dtmvtolt>
                          <vldtrans>' || vr_tab_relat_rescop(vr_idxcop)
                                                .vldtrans || '</vldtrans>                           
                        </detalhes>');
                        -- buscar proximo
            ...
            BEGIN
                ...
                gene0002.pc_escreve_xml(vr_des_xml
                                       ,vr_texto_completo
                                       ,'<?xml version="1.0" encoding="utf-8"?><crrl685>');
                ...
                FOR rw_rel IN cr_work_rel(pr_cdcooper, vr_cdprogra, 'DADOS_RELAT', rw_crapdat.dtmvtolt) LOOP
                    ...
                    IF rw_rel.cdcooper <> vr_cdcooper THEN
                        ...
                        gene0002.pc_escreve_xml(vr_des_xml
                                               ,vr_texto_completo
                                               ,'<cooper  cdcooper="' || rw_rel.cdcooper || '" nmrescop="' ||
                                                rw_rel.nmrescop || '">');
                    ...
                    gene0002.pc_escreve_xml(vr_des_xml
                            ...
                            <cdtrnbcb>' ||
                                            ...
                                            '</cdtrnbcb>
                            <dstrnbcb>' ||
                                            lpad(rw_rel.cdtrnbcb, 3, '0') || ' - ' || rw_rel.dstrnbcb ||
                                            '</dstrnbcb>
                            <dshistor>' || rw_rel.dshistor ||
                                            '</dshistor>
                            <inpessoa>' || rw_rel.inpessoa ||
                                            '</inpessoa>
                            <dspessoa>' || vr_dspessoa ||
                                            '</dspessoa>
                            <cdorigem>' || rw_rel.cdorigem ||
                                            '</cdorigem>
                            <dsorigem>' || vr_dsorigem ||
                                            '</dsorigem>
                            <flgdebcc>' || rw_rel.flgdebcc ||
                                            '</flgdebcc>                          
                            <dtdtrans>' ||
                                            to_char(rw_rel.dtdtrans, 'dd/mm/yyyy') ||
                                            '</dtdtrans>
                            <dtmvtolt>' ||
                                            to_char(rw_rel.dtmvtolt, 'dd/mm/yyyy') ||
                                            '</dtmvtolt>
                            <vldtrans>' || rw_rel.vldtrans ||
                                            '</vldtrans>                           
                          </detalhes>');
                
                    -- resumo cooperativa
                    vr_idxcop := lpad(rw_rel.cdcooper, 5, '0') || -- cdcooper(5)
                                 rw_rel.inpessoa || lpad(rw_rel.cdtrnbcb, 3, '0') ||
                                 lpad(rw_rel.cdhistor, 5, '0') || rw_rel.cdorigem ||
                                 to_char(rw_rel.dtdtrans, 'ddmmyyyy') || to_char(rw_rel.dtmvtolt, 'ddmmyyyy');
                ...
                gene0002.pc_solicita_relato(pr_cdcooper  => 3 -- CECRED       --> Cooperativa conectada
                                           ...
                                           ,pr_dsarqsaid => vr_nom_direto || '/crrl685_' ||
                                                            lpad(nvl(vr_nrseqarq, 0), 7, '0') || '.lst' --> Arquivo final com código da agência
            ...
            BEGIN
                ...
                vr_dstexto := to_char(SYSDATE, 'hh24:mi:ss') || ' - ' || vr_cdprogra || ' --> ' || 'Erro na ' ||
                              nvl(vr_dstpdreg, ' ') || '. ' || ' Linha ' || nvl(pr_nrdlinha, 0) ||
        ...
        BEGIN
            -- Incluir nome do modulo logado
            gene0001.pc_informa_acesso(pr_module => vr_cdprogra, pr_action => 'CCRD0003.pc_crps670');
            ...
            pc_log_programa(pr_dstiplog     => 'O'
                           ...
                           ,pr_tpexecucao   => 2 -- Tipo de execucao (0-Outro/ 1-Batch/ 2-Job/ 3-Online)
                           ,pr_tpocorrencia => 4
                           ,pr_dsmensagem   => 'Iniciando processamento de arquivos. Encontrado ' ||
                                               vr_vet_nmarquiv.count || ' arquivo(s).'
                           ,pr_idprglog     => vr_idlog_ini_ger);
            ...
            FOR i IN 1 .. vr_vet_nmarquiv.count() LOOP
                ...
                ELSIF nvl(vr_maior_seq, 0) + 1 <> nvl(vr_nrseqarq, 0) THEN
                    -- Montar mensagem de critica
                    vr_dscritic := 'Falta sequencial de arquivo ' || '(seq arq.: ' || vr_nrseqarq ||
                                   ', Ult. seq.: ' || vr_maior_seq || '), arquivo ' || vr_nmarqimp ||
                                   ' nao sera processado.';
                    -- Chamar rotina para enviar E-mail e abrir chamado
                    pc_log_dados_arquivo(pr_tipodreg => 1 -- Conciliacao Cartao Bancoob/Cabal
                                        ,pr_nmdarqui => nvl(vr_nmarqimp, ' ')
                ...
                OPEN cr_work_arq(pr_cdcooper, vr_cdprogra, 'CTRL_ARQ', rw_crapdat.dtmvtolt);
                FETCH cr_work_arq
                    INTO rw_work_arq;
                -- Se encontrou
                IF cr_work_arq%FOUND THEN
                    ...
                    IF rw_work_arq.nmarquiv <> vr_nmarqimp THEN
                        -- Montar mensagem de critica
                        vr_dscritic := 'Houve execucao parcial anterior para o arquivo ' ||
                                       rw_work_arq.nmarquiv || 'e agora esta sendo processado outro arquivo ' ||
                                       vr_nmarqimp || '.';
                        -- Chamar rotina para enviar E-mail e abrir chamado
                        pc_log_dados_arquivo(pr_tipodreg => 1 -- Conciliacao Cartao Bancoob/Cabal
                                            ,pr_nmdarqui => nvl(vr_nmarqimp, ' ')
                    ...
                    ELSIF rw_work_arq.nrseqarq <> vr_nrseqarq THEN
                        -- Montar mensagem de critica
                        vr_dscritic := 'Houve execucao parcial anterior para a sequencia ' ||
                                       rw_work_arq.nrseqarq ||
                ...
                IF NOT vr_flrestar THEN
                    ...
                    ELSE
                        ...
                        BEGIN
                            INSERT INTO crapccb
                                (nrseqarq, nmarquiv, cddbanco, dtarquiv)
                            VALUES
                                (nvl(vr_nrseqarq, 0)
                                ,vr_nmarqimp
                    ...
                    vr_comando := 'grep -v ' || '''^$'' ' || vr_direto_connect || '/' || vr_nmarqimp ||
                                  '| tail -1';
                    ...
                    IF utl_file.is_open(vr_ind_arquiv) THEN
                        ...
                        LOOP
                            BEGIN
                                ...
                                EXCEPTION
                                    WHEN OTHERS THEN
                                        vr_dscritic := 'Erro ao gerar tabela temporaria com dados arquivo -> ' ||
                                                       SQLERRM;
                                        RAISE vr_exc_saida;
                                END;
                            EXCEPTION
                    ...
                    IF vr_qtdejobs > 0 THEN
                        ...
                        EXCEPTION
                            WHEN OTHERS THEN
                                vr_dscritic := 'Erro ao gerar tabela temporaria com dados controle arquivo -> ' ||
                                               SQLERRM;
                                RAISE vr_exc_saida;
                        END;
                    END IF;
                ...
                IF vr_flrestar OR vr_qtdejobs > 0 THEN
                    ...
                    FOR vr_idx IN 1 .. vr_nrexepar LOOP
                        ...
                        vr_dsplsql := 'DECLARE' || chr(13) || '  wpr_cdcritic NUMBER;' || chr(13) ||
                                      ...
                                      '                                    ,to_date(''' ||
                                      to_char(rw_crapdat.dtmvtolt, 'dd/mm/rrrr') || ''',''dd/mm/rrrr'')' ||
                                      chr(13) || '                                    ,''' || vr_dtcxtmig || '''' ||
                                      chr(13) || '                                    ,' || vr_nrseqarq ||
                                      chr(13) || '                                    ,' || vr_idx || chr(13) ||
                                      '                                    ,' || vr_idparale || chr(13) ||
                ...
                vr_comando := 'cp ' || vr_direto_connect || '/' || vr_nmarqimp || ' ' || vr_dsdireto ||
                              '/recebidos/ 2> /dev/null';
                ...
                vr_comando := 'mv ' || vr_direto_connect || '/' || vr_nmarqimp || ' /usr/coop/' || vr_dsdircop ||
                              '/salvar/ 2> /dev/null';
                ...
                -- ATUALIZA REGISTRO REFERENTE A SEQUENCIA DE ARQUIVOS
                BEGIN
                    UPDATE crapscb SET nrseqarq = vr_maior_seq, dtultint = SYSDATE WHERE crapscb.tparquiv = 2; -- Arquivo CEXT - Conciliação dos Débitos
    ...
    BEGIN
        ...
        EXCEPTION
            WHEN vr_exc_saida THEN
                ...
                pr_retxml := xmltype.createxml('<?xml version="1.0" encoding="ISO-8859-1" ?><Root><Erro><![CDATA[' ||
                                               vr_dscritic || ']]></Erro><TpException>1</TpException></Root>');
    ...
    BEGIN
        ...
        DECLARE
            ...
            CURSOR cr_crapcrd(pr_cdcooper IN crapcop.cdcooper%TYPE
                ...
                SELECT crd.cdadmcrd
                 ...
                 WHERE crd.cdcooper = pr_cdcooper
                   ...
                   AND (crd.cdadmcrd >= 10 AND crd.cdadmcrd <= 80)
                   AND crd.dtcancel IS NULL;
            ...
            CURSOR cr_crawcrd_flgprcrd(pr_cdcooper IN crapcop.cdcooper%TYPE
                ...
                SELECT pcr.flgprcrd
                 ...
                 WHERE adc.cdcooper = pcr.cdcooper
                   ...
                   AND (pcr.cdadmcrd >= 10 AND pcr.cdadmcrd <= 80)
                   AND pcr.flgprcrd = 1
            ...
            CURSOR cr_crawcrd(pr_cdcooper IN crapcop.cdcooper%TYPE) IS
                SELECT pcr.cdcooper
                 ...
                 WHERE pcr.cdcooper = pr_cdcooper
                   ...
                   AND pcr.insitcrd = 1
                   AND -- APROVADO
                       ass.cdcooper = pcr.cdcooper
                   AND ass.nrdconta = pcr.nrdconta
                   AND ass.dtdemiss IS NULL
                   AND age.cdcooper = ass.cdcooper
                   AND age.cdagenci = ass.cdagenci
                   AND pcr.insitdec IN (2, 3) /* Decisao esteira = 2 - Aprovado Auto, 3 - Aprovado Manuel */
            ...
            CURSOR cr_crapenc(pr_cdcooper IN crapenc.cdcooper%TYPE
                ...
                SELECT enc.nrcepend
                      ...
                      ,enc.dsendere || decode(enc.nrendere, 0, NULL, ',' || enc.nrendere) dsender_compl
            ...
            BEGIN
                BEGIN
                    ...
                    IF cr_crapenc%NOTFOUND THEN
                        ...
                        CLOSE cr_crapenc;
                        -- Montar mensagem de critica
                        vr_dscritic := 'Endereco nao encontrado. ' || 'Cooperativa: ' ||
                                       to_char(rw_crawcrd.cdcooper) || ' Conta: ' ||
                                       to_char(rw_crawcrd.nrdconta) || '.';
                        RAISE vr_exc_saida;
                    ELSE
                        -- Apenas fechar o cursor
                        CLOSE cr_crapenc;
                    ...
                    ELSE
                        ...
                        vr_aux_dsendcom := rpad(nvl((TRIM(substr(nvl(rw_crapenc.dsendere, ' '), 1, 29)) ||
                                                    TRIM(substr(nvl(rw_crapenc.nrendere, ' '), 1, 6) ||
                                                          substr(nvl(rw_crapenc.dsender_apbl, ' '), 1, 15)))
                                                   ,' ')
                                               ,50
                                               ,' ');
                    END IF;
            ...
            BEGIN
                ...
                BEGIN
                    ...
                    vr_dsdettp2 := ('CCB3' /* Pedido */
                                   ...
                                   || pr_tipooper /* Tp. Operac.                        */
                                   || lpad(rw_crawcrd.nrseqcrd, 8, '0') /* Nrd. Operac.                       */
                                   || to_char(rw_crapdat.dtmvtolt, 'DDMMYYYY') || rpad(pr_nrctacrd, 13, '0') /* Nr. Conta Cart.                    */
        ...
        BEGIN
            ...
            -- monta nome do arquivo
            vr_nmrquivo := 'CCB3756' || to_char(lpad(rw_crapcop.cdagebcb, 4, '0')) || '_' ||
                           lpad(vr_nrseqarq, 7, 0) || '.CCB';
            ...
            -- monta HEADER do arquivo
            vr_dsheader := 'CCB3' || '00' || '0756' || to_char(lpad(rw_crapcop.cdagebcb, 4, '0')) ||
                           lpad(vr_nrseqarq, 7, 0) || to_char(rw_crapdat.dtmvtolt, 'DDMMYYYY') || '1' ||
                           lpad('0', 70, '0');
            ...
            FOR rw_crapcol IN cr_crapcol LOOP
                ...
                FOR rw_crapcrd_loop_alt IN cr_crapcrd_loop_alt(rw_crapcol.cdcooper) LOOP
                    ...
                    OPEN cr_crapalt(pr_cdcooper => rw_crapcrd_loop_alt.cdcooper
                                   ,pr_nrdconta => rw_crapcrd_loop_alt.nrdconta
                                   ,pr_dtaltini => vr_dtultenv
                                   , -- Desde a data do ultimo envio do arquivo
                    ...
                    IF cr_crapalt%FOUND OR cr_altlimit%FOUND THEN
                        ...
                        IF upper(rw_crapalt.dsaltera) LIKE 'PAC %' OR upper(rw_crapalt.dsaltera) LIKE 'PA %' OR
                           upper(rw_crapalt.dsaltera) LIKE '%,PAC %' OR
                           upper(rw_crapalt.dsaltera) LIKE '%,PA %' OR
                           upper(rw_crapalt.dsaltera) LIKE '%, PAC %' OR
                        ...
                        IF upper(rw_crapalt.dsaltera) LIKE '%CEP 1.TTL%' OR
                           ...
                           upper(rw_crapalt.dsaltera) LIKE '%UF 1.TTL%' OR
                           upper(rw_crapalt.dsaltera) LIKE '%CIDADE,%' OR
                           upper(rw_crapalt.dsaltera) LIKE '%UF,%' OR upper(rw_crapalt.dsaltera) LIKE '%CEP,%' OR
                           upper(rw_crapalt.dsaltera) LIKE '%CEP COM.,%' OR
                           upper(rw_crapalt.dsaltera) LIKE '%CIDADE COM.,%' OR
                        ...
                        IF cr_altlimit%FOUND THEN
                            ...
                            EXCEPTION
                                WHEN OTHERS THEN
                                    -- Montar mensagem de critica
                                    vr_dscritic := 'Erro ao atualizar solicitação de alteração de limite: ' ||
                                                   SQLERRM;
                                    RAISE vr_exc_saida;
                            END;
                        END IF;
                        ...
                        ELSE
                            ...
                            ELSE
                                ...
                                IF cr_crapavt%NOTFOUND THEN
                                    ...
                                    CLOSE cr_crapavt;
                                    -- Montar mensagem de critica
                                    vr_dscritic := 'Representante nao encontrado. Conta/DV: ' ||
                                                   rw_crawcrd.nrdconta || ' CPF: ' || rw_crawcrd.nrcpftit ||
                            ...
                            FETCH cr_crawcrd_flgprcrd
                                INTO rw_crawcrd_flgprcrd;
                    ...
                    EXCEPTION
                        ...
                        WHEN OTHERS THEN
                            ...
                            gene0003.pc_solicita_email(pr_cdcooper    => vr_cdcooper
                                                      ...
                                                      ,pr_des_anexo   => NULL
                                                      ,pr_des_corpo   => 'Erro ao gerar arquivo ' ||
                                                                         vr_nmrquivo || '<br><br>' ||
                                                                         'Critica: ' || vr_dscritic
            ...
            BEGIN
                UPDATE crapscb
                   SET nrseqarq = vr_nrseqarq, dtultint = SYSDATE, flgretpr = 0
                 WHERE crapscb.tparquiv = 3; -- Arquivo CBB3 - Interface Cadastral
        ...
        EXCEPTION
            ...
            WHEN vr_exc_fimprg THEN
                ...
                pr_retxml := xmltype.createxml('<?xml version="1.0" encoding="ISO-8859-1" ?><Root><Erro>' ||
                                               vr_dscritic || '</Erro><TpException>2</TpException></Root>');
            WHEN OTHERS THEN
                pr_cdcritic := vr_cdcritic;
    ...
    BEGIN
        ...
        DECLARE
            ...
            TYPE typ_tab_nmarquiv IS TABLE OF VARCHAR2(100) INDEX BY BINARY_INTEGER;
        
            -- Vetor para armazenar os arquivos para processamento
            vr_vet_nmarquiv typ_tab_nmarquiv;
        
            -- Definicao do vetor com os códigos e os nomes das solicitações
            TYPE typ_vet_nmtipsol IS TABLE OF VARCHAR2(150) INDEX BY BINARY_INTEGER;
        
            vr_vet_nmtipsol typ_vet_nmtipsol;
        
            -- Definicao do vetor com os códigos de lote de SMS criado por cooperativa
            TYPE typ_tab_nrdlote IS TABLE OF NUMBER(10) INDEX BY BINARY_INTEGER;
            ...
            CURSOR cr_crawcrd_cpf(pr_cdcooper IN crawcrd.cdcooper%TYPE
                                 ,pr_nrcpftit IN crawcrd.nrcpftit%TYPE) IS
                SELECT crd.nrdconta
                  FROM crawcrd crd
                 WHERE crd.cdcooper = pr_cdcooper
            ...
            -- cursor para Grupo de Afinidade
            CURSOR cr_crapacb(pr_cdgrafin IN crapacb.cdgrafin%TYPE) IS
                SELECT acb.cdadmcrd FROM crapacb acb WHERE acb.cdgrafin = pr_cdgrafin;
            rw_crapacb cr_crapacb%ROWTYPE;
            ...
            CURSOR cr_craprej(pr_dtmvtolt IN crapdat.dtmvtolt%TYPE
                ...
                SELECT rej.cdcooper
                      ...
                      ,rej.nrdconta
                      ,rej.nrdocmto
                      ,decode(nvl(to_number(substr(rej.cdpesqbb, 0, 19)), 0)
                             ,0
                             ,NULL
                             ,substr(rej.cdpesqbb, 0, 19)) cdpesqbb
                      ...
                      ,substr(listagg(substr(rej.cdpesqbb, 20, 23), ', ') within
                              GROUP(ORDER BY substr(rej.cdpesqbb, 20, 23))
                             ,0
                             ,23) nmtitcrd
                 ...
                 INNER JOIN crapage age
                    ON age.cdcooper = rej.cdcooper
                   AND age.cdagenci = rej.cdagenci
                
                  LEFT JOIN crapcrc crc
                    ON crc.cdcodigo = rej.cdcritic
                
                 WHERE rej.dshistor = 'CCR3'
                   AND (rej.cdcritic > 10 AND rej.cdcritic < 900 OR rej.cdcritic = 999)
                 ...
                 GROUP BY rej.cdcooper
                         ...
                         ,decode(nvl(to_number(substr(rej.cdpesqbb, 0, 19)), 0)
                                ,0
                                ,NULL
                                ,substr(rej.cdpesqbb, 0, 19))
                         ,rej.nrdctitg
                         ,crc.dscritic
                         ,to_number(substr(rej.cdpesqbb, 43, 2))
                 ORDER BY rej.cdagenci
                         ,rej.nrdconta;
            ...
            CURSOR cr_crawcrd(pr_cdcooper IN crawcrd.cdcooper%TYPE
                ...
                SELECT pcr.cdcooper
                 ...
                 WHERE pcr.cdcooper = pr_cdcooper
                   ...
                   AND pcr.cdadmcrd = pr_cdadmcrd
                   AND (pcr.rowid <> pr_rowid OR pr_rowid IS NULL)
                   AND pcr.dtcancel IS NULL;
            ...
            -- Busca os demais cartões da conta cartao daquele CPF
            CURSOR cr_crapcrd_nrcctitg_nrcpftit(pr_cdcooper crawcrd.cdcooper%TYPE
                                               ,pr_nrdconta crawcrd.nrdconta%TYPE
                                               ,pr_nrcctitg crawcrd.nrcctitg%TYPE
                                               ,pr_nrcpftit crawcrd.nrcpftit%TYPE) IS
            
                SELECT crapcrd.nrcrcard
                  FROM crawcrd
									    ,crapcrd
                 WHERE crawcrd.cdcooper = crapcrd.cdcooper
                   ...
                   AND crawcrd.nrcctitg = pr_nrcctitg
                   AND crawcrd.nrcpftit = pr_nrcpftit;
        
            rw_crapcrd_nrcctitg_nrcpftit cr_crapcrd_nrcctitg_nrcpftit%ROWTYPE;
        
            -------------------- PROCEDIMENTOS INTERNOS ------------------------------
            /* Função para mascarar do numero do cartao */
            FUNCTION fn_mask_cartao(pr_nrcrcard VARCHAR2) RETURN VARCHAR2 IS
            BEGIN
                RETURN substr(pr_nrcrcard, 1, 4) || '.****.****.' || substr(pr_nrcrcard
                                                                           ,length(pr_nrcrcard) - 3
                                                                           ,4);
            END;
            ...
            PROCEDURE atualiza_dados_cartao(pr_cdcooper       IN crawcrd.cdcooper%TYPE
                ...
                CURSOR cr_crawcrd_limite(pr_cdcooper IN crawcrd.cdcooper%TYPE
                    ...
                    SELECT crawcrd.cdadmcrd
                          ,crawcrd.vllimcrd
                          ,crawcrd.nrcrcard
                          ,row_number() over(PARTITION BY crawcrd.cdcooper, crawcrd.nrdconta, crawcrd.cdadmcrd ORDER BY crawcrd.cdcooper, crawcrd.nrdconta, crawcrd.cdadmcrd) nrseqreg
                          ,progress_recid
                      FROM crawcrd
                     WHERE crawcrd.cdcooper = pr_cdcooper
                       AND crawcrd.nrdconta = pr_nrdconta
                ...
                BEGIN
                    ...
                    IF pr_rwatulim.dsdrowid IS NOT NULL THEN
                        ...
                        IF pr_rwatulim.cdadmcrd = pr_rwcrawcrd.cdadmcrd AND pr_rwcrawcrd.nrseqreg = 1 THEN
                ...
                EXCEPTION
                    ...
                    WHEN OTHERS THEN
                        ...
                        pr_cdcritic := 0;
                        pr_dscritic := 'Erro ao atualizar os dados do cartao. Rotina PC_CRPS672.atualiza_historico_limite. ' ||
                                       SQLERRM;
            ...
            BEGIN
                ...
                FOR rw_crawcrd_limite IN cr_crawcrd_limite(pr_cdcooper => pr_cdcooper
                    ...
                    IF rw_crawcrd_limite.nrseqreg = 1 THEN
                        ...
                        OPEN cr_crapadc(pr_cdcooper => pr_cdcooper, pr_cdadmcrd => rw_crawcrd_limite.cdadmcrd);
                        FETCH cr_crapadc
                            INTO rw_crapadc;
                        IF cr_crapadc%NOTFOUND THEN
                            CLOSE cr_crapadc;
                            pr_dscritic := 'Administradora nao encontrada. Codigo: ' ||
                                           to_char(rw_crawcrd_limite.cdadmcrd);
                            RAISE vr_exc_erro;
                        ...
                        IF upper(rw_crapadc.nmbandei) <> 'MAESTRO' THEN
                            ...
                            IF NOT vr_craptlc THEN
                                ...
                                FETCH cr_craptlc_cecred
                                    INTO rw_craptlc_cecred;
                    ...
                    IF NOT vr_craptlc THEN
                        ...
                        pc_escreve_xml(pr_xml_lim_cartao
                                      ,'<Dados>' || '<cdcooper>' || pr_cdcooper || '</cdcooper>' ||
                                       '<nmrescop>' || pr_nmrescop || '</nmrescop>' || '<cdagenci>' ||
                                       pr_cdagenci || '</cdagenci>' || '<nmextage>' || pr_nmextage ||
                                       '</nmextage>' || '<nrdconta>' ||
                                       ltrim(gene0002.fn_mask_conta(pr_nrdconta)) || '</nrdconta>' ||
                                       '<nrcrcard>' || vr_nrcrcard || '</nrcrcard>' || '<nmprimtl>' ||
                                       pr_nmprimtl || '</nmprimtl>' || '<cdadmcrd>' || rw_crapadc.cdadmcrd ||
                                       '</cdadmcrd>' || '<nmresadm>' || rw_crapadc.nmresadm || '</nmresadm>' ||
                                       '<limite_bancoob>' || to_char(pr_vllimcrd, 'fm999g999g990d00') ||
                                       '</limite_bancoob>' || '<limite_ayllos>' ||
                                       to_char(rw_crawcrd_limite.vllimcrd, 'fm999g999g990d00') ||
                                       '</limite_ayllos>' || '</Dados>');
                    ELSE
                        -- Atualiza os dados do cartao de credito
                        BEGIN
                            UPDATE crawcrd
                               SET dddebant = crawcrd.dddebito
            ...
            EXCEPTION
                ...
                WHEN OTHERS THEN
                    ...
                    --Variavel de erro recebe erro ocorrido
                    pr_cdcritic := 0;
                    pr_dscritic := 'Erro ao atualizar os dados do cartao. Rotina PC_CRPS672.atualiza_dados_cartao. ' ||
                                   SQLERRM;
            ...
            BEGIN
                ...
                IF cr_crawcrd%NOTFOUND THEN
                    CLOSE cr_crawcrd;
                    pr_dscritic := 'Cartao nao encontrado. Conta: ' || to_char(pr_nrdconta) || '. Cartao: ' ||
                                   fn_mask_cartao(to_char(pr_nrcrcard));
                    RAISE vr_exc_erro;
                END IF;
                CLOSE cr_crawcrd;
                ...
                IF cr_tbcrd_situacao%NOTFOUND THEN
                    ...
                    pr_dscritic := 'Situacao nao encontrada. Conta: ' || to_char(pr_nrdconta) ||
                                   '. Situacao: ' || to_char(pr_insitcrd);
                    RAISE vr_exc_erro;
                END IF;
                CLOSE cr_tbcrd_situacao;
                ...
                IF rw_tbcrd_situacao.cdsitcrd = 6 THEN
                    ...
                    BEGIN
                        UPDATE crawcrd
                           SET insitcrd = rw_tbcrd_situacao.cdsitcrd
                              ,dtcancel = pr_dtmvtolt
                              ,cdmotivo = rw_tbcrd_situacao.cdmotivo
                         WHERE crawcrd.cdcooper = pr_cdcooper
                           AND crawcrd.nrdconta = pr_nrdconta
                           AND crawcrd.nrcrcard = pr_nrcrcard
                        RETURNING insitcrd, dtcancel, cdmotivo INTO vr_insitcrd, vr_dtcancel, vr_cdmotivo;
                    EXCEPTION
                        WHEN OTHERS THEN
                            pr_dscritic := 'Erro ao atualizar crawcrd: ' || SQLERRM;
                            RAISE vr_exc_erro;
                ...
                ELSE
                    ...
                    BEGIN
                        UPDATE crawcrd
                           SET insitcrd = rw_tbcrd_situacao.cdsitcrd, dtcancel = NULL, cdmotivo = 0
                         WHERE crawcrd.cdcooper = pr_cdcooper
                           AND crawcrd.nrdconta = pr_nrdconta
                           AND crawcrd.nrcrcard = pr_nrcrcard
                        RETURNING insitcrd, dtcancel, cdmotivo INTO vr_insitcrd, vr_dtcancel, vr_cdmotivo;
            ...
            EXCEPTION
                ...
                WHEN OTHERS THEN
                    ...
                    --Variavel de erro recebe erro ocorrido
                    pr_cdcritic := 0;
                    pr_dscritic := 'Erro ao atualizar a situacao do cartao. Rotina PC_CRPS672.atualiza_situacao_cartao. ' ||
                                   SQLERRM;
            ...
            BEGIN
                ...
                vr_dstexto := to_char(SYSDATE, 'hh24:mi:ss') || ' - ' || vr_cdprogra || ' --> ' ||
                              ...
                              nvl(pr_nrdlinha, 0) || ', arquivo: ' || pr_nmdarqui || ', Critica: ' ||
                              nvl(pr_dscritic, ' ');
            ...
            BEGIN
                -- Texto para utilizar na abertura do chamado e no email enviado
                vr_dstexto := to_char(SYSDATE, 'hh24:mi:ss') || ' - ' || vr_cdprogra || ' --> ' || 'Arquivo ' ||
                              pr_nmdarqui || ' foi recebido incompleto.';
            ...
            PROCEDURE pc_atualiza_majoracao(pr_cdcooper IN NUMBER
                ...
                CURSOR cr_crapcrc IS
                    SELECT crc.dscritic FROM crapcrc crc WHERE crc.cdcodigo = pr_cdcodigo;
            ...
            BEGIN
                ...
                IF gene0001.fn_database_name =
                   gene0001.fn_param_sistema('CRED', pr_cdcooper, 'DB_NAME_PRODUC') THEN
                    --> Produção
        ...
        BEGIN
            ...
            --vr_direto_connect := rw_crapscb.dsdirarq || '/recebe';
						vr_direto_connect := '/usr/coop/sistema/equipe/augustinho';
            ...
            vr_split := gene0002.fn_quebra_string(pr_string => vr_listarq, pr_delimit => ',');
            ...
            FOR i IN 1 .. vr_contador LOOP
                ...
                ELSIF nvl(vr_nrseqarq_max, 0) + 1 <> nvl(vr_nrseqarq, 0) THEN
                    -- Montar mensagem de critica
                    vr_dscritic := 'Falta sequencial de arquivo ' || '(seq arq.: ' || vr_nrseqarq ||
                                   ', Ult. seq.: ' || vr_nrseqarq_max || '), arquivo ' || vr_vet_nmarquiv(i) ||
                                   ' não será processado.';
                    -- gravar log do erro
                    pc_log_message;
                    continue;
                ...
                /* o comando abaixo ignora quebras de linha atraves do 'grep -v' e o 'tail -1' retorna
                a ultima linha do resultado do grep */
                vr_comando := 'grep -v ' || '''^$'' ' || vr_direto_connect || '/' || vr_vet_nmarquiv(i) ||
                              '| tail -1';
                ...
                IF utl_file.is_open(vr_ind_arquiv) THEN
                    ...
                    LOOP
                        BEGIN
                                ...
                                */
                                ...
                                IF substr(vr_des_text, 275, 3) <> '000' THEN
                                    ...
                                    IF rw_atulimi.dsdrowid IS NOT NULL THEN
                                        ...
                                        EXCEPTION
                                            WHEN OTHERS THEN
                                                vr_dscritic := 'Erro ao atualizar tbcrd_limite_atualiza: ' ||
                                                               SQLERRM;
                                                pc_log_message;
                                        END;
                            ...
                            IF substr(vr_des_text, 5, 2) = '02' THEN
                                ...
                                1 - Inclusao de Cartao
                                3 - Cancelamento de Cartao
                                4 - Inclusao de Adicional (Operação também é utilizada para inclusão de cartão provisório)
                                7 - Reativacao de Contas
                                ...
                                */
                                ...
                                IF nvl(vr_nrctatp2, 0) = 0 THEN
                                    ...
                                    FETCH cr_crawcrd_outros_nrcctitg
                                        INTO rw_crawcrd_outros_nrcctitg;
                                    ...
                                    ELSE
                                        ...
                                        OPEN cr_crawcrd_outros(pr_cdcooper => vr_cdcooper
                                                              ,pr_nrseqcrd => vr_nroperac);
                                        FETCH cr_crawcrd_outros
                                            INTO rw_crawcrd_outros;
                                    
                                        IF cr_crawcrd_outros%NOTFOUND THEN
                                            CLOSE cr_crawcrd_outros;
                                            IF nvl(vr_tpdocmto, 0) = 1 THEN
                                                --> se o Documento é um CPF ira buscar pelo cursor
                                            
                                                vr_cpf := to_number(nvl(substr(vr_des_text, 95, 11), 0)); --> CPF é extraido
                                            
                                                OPEN cr_crawcrd_cpf(pr_cdcooper => vr_cdcooper
                                                                   ,pr_nrcpftit => vr_cpf);
                                                FETCH cr_crawcrd_cpf
                                                    INTO rw_crawcrd_cpf;
                                ...
                                IF vr_tipooper = 4 THEN
                                     ...
                                     vr_cpf := to_number(nvl(substr(vr_des_text, 95, 11), 0)); --> CPF é extraido
																	...
																	IF nvl(TRIM(upper(vr_nmtitcrd)), ' ') = 'CARTAO PROVISORIO' THEN
																		OPEN cr_crapcrd_nrcctitg_nrcpftit(pr_cdcooper => vr_cdcooper
																																		 ,pr_nrdconta => vr_nrdconta
																																		 ,pr_nrcctitg => vr_nrdctitg
																																		 ,pr_nrcpftit => vr_cpf);
																		FETCH cr_crapcrd_nrcctitg_nrcpftit
																				INTO rw_crapcrd_nrcctitg_nrcpftit;

																		IF cr_crapcrd_nrcctitg_nrcpftit%NOTFOUND THEN
																				CLOSE cr_crapcrd_nrcctitg_nrcpftit;
																				CONTINUE;
																		END IF;
																		CLOSE cr_crapcrd_nrcctitg_nrcpftit;
																		...
																		BEGIN
																			UPDATE crapcrd
																				 SET crapcrd.flgprovi = 1
																			 WHERE crapcrd.cdcooper = vr_cdcooper
																				 AND crapcrd.nrdconta = vr_nrdconta
																				 AND crapcrd.nrcrcard = rw_crapcrd_nrcctitg_nrcpftit.nrcrcard;
																		EXCEPTION
																				WHEN OTHERS THEN
																						vr_dscritic := 'Erro ao atualizar cartao como provisorio: ' || SQLERRM;
																						RAISE vr_exc_saida;
																		END;
																	END IF;
                                END IF;
																
																-- Caso a operação for "Cancelamento de Cartão"
                                IF vr_tipooper = 3 THEN
																	--
																	IF nvl(vr_tpdocmto, 0) = 1 THEN
                                     vr_cpf := to_number(nvl(substr(vr_des_text, 95, 11), 0)); --> CPF é extraido
																	END IF;
																	...
																	IF nvl(TRIM(upper(vr_nmtitcrd)), ' ') = 'CARTAO PROVISORIO' THEN
																		...
																		BEGIN
																			UPDATE crapcrd
																				 SET crapcrd.flgprovi = 0
																			 WHERE crapcrd.cdcooper = vr_cdcooper
																				 AND crapcrd.nrdconta = vr_nrdconta
																				 AND crapcrd.nrcrcard = rw_crapcrd_nrcctitg_nrcpftit.nrcrcard;
																		EXCEPTION
																				WHEN OTHERS THEN
																						vr_dscritic := 'Erro ao atualizar cartao definitivo (cancelamento do provisorio): ' || SQLERRM;
																						RAISE vr_exc_saida;
																		END;
																	END IF;
                                END IF;
                                ...
                                IF vr_tpdocmto = '03' THEN
                                    ...
                                    vr_nmtitcrd := substr(vr_des_text, 38, 19) || substr(vr_des_text, 250, 23) ||
                                                   substr(vr_des_text, 7, 2);
                                ...
                                */
                                ...
                                IF nvl(vr_nrctatp1, 0) <> nvl(vr_nrctatp2, 0) THEN
                                    ...
                                    FETCH cr_crawcrd_em_uso
                                        INTO rw_crapacb.cdadmcrd
                                            ,vr_dddebito
                                            ,vr_vllimcrd
                                            ,vr_tpdpagto
                                            ,vr_flgdebcc;
                                                ...
                                                IF cr_crawcrd_cdgrafin%NOTFOUND THEN
                                                    ...
                                                    IF cr_crawcrd_cancel%NOTFOUND THEN
                                                        ...
                                                        OPEN cr_crawcrd_cdgrafin_conta(vr_cdcooper -- pr_cdcooper
                                                                                      ...
                                                                                      ,rw_crapdat.dtmvtolt); -- pr_dtmvtolt
                                                        -- Buscar os dados                              
                                                        FETCH cr_crawcrd_cdgrafin_conta
                                                            INTO rw_crawcrd_cdgrafin_conta;
                                ...
                                IF vr_codrejei <> '000' THEN
                                    ...
                                    BEGIN
                                        vr_nmtitcrd := substr(vr_des_text, 38, 19) ||
                                                       substr(vr_des_text, 57, 23) ||
                                                       substr(vr_des_text, 7, 2);
                                        INSERT INTO craprej
                                            (cdcooper
                                            ,cdagenci
                                    ...
                                    IF cr_crapass%FOUND THEN
                                        IF rw_crapass.inpessoa = 1 THEN
                                            ...
                                            IF cr_crapttl%NOTFOUND THEN
                                                ...
                                                CLOSE cr_crapttl;
                                                -- Montar mensagem de critica
                                                vr_dscritic := 'Titular nao encontrado da conta: ' ||
                                                               rw_crawcrd.nrdconta;
                                                -- gravar log do erro
                                                pc_log_message;
                                        ...
                                        ELSE
                                            ...
                                            IF cr_crapjur%NOTFOUND THEN
                                                ...
                                                CLOSE cr_crapjur;
                                                -- Montar mensagem de critica
                                                vr_dscritic := 'Empresa nao encontrada. Conta/DV: ' ||
                                                               rw_crapass.nrdconta;
                                                -- gravar log do erro
                                                pc_log_message;
                                            ...
                                            IF cr_crapavt%NOTFOUND THEN
                                                ...
                                                IF vr_valida_avt THEN
                                                    ...
                                                    EXCEPTION
                                                        WHEN OTHERS THEN
                                                            vr_dscritic := 'Erro ao inserir craprej: ' ||
                                                                           SQLERRM;
                                                            RAISE vr_exc_saida;
                                                    END;
                                            ...
                                            IF vr_valida_avt THEN
                                                ...
                                                IF cr_crapass_avt%NOTFOUND THEN
                                                    ...
                                                    vr_vlsalari := 0;
                                                ELSE
                                                    -- Se for cooperado, pega os dados da conta
                                    ...
                                    BEGIN
                                        ...
                                        VALUES
                                            ...
                                            , -- tpcartao
                                             vr_dtdonasc
                                            , -- dtnasccr
                                             substr(vr_des_text, 230, 15)
                                            , -- nrdoccrd
                                             TRIM(substr(vr_des_text, 57, 23))
                                            , -- nmtitcrd
                                             vr_nrctrcrd
                                            , -- nrctrcrd
                                             rw_crapacb.cdadmcrd
                                ...
                                ELSE
                                    -- se encontrar proposta de cartão de crédito   
                                    ...
                                    IF rw_crawcrd.nrcrcard = 0 THEN
                                        ...
                                        BEGIN
                                            UPDATE crawcrd
                                               SET nrcctitg = vr_nrdctitg, nrcrcard = vr_nrcrcard
                                             WHERE ROWID = rw_crawcrd.rowid;
                                        EXCEPTION
                                            WHEN OTHERS THEN
                                                vr_dscritic := 'Erro ao atualizar crawcrd: ' || SQLERRM;
                                        ...
                                        ELSE
                                            -- se encontrar registro do cartão de crédito,
                                    ...
                                    ELSE
                                        -- Se o número do Cartão não for zerado (tratamento 2a. via)
                                        ...
                                        IF cr_crawcrd_ativo%NOTFOUND OR
                                           (cr_crawcrd_ativo%FOUND AND vr_nrcrcard <> rw_crawcrd.nrcrcard AND
                                        ...
                                        IF cr_crawcrd%NOTFOUND OR
                                           (cr_crawcrd%FOUND AND (vr_nrcrcard <> rw_crawcrd.nrcrcard) AND
                                           rw_crawcrd.nrcrcard <> 0) THEN
                                            ...
                                            BEGIN
                                                ...
                                                VALUES
                                                    (rw_crawcrd.nrdconta
                                                    ,vr_nrcrcard
                                                    , -- número cartão vindo do arquivo
                                                     rw_crawcrd.nrcctitg
                                                    ,rw_crawcrd.nrcpftit
                                                    ,rw_crawcrd.vllimcrd
                                                    ,rw_crawcrd.flgctitg
                                ...
                                ccrd0003.pc_insere_conta_cartao(rw_crawcrd.cdcooper
                                                               , --> cdcooper
                                                                rw_crawcrd.nrdconta
                                                               , --> nrdconta
                                                                to_number(substr(vr_des_text, 25, 13))
                                                               , --> nrcctitg
                                                                vr_cdcritic
                                                               ,vr_dscritic);
                                IF (nvl(vr_cdcritic, 0) > 0) OR (nvl(vr_dscritic, ' ') <> ' ') THEN
                                    -- LOGA NO PROC_MESSAGE
                                    btch0001.pc_gera_log_batch(pr_cdcooper     => vr_cdcooper_ori
                                                              ,pr_ind_tipo_log => 2 -- Erro tratato
                                                              ,pr_des_log      => to_char(SYSDATE
                    ...
                    IF nvl(vr_nrseqarq_max, 0) > nvl(rw_crapscb.nrseqarq, 0) THEN
                        BEGIN
                            UPDATE crapscb
                               SET dtultint = SYSDATE, nrseqarq = vr_nrseqarq_max
            ...
            FOR rw_crapcop_todas IN cr_crapcop_todas LOOP
                ...
                pc_escreve_xml(vr_xml_clobxml
                              ,'<?xml version="1.0" encoding="utf-8"?>' || chr(10) || '<crrl676>' || chr(10));
                ...
                FOR rw_craprej IN cr_craprej(pr_dtmvtolt => rw_crapdat.dtmvtolt
                    ...
                    IF vr_pa_anterior <> rw_craprej.cdagenci THEN
                        ...
                        END IF;
                        pc_escreve_xml(vr_xml_clobxml
                                      ,'<agencia cdagenci="' || rw_craprej.cdagenci || '" nmextage="' ||
                                       rw_craprej.nmextage || '">');
                        vr_pa_proximo := TRUE;
                    ...
                    -- Adiciona a linha ao XML
                    pc_escreve_xml(vr_xml_clobxml
                                  ,'<rejeitados>' || chr(10) || '<cdcooper>' || rw_craprej.cdcooper ||
                                   '</cdcooper>' || chr(10) || '<nmtitcrd>' ||
                                   nvl(TRIM(rw_craprej.nmtitcrd), ' ') || '</nmtitcrd>' || chr(10) ||
                                   '<cdpesqbb>' || TRIM(rw_craprej.cdpesqbb) || '</cdpesqbb>' || chr(10) ||
                                   '<nrdocmto>' || TRIM(gene0002.fn_mask(rw_craprej.nrdocmto, 'zz.zzz.zzz')) ||
                                   '</nrdocmto>' || chr(10) || '<nrdconta>' ||
                                   TRIM(gene0002.fn_mask(rw_craprej.nrdconta, 'zzzz.zzz.z')) || '</nrdconta>' ||
                                   chr(10) || '<nrdctitg>' || TRIM(to_char(rw_craprej.nrdctitg)) ||
                                   '</nrdctitg>' || chr(10) || '<cdtipope>' || TRIM(rw_craprej.cdtipope) || '-' ||
                                   vr_vet_nmtipsol(rw_craprej.cdtipope) || '</cdtipope>' || chr(10) ||
                                   '<cdcritic>' || TRIM(REPLACE(rw_craprej.cdcritic, ',', chr(10))) ||
                                   '</cdcritic>' || chr(10) || '</rejeitados>');
                ...
                vr_dsdirarq := vr_dsdireto || '/cecred_cartoes/crrl676_' ||
                               to_char(rw_crapdat.dtmvtolt, 'DDMMYYYY') || '.pdf';
            ...
            vr_dsdirarq := vr_dsdireto || '/cecred_cartoes/crrl707_' ||
                           to_char(rw_crapdat.dtmvtolt, 'DDMMYYYY');
    ...
    BEGIN
        DECLARE
                    ...
                    IF rw_crapprm.dsvlrprm = 'S' THEN
                        BEGIN
                            UPDATE crapprm
                             ...
                             WHERE cdcooper = pr_cdcooper
                               AND crapprm.nmsistem = 'CRED'
                               AND crapprm.cdacesso = 'FL_EXECUTADO_674' RETURN ROWID INTO vr_prmrowid;
                        EXCEPTION
                            WHEN OTHERS THEN
                                RETURN NULL;
                        END;
            ...
            BEGIN
                BEGIN
                    UPDATE crapprm SET crapprm.dsvlrprm = 'S' WHERE crapprm.rowid = pr_prmrowid;
        ...
        BEGIN
            ...
            vr_dtmvante := gene0005.fn_valida_dia_util(pr_cdcooper => pr_cdcooper
                                                      ,pr_dtmvtolt => pr_dtmvtolt - vr_qtddiapg
                                                      ,pr_tipo     => 'A');
            vr_dtmvante := gene0005.fn_valida_dia_util(pr_cdcooper => pr_cdcooper
                                                      ,pr_dtmvtolt => vr_dtmvante - 1
                                                      ,pr_tipo     => 'A');
            ...
            FOR rw_tbcrd_fatura IN cr_tbcrd_fatura(pr_cdcooper   => pr_cdcooper
                ...
                IF cr_crapass%NOTFOUND THEN
                    ...
                    btch0001.pc_gera_log_batch(pr_cdcooper     => pr_cdcooper
                                              ...
                                              ,pr_des_log      => to_char(SYSDATE, 'dd/mm/yyyy hh24:mi:ss') ||
                                                                  ' - ' || pr_cdprogra || ' --> ' || 'COOP ' ||
                                                                  rw_tbcrd_fatura.cdcooper || ' ' || 'CONTA ' ||
                                                                  rw_tbcrd_fatura.nrdconta || ' ' ||
                                                                  'IDFATURA ' || rw_tbcrd_fatura.idfatura ||
                ...
                extr0001.pc_obtem_saldo_dia(pr_cdcooper   => rw_tbcrd_fatura.cdcooper
                                           ...
                                           ,pr_tipo_busca => 'A'
                                           , --Usar data do dia anterior na crapsda
                                            pr_des_reto   => vr_des_erro
                                           ,pr_tab_sald   => vr_tab_sald
                                           ,pr_tab_erro   => vr_tab_erro);
                ...
                vr_vlsddisp := vr_tab_sald(vr_ind_sald).vlsddisp + vr_tab_sald(vr_ind_sald).vlsdchsl + vr_tab_sald(vr_ind_sald)
                               .vllimcre;
                ...
                IF rw_tbcrd_fatura.vlfatura = rw_tbcrd_fatura.vlpendente AND
                   gene0005.fn_valida_dia_util(pr_cdcooper => pr_cdcooper
                    ...
                    ELSE
                        ...
                        IF vr_vlsddisp >= vr_vlminpag /* rw_tbcrd_fatura.vlminimo_pagamento */
                           AND vr_flrepccr = 'S' THEN
                ...
                ELSE
                    ...
                    IF rw_tbcrd_fatura.dtvencimento > pr_dtmvtolt OR vr_flrepccr = 'N' THEN
                    ...
                    IF rw_tbcrd_fatura.vlpendente < vr_vlminpag AND vr_vlsddisp >= rw_tbcrd_fatura.vlpendente THEN
                        vr_vlpagmto := rw_tbcrd_fatura.vlpendente;
                    END IF;
                
                    IF vr_vlsddisp >= vr_vlminpag AND rw_tbcrd_fatura.vlpendente >= vr_vlminpag THEN
                ...
                BEGIN
                    INSERT INTO tbcrd_pagamento_fatura
                        ...
                        ,dtreferencia)
                    VALUES
                        (seq_crd_idpagamento_fatura.nextval
                        ...
                        ,vr_vlsddisp
                        ,vr_tporigem
                        ,SYSDATE) RETURN tbcrd_pagamento_fatura.idpagamento_fatura INTO vr_idpagamento_fatura;
                EXCEPTION
                    WHEN OTHERS THEN
                ...
                IF pr_cdprogra = 'CRPS674' AND vr_flultexe = 1 AND -- somente quando for a última execução do debitador  - Projeto Debitador Unico    
                ...
                IF vr_vlpagmto > 0 THEN
                    ...
                    BEGIN
                        ...
                        VALUES
                            ...
                            ,vr_vlpagmto
                            , -- Valor Total ou definido pelo logica de repique
                             rw_tbcrd_fatura.nrdconta
                            ,ct_hispgfat
                            , -- Historico
                             vr_idpagamento_fatura
                            , -- Alterado por Renato devido a erro no processo noturno 
                             rw_crawcrd.nrcrcard
                            , -- Num cartao
                             trunc(SYSDATE)
                            , -- Data referencia
                        ...
                        BEGIN
                            UPDATE tbcrd_fatura
                               SET tbcrd_fatura.vlpendente    = 0
                                  ...
                                  ,tbcrd_fatura.dtref_pagodia = decode(vr_flmuddia
                                                                      ,1
                                                                      ,vr_dtultsld
                                                                      ,tbcrd_fatura.dtref_pagodia)
                                  ,tbcrd_fatura.vlpagodia     = decode(vr_flmuddia
                                                                      ,1
                                                                      ,vr_vlsomsld
                                                                      ,tbcrd_fatura.vlpagodia + vr_vlsomsld)
                             WHERE tbcrd_fatura.idfatura = rw_tbcrd_fatura.idfatura;
                        EXCEPTION
                            WHEN OTHERS THEN
                ...
                IF nvl(vr_cdcritic, 0) > 0 OR TRIM(vr_dscritic) IS NOT NULL THEN
                    ...
                    IF vr_dscritic <> vr_dsdiautil THEN
                        ...
                        pc_controla_log_batch(pr_dstiplog => 'E'
                                             ,pr_dscritic => 'Coop: ' || vr_crapcop(i) || ' - ' || vr_dscritic);
                    END IF;
    ...
    BEGIN
        DECLARE
            ...
            CURSOR cr_tbcrd_fatura(pr_cdcooper IN crapcop.cdcooper%TYPE
                ...
                SELECT *
                  FROM (SELECT decode(fat.vlfatura
                                     ,fat.vlpendente
                                     ,'DÉBITOS NÃO EFETIVADOS'
                                     ,'DÉBITOS EFETIVADOS PARCIALMENTE') quebra
                              ,fat.rowid
                              ,fat.cdcooper
                              ,fat.nrdconta
                              ,fat.idfatura
            ...
            CURSOR cr_crawcrd(pr_cdcooper IN crapcop.cdcooper%TYPE
                ...
                SELECT crd.cdcooper
                 ...
                 ORDER BY CASE pr_inpessoa
                              WHEN 1 THEN
                               row_number() over(ORDER BY tfc.tptelefo ASC)
                              WHEN 2 THEN
                               row_number() over(ORDER BY tfc.tptelefo DESC)
                              ELSE
                               row_number() over(ORDER BY tfc.tptelefo ASC)
                          END;
            rw_crawcrd cr_crawcrd%ROWTYPE;
        ...
        BEGIN
            ...
            FOR rw_tbcrd_fatura IN cr_tbcrd_fatura(pr_cdcooper => pr_cdcooper, pr_dtmvtolt => pr_dtmvtolt) LOOP
                /*
                OPEN cr_crapass(pr_cdcooper => rw_tbcrd_fatura.cdcooper
                               ,pr_nrdconta => rw_tbcrd_fatura.nrdconta);                         
                FETCH cr_crapass INTO rw_crapass;               
                ...
                -- Adiciona a linha ao XML
                pc_escreve_xml('<rejeitados>' || chr(10) || '<quebra>' || rw_tbcrd_fatura.quebra ||
                               '</quebra>' || chr(10) || '<cdcooper>' || rw_tbcrd_fatura.cdcooper ||
                               '</cdcooper>' || chr(10) || '<cdagenci>' || TRIM(rw_tbcrd_fatura.cdagenci) ||
                               '</cdagenci>' || chr(10) || '<nrdconta>' ||
                               TRIM(gene0002.fn_mask(rw_tbcrd_fatura.nrdconta, 'zzzz.zzz.z')) ||
                               '</nrdconta>' || chr(10) || '<nrdctabb>' ||
                               TRIM(rw_tbcrd_fatura.nrconta_cartao) || '</nrdctabb>' || chr(10) ||
                               '<nrdocmto>' ||
                               TRIM(gene0002.fn_mask(rw_tbcrd_fatura.nrcontrato, 'zz.zzz.zzz')) ||
                               '</nrdocmto>' || chr(10) || '<nmprimtl>' || TRIM(rw_tbcrd_fatura.nmprimtl) ||
                               '</nmprimtl>' || chr(10) || '<vlfatura>R$ ' ||
                               TRIM(to_char(rw_tbcrd_fatura.vlfatura, '99g999g990d00')) || '</vlfatura>' ||
                               chr(10) || '<vllanaut>R$ ' ||
                               TRIM(to_char((rw_tbcrd_fatura.vlfatura - rw_tbcrd_fatura.vlpendente)
                                           ,'99g999g990d00')) || '</vllanaut>' || chr(10) || '<vlsddisp>R$ ' ||
                               TRIM(to_char(rw_tbcrd_fatura.vlsaldo_conta, '99g999g990d00')) || '</vlsddisp>' ||
                               chr(10) || '<vllimcre>R$ ' ||
                               TRIM(to_char(rw_tbcrd_fatura.vllimcre, '99g999g990d00')) || '</vllimcre>');
                ...
                IF cr_crawcrd%NOTFOUND THEN
                    pc_escreve_xml(chr(10) || '<nrtelefo>NAO CADASTRADO</nrtelefo>' || chr(10) ||
                                   '<cdadmcrd>0</cdadmcrd>' || chr(10) ||
                                   '<nmadmcrd>NAO CADASTRADO</nmadmcrd>' || chr(10) ||
                                   '<dsformpg>NAO CADASTRADO</dsformpg>');
                ELSE
            ...
            CURSOR cr_tbcrd_fatura(pr_cdcooper IN crapcop.cdcooper%TYPE
                ...
                SELECT fat.dtvencimento
                 ...
                 WHERE fat.cdcooper = pr_cdcooper
                   ...
                   AND fat.dtvencimento >= gene0005.fn_valida_dia_util(pr_cdcooper => pr_cdcooper
                                                                      ,pr_dtmvtolt => (pr_dtmvtolt - 31)
                                                                      ,pr_tipo     => 'A');
            ...
            IF vr_tab_fat_pend.count() > 0 THEN
                ...
                FOR vr_contador IN vr_tab_fat_pend.first .. vr_tab_fat_pend.last LOOP
                    ...
                    gene0007.pc_insere_tag(pr_xml      => pr_retxml
                                          ...
                                          ,pr_tag_nova => 'dtvencimento'
                                          ,pr_tag_cont => to_char(vr_tab_fat_pend(vr_contador).dtvencimento
                                                                 ,'DD/MM/RRRR')
                                          ,pr_des_erro => vr_dscritic);
                    gene0007.pc_insere_tag(pr_xml      => pr_retxml
                                          ,pr_tag_pai  => 'inf'
                                          ,pr_posicao  => vr_auxconta
                                          ,pr_tag_nova => 'dsdocumento'
                                          ,pr_tag_cont => to_char(vr_tab_fat_pend(vr_contador).dsdocumento)
                                          ,pr_des_erro => vr_dscritic);
                    gene0007.pc_insere_tag(pr_xml      => pr_retxml
                                          ,pr_tag_pai  => 'inf'
                                          ,pr_posicao  => vr_auxconta
                                          ,pr_tag_nova => 'nrconta_cartao'
                                          ,pr_tag_cont => to_char(vr_tab_fat_pend(vr_contador).nrconta_cartao)
                                          ,pr_des_erro => vr_dscritic);
                    gene0007.pc_insere_tag(pr_xml      => pr_retxml
                                          ,pr_tag_pai  => 'inf'
                                          ,pr_posicao  => vr_auxconta
                                          ,pr_tag_nova => 'vlpendente'
                                          ,pr_tag_cont => to_char(vr_tab_fat_pend(vr_contador).vlpendente)
                                          ,pr_des_erro => vr_dscritic);
                    gene0007.pc_insere_tag(pr_xml      => pr_retxml
                                          ,pr_tag_pai  => 'inf'
                                          ,pr_posicao  => vr_auxconta
                                          ,pr_tag_nova => 'rowid'
                                          ,pr_tag_cont => to_char(vr_tab_fat_pend(vr_contador).fatrowid)
                                          ,pr_des_erro => vr_dscritic);
    ...
    BEGIN
        ...
        BEGIN
            ...
            EXCEPTION
                ...
                WHEN OTHERS THEN
                    vr_dscritic := 'Erro ao inserir tbcrd_conta_cartao em CCRD0003.pc_insere_conta_cartao: ' ||
                                   SQLERRM;
                    RAISE vr_exc_saida;
            END;
