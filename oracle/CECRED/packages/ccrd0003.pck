CREATE OR REPLACE PACKAGE CECRED.CCRD0003 AS
  ...
  --  Data     : Abril - 2014.                   Ultima atualizacao: 16/02/2016
  --
...
/* Rotina com a os procedimentos para o CRPS669 */
  ...
  BEGIN
    ...
    Sigla   : CRRD
    Autor   : Lucas Lunelli
    Data    : Maio/14.                    Ultima atualizacao: 22/05/2015
    ...
    DECLARE
      ...
      BEGIN
        ...
        vr_dstraile := '9' || lpad(vr_contador,6,'0');
  ...
  BEGIN
    ...
    DECLARE
      ...
      PROCEDURE gera_linha_registro_tipo1 (rw_crawcrd  IN OUT cr_crawcrd%ROWTYPE,
                                           ...
                                           pr_flalttfc IN BOOLEAN DEFAULT FALSE) IS
