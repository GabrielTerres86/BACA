        ...
        vr_idx := lpad(rw_craplmt.hrtransa,5,'0')||lpad(rw_craplmt.progress_recid,25,'0');
         ...
         ELSIF pr_idsitmsg IN (3,4) THEN -- RECEBIDA-OK OU RECEBIDA-NOK
           ...
           IF cr_infrec_spb%FOUND THEN
              ...
              vr_TpCtRem       := substr(sspb0003.fn_busca_conteudo_campo(rr_infrec_spb.dsxml_completo,'TpCtCredtd','S'),1,2);
              vr_TpCtDst       := substr(sspb0003.fn_busca_conteudo_campo(rr_infrec_spb.dsxml_completo,'TpCtDebtd','S'),1,2);
              vr_TpPessoaRem   := substr(sspb0003.fn_busca_conteudo_campo(rr_infrec_spb.dsxml_completo,'TpPessoaCredtd','S'),1,1);
              If  vr_TpPessoaRem is null Then 
                 vr_TpPessoaRem    := substr(sspb0003.fn_busca_conteudo_campo(rr_infrec_spb.dsxml_completo,'TpPessoaDestinatario','S'),1,1);
              End If;    
              vr_TpPessoaDst       := substr(sspb0003.fn_busca_conteudo_campo(rr_infrec_spb.dsxml_completo,'TpPessoaDebtd','S'),1,1);
              If vr_TpPessoaDst is null Then 
                 vr_TpPessoaDst    := substr(sspb0003.fn_busca_conteudo_campo(rr_infrec_spb.dsxml_completo,'TpPessoaDebtd_Remet','S'),1,1);
                 If vr_TpPessoaDst is null Then 
                    vr_TpPessoaDst := substr(sspb0003.fn_busca_conteudo_campo(rr_infrec_spb.dsxml_completo,'TpPessoaRemet','S'),1,1);
                 End If;
              End If;                   
              --
