...
CREATE OR REPLACE PACKAGE BODY CECRED.cxon0014 AS
  ...
  CURSOR cr_crapagb (pr_cddbanco IN crapagb.cddbanco%TYPE) IS
    ...
    ORDER BY crapagb.progress_recid ASC;
...
---------------------------------------------------------------------------------------------------------------
  ...
  BEGIN
    ...
    BEGIN
      ...
      IF pr_cod_agencia = 0 OR pr_nro_caixa = 0 OR pr_cod_operador = '' OR pr_cod_operador IS NULL  THEN
        --Mensagem erro
    ...
    DECLARE
      ...
      CURSOR cr_crapceb (pr_cdcooper IN crapceb.cdcooper%type
        ...
        SELECT crapceb.cdcooper
              ...
              ,crapceb.nrcnvceb
              ,crapceb.nrdconta
              ,Count(1) OVER (PARTITION BY crapceb.cdcooper,crapceb.nrconven
                                         ,crapceb.nrcnvceb,crapceb.nrdconta) qtdreg
        FROM crapceb
        WHERE  crapceb.cdcooper = pr_cdcooper
        AND    crapceb.nrconven = pr_nrconven
        AND    SUBSTR(TRIM(gene0002.fn_mask(crapceb.nrcnvceb,'ZZZZ9')),1,4) = pr_nrcnvceb;
      rw_crapceb cr_crapceb%ROWTYPE;

      --Selecionar cadastro emissao bloquetos
      CURSOR cr_crapceb2 (pr_cdcooper IN crapceb.cdcooper%type
                         ,pr_nrconven IN crapceb.nrconven%type
                         ,pr_nrcnvceb IN varchar2
                         ,pr_nrdocmto IN crapcob.nrdocmto%type
        ...
        WHERE  crapceb.cdcooper = pr_cdcooper
        AND    crapceb.nrconven = pr_nrconven
        AND    SUBSTR(TRIM(gene0002.fn_mask(crapceb.nrcnvceb,'99999')),1,4) =
                      TRIM(gene0002.fn_mask(pr_nrcnvceb,'9999'))
      ...
      --Selecionar cadastro emissao bloquetos
      CURSOR cr_crapceb3 (pr_cdcooper IN crapceb.cdcooper%type
                         ,pr_nrconven IN crapceb.nrconven%type
        ...
        AND    crapceb.nrconven = pr_nrconven
        AND    crapceb.nrdconta = pr_nrdconta;
      rw_crapceb3 cr_crapceb3%ROWTYPE;
...
---------------------------------------------------------------------------------------------------------------
  ...
  BEGIN
    DECLARE
      ...
      --Selecionar informacoes emissoes de bloqueto
      CURSOR cr_crapceb (pr_cdcooper IN crapceb.cdcooper%type
                        ,pr_nrconven IN crapceb.nrconven%type
  ...
  BEGIN
    DECLARE
      ...
      CURSOR cr_crapcob1 (pr_rowid IN ROWID) IS
        ...
        FROM crapcob
        WHERE crapcob.ROWID = pr_rowid;
      rw_crapcob1 cr_crapcob1%ROWTYPE;
