CREATE OR REPLACE PACKAGE CECRED.WEBS0003 IS
  ...
  PROCEDURE pc_grava_acionamento(pr_cdcooper              IN tbgen_webservice_aciona.cdcooper%TYPE              --> Código da cooperativa
                                ...
                                ,pr_cdcliente             IN PLS_INTEGER DEFAULT 1                              --> Código do cliente
                                ...
                                ,pr_dsuriservico          IN tbgen_webservice_aciona.dsuriservico%TYPE          --> URI usada
																,pr_dsmetodo              IN VARCHAR2 DEFAULT 'POST'                            --> Método (post, put, delete, get)
                                ...
                                ,pr_flgreenvia            IN tbgen_webservice_aciona.flgreenvia%TYPE DEFAULT 0   --> Flag reenvio (0-Não, 1-Sim)
                                ,pr_nrreenvio             IN tbgen_webservice_aciona.nrreenvio%TYPE DEFAULT 0    --> Número de reenvios
																,pr_tpconteudo            IN tbgen_webservice_aciona.tpconteudo%TYPE DEFAULT 1   --> Tipo conteúdo (1-Json, 2-xml)
