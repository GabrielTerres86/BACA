    ...
    IF cr_crapenc%NOTFOUND THEN
     ...
     IF pr_idorigem = 3 THEN -- InternetBank
        ...
        ELSE
          ...
          rw_craptab.dstextab := REPLACE(rw_craptab.dstextab,'#NMPRIMTL#',rw_crapass.nmprimtl );
          rw_craptab.dstextab := REPLACE(rw_craptab.dstextab,'#NRCPFCGC#',rw_crapass.nrcpfcgc );
          rw_craptab.dstextab := REPLACE(rw_craptab.dstextab,'#CDAGENCI#',rw_crapass.cdagenci );
          rw_craptab.dstextab := REPLACE(rw_craptab.dstextab,'#NRDCONTA#',TO_CHAR(rw_crapass.nrdconta) );
          rw_craptab.dstextab := REPLACE(rw_craptab.dstextab,'#DSENDERE#',vr_dsendere );
          rw_craptab.dstextab := REPLACE(rw_craptab.dstextab,'#NMRESCOP#',rw_crapcop.nmrescop );
          rw_craptab.dstextab := REPLACE(rw_craptab.dstextab,'#NMEXTCOP#',rw_crapcop.nmextcop );
          rw_craptab.dstextab := REPLACE(rw_craptab.dstextab,'#DATA#'    ,vr_dtdehoje );
          ...
          gene0002.pc_escreve_xml(pr_xml            => pr_dsdtermo
                                 ...
                                 ,pr_texto_novo     => '<termo>' || rw_craptab.dstextab);
