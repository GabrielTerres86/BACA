...
CREATE OR REPLACE PACKAGE BODY CECRED.GRVM0001 AS
  ...
  -- ..........................................................................
    ...
    -- Código do programa
	  vr_cdprogra CONSTANT crapprg.cdprogra%TYPE := 'GRAVAM';
    ...
    BEGIN
      ...
      IF cr_crapcop%NOTFOUND THEN
        pr_des_reto := 'NOK';
        vr_cdcritic := 794;
/* substituido pelo raise vr_exec_erro
    ...
    EXCEPTION
      WHEN OTHERS THEN
        ...
        btch0001.pc_gera_log_batch(pr_cdcooper     => pr_cdcooper
                                  ...
                                  ,pr_des_log      => to_char(SYSDATE,'DD/MM/RRRR hh24:mi:ss') ||
                                                      ' - '||vr_cdprogra||' --> '|| 
                                                      'ERRO: ' || pr_dscritic ||' [gravames_gerac_arqs_bxa_cnc].');
    ...
    EXCEPTION
      WHEN OTHERS THEN
        ...
        btch0001.pc_gera_log_batch(pr_cdcooper     => pr_cdcooper
                                  ...
                                  ,pr_des_log      => to_char(SYSDATE,'DD/MM/RRRR hh24:mi:ss') ||
                                                      ' - '||vr_cdprogra||' --> '|| 
                                                      'ERRO: ' || pr_dscritic ||' [gravames_gerac_arq_inclus].');
    ...
    FOR rw_crapgrv_sem_retorno IN cr_crapgrv_sem_retorno(pr_cdcooper => pr_cdcoptel
      ...
      IF cr_crapbpr%NOTFOUND THEN
        ...
        btch0001.pc_gera_log_batch(pr_cdcooper     => vr_cdcooper
                                  ...
                                  ,pr_des_log      => to_char(SYSDATE,'DD/MM/RRRR hh24:mi:ss') ||
                                                    ' - '||vr_cdprogra||' --> '|| 
                                                    'ERRO: GRAVAM - ERRO: 0 - Erro na localizacao do Bem [' || 
