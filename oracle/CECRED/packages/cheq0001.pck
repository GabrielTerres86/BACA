...
CREATE OR REPLACE PACKAGE BODY cecred.CHEQ0001 AS
  ...
  --  Sigla    : GENE
  --  Autor    : Marcos Ernani Martini - Supero
  --  Data     : Maio/2013.                   Ultima atualizacao: 24/08/2015
  --
  -- Dados referentes ao programa:
  --
  -- Frequencia: -----
    ...
    BEGIN
      ...
      IF pr_auxnrregist > 0 THEN
        ...
        IF pr_incheque IN (1,2,6,7) THEN
          ...
          IF cr_crapcor%FOUND AND rw_crapcor.contador = 1 THEN
            -- Busca informações de histórico
            ...
            ELSE
              ...
              ELSE
                pr_tab_cheques(vr_index)('dscordem') := pr_tab_cheques(vr_index)('dscordem') || to_char(rw_crapcor.dtvalcor, 'DD/MM/RRRR');
              END IF;
            END IF;
