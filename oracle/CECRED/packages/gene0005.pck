...
CREATE OR REPLACE PACKAGE BODY CECRED.gene0005 AS
  ...
  --  Sigla    : GENE
  --  Autor    : Marcos Ernani Martini - Supero
  --  Data     : Maio/2013.                   Ultima atualizacao: 21/10/2016
  --
  -- Dados referentes ao programa:
  --
  -- Frequencia: -----
  ...
  --                          (Adriano - SD 463762).
  --                
  --             21/10/2016 - Removi o cursor da CRAPTAB e alterei o uso do mesmo nas proc's
  --                          busca_cpmf e busca_iof aplicando o uso do fn_busca_dstextab.
  --                          (Carlos Rafael Tanholi/Rodrigo Siewerdt)
  ---------------------------------------------------------------------------------------------------------------
  ...
  BEGIN
    ...
    BEGIN
      ...
      ELSE 
        -- carregar as informacões conforme as regras da versão anterior
