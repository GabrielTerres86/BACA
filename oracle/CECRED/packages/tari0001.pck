CREATE OR REPLACE PACKAGE CECRED.TARI0001 AS
  ...
  --  Data    : Fevereiro/2013                  Ultima Atualizacao: 03/05/2016
  --
  ...
  */
  ...
  BEGIN
    ...
    BEGIN
      ...
      CLOSE cr_crapbat;
      --Selecionar as tarifas
      OPEN cr_craptar (pr_cdtarifa => rw_crapbat.cdcadast);
      --Posicionar no proximo registro
      FETCH cr_craptar INTO rw_craptar;
      --Se nao encontrar
      IF cr_craptar%NOTFOUND THEN
  ...
  ............................................................................ */
    ...
    -- Código do programa
    vr_cdprogra CONSTANT crapprg.cdprogra%TYPE := 'DEBTAR';
  ...
  PROCEDURE pc_verifica_tarifa_operacao(pr_cdcooper IN NUMBER                     --> Codigo da Cooperativa
    ...
    /* ............................................................................
     ...
     Sigla   : CRED
     Autor   : Jean Michel
     Data    : Setembro/2015                     Ultima atualizacao: 10/02/2016
  ...
  ............................................................................ */
    ...
    CURSOR cr_tbcc_operacoes_diarias(pr_tpoperacao tbcc_operacoes_diarias.tpoperacao%TYPE) IS
      SELECT
      ...
      WHERE
        ...
        AND tbc.tpoperacao = pr_tpoperacao
