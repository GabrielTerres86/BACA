...
/*..............................................................................
   ...
   Sigla   : CRED
   Autor   : Mirtes.
   Data    : Marco/2001                      Ultima atualizacao: 21/03/2016
...
---------------------------------------------------------------------------------------------------------------
  ...
  *************************************************************************************/
  ...
  /* Pesquisa na CRAPTAB */
  CURSOR cr_verifica_tab(p_coop IN INTEGER
                        ,p_nmsistem IN VARCHAR2
                        ,p_tptabela IN VARCHAR2
                        ,p_cdempres IN INTEGER
                        ,p_cdacesso IN VARCHAR2
                        ,p_tpregist IN INTEGER)IS
      SELECT tab.dstextab
        FROM craptab tab
       WHERE tab.cdcooper = p_coop
         AND tab.nmsistem = p_nmsistem
         AND tab.tptabela = p_tptabela
         AND tab.cdempres = p_cdempres
         AND tab.cdacesso = p_cdacesso
         AND tab.tpregist = p_tpregist;
           ...
           ELSE
              ...
              ELSE
                 IF pr_operacao = 3 THEN /** 3 - Consulta **/
                    OPEN cr_verifica_tab(rw_cod_coop_orig.cdcooper
                                        ,'CRED'
                                        ,'GENERI'
                                        ,0
                                        ,'EXETRUNCAGEM'
                                        ,pr_cod_agencia);
                    FETCH cr_verifica_tab INTO vr_dstextab;
                    IF cr_verifica_tab%FOUND OR vr_dstextab = 'NAO' THEN
                       pr_retorno  := 'OK';
                    ELSE
