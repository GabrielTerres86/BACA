CREATE OR REPLACE PACKAGE CECRED.CADA0003 is
  ...
  PROCEDURE pc_consulta_consultores_org(pr_cdconsultor IN tbcc_consultor.cdconsultor%TYPE --> Codigo do Consultor
  ...
  PROCEDURE pc_consulta_consultores_dst(pr_cdconsultor IN tbcc_consultor.cdconsultor%TYPE --> Codigo do Consultor
                                       ,pr_cdoperador  IN crapope.cdoperad%TYPE           --> Codigo do Operador
                                       ,pr_nmoperador  IN crapope.nmoperad%TYPE           --> Nome do Operador
                                       ,pr_xmllog      IN VARCHAR2                        --> XML com informações de LOG
                                       ,pr_cdcritic    OUT PLS_INTEGER                    --> Código da crítica
