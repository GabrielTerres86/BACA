...
/*..............................................................................
   ...
   Sigla   : CRED
   Autor   : Elton
   Data    : Outubro/2011                      Ultima atualizacao: 23/07/2013
...
CREATE OR REPLACE PACKAGE BODY CECRED.cxon0020 AS
  ...
  /*---------------------------------------------------------------------------------------------------------------
    ...
    Data     : Junho/2013.                   Ultima atualizacao: 14/03/2016
  ...
  BEGIN
    ...
    IF vr_tab_limite.exists(vr_index) = FALSE OR   -- Não encontrou
       ...
       vr_tab_limite(vr_index).iddiauti = 2   THEN -- Não é dia util
  ...
  /*---------------------------------------------------------------------------------------------------------------
      ...
      Sigla    : CRED
      Autor    : Odirlei Busana - Amcom
      Data     : Junho/2015.                   Ultima atualizacao: 01/03/2016
  ...
  ---------------------------------------------------------------------------------------------------------------*/
    ...
    CURSOR cr_craptvl (pr_cdcooper craptvl.cdcooper%TYPE,
      ...
      SELECT flgtitul,
       ...
       WHERE craptvl.cdcooper = pr_cdcooper
         ...
         AND craptvl.idopetrf = pr_nrctrlif;
    rw_craptvl cr_craptvl%ROWTYPE;
         
    -- Verificar transferencia de valores (DOC C, DOC D E TEDS)
    CURSOR cr_craptvl_f (pr_cdcooper craptvl.cdcooper%TYPE,
                         pr_dtmvtolt craptvl.dtmvtolt%TYPE,
                         pr_cdagenci craptvl.cdagenci%TYPE,
                         pr_nrdolote craptvl.nrdolote%TYPE,
                         pr_vldocmto craptvl.vldocrcb%TYPE)IS
      SELECT /*+index_asc (craptvl CRAPTVL##CRAPTVL1)*/
             craptvl.hrtransa
        FROM craptvl
       WHERE craptvl.cdcooper = pr_cdcooper
         AND craptvl.tpdoctrf = 3 /* TED SPB */
    ...
    rw_craptvl_f cr_craptvl_f%ROWTYPE;     
