...
create or replace package body cecred.SICR0001 is
    ...
    DECLARE
      ...
      SELECT darf_das.tppagamento
            ...
            ,cxon0041.fn_busca_sequencial_darf(pr_dtapurac => darf_das.dtapuracao -- Data da Apuracao
                                              ...
                                              ,pr_vlrtotal => darf_das.vlprincipal -- Valor Total [TODO] Fazer join com a LAU e buscar o vllamnto
                                              ) cdseqfat
        FROM tbpagto_agend_darf_das darf_das
       WHERE darf_das.idlancto = pr_idlancto;
      rw_agen_darf cr_agen_darf%ROWTYPE;
    ...
    BEGIN
      ...
      FOR rw_craplau IN cr_craplau ( pr_cdcooper => pr_cdcooper,
        ...
        ELSIF rw_craplau.cdtiptra = 10 THEN
          ...
          OPEN cr_agen_darf(pr_idlancto => rw_craplau.idlancto);
          FETCH cr_agen_darf INTO rw_agen_darf;
          CLOSE cr_agen_darf;
          ...
          vr_dstransa := rw_agen_darf.dsidentif_pagto; -- Cedente

          IF (rw_agen_darf.tpcaptura = 1) THEN -- Captura por linha digitável
  ...
  --                          limite definido da crapatr ou por não possuir saldo.
  ...
  BEGIN
    ...
    EXCEPTION
      ...
      WHEN OTHERS THEN
        ...
        pr_cdcritic := 0;
        pr_dscritic := 'Erro não tratado em sicr0001.pc_efetua_debito_automatico --> '|| SQLERRM;
    END;
