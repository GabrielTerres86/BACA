       ...
       -- Busca o nome resumido
        ...
        IF vr_cdcritic > 0 THEN
          ...
          IF vr_cdcritic IN (64, 447, 453, 964, 967) THEN
            ...
            EXCEPTION
              WHEN OTHERS THEN
                vr_dscritic := gene0001.fn_busca_critica(1035)||' craplau[1]: '||
                            'insitlau:3' ||
        ...
        BEGIN
          ...
          IF vr_cdcritic > 0 THEN
            ...
            IF vr_qtdexec < 3 THEN
              ...
              EXCEPTION
                WHEN OTHERS THEN
                  vr_dscritic := gene0001.fn_busca_critica(1035)||' craplau[2]: '||
            ...
            ELSIF vr_flultexe = 1 THEN
              ...
              EXCEPTION
                WHEN OTHERS THEN
                  vr_dscritic := gene0001.fn_busca_critica(1035)||' craplau[3]: '||
                              'insitlau:3' ||
                              ', dtdebito:'||pr_dtmvtolt||
                              ', cdcritic:'||NVL(vr_cdcritic, 0)||
                              ' com rowid:'||rw_craplau.rowid||
        ...
        IF rw_craplau.vllanaut >
          ...
          -- Se for a primeira tentativa do dia, apenas incluir a mensagem para o cooperado
            ...
            EXCEPTION
              WHEN OTHERS THEN
                vr_dscritic := gene0001.fn_busca_critica(1035)||' craplau[4]: '||
                            'cdcritic:717'||
                            ' com rowid:'||rw_craplau.rowid||
                            '. '||sqlerrm;
                vr_cdcritic := 1035; --atualiza aqui porque é utilizada a mesma variável para o update
          ...
          ELSIF vr_flultexe = 1 THEN
            ...
            EXCEPTION
              WHEN OTHERS THEN
                vr_dscritic := gene0001.fn_busca_critica(1035)||' craplau[5]: '||
                            'insitlau:3' ||
                            ', dtdebito:'||pr_dtmvtolt||
                            ' com rowid:'||rw_craplau.rowid||
                            '. '||sqlerrm;
        ...
        IF rw_craplau.vllanaut 
          ...
          IF vr_flultexe = 2 THEN
            ...
            EXCEPTION
              WHEN OTHERS THEN
                vr_dscritic := gene0001.fn_busca_critica(1035)||' craplau[6]: '||
                            'insitlau:3' ||
                            ', dtdebito:'||pr_dtmvtolt||
                            ' com rowid:'||rw_craplau.rowid||
                            '. '||sqlerrm;
