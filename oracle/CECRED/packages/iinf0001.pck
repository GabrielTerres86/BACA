...
-------------------Cursores-------------------------------------
  ...
  ORDER BY crapifc.cdprogra;
    ...
    -- cadastro de informativo, Condiçao para Rodar Periodico
    ...
    BEGIN
      ...
      FOR rw_crapifc IN cr_crapifc LOOP
        ...
        IF cr_craptab%FOUND THEN
          ...
          pr_tab_cadinf(vr_index).dsfenvio := substr(rw_craptab.dstextab,instr(rw_craptab.dstextab,',')+1);
        ...
        IF cr_craptab%FOUND THEN
          ...
          pr_tab_cadinf(vr_index).dsperiod := rw_craptab.dstextab;
    ...
    BEGIN
      ...
      FOR rw_gnfepri IN cr_gnfepri LOOP
        ...
        IF cr_craptab%FOUND THEN
          ...
          pr_tab_informa(vr_index).dsfenvio := substr(rw_craptab.dstextab,instr(rw_craptab.dstextab,',')+1);
        ...
        IF cr_craptab%FOUND THEN
          ...
          pr_tab_informa(vr_index).dsperiod := rw_craptab.dstextab;
