create or replace package cecred.PAGA0004 is
...
..............................................................................*/
  ...
  PROCEDURE pc_ret_val_fatura_estorno 
  ...
  PROCEDURE pc_estorna_convenio ( pr_cdcooper  IN crapcop.cdcooper%TYPE   --> Codigo da cooperativa
  ...
  PROCEDURE pc_estorna_titulo ( pr_cdcooper  IN crapcop.cdcooper%TYPE   --> Codigo da cooperativa
...
/
create or replace package body cecred.PAGA0004 is
  ...
  BEGIN
    ...
    --> Procedimento para retornar/validar valores para estorno
    pc_ret_val_fatura_estorno ( pr_cdcooper => rw_crapcop.cdcooper    --> Codigo da cooperativa
    ...
    ELSIF rw_craplft.tpfatura = 2 AND 
      ...
      pc_ret_val_darf_estorno ( pr_cdcooper     => rw_crapcop.cdcooper   --> Codigo da cooperativa
                               ,pr_cdoperad     => 996                   --> Codigo do operador
                               ,pr_cdagenci     => vr_cdagenci           --> Codigo Agencia
                               ,pr_nrdcaixa     => 900                   --> Numero Caixa                                 
    ...
    rw_craplot := NULL;
    LOTE0001.pc_insere_lote(pr_cdcooper => rw_crapaut_sequen.cdcooper
    ...
    BEGIN
      UPDATE craplot
         SET craplot.qtcompln = nvl(craplot.qtcompln,0) + 1,
             ...
             --> CREDITO 
             craplot.vlcompcr = nvl(craplot.vlcompcr,0) + rw_crapaut_sequen.vldocmto,
             craplot.vlinfocr = nvl(craplot.vlinfocr,0) + rw_crapaut_sequen.vldocmto
