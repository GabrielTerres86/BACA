CREATE OR REPLACE PACKAGE CECRED.INSS0001 AS
  ...
  /*---------------------------------------------------------------------------------------------------------------
   ...
   Autor   : Andre - DB1
   Data    : 16/05/2011                        Ultima atualizacao: 07/10/2015
...
/* Procedure para Solicitar Alteracao Cadastral do beneficiario Modo WEB */
  ...
  FUNCTION fn_senha_sicredi RETURN VARCHAR2;
	...
	PROCEDURE pc_popula_dcb_inss(pr_nrodojob IN NUMBER);
...
create or replace package body cecred.INSS0001 as
  ...
  /*---------------------------------------------------------------------------------------------------------------
   ...
   Data    : 27/08/2013                        Ultima atualizacao: 10/03/2016
  ...
  BEGIN
    ...
    IF UPPER(pr_cdprogra) = 'PRPREV' THEN
      ...
      btch0001.pc_gera_log_batch(pr_cdcooper     => pr_cdcooper,
                                 ...
                                 pr_des_log      => to_char(pr_dtdehoje,'DD/MM/RRRR')||' '||
  ...
  ---------------------------------------------------------------------------------------------------------------*/
    ...
    BEGIN
      ...
      --Diretorio Salvar
      vr_nmdireto_salvar:= pr_pathcoop||'/salvar';
  ...
  /*---------------------------------------------------------------------------------------------------------------
      ...
      Sigla    : CRED
      Autor    : Alisson C. Berrido - Amcom
      Data     : Agosto/2014                           Ultima atualizacao: 09/03/2016 
  ...
  ---------------------------------------------------------------------------------------------------------------*/
    ...
    BEGIN
      ...
      vr_nmdireto_salvar:= vr_nmdireto||'/salvar';
  ...
  Sigla    : CRED
  Autor    : Alisson C. Berrido - Amcom
  Data     : Agosto/2014                           Ultima atualizacao: 15/10/2015
  ...
  BEGIN
    ...
    FOR rw_crapdat_cooper IN cr_crapdat_cooper LOOP
      ...
      vr_tab_salvar(rw_crapdat_cooper.cdcooper):= vr_tab_dircoop(rw_crapdat_cooper.cdcooper)||'/salvar';
  ...
  /*--------------------------------------------------------------------------------------------------------------
    ...
    Sigla    : CRED
    Autor    : Alisson C. Berrido - AMcom
    Data     : Fevereiro/2015                           Ultima atualizacao: 16/06/2015
  ...
  /*---------------------------------------------------------------------------------------------------------------
    ...
    Sigla    : CRED
    Autor    : Alisson C. Berrido - AMcom
    Data     : Fevereiro/2015                           Ultima atualizacao: 10/02/2016
  ...
  /*---------------------------------------------------------------------------------------------------------------
    ...
    Sigla    : CRED
    Autor    : Alisson C. Berrido - AMcom
    Data     : Fevereiro/2015                           Ultima atualizacao: 23/09/2015
  ...
  /*---------------------------------------------------------------------------------------------------------------
    ...
    Sigla    : CRED
    Autor    : Alisson C. Berrido - AMcom
    Data     : Fevereiro/2015                           Ultima atualizacao: 22/09/2015
  ...
  /*---------------------------------------------------------------------------------------------------------------
    ...
    Sigla    : CRED
    Autor    : Alisson C. Berrido - AMcom
    Data     : Marco/2015                           Ultima atualizacao: 23/09/2015
  ...
  /*---------------------------------------------------------------------------------------------------------------
    ...
    Sigla    : CRED
    Autor    : Alisson C. Berrido - AMcom
    Data     : Fevereiro/2015                           Ultima atualizacao: 15/10/2015
  ...
  Sigla    : CRED
  Autor    : Douglas Quisinski
  Data     : Setembro/2015                         Ultima atualizacao: 10/03/2016
  ...
  .............................................................................*/  
  BEGIN
    RETURN gene0001.fn_param_sistema('CRED',0,'SENHA_SICREDI');
  EXCEPTION
    WHEN OTHERS THEN
      RETURN(NULL);  
