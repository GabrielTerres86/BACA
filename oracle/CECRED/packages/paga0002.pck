 ...
 SELECT MAX(c.hriniexe) hriniexe
      ...
      IF pr_flgtrans = 1 THEN
        ...
        GENE0001.pc_gera_log_item
                        ...
                        ,pr_dsdadatu => (CASE
                                          ...
                                          WHEN pr_cdtiptra = 22 THEN 'TED JUDICIAL' --R39
  ...
  BEGIN
    ...
    ELSE
      ...
      IF pr_cdtiptra = 22 THEN --R39 TED JUDICIAL
    ...
    /* Efetuada por operador ou responsável de assinatura conjunta de conta PJ */
      ...
      -- TED
      IF pr_cdtiptra IN (4,22) THEN --R39
    ...
    ELSIF vr_idagenda = 1 THEN /** Transferencia no dia corrente **/
      ...
      IF nvl(vr_cdcritic,0) = 0 AND
        ...
        ELSIF pr_cdtiptra IN (1,5,22) THEN --R39
    ...
    ELSIF vr_idagenda = 3  THEN /** Agendamento recorrente **/
      ...
      IF TRIM(vr_dscritic) IS NULL THEN
          vr_dscritic := (CASE
                         WHEN pr_cdtiptra IN (4,22) THEN 'Transferencia agendada'  --R39
                           WHEN pr_cdtiptra IN (1,5) THEN 'Transferencia agendada'
                           ELSE ' Credito de salario agendado'
                          END)||
                         ' com sucesso.';
