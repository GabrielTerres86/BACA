...
/* Rotina que busca as informacoes de IR parametrizadas para aplicacoes RDCA */
  ...
  BEGIN
    /* .............................................................................
     ...
     Autor   : Marcos.
     Data    : 10/01/2012                     Ultima atualizacao:
  ...
  BEGIN
    /* .............................................................................
     ...
     Autor   : Marcos.
     Data    : 04/02/2013                     Ultima atualizacao: 28/08/2014
  ...
  /* .............................................................................
     ...
     Sigla   : CRED
     Autor   : Marcos (Supero)
     Data    : Fevereiro/13.                    Ultima atualizacao: 21/05/2013
  ...
  /* .............................................................................
     ...
     Sigla   : CRED
     Autor   : Marcos (Supero)
     Data    : Fevereiro/13.                    Ultima atualizacao: 30/11/2015
  ...
  BEGIN
    /* .............................................................................
       ...
       Sigla   : CRED
       Autor   : Deborah/Edson
       Data    : Junho/94.                       Ultima atualizacao: 06/11/2013
...
................................................................................................... */
      ...
      open cr_craptrd (pr_cdcooper => pr_cdcooper,
        ...
        if cr_craptrd%notfound then
          ...
          vr_des_erro := gene0001.fn_busca_critica(347)||
                         ...
                         ' Faixa: '||to_char(vr_vlsdrdpp, '999g999g990d99-');
          raise vr_exc_erro;
        end if;
      close cr_craptrd;
      if rw_craptrd.txofidia > 0 then
  ...
  PROCEDURE pc_consulta_aplicacoes(pr_cdcooper    IN crapcop.cdcooper%TYPE,     --> Cooperativa
    ...
    /*..........................................................................
      ...
      Programa : pc_consulta_aplicacoes (antiga b1wgen0004.consulta_aplicacoes)
       ...
       Sigla   : CRED
       Autor   : Andrino (RKAM)
       Data    : Abril/2014                          Ultima Atualizacao: 01/04/2015
    ...
    -- Temp-Table sobre as aplicacoes bloqueadas da conta
    ...
    -- Cursor para verificar se a situacao da aplicacao esta bloqueada
    CURSOR cr_craptab_2 IS
      SELECT to_number(SUBSTR(craptab.dstextab,1,7)) nraplica
        FROM craptab
       WHERE craptab.cdcooper = pr_cdcooper
         AND UPPER(craptab.nmsistem) = 'CRED'
         AND UPPER(craptab.tptabela) = 'BLQRGT'
         AND craptab.cdempres = 0
         AND UPPER(craptab.cdacesso) = to_char(pr_nrdconta,'fm0000000000');
    rw_craptab_2 cr_craptab_2%ROWTYPE;
  ...
  BEGIN
    ...
    FOR rw_craptab_2 IN cr_craptab_2 LOOP
      vr_tab_craptab(rw_craptab_2.nraplica).nraplica := rw_craptab_2.nraplica;
    END LOOP;
    ...
    FOR rw_craprda IN cr_craprda LOOP
      ...
      IF vr_tab_craptab.exists(rw_craprda.nraplica) THEN
