...
CREATE OR REPLACE PACKAGE BODY CECRED.FORM0001 AS
    ...
    BEGIN
      ...
      ELSE
        ...
        IF cr_craptab%FOUND THEN
          ...
          vr_tab_dsmsgext(1) := SUBSTR(rw_craptab.dstextab,001,50);
          vr_tab_dsmsgext(2) := SUBSTR(rw_craptab.dstextab,051,50);
          vr_tab_dsmsgext(3) := SUBSTR(rw_craptab.dstextab,101,50);
          vr_tab_dsmsgext(4) := SUBSTR(rw_craptab.dstextab,151,50);
          vr_tab_dsmsgext(5) := SUBSTR(rw_craptab.dstextab,201,50);
          vr_tab_dsmsgext(6) := SUBSTR(rw_craptab.dstextab,251,50);
          vr_tab_dsmsgext(7) := SUBSTR(rw_craptab.dstextab,301,50);
        ELSE
  ...
  PROCEDURE pc_gera_dados_inform_1(pr_cdcooper    IN crapcop.cdcooper%TYPE
    ...
    -- CURSORES
    -- Buscar dados genericos para o relatorio
