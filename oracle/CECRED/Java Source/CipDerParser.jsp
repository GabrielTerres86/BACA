create or replace and compile java source named CECRED."CipDerParser" as
...
public class CipDerParser {
   ...
   */
  public CipDerParser(InputStream in) throws IOException {
    this.in = in;
  }
   ...
   * @throws IOException 
   */
  public CipDerParser(byte[] bytes) throws IOException {
   ...
   * @throws IOException
   */
  public CipAsn1Object read() throws IOException {
    int tag = in.read();
    ...
    CipAsn1Object o = new CipAsn1Object(tag, length, value);
