...
rw_crapdat.dtultdia := to_date('310318','ddmmrr');    
rw_crapdat.dtmvtopr := to_date('020418','ddmmrr'); 
   
/*
rw_crapdat.dtmvtolt := to_date('300418','ddmmrr');
rw_crapdat.dtultdia := to_date('300418','ddmmrr');    
