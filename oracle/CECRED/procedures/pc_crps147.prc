...
/* ..........................................................................
   ...
   Sigla   : CRED
   Autor   : Deborah/Edson
   Data    : Abril/96.                       Ultima atualizacao: 23/03/2015
...
............................................................................. */
  ...
  BEGIN
    ...
    FOR vr_craprpp IN cr_craprppp(pr_cdcooper) LOOP
      vr_tab_craprpp(lpad(vr_craprpp.nrdconta, 10, '0') || lpad(vr_craprpp.nrctrrpp, 10, '0')).nrdconta := vr_craprpp.nrdconta;
      vr_tab_craprpp(lpad(vr_craprpp.nrdconta, 10, '0') || lpad(vr_craprpp.nrctrrpp, 10, '0')).nrctrrpp := vr_craprpp.nrctrrpp;
      vr_tab_craprpp(lpad(vr_craprpp.nrdconta, 10, '0') || lpad(vr_craprpp.nrctrrpp, 10, '0')).flgctain := vr_craprpp.flgctain;
    END LOOP;
    ...
    FOR vr_craplpp IN cr_craplpp(pr_cdcooper, vr_dtinimes, vr_dtfimmes) LOOP
      -- Verifica se encontrou registro
      IF NOT vr_tab_craprpp.exists(lpad(vr_craplpp.nrdconta, 10, '0') || lpad(vr_craplpp.nrctrrpp, 10, '0')) THEN
        vr_cdcritic := 0;
        vr_dscritic := 'Não encontrou registros em VR_TAB_CRAPRPP!';
        RAISE vr_exc_erro;
      END IF;

      -- Valida se será computado aplicações novas ou antigas
      IF vr_tab_craprpp(lpad(vr_craplpp.nrdconta, 10, '0') || lpad(vr_craplpp.nrctrrpp, 10, '0')).flgctain = 1 THEN
