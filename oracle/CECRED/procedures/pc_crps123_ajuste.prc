CREATE OR REPLACE PROCEDURE CECRED.pc_crps123_ajuste(pr_cdcooper IN crapcop.cdcooper%TYPE  --> Cooperativa solicitada
...
BEGIN
  ...
  BEGIN
    ...
    rw_crapdat.dtmvtolt := to_date('23/01/2018','DD/MM/YYYY');
    rw_crapdat.dtmvtopr := to_date('24/01/2018','DD/MM/YYYY');
