CREATE OR REPLACE PROCEDURE CECRED.pc_crps720(pr_cdcooper  IN crapcop.cdcooper%TYPE     --> Codigo Cooperativa
...
BEGIN
  ...
  BEGIN
    ...
    vr_qtdjobs := NVL(GENE0001.fn_param_sistema('CRED',pr_cdcooper,'QTD_PARALE_CRPS720'),10);
    ...
    FOR rw_epr_pep IN cr_epr_pep(pr_cdcooper => pr_cdcooper
      ...
      vr_jobname := 'crps720_' || rw_epr_pep.cdagenci || '$';
