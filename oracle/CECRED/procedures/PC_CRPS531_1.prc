  ...
  BEGIN
   ...
   END IF;
        ...
        IF vr_aux_CodMsg = 'STR0026R2' THEN
          ...
          /*Somente se a cobrança não for da COBTIT iremos realizar o armazenamento dos titulos para efetuar a baixa
            Caso contrário, irá efetuar a baixa no processo de baixa da COBTIT*/
          IF NOT dsct0003.fn_cobranca_cobtit(pr_cdcooper => pr_cdcooper
