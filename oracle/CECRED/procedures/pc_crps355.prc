CREATE OR REPLACE PROCEDURE CECRED.
         pc_crps355 (pr_cdcooper IN crapcop.cdcooper%TYPE   --> Cooperativa solicitada
  ...
  BEGIN
   ...
   Programa: pc_crps355 (Fontes/crps355.p)
   ...
   Objetivo  : Atende a solicitacao 13.
               Ordem na Solicitacao = 20
               Gerar arquivo para microfilmagem razao deposito a vista.
...
..............................................................................*/
    ...
    DECLARE
      ...
      -- Código do programa
      vr_cdprogra CONSTANT crapprg.cdprogra%TYPE := 'CRPS355';
    ...
    BEGIN
      ...
      vr_nmarquiv := vr_nom_direto ||
                     '/microfilmagem/cradrcc' || vr_sufixarq;
      ...
      cobr0002.pc_gera_razao(pr_cdcooper => pr_cdcooper,
                             ...
                             pr_nmestrut => 'craplcm',
                             pr_nmcampocta => 'nrdctabb',
                             pr_nmestrut_aux => 'craplcm',
