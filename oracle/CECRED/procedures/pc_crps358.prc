CREATE OR REPLACE PROCEDURE CECRED.
         pc_crps358 (pr_cdcooper IN crapcop.cdcooper%TYPE   --> Cooperativa solicitada
  ...
  BEGIN
   ...
   Programa: pc_crps358 (Fontes/crps358.p)
   ...
   Objetivo  : Atende a solicitacao 13.
               Ordem na Solicitacao = 23
               Gerar arquivo para microfilmagem "Razao de Aplicacoes".
...
..............................................................................*/
    ...
    DECLARE
      ...
      -- Código do programa
      vr_cdprogra CONSTANT crapprg.cdprogra%TYPE := 'CRPS358';
    ...
    BEGIN
      ...
      vr_nmarquiv := vr_nom_direto ||
                     '/microfilmagem/cradrap' || vr_sufixarq;
