CREATE OR REPLACE PROCEDURE CECRED.PC_CRPS531(pr_cdcooper  IN crapcop.cdcooper%TYPE
  ...
  /* ..........................................................................
    ...
    BEGIN
      ...
      gene0001.pc_lista_arquivos (pr_path     => vr_dsdircop || '/log'
      ...
      IF vr_splisarq.count() > 0 THEN 
        FOR idx IN 1..vr_splisarq.count() LOOP     
          BEGIN
            vr_dtarqlog := TO_DATE(SUBSTR(vr_splisarq(idx),9,8),'ddmmrrrr');
            ...
            IF vr_dtarqlog < rw_crapdat.dtmvtolt THEN 
              ...
              gene0001.pc_OScommand_Shell(pr_des_comando => 'mv '||vr_dsdircop||'/log/'||vr_splisarq(idx) ||' '||vr_dsdircop||'/salvar');
            END IF;
          EXCEPTION
            WHEN OTHERS THEN
      ...
      IF vr_splisarq.count() > 0 THEN 
        ...
        FOR idx IN 1..vr_splisarq.count() LOOP  
          ...
          vr_dsplsql := 'DECLARE'||chr(13)
                     ...
                     || 'BEGIN'||chr(13)
                     || '  pc_crps531_1('||pr_cdcooper||','||vr_idparale||','||idx||','''||vr_dsdircop || '/integra/' || vr_splisarq(idx)||''',vr_cdcritic,vr_dscritic);'||chr(13)
                     || 'END;';
          ...
          btch0001.pc_gera_log_batch(pr_cdcooper     => pr_cdcooper
                                    ...
                                    ,pr_des_log      => to_char(sysdate,'dd/mm/rrrr') || ' - ' 
                                                     ...
                                                     || ' Mensagem: ' || vr_dsdircop || '/integra/' || vr_splisarq(idx) 
