CREATE OR REPLACE PROCEDURE CECRED.pc_crps388(pr_cdcooper IN crapcop.cdcooper%TYPE   --> Cooperativa solicitada
...
/* 
  ...
  Alteracoes: 29/06/2004 - Tratamento de erros nos relatorios (Ze Eduardo).
			  ...
			  03/04/2019 - Ajuste realizado para corrigir problema de merge da liberação anterior. (Kelvin)
