CREATE OR REPLACE PROCEDURE CECRED.PC_CRPS543 (pr_cdcooper  IN crapcop.cdcooper%TYPE
...
/* .............................................................................
   ...
   Programa: PC_CRPS543                         Antigo: Fontes/crps543.p
   ...
   Objetivo  : Integrar arquivos FAC - CECRED
...
............................................................................. */
  ...
  vr_cdprogra crapprg.cdprogra%TYPE := 'CRPS543';  -- Codigo do presente programa
  vr_nmarqlog         VARCHAR2(100);               -- Nome de arquivo de log
  vr_nmarquiv         VARCHAR2(100);               -- Arquivos do FAC
  ...
  vr_exc_fimprg       EXCEPTION;                   -- Tratamento de excecao sem parar a cadeias
  ...
  PROCEDURE mostrar_no_log (pr_cdcooper  IN crapcop.cdcooper%TYPE
    ...
    BEGIN
      ...
      IF  pr_nmdatela = 'PRCCTL'  THEN
        vr_dsinforma := vr_dsinforma || 'Coop:' || to_char(pr_cdcooper,'fm00') || ' - Processar: FAC - ';
      END IF;
...
BEGIN
  ...
  IF vr_typ_saida = 'ERR' THEN
    vr_dscritic := 'Erro na leitura dos arquivos FAC.';
    RAISE vr_exc_saida;
  END IF;
  ...
  FOR vr_pos IN 1..vr_vet_arquivos.COUNT LOOP
    ...
    IF  utl_file.IS_OPEN(vr_input_file) THEN
      ...
      BEGIN
        ...
        LOOP
          ...
          IF  vr_conta_linha = 1  THEN
            ...
            IF  substr(vr_setlinha,2,6) != 'FAC640'  THEN     -- Se arquivo nao for FAC640, critica
              vr_cdcritic := 173;
            ELSIF
        ...
        ELSE
          mostrar_no_log (pr_cdcooper  => pr_cdcooper
                         ,pr_nmarqlog  => vr_nmarqlog
                         ,pr_dsinforma => 'Arquivo FAC integrado com sucesso!'
                         ,pr_cdcritic  => vr_cdcritic
                         ,pr_dscritic  => vr_dscritic);
        END IF;

      -- Tratamento de erro para a importacao dos arquivos FAC
      EXCEPTION
      ...
      END; -- Fim da leitura do arquivo do FAC
