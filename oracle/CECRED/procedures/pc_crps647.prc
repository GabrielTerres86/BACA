CREATE OR REPLACE PROCEDURE CECRED.pc_crps647 (pr_cdcooper IN crapcop.cdcooper%TYPE   --> Cooperativa solicitada
    ...
    /* .............................................................................
      ...
      Sigla   : CRED
      Autora  : Lucas R.
      Data    : Setembro/2013                        Ultima atualizacao: 20/05/2016
          ...
          IF vr_tpregist = 'E' THEN
            ...
            IF  to_number(SUBSTR(vr_setlinha,158,1)) = 0 THEN
              ...
              IF rw_crapatr.flgmaxdb = 1 AND 
                 (vr_vllanaut / 100) > rw_crapatr.vlrmaxdb THEN
                ...
                SICR0001.pc_notif_cooperado_DEBAUT
                                      ( pr_cdcritic  => vr_cdcritic
                                       ...
                                       ,pr_cdprogra  => vr_cdprogra
                                       ,pr_nrdconta  => vr_nrdconta
                                       ,pr_nrdocmto  => vr_cdrefere --nrdocmto
                                       ,pr_nmconven  => vr_nmempres
                                       ,pr_dtmvtopg  => vr_dtmvtolt
                                       ,pr_vllanaut  => (vr_vllanaut / 100)
