CREATE OR REPLACE PROCEDURE CECRED.pc_crps120 (pr_cdcooper  IN crapcop.cdcooper%TYPE  --> Cooperativa solicitada
  ...
  BEGIN
    /* .............................................................................
       ...
       Sigla   : CRED
       Autor   : Deborah/Edson
       Data    : Junho/95.                     Ultima atualizacao: 28/07/2015
          ...
          BEGIN
            ...
            INSERT INTO craptab
                 ...
                 VALUES('CRED'             -- nmsistem
                       ...
                       ,0                  -- tpregist
                       ,pr_cdcooper        -- cdcooper
                       ,to_char(vr_dtrefere,'DD/MM/RRRR') ||' '||to_char(vr_dtintegr + 1,'DD/MM/RRRR')||' 0' ); -- dstextab
          EXCEPTION
            WHEN DUP_VAL_ON_INDEX THEN
              ...
              BEGIN
                UPDATE craptab
                   SET craptab.dstextab = to_char(vr_dtrefere,'DD/MM/RRRR') ||' '||
                                          to_char(vr_dtintegr + 1,'DD/MM/RRRR')||' 0'
                 WHERE craptab.cdcooper        = pr_cdcooper
                   AND upper(craptab.nmsistem) = 'CRED'
