CREATE OR REPLACE PROCEDURE CECRED."PC_CRPS669" ( pr_cdcooper IN crapcop.cdcooper%TYPE   --> Cooperativa solicitada
...
/* ..........................................................................
       ...
       Objetivo  : Atende a solicitacao ??. Rodado via CRON ou Manualmente (tela ARQBCB).
                   Criar o arquivo de Saldo Disp. dos Associados (Bancoob/CABAL).
    ...
    ............................................................................ */		                                                                             
      ...
      FETCH cr_crapcop INTO rw_crapcop;
 		  ...
 		  vr_xml_def := '<?xml version="1.0" encoding="ISO-8859-1" ?><Root> <Dados> </Dados><params><nmprogra>ARQBCB</nmprogra>' || 
										'<nmeacao>CRPS669</nmeacao><cdcooper>3</cdcooper><cdagenci>0</cdagenci><nrdcaixa>0</nrdcaixa><idorigem>1</idorigem>' ||
										'<cdoperad>' || pr_cdoperad || '</cdoperad></params></Root>';				
										
      vr_xml := XMLType.createXML(vr_xml_def);									
																						
			CCRD0003.pc_crps669(pr_xmllog   => ''
												 ,pr_cdcritic => vr_cdcritic
