CREATE OR REPLACE PROCEDURE CECRED.pc_crps778 (pr_dscritic OUT VARCHAR2) IS           --> Descricao da critica
  ...
  /* ............................................................................
     ...
     Data    : Julho/2016                         Ultima atualizacao: 27/03/2017
     ...
     Alteracao : 22/07/2016 - Criação do fonte crps778 (Odirlei-AMcom)             
                 ...
                 27/03/2017 - Alterado o nome do job para jbcobran_integracao_ftp e correção do início, fim e demais
                              mensagens do programa (Carlos)
  ...
  ------------------------------- CURSORES ---------------------------------
    ...
    vr_nomdojob  CONSTANT VARCHAR2(26) := 'jbcobran_integracao_ftp';
    ...
    BEGIN
      ...
      vr_dscdolog := to_char(SYSDATE,'DD/MM/RRRR HH24:MI:SS')||' - '||vr_nomdojob ||' -> '||pr_dscdolog;
