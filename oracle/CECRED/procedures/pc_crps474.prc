...
BEGIN
  ...
  Sigla   : CRED
  Autor   : Gabriel
  Data    : Fevereiro/2012.                    Ultima atualizacao: 03/02/2016
    ...
    --Selecionar Parcelas emprestimo
       CURSOR cr_crappep (pr_cdcooper  IN crappep.cdcooper%TYPE
         ...
         SELECT crappep.cdcooper
               ...
               ,crappep.inliquid
               ,crappep.rowid
         FROM   crapass, crappep
         WHERE crapass.cdagenci = decode(pr_cdagenci,0,crapass.cdagenci,pr_cdagenci)
         ...
         ORDER BY crappep.cdcooper,crappep.nrdconta,crappep.nrctremp,crappep.nrparepr;
