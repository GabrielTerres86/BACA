CREATE OR REPLACE PROCEDURE CECRED.pc_crps150(pr_cdcooper IN crapcop.cdcooper%TYPE  --> Coop conectada
  ...
  /* ............................................................................
   ...
   Sigla   : CRED
   Autor   : Edson/Odair
   Data    : Marco/96.                       Ultima atualizacao: 01/08/2016
   ...
   Alteracoes: 21/05/96 - Alterado para tratar conta conjunta (ate 2 taloes
			   ...
			   01/08/2016 - Nao validar parametro de isencao da cooperativa quando
                            cooperado possuir pacote de tarifas (Diego).			   
  ............................................................................. */
    ...
    FOR rw_crapreq IN cr_crapreq(pr_cdcooper => pr_cdcooper,
      ...
      END IF;
          ...
          CONTINUE;         
			...
			-- Tem pacote e excedeu limite de operacoes do pacote 
			IF vr_fliseope <> 1 AND vr_qtacobra > 0 THEN
			   -- Cobra qtd.operacoes excedentes e nao valida mais o parametro de isencao da cooperativa 
