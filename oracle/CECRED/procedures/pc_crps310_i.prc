CREATE OR REPLACE PROCEDURE CECRED.PC_CRPS310_I(pr_cdcooper   IN crapcop.cdcooper%TYPE       --> Coop. conectada
  ...
  /* ............................................................................
     ...
     Data    : Maio/2001                       Ultima atualizacao: 24/04/2019
     ...
     Alteracoes: 06/10/2008 - Adaptacao para Desconto de Titulos (David).
                 ...
                 23/04/2019 - P437 - consignado - Para o consignado será considerado o valor do Juros+60 calculado pela FIS Brasil
  ............................................................................ */
  ...
  END; -- Fim procedure pc_calcula_risco_refin
      ...
      PROCEDURE pc_lista_emp_prefix(pr_rw_crapass IN cr_crapass%ROWTYPE
        ...
        vr_tpmodcon         number;                --> tipo modo de consignado
...
--           ORDER BY dtvencto;
        ...
        CURSOR cr_consig IS
        SELECT epr.vljura60
            FROM tbepr_consignado epr
           WHERE epr.cdcooper = pr_cdcooper
             AND epr.nrdconta = pr_rw_crapepr.nrdconta
             AND epr.nrctremp = pr_rw_crapepr.nrctremp;
