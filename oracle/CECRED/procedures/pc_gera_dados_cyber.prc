...
/* .............................................................................
    ...
    Alteracoes: 14/11/2017 - Log de trace da exception others e retorno de crítica para
                ...
                23/07/2018 - Projeto Revitalização Sistemas - Andreatta (MOUTs)    
  ...
  BEGIN     
    ...
    IF gene0005.fn_valida_dia_util(pr_cdcooper => vr_cdcooper
      ...
      -- Garantir que o programa execute fora do processo e em data util, reprogramando se necessário
      ...
      IF trim(vr_dscritic) IS NULL THEN
        ...
        IF NVL(vr_cdcritic,0) <> 0 OR vr_dscritic IS NOT NULL THEN
          ...
          vr_destinatario := gene0001.fn_param_sistema('CRED',vr_cdcooper,'CYBER_RESPONSAVEL');
          ...
          cecred.pc_log_programa(
             ...
             ,pr_destinatario_email => vr_destinatario
