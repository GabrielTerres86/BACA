CREATE OR REPLACE PROCEDURE CECRED.
         pc_crps357 (pr_cdcooper IN crapcop.cdcooper%TYPE   --> Cooperativa solicitada
  ...
  BEGIN
   ...
   Programa: pc_crps357 (Fontes/crps357.p)
   ...
   Objetivo  : Atende a solicitacao 13.
               Ordem na Solicitacao = 22
               Gerar arquivo para microfilmagem ralatorio razao de emprestimo.
...
..............................................................................*/
    ...
    DECLARE
      ...
      -- Código do programa
      vr_cdprogra CONSTANT crapprg.cdprogra%TYPE := 'CRPS357';
    ...
    BEGIN
      ...
      vr_nmarquiv := vr_nom_direto ||
                     '/microfilmagem/cradrep' || vr_sufixarq;
