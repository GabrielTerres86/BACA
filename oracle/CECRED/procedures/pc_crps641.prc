...
BEGIN
  /* ..........................................................................
   ...
   Sigla   : CECRED
   Autor   : Adriano
   Data    : Marco/2013                     Ultima atualizacao: 14/12/2017
...
............................................................................. */
  ...
  BEGIN
    ...
    IF vr_dstextab IS NULL THEN
      vr_dscritic := 'Valor do Percentual Societário Exigido não foi encontrado para a '||rw_crapcop.nmrescop;
      RAISE vr_exc_saida;
    ELSE
    ...
    btch0001.pc_gera_log_batch(pr_cdcooper      => rw_crapcop.cdcooper
                              ,pr_ind_tipo_log  => 2 -- grava 1 - Mensagem
