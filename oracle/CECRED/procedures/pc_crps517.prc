CREATE OR REPLACE PROCEDURE CECRED.pc_crps517 (pr_cdcooper IN crapcop.cdcooper%TYPE   --> Cooperativa solicitada
  ...
  BEGIN
    ...
    Sigla   : CRED
    Autor   : David
    Data    : Outubro/2008                    Ultima Atualizacao: 17/02/2016
        ...
        SELECT qtrenova,
         ...
         WHERE (craplim.cdcooper  = pr_cdcooper   
           ...
           AND  craplim.dtfimvig <= rw_crapdat.dtmvtolt) 
            OR (craplim.cdcooper  = pr_cdcooper 
           AND  craplim.tpctrlim  = 3           
