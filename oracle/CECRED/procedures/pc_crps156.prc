    ...
    CURSOR cr_craptab(pr_cdcooper IN craptab.cdcooper%TYPE
      ...
      SELECT tab.dstextab
       ...
       WHERE tab.cdcooper = pr_cdcooper
         ...
         AND UPPER(tab.cdacesso) = UPPER(NVL(pr_cdacesso, tab.cdacesso))
    ...
    BEGIN
      IF pr_flgctain = 1 /* True */ AND  /* Nova aplicacao  */    
        ...
        IF cr_craplot%NOTFOUND THEN
          ...
          EXCEPTION
            WHEN OTHERS THEN
              vr_dscritic := 'Não foi possivel inserir craplot(1015): '||SQLERRM;
              RAISE vr_exc_saida;
          END;
        END IF;
        -- fechar cursor;
        ...
        EXCEPTION
          WHEN OTHERS THEN
            vr_dscritic := 'Não foi possivel atualizar craplot(1015): '||SQLERRM;
            RAISE vr_exc_saida;  
        END;
