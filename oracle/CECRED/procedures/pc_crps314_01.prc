CREATE OR REPLACE PROCEDURE CECRED."PC_CRPS314_01" (pr_stprogra OUT PLS_INTEGER           --> Saída de termino da execução
...
/* ..........................................................................
   ...
   Sigla   : CRED
   Autor   : Junior.
   Data    : Julho/2001                          Ultima atualizacao: 30/07/2014
 ...
 ............................................................................ */
  ...
  type typ_tab_bordero is table of typ_bordero index by varchar2(22);
  ...
  type typ_tab_separados is table of typ_separados index by varchar2(65);
  ...
  -- Variavel para leitura das pl/tables
  vr_indice_separados    varchar2(65);
    ...
    cursor cr_crapbdc is
      select crapcdb.nrctrlim,
       ...
       where crapage.cdcooper = pr_cdcooper
         ...
         and crapbdc.dtlibbdc between to_date('01/10/2014', 'dd/mm/yyyy') and to_date('22/10/2014', 'dd/mm/yyyy')
    ...
    cursor cr_crapbdt is
      select craptdb.nrctrlim,
       ...
       where crapage.cdcooper = pr_cdcooper
         ...
         and crapbdt.dtlibbdt between to_date('01/10/2014', 'dd/mm/yyyy') and to_date('22/10/2014', 'dd/mm/yyyy')
  ...
  BEGIN
    ...
    for rw_crapbdc in cr_crapbdc loop
      vr_indice_bordero := to_char(rw_crapbdc.cdagenci, 'fm00')||to_char(rw_crapbdc.nrborder, 'fm0000000000')||to_char(rw_crapbdc.nrctrlim, 'fm0000000000');
    ...
    for rw_crapbdt in cr_crapbdt loop
      vr_indice_bordero := to_char(rw_crapbdt.cdagenci, 'fm00')||to_char(rw_crapbdt.nrborder, 'fm0000000000')||to_char(rw_crapbdt.nrctrlim, 'fm0000000000');
    ...
    cursor cr_craplim (pr_tipo in varchar2) is
      select craplim.nrdconta,
       ...
       where crapage.cdcooper = pr_cdcooper
         ...
         and craplim.dtinivig between to_date('01/10/2014', 'dd/mm/yyyy') and to_date('22/10/2014', 'dd/mm/yyyy')
  ...
  BEGIN
    ...
    for rw_craplim in cr_craplim ('MENOR') loop
      ...
      vr_indice_geral := to_char(rw_craplim.cdagenci, 'fm00000')||'4'||'1'||'00000'||to_char(rw_craplim.nrdconta, 'fm0000000000')||to_char(rw_craplim.nrctrlim, 'fm0000000000')||'0000000000';
      vr_tab_geral(vr_indice_geral).vr_cdagenci := rw_craplim.cdagenci;
      ...
      vr_indice_geral2 := '4'||'1'||'00000'||to_char(rw_craplim.cdagenci, 'fm00000')||to_char(rw_craplim.nrdconta, 'fm0000000000')||to_char(rw_craplim.vllimite, 'fm0000000000000000000000000')||to_char(rw_craplim.nrctrlim, 'fm0000000000')||'0000000000';
      vr_tab_geral2(vr_indice_geral2).vr_cdagenci := rw_craplim.cdagenci;
    ...
    for rw_craplim in cr_craplim ('MAIOR') loop
      -- Inclui na primeira tabela, ordenada por agencia
      vr_indice_geral := to_char(rw_craplim.cdagenci, 'fm00000')||'4'||'2'||'00000'||to_char(rw_craplim.nrdconta, 'fm0000000000')||to_char(rw_craplim.nrctrlim, 'fm0000000000')||'0000000000';
      vr_tab_geral(vr_indice_geral).vr_cdagenci := rw_craplim.cdagenci;
      vr_tab_geral(vr_indice_geral).vr_dtmvtolt := pr_dtmvtolt;
      vr_tab_geral(vr_indice_geral).vr_nrdconta := rw_craplim.nrdconta;
      vr_tab_geral(vr_indice_geral).vr_nrctremp := rw_craplim.nrctrlim;
      ...
      vr_tab_geral(vr_indice_geral).vr_vlrgeral := vr_desvalor;
      -- Inclui na segunda tabela, ordenada pelos indicadores e depois por agencia e conta
      vr_indice_geral2 := '4'||'2'||'00000'||to_char(rw_craplim.cdagenci, 'fm00000')||to_char(rw_craplim.nrdconta, 'fm0000000000')||to_char(rw_craplim.vllimite, 'fm0000000000000000000000000')||to_char(rw_craplim.nrctrlim, 'fm0000000000')||'0000000000';
      vr_tab_geral2(vr_indice_geral2).vr_cdagenci := rw_craplim.cdagenci;
      vr_tab_geral2(vr_indice_geral2).vr_dtmvtolt := pr_dtmvtolt;
      vr_tab_geral2(vr_indice_geral2).vr_nrdconta := rw_craplim.nrdconta;
      vr_tab_geral2(vr_indice_geral2).vr_nrctremp := rw_craplim.nrctrlim;
    ...
    cursor cr_crawcrd (pr_tipo in varchar2) is
      select crawcrd.nrdconta,
       ...
       where crapage.cdcooper = pr_cdcooper
         ...
         and crawcrd.dtentreg between to_date('01/10/2014', 'dd/mm/yyyy') and to_date('22/10/2014', 'dd/mm/yyyy')
    ...
    cursor cr_crapepr (pr_cdcooper in crapepr.cdcooper%type,
      ...
      select /*+ index (crapepr crapepr##crapepr1)*/
       ...
       where crapepr.cdcooper = pr_cdcooper
         ...
         and crapepr.dtmvtolt between to_date('01/10/2014', 'dd/mm/yyyy') and to_date('22/10/2014', 'dd/mm/yyyy')
         and (   (    pr_tipo = 'MENOR'
    ...
    cursor cr_crapadt (pr_cdcooper in crapadt.cdcooper%type,
      ...
      select crapadt.nraditiv,
       ...
       where crapadt.cdcooper = pr_cdcooper
         ...
         and crapadt.dtmvtolt between to_date('01/10/2014', 'dd/mm/yyyy') and to_date('22/10/2014', 'dd/mm/yyyy');
  ...
  BEGIN
    for rw_crapadt in cr_crapadt (pr_cdcooper,
      ...
      close cr_crapass;
      --
      vr_indice_aditivo := to_char(rw_crapass.cdagenci, 'fm00000')||to_char(rw_crapadt.nrdconta, 'fm0000000000')||to_char(rw_crapadt.cdaditiv, 'fm00000')||to_char(rw_crapadt.nraditiv, 'fm0000000000')||to_char(rw_crapadt.nrctremp,'fm0000000000');
      -- Informações do aditivo
      vr_tab_aditivo(vr_indice_aditivo).vr_cdagenci := rw_crapass.cdagenci;
    ...
    cursor cr_crapcdc (pr_cdcooper in crapcdc.cdcooper%type,
      ...
      select /*+index (crapcdc crapcdc##crapcdc1)*/
       ...
       where crapcdc.cdcooper = pr_cdcooper
         ...
         and crapcdc.dtmvtolt between to_date('01/10/2014', 'dd/mm/yyyy') and to_date('22/10/2014', 'dd/mm/yyyy')
         and (   (    pr_tipo = 'MENOR'
...
begin
  ...
  BTCH0001.pc_valida_iniprg (pr_cdcooper => 1
                            ,pr_flgbatch => 1 -- Fixo
  ...
  vr_dstextab := tabe0001.fn_busca_dstextab(pr_cdcooper => 1
                                           ,pr_nmsistem => 'CRED'
                                           ,pr_tptabela => 'GENERI'
                                           ,pr_cdempres => 0
  ...
  -- Inclui informações de borderô na vr_tab_bordero
  pc_grava_borderos(1,rw_crapdat.dtmvtolt);

  -- Inclui informações de limite de crédito na vr_tab_geral e vr_tab_geral2
  pc_limite_credito(1,rw_crapdat.dtmvtolt,vr_vllimcre);

  -- Inclui informações de limite de cartão de crédito na vr_tab_geral e vr_tab_geral2
  pc_limite_cartao_cred(1,rw_crapdat.dtmvtolt,vr_vllimcre);

  -- Inclui informações de empréstimos na vr_tab_geral e vr_tab_geral2
  pc_processa_emprestimos(1,rw_crapdat.dtmvtolt,vr_vlfaixa1,vr_vlfaixa2);

  -- Inclui informações de aditivos na vr_tab_aditivo
  pc_processa_aditivos(1,rw_crapdat.dtmvtolt);

  -- Inclui informações de descontos na vr_tab_geral e vr_tab_geral2
  pc_processa_limite_desconto(1,rw_crapdat.dtmvtolt,vr_vllimctr);

  -- Busca do diretório base da cooperativa
  vr_nom_diretorio :=  '/usr/coop/sistema/equipe/paulo/';
  -- Imprime relatorio por PA
  for rw_crapage in cr_crapage (1) loop
    ...
    while vr_indice_bordero is not null loop
      ...
      if vr_tab_bordero(vr_indice_bordero).vr_cdagenci = rw_crapage.cdagenci then
        ...
        if vr_indice_separados <> to_char(vr_tab_bordero(vr_indice_bordero).vr_dtlibbdc, 'yyyymmdd')||
                                  to_char(vr_tab_bordero(vr_indice_bordero).vr_cdagenci, 'fm00')||
    ...
    IF 1 = 1 THEN -- Cfe. chamado 8482 - Edson
    ...
    gene0002.pc_solicita_relato(pr_cdcooper  => 1,         --> Cooperativa conectada
                                ...
                                pr_dsarqsaid => vr_nom_diretorio||'/'||vr_nom_arquivo||'R.lst', --> Arquivo final com código da agência
                                pr_flg_gerar => 'N',
  ...
  -- Nome base do arquivo é crrl266
  vr_nom_arquivo := 'crrl266'||gene0001.fn_param_sistema('CRED',1,'SUFIXO_RELATO_TOTAL');
  -- Inicializar o CLOB
  dbms_lob.createtemporary(vr_des_xml, TRUE);
  dbms_lob.open(vr_des_xml, dbms_lob.lob_readwrite);
  -- Inicilizar as informações do XML
  ...
  btch0001.pc_valida_fimprg(pr_cdcooper => 1
                           ,pr_cdprogra => vr_cdprogra
                           ,pr_infimsol => pr_infimsol
