create or replace procedure cecred.pc_crps616_old(pr_cdcooper  in craptab.cdcooper%type,
...
/* ............................................................................
   ...
   Alteracoes: 15/01/2013 - Atualizar o campo crapepr.dtdpagto com a data da
               ...
               18/08/2017 - #696286 Programa pc_crps616_old sem as melhorias de performance, porém 
                            com commit e exportação da crapepr; chamado pelo programa crpN616.p, 
                            que está cadastrado na crapprg apenas para a Altovale (Carlos)
............................................................................. */
...
begin
  ...
  gene0001.pc_informa_acesso(pr_module => 'PC_CRPS616_OLD',
  ...
  for rw_crapepr in cr_crapepr (pr_cdcooper) loop
    ...
    begin
      ...
      ELSE
        vr_tab_crapepr(vr_index).dtdpagto:= rw_crapepr.dtdpagto;
      END IF;
    --  vr_tab_crapepr(vr_index).dtdpagto:= vr_dtdpagto;
  ...
  BEGIN
    FORALL idx IN INDICES OF vr_tab_crappep SAVE EXCEPTIONS
      UPDATE crappep -- + PARALLEL (crappep) 
  ...
  BEGIN
    FORALL idx IN INDICES OF vr_tab_crapepr SAVE EXCEPTIONS
      update crapepr -- + PARALLEL (crapepr) 
  ...
  -- Gravar os dados das tabelas afetadas em arquivo .csv para comparação
