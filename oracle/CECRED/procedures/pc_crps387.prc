...
/* .............................................................................
   ...
   Sigla   : CRED
   Autora  : Mirtes
   Data    : Abril/2004                        Ultima atualizacao: 26/02/2016
    ...
    DECLARE
      ...
      TYPE typ_reg_relato IS
        RECORD(nrdconta   craprej .nrdconta%TYPE,
               contrato   craprej.vldaviso%TYPE,
          ...
          INSERT INTO crapndb
           ...
           VALUES
            (vr_dtmvtopr,
             ...
             pr_cdhisdeb,
             0,
             'F' || SUBSTR(vr_setlinha,2,66) || vr_par_dstextar || SUBSTR(vr_setlinha,70,81),
                ...
                BEGIN
                          ...
                          INSERT INTO crapndb
                           ...
                           VALUES
                            (vr_dtultdia,
                             ...
                             rw_gnconve.cdhisdeb,
                             0,
                             'F'||SUBSTR(vr_setlinha,2,66)||'14'||SUBSTR(vr_setlinha,70,81),
                             vr_cdcooper);
                        EXCEPTION
                          WHEN OTHERS THEN
                            vr_dscritic := 'Erro ao inserir crapndb: '||SQLERRM;
                  ...
                  LOOP
                    ...
                    IF cr_crapass%NOTFOUND THEN
                      ...
                      EXIT;
                    ELSE
                    --  IF rw_crapass.cdsitdtl IN (2,4,5,6,7,8,9) THEN
                            ...
                            INSERT INTO crapndb
                             ...
                             VALUES
                              (vr_dtultdia,
                               ...
                               rw_gnconve.cdhisdeb,
                               0,
                               'F'||SUBSTR(vr_setlinha,2,66)||'04'||SUBSTR(vr_setlinha,70,81),
                               vr_cdcooper);
                          EXCEPTION
                            WHEN OTHERS THEN
                              vr_dscritic := 'Erro ao inserir crapndb: '||SQLERRM;
          ...
          BEGIN
            UPDATE craptab
             ...
             WHERE craptab.cdcooper = pr_cdcooper
               ...
               AND craptab.cdacesso = 'LOTEINT031'
