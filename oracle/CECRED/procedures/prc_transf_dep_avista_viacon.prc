CREATE OR REPLACE PROCEDURE CECRED.prc_transf_dep_avista_viacon IS

  aux_cdcooper_old crapass.cdcooper%TYPE := 4;
  aux_cdcooper_new crapass.cdcooper%TYPE := 1;
  aux_caminho      VARCHAR2(400) := '/micros/cecred/james/concredi/';
...
END prc_transf_dep_avista_viacon;
/
