  /* .............................................................................
   ...
   Objetivo  : Envio do arquivo de negativacao da Serasa
     ...
     DECLARE
       ...
       CURSOR cr_crapjur(pr_cdcooper crapcop.cdcooper%TYPE,
         ...
         SELECT ass.nrcpfcgc, --> Documento do Credor 
                jur.nmtalttl, --> Razão Social do Credor   
                jur.nmfansia, --> Nome Fantasia do Credor
                enc.dsendere, --> Endereço do Credor
                enc.nmbairro, --> Bairro do Credor
                enc.nmcidade, --> Município do Credor 
                enc.cdufende, --> Sigla Unidade Federativa do Credor    
                enc.nrcepend, --> Código de endereçamento postal
                tfc.nrdddtfc, --> DDD do Telefone do Credor
                tfc.nrtelefo, --> Telefone do Credor
                tfc.nrdramal  --> Número de ramal do telefone do Credor 
          FROM crapass ass, 
               crapenc enc, 
               craptfc tfc,
               crapjur jur
       ...
       CURSOR cr_crapsab(pr_cdcooper crapsab.cdcooper%TYPE,
        ...
        SELECT cdtpinsc, --> Tipo de pessoa do Devedor (F - Fisica / J - Juridica)
               ...
               nmdsacad, --> Nome do Devedor
               dsendsac, --> Endereço do Devedor
               complend, --> Complemento do Endereço do Devedor
               nmbaisac, --> Bairro do Devedor
               nmcidsac, --> Município do Devedor
          ...
          FOR rw_crapcob IN cr_crapcob(rw_crapcop.cdcooper) LOOP 
            ...
            gene0002.pc_escreve_xml(pr_xml            => vr_clob
                                   ...
                                   ,pr_texto_novo     => '1'                              || --> Código do registro = '1'
                                                         ...
                                                         RPad(rw_crapcob.nrcnvcob,20,' ') || --> Uso Reservado da Instituição Conveniada (na inclusão)
