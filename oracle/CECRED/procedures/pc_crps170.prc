...
/* ..........................................................................
   ...
   Sigla   : CRED
   Autor   : Odair
   Data    : Outubro/96.                        Ultima atualizacao: 22/06/2016
    ...
    BEGIN
      ...
      gene0002.pc_escreve_xml(pr_xml         => vr_xml_clobxml 
        ...
        FOR rw_crapacc IN cr_crapacc(pr_cdcooper => rw_crapcop.cdcooper,
           ...
           vr_dstextab := TABE0001.fn_busca_dstextab(pr_cdcooper => rw_crapacc.cdcooper
                                                    ,pr_nmsistem => 'CRED'
                                                    ,pr_tptabela => 'USUARI'
                                                    ,pr_cdempres => rw_crapacc.cdempres
                                                    ,pr_cdacesso => 'VLTARIF105'
                                                    ,pr_tpregist => 1);   
                         									 
           IF TRIM(vr_dstextab) IS NOT NULL THEN          
               vr_vltarifa := vr_dstextab;              
           END IF;
