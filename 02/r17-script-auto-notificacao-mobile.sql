declare  
  ...
  /* 008 grupos foram executados em 236/383 segundos no homol1 */
  /* 023 grupos foram executados em 41 segundos no homol1      */
  /* 222 grupos foram executados em 2240 segundos no dev3                  */
  /* 222 grupos foram executados em 15mi segundos no dev3 <-- bulk collect */
  ...
  begin
    ...
    open cr_busca_cooperados (1,0,0);
...
<p>Essa é a data exclusiva para você votar nas decisões da Cooperativa. Chegue 30 minutos antes para retirar seu aparelho de votação com tranquilidade.</p>
<p>Obs: Se você transferiu sua conta para outro Posto de Atendimento após o dia 02/01/2019, a data do evento poderá sofrer alteração. Consulte pelo WhatsApp (47) 99150 7478 ou SAC 0800 647 2200.</p>
<p>Aguardamos você ;)</p>
12'; 
    ...
    pc_mantem_msg_manual(pr_cdmensagem                => 0
                        ...
                        ,pr_dslink_acao_mobile        => 'http://www.aquivoceparticipa.com.br/'||rw_crapage.nmrescop
                        ,pr_dsmensagem_acao_mobile    => 'Você será redirecionado para fora do app.'
                        ,pr_cdicone                   => 11
                        ,pr_inexibir_banner           => 1
                        ,pr_nmimagem_banner           => 'assembleias_2019_viacredi.jpg'
                        ,pr_inenviar_push             => 1
