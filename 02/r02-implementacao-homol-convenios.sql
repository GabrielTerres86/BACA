...
*/
  ...
  begin
    ...
    insert into crapaca (NMDEACAO, NMPACKAG, NMPROCED, LSTPARAM, NRSEQRDR) values ('HOMOL_AUTO_DEB_CONV',    'TELA_HCONVE', 'pc_conv_autori_de_debito_web', 'pr_nrdconta, pr_cdconven, pr_cdrefere',                                                                  nm_nrseqrdr);
    insert into crapaca (NMDEACAO, NMPACKAG, NMPROCED, LSTPARAM, NRSEQRDR) values ('HOMOL_FATURAS',          'TELA_HCONVE', 'pc_conv_homologa_faturas_web', 'pr_cdbarras',                                                                                            nm_nrseqrdr);
