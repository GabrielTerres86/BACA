<?php
	...
	**************************************************************************************/
	...
	$xmlResult = mensageria($xml, "MATRIC", "SAQUE_PARCIAL_COTAS_MATRIC", $glbvars["cdcooper"], $glbvars["cdagenci"], $glbvars["nrdcaixa"], $glbvars["idorigem"], $glbvars["cdoperad"], "</Root>");
	...
	if (strtoupper($xmlObj->roottag->tags[0]->name) == "ERRO") {
		...
		exibirErro('error',$msgErro,'Alerta - Ayllos','$(\'input\',\'#frmSaqueParcial\').removeClass(\'campoErro\');blockBackground(parseInt($(\'#divRotina\').css(\'z-index\')));',false);		
