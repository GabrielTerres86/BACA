<?
/*!
 * FONTE        : form_filtro_contas_demitidas.php
 * CRIAÇÃO      : Jonata/RKAM 
 * DATA CRIAÇÃO : Novembro/2017
 * OBJETIVO     : Form para apresentar os filtros de pesquisa da tela MATRIC - G.
 * --------------
 * ALTERAÇÕES   :  
...
<form id="frmFiltroContasDemitidas" name="frmFiltroContasDemitidas" class="formulario" style="display:none;">
...
<div id="divBotoesFiltroContasDemitidas" style='text-align:center; margin-bottom: 10px; margin-top: 10px; display:none;'>
																			
	<a href="#" class="botao" id="btVoltar" onClick="controlaVoltar('1'); return false;">Voltar</a>																																							
	<a href="#" class="botao" id="btProsseguir" onClick="buscarContasDemitidas('1','200'); return false;" >Prosseguir</a>	
