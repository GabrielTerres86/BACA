 ...
 * OBJETIVO     : Mostrar rotina de Resultado da tela CONTAS
 *
 * ALTARACOES   : 05/08/2015 - Reformulacao cadastral (Gabriel-RKAM)
 */	
?>
...
<?
	...
	// Carregas as opções da Rotina de Resultado
					...
					<td>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td class="txtBrancoBold ponteiroDrag" background="<?php echo $UrlImagens; ?>background/tit_tela_fundo.gif">RESULTADO</td>
