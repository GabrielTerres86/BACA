<?
/*!
 * FONTE        : alterar_rating.php
 * CRIAÇÃO      : Andre Santos - SUPERO
 * DATA CRIAÇÃO : 22/11/2013
 * OBJETIVO     : Alterar informações cadastrais - Tela RATBND
 * --------------
 * ALTERAÇÕES   :
 * --------------
 */
...
<?
    ...
    $xmlContrato .= '		<Proc>alterar-rating-bndes</Proc>';
    $xmlContrato .= '	</Cabecalho>';
    $xmlContrato .= '	<Dados>';
	...
	// Carrega variavel com a informação do RISCO PROPOSTO
