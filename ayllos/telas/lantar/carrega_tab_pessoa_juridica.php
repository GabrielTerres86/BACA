<? 
/*!
 * FONTE        : carrega_tab_pessoa_juridica.php
 * CRIAÇÃO      : Tiago Machado
 * DATA CRIAÇÃO : 26/03/2013
 * OBJETIVO     : Gera form com tarifas pessoa juridica.
 * --------------
 * ALTERAÇÕES   : 
 * -------------- 
 */
...
<?php
	...
	for ($i = 0; $i < $tarifas_count; $i++){		
		...
		echo "criaObjetoTarifaPj('$cdtarifa', '$dstarifa', '$cdhistor', '$dshistor', '$vltarifa', '$cdfvlcop', '$bloqueia');";
	}	

	echo	"carregaTabelaTarifaPj();";	
?>