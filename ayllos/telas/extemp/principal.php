 ...
 * OBJETIVO     : Capturar dados para tela EXTEMP
 * --------------
 * ALTERAÇÕES   : 
 * -------------- 
 */ 
...
<?	
	...
	if ( empty($nrctremp) ) {
		...
		echo "cNrctremp.habilitaCampo().focus();";
		echo "qtdeExtemp='1';";
		echo "hideMsgAguardo();";
	} else {
		echo "cNrctremp.val('".$nrctremp."');";
		echo "cNrctremp.trigger('blur');";
