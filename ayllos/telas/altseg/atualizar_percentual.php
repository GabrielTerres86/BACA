<? 
/*!
 * FONTE        : atualizar_percentual.php
 * CRIAÇÃO      : Adriano Marchi
 * DATA CRIAÇÃO :  18/12/2015
 * OBJETIVO     : Atualzar percentual do plano
 * --------------
 * ALTERAÇÕES   : 
 * -------------- 
 */
...
<?
	...
	$retornoCampo = "$('input', '#frmInfAtualiza').habilitaCampo(); focaCampoErro('tpplaseg', 'frmInfAtualiza')";
	...
	$xmlSetPesquisa .= "        <Proc>pi_atualizar_perc_seg</Proc>";
	$xmlSetPesquisa .= "  </Cabecalho>";
