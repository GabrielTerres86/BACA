<?
/*!
 * FONTE        : parametro_coop.php
 * CRIAÇÃO      : Daniel Zimmermann
 * DATA CRIAÇÃO : 07/03/2013
 * OBJETIVO     : Tela do formulario parametro
 */	 
?>
...
<table id='telaParametro' cellpadding="0" cellspacing="0" border="0" >
	<tr>
		<td align="center">		
					...
					<td>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td class="txtBrancoBold ponteiroDrag" background="<?php echo $UrlImagens; ?>background/tit_tela_fundo.gif"><? echo utf8ToHtml('Parametro por cooperativa') ?></td>
