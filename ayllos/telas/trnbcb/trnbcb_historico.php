<?
/*!
* FONTE        : trnbcb_historico.php
* CRIAÇÃO      : Lucas Ranghetti
* DATA CRIAÇÃO : 20/01/2016
* OBJETIVO     : Tela do formulario Trnbcb
*/	 
?>
...
<table id='telaTrnbcb' cellpadding="0" cellspacing="0" border="0" >
    <tr>
        <td align="center">		
                    ...
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                ...
                                <td class="txtBrancoBold ponteiroDrag" background="<?php echo $UrlImagens; ?>background/tit_tela_fundo.gif"><? echo utf8ToHtml('Vinculo Transa&ccedil;&atilde;o Bancoob X Hist&oacute;rico') ?></td>
