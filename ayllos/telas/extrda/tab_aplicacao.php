 ...
 * --------------
 * ALTERAÇÕES   : 26/10/2012 - Alteração layout da tela, retirado input image
 * 							   e incluso botões (Daniel). 	
 *
 *				  05/11/2014 - Adicionada estrutura de novos produtos de captacao. (Reinert)
 * --------------
 */	
				 ...
				 <? foreach( $registros as $r ) { ?>
					<tr>
						<td><span><? echo dataParaTimestamp(getByTagName($r->tags,'dtmvtolt')) ?></span>
								  ...
								  <input type="hidden" id="dsaplica" name="dsaplica" value="<? echo getByTagName($r->tags,'dsaplica') ?>" />								  
						</td>
				...
				?>
					<tr>
						<td><span><? echo (dataParaTimestamp($r->tags[11]->cdata)); ?></span>
								  ...
								  <input type="hidden" id="nraplica" name="nraplica" value="<? echo ($r->tags[0]->cdata); ?>" />								  
								  <input type="hidden" id="dsaplica" name="dsaplica" value="<? echo ($r->tags[4]->cdata); ?>" />								  
						</td>
...
<div id="divBotoes" style='margin-bottom :10px'>
	...
	<a href="#" class="botao" id="btSalvar" onClick="selecionaAplicacao(); return false;">Prosseguir</a>
</div>