...
function buscaDadosGrupoEconomico() {  
	...
	$.ajax({		
		type: "POST", 
		dataType: "html",
		url: UrlSite + "telas/cadcta/grupo_economico/principal.php",
		async: true,
		data: {
			nrdconta: nrdconta,
			redirect: "html_ajax"
...
function carregaTelaConsultarIntegrantes(){
    ...
    $.ajax({
        type: 'POST',
        dataType: 'html',
        url: UrlSite + 'telas/cadcta/grupo_economico/carrega_integrantes_grupo_economico.php',
		async: true,
        data:{
			idgrupo:  idgrupo,
...
function abreTelaInclusaoIntegrante(){
    ...
    $.ajax({
        type: 'POST',
        dataType: 'html',
        url: UrlSite + 'telas/cadcta/grupo_economico/carrega_tela_incluir_integrantes.php',
		async: true,
        data:{
...
function abreTelaInclusaoGrupoEconomico(){
    ...
    $.ajax({
        type: 'POST',
        dataType: 'html',
        url: UrlSite + 'telas/cadcta/grupo_economico/carrega_tela_incluir_grupo_economico.php',
		async: true,
        data:{
			redirect: "html_ajax"
		},
...
function manterRotina(operacao,nomeFormulario) {
	...
	$.ajax({		
		type: 'POST',
		url: UrlSite + 'telas/cadcta/grupo_economico/manter_rotina.php', 		
		data: {
			nrdconta: nrdconta, 
...
function buscaDadosAssociado(){
	...
	$.ajax({
		type: 'POST',
		url: UrlSite + 'telas/cadcta/grupo_economico/busca_associado.php',		
		data: {
			nrdconta: normalizaNumero($('#nrdconta', '#frmGrupoEconomicoIntegrantes').val())
		   ,nrcpfcgc: normalizaNumero($('#nrcpfcgc', '#frmGrupoEconomicoIntegrantes').val())
		   ,redirect: 'html_ajax'
...
function imprimirRelatorio(){
	var action    = UrlSite + 'telas/cadcta/grupo_economico/imprime_grupo_economico.php';	
