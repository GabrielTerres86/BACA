								...
								<td align="center" style="border: 2px solid #969FA9; background-color: #F4F3F0; padding: 2px;">
									<div id="divConteudo">
										...
										<form id="frmImprimir" name="frmImprimir" class="formulario" onsubmit="return false;">
											...
											<fieldset>
												<legend><? echo utf8ToHtml('Impressao do Termo Aditivo ?') ?></legend>
												<input name="avalista1" id="avalista1" type="button" value="Avalista 1" onClick="Gera_Impressao('1'); return false "/>
												<input name="avalista2" id="avalista2" type="button" value="Avalista 2" onClick="Gera_Impressao('2'); return false "/>
											</fieldset>	
										</form>
