 ...
 * --------------
 * ALTERAÇÕES   : Correcao no erro de sessao ja inicializada. SD 479874. (Carlos R.)
 * --------------
 */ 
...
<div id="divBotoes">
	<input type="image" id="btVoltar" src="<?php echo $UrlImagens; ?>botoes/cancelar.gif" onClick="fechaRotina($('#divRotina')); acessaOpcaoAba(7, 5, 'I'); return false;" />
