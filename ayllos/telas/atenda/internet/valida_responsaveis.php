<?php 
	...
	if (strtoupper($xmlObj->roottag->tags[0]->name) == "ERRO") {
		...
		if($xmlObj->roottag->tags[0]->attributes['FLGPENDE'] == 0){
			echo 'showConfirmacao("H&aacute; transa&ccedil;&otilde;es pendentes de aprova&ccedil;&atilde;o. Deseja alterar os respons&aacute;veis pela assinatura?","Confirma&ccedil;&atilde;o - Ayllos","salvarRepresentantes();","blockBackground(parseInt($(\"#divRotina\").css(\"z-index\")));","sim.gif","nao.gif");';
		}else if($xmlObj->roottag->tags[0]->attributes['FLGPENDE'] == 1){
			echo 'showConfirmacao("Deseja alterar os respons&aacute;veis pela assinatura?","Confirma&ccedil;&atilde;o - Ayllos","salvarRepresentantes();","blockBackground(parseInt($(\"#divRotina\").css(\"z-index\")));","sim.gif","nao.gif");';
		}else if($xmlObj->roottag->tags[0]->attributes['FLGPENDE'] == 2){
			echo 'showConfirmacao("Revise as senhas de acesso a Conta Online para os novos respons&aacute;veis. Deseja alterar as permiss&otilde;es de assinatura?","Confirma&ccedil;&atilde;o - Ayllos","salvarRepresentantes();","blockBackground(parseInt($(\"#divRotina\").css(\"z-index\")));","sim.gif","nao.gif");';
		}
	}
