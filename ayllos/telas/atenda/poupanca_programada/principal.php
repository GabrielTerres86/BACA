		...
		<table>
			...
			<tbody>
				<?  for ($i = 0; $i < $qtPoupancas; $i++) { 
						...
						$mtdClick = "selecionaPoupanca('".$i."','".$qtPoupancas."','".$poupancas[$i]->tags[0]->cdata."','".$poupancas[$i]->tags[24]->cdata."','".$poupancas[$i]->tags[26]->cdata."');";
					?>
...
<form action="<?php echo $UrlSite; ?>telas/atenda/poupanca_programada/poupanca_autorizacao.php" name="frmAutorizacao" id="frmAutorizacao" method="post">
