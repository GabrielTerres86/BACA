<?
/*!
 * FONTE        : atribuicao_detalhamento.php
 * CRIAÇÃO      : Daniel Zimmermann
 * DATA CRIAÇÃO : 05/03/2013
 * OBJETIVO     : Tela do formulario atribuição de detalhamento de tarifas
 */	 
?>
...
<table width="100% id='telaAtribuicaoDetalhamento' cellpadding="0" cellspacing="0" border="0" >
	<tr>
		<td align="center">		
					...
					<td>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td class="txtBrancoBold ponteiroDrag" background="<?php echo $UrlImagens; ?>background/tit_tela_fundo.gif"><? echo utf8ToHtml('Atribui&ccedil;&atilde;o de Detalhamento') ?></td>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								<td align="center" style="border: 2px solid #969FA9; background-color: #F4F3F0; padding: 2px;">
									<div id="divAtribuicaoDetalhamento" >
