...
<form name="frmCmesaq" id="frmCmesaq" class="formulario">	

	<input type="hidden" name="nmarqpdf" id="nmarqpdf" value="">
	<input type="hidden" name="vlmincen" id="vlmincen" value="">
	...
	<fieldset>
		<legend><? echo utf8ToHtml('Sacador') ?></legend>
		...
		<label for="cdufdrcb"><? echo utf8ToHtml('UF:') ?></label>
		...
		<label for="dstrecur"><? echo utf8ToHtml('Destino:') ?></label>
		<input name="dstrecur" id="dstrecur" type="text" />
			
		<br />

		<label for="dsdopera"> <? echo utf8ToHtml('Valor sendo levado:') ?> </label>
		<select id="dsdopera" name="dsdopera">
			<option value="" selected> Selecione </option>
			<option value="T" > Total  </option>
			<option value="P" >Parcial </option>
		</select>
		
		<label for="vlretesp"> <? echo utf8ToHtml('Valor:') ?> </label>
		<input name="vlretesp" id="vlretesp" type="text" />
...
<div id="divBotoes">	
	<input type="image" id="btVoltar" src="<?php echo $UrlImagens; ?>botoes/voltar.gif"   onclick="btnVoltar('voltar');return false;"   />
