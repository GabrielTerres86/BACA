...
<table id='telaIdentificadores' cellpadding="0" cellspacing="0" border="0" >
	<tr>
		<td align="center">		
					...
					<td>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td class="txtBrancoBold ponteiroDrag" background="<?php echo $UrlImagens; ?>background/tit_tela_fundo.gif">IDENTIFICADORES</td>
