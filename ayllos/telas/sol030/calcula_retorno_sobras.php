 ...
 */
	...
	$xmlResult = mensageria($xml, "TELA_SOL030", "CAL_RETORNO_SOBRAS", $glbvars["cdcooper"], $glbvars["cdagenci"], $glbvars["nrdcaixa"], $glbvars["idorigem"], $glbvars["cdoperad"], "</Root>");
	...
	if (strtoupper($xmlObjeto->roottag->tags[0]->name) == "ERRO") {
		...
		echo 'showError("error","'.htmlentities($msgErro).'","Alerta - Ayllos",\'estadoInicial();\');';
		exit();
	}
	$dados = $xmlObjeto->roottag->tags[0]->cdata;
	echo "showError(\"inform\",\"".htmlentities($dados)."\",\"Alerta - Ayllos\",\"estadoInicial();\");";
?>