/*****************************************************************************
 Fonte: menu.js                                                     
 Autor: David                                                       
 Data : Julho/2007        			Ultima Alteracoes: 03/08/2015             
...
function setaATENDA() {
	...
	if  ($("#nmdatela","#frmMenu").val() == "AUTORI" || $("#nmdatela","#frmMenu").val() == "CADEMP") { // Se esta indo para a tela AUTORI ou CADEMP
	
		// Concatenar servicos essencias
		for (var i = 0; i < produtosTelasServicos.length; i++ ) {
			essenciais += produtosTelasServicos[i] + "|";
		}
		...
		for (var i = 0; i < produtosTelasServicosAdicionais.length; i++) {
			adicionais += produtosTelasServicosAdicionais[i] + "|";		
		}
