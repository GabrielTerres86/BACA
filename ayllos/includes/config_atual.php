<?php 
	...
	//*** Fonte: config.php                                                ***//
	//*** Autor: David                                                     ***//
	//*** Data : Julho/2007                   �ltima Alteracao: 20/08/2018 ***//
	//***                                                                  ***//
	//*** Objetivo  : Variaveis globais de controle                        ***//
	//***                                                                  ***//	 
	//*** Altera��es: 22/10/2010 - Eliminar variaveis da session que s�o   ***//
	...
	// Url para Login 
	$UrlLogin = "http://ayllos.cecred.coop.br/login_sistemas.php";
