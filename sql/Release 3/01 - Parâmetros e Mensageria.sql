...
/* Mensageria Busca dados titulo */
INSERT INTO CRAPACA(NRSEQACA, NMDEACAO, NMPACKAG, NMPROCED, LSTPARAM, NRSEQRDR) 
   VALUES (SEQACA_NRSEQACA.NEXTVAL,'BUSCA_DADOS_TITULO','TELA_ATENDA_DSCTO_TIT','pc_busca_dados_titulo_web','pr_nrdconta,pr_nrborder,pr_chave',(SELECT nrseqrdr FROM craprdr WHERE nmprogra ='TELA_ATENDA_DESCTO'));
