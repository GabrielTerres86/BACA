declare 
  ...
  vr_nrdconta      crapass.nrdconta%TYPE := 434957;
  vr_nrctremp      craplem.nrctremp%TYPE := 67178;
  vr_vllanmto      craplem.vllanmto%TYPE := 550.9;
  vr_cdhistor      craplem.cdhistor%TYPE := 3273;
  
  vr_vlpagpar      crappep.vlpagpar%TYPE := 275.45;
  vr_vldespar      crappep.vldespar%TYPE := 51.06; 
...
BEGIN
  ...
  BEGIN
    UPDATE crappep c
       SET vldespar = vr_vldespar, 
           vlpagpar = vr_vlpagpar
  ...
  BEGIN
    UPDATE crapepr
       SET crapepr.vlsdeved = crapepr.vlsdeved + vr_vllanmto
          ,crapepr.vlsprojt = crapepr.vlsprojt + vr_vllanmto
