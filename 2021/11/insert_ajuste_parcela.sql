...
insert into tbgen_evento_soa (IDEVENTO, CDCOOPER, NRDCONTA, NRCTRPRP, TPEVENTO, TPRODUTO_EVENTO, TPOPERACAO, DHOPERACAO, DSPROCESSAMENTO, DSSTATUS, DHEVENTO, DSERRO, NRTENTATIVAS, DSCONTEUDO_REQUISICAO)
values (5025288, 10, 134090, 16316, 'PAGTO_PAGAR', 'CONSIGNADO', 'INSERT', '16/11/21 16:21:25,289489', null, null, null, null, null, '<?xml version="1.0" encoding="UTF-8"?><Root><convenioCredito>
                    <cooperativa>
                      <codigo>10</codigo>
                    </cooperativa>
                    <numeroContrato>16316</numeroContrato>
