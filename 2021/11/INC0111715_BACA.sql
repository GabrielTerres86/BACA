  ...
  PROCEDURE pc_efetiva_reg_pendentes(pr_dtprocesso IN DATE,
    ...
    CURSOR cr_lancamento IS
       ...
       WHERE lct.idarquivo = arq.idarquivo
		 ...
		 and to_date(pdv.dtpagamento, 'RRRR-MM-DD') between to_date('03/11/2021', 'DD/MM/RRRR') and to_date('04/11/2021', 'DD/MM/RRRR')
         AND pdv.idcentraliza = ctz.idcentraliza
	and (arq.nmarquivo_gerado is null or arq.idarquivo = 481994)
		 and arq.idarquivo in
			 (481994, 482518, 482519)
