    ...
    select a.*,
           (select b.dsdadant
             ...
             where b.cdcooper = a.cdcooper
               ...
               and b.nmdcampo = 'crapass.cdsitdct') dsdadant
      from craplgm a
     where dstransa =
           'Alteracao da situacao de conta por script - INC0111526';
...
BEGIN
  ...
  FOR rg_craplgm IN cr_craplgm LOOP
    ...
    update crapass a
       set a.cdsitdct = rg_craplgm.dsdadant
    ...
    DELETE CECRED.craplgi lgi
     WHERE lgi.cdcooper = vr_cdcooper
       ...
       and lgi.nmdcampo = 'crapass.cdsitdct';
