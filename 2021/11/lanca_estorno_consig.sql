...
begin
  ...
  vr_nmdireto := gene0001.fn_param_sistema('CRED',3,'ROOT_MICROS') || 'cpd/bacas/INC0112090/';
  ...
  LOOP
    ...
    vr_vllancto  := gene0002.fn_char_para_number(TRIM(gene0002.fn_busca_entrada(4,vr_setlinha,';')));   
