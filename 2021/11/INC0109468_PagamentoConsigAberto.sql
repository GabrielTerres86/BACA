	  ...
	  FROM tbepr_consignado_pagamento b,
		   (SELECT cdcooper, nrdconta, nrctremp, nrparepr
			 ...
			 WHERE (cdcooper, nrdconta, nrctremp, nrparepr) IN (
																(1, 80099939, 2956166, 16),
																(1, 80099939, 2956166, 17),
																(1, 80099939, 2956166, 18),
																(1, 9329587, 4290768, 11),
																(1, 9329587, 4290768, 12),
																(1, 10488448, 2143167, 18),
																(9, 501000, 19100579, 1),
																(9, 504971, 21100042, 1),
																(13, 467448, 73978, 14),
																(13, 442240, 61407, 18),
																(13, 242098, 68876, 57)
																) OR ((cdcooper, nrdconta, nrctremp) IN ((13, 242098, 68876))
																	  AND nrparepr BETWEEN 17 AND 55) OR (
																	  (cdcooper, nrdconta, nrctremp) IN ((13, 490695, 81575))
																	  AND nrparepr BETWEEN 14 AND 36)
			   AND inliquid = 0
	) pep
