...
BEGIN
  ...
  values (aux_cdpartar_add, 'RITM0170468 - Variaveis JSON (1-Ligado/0-Desligado)', 2, 13);

  insert into crapbat (CDBATTAR, NMIDENTI, CDPROGRA, TPCADAST, CDCADAST)
  values ('RITM0170468', 'RITM0170468 - Variaveis JSON (1-Ligado/0-Desligado)', ' ', 2, aux_cdpartar_add);
...
BEGIN
  ...
  insert into crappat (CDPARTAR, NMPARTAR, TPDEDADO, CDPRODUT)
  values (aux_cdpartar_add, 'RITM0162123 - Variaveis JSON (1-Ligado/0-Desligado)', 2, 13);

  insert into crapbat (CDBATTAR, NMIDENTI, CDPROGRA, TPCADAST, CDCADAST)
  values ('RITM0162123', 'RITM0162123 - Variaveis JSON (1-Ligado/0-Desligado)', ' ', 2, aux_cdpartar_add);
