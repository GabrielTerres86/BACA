BEGIN
  ...
  BEGIN    
    ...
    vr_dtmvtoan:= to_date('14/09/2021', 'DD/MM/YYYY');
    vr_dtmvtolt:= to_date('15/09/2021', 'DD/MM/YYYY');--rw_crapdat.dtmvtolt;    
    vr_dtmvtopr:= to_date('16/09/2021', 'DD/MM/YYYY');--rw_crapdat.dtmvtolt;
