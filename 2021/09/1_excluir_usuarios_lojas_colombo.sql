declare
  ...
  CURSOR cr_loja IS
    ...
    AND   nrdconta = 202681 -- Feir�o de M�veis
...
tb_usuario( 309 ) := t_usuario('921.271.939-20','ANDR� LUIZ DA SILVA','andre.silva@colombo.com.br','Administrador');
