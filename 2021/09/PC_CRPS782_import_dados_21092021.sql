BEGIN
  ...
  BEGIN    
    ...
    vr_dtmvtoan:= to_date('20/09/2021', 'DD/MM/YYYY');
    vr_dtmvtolt:= to_date('21/09/2021', 'DD/MM/YYYY');--rw_crapdat.dtmvtolt;    
    vr_dtmvtopr:= to_date('22/09/2021', 'DD/MM/YYYY');--rw_crapdat.dtmvtolt;
