    ...
    DECLARE
      ...
      BEGIN
        ...
        IF (cr_crappat%NOTFOUND) THEN
          CLOSE cr_crappat;
          vr_dscritic := 'Parametro ṇo encontrado.';
          RAISE vr_exc_erro;
        END IF;
        CLOSE cr_crappat;
      ...
      EXCEPTION
        ...
        WHEN OTHERS THEN
          -- Montar descri̤̣o de erro ṇo tratado
          pr_vlparamt := NULL;
          pr_dscritic := 'Erro ṇo tratado na buscaParamCadpar: ' || SQLERRM;
