BEGIN
  ...
  BEGIN    
    ...
    vr_dtmvtoan:= to_date('28/09/2021', 'DD/MM/YYYY');
    vr_dtmvtolt:= to_date('29/09/2021', 'DD/MM/YYYY');--rw_crapdat.dtmvtolt;    
    vr_dtmvtopr:= to_date('30/09/2021', 'DD/MM/YYYY');--rw_crapdat.dtmvtolt;
