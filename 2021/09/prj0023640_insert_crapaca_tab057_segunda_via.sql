BEGIN
  ...
  INSERT INTO crapaca (nrseqaca, nmdeacao, nmpackag, nmproced, lstparam, nrseqrdr)
  VALUES ((SELECT MAX(nrseqaca)+1 FROM crapaca), 'TAB057_ATUALIZA_COMPROVANTE_SEGVIA', 'TELA_TAB057', 'pc_atualiza_comprovante_segunda_via', 'pr_idsicredi,pr_dscomprovante', (SELECT nrseqrdr FROM craprdr WHERE nmprogra = 'TAB057'));
