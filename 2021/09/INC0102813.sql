...
---------------------------------------------------
  --#1 INC0102813  viacredi   7106025	20/jul	 2722 R$ 64,85 	 2721 R$ 40,73 
---------------------------------------------------
  vr_incidente := 'INC0102813';
  vr_cdcooper  := 1;
  vr_nrdconta  := 7106025;
  vr_vllanmto  := 64.85;
  vr_cdhistor  := 2722;
...
-------------------------------------------------------------
 ...
 --#2 INC0102813  viacredi   6910432	20/jul	 2722 	 R$ 124,38 	2721 R$ 120,73 
---------------------------------------------------
  vr_incidente := 'INC0102813';
  vr_cdcooper  := 1;
  vr_nrdconta  := 6910432;
...
--#3 INC0102813  viacredi   7411987	28/jul	 2722 	 R$ 64,46 	 2721 R$ 56,91 
---------------------------------------------------
  vr_incidente := 'INC0102813';
  vr_cdcooper  := 1;
  vr_nrdconta  := 7411987;
...
--#4 INC0102813  viacredi   10972293	28/jul	 2722 	 R$ 74,77 	2721 R$ 74,20 
---------------------------------------------------
  vr_incidente := 'INC0102813';
  vr_cdcooper  := 1;
  vr_nrdconta  := 10972293;
  vr_vllanmto  := 74.77;
  vr_cdhistor  := 2722;
  dbms_output.put_line('  ');
  dbms_output.put_line('-------- '|| vr_incidente || ' - INICIO --------');
