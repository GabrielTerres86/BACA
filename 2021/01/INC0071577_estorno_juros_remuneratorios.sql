...
--
  ...
  vr_nrdconta   craplem.nrdconta%type := 184950; -- Alterar aqui
  vr_nrctremp   craplem.nrctremp%type := 60076; -- Alterar aqui
  vr_vllanmto   craplem.vllanmto%type := 949.73; -- Alterar aqui
--
  vr_cdcritic    number;
