...
-- ## 01
---------------------------------------------------
  -- INC0075798 - Viacredi - C/C 10636498  - R$ 200,00
  -- -> Solução: Incluir um 2408 no valor de R$ 200,00
---------------------------------------------------
  vr_incidente := 'INC0075798';
  vr_cdcooper  := 1;
  vr_nrdconta  := 10636498;
  vr_vllanmto  := 200.00;
  vr_cdhistor  := 2408;
  dbms_output.put_line('  ');
...
-- ## 02
---------------------------------------------------
-- INC0075786 - Viacredi - 1 - Conta 2372576 - R$ 320,41.
---------------------------------------------------
  vr_incidente := 'INC0075786';
  vr_cdcooper  := 1;
  vr_nrdconta  := 2372576;
  vr_vllanmto  := 320.41;
  vr_cdhistor  := 2408;
...
-- ## 03
---------------------------------------------------
-- INC0075790 - Viacredi - 1 - Conta 10079610 - R$ 1.360,00
---------------------------------------------------
  vr_incidente := 'INC0075790';
  vr_cdcooper  := 1;
  vr_nrdconta  := 10079610;
  vr_vllanmto  := 1360;
  vr_cdhistor  := 2408;
  dbms_output.put_line('  ');
  dbms_output.put_line('-------- '|| vr_incidente || ' - INICIO --------');
...
-- ## 04
---------------------------------------------------
-- INC0074856 - Credcrea - 7 - Conta 191345 - R$ 12.89
---------------------------------------------------
  vr_incidente := 'INC0074856';
  vr_cdcooper  := 7;
  vr_nrdconta  := 191345;
  vr_vllanmto  := 12.89;
  vr_cdhistor  := 2408;
  ...
  prc_gera_acerto_debt (prm_cdcooper => vr_cdcooper,
                        prm_nrdconta => vr_nrdconta,
                        prm_vllanmto => vr_vllanmto);
