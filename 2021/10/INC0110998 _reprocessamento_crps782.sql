BEGIN
  ...
  BEGIN    
    ...
    vr_dtmvtoan:= to_date('26/10/2021', 'DD/MM/YYYY');
    vr_dtmvtolt:= to_date('27/10/2021', 'DD/MM/YYYY');--rw_crapdat.dtmvtolt;    
    vr_dtmvtopr:= to_date('28/10/2021', 'DD/MM/YYYY');--rw_crapdat.dtmvtolt;
