...
---------------------------------------------------
  -- #01 14/9/2021	Viacredi	1	10446680	INC0109721	 R$ 92,68 	 R$ 92,68
  vr_incidente := 'INC0109721';
  vr_cdcooper  := 1;
  vr_nrdconta  := 10446680;
  vr_vllanmto  := 92.68;
...
--------------------------------------------------------  
-- #02 20/9/2021	Viacredi	1	8187231	INC0109721	 R$ 481,71 	 R$ 481,71 
  vr_incidente := 'INC0109721';
  vr_cdcooper  := 1;
  vr_nrdconta  := 8187231;
  vr_vllanmto  := 481.71;
  ...
  prc_atlz_prejuizo (prm_cdcooper => vr_cdcooper,
                     ...
                     prm_tipoajus => 'I'); 
--------------------------------------------------------  
-- #03 21/9/2021	Viacredi	1	10047476	INC0109721	 R$ 245,58 	 R$ 245,58
  vr_incidente := 'INC0109721';
  vr_cdcooper  := 1;
  vr_nrdconta  := 10047476;
  vr_vllanmto  := 245.58;
  ...
  prc_atlz_prejuizo (prm_cdcooper => vr_cdcooper,
                     ...
                     prm_tipoajus => 'I');
--------------------------------------------------------  
-- #04 22/9/2021	Viacredi	1	10397396	INC0109721	 R$ 511,98 	 R$ 511,98
  vr_incidente := 'INC0109721';
  vr_cdcooper  := 1;
  vr_nrdconta  := 10397396;
  vr_vllanmto  := 511.98;
  ...
  prc_atlz_prejuizo (prm_cdcooper => vr_cdcooper,
                     ...
                     prm_tipoajus => 'I'); 
--------------------------------------------------------  
-- #05 28/9/2021	Viacredi	1	7299338	INC0109721	 R$ 2.263,09 	 R$ 2.263,09 
  vr_incidente := 'INC0109721';
  vr_cdcooper  := 1;
  vr_nrdconta  := 7299338;
  vr_vllanmto  := 2263.09;
  ...
  prc_atlz_prejuizo (prm_cdcooper => vr_cdcooper,
                     ...
                     prm_tipoajus => 'I');
--------------------------------------------------------  
-- #06 28/9/2021	Viacredi	1	10117792	INC0109721	 R$ 227,86 	 R$ 227,86
  vr_incidente := 'INC0109721';
  vr_cdcooper  := 1;
  vr_nrdconta  := 10117792;
  vr_vllanmto  := 227.86;
  ...
  prc_atlz_prejuizo (prm_cdcooper => vr_cdcooper,
                     ...
                     prm_tipoajus => 'I');
--------------------------------------------------------  
-- #07 29/9/2021	Viacredi	1	8945756	INC0109721	 R$ 119,22 	 R$ 119,22
  vr_incidente := 'INC0109721';
  vr_cdcooper  := 1;
  vr_nrdconta  := 8945756;
  vr_vllanmto  := 119.22;
  ...
  prc_atlz_prejuizo (prm_cdcooper => vr_cdcooper,
                     ...
                     prm_tipoajus => 'I'); 
--------------------------------------------------------  
-- #08 30/9/2021	Viacredi	1	10767703	INC0109721	 R$ 142,24 	 R$ 142,24 
  vr_incidente := 'INC0109721';
  vr_cdcooper  := 1;
  vr_nrdconta  := 10767703;
  vr_vllanmto  := 142.24;
  ...
  prc_atlz_prejuizo (prm_cdcooper => vr_cdcooper,
                     ...
                     prm_tipoajus => 'I'); 
--------------------------------------------------------  
-- #09 20/9/2021	Acredicoop	2	655848	INC0109721	 R$ 223,62 	 R$ 223,62
  vr_incidente := 'INC0109721';
  vr_cdcooper  := 2;
  vr_nrdconta  := 655848;
  vr_vllanmto  := 223.62;
  ...
  prc_atlz_prejuizo (prm_cdcooper => vr_cdcooper,
                     ...
                     prm_tipoajus => 'I'); 
--------------------------------------------------------  
-- #10 1/10/2021	Acentra		5	176397	INC0109721	 R$ 92,23 	 R$ 92,23
  vr_incidente := 'INC0109721';
  vr_cdcooper  := 5;
  vr_nrdconta  := 176397;
  vr_vllanmto  := 92.23;
  ...
  prc_atlz_prejuizo (prm_cdcooper => vr_cdcooper,
                     ...
                     prm_tipoajus => 'I');                
--------------------------------------------------------  
-- #11 28/9/2021	Credcrea	7	124460	INC0109721	 R$ 313,50 	 R$ 313,50
  vr_incidente := 'INC0109721';
  vr_cdcooper  := 7;
  vr_nrdconta  := 124460;
  vr_vllanmto  := 313.50;
  ...
  prc_atlz_prejuizo (prm_cdcooper => vr_cdcooper,
                     ...
                     prm_tipoajus => 'I');  
--------------------------------------------------------  
-- #12 20/9/2021	Credifoz	11	468975	INC0109721	 R$ 998,67 	 R$ 998,67 
  vr_incidente := 'INC0109721';
  vr_cdcooper  := 11;
  vr_nrdconta  := 468975;
  vr_vllanmto  := 998.67;
  ...
  prc_atlz_prejuizo (prm_cdcooper => vr_cdcooper,
                     ...
                     prm_tipoajus => 'I');                 
--------------------------------------------------------  
-- #13 20/9/2021	Credifoz	11	543500	INC0109721	 R$ 57,22 	 R$ 57,22  
  vr_incidente := 'INC0109721';
  vr_cdcooper  := 11;
  vr_nrdconta  := 543500;
  vr_vllanmto  := 57.22;
  ...
  prc_atlz_prejuizo (prm_cdcooper => vr_cdcooper,
                     ...
                     prm_tipoajus => 'I'); 
--------------------------------------------------------  
-- #14 24/9/2021	Credifoz	11	387142	INC0109721	 R$ 515,80 	 R$ 515,80  
  vr_incidente := 'INC0109721';
  vr_cdcooper  := 11;
  vr_nrdconta  := 387142;
  vr_vllanmto  := 515.80;
  ...
  prc_atlz_prejuizo (prm_cdcooper => vr_cdcooper,
                     ...
                     prm_tipoajus => 'I');    
--------------------------------------------------------  
-- #15 30/9/2021	Credifoz	11	533351	INC0109721	 R$ 281,45 	 R$ 281,45  
  vr_incidente := 'INC0109721';
  vr_cdcooper  := 11;
  vr_nrdconta  := 533351;
  vr_vllanmto  := 281.45;
  ...
  prc_atlz_prejuizo (prm_cdcooper => vr_cdcooper,
                     ...
                     prm_tipoajus => 'I');   
--------------------------------------------------------  
-- #16 17/9/2021	Crevisc	12	133019	INC0109721	 R$ 230,00 	 R$ 230,00 
  vr_incidente := 'INC0109721';
  vr_cdcooper  := 12;
  vr_nrdconta  := 133019;
  vr_vllanmto  := 230;
  ...
  prc_atlz_prejuizo (prm_cdcooper => vr_cdcooper,
                     ...
                     prm_tipoajus => 'I');   
--------------------------------------------------------  
-- #17 17/9/2021	Civia	13	79456	INC0109721	 R$ 924,03 	 R$ 924,03 
  vr_incidente := 'INC0109721';
  vr_cdcooper  := 13;
  vr_nrdconta  := 79456;
  vr_vllanmto  := 924.03;
  ...
  prc_atlz_prejuizo (prm_cdcooper => vr_cdcooper,
                     ...
                     prm_tipoajus => 'I');         
--------------------------------------------------------  
-- #18 20/9/2021	Civia	13	80055	INC0109721	 R$ 201,84 	 R$ 201,84 
  vr_incidente := 'INC0109721';
  vr_cdcooper  := 13;
  vr_nrdconta  := 80055;
  vr_vllanmto  := 201.84;
  ...
  prc_atlz_prejuizo (prm_cdcooper => vr_cdcooper,
                     ...
                     prm_tipoajus => 'I');   
--------------------------------------------------------  
-- #19 24/9/2021	Civia	13	365513	INC0109721	 R$ 660,00 	 R$ 660,00 
  vr_incidente := 'INC0109721';
  vr_cdcooper  := 13;
  vr_nrdconta  := 365513;
  vr_vllanmto  := 660;
  ...
  prc_atlz_prejuizo (prm_cdcooper => vr_cdcooper,
                     ...
                     prm_tipoajus => 'I');  
--------------------------------------------------------  
-- #20 24/9/2021	Viacredi AV	16	598410	INC0109721	 R$ 80,00 	 R$ 80,00
  vr_incidente := 'INC0109721';
  vr_cdcooper  := 16;
  vr_nrdconta  := 598410;
  vr_vllanmto  := 80;
  ...
  prc_atlz_prejuizo (prm_cdcooper => vr_cdcooper,
                     ...
                     prm_tipoajus => 'I'); 
--------------------------------------------------------  
-- #21 29/9/2021	Viacredi AV	16	360422	INC0109721	 R$ 274,70 	 R$ 274,70 
  vr_incidente := 'INC0109721';
  vr_cdcooper  := 16;
  vr_nrdconta  := 360422;
  vr_vllanmto  := 274.70;
