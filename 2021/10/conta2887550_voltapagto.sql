declare 
  ...
  vr_nrdconta      crapass.nrdconta%TYPE := 2887550;
  vr_nrctremp      craplem.nrctremp%TYPE := 3626426;
  vr_vllanmto      craplem.vllanmto%TYPE := 176.57;
  vr_cdhistor      craplem.cdhistor%TYPE := 3273;
  
  vr_vlsdeved      crapepr.vlsdeved%TYPE := 191734.58;
  vr_vlpagpar      crappep.vlpagpar%TYPE := 176.57;
  vr_vldespar      crappep.vldespar%TYPE := 2051.29;
