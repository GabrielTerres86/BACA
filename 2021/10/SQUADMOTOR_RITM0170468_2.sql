...
BEGIN
  ...
  values (aux_cdpartar_add, 'Meses para análise motor de quantidade de propostas aprovadas', 2, 13);

  insert into crapbat (CDBATTAR, NMIDENTI, CDPROGRA, TPCADAST, CDCADAST)
  values ('QTDPROPAPROV', 'Meses para análise motor de quantidade de propostas aprovadas', ' ', 2, aux_cdpartar_add);
