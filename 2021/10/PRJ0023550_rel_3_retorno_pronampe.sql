...
BEGIN
  ...
  BEGIN
    ...
    VALUES ('IMP_TERCEIRO_RET_PRONAM', 'TELA_PRONAM', 'pc_rel_terceiro_retorno', 'pr_nrremessa, pr_tprelato', (SELECT a.nrseqrdr FROM CRAPRDR a WHERE a.nmprogra = 'TELA_PRONAM' AND ROWNUM = 1));
  EXCEPTION
      WHEN OTHERS THEN
