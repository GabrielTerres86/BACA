...
---------------------------------------------------
  -- 01 INC0108097 Acentra, cc: 96695, R$ 996,67 
  vr_incidente := 'INC0108097';
  vr_cdcooper  := 5;
  vr_nrdconta  := 96695;
  vr_vllanmto  := 996.67;
  vr_cdhistor  := 2738;
...
---------------------------------------------------------------------
-- 02 INC0108097 Acentra, cc:135674, R$ 2.710,00 
  vr_incidente := 'INC0108097';
  vr_cdcooper  := 5;
  vr_nrdconta  := 135674;
  vr_vllanmto  := 2710;
  ...
  dbms_output.put_line('  ');
---------------------------------------------------
-- 03 INC0108097 Credelesc, cc:43885, R$ 3.014,22
  vr_incidente := 'INC0108097';
  vr_cdcooper  := 8;
  vr_nrdconta  := 43885;
  vr_vllanmto  := 3014.22;
  ...
  dbms_output.put_line('  ');
----------------------------------------------------------------
-- 04 INC0108097 Civia, cc:80217, R$ 93,75  
  vr_incidente := 'INC0108097';
  vr_cdcooper  := 13;
  vr_nrdconta  := 80217;
  vr_vllanmto  := 93.75 ;
  ...
  dbms_output.put_line('  ');
-------------------------------------------------------------------
-- 05 INC0108097 Viacredi AV, cc:260754, R$ 378,67
  vr_incidente := 'INC0108097';
  vr_cdcooper  := 16;
  vr_nrdconta  := 260754;
  vr_vllanmto  := 378.67;
