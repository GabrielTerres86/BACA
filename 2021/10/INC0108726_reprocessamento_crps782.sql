BEGIN
  ...
  BEGIN    
    ...
    vr_dtmvtoan:= to_date('07/10/2021', 'DD/MM/YYYY');
    vr_dtmvtolt:= to_date('08/10/2021', 'DD/MM/YYYY');--rw_crapdat.dtmvtolt;    
    vr_dtmvtopr:= to_date('11/10/2021', 'DD/MM/YYYY');--rw_crapdat.dtmvtolt;
