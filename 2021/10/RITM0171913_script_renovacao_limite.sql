...
DECLARE
 ...
 /*  
  --LOCAL
  vr_nmarq_carga    VARCHAR2(200) := '/progress/t0032597/micros/script_renovacao/RITM0171913/renovar_altovale.csv';           -- Arquivo a ser lido
  vr_nmarq_log      VARCHAR2(200) := '/progress/t0032597/micros/script_renovacao/RITM0171913/renovar_altovale_LOG.txt';       -- Arquivo de Log
  vr_nmarq_rollback VARCHAR2(200) := '/progress/t0032597/micros/script_renovacao/RITM0171913/renovar_altovale_ROLLBACK.sql';  -- Arquivo de Rollback
  */
  
 /*     
  --TEST
  vr_nmarq_carga    VARCHAR2(200) := GENE0001.fn_param_sistema('CRED',3,'ROOT_MICROS') || 'cecred/daniel/RITM0171913/renovar_altovale.csv';          -- Arquivo a ser lido
  vr_nmarq_log      VARCHAR2(200) := GENE0001.fn_param_sistema('CRED',3,'ROOT_MICROS') || 'cecred/daniel/RITM0171913/renovar_altovale_LOG.txt';      -- Arquivo de Log
  vr_nmarq_rollback VARCHAR2(200) := GENE0001.fn_param_sistema('CRED',3,'ROOT_MICROS') || 'cecred/daniel/RITM0171913/renovar_altovale_ROLLBACK.sql'; -- Arquivo de Rollback   
 */
...
*/
   ...
   GENE0001.pc_gera_log(pr_cdcooper =>  pr_cdcooper
                       ...
                       ,pr_dstransa => 'Renovacao manual Limite (RITM0171913)'
