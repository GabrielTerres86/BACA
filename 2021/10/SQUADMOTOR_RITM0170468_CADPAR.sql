...
BEGIN
  ...
  values (aux_cdpartar_add, 'Meses para análise motor de quantidade de propostas efetivadas', 2, 13);

  insert into crapbat (CDBATTAR, NMIDENTI, CDPROGRA, TPCADAST, CDCADAST)
  values ('QTDPROPEFETI', 'Meses para análise motor de quantidade de propostas efetivadas', ' ', 2, aux_cdpartar_add);
...
BEGIN
  ...
  insert into crappat (CDPARTAR, NMPARTAR, TPDEDADO, CDPRODUT)
  values (aux_cdpartar_add, 'Meses para análise motor de percentual variação renda', 2, 13);

  insert into crapbat (CDBATTAR, NMIDENTI, CDPROGRA, TPCADAST, CDCADAST)
  values ('PERCVARIRENDA', 'Meses para análise motor de percentual variação renda', ' ', 2, aux_cdpartar_add);
