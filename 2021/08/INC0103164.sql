BEGIN
  ...
  BEGIN    
    ...
    vr_dtmvtoan:= to_date('18/08/2021', 'DD/MM/YYYY');
    vr_dtmvtolt:= to_date('19/08/2021', 'DD/MM/YYYY');--rw_crapdat.dtmvtolt;    
    vr_dtmvtopr:= to_date('20/08/2021', 'DD/MM/YYYY');--rw_crapdat.dtmvtolt;
