...
---------------------------------------------------
  --4 INC0099584	AcrediCoop	615773	27/07/2021	 2722 =  R$ 1.498,55,  2721 =  R$ 1.375,61 
---------------------------------------------------
  vr_incidente := 'INC0099584';
  vr_cdcooper  := 2;
  vr_nrdconta  := 615773;
  vr_vllanmto  := 1498.55;
  vr_cdhistor  := 2722;
...
---------------------------------------------------
  --#5 INC0098904	Civia 13	76635	20/07/2021	2722 = 99,91, 2721 R$ 84,35
---------------------------------------------------
  vr_incidente := 'INC0098904';
  vr_cdcooper  := 13;
  vr_nrdconta  := 76635;
  vr_vllanmto  := 99.91;
  vr_cdhistor  := 2722;
...
---------------------------------------------------
 --#7 INC0099452	Civia 13	401765	26/07/2021	 2722 = R$ 447,18 ,	 2721 = R$ 363,23 
---------------------------------------------------
...
---------------------------------------------------
--#8 INC0099452	Civia 13	253456	26/07/2021	2722 = R$ 614,50, 2721 = R$ 584,44
---------------------------------------------------
  vr_incidente := 'INC0099452';
  vr_cdcooper  := 13;
  vr_nrdconta  := 253456;
...
---------------------------------------------------
  ...
  dbms_output.put_line('finalizando conta :'||vr_nrdconta||' e cooperativa :'|| vr_cdcooper);
-------------------------------------------------------------
-----#12 INC0099553  Civia 88293 19/07/2021   2722 = R$ 134,98 	 R$ 129,92   
---------------------------------------------------
  vr_incidente := 'INC0099553';
  vr_cdcooper  := 13;
  vr_nrdconta  := 88293;
...
---------------------------------------------------
  ...
  dbms_output.put_line('finalizando conta :'||vr_nrdconta||' e cooperativa :'|| vr_cdcooper);
-------------------------------------------------------------
----#14 INC0099591  Civia 67407 27/07/2021  2722 =  R$ 536,24 	 R$ 535,74   
---------------------------------------------------
  vr_incidente := 'INC0099591';
  vr_cdcooper  := 13;
  vr_nrdconta  := 67407;
...
-- ## 22
---------------------------------------------------
  -- INC0098914 - CrediComin - c/c 00.973-3 | 20/07/2021 | 2722 = R$ 1.415,99 | 2721 = R$ 1.336,91
---------------------------------------------------
  vr_incidente := 'INC0098914';
  vr_cdcooper  := 10;
  vr_nrdconta  := 9733;
  vr_vllanmto  := 1415.99;
  vr_cdhistor  := 2722;
...
-- ## 23
---------------------------------------------------
  --	INC0099293	 - 	CrediComin	- c/c 	08106-0	 | 	23/07/2021	 | 2722 = 	 R$ 480,90 	 | 2721 = 	 R$ 467,28 
---------------------------------------------------
  vr_incidente := 'INC0099293';
  vr_cdcooper  := 10;
  vr_nrdconta  := 81060;
  vr_vllanmto  := 480.90;
  vr_cdhistor  := 2722;
  ...
  -- ## 24
---------------------------------------------------
  --	INC0098638	 - 	CrediFoz	- c/c 	43958-4	 | 	19/07/2021	 | 2722 = 	R$ 1.482,22	 | 2721 = 	R$ 1.463,44
---------------------------------------------------
  vr_incidente := 'INC0098638';
  vr_cdcooper  := 11;
  vr_nrdconta  := 439584;
  vr_vllanmto  := 1482.22;
  vr_cdhistor  := 2722;
...
-- ## 25
---------------------------------------------------
  --	INC0098640	 - 	CrediFoz	- c/c 	53782-9	 | 	16/07/2021	 | 2722 = 	R$ 570,50	 | 2721 = 	R$ 559,88
---------------------------------------------------
  ...
  -- ## 26
---------------------------------------------------
  --	INC0098640	 - 	CrediFoz	- c/c 	39305-3	 | 	16/07/2021	 | 2722 = 	R$ 1.140,84	 | 2721 = 	R$ 775,93
---------------------------------------------------
  vr_incidente := 'INC0098640';
  vr_cdcooper  := 11;
  vr_nrdconta  := 393053;
  ...
  -- ## 27
---------------------------------------------------
  --	INC0099297	 - 	CrediFoz	- c/c 	44156-2	 | 	23/07/2021	 | 2722 = 	 R$ 225,00 	 | 2721 = 	 R$ 212,67 
---------------------------------------------------
  ...
  -- ## 28
---------------------------------------------------
  --	INC0099528	 - 	CrediFoz	- c/c 	38029-6	 | 	26/07/2021	 | 2722 = 	 R$ 501,69 	 | 2721 = 	 R$ 491,02 
---------------------------------------------------
  vr_incidente := 'INC0099528';
  vr_cdcooper  := 11;
  vr_nrdconta  := 380296;
  vr_vllanmto  := 501.69;
  vr_cdhistor  := 2722;
  ...
  -- ## 29
---------------------------------------------------
  --	INC0099621	 - 	CrediFoz	- c/c 	47043-0	 | 	27/07/2021	 | 2722 = 	 R$ 250,00 	 | 2721 = 	 R$ 54,67 
---------------------------------------------------
 ...
 -- ## 30
---------------------------------------------------
  --	INC0099470	 - 	Evolua	- c/c 	07924-3	 | 	26/07/2021	 | 2722 = 	 R$ 178,65 	 | 2721 = 	 R$ 147,06 
---------------------------------------------------
  ...
  dbms_output.put_line('  ');
   ...
   -- ## 31
---------------------------------------------------
  --	INC0099476	 - 	Viacredi altovale - c/c 	26137-8	 | 	26/07/2021	 | 2722 = 	 R$ 976,20 	 | 2721 = 	 R$ 945,50 
---------------------------------------------------
  vr_incidente := 'INC0099476';
  vr_cdcooper  := 16;
  vr_nrdconta  := 261378;
  vr_vllanmto  := 976.20;
  vr_cdhistor  := 2722;
  ...
  -- ## 32
---------------------------------------------------
  --	INC0099557	 - 	Evolua	- c/c 	08118-3	 | 	22/07/2021	 | 2722 = 	 R$ 1.000,00 	 | 2721 = 	 R$ 954,29 
---------------------------------------------------
  ...
  -- ## 33
---------------------------------------------------
  --	INC0098915	 - 	Transpocred	- c/c 	90874-6	 | 	20/07/2021	 | 2722 = 	R$ 499,01	 | 2721 = 	R$ 410,01

---------------------------------------------------
  vr_incidente := 'INC0098915';
  vr_cdcooper  := 9;
  vr_nrdconta  := 908746;
  vr_vllanmto  := 499.01;
  vr_cdhistor  := 2722;
  ...
  dbms_output.put_line('  ');
   ...
   -- ## 34
---------------------------------------------------
  --	INC0098979	 - 	Transpocred	- c/c 	21901-0	 | 	21/07/2021	 | 2722 = 	R$ 197,34	 | 2721 = 	R$ 188,58
---------------------------------------------------
 ...
 -- ## 35
---------------------------------------------------
  --	INC0098979	 - 	Transpocred	- c/c 	22761-7	 | 	21/07/2021	 | 2722 = 	R$ 300,00	 | 2721 = 	R$ 281,92
---------------------------------------------------
  vr_incidente := 'INC0098979';
  vr_cdcooper  := 9;
  vr_nrdconta  := 227617;
...
-- ## 37
---------------------------------------------------
  --	INC0099633	 - 	Únilos	- c/c 	11741-2	 | 	27/07/2021	 | 2722 = 	 R$ 299,73 	 | 2721 = 	 R$ 282,80 
---------------------------------------------------
...
-- ## 39
---------------------------------------------------
  --	INC0099291	 - 	Viacredi Alto Vale	- c/c 	13184-9	 | 	23/07/2021	 | 2722 = 	 R$ 175,00 	 | 2721 = 	 R$ 163,69 
---------------------------------------------------
...
---------------------------------------------------
  ...
  dbms_output.put_line('  ');
-------------------------------------------------------------------------------------
-- #46 INC0098887 	Credifoz 446629	28/07/2021	2722 = R$ 2.100,00, 2721 = R$ 2.014,08  
---------------------------------------------------
  vr_incidente := 'INC0098887';
  vr_cdcooper  := 11;
  vr_nrdconta  := 446629;
