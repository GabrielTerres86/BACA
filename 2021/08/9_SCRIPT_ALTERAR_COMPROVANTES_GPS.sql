...
BEGIN     
  ...
  gene0001.pc_abre_arquivo(pr_nmcaminh => '/usr/connect/tivit/TEMP_LISTA_PAGAMENTOS/GPS/4_LISTA_PAGAMENTOS_GPS.TXT',
                           pr_tipabert => 'R',
  ...
  LOOP
    BEGIN
      ...
      dbms_output.put_line(rw_registros_lgp.idsicred);
