...
BEGIN
  ...
  INSERT INTO tbgen_layout_campo (IDLAYOUT, TPREGISTRO, NRSEQUENCIA_CAMPO, NMCAMPO, TPDADO, DSFORMATO, NRPOSICAO_INICIAL, QTDPOSICOES, QTDDECIMAIS, DSOBSERVACAO, DSIDENTIFICADOR_REGISTRO)
  VALUES (vr_idcampo, '91', 3, 'VLAMOVIMENTAR', 'N', null, 14, 17, null, 'VALOR A SER MOVIMENTADO', null);
  ...
  INSERT INTO tbgen_layout_campo (IDLAYOUT, TPREGISTRO, NRSEQUENCIA_CAMPO, NMCAMPO, TPDADO, DSFORMATO, NRPOSICAO_INICIAL, QTDPOSICOES, QTDDECIMAIS, DSOBSERVACAO, DSIDENTIFICADOR_REGISTRO)
  VALUES (vr_idcampo, '91', 6, 'VLARETERISSQN', 'N', null, 40, 17, null, 'VALOR A SER RETIRO PARA RECOLHIMENTO DO ISSQN', null);
  ...
  INSERT INTO tbgen_layout_campo (IDLAYOUT, TPREGISTRO, NRSEQUENCIA_CAMPO, NMCAMPO, TPDADO, DSFORMATO, NRPOSICAO_INICIAL, QTDPOSICOES, QTDDECIMAIS, DSOBSERVACAO, DSIDENTIFICADOR_REGISTRO)
  VALUES (vr_idcampo, '96', 2, 'VLBASECALC', 'N', null, 10, 17, null, 'BASE DE CALCULO LIMITE FGO', null);

  INSERT INTO tbgen_layout_campo (IDLAYOUT, TPREGISTRO, NRSEQUENCIA_CAMPO, NMCAMPO, TPDADO, DSFORMATO, NRPOSICAO_INICIAL, QTDPOSICOES, QTDDECIMAIS, DSOBSERVACAO, DSIDENTIFICADOR_REGISTRO)
  VALUES (vr_idcampo, '96', 3, 'VLLIMFGO', 'N', null, 44, 17, null, 'LIMITE MAXIMO CARTEIRA FGO', null);

  INSERT INTO tbgen_layout_campo (IDLAYOUT, TPREGISTRO, NRSEQUENCIA_CAMPO, NMCAMPO, TPDADO, DSFORMATO, NRPOSICAO_INICIAL, QTDPOSICOES, QTDDECIMAIS, DSOBSERVACAO, DSIDENTIFICADOR_REGISTRO)
  VALUES (vr_idcampo, '96', 4, 'VLLIMAGENTE', 'N', null, 61, 17, null, 'LIMITE MAXIMO CARTEIRA AGENTE', null);

  INSERT INTO tbgen_layout_campo (IDLAYOUT, TPREGISTRO, NRSEQUENCIA_CAMPO, NMCAMPO, TPDADO, DSFORMATO, NRPOSICAO_INICIAL, QTDPOSICOES, QTDDECIMAIS, DSOBSERVACAO, DSIDENTIFICADOR_REGISTRO)
  VALUES (vr_idcampo, '96', 5, 'VLCMPRMFGO', 'N', null, 78, 17, null, 'VALOR COMPROMETIDO FGO', null);

  INSERT INTO tbgen_layout_campo (IDLAYOUT, TPREGISTRO, NRSEQUENCIA_CAMPO, NMCAMPO, TPDADO, DSFORMATO, NRPOSICAO_INICIAL, QTDPOSICOES, QTDDECIMAIS, DSOBSERVACAO, DSIDENTIFICADOR_REGISTRO)
  VALUES (vr_idcampo, '96', 6, 'VLCOMPRMAGENTE', 'N', null, 95, 17, null, 'VALOR COMPROMETIDO AGENTE', null);
