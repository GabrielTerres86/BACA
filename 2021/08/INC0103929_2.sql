  ...
  PROCEDURE pc_efetiva_reg_pendentes(pr_dtprocesso IN DATE,
    ...
    CURSOR cr_lancamento IS
       ...
       WHERE lct.idarquivo = arq.idarquivo
		 ...
		 and arq.nmarquivo_origem like 'ASLC024%'
		 and pdv.dsocorrencia_retorno = 'ESLC0129'
		 and to_date(pdv.dtpagamento, 'RRRR-MM-DD') = to_date('30/08/2021', 'DD/MM/RRRR')
		 and trunc(arq.dhrecebimento) >= to_date('26/08/2021', 'DD/MM/RRRR')
