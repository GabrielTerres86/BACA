...
BEGIN
  ...
  vr_cdcooper := 1;
  vr_nrdconta := 10610715;

  GENE0001.pc_gera_log(pr_cdcooper => vr_cdcooper,
                       pr_cdoperad => vr_cdoperad,
                       pr_dscritic => vr_dscritic,
                       pr_dsorigem => 'AIMARO',
                       pr_dstransa => 'Alteracao da situacao de conta por script - INC0116143',
  ...
  GENE0001.pc_gera_log_item(pr_nrdrowid => vr_nrdrowid,
                            ...
                            pr_dsdadatu => rg_crapsld.vlsddisp + 1500.00);
  UPDATE crapsld a
     SET a.VLSDDISP = a.vlsddisp + 1500.00
   WHERE a.nrdconta = 10610715
       AND a.cdcooper = 1;
  ...
  FOR rg_crapass IN cr_crapsda LOOP
    ...
    GENE0001.pc_gera_log_item(pr_nrdrowid => vr_nrdrowid,
                              ...
                              pr_dsdadatu => rg_crapass.vlsddisp + 1500.00);
   end loop;
