DECLARE
  ...
  vr_nrctrlim  craplim.nrctrlim%TYPE := 100834;
  ...
  CURSOR cr_crawlim(pr_cdcooper IN craplim.cdcooper%TYPE
                   ...
                   ,pr_nrctrmnt IN craplim.nrctrlim%TYPE
...
BEGIN
  ...
  -- Efetuar o desbloqueio de possíveis coberturas vinculadas ao limite anterior
