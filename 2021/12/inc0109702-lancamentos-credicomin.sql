declare 
  ...
  vr_nrdconta      crapass.nrdconta%TYPE := 150843;
  vr_nrctremp      craplem.nrctremp%TYPE := 13213;
  vr_vllanmto      craplem.vllanmto%TYPE := 176.47;
...
declare 
  ...
  vr_nrdconta      crapass.nrdconta%TYPE := 150843;
  vr_nrctremp      craplem.nrctremp%TYPE := 13213;
  vr_vllanmto      craplem.vllanmto%TYPE := 251.26;
