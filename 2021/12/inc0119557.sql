...
-- ## 01
---------------------------------------------------
  -- c/c: 83429, 2408 C valor R$ 295,00 Crevisc
---------------------------------------------------
  vr_incidente := 'INC0119557';
  vr_cdcooper  := 12;
  vr_nrdconta  := 83429;
  vr_vllanmto  := 295;
  vr_cdhistor  := 2408; 
...
-- ## 02
---------------------------------------------------
  -- c/c: 8075301, 2408 D valor R$ 46.42  Viacredi
---------------------------------------------------
  vr_cdcooper  := 1;
  vr_nrdconta  := 8075301;
  vr_vllanmto  := 46.42;
...
-- ## 03
---------------------------------------------------
  -- c/c: 125520, 2408 D valor R$ 58.85  Unilos
---------------------------------------------------
  vr_cdcooper  := 6;
  vr_nrdconta  := 125520;
  vr_vllanmto  := 58.85;
...
-- ## 04
---------------------------------------------------
  -- c/c: 10824308, 2408 D valor R$ 11,54  Viacredi
---------------------------------------------------
  vr_cdcooper  := 1;
  vr_nrdconta  := 10824308;
  vr_vllanmto  := 11.54;
  vr_cdhistor  := 2408; 
  dbms_output.put_line('  ');
  dbms_output.put_line('-------- '|| vr_incidente || ' - INICIO --------');
...
-- ## 05
---------------------------------------------------
  -- c/c: 10686096, 2408 D valor R$ 28,33  Viacredi
---------------------------------------------------
  vr_cdcooper  := 1;
  vr_nrdconta  := 10686096;
  vr_vllanmto  := 28.33;
  vr_cdhistor  := 2408; 
  dbms_output.put_line('  ');
  dbms_output.put_line('-------- '|| vr_incidente || ' - INICIO --------');
