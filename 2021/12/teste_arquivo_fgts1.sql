DECLARE
  ...
  vr_dtmvtolt crapdat.dtmvtolt%TYPE := to_date('01/12/2021','DD/MM/YYYY');
  vr_dtmvtopr crapdat.dtmvtopr%TYPE := to_date('01/12/2021','DD/MM/YYYY');
  vr_dtmvtoan crapdat.dtmvtoan%TYPE := to_date('01/12/2021','DD/MM/YYYY');
  vr_dtmvtocd crapdat.dtmvtocd%TYPE := to_date('01/12/2021','DD/MM/YYYY');
