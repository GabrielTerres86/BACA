...
BEGIN
  ...
  values (aux_cdpartar_add, 'RITM0181232 - Variaveis JSON (1-Ligado/0-Desligado)', 2, 13);

  insert into crapbat (CDBATTAR, NMIDENTI, CDPROGRA, TPCADAST, CDCADAST)
  values ('RITM0181232', 'RITM0181232 - Variaveis JSON (1-Ligado/0-Desligado)', ' ', 2, aux_cdpartar_add);
