DECLARE
  ...
  begin
    ...
    GENE0001.pc_gera_log(pr_cdcooper => pr_cdcoopercc,
                         ...
                         pr_dsorigem => 'AIMARO',
                         pr_dstransa => 'Alteracao da situacao de conta por script - INC0117031 - Conta - ' || pr_nrdcontacc || ' - ' || pr_cdcoopercc,
...
BEGIN
  CorrigeConta(pr_nrdcontacc => 13206176,
               pr_cdcoopercc => 1,
               pr_sldadd   => 316.43,
               pr_dtmvtoltcc => TO_DATE('06/12/2021', 'dd/mm/yyyy'));
