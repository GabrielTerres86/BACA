declare
  ...
  vr_nmdireto        VARCHAR2(4000) := vr_rootmicros||'/cpd/bacas/maicon';
  vr_nmarqimp        VARCHAR2(100)  := 'baca_liquid_contrato.csv';   
...
BEGIN
  ...
  LOOP
      ...
      EMPR0001.pc_cria_lancamento_cc(pr_cdcooper => vr_cdcooper   --> Cooperativa conectada
                                    ...
                                    ,pr_cdhistor => 362  --> Codigo historico
                                    ,pr_vllanmto => 10000   
                                    ,pr_nrparepr => 0   
     ...
     END IF;      
      ...
      empr0011.pc_efetua_pgto_parc_pos_prog(pr_cdcooper => vr_cdcooper,
                                            pr_nmdatela => 'ATENDA',
