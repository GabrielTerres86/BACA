...
BEGIN
  ...
  BEGIN
    ...
    FOR rw_crapcop IN cr_crapcop LOOP
      INSERT INTO crapprm (nmsistem, cdcooper, cdacesso, dstexprm, dsvlrprm) values ('CRED', rw_crapcop.cdcooper, 'CD_ATIVAR_MOBILE_RECAN'  , 'Ativar Mobile - Renegociação.'      , '1');
      INSERT INTO crapprm (nmsistem, cdcooper, cdacesso, dstexprm, dsvlrprm) values ('CRED', rw_crapcop.cdcooper, 'CD_ATIVAR_CNT_ONLN_RECAN', 'Ativar Conta Online - Renegociação.', '1');
    END LOOP;
