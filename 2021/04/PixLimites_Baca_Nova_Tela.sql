...
BEGIN
  ...
  FOR rw_crapcop IN (SELECT cdcooper FROM crapcop where cdcooper = 3) LOOP 
    ...
    values ('LIMITE', 7, '@,C,I,A,E', 'Consulta e Gerenciamento de Limites', 'Consulta e Gerenciamento de Limites', 0, 1, ' ', 'ACESSO,CONSULTAR,INSERIR,ALTERAR,EXCLUIR', 2, rw_crapcop.cdcooper, 1, 0, 0, 0, ' ', 0);
 ...
 INSERT INTO crapaca
  ...
  INSERT INTO crapaca
    (nmdeacao, nmpackag, nmproced, lstparam, nrseqrdr)
  VALUES
    ('EXCLUIR_FAIXA','TELA_LIMITE','pc_excluir_faixa','pr_idfailim,pr_tlcooper,pr_cdprodut',vr_nrseqrdr);
  ...
  INSERT INTO crapaca
    (nmdeacao, nmpackag, nmproced, lstparam, nrseqrdr)
  VALUES
    ('LISTA_COOP_PIX','TELA_LIMITE','pc_lista_cooperativas','pr_cdcopsel,pr_flgativo',vr_nrseqrdr);	
