DECLARE
  ...
  CURSOR cr_crapass is 
    ...
    FROM CECRED.CRAPASS
    WHERE ( cdcooper = 1
        and nrdconta   IN (9819983,9619283,8321469,10544100,10085858,9732861,8635242,10476458,9746480,10776044,9669353,9267450,8220980,8197130) -- VIACREID
      )
      OR ( cdcooper = 11
        and nrdconta   IN (246581)  -- CREDIFOZ

      )
	  OR ( cdcooper = 7
        and nrdconta   IN (334936)  -- CREDCREA
...
BEGIN
  ...
  LOOP
    ...
    vr_log_script := vr_log_script || chr(10) || 'Atualização da conta: (' 
                     ...
                     || ') para (4)';
    --
    vr_dstransa := 'Alterada situacao de conta por script. INC0090362.';
    --
