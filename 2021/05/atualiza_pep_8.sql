  ...
  FOR rw_crapass IN cr_crapass LOOP
    ...
    BEGIN
      ...
      IF instr(vr_res_body, '<DATA>') > 0 THEN
        ...
        BEGIN
          IF instr(vr_pep.vr_dsrelacmnto, ' CONJUGE ') > 0 THEN
          ...
          ELSIF instr(vr_pep.vr_dsrelacmnto, 'TIO/TIA') > 0 OR instr(vr_pep.vr_dsrelacmnto, 'TIA/TIO') > 0 OR instr(vr_pep.vr_dsrelacmnto, ' TIO ') > 0 OR instr(vr_pep.vr_dsrelacmnto, ' TIA ') > 0 THEN
