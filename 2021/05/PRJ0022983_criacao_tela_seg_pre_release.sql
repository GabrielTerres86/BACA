...
values
  ((select max(NRSEQACA) + 1 from crapaca),
   ...
   'TELA_SEGPRE',
   'pc_alterar',
   'PR_IDSEQPAR, PR_CDCOOPER,   PR_TPPESSOA,   PR_CDSEGURA, PR_TPDPAGTO, PR_QTPARCEL, PR_SEGMAT65, PR_SEGMAP65, PR_SEGIAT65, PR_SEGIAP65, PR_PIEDIAS,  PR_PIEPARCE, PR_PIELIMIT, PR_PIETAXA,  PR_IFTTDIAS, PR_IFTTPARC, PR_IFTTLIMI, PR_IFTTTAXA, PR_LMPSELEG, PR_TPCUSTEI, PR_VLCOMISS, PR_TPADESAO, PR_LIMITDPS, PR_VIGENCIA, PR_NRAPOLIC, PR_ENDERFTP, PR_LOGINFTP, PR_SENHAFTP, PR_FLGELEPF, PR_FLGINDEN',   
