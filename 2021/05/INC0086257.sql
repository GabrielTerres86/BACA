...
BEGIN
  ...
  vr_nmdireto := gene0001.fn_diretorio(pr_tpdireto => 'C', pr_cdcooper => 13, pr_nmsubdir => '/log');
        
  -- Abrir arquivo
  GENE0001.pc_abre_arquivo(pr_nmdireto => vr_nmdireto
                          ,pr_nmarquiv => 'estorna_juros_de_mora_indev_consig.txt'                                          
                          ,pr_tipabert => 'A'
  ...
  FOR rw_craplem IN cr_craplem  LOOP     
      ...
      vr_linha := ' Cooperativa:'      || rw_craplem.cdcooper    || ';' ||
                  ...
                  ' Historico:'        || '1711-ESTORNO JUROS TAXA PRE-FIXADA;';
