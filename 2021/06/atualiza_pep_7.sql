DECLARE--2478,376
  ...
  vr_nmarquiv   VARCHAR2(100)  := 'atualizacao_pep_7.csv';
  ...
  CURSOR cr_crapass IS
    SELECT crapttl.nrcpfcgc
     ...
     WHERE crapass.nrdconta = crapttl.nrdconta
       ...
       AND crapass.cdcooper = 7
       AND (crapass.nrcpfcgc in (56379692991,5838667940,50171704991,1838151141,4074616980,1025982908,577269909,
                                34308164915,5060022927,8596339930,8810274806,1471565998,2565497962,657306908,
                                7776343927,67449352915,9204711965,10099211939,74543580206,4423804964,622866095,
                                2594576980,93269455968,2850752924,2638425923,8596338969,927854929,2021379965,
                                5670886933,5829931990,2976590907,3300369983,4697338960,60806567953,71479422991,
                                4976868990,11912413000,2120588945,10519023986,93112360044,8769059985,369598989,
                                6246155960,6789956999,71479422991,6789956999,6249787968,3691194958,82373051915)
