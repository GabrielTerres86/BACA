DECLARE--2514,889
  ...
  vr_nmarquiv   VARCHAR2(100)  := 'atualizacao_pep_14.csv';
  ...
  CURSOR cr_crapass IS
    SELECT crapttl.nrcpfcgc
     ...
     WHERE crapass.nrdconta = crapttl.nrdconta
       ...
       AND crapass.cdcooper = 14
       AND (crapass.nrcpfcgc in (19690568949,89457480910,88086690920,95536949934,52467856968,7830665974,97128970959,
                                6242214903,3247284923,6478214940,6939227962,4653382913,454881002,4902704927,
                                30300525915,3448893943,37064738953,9000130956,2257127927,3619529965,83160159949,
                                71869166949,3196988902,7111990943,55520910944,6513502985,5182887906,84309490972,
                                43123139972,57507287904,9898376961,2739296908,90489845991,37296345934,45118396972,
                                7475664961,49230450944,6995180917,38818256904,7260670916,80640290906,14165147915,
                                4653382913,5461697917,8865166924,47647329987,8235086921,5421602931,6015414995,
                                7642711999,6121562900,5392413935,83642277934,4891468998,10934425906,4713014931,
                                52541797915,28497864972,3382534916,85688452900,7678024975,8307434998)
