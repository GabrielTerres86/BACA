  ...
  CURSOR cr_crapass IS
    SELECT crapttl.nrcpfcgc
     ...
     WHERE crapass.nrdconta = crapttl.nrdconta
       ...
       AND (crapass.nrcpfcgc in (1988477930,5283743977,42387981987,7978113973,5190430901,83202129953,50770837034,
                                6751637900,59374829991,4496539942,1728080908,29504902987,45495939972,70806276991,
                                3601636964,65333420963,79678831953,29533791934,89782640930,7918924924,63917769972,
                                85432032287,7180612928)
