DECLARE--215,328
  ...
  vr_nmarquiv   VARCHAR2(100)  := 'atualizacao_pep_15.csv';
  ...
  CURSOR cr_crapass IS
    SELECT crapttl.nrcpfcgc
     ...
     WHERE crapass.nrdconta = crapttl.nrdconta
       ...
       AND crapass.cdcooper = 15
       AND (crapass.nrcpfcgc in (7446568933,49957503987,49957503987,90519620968,19322186968,47215933920,24380997987)
