DECLARE--1846,872
  ...
  vr_nmarquiv   VARCHAR2(100)  := 'atualizacao_pep_6.csv';
  ...
  CURSOR cr_crapass IS
    SELECT crapttl.nrcpfcgc
     ...
     WHERE crapass.nrdconta = crapttl.nrdconta
       ...
       AND crapass.cdcooper = 6
       AND (crapass.nrcpfcgc in (16929039934,7037150975,3612488902,48106569934,4839809941,6161135957,10757544967,
                                14524635904,818092980,48106569934,93223285920,83395121968,7050984,162441096,
                                93223285920,2120588945,10707157943,6688119943,34472509920)
