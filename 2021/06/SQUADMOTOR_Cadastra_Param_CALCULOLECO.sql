...
BEGIN
  ...
  values (aux_cdpartar_add, 'Calcular LECO (job) - (0-Desligado / 1-Ligado)', 1, 12);

  insert into crapbat (CDBATTAR, NMIDENTI, CDPROGRA, TPCADAST, CDCADAST)
  values ('CALCULOLECO', 'Calcular LECO (job) - (0-Desligado / 1-Ligado) ', ' ', 2, aux_cdpartar_add);
