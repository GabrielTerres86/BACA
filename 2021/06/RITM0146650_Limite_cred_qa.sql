---atualizar cdageimp no limite credito
DECLARE
  ...
  CURSOR c1 (pr_cdcooper IN crapcop.cdcooper%TYPE)  IS
    SELECT craplim.cdopelib
     ...
     WHERE craplim.cdcooper = pr_cdcooper
       ...
       AND UPPER(crapope.cdoperad) = UPPER(craplim.cdopelib)     
...
BEGIN
  ...
  -- caminho para produção:
     ...
     vr_nmarq_rollback := vr_dsdireto||'RITM0146650_Limite_cred_ROLLBACK.sql';
