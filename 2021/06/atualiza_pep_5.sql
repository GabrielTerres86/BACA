DECLARE--2542,536 alterado para 11
  ...
  vr_nmarquiv   VARCHAR2(100)  := 'atualizacao_pep_5.csv';
  ...
  CURSOR cr_crapass IS
    SELECT crapttl.nrcpfcgc
     ...
     WHERE crapass.nrdconta = crapttl.nrdconta
       ...
       AND crapass.cdcooper = 5
       AND (crapass.nrcpfcgc in (10727009990,2533126985,5153364917,71917292953,48005231920,81205376968,39546926,9530500920,
                                1843859971,3780125927,9495561906,82075280959,48052388953,41675665915,5352527905,3186228905,
                                39605957,32606028015,53121236920,3746987911,8294418919,55859607920,8209254979,4825883907,
                                1439716978,56581637904,4186297908,2874095974,55139426900,1439716978,3912435944,2336147963,
                                2127879937,334953944,434607983,5299778937,51390990982,17903645900,11043484973,82372047949)
