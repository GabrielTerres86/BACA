DELETE FROM craptel WHERE nmdatela = 'SEGPRE';
DELETE FROM crapace WHERE nmdatela = 'SEGPRE'; 
DELETE FROM crapprg WHERE cdprogra = 'SEGPRE';
DELETE FROM crapaca WHERE NMPACKAG = 'TELA_SEGPRE';
DELETE FROM CRAPRDR WHERE nmprogra = 'TELA_SEGPRE';
