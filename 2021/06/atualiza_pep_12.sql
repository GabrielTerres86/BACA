DECLARE--1770,390
  ...
  vr_nmarquiv   VARCHAR2(100)  := 'atualizacao_pep_12.csv';
  ...
  CURSOR cr_crapass IS
    SELECT crapttl.nrcpfcgc
     ...
     WHERE crapass.nrdconta = crapttl.nrdconta
       ...
       AND crapass.cdcooper = 12
       AND (crapass.nrcpfcgc in (82794138987,83119671991,82717842934,6988974989,3973302944,4200072963,4056406928,
                                433188944,59950714915,453829996,78613965920,4715923904,24717983904,421527986,
                                6333481980,607799935,961428988,93556527987,3761336942,60459034987,10198454902,
                                6691067983,24716596915,4089532922,86027565934,43968252934)
