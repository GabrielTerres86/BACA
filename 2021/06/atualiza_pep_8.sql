  ...
  CURSOR cr_crapass IS
    SELECT crapttl.nrcpfcgc
     ...
     WHERE crapass.nrdconta = crapttl.nrdconta
       ...
       AND (crapass.nrcpfcgc in (37676202949,88796094915,2782788922,69038783949,67502962972,1603204962,94217890915,
                                80738346934,3922602983,38267306072,7431681941,4756558933)
