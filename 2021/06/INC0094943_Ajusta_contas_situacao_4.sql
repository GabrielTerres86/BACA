DECLARE
  ...
  CURSOR cr_crapass is 
    ...
    FROM CECRED.CRAPASS
    WHERE ( cdcooper = 1
        and nrdconta   IN (10285784,855219,10950710,9919635,7915977,9886680,7373759,10373365,10046038,10806270,9308091,11303751,8271356,10550330,9650210,10295763,9885765,10985417,
...
BEGIN
  ...
  LOOP
    ...
    vr_log_script := vr_log_script || chr(10) || 'Atualização da conta: (' 
                     ...
                     || ') para (4)';
    --
    vr_dstransa := 'Alterada situacao de conta por script. INC0094943.';
    --
