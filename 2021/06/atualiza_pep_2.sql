DECLARE--4263.103, alterado para 
  ...
  vr_nmarquiv   VARCHAR2(100)  := 'atualizacao_pep_2.csv';
  ...
  CURSOR cr_crapass IS
    SELECT crapttl.nrcpfcgc
     ...
     WHERE crapass.nrdconta = crapttl.nrdconta
       ...
       AND crapass.cdcooper = 2
       AND (crapass.nrcpfcgc in (67489958920,355573970,870554905,8621766973,9697170916,2189115990,3476214907,
                                606533966,91864259949,46933654915,89087941900,2627007947,4075728994,83083863934,
                                79129412900,17565057991,1505994985,7794076951,5114404997,90129776904,7834321943,
                                88984290963,12586999908,7872302942,4161634919,5974998960,82367671249,377994952,
                                1777876940,83083863934,82178330959,48483362953,21992282900,57239258904,21768471991,
                                5576383990,4459227967,2612047930,7233571961,85918342915,24823686934,51779684991,
                                49922459949,2931502901,4830132930,48637114920,2766049975,2590519931,460500945)
