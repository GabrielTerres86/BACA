...
declare 
  ...
  /*!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!*/
  wpr_dtmvtolt DATE                  := to_date('31/01/2021','dd/mm/yyyy');
  wpr_dtmvtoan DATE;
  wpr_dtmvtopr DATE;
...
BEGIN  
  ...
  UPDATE tbgen_batch_relatorio_wrk wrk
     SET wrk.cdprograma = 'CRPS280_old'
   WHERE wrk.cdcooper   = 1
     AND wrk.cdprograma = 'CRPS280'
     AND wrk.dtmvtolt   = wpr_dtmvtolt;
  ...
  UPDATE tbgen_batch_relatorio_wrk wrk
     SET wrk.cdprograma = 'CRPS280'
   WHERE wrk.cdcooper   = 1
     AND wrk.cdprograma = 'CRPS280_old'
     AND wrk.dtmvtolt   = wpr_dtmvtolt;
