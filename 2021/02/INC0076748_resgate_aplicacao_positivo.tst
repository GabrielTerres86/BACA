...
vr_nmdireto        VARCHAR2(4000) := vr_rootmicros||'cpd/bacas/INC0076748'; 
  ...
  CURSOR cr_aplica IS   
   SELECT  7 cdcooper, 222771 nrdconta, 11243  nrctrrpp, 10 nraplica,  'AABTD3AABAAESJ7AAs' rowidlac FROM dual ;
...
BEGIN
  ...
  FOR rw_aplica IN cr_aplica LOOP
    ...
    RAISE vr_excsaida;
    END;
    backup2('update from craplac set cdhistor = 2747 where rowid = '||rw_aplica.rowidlac||';'); 
