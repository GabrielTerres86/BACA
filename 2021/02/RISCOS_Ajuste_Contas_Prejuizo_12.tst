...
-- ## 01
---------------------------------------------------
  -- INC0078004 - Viacredi - C/C 6934293  - R$ 3117.46
  -- -> Solução: Incluir um 2408 no valor de R$ 3117.46
---------------------------------------------------
  vr_incidente := 'INC0078004';
  vr_cdcooper  := 1;
  vr_nrdconta  := 6934293;
  vr_vllanmto  := 3117.46;
  vr_cdhistor  := 2408;
...
---------------------------------------------------
  -- INC0076113 - VIACREDI AV - Conta: 94382
  -- => Solução: gerar um 2408 de R$ 0,08 para zerar a transitória.
  vr_incidente := 'INC0076113';
  vr_cdcooper  := 16;
  vr_nrdconta  := 94382;
  vr_vllanmto  := 0.08;
  vr_cdhistor  := 2408;
