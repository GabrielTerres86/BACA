...
BEGIN
  ...
  FOR rw_saldo_extrato IN cr_saldo_extrato LOOP
     ...
     AND rw_saldo_fis.vlsdev_empratu_d0 = 0 THEN
        ...
        IF rw_saldo_extrato.inliquid = 0 THEN
          UPDATE crapepr
          SET  inliquid = 1
          WHERE cdcooper = rw_saldo_extrato.cdcooper
          AND   nrdconta = rw_saldo_extrato.nrdconta
          AND   nrctremp = rw_saldo_extrato.nrctremp;
        END IF;
