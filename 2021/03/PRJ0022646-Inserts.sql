BEGIN
  ...
  BEGIN
    ...
    values
      ('CRED',
       1,
       'DT_VIGENCIA_BINS_AFINS',
       'Data de vigência de inicio das atividades com os novos BINS e Grupos Afinidade',
       '01/07/2021');
  ...
  BEGIN
    UPDATE tbcrd_grupo_afinidade_bin
       SET dtvigencia = '01/07/2021';
  END;
