BEGIN
  ...
  UPDATE crapepr SET vlpgjmpr = 49.28 WHERE cdcooper = 1 AND nrdconta = 10386378 AND nrctremp = 1689700;
  UPDATE crapepr SET vlpgjmpr = 62.35 WHERE cdcooper = 1 AND nrdconta = 6616143 AND nrctremp = 1787182;
  UPDATE crapepr SET vlpgjmpr = 50.51 WHERE cdcooper = 1 AND nrdconta = 8107572 AND nrctremp = 1871323;
  ...
  UPDATE crapepr SET vlpgjmpr = 32 WHERE cdcooper = 1 AND nrdconta = 6954456 AND nrctremp = 1958200;
  UPDATE crapepr SET vlpgjmpr = 58.95 WHERE cdcooper = 1 AND nrdconta = 9351981 AND nrctremp = 1816451;
  UPDATE crapepr SET vlpgjmpr = 169.8 WHERE cdcooper = 1 AND nrdconta = 8384991 AND nrctremp = 1828426;
  UPDATE crapepr SET vlpgjmpr = 61.58 WHERE cdcooper = 1 AND nrdconta = 6668305 AND nrctremp = 1962835;
  UPDATE crapepr SET vlpgjmpr = 110.02 WHERE cdcooper = 1 AND nrdconta = 9923462 AND nrctremp = 1879004;
  UPDATE crapepr SET vlpgjmpr = 17.68 WHERE cdcooper = 1 AND nrdconta = 3785297 AND nrctremp = 2337593;
