...
DECLARE
  ...
  -- ALTERAR
  NOME_DA_ACAO       VARCHAR2(40)  := 'CALCULA_RISCO_OPERACAO';
  PROCEDURE_DA_ACAO  VARCHAR2(100) := 'calcularRiscoOperacaoWeb';
  PACKAGE_DA_ACAO    VARCHAR2(100) := 'ATENDA';
  PARAMETROS_DA_ACAO VARCHAR2(1000):= 'pr_nrdconta,pr_nrctrato,pr_tpctrato';
  -- FIM ALTERAR
...
BEGIN
  ...
  IF CR_CRAPACA%NOTFOUND THEN
    ...
    DBMS_OUTPUT.PUT_LINE('INSERE CRAPACA -> '||NOME_DA_ACAO||' -> '||'EMPR0021'||'.'||PROCEDURE_DA_ACAO);
