DECLARE
  ...
  CURSOR cr_crapass is 
    ...
    WHERE 
      ...
      -- CIVIA
      OR ( cdcooper = 13
        and nrdconta   IN (162892
                           ,336521)
      )
      -- EVOLUA
      OR ( cdcooper = 14
        and nrdconta   IN (61409)
      )
      -- ACENTRA
      OR ( cdcooper = 5
        and nrdconta   IN (171018)
      );
  --
...
BEGIN
  ...
  LOOP
    ...
    vr_log_script := vr_log_script || chr(10) || 'Atualização da conta: (' 
                     ...
                     || ') para (8)';
    --
    vr_dstransa := 'INC0084476 - Conta alterada para situacao 8.';
    --
