BEGIN
  ...
  BEGIN    
    ...
    vr_dtmvtoan:= to_date('12/07/2021', 'DD/MM/YYYY');
    vr_dtmvtolt:= to_date('13/07/2021', 'DD/MM/YYYY');--rw_crapdat.dtmvtolt;    
    vr_dtmvtopr:= to_date('14/07/2021', 'DD/MM/YYYY');--rw_crapdat.dtmvtolt;
