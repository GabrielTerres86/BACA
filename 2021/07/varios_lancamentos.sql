...
---------------------------------------------------
  --INC0099551 - Civia 19/07 - c/c: 385140- R$ 10,00
...
---------------------------------------------------
---------------------------------------------------
  -- INC0099149 - Civia - c/c 28.162-0 lançar R$ 10,00
  vr_incidente := 'INC0099149';
  vr_cdcooper  := 13;
  vr_nrdconta  := 281620;
  vr_vllanmto  := 10;
  vr_cdhistor  := 2739;
...
---------------------------------------------------
--------------------------------------------------
  --INC0099556 - Credifoz 21/07 - c/c 43.357-8 - R$ 15,58
...
---------------------------------------------------
---------------------------------------------------
  --INC0099556 - Credifoz 21/07 - c/c 20.326-2 - R$ 12,52
  vr_incidente := 'INC0099556';
  vr_cdcooper  := 11;
  vr_nrdconta  := 203262;
  vr_vllanmto  := 12.52;
