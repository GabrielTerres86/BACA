declare 
  ...
  vr_nrdconta      crapass.nrdconta%TYPE := 10316868;
  vr_nrctremp      craplem.nrctremp%TYPE := 3851869;
  vr_vllanmto      craplem.vllanmto%TYPE := 11620.43;
  vr_cdhistor      craplem.cdhistor%TYPE := 3273;
  vr_vlsdeved      crapepr.vlsdeved%TYPE := 196128.68;
  vr_vlsprojt      crapepr.vlsprojt%TYPE := 196128.68;
  vr_vlparepr      crappep.vlparepr%TYPE := 6003.15;
