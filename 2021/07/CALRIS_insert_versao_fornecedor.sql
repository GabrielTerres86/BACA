...
begin
  ...
  values ('DATA_CONST_FORNECEDOR', 'Risco atribuí­do por tempo de existência', 3, 0, NULL) RETURNING idrisco INTO v_idrisco;
  ...
  insert into TBCALRIS_RISCOS (CDRISCO, DSABREV, INPESSOA, TPCRITERIO, DSRISCO)
  values ('ATIVIDADE_FORNECEDOR', 'Risco atribuí­do conforme ramo de atividade', 3, 1, NULL) RETURNING idrisco INTO v_idrisco;
  ...
  insert into TBCALRIS_RISCOS (CDRISCO, DSABREV, INPESSOA, TPCRITERIO, DSRISCO)
  values ('SERV_PROD_FORNECEDOR', 'Risco atribuí­do conforme serviço ou produto fornecido', 3, 1, NULL) RETURNING idrisco INTO v_idrisco;
  ...
  insert into TBCALRIS_RISCOS (CDRISCO, DSABREV, INPESSOA, TPCRITERIO, DSRISCO)
  values ('VALOR_CONTRATO_FORNECEDOR', 'Risco atribuí­do por valor do contrato com o fornecedor', 3, 0, NULL) RETURNING idrisco INTO v_idrisco;
  ...
  insert into TBCALRIS_RISCOS (CDRISCO, DSABREV, INPESSOA, TPCRITERIO, DSRISCO)
  values ('CEP_FORNECEDOR', 'Risco atribuí­do conforme localização', 3, 1, NULL) RETURNING idrisco INTO v_idrisco;
  ...
  insert into TBCALRIS_RISCOS (CDRISCO, DSABREV, INPESSOA, TPCRITERIO, DSRISCO)
  values ('RELACIONAMENTO_COLAB', 'Risco atribuí­do por tipo de relacionamento do colaborador', 4, 2, NULL) RETURNING idrisco INTO v_idrisco;
  ...
  insert into TBCALRIS_RISCOS (CDRISCO, DSABREV, INPESSOA, TPCRITERIO, DSRISCO)
  values ('REGIAO_ATUACAO_COLAB', 'Risco atribuí­do pela região de atuação do colaborador', 4, 2, NULL) RETURNING idrisco INTO v_idrisco;
  ...
  insert into TBCALRIS_RISCOS (CDRISCO, DSABREV, INPESSOA, TPCRITERIO, DSRISCO)
  values ('PENDENCIA_FINAN_COLAB', 'Risco atribuí­do pelas pendências financeiras do colaborador', 4, 0, NULL) RETURNING idrisco INTO v_idrisco;
  ...
  insert into TBCALRIS_RISCOS (CDRISCO, DSABREV, INPESSOA, TPCRITERIO, DSRISCO)
  values ('GRAU_ENDIVIDAMENTO_COLAB', 'Risco atribuí­do pelo grau de endividamento do colaborador', 4, 0, NULL) RETURNING idrisco INTO v_idrisco;
