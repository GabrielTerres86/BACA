...
BEGIN
  ...
  T.DSVLRPRM = 'rodrigo.siewerdt@ailos.coop.br, helio.mariano@ailos.coop.br, marcos@ailos.coop.br, frank.ribeiro@ailos.coop.br, renan.censi@ailos.coop.br, plantonistas@ailos.coop.br, jhonatan.moraes@ailos.coop.br'
  WHERE T.NMSISTEM = 'CRED' AND T.CDACESSO = 'PC_LISTA_TBGEN_EMAIL_1';
