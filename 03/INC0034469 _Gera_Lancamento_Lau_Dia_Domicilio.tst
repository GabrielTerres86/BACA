...
600
-- Created on 08/03/2019 by F0031800 
declare 

procedure pc_credito_manual_cip IS
begin

DECLARE
    rw_crapdat cecred.btch0001.cr_crapdat%ROWTYPE;
    pr_dtprocesso date:=sysdate;
    ...
    CURSOR cr_lancamento IS
      SELECT  arq.idarquivo
        ...
        ARQ.IDARQUIVO IN (101485,101529,101512,101522,101508,101539,101501,101475)
  ...
  END; --pc_procura_ultseq_craplau
    ...
    FOR rw_lancamento IN cr_lancamento LOOP
      ...
      END IF;
        ...
        vr_qtproclancto := 0;
        dbms_output.put_line('Lançamentos: '||rw_lancamento.idlancto);
        ...
        FOR rw_tabela IN cr_tabela(rw_lancamento.idlancto,rw_lancamento.tpforma_transf) LOOP
          ...
          IF vr_cdocorr IS NULL AND
            ...
            IF vr_dscritic is not null THEN
              dbms_output.put_line('Erro -1: '||vr_dscritic);
              RAISE vr_exc_saida;
            END IF;
            
            dbms_output.put_line('Gerou LCM Coop: '||vr_cdcooper||' e Conta: '||vr_nrdconta||' e Valor: '||rw_tabela.vlpagamento);
            ...
            EXCEPTION
              WHEN OTHERS THEN
                ...
                dbms_output.put_line('Erro 000: '||vr_dscritic);
                RAISE vr_exc_saida;
            END;
            ...
            EXCEPTION
              WHEN OTHERS THEN
                ...
                dbms_output.put_line('Erro 111: '||vr_dscritic);
                RAISE vr_exc_saida;
            END;
        ...
        IF vr_qtproclancto > 0 THEN
          ...
          EXCEPTION
            WHEN OTHERS THEN
              ...
              dbms_output.put_line('Erro 222: '||vr_dscritic);
              RAISE vr_exc_saida;
          END;
        END IF;
    ...
    dbms_output.put_line('Chegou ao fim, sucesso.');
    COMMIT;
...
begin
  ...
  -- Credita os lancamentos na conta do cooperado
  pc_credito_manual_cip;
