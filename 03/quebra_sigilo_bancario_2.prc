 ...
 */
CREATE OR REPLACE PROCEDURE CECRED.pc_quebra_sigilo_bancario_2 IS 
...
BEGIN 
  ...
  */
  ...
  vr_referencia := 'SCTASK0050439';
  -- Data que deve ocorrer a quebra de sigilo bancário
  vr_dtinicio   := TO_DATE('01/01/2008','DD/MM/YYYY');
  vr_dtfim      := TO_DATE('31/12/2011','DD/MM/YYYY'); 
  
--1082;          1953
--457.504.679.53; 223.915.339-34

  vr_tbconta_investigar('007_0000001082_000045750467953').cdcooper := 7;
  vr_tbconta_investigar('007_0000001082_000045750467953').nrdconta := 1082;
  vr_tbconta_investigar('007_0000001082_000045750467953').nrcpfcgc := 45750467953;

  vr_tbconta_investigar('007_0000001953_000022391533934').cdcooper := 7;
  vr_tbconta_investigar('007_0000001953_000022391533934').nrdconta := 1953;
  vr_tbconta_investigar('007_0000001953_000022391533934').nrcpfcgc := 22391533934;
...
EXCEPTION
  ...
  WHEN OTHERS THEN
    ...
    -- Não altera nenhum dado    
    ROLLBACK;
END pc_quebra_sigilo_bancario_2;
/
