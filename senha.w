...
&Scoped-Define ENABLED-OBJECTS RECT-1 RECT-2 ed_dssencar Btn_H 
&Scoped-Define DISPLAYED-OBJECTS ed_dssencar 
...
DEFINE FRAME f_senha
     ed_dssencar AT ROW 11.48 COL 61 COLON-ALIGNED NO-LABEL WIDGET-ID 94 PASSWORD-FIELD 
     ...
     "Atenção! NÃO forneça a sua senha a estranhos!" VIEW-AS TEXT
          SIZE 105 BY 1.33 AT ROW 14.57 COL 32 WIDGET-ID 130
          FGCOLOR 1 FONT 8
     "DIGITE A SUA SENHA" VIEW-AS TEXT
          SIZE 94.4 BY 3.33 AT ROW 1.48 COL 33.8 WIDGET-ID 162
          FGCOLOR 1 FONT 10
     RECT-1 AT ROW 10.05 COL 11 WIDGET-ID 116
...
DO:
    ...
    IF  KEY-FUNCTION(LASTKEY) = "H"  THEN
        ...
        END.
    ELSE
    IF  KEY-FUNCTION(LASTKEY) = "RETURN"  AND
        ed_dssencar:SCREEN-VALUE <> ""    THEN
        DO:
            /* maximo 3 tentativas */
...
END.
ELSE MESSAGE "senha.wrx":U SKIP(1)
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY ed_dssencar 
      WITH FRAME f_senha.
  ENABLE RECT-1 RECT-2 ed_dssencar Btn_H 
      WITH FRAME f_senha.
