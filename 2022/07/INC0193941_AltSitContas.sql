DECLARE
  ...
  vc_dstransaStatusCC             CONSTANT VARCHAR2(4000) := 'Alteracao da situacao de conta por script - INC0193941';
  vc_dstransaDevCotas             CONSTANT VARCHAR2(4000) := 'Alteracao de Cotas e devolucao - INC0193941';
  vc_dstransaDevDepVista          CONSTANT VARCHAR2(4000) := 'Alteracao da devolução do Deposito a Vista - INC0193941';    
  ...
  CURSOR cr_crapass is
    SELECT t.cdagenci
      ...
      FROM CECRED.CRAPASS t
         ,(select 1 as cdcooper, 9268367 as nrdconta, vc_cdsitdctProcesDemis as cdsitdct, null as dtdemiss, null as dtelimin, null as dtasitct, null as  cdmotdem from dual
          union all
          select 1 as cdcooper, 9715010 as nrdconta, vc_cdsitdctProcesDemis as cdsitdct, null as dtdemiss, null as dtelimin, null as dtasitct, null as  cdmotdem from dual
          union all
          select 11 as cdcooper, 402192 as nrdconta, vc_cdsitdctProcesDemis as cdsitdct, null as dtdemiss, null as dtelimin, null as dtasitct, null as  cdmotdem from dual
          union all
          select 13 as cdcooper, 355216 as nrdconta, vc_cdsitdctProcesDemis as cdsitdct, null as dtdemiss, null as dtelimin, null as dtasitct, null as  cdmotdem from dual
          union all
          select 8 as cdcooper, 9849 as nrdconta, vc_cdsitdctProcesDemis as cdsitdct, null as dtdemiss, null as dtelimin, null as dtasitct, null as  cdmotdem from dual
          union all
          select 11 as cdcooper, 768111 as nrdconta, vc_cdsitdctEncerrada as cdsitdct, sysdate as dtdemiss, sysdate as dtelimin, sysdate as dtasitct, vc_cdsitdctEncerrada as  cdmotdem from dual
          union all
          select 1 as cdcooper, 10728368 as nrdconta, vc_cdsitdctEncerrada as cdsitdct, sysdate as dtdemiss, sysdate as dtelimin, sysdate as dtasitct, vc_cdsitdctEncerrada as  cdmotdem from dual
          union all
          select 1 as cdcooper, 11086343 as nrdconta, vc_cdsitdctEncerrada as cdsitdct, sysdate as dtdemiss, sysdate as dtelimin, sysdate as dtasitct, vc_cdsitdctEncerrada as  cdmotdem from dual
          union all
          select 1 as cdcooper, 11120959 as nrdconta, vc_cdsitdctEncerrada as cdsitdct, sysdate as dtdemiss, sysdate as dtelimin, sysdate as dtasitct, vc_cdsitdctEncerrada as  cdmotdem from dual
          ) a
     WHERE 1=1
