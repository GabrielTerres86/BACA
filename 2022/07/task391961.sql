...
BEGIN
  ...
  v_dados(v_dados.last()).vr_nrctremp := 53786;
  v_dados(v_dados.last()).vr_vllanmto := 11898.44;
  ...
  v_dados(v_dados.last()).vr_vllanmto := 1702.74;
  ...
  v_dados(v_dados.last()).vr_nrctremp := 69374;
  ...
  v_dados(v_dados.last()).vr_vllanmto := 131.51;
  v_dados(v_dados.last()).vr_cdhistor := 3918;
  ...
  v_dados(v_dados.last()).vr_vllanmto := 1094.35;
  v_dados(v_dados.last()).vr_cdhistor := 3918;
