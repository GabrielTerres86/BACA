BEGIN
  ...
  VALUES (1, 3596559, 1, 1, to_date(TRUNC(SYSDATE+1), 'dd-mm-yyyy'), 60000, 'Reativação débito autorizado (INC0195803)', 'AIMARO WEB', 'CONTAS', 1, ' ', '1', ' '); 
  ...
  INSERT INTO cecred.craplgm (CDCOOPER, NRDCONTA, IDSEQTTL, NRSEQUEN, DTTRANSA, HRTRANSA, DSTRANSA, DSORIGEM, NMDATELA, FLGTRANS, DSCRITIC, CDOPERAD, NMENDTER)
  VALUES (1, 14044510, 1, 1, to_date(TRUNC(SYSDATE+1), 'dd-mm-yyyy'), 60000, 'Reativação débito autorizado (INC0195803)', 'AIMARO WEB', 'CONTAS', 1, ' ', '1', ' '); 
