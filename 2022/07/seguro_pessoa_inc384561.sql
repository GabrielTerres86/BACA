begin
    ...
    cursor c01 is
      select p.cdcooper,
       ...
       where p.cdcooper = s.cdcooper
         ...
         and p.idseqtra in (561297, 549506);
  ...
  begin
    ...
    if (upper(cecred.gene0001.fn_database_name) like '%AYLLOSP%' or
      ...
      ds_nome_diretorio_v := ds_nome_diretorio_v || 'cpd/bacas/INC384651';
      ...
      ds_nome_diretorio_v := ds_nome_diretorio_v || '/INC384651';
      ...
      begin
        ...
        if (qt_reg_arquivo >= 50000) then
          ...
          cecred.gene0002.pc_escreve_xml(ds_dados_rollback_v,
                                         ...
                                         'begin ' || chr(13) || chr(13),
                                         false);
          nm_arquivo_rollback_v := 'ROLLBACK_INC384651_' || nr_arquivo ||
                                   '.sql';
