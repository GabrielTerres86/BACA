declare
  ...
  -- Registro dos riscos 
  TYPE typ_risco IS
    RECORD(cdcooper       cecred.tbcrd_risco.cdcooper%TYPE
          ,nrdconta       cecred.tbcrd_risco.nrdconta%TYPE
          ,nrcontrato     cecred.tbcrd_risco.nrcontrato%TYPE
          ,nrseqctr       cecred.crapris.nrseqctr%TYPE
          ,cdagencia      cecred.crapris.cdagenci%TYPE
          ,nrmodalidade   cecred.tbcrd_risco.nrmodalidade%TYPE
          ,dtcadastro     cecred.tbcrd_risco.dtcadastro%TYPE
          ,dtvencimento   cecred.tbcrd_risco.dtvencimento%TYPE
          ,innivris       cecred.crapris.innivris%TYPE
          ,vldivida       cecred.crapris.vldivida%TYPE
          ,inpessoa       cecred.crapris.inpessoa%TYPE
          ,dtvencop       cecred.crapris.dtvencop%TYPE
          ,qtdiaatr       cecred.crapris.qtdiaatr%TYPE
          ,nrcpfcgc       cecred.crapris.nrcpfcgc%TYPE
          ,dtprxpar       cecred.crapris.dtprxpar%TYPE
          ,vlprxpar       cecred.crapris.vlprxpar%TYPE
          ,qtparcel       cecred.crapris.qtparcel%TYPE
          ,vlvec180       cecred.crapris.vlvec180%TYPE
          ,vlvec360       cecred.crapris.vlvec360%TYPE
          ,vlvec999       cecred.crapris.vlvec999%TYPE
          ,vldiv060       cecred.crapris.vldiv060%TYPE
          ,vldiv180       cecred.crapris.vldiv180%TYPE
          ,vldiv360       cecred.crapris.vldiv360%TYPE
          ,vldiv999       cecred.crapris.vldiv999%TYPE
          ,vlprjano       cecred.crapris.vlprjano%TYPE
          ,vlprjaan       cecred.crapris.vlprjaan%TYPE
          ,vlprjant       cecred.crapris.vlprjant%TYPE
          ,cdinfadi       cecred.crapris.cdinfadi%TYPE
          ,dsinfaux       cecred.crapris.dsinfaux%TYPE
          ,flgindiv       cecred.crapris.flgindiv%TYPE
          ,flarrasto      cecred.crapris.flarrasto%TYPE);
  ...
  TYPE typ_risco_venc IS
    RECORD(cdcooper       cecred.tbcrd_risco.cdcooper%TYPE
          ...
          ,nrseqctr       cecred.crapris.nrseqctr%TYPE
          ,nrmodalidade   cecred.tbcrd_risco.nrmodalidade%TYPE
          ,cdvencto       cecred.crapvri.cdvencto%TYPE
          ,innivris       cecred.crapvri.innivris%TYPE
          ,vldivida       cecred.crapvri.vldivida%TYPE);
  ...
  PROCEDURE pc_grava_crapris_temporaria_temp(pr_cdcooper     IN cecred.tbcrd_risco.cdcooper%TYPE         -- Codigo da cooperativa
                                       ,pr_nrdconta          IN cecred.tbcrd_risco.nrdconta%TYPE         -- Numero da conta
                                       ,pr_inpessoa          IN cecred.crapris.inpessoa%TYPE             -- Tipo de pessoa
                                       ,pr_nrcontrato        IN cecred.tbcrd_risco.nrcontrato%TYPE       -- Numero do contrato
                                       ,pr_nrseqctr          IN cecred.crapris.nrseqctr%TYPE             -- Sequencia contrato
                                       ,pr_cdagencia         IN cecred.crapris.cdagenci%TYPE             -- Numero da agencia
                                       ,pr_nrcpfcnpj         IN cecred.tbcrd_risco.nrcpfcnpj%TYPE        -- CPF/CNPJ
                                       ,pr_nrmodalidade      IN cecred.tbcrd_risco.nrmodalidade%TYPE     -- Codigo da modalidade
                                       ,pr_dtultdma_util     IN DATE                              -- Ultima dia util do mes anterior
                                       ,pr_dsnivel_risco     IN VARCHAR2                          -- Nivel do Risco
                                       ,pr_dtcadastro        IN cecred.tbcrd_risco.dtcadastro%TYPE       -- Data de abertura da conta cartao
                                       ,pr_dtvencimento      IN cecred.tbcrd_risco.dtvencimento%TYPE     -- Data de vencimento
                                       ,pr_vlsaldo_devedor   IN cecred.tbcrd_risco.vlsaldo_devedor%TYPE  -- Saldo Devedor
                                       ,pr_dtprxpar          IN cecred.crapris.dtprxpar%TYPE             -- Data proxima parcela
                                       ,pr_vlprxpar          IN cecred.crapris.vlprxpar%TYPE             -- Valor proxima parcela
                                       ,pr_qtparcel          IN cecred.crapris.qtparcel%TYPE             -- Quantidade de parcelas
                                       ,pr_cdinfadi          IN cecred.crapris.cdinfadi%TYPE             -- Saida de operação
                                       ,pr_dsinfaux          IN cecred.crapris.dsinfaux%TYPE             -- Informação auxiliar
                                       ...
                                       ,pr_idproduto         IN cecred.tbrisco_provisgarant_movto.idproduto%TYPE --> ID do Produto do Movimento Risco de Provisao e Garantia
  ...
  BEGIN
    ...
    DECLARE
      ...
      vr_vldiv060     cecred.crapris.vldiv060%TYPE := 0; --> Valor do atraso quando prazo inferior a 60
      vr_vldiv180     cecred.crapris.vldiv180%TYPE := 0; --> Valor do atraso quando prazo inferior a 180
      vr_vldiv360     cecred.crapris.vldiv360%TYPE := 0; --> Valor do atraso quando prazo inferior a 360
      vr_vldiv999     cecred.crapris.vldiv999%TYPE := 0; --> Valor do atraso para outros casos
      vr_vlvec180     cecred.crapris.vlvec180%TYPE := 0; --> Valor a vencer nos próximos 180 dias
      vr_vlvec360     cecred.crapris.vlvec360%TYPE := 0; --> Valor a vencer nos próximos 360 dias
      vr_vlvec999     cecred.crapris.vlvec999%TYPE := 0; --> Valor a vencer para outros casos
      vr_vlprjano     cecred.crapris.vlprjano%TYPE := 0; --> Valor prejuizo no ano corrente
      vr_vlprjaan     cecred.crapris.vlprjaan%TYPE := 0; --> Valor prejuizo no ano anterior
      vr_vlprjant     cecred.crapris.vlprjant%TYPE := 0; --> Valor prejuizo anterior
  ...
  PROCEDURE pc_fecham_risco_garantia_prest(pr_cdcooper  IN cecred.crapcop.cdcooper%TYPE    --> codigo da cooperativa
  ...
  BEGIN
    ...
    ----------------------------- CURSORES -------------------------------
      ...
      CURSOR cr_movto_sem_conta IS
        SELECT 1
          FROM cecred.tbrisco_provisgarant_movto mvto 
      ...
      CURSOR cr_movto IS
        SELECT mvto.idmovto_risco
          ...
          FROM cecred.tbrisco_provisgarant_prodt prod
              ,cecred.tbrisco_provisgarant_movto mvto
      ...
      TYPE typ_reg_crapass IS
        RECORD(inpessoa cecred.crapass.inpessoa%TYPE
...
*/
      ...
      BEGIN
        FOR idx IN 1..vr_tab_risco_venc_temp.count LOOP
          ...
          IF SQL%ROWCOUNT = 0 THEN
            INSERT INTO cecred.crapvri(cdcooper
                               ,nrdconta
                               ,dtrefere
                               ,innivris
                               ,cdmodali
      ...
      cecred.risc0003.pc_efetua_arrasto_docto5(pr_cdcooper => pr_cdcooper --> codigo da cooperativa
