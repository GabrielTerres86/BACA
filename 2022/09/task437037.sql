...
BEGIN
    ...
    v_dados.extend();
    v_dados(v_dados.last()).vr_cdcooper := 1;
    v_dados(v_dados.last()).vr_nrdconta := 6382550;
    v_dados(v_dados.last()).vr_nrctremp := 5663277;
    ...
    v_dados(v_dados.last()).vr_vllanmto := 121.17;
    v_dados(v_dados.last()).vr_cdhistor := 3919;
    ...
    v_dados(v_dados.last()).vr_vllanmto := 216.75;
    v_dados(v_dados.last()).vr_cdhistor := 3919;
    ...
    v_dados(v_dados.last()).vr_vllanmto := 101.57;
    v_dados(v_dados.last()).vr_cdhistor := 3919;
    ...
    v_dados(v_dados.last()).vr_vllanmto := 107.05;
    v_dados(v_dados.last()).vr_cdhistor := 3919;
    ...
    v_dados(v_dados.last()).vr_vllanmto := 161.18;
    v_dados(v_dados.last()).vr_cdhistor := 3883;
    ...
    v_dados(v_dados.last()).vr_vllanmto := 175.43;
    v_dados(v_dados.last()).vr_cdhistor := 3883;
    ...
    v_dados(v_dados.last()).vr_vllanmto := 265.28;
    v_dados(v_dados.last()).vr_cdhistor := 3919;
    ...
    v_dados(v_dados.last()).vr_vllanmto := 400.83;
    v_dados(v_dados.last()).vr_cdhistor := 3919;
    ...
    v_dados(v_dados.last()).vr_vllanmto := 691.75;
    v_dados(v_dados.last()).vr_cdhistor := 3919;
    ...
    v_dados(v_dados.last()).vr_vllanmto := 851.34;
    v_dados(v_dados.last()).vr_cdhistor := 3919;
    ...
    v_dados(v_dados.last()).vr_vllanmto := 965.14;
    v_dados(v_dados.last()).vr_cdhistor := 3919;
    ...
    v_dados(v_dados.last()).vr_vllanmto := 1744.05;
    v_dados(v_dados.last()).vr_cdhistor := 3919;
