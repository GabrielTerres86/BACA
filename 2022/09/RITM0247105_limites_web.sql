...
BEGIN
  ...
  vr_nmarq_carga    := GENE0001.fn_param_sistema('CRED',3,'ROOT_MICROS') || 'cpd/bacas/RITM0247105/' || 'RITM0247105_carga.csv';
  vr_nmarq_log      := GENE0001.fn_param_sistema('CRED',3,'ROOT_MICROS') || 'cpd/bacas/RITM0247105/' || 'LOG.txt';
  vr_nmarq_rollback := GENE0001.fn_param_sistema('CRED',3,'ROOT_MICROS') || 'cpd/bacas/RITM0247105/' || 'RITM0247105_ROLLBACK.sql';
