DECLARE
  ...
  vc_dstransaStatusCC             CONSTANT VARCHAR2(4000) := 'Alteracao da situacao de conta por script - INC0217110';
  vc_dstransaDevCotas             CONSTANT VARCHAR2(4000) := 'Alteração de Cotas e devolução - INC0217110';
  vc_dstransaDevDepVista          CONSTANT VARCHAR2(4000) := 'Alteracao da devolução do Depósito a Vista - INC0217110';
  ...
  CURSOR cr_crapass(pr_globalname varchar2
    ...
    SELECT t.cdagenci
      ...
      FROM CECRED.CRAPASS t
         ,(select 11 as cdcooper, decode(pr_globalname, vc_bdprod, 328510,328510) as nrdconta, vc_cdsitdctProcesDemis as cdsitdct, null as dtdemiss, null as dtelimin, null as dtasitct, null as  cdmotdem from dual
          union all
          select 2 as cdcooper, decode(pr_globalname, vc_bdprod, 598100,598100) as nrdconta, vc_cdsitdctProcesDemis as cdsitdct, null as dtdemiss, null as dtelimin, null as dtasitct, null as  cdmotdem from dual
          union all
          select 1 as cdcooper, decode(pr_globalname, vc_bdprod, 9643290,9643290) as nrdconta, vc_cdsitdctProcesDemis as cdsitdct, null as dtdemiss, null as dtelimin, null as dtasitct, null as  cdmotdem from dual
          union all
          select 1 as cdcooper, decode(pr_globalname, vc_bdprod, 10268774,10268774) as nrdconta, vc_cdsitdctProcesDemis as cdsitdct, null as dtdemiss, null as dtelimin, null as dtasitct, null as  cdmotdem from dual
          union all
          select 1 as cdcooper, decode(pr_globalname, vc_bdprod, 10504206,10504206) as nrdconta, vc_cdsitdctProcesDemis as cdsitdct, null as dtdemiss, null as dtelimin, null as dtasitct, null as  cdmotdem from dual
          union all
          select 1 as cdcooper, decode(pr_globalname, vc_bdprod, 10619089,10619089) as nrdconta, vc_cdsitdctProcesDemis as cdsitdct, null as dtdemiss, null as dtelimin, null as dtasitct, null as  cdmotdem from dual
          union all
          select 1 as cdcooper, decode(pr_globalname, vc_bdprod, 10804641,10804641) as nrdconta, vc_cdsitdctProcesDemis as cdsitdct, null as dtdemiss, null as dtelimin, null as dtasitct, null as  cdmotdem from dual
          union all
          select 13 as cdcooper, decode(pr_globalname, vc_bdprod, 404403,404403) as nrdconta, vc_cdsitdctEncerrada as cdsitdct, pr_dtmvtolt as dtdemiss, pr_dtmvtolt as dtelimin, pr_dtmvtolt as dtasitct, 11 as  cdmotdem from dual
          ) a
     WHERE 1=1
