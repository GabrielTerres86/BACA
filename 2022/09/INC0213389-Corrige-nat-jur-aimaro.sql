...
BEGIN
  ...
  LOOP
    ...
    IF rw_natjur_ctr.natjur_centralizado IS NULL THEN
      ...
      gene0001.pc_escr_linha_arquivo(vr_ind_arqlog, 'CNPJ ' || rw_natjur.nrcpfcgc || ' sem natureza jurídica no centralizado. ' 
                                                    || ' - Conta: '       || rw_natjur.nrdconta
                                                    || ' - Cooper: '      || rw_natjur.cdcooper  );
