DECLARE texto CLOB := '{
    "paragrafo": [
		...
		{
		   "conteudo": "1. Ao aceitar as CONDIÇÕES abaixo, o COOPERADO solicita a contratação do Seguro Vida, nos termos e condições apresentadas na simulação realizada por meio do acesso aos Canais Digitais."
		},
		{
		...
		{
		   "conteudo": "11. Nos termos do artigo 29, §5º da Lei 10.931/04 e do §2º da Medida Provisória de nº 2.200-2, o COOPERADO reconhece como válida a assinatura deste documento em formato eletrônico, inclusive através da ferramenta digital que não utilize o certificado digital emitido no padrão ICP-Brasil."
		},
		{
		   "conteudo": "12. Assinado eletronicamente pelo COOPERADO {NOME}, inscrito no CPF de nº {CPF} no dia {DT_CONTRATO}, as {HR_CONTRATO}, através do Aplicativo Ailos ou Conta Online, IP nº {IP}, mediante senha digitada."
		}
	]
}';
BEGIN
