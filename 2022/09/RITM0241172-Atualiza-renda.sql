    ...
    IF cr_crapalt%NOTFOUND THEN
      ...
      EXCEPTION
        WHEN OTHERS THEN
          ...
          vr_dscritic := 'Erro ao Inserir atualização cadastral para conta ' || rw_crapttl.nrdconta 
    ...
    ELSE 
      ...
      EXCEPTION
        WHEN OTHERS THEN
          ...
          vr_dscritic := 'Erro ao Complementar atualização cadastral para conta ' || rw_crapttl.nrdconta 
                         || ' - CPF: ' || vr_nrcpfcgc || ' - ' || SQLERRM;
          RAISE vr_exception;
