...
begin
	...
	if	(qt_reg_arquivo	>= 10000) then
		...
		nm_arquivo_rollback_v	:= 'ROLLBACK_INC0212788_coop_' || pr_cdcooper || '_arq_' || nr_arquivo || '.sql';
...
if	(upper(cecred.gene0001.fn_database_name) like '%AYLLOSP%' or upper(cecred.gene0001.fn_database_name) like '%AILOSTS%') then
	...
	ds_nome_diretorio_v	:= ds_nome_diretorio_v || 'cpd/bacas/INC0212788';
	...
	ds_nome_diretorio_v	:= ds_nome_diretorio_v || '/INC0212788';
