...
BEGIN
  ...
  v_dados(v_dados.last()).vr_vllanmto := 77.99;
  ...
  v_dados(v_dados.last()).vr_vllanmto := 3461.16;
  ...
  v_dados(v_dados.last()).vr_vllanmto := 2677.07;
  v_dados(v_dados.last()).vr_cdhistor := 3919;
  ...
  v_dados(v_dados.last()).vr_vllanmto := 168.46;
  v_dados(v_dados.last()).vr_cdhistor := 3919;
