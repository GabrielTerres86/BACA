BEGIN
  ...
  insert into SEGURO.tbseg_template_textos( cdtexto_template, dstexto_template, flstatus_texto_template)  values( '10', 'A contratação neste canal só é permitida para pessoas residentes no Brasil. Gentileza entrar em contato com a Ailos Corretora através do WhatsApp pelo número:', 1);
