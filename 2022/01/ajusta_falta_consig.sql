declare
  ...
  vr_nmdireto        VARCHAR2(4000) := vr_rootmicros||'/cpd/bacas/inc0118769';
  vr_nmarqimp        VARCHAR2(100)  := 'diff_falta_consig.csv';
  vr_nmarqimpr       VARCHAR2(100)  := 'log_diff_falta_consig.csv';
