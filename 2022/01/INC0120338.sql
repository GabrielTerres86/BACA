...
CURSOR cr_craplcm IS       
        SELECT b.dtvencto,        
                ...
                b.nrparepr,
                b.dtmvtolt,
                min(b.idsequencia) idsequencia, LISTAGG(b.instatus, ';')
...
BEGIN
    ...
    update crappep pep
       set pep.vlpagpar = 396.04,
        pep.inliquid = 1,
        pep.vlsdvatu = 0,
        pep.dtultpag = to_date('01/11/2021', 'DD/MM/YYYY')
     where pep.nrdconta = 12417670
       and pep.nrctremp = 3612317
       and pep.nrparepr = 8
       and pep.cdcooper = 1
       and pep.inliquid = 0;
