begin
  ...
  delete CECRED.TBCAPT_CUSTODIA_LOG log
   where log.idarquivo in (select idarquivo
                             from cecred.tbcapt_custodia_arquivo e
  ...
  delete cecred.tbcapt_custodia_arquivo e
   where e.idtipo_operacao = 'E'
     and e.idsituacao <> 0
     and e.idtipo_arquivo <> 9
     and e.dtprocesso is not null
  ...
  update cecred.tbcapt_custodia_lanctos
     set idsituacao = 8
   where idlancamento = 30395124 and idsituacao = 0;
