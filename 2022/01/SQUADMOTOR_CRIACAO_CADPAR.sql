...
BEGIN
  ...
  values (aux_cdpartar_add, 'Meses para analise motor de percentual OUTRAS RENDA ', 2, 13);

  insert into crapbat (CDBATTAR, NMIDENTI, CDPROGRA, TPCADAST, CDCADAST)
  values ('PERCOUTRENDAS', 'Meses para analise motor de percentual OUTRAS RENDA', ' ', 2, aux_cdpartar_add);
