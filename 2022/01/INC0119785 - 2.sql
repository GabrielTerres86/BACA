DECLARE
  ...
  CURSOR cr_crapass is
    SELECT t.cdagenci, t.cdsitdct, t.cdcooper, t.nrdconta
      FROM CRAPASS t
     WHERE (t.nrdconta = 136654 AND t.cdcooper = 7);
...
BEGIN
  ...
  FOR rg_crapass IN cr_crapass LOOP
    ...
    GENE0001.pc_gera_log(pr_cdcooper => vr_cdcooper,
                         ...
                         pr_dsorigem => 'AIMARO',
                         pr_dstransa => 'Alteracao da situacao de conta por script - INC0119785 - 2',
    ...
    GENE0001.pc_gera_log(pr_cdcooper => vr_cdcooper,
                         ...
                         pr_dscritic => vr_dscritic,
                         pr_dsorigem => 'AIMARO',
                         pr_dstransa => 'Alteração de Cotas e devolução - INC0119785 - 2',
                         pr_dttransa => vr_dttransa,
                         pr_flgtrans => 1,
                         pr_hrtransa => vr_hrtransa,
                         pr_idseqttl => 0,
