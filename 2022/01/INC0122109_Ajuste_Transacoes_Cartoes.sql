declare 
  pr_dtmvtolt  date := to_date('31/03/2021','dd/mm/rrrr');
  pr_dtmvtolt2 date := to_date('31/12/2021','dd/mm/rrrr');
...
begin  
  --Apaga registros existentes antes da importação
  DELETE tbcrd_utilizacao_cartao c
   WHERE c.dtmvtolt = pr_dtmvtolt
      OR c.dtmvtolt = pr_dtmvtolt2;
