begin
	...
	insert into seguro.tbseg_cobertura_vida(cdcobertura,dsdescricao_abreviada,dsdescricao_completa,         cdidade_min,cdidade_max,vlcapital_min,vlcapital_max,tpcobertura,dsobervacao,tpambiente) values 
     ...
     insert into seguro.tbseg_cobertura_vida(cdcobertura,dsdescricao_abreviada,dsdescricao_completa,   cdidade_min,cdidade_max,vlcapital_min,vlcapital_max,tpcobertura,dsobervacao,tpambiente) values 
											(3,                   'IPA_VG_AP','Invalidez por acidente',          18,         65,     20000.00,    200000.00,         'R',        'Cobertura de até R$ {vlcobertura} em casos de invalidez total ou parcial por acidente.',         1);
	...
	insert into seguro.tbseg_cobertura_vida(cdcobertura,dsdescricao_abreviada,dsdescricao_completa,   cdidade_min,cdidade_max,vlcapital_min,vlcapital_max,tpcobertura,dsobervacao,tpambiente) values 
											(3,                  'IPA_VG_AP','Invalidez por acidente',          18,         65,     20000.00,    200000.00,         'R',        'Cobertura de até R$ {vlcobertura} em casos de invalidez total ou parcial por acidente.',         2);										

	insert into seguro.tbseg_cobertura_vida(cdcobertura,dsdescricao_abreviada,dsdescricao_completa,                cdidade_min,cdidade_max,vlcapital_min,vlcapital_max,tpcobertura,dsobervacao,tpambiente) values 
											(420,                  'REA_DIH_A','Internação hospitalar por acidente',           18,         65,     6000.00,     6000.00,         'R',        'Cobertura de até R$ 200 por dia em caso de hospitalização por acidente.',         2);			
