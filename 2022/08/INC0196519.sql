DECLARE
  ...
  vc_dstransaStatusCC             CONSTANT VARCHAR2(4000) := 'Alteracao da situacao de conta por script - INC0196519';
  vc_dstransaDevCotas             CONSTANT VARCHAR2(4000) := 'Alteracao de Cotas e devolucao - INC0196519';
  vc_dstransaDevDepVista          CONSTANT VARCHAR2(4000) := 'Alteracao da devolução do Deposito a Vista - INC0196519';    
  ...
  CURSOR cr_crapass is
    SELECT t.cdagenci
      ...
      FROM CECRED.CRAPASS t
         ,(select 9 as cdcooper, 500801 as nrdconta, vc_cdsitdctEncerrada as cdsitdct, sysdate as dtdemiss, sysdate as dtelimin, sysdate as dtasitct, vc_cdsitdctEncerrada as  cdmotdem from dual
          ) a
     WHERE 1=1
