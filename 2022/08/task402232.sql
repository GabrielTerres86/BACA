...
BEGIN
  ...
  v_dados.extend();
  v_dados(v_dados.last()).vr_cdcooper := 14;
  v_dados(v_dados.last()).vr_nrdconta := 42099;
  v_dados(v_dados.last()).vr_nrctremp := 37666;
  ...
  v_dados(v_dados.last()).vr_vllanmto := 1155.38;
  v_dados(v_dados.last()).vr_cdhistor := 3919;
  ...
  v_dados(v_dados.last()).vr_vllanmto := 820.17;
  ...
  v_dados(v_dados.last()).vr_vllanmto := 499.88;
  v_dados(v_dados.last()).vr_cdhistor := 3918;

  v_dados.extend();
  v_dados(v_dados.last()).vr_cdcooper := 14;
  v_dados(v_dados.last()).vr_nrdconta := 296295;
  v_dados(v_dados.last()).vr_nrctremp := 46043;
  v_dados(v_dados.last()).vr_vllanmto := 13.49;
  v_dados(v_dados.last()).vr_cdhistor := 3883;

  v_dados.extend();
  v_dados(v_dados.last()).vr_cdcooper := 14;
  v_dados(v_dados.last()).vr_nrdconta := 207730;
  v_dados(v_dados.last()).vr_nrctremp := 47348;
  ...
  v_dados(v_dados.last()).vr_vllanmto := 30.18;
  v_dados(v_dados.last()).vr_cdhistor := 3918;

  v_dados.extend();
  v_dados(v_dados.last()).vr_cdcooper := 14;
  v_dados(v_dados.last()).vr_nrdconta := 49611;
  v_dados(v_dados.last()).vr_nrctremp := 67281;
  v_dados(v_dados.last()).vr_vllanmto := 251.73;
  v_dados(v_dados.last()).vr_cdhistor := 3919;
