...
BEGIN
    ...
    v_dados(v_dados.last()).vr_vllanmto := 726.19;
    v_dados(v_dados.last()).vr_cdhistor := 3919;

    v_dados.extend();
    v_dados(v_dados.last()).vr_cdcooper := 12;
    v_dados(v_dados.last()).vr_nrdconta := 87564;
    v_dados(v_dados.last()).vr_nrctremp := 10796;
    ...
    v_dados(v_dados.last()).vr_nrctremp := 47901;
    v_dados(v_dados.last()).vr_vllanmto := 32.59;
    v_dados(v_dados.last()).vr_cdhistor := 3918;

    v_dados.extend();
    v_dados(v_dados.last()).vr_cdcooper := 12;
    v_dados(v_dados.last()).vr_nrdconta := 104612;
    v_dados(v_dados.last()).vr_nrctremp := 10465;
    v_dados(v_dados.last()).vr_vllanmto := 31.73;
    v_dados(v_dados.last()).vr_cdhistor := 3919;

    v_dados.extend();
    v_dados(v_dados.last()).vr_cdcooper := 12;
    v_dados(v_dados.last()).vr_nrdconta := 104612;
    v_dados(v_dados.last()).vr_nrctremp := 17161;
    v_dados(v_dados.last()).vr_vllanmto := 472.5;
    v_dados(v_dados.last()).vr_cdhistor := 3919;

    v_dados.extend();
    v_dados(v_dados.last()).vr_cdcooper := 12;
    v_dados(v_dados.last()).vr_nrdconta := 126624;
    v_dados(v_dados.last()).vr_nrctremp := 20612;
    v_dados(v_dados.last()).vr_vllanmto := 485.32;
    v_dados(v_dados.last()).vr_cdhistor := 3919;
