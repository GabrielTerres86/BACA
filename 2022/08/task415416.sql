...
BEGIN
  ...
  v_dados(v_dados.last()).vr_vllanmto := 333.68;
  ...
  v_dados(v_dados.last()).vr_vllanmto := 330.12;
  v_dados(v_dados.last()).vr_cdhistor := 3919;
  ...
  v_dados(v_dados.last()).vr_vllanmto := 1125.59;
  v_dados(v_dados.last()).vr_cdhistor := 3919;
  ...
  v_dados(v_dados.last()).vr_vllanmto := 65.65;
  ...
  v_dados(v_dados.last()).vr_vllanmto := 49.1;
  ...
  v_dados(v_dados.last()).vr_vllanmto := 646.29;
  v_dados(v_dados.last()).vr_cdhistor := 3919;
