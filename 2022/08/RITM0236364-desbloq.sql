declare
  ...
  vr_nmdireto        VARCHAR2(4000) := vr_rootmicros||'/cpd/bacas/RITM0236364';
  vr_nmarqimp        VARCHAR2(100)  := 'RITM0236364.csv';
  vr_nmarqimpr       VARCHAR2(100)  := 'ROLLBACK_RITM0236364.csv';
