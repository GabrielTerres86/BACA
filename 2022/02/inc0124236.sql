-- Created on 14/02/2022 by T0032717 
declare 
  ...
  -- lista de contratos quebrados com pipe: coop ; conta ; contrato |
  
  -- emprestimos, atualizar todos campos (90)
  ...
  -- emprestimos, atualizar integra_sas (90)
  ...
  -- desconto de cheque, atualizar integra_sas / quebrado em dois pipes devido ao tamanho do varchar (2)
  ...
  BEGIN
    ...
    FOR vr_idx_lst IN 1..vr_contrato.COUNT LOOP
      ...
      IF pr_tpctrato = 90 THEN
        ...
        -- evitar que o cursor nao venha vazio e evitar que seja aberto duas vezes
...
BEGIN
  ...
  pc_processa_contratos(pr_dadosctr => vr_lstcontr_1
                       ,pr_tpctrato => 90
                       ,pr_updcompl => 1 -- 1 - update em integra_sas, inrisco_rating, dtrisco_rating, inrisco_inclusao, dsnivris
                       ,pr_cdcritic => vr_cdcritic
                       ,pr_dscritic => vr_dscritic);
  ...
  pc_processa_contratos(pr_dadosctr => vr_lstcontr_2
                       ,pr_tpctrato => 90
                       ,pr_updcompl => 0 -- 0 - update só no integra_sas
                       ,pr_cdcritic => vr_cdcritic
                       ,pr_dscritic => vr_dscritic);
