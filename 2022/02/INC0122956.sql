...
------------ BLOCO PRINCIPAL ---------------------
  ...
  vr_incidente := 'INC0122956';
  dbms_output.put_line('-------- '|| vr_incidente || ' - INICIO --------'); 
  
---------------------------------------------------
  --#1 hist 2721 na cc 5.637-5 cooperativa Credicomin no valor de R$15,00
---------------------------------------------------  
  vr_cdcooper  := 10;
  vr_nrdconta  := 56375;
  vr_vllanmto  := 15.00;
...
---------------------------------------------------
  --#2 hist 2722 na cc 1038.235-6 cooperativa Viacredi no valor de R$66,28
---------------------------------------------------  
  vr_cdcooper  := 1;
