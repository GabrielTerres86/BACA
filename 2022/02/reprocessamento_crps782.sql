BEGIN
  ...
  BEGIN    
    ...
    vr_dtmvtoan:= to_date('09/02/2022', 'DD/MM/YYYY');
    vr_dtmvtolt:= to_date('10/02/2022', 'DD/MM/YYYY');--rw_crapdat.dtmvtolt;
    vr_dtmvtopr:= to_date('11/02/2022', 'DD/MM/YYYY');--rw_crapdat.dtmvtolt;
