declare
  ...
  conta_14164116_72047 clob := '<?xml version="1.0" encoding="UTF-8"?><Root><convenioCredito>
                        <cooperativa>
                          <codigo>7</codigo>
                        </cooperativa>
                      ...
                      <propostaContratoCredito>
                        <CETPercentAoAno>22.51</CETPercentAoAno>
                        ...
                        <tributoIOFValor>312.04</tributoIOFValor>
                        <valor>10312.04</valor><valorBase>10000.00</valorBase><dataProposta>2022-01-25T17:40:55</dataProposta>
                        <emitente> 
                          <dataNascOuConstituicao>1988-03-16T00:00:00</dataNascOuConstituicao>
                          <identificadorReceitaFederal>38382739822</identificadorReceitaFederal>
                          <razaoSocialOuNome>ALINE SOARES BARBOSA</razaoSocialOuNome>
                          <nacionalidade>
                            <codigo>42</codigo>
                          </nacionalidade>
                          <tipo> 
                          ...
                          <contaCorrente>
                            ...
                            <codigoConta>14164116</codigoConta>
                            <cooperativa>
                              <codigo>7</codigo>
                            </cooperativa>
                          </contaCorrente>
                          ...
                          <pessoaContatoEndereco>
                            ...
                            <nomeBairro>VILA ENGENHO NOVO</nomeBairro>
                            <numeroLogradouro>114</numeroLogradouro>
                            <tipoEndereco>
                              <codigo>13</codigo> 
                            </tipoEndereco>
                            <tipoENomeLogradouro>RUA MAJOR ALVARO FON</tipoENomeLogradouro>
                            <UF>SP</UF>
                          </pessoaContatoEndereco>
                        </emitente>
                        <identificadorProposta>72047</identificadorProposta>
                        <statusProposta>
                          <codigo>26</codigo>
                        </statusProposta>
                      </propostaContratoCredito>
                      <pessoaDocumento>
                        <identificador>424592046</identificador>
                        <tipo>
                          <sigla>CI</sigla>
                        </tipo>
                      </pessoaDocumento>
                      ...
                      <parametroConsignado> 
                        ...
                        <naturalidade>CARAPICUIBA</naturalidade>
                         <dataCalculoLegado>2022-01-21T00:00:00</dataCalculoLegado>
                      </parametroConsignado> </Root>
';

  conta_14166313_71878 clob := '<?xml version="1.0" encoding="UTF-8"?><Root><convenioCredito>
                        <cooperativa>
                          <codigo>7</codigo>
                        </cooperativa>
                        <numeroContrato>478</numeroContrato>
                      ...
                      <propostaContratoCredito>
                        ...
                        <tributoIOFValor>312.28</tributoIOFValor>
                        <valor>10312.28</valor><valorBase>10000.00</valorBase><dataProposta>2022-01-25T10:55:53</dataProposta>
                        <emitente> 
                        ...
                        <identificadorProposta>71878</identificadorProposta>
                        <statusProposta>
                          <codigo>26</codigo>
                        </statusProposta>
                      </propostaContratoCredito>
...
BEGIN
    ...
    values (7, 14164116, 72047, 'EFETIVA_PROPOSTA', 'CONSIGNADO', 'INSERT', sysdate, null, null, null, null, null, conta_14164116_72047);
	
	insert into tbgen_evento_soa (CDCOOPER, NRDCONTA, NRCTRPRP, TPEVENTO, TPRODUTO_EVENTO, TPOPERACAO, DHOPERACAO, DSPROCESSAMENTO, DSSTATUS, DHEVENTO, DSERRO, NRTENTATIVAS, DSCONTEUDO_REQUISICAO)
    values (7, 14166313, 71878, 'EFETIVA_PROPOSTA', 'CONSIGNADO', 'INSERT', sysdate, null, null, null, null, null, conta_14166313_71878);
