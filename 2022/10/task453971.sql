...
BEGIN
    ...
    v_dados(v_dados.last()).vr_vllanmto := 219.18;
    v_dados(v_dados.last()).vr_cdhistor := 3919;
    ...
    v_dados(v_dados.last()).vr_vllanmto := 141.04;
    ...
    v_dados(v_dados.last()).vr_vllanmto := 99.76;
    v_dados(v_dados.last()).vr_cdhistor := 3883;
    ...
    v_dados(v_dados.last()).vr_vllanmto := 412.91;
    v_dados(v_dados.last()).vr_cdhistor := 3919;
    ...
    v_dados(v_dados.last()).vr_vllanmto := 820.2;
    v_dados(v_dados.last()).vr_cdhistor := 3919;

    v_dados.extend();
    v_dados(v_dados.last()).vr_cdcooper := 5;
    v_dados(v_dados.last()).vr_nrdconta := 348236;
    v_dados(v_dados.last()).vr_nrctremp := 64136;
    v_dados(v_dados.last()).vr_vllanmto := 817.88;
    v_dados(v_dados.last()).vr_cdhistor := 3919;
    ...
    v_dados(v_dados.last()).vr_vllanmto := 102.39;
