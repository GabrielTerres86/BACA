...
BEGIN
    ...
    v_dados(v_dados.last()).vr_vllanmto := 129.71;
    ...
    v_dados(v_dados.last()).vr_vllanmto := 132.85;
    v_dados(v_dados.last()).vr_cdhistor := 3883;
    ...
    v_dados(v_dados.last()).vr_vllanmto := 56.87;
    v_dados(v_dados.last()).vr_cdhistor := 3883;
    ...
    v_dados.extend();
    v_dados(v_dados.last()).vr_cdcooper := 16;
    v_dados(v_dados.last()).vr_nrdconta := 14824590;
    v_dados(v_dados.last()).vr_nrctremp := 528263;
