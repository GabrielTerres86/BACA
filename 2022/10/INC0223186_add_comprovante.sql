...
BEGIN
  ...
  i := i + 1;
  vlistaconsulta(i).cdcooper := 5;
  vlistaconsulta(i).nrdconta := 131318;
  vlistaconsulta(i).vllanaut := 35.98;
  vlistaconsulta(i).dtmvtolt := '15/09/2022';
  vlistaconsulta(i).cdempres := 8480162;
  vlistaconsulta(i).cdrefere := 141989612;
  vlistaconsulta(i).nrdocmto := 141989612;
  vlistaconsulta(i).dshisext := 'Fat claro cel';
  vlistaconsulta(i).nmextcon := 'CLARO MOVEL';
  i := i + 1;
  ...
  i := i + 1;
  vlistaconsulta(i).cdcooper := 2;
  vlistaconsulta(i).nrdconta := 576905;
  vlistaconsulta(i).vllanaut := 35.99;
  vlistaconsulta(i).dtmvtolt := '15/09/2022';
  vlistaconsulta(i).cdempres := 8480162;
  vlistaconsulta(i).cdrefere := 103295191;
  vlistaconsulta(i).nrdocmto := 103295191;
  vlistaconsulta(i).dshisext := 'paty';
  vlistaconsulta(i).nmextcon := 'CLARO MOVEL';
