DECLARE
  ...
  vc_dstransaStatusCC             CONSTANT VARCHAR2(4000) := 'Alteracao da situacao de conta por script - INC0222937';
  vc_dstransaDevCotas             CONSTANT VARCHAR2(4000) := 'Alteração de Cotas e devolução - INC0222937';
  vc_dstransaDevDepVista          CONSTANT VARCHAR2(4000) := 'Alteracao da devolução do Depósito a Vista - INC0222937';
  ...
  CURSOR cr_crapass(pr_globalname varchar2
    ...
    SELECT t.cdagenci
      ...
      FROM CECRED.CRAPASS t
         ,(select 11 as cdcooper, decode(pr_globalname, vc_bdprod, 422630,99577305) as nrdconta, vc_cdsitdctEncerrada as cdsitdct, pr_dtmvtolt as dtdemiss, pr_dtmvtolt as dtelimin, pr_dtmvtolt as dtasitct, 11 as  cdmotdem from dual
          ) a
     WHERE 1=1
