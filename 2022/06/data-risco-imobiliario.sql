...
BEGIN
  ...
  FOR rw_crapris IN cr_crapris LOOP
    ...
    IF cr_tbrisco_ocr%FOUND THEN
      ...
      UPDATE tbrisco_central_ocr SET dtdrisco = rw_tbrisco_ocr.dtdrisco WHERE cdcooper = rw_crapris.cdcooper AND nrdconta = rw_crapris.nrdconta AND nrctremp = rw_crapris.nrctremp AND dtdrisco IS NULL;
    ELSE
      ...
      UPDATE tbrisco_central_ocr SET dtdrisco = rw_crapris_min.dtrefere WHERE cdcooper = rw_crapris.cdcooper AND nrdconta = rw_crapris.nrdconta AND nrctremp = rw_crapris.nrctremp AND dtdrisco IS NULL;
