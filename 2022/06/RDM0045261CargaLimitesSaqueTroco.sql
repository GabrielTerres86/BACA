...
BEGIN
	...
	USING (
		...
		WHERE TPDSENHA = 1 AND CDSITSNH = 1 and not exists (SELECT H.CDCOOPER, H.NRDCONTA, H.IDSEQTTL FROM PIX.TBPIX_LIMITE_COOPERADO H
		WHERE H.CDCOOPER = crapsnh.CDCOOPER AND H.NRDCONTA = crapsnh.NRDCONTA AND H.IDSEQTTL = crapsnh.IDSEQTTL)
	) t2
