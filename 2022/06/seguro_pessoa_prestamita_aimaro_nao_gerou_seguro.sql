begin
  ...
  declare
    ...
    cursor c01 is
      select w.*,
             ...
             e.cdagenci,
             e.cdoperad,
             w.rowid nr_linha_crawseg
        from cecred.tbseg_nrproposta n,
             cecred.craplcr          l,
             cecred.crawepr          e,
             cecred.crawseg          w
       where w.nrproposta = n.nrproposta
         and w.cdcooper not in (9, 13)
         and w.tpcustei = 0
  ...
  begin
    ...
    if (upper(cecred.gene0001.fn_database_name) like '%AYLLOSP%' or
      ...
      ds_nome_diretorio_v := ds_nome_diretorio_v || 'cpd/bacas/INC0159052';
      ...
      ds_nome_diretorio_v := ds_nome_diretorio_v || '/INC0159052';
      ...
      begin
        ...
        if (qt_reg_arquivo >= 50000) then
          ...
          gene0002.pc_escreve_xml(ds_dados_rollback_v,
                                  ...
                                  'begin ' || chr(13) || chr(13),
                                  false);
          nm_arquivo_rollback_v := 'ROLLBACK_INC0159052_' || nr_arquivo ||
                                   '.sql';
