DECLARE
  ...
  PROCEDURE pc_efetiva_reg_pendentes(pr_dtprocesso IN DATE
    ...
    CURSOR cr_lancamento IS
      SELECT arq.idarquivo
       ...
       WHERE lct.idarquivo = arq.idarquivo
         ...
         AND arq.idarquivo IN (567284, 567285, 567286, 567287, 567288, 567289,
             567290, 567291, 567292, 567293, 567294, 567295,
             567296, 567297, 567298, 567299, 567300, 567301,
             567302, 567303, 567304, 567305, 567306, 567307, 567308, 567309)
    ...
    vr_coopdest     crapcop.cdcooper%TYPE; 
    vr_nrdconta     NUMBER(25);
    vr_cdcooper_lcm craplcm.cdcooper%TYPE; 
    vr_cdcooper_lau craplau.cdcooper%TYPE; 
...
BEGIN
  ...
  UPDATE cecred.tbdomic_liqtrans_lancto
     SET insituacao = 1
   WHERE idarquivo IN (567284, 567285, 567286, 567287, 567288, 567289,
             567290, 567291, 567292, 567293, 567294, 567295,
             567296, 567297, 567298, 567299, 567300, 567301,
             567302, 567303, 567304, 567305, 567306, 567307, 567308, 567309);
