DECLARE                                 
  ...
  SELECT t.nrnu_portabilidade,
   ...
   WHERE 1=1
     AND T.NRNU_PORTABILIDADE = '202204190000228323859';                                 
  ...
  vc_dtcancel                    CONSTANT DATE         := to_date('20/04/2022','dd/mm/yyyy');
  vc_nmarquiv                    CONSTANT VARCHAR2(60) := 'APCS106_05463212_20220420_00021';
...
BEGIN
  ...
  vr_dstransa := 'Alteracao da situacao portabilidade - INC0184377 - ' || vr_tabela;
