declare
  ...
  vr_nrdconta crapass.nrdconta%TYPE := 501239;
  vr_nrctremp craplem.nrctremp%TYPE := 20200572;
  vr_vllanmto craplem.vllanmto%TYPE := 145.41;
...
BEGIN
  ...
  EMPR0001.pc_cria_lancamento_lem(pr_cdcooper => vr_cdcooper,
                                  ...
                                  pr_vllanmto => TO_NUMBER(vr_vllanmto),
