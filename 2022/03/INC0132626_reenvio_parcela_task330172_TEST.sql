...
BEGIN
  ...
  BEGIN
	...
	VALUES (1, 13137433, 4499682, 5, 1, 697.68, 697.68, to_date('01-03-2022', 'dd-mm-yyyy'), 3, to_date('03-03-2022 08:26:18', 'dd-mm-yyyy hh24:mi:ss'), to_date('03-03-2022 08:45:04', 'dd-mm-yyyy hh24:mi:ss'), 214, 0, '1', null, null, null, to_date('03-03-2022', 'dd-mm-yyyy'));
	COMMIT;
	EXCEPTION
	  WHEN OTHERS THEN
