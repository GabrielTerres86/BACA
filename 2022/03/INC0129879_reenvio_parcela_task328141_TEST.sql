...
BEGIN
  ...
  BEGIN
	...
	VALUES (1179177, 1, 12752827, 3960181, 34, 2, 409.12, 409.12, to_date('01-04-2024', 'dd-mm-yyyy'), 3, to_date('25-02-2022 09:35:03', 'dd-mm-yyyy hh24:mi:ss'), to_date('25-02-2022 09:35:44', 'dd-mm-yyyy hh24:mi:ss'), 0, 0, 'f0032949', null, null, null, to_date('25-02-2022', 'dd-mm-yyyy'));
	COMMIT;
	EXCEPTION
	  WHEN OTHERS THEN
  ...
  FOR rw_craplcm IN cr_craplcm LOOP
    ...
    vr_xml_parcela := ' <parcela>
						  <dataEfetivacao>' || ('2022-02-24') || 'T' || to_char(SYSDATE, 'hh24:mi:ss') || '</dataEfetivacao>
