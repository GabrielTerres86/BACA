declare 
  ...
  vr_vlsdeveda      crapepr.vlsdeved%TYPE := 440.97;
  vr_vlparepra      crappep.vlpagpar%TYPE := 20.52;
  
  vr_cdcooperb      crapcop.cdcooper%TYPE := 16;
  vr_nrdcontab      crapass.nrdconta%TYPE := 6521096;
  vr_nrctrempb      craplem.nrctremp%TYPE := 302190;
  vr_vlsdevedb      crapepr.vlsdeved%TYPE := 583.36;
  vr_vlpareprb      crappep.vlpagpar%TYPE := 16.39;
