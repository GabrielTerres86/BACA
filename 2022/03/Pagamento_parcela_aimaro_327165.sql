DECLARE
  ...
  CURSOR cr_crappep is
    SELECT x.*
          ,REGEXP_SUBSTR('2,3,4,5,6,7,8,9','[^,]+', 1, LEVEL) as idsequencia
     FROM(SELECT b.dtvencto
           ...
           where pep.cdcooper = 1 
             and pep.nrdconta = 12392820  
             and pep.nrctremp = 3586887 
             and pep.nrparepr = 12
           ...
           order by b.cdcooper
                   ...
                   ,b.nrctremp
                   ,b.nrparepr) x  
      CONNECT BY REGEXP_SUBSTR('2,3,4,5,6,7,8,9','[^,]+', 1, LEVEL) IS NOT NULL;
