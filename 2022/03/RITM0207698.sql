...
vr_nmarqmov			varchar2(200) := 'IS_0495_9650_0001_20220307181605_1971820.TXT';
...
begin
	...
	if	(upper(gene0001.fn_database_name) like '%AYLLOSP%') then
		...
		vr_diretorio	:= vr_diretorio || 'cpd/bacas/RITM0207698';
		...
		vr_diretorio	:= vr_diretorio || '/RITM0207698';
	...
	for	idx in 1..vr_tab_nmarqtel.count loop
		...
		ds_nome_arquivo_bkp_v	:= 'ROLLBACK_RITM0207698_' || idx || '.sql';
