declare
  ...
  vr_nmdireto        VARCHAR2(4000) := vr_rootmicros||'/cpd/bacas/inc0126512';
  vr_nmarqimp        VARCHAR2(100)  := 'diff_consig_jan.csv';
  vr_nmarqimpr       VARCHAR2(100)  := 'log_diff_consig_jan.csv';
