...
DECLARE
  --
  vr_cdprogra VARCHAR2(100) := 'crps538_compefora_20220325';
  ...
  --
  PROCEDURE pc_crps538_20220325(pr_cdcooper IN crapcop.cdcooper%TYPE --> Codigo Cooperativa
  ...
  BEGIN
    ...
    END pc_baixa_eft_interbca_local;
      ...
      PROCEDURE pc_integra_cobranca_registrada(pr_cdcritic OUT INTEGER
        ...
        vr_exc_saida   EXCEPTION;
      --
      CURSOR cr_crapcob_220325(pr_cdcooper crapcob.cdcooper%TYPE
        ...
        BEGIN
          ...
          LOOP
              ...
              *************************************************************/
              ...
              FOR rw_crapcob_220325 IN cr_crapcob_220325(pr_cdcooper => rw_crapcco.cdcooper
                ...
                PAGA0001.pc_valores_a_creditar(pr_cdcooper            => rw_crapcco.cdcooper
                                              ...
                                              ,pr_dtmvtolt            => rw_crapdat.dtmvtolt
                                              ,pr_dtcredit            => vr_dtcredit
                                              ,pr_idtabcob            => rw_crapcob_220325.idrowid_cob
        ...
        LOOP
            ...
            LOOP
              ...
              vr_index_crapcco := lpad(rw_crapcop.cdcooper, 10, '0') || lpad(vr_nrcnvcob, 10, '0');
                      ...
                      EXCEPTION
                        WHEN OTHERS THEN
                          ...
                          vr_dscritic := gene0001.fn_busca_critica(pr_cdcritic => vr_cdcritic) ||
                                         ...
                                         ', nrseqdig:' ||
                                         TO_NUMBER(TRIM(SUBSTR(vr_setlinha, 151, 10))) ||
                                         ', cdpesqbb:' || vr_setlinha || ', cdcritic:' ||
                                         vr_cdcritic || ', cdcooper:' || pr_cdcooper ||
                                         ', nrdconta:' || vr_nrdconta || ', cdbccxlt:' ||
                                         vr_cdbanpag || ', nrdocmto:' || vr_nrdocmto || '. ' ||
                                         SQLERRM;
                          --Levantar Excecao
                          RAISE vr_exc_sair;
                      END;
                ...
                IF rw_crapcob.incobran IN (3, 5) AND
                  ...
                  -- Ajusta o parametro com a regra de evitar o nulo - 21/03/2019 - REQ0037942                   
                  IF vr_nmtelant = 'COMPEFORA' THEN
                    vr_dtrefere := TO_DATE('25/03/2022', 'DD/MM/YYYY');
                  ELSE
          ...
          LOOP
              ...
              IF vr_index_desc = vr_tab_descontar.LAST OR
                ...
                --Verificar nome da tela
                IF vr_nmtelant = 'COMPEFORA' THEN
                  vr_dtmvtaux := TO_DATE('25/03/2022', 'DD/MM/YYYY');
                ELSE
                  vr_dtmvtaux := rw_crapdat.dtmvtolt;
                END IF;
      ...
      BEGIN
        ...
        LOOP
          ...
          IF vr_nmtelant = 'COMPEFORA' THEN
            ...
            vr_dtleiarq   := to_char(TO_DATE('25/03/2022', 'DD/MM/YYYY'), 'YYYYMMDD');
            vr_idprocesso := 1;
          ELSE
            --Data leitura arquivo
...
BEGIN
  ...
  FOR rw_crapcop IN (SELECT cop.cdcooper, cop.nmrescop
    ...
    vr_dscritic := '';
    --
    pc_crps538_20220325(pr_cdcooper => rw_crapcop.cdcooper,
                        pr_cdagenci => 0,
                        pr_idparale => 0,
                        pr_flgresta => 0,
