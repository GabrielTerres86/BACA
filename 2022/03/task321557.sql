...
<Root>
  ...
  <propostaContratoCredito>
    ...
    <dataProposta>' || v_dh_envioproposta || '</dataProposta>
    <emitente>
  ...
  <parametroConsignado>
    ...
    <dataCalculoLegado>2022-03-07T00:00:00</dataCalculoLegado>
  </parametroConsignado>
</Root>
';
...
BEGIN
  ...
  UPDATE crappep pep
   ...
   WHERE (pep.cdcooper, pep.nrdconta, pep.nrctremp) IN ((7, 14204118, 72923));
