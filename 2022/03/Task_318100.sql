DECLARE
  ...
  CURSOR cr_craplcm IS       
    SELECT b.dtvencto,
		   ...
		   b.cdcooper,
		   b.nrparepr,
		   to_date('10/02/2022', 'DD/MM/YYYY') AS dtmvtolt,
		   min(b.idsequencia) idsequencia
	  FROM tbepr_consignado_pagamento b,
		  (SELECT cdcooper, nrdconta, nrctremp, nrparepr
			 FROM crappep
			WHERE (cdcooper, nrdconta, nrctremp, nrparepr) IN ((1, 11618191, 4244536, 6))
			  AND inliquid = 0
		   ) pep
...
BEGIN
  ...
  values
	...
	3,
	to_date('11-02-2022 07:04:15', 'dd-mm-yyyy hh24:mi:ss'),
	to_date('18-02-2022 08:43:56', 'dd-mm-yyyy hh24:mi:ss'),
	71,
	0,
	'1',
	NULL,
