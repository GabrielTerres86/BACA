...
BEGIN
  ...
  BEGIN
	...
	VALUES (1179905, 1, 12873632, 4085979, 8, 1, 816.43, 816.43, to_date('01-03-2022', 'dd-mm-yyyy'), 3, to_date('03-03-2022 08:26:17', 'dd-mm-yyyy hh24:mi:ss'), to_date('03-03-2022 10:31:26', 'dd-mm-yyyy hh24:mi:ss'), 214, 0, '1', null, null, null, to_date('03-03-2022', 'dd-mm-yyyy')); 
	COMMIT;
	EXCEPTION
	  WHEN OTHERS THEN
  ...
  FOR rw_craplcm IN cr_craplcm LOOP
    ...
    vr_xml_parcela := ' <parcela>
						  <dataEfetivacao>' || ('2022-02-25') || 'T' || to_char(SYSDATE, 'hh24:mi:ss') || '</dataEfetivacao>
