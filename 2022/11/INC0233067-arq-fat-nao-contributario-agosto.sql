begin
  ...
  vr_nmarq    VARCHAR2(100)  := 'ROLLBACK_INC0233067_agosto.sql';
  ...
  CURSOR cr_prestamista(pr_cdcooper IN CECRED.crapcop.cdcooper%TYPE,
    ...
    SELECT p.idseqtra
     ...
     WHERE p.cdcooper = pr_cdcooper
       ...
       AND p.tpcustei = 1
       and p.nrproposta IN ('770658270427',
                            '770655870474',
                            '770657768146',
                            '770658628240',
                            '770658627082',
  ...
  BEGIN
    ...
    FOR rw_crapcop IN cr_crapcooperativa LOOP
      ...
      FOR rw_prestamista IN cr_prestamista(pr_cdcooper => pr_cdcooper,
            ...
            vr_linha_txt := '';
            IF vr_tpregist = 0 OR vr_tpregist = 3 THEN
              vr_tpregist := 1;
            END IF;
          ...
          vr_dir_relatorio_815 := CECRED.gene0001.fn_diretorio('C', rw_crapcop.cdcooper, 'rl') || '/crrl815_agosto.lst';
          ...
          vr_ultimodiaMes := add_months(trunc(SYSDATE,'MONTH'),-2) -1 ;
