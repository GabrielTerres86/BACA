DECLARE
  ...
  vc_cdhistCotasPF                CONSTANT NUMBER := 2518;
  vc_cdhistCotasPJ                CONSTANT NUMBER := 2519;  
  ...
  vc_cdsitdctLiberada             CONSTANT NUMBER := 1;
  ...
  CURSOR cr_crapass(pr_globalname varchar2
    ...
    SELECT t.cdagenci
      ...
      FROM CECRED.CRAPASS t
         ,(select 1 as cdcooper, decode(pr_globalname, vc_bdprod, 13463306,19711280) as nrdconta, vc_cdsitdctLiberada as cdsitdct, null as dtdemiss, null as dtelimin, null as dtasitct, null as  cdmotdem from dual
          ) a
     WHERE 1=1
  ...
  FOR rg_crapass IN cr_crapass(vr_globalname, vr_dtmvtolt) LOOP
    ...
    IF vr_vldcotas_crapcot > 0 THEN
      ...
      UPDATE CECRED.crapcot
         SET vldcotas = vr_vldcotas_crapcot
