  ...
  CURSOR cr_crapass(pr_globalname varchar2
    ...
    SELECT t.cdagenci
      ...
      FROM CECRED.CRAPASS t
         ,(select 1 as cdcooper, decode(pr_globalname, vc_bdprod, 13463306,9733027) as nrdconta, vc_cdsitdctLiberada as cdsitdct, null as dtdemiss, null as dtelimin, null as dtasitct, null as  cdmotdem from dual
          ) a
     WHERE 1=1
