  ...
  LOOP
          ...
          WHEN 1 THEN
            ...
            IF NVL(rg_crapjfn.vlrftbru##1 , 0) <> vr_parcela
              ...
              IF NVL(rg_crapjfn.vlrftbru##1 , 0) <> vr_parcela THEN
                ...
                vr_rollback  := vr_rollback || ' vlrftbru##' || i || ' = ' || replace( rg_crapjfn.vlrftbru##1, ',', '.' ) ;
              ...
              IF NVL(rg_crapjfn.mesftbru##1 , 0) <> vr_mes THEN
                ...
                vr_rollback  := vr_rollback || ' , mesftbru##' || i || ' = ' || rg_crapjfn.mesftbru##1;
              ...
              IF NVL(rg_crapjfn.anoftbru##1, 0) <> vr_ano THEN
                ...
                vr_rollback  := vr_rollback || ' , anoftbru##' || i || ' = ' || rg_crapjfn.anoftbru##1;
          ...
          WHEN 2 THEN
            ...
            IF NVL(rg_crapjfn.vlrftbru##2 , 0) <> vr_parcela
              ...
              IF NVL(rg_crapjfn.vlrftbru##2 , 0) <> vr_parcela THEN
                ...
                vr_rollback  := vr_rollback || ' , vlrftbru##' || i || ' = ' || replace( rg_crapjfn.vlrftbru##2, ',', '.' );
              ...
              IF NVL(rg_crapjfn.mesftbru##2 , 0) <> vr_mes THEN
                ...
                vr_rollback  := vr_rollback || ' , mesftbru##' || i || ' = ' || rg_crapjfn.mesftbru##2;
              ...
              IF NVL(rg_crapjfn.anoftbru##2, 0) <> vr_ano THEN
                ...
                vr_rollback  := vr_rollback || ' , anoftbru##' || i || ' = ' || rg_crapjfn.anoftbru##2;
          ...
          WHEN 3 THEN
            ...
            IF NVL(rg_crapjfn.vlrftbru##3 , 0) <> vr_parcela
              ...
              IF NVL(rg_crapjfn.vlrftbru##3 , 0) <> vr_parcela THEN
                ...
                vr_rollback  := vr_rollback || ' , vlrftbru##' || i || ' = ' || replace( rg_crapjfn.vlrftbru##3, ',', '.' );
              ...
              IF NVL(rg_crapjfn.mesftbru##3 , 0) <> vr_mes THEN
                ...
                vr_rollback  := vr_rollback || ' , mesftbru##' || i || ' = ' || rg_crapjfn.mesftbru##3;
              ...
              IF NVL(rg_crapjfn.anoftbru##3, 0) <> vr_ano THEN
                ...
                vr_rollback  := vr_rollback || ' , anoftbru##' || i || ' = ' || rg_crapjfn.anoftbru##3;
          ...
          WHEN 4 THEN
            ...
            IF NVL(rg_crapjfn.vlrftbru##4 , 0) <> vr_parcela
              ...
              IF NVL(rg_crapjfn.vlrftbru##4 , 0) <> vr_parcela THEN
                ...
                vr_rollback  := vr_rollback || ' , vlrftbru##' || i || ' = ' || replace( rg_crapjfn.vlrftbru##4, ',', '.' );
              ...
              IF NVL(rg_crapjfn.mesftbru##4 , 0) <> vr_mes THEN
                ...
                vr_rollback  := vr_rollback || ' , mesftbru##' || i || ' = ' || rg_crapjfn.mesftbru##4;
              ...
              IF NVL(rg_crapjfn.anoftbru##4, 0) <> vr_ano THEN
                ...
                vr_rollback  := vr_rollback || ' , anoftbru##' || i || ' = ' || rg_crapjfn.anoftbru##4;
          ...
          WHEN 5 THEN
            ...
            IF NVL(rg_crapjfn.vlrftbru##5 , 0) <> vr_parcela
              ...
              IF NVL(rg_crapjfn.vlrftbru##5 , 0) <> vr_parcela THEN
                ...
                vr_rollback  := vr_rollback || ' , vlrftbru##' || i || ' = ' || replace( rg_crapjfn.vlrftbru##5, ',', '.' );
              ...
              IF NVL(rg_crapjfn.mesftbru##5 , 0) <> vr_mes THEN
                ...
                vr_rollback  := vr_rollback || ' , mesftbru##' || i || ' = ' || rg_crapjfn.mesftbru##5;
              ...
              IF NVL(rg_crapjfn.anoftbru##5, 0) <> vr_ano THEN
                ...
                vr_rollback  := vr_rollback || ' , anoftbru##' || i || ' = ' || rg_crapjfn.anoftbru##5;
          ...
          WHEN 6 THEN
            ...
            IF NVL(rg_crapjfn.vlrftbru##6 , 0) <> vr_parcela
              ...
              IF NVL(rg_crapjfn.vlrftbru##6 , 0) <> vr_parcela THEN
                ...
                vr_rollback  := vr_rollback || ' , vlrftbru##' || i || ' = ' || replace( rg_crapjfn.vlrftbru##6, ',', '.' );
              ...
              IF NVL(rg_crapjfn.mesftbru##6 , 0) <> vr_mes THEN
                ...
                vr_rollback  := vr_rollback || ' , mesftbru##' || i || ' = ' || rg_crapjfn.mesftbru##6;
              ...
              IF NVL(rg_crapjfn.anoftbru##6, 0) <> vr_ano THEN
                ...
                vr_rollback  := vr_rollback || ' , anoftbru##' || i || ' = ' || rg_crapjfn.anoftbru##6;
          ...
          WHEN 7 THEN
            ...
            IF NVL(rg_crapjfn.vlrftbru##7 , 0) <> vr_parcela
              ...
              IF NVL(rg_crapjfn.vlrftbru##7 , 0) <> vr_parcela THEN
                ...
                vr_rollback  := vr_rollback || ' , vlrftbru##' || i || ' = ' || replace( rg_crapjfn.vlrftbru##7, ',', '.' );
              ...
              IF NVL(rg_crapjfn.mesftbru##7 , 0) <> vr_mes THEN
                ...
                vr_rollback  := vr_rollback || ' , mesftbru##' || i || ' = ' || rg_crapjfn.mesftbru##7;
              ...
              IF NVL(rg_crapjfn.anoftbru##7, 0) <> vr_ano THEN
                ...
                vr_rollback  := vr_rollback || ' , anoftbru##' || i || ' = ' || rg_crapjfn.anoftbru##7;
          ...
          WHEN 8 THEN
            ...
            IF NVL(rg_crapjfn.vlrftbru##8 , 0) <> vr_parcela
              ...
              IF NVL(rg_crapjfn.vlrftbru##8 , 0) <> vr_parcela THEN
                ...
                vr_rollback  := vr_rollback || ' , vlrftbru##' || i || ' = ' || replace( rg_crapjfn.vlrftbru##8, ',', '.' );
              ...
              IF NVL(rg_crapjfn.mesftbru##8 , 0) <> vr_mes THEN
                ...
                vr_rollback  := vr_rollback || ' , mesftbru##' || i || ' = ' || rg_crapjfn.mesftbru##8;
              ...
              IF NVL(rg_crapjfn.anoftbru##8, 0) <> vr_ano THEN
                ...
                vr_rollback  := vr_rollback || ' , anoftbru##' || i || ' = ' || rg_crapjfn.anoftbru##8;
          ...
          WHEN 9 THEN
            ...
            IF NVL(rg_crapjfn.vlrftbru##9 , 0) <> vr_parcela
              ...
              IF NVL(rg_crapjfn.vlrftbru##9 , 0) <> vr_parcela THEN
                ...
                vr_rollback  := vr_rollback || ' , vlrftbru##' || i || ' = ' || replace( rg_crapjfn.vlrftbru##9, ',', '.' );
              ...
              IF NVL(rg_crapjfn.mesftbru##9 , 0) <> vr_mes THEN
                ...
                vr_rollback  := vr_rollback || ' , mesftbru##' || i || ' = ' || rg_crapjfn.mesftbru##9;
              ...
              IF NVL(rg_crapjfn.anoftbru##9, 0) <> vr_ano THEN
                ...
                vr_rollback  := vr_rollback || ' , anoftbru##' || i || ' = ' || rg_crapjfn.anoftbru##9;
          ...
          WHEN 10 THEN
            ...
            IF NVL(rg_crapjfn.vlrftbru##10 , 0) <> vr_parcela
              ...
              IF NVL(rg_crapjfn.vlrftbru##10 , 0) <> vr_parcela THEN
                ...
                vr_rollback  := vr_rollback || ' , vlrftbru##' || i || ' = ' || replace( rg_crapjfn.vlrftbru##10, ',', '.' );
              ...
              IF NVL(rg_crapjfn.mesftbru##10 , 0) <> vr_mes THEN
                ...
                vr_rollback  := vr_rollback || ' , mesftbru##' || i || ' = ' || rg_crapjfn.mesftbru##10;
              ...
              IF NVL(rg_crapjfn.anoftbru##10, 0) <> vr_ano THEN
                ...
                vr_rollback  := vr_rollback || ' , anoftbru##' || i || ' = ' || rg_crapjfn.anoftbru##10;
          ...
          WHEN 11 THEN
            ...
            IF NVL(rg_crapjfn.vlrftbru##11 , 0) <> vr_parcela
              ...
              IF NVL(rg_crapjfn.vlrftbru##11 , 0) <> vr_parcela THEN
                ...
                vr_rollback  := vr_rollback || ' , vlrftbru##' || i || ' = ' || replace( rg_crapjfn.vlrftbru##11, ',', '.' );
              ...
              IF NVL(rg_crapjfn.mesftbru##11 , 0) <> vr_mes THEN
                ...
                vr_rollback  := vr_rollback || ' , mesftbru##' || i || ' = ' || rg_crapjfn.mesftbru##11;
              ...
              IF NVL(rg_crapjfn.anoftbru##11, 0) <> vr_ano THEN
                ...
                vr_rollback  := vr_rollback || ' , anoftbru##' || i || ' = ' || rg_crapjfn.anoftbru##11;
          ...
          WHEN 12 THEN
            ...
            IF NVL(rg_crapjfn.vlrftbru##12 , 0) <> vr_parcela
              ...
              IF NVL(rg_crapjfn.vlrftbru##12 , 0) <> vr_parcela THEN
                ...
                vr_rollback  := vr_rollback || ' , vlrftbru##' || i || ' = ' || replace( rg_crapjfn.vlrftbru##12, ',', '.' );
              ...
              IF NVL(rg_crapjfn.mesftbru##12 , 0) <> vr_mes THEN
                ...
                vr_rollback  := vr_rollback || ' , mesftbru##' || i || ' = ' || rg_crapjfn.mesftbru##12;
              ...
              IF NVL(rg_crapjfn.anoftbru##12, 0) <> vr_ano THEN
                ...
                vr_rollback  := vr_rollback || ' , anoftbru##' || i || ' = ' || rg_crapjfn.anoftbru##12;
      ...
      IF TRIM(vr_rollback) IS NOT NULL THEN
        ...
        EXCEPTION
          WHEN OTHERS THEN
            ...
            vr_dscritic := vr_nrcpfcgc || ' - Erro ao atualizar faturamento total Ano ';
            RAISE vr_exception;
    ...
    EXCEPTION
      WHEN OTHERS THEN
        ...
        vr_dscritic := vr_nrcpfcgc || ' - Erro ao cadastrar telefone (' || vr_dddctato01 || ') ' || vr_ctato01;
        RAISE vr_exception;
    ...
    EXCEPTION
      WHEN OTHERS THEN
        ...
        vr_dscritic := vr_nrcpfcgc || ' - Erro ao cadastrar telefone (' || vr_dddctato02 || ') ' || vr_ctato02;
        RAISE vr_exception;
    ...
    EXCEPTION
      WHEN OTHERS THEN
        ...
        vr_dscritic := vr_nrcpfcgc || ' - Erro ao cadastrar telefone (' || vr_dddctato03 || ') ' || vr_ctato03;
        RAISE vr_exception;
    ...
    EXCEPTION
      WHEN OTHERS THEN
        ...
        vr_dscritic := vr_nrcpfcgc || ' - Erro ao cadastrar telefone (' || vr_dddctatocel01 || ') ' || vr_ctatocel01;
        RAISE vr_exception;
    ...
    EXCEPTION
      WHEN OTHERS THEN
        ...
        vr_dscritic := vr_nrcpfcgc || ' - Erro ao cadastrar telefone (' || vr_dddctatocel02 || ') ' || vr_ctatocel02;
        RAISE vr_exception;
    ...
    EXCEPTION
      WHEN OTHERS THEN
        ...
        vr_dscritic := vr_nrcpfcgc || ' - Erro ao cadastrar telefone (' || vr_dddctatocel03 || ') ' || vr_ctatocel03;
        RAISE vr_exception;
