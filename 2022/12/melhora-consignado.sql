...
BEGIN
  ...
  vr_nmarqbkp := 'ROLLBACK_MELHORA_CONSIG_'||to_char(sysdate,'ddmmyyyy_hh24miss')||'.sql';
  vr_nmarquiv := 'MELHORA_CONSIGNADO.csv';
  ...
  BEGIN     
    ...
    LOOP
      ...
      IF utl_file.IS_OPEN(vr_ind_arquiv) THEN
        ...
        vr_inrisco_atraso := cecred.risc0004.fn_traduz_nivel_risco(REPLACE(TRIM(vr_vet_dados(5)), CHR(13), ''));
