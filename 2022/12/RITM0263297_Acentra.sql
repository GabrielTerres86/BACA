DECLARE
  ...
  vc_cdcooper               CONSTANT cecred.crapcop.cdcooper%type := 5;
  vc_nrdcontaAdm            CONSTANT cecred.crapass.nrdconta%type := 850004;
  vr_nmarqbkp               VARCHAR2(100) := 'ROLLBACK_RITM0263297_Acentra.sql';
  vr_nmarqcri               VARCHAR2(100) := 'ArquivoRetorno_Acentra.csv';  
