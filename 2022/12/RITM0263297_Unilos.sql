DECLARE
  ...
  vc_cdcooper               CONSTANT cecred.crapcop.cdcooper%type := 6;
  vc_nrdcontaAdm            CONSTANT cecred.crapass.nrdconta%type := 850004;
  vr_nmarqbkp               VARCHAR2(100) := 'ROLLBACK_RITM0263297_Unilos.sql';
  vr_nmarqcri               VARCHAR2(100) := 'ArquivoRetorno_Unilos.csv';  
