DECLARE
  ...
  vc_cdcooper               CONSTANT cecred.crapcop.cdcooper%type := 13;
  vc_nrdcontaAdm            CONSTANT cecred.crapass.nrdconta%type := 99665670;
  vr_nmarqbkp               VARCHAR2(100) := 'ROLLBACK_RITM0263297_Civia.sql';
  vr_nmarqcri               VARCHAR2(100) := 'ArquivoRetorno_Civia.csv';  
