declare
  ...
  vr_nrdconta crapass.nrdconta%TYPE := 194743;
  vr_nrctremp craplem.nrctremp%TYPE := 37044;
  vr_nrparepr crappep.nrparepr%TYPE := 1;
  ...
  CURSOR cr_lancamento IS
    SELECT REGEXP_SUBSTR('1041,1705,1708,1711,3026','[^,]+', 1, LEVEL) as vr_cdhistor,
           REGEXP_SUBSTR('56.48,375.31,7.51,0.12,375.31','[^,]+', 1, LEVEL) as vr_vllanmto          
      FROM DUAL
