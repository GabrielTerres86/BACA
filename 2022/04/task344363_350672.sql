declare
  ...
  vr_nrdconta crapass.nrdconta%TYPE := 350672;
  vr_nrctremp craplem.nrctremp%TYPE := 80334;
  vr_nrparepr crappep.nrparepr%TYPE := 17;
  ...
  CURSOR cr_lancamento IS
    SELECT REGEXP_SUBSTR('1041,1705,1708,1711,3026','[^,]+', 1, LEVEL) as vr_cdhistor,
           REGEXP_SUBSTR('20.34,92.92,1.86,0.03,92.92','[^,]+', 1, LEVEL) as vr_vllanmto          
      FROM DUAL
