declare
  ...
  vr_nrdconta crapass.nrdconta%TYPE := 223913;
  vr_nrctremp craplem.nrctremp%TYPE := 57290;
  vr_nrparepr crappep.nrparepr%TYPE := 24;
  ...
  CURSOR cr_lancamento IS
    SELECT REGEXP_SUBSTR('1041,1705,1708,1711,3027','[^,]+', 1, LEVEL) as vr_cdhistor,
           REGEXP_SUBSTR('35.57,254.41,5.08,0.09,254.41','[^,]+', 1, LEVEL) as vr_vllanmto          
      FROM DUAL
