declare
  ...
  vr_nrdconta crapass.nrdconta%TYPE := 386545;
  vr_nrctremp craplem.nrctremp%TYPE := 51508;
  vr_nrparepr crappep.nrparepr%TYPE := 27;
  ...
  CURSOR cr_lancamento IS
    SELECT REGEXP_SUBSTR('1041,1705,1708,1711,3027','[^,]+', 1, LEVEL) as vr_cdhistor,
           REGEXP_SUBSTR('26.74,449.70,8.99,0.15,449.70','[^,]+', 1, LEVEL) as vr_vllanmto          
      FROM DUAL
