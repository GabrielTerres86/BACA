declare
  ...
  vr_nrdconta crapass.nrdconta%TYPE := 155098;
  vr_nrctremp craplem.nrctremp%TYPE := 14109;
  ...
  CURSOR cr_lancamento IS
    SELECT REGEXP_SUBSTR('1041,1705,1708,1711,3026','[^,]+', 1, LEVEL) as vr_cdhistor,
           REGEXP_SUBSTR('26.66,210.62,4.84,0.08,210.62','[^,]+', 1, LEVEL) as vr_vllanmto,
           REGEXP_SUBSTR('0,18,18,18,18','[^,]+', 1, LEVEL) as vr_nrparepr           
      FROM DUAL
