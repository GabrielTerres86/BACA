declare
  ...
  vr_nrdconta crapass.nrdconta%TYPE := 128090;
  vr_nrctremp craplem.nrctremp%TYPE := 30674;
  ...
  CURSOR cr_lancamento IS
    SELECT REGEXP_SUBSTR('1041,1705,1708,1711,3026','[^,]+', 1, LEVEL) as vr_cdhistor,
           REGEXP_SUBSTR('31.05,268.62,5.37,0.09,268.62','[^,]+', 1, LEVEL) as vr_vllanmto,
           REGEXP_SUBSTR('0,5,5,5,5','[^,]+', 1, LEVEL) as vr_nrparepr           
      FROM DUAL
