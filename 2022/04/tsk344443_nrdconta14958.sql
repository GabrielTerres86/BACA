declare
  ...
  vr_nrdconta crapass.nrdconta%TYPE := 14958;
  vr_nrctremp craplem.nrctremp%TYPE := 118515;
  vr_nrparepr crappep.nrparepr%TYPE := 9;
  ...
  CURSOR cr_lancamento IS
    SELECT REGEXP_SUBSTR('1041,1705,1708,1711,3027','[^,]+', 1, LEVEL) as vr_cdhistor,
           REGEXP_SUBSTR('1.98,24.39,.48,0.03,166.46','[^,]+', 1, LEVEL) as vr_vllanmto          
      FROM DUAL
