...
DECLARE
  ...
  --
  PROCEDURE pc_crps538_20220425(pr_cdcooper IN crapcop.cdcooper%TYPE --> Codigo Cooperativa
  ...
  BEGIN
    ...
    DECLARE
              ...
              FROM crapcob cob
                  ,(SELECT (SELECT ceb.cdcooper
                     ...
                     WHERE tit.cdcooper = pr_cdcooper
                       AND tit.dtmvtolt >= to_date('25042022', 'ddmmyyyy')
                       AND tit.cdbandst = 85
                       AND tit.nmarquiv = '29999425_REP.RET') a
      ...
      BEGIN
        ...
        LOOP
          ...
          IF vr_index_rel706 = 1 THEN
            ...
            ELSE
              -- Nome arquivo Impressao
              vr_nmarqimp := 'crrl706_' || GENE0002.fn_busca_time || '.lst';
            END IF;
      ...
      PROCEDURE pc_integra_cobranca_registrada(pr_cdcritic OUT INTEGER
        ...
        --
        CURSOR cr_crapcob_220425(pr_cdcooper crapcob.cdcooper%TYPE
      ...
      BEGIN
        ...
        BEGIN
          ...
          IF (rw_crapdat.inproces > 2 -- Processo Batch
            ...
            EXCEPTION
              WHEN OTHERS THEN
                SISTEMA.excecaoInterna('INC0136290');
            END;
            --
            -- 1o processamento
            ...
            LOOP
              ...
              *************************************************************/
              ...
              FOR rw_crapcob_220425 IN cr_crapcob_220425(pr_cdcooper => rw_crapcco.cdcooper
                ...
                PAGA0001.pc_valores_a_creditar(pr_cdcooper            => rw_crapcco.cdcooper
                                              ...
                                              ,pr_dtmvtolt            => rw_crapdat.dtmvtolt
                                              ,pr_dtcredit            => vr_dtcredit
                                              ,pr_idtabcob            => rw_crapcob_220425.idrowid_cob
...
BEGIN
  ...
  pc_log_programa(pr_dstiplog   => 'I'
                 ...
                 ,pr_idprglog   => vr_idprglog_principal);
  --
  FOR rw_crapcop IN (SELECT cop.cdcooper, cop.nmrescop
                       FROM crapcop cop
                      WHERE 1 = 1
                        AND cop.cdcooper <> 3
                        AND cop.flgativo = 1
    ...
    vr_dscritic := '';
    --
    pc_crps538_20220425(pr_cdcooper => rw_crapcop.cdcooper,
                        pr_cdagenci => 0,
                        pr_idparale => 0,
                        pr_flgresta => 0,
