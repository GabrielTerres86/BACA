declare
  ...
  vr_nrdconta crapass.nrdconta%TYPE := 1006126;
  vr_nrctremp craplem.nrctremp%TYPE := 312481;
  vr_nrparepr crappep.nrparepr%TYPE := 7;
  ...
  CURSOR cr_lancamento IS
    SELECT REGEXP_SUBSTR('1041,1705,1708,1711,3026','[^,]+', 1, LEVEL) as vr_cdhistor,
           REGEXP_SUBSTR('51.97,423.22,8.46,0.14,423.22','[^,]+', 1, LEVEL) as vr_vllanmto          
      FROM DUAL
