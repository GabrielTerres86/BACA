declare
  ...
  vr_nrdconta crapass.nrdconta%TYPE := 104027;
  vr_nrctremp craplem.nrctremp%TYPE := 17842;
  ...
  CURSOR cr_lancamento IS
    SELECT REGEXP_SUBSTR('1041,1705,1708,1711,3026','[^,]+', 1, LEVEL) as vr_cdhistor,
           REGEXP_SUBSTR('66.45,649.71,12.99,0.23,649.71','[^,]+', 1, LEVEL) as vr_vllanmto,
           REGEXP_SUBSTR('0,15,15,15,15','[^,]+', 1, LEVEL) as vr_nrparepr           
      FROM DUAL
