declare
  ...
  vr_nrdconta crapass.nrdconta%TYPE := 1019570;
  vr_nrctremp craplem.nrctremp%TYPE := 315729;
  vr_nrparepr crappep.nrparepr%TYPE := 6;
  ...
  CURSOR cr_lancamento IS
    SELECT REGEXP_SUBSTR('1041,1705,1708,1711,3026','[^,]+', 1, LEVEL) as vr_cdhistor,
           REGEXP_SUBSTR('19.76,349.59,6.99,0.13,349.59','[^,]+', 1, LEVEL) as vr_vllanmto          
      FROM DUAL
