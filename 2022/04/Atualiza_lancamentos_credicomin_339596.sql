declare
  ...
  vr_nrdconta crapass.nrdconta%TYPE := 142395;
  vr_nrctremp craplem.nrctremp%TYPE := 16565;
  ...
  CURSOR cr_lancamento IS
    SELECT REGEXP_SUBSTR('1041,1705,1708,1711,3026','[^,]+', 1, LEVEL) as vr_cdhistor,
           REGEXP_SUBSTR('13.89,117.68,2.35,0.04,117.68','[^,]+', 1, LEVEL) as vr_vllanmto,
           REGEXP_SUBSTR('0,16,16,16,16','[^,]+', 1, LEVEL) as vr_nrparepr           
      FROM DUAL
