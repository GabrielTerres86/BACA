DECLARE
  ...
  CURSOR cr_craplcm IS
    SELECT b.dtvencto
      ...
      ,b.cdcooper
      ,b.nrparepr
      ,decode(b.nrparepr,2, to_date('01/01/2022','dd/mm/yyyy'), to_date('01/03/2022','dd/mm/yyyy')) dtmvtolt
    ...
    FROM tbepr_consignado_pagamento b
      ,(SELECT cdcooper
       ...
       WHERE (cdcooper, nrdconta, nrctremp, nrparepr) IN
           ((1, 13455435 , 4674078 , 2),
            (1, 13455435 , 4674078 , 4))
         AND inliquid = 0) pep
  ...
  CURSOR cr_craplcm_estorno IS
    SELECT b.dtvencto,
           ...
           b.nrparepr,
           b.dtmvtolt,
           nvl(b.idintegracao,1) idintegracao
