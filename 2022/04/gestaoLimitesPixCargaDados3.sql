...
begin
	...
	USING (SELECT crapsnh.CDCOOPER, crapsnh.NRDCONTA, crapsnh.IDSEQTTL, crapsnh.VLLIMITE_PIX_COOPERADO, crapsnh.VLLIMITE_PIX FROM crapsnh crapsnh WHERE TPDSENHA = 1 AND CDSITSNH = 1) t2
