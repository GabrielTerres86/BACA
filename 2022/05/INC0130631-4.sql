...
and	a.tpcustei	= 1
and	a.DTMVTOLT	between to_date('01/05/2022','dd/mm/yyyy') and to_date('17/05/2022 23:59:59','dd/mm/yyyy hh24:mi:ss')
...
and	a.CDCOOPER	= b.CDCOOPER
and	a.tpseguro	= 4
and a.dtmvtolt = to_date('02/05/2022','dd/mm/yyyy');
...
if	(upper(cecred.gene0001.fn_database_name) like '%AYLLOSP%' or upper(cecred.gene0001.fn_database_name) like '%AILOST%') then
