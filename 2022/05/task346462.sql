DECLARE
  ...
  vr_nrdconta cecred.crappep.nrdconta%TYPE := 590894;
  vr_nrctremp cecred.crappep.nrctremp%TYPE := 276937;
...
BEGIN
  ...
  FOR rw_lancamentos IN cr_lancamento(pr_cdcooper => vr_cdcooper,
    ...
    IF rw_lancamentos.cdhistor IS NULL THEN
      ...
      GENE0001.pc_gera_log(pr_cdcooper => rw_lancamentos.cdcooper,
                           pr_cdoperad => '1',
