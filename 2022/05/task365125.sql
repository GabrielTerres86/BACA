DECLARE
  ...
  vr_cdcooper cecred.crappep.cdcooper%TYPE := 12;
  vr_nrdconta cecred.crappep.nrdconta%TYPE := 158593;
  vr_nrctremp cecred.crappep.nrctremp%TYPE := 33015;
