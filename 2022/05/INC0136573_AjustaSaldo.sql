DECLARE
  ...
  vc_dstransaSensbCRAPSLD             CONSTANT VARCHAR2(4000) := 'Sensibilizacao do Saldo (CRAPSLD) por script - INC0136573';
  vc_dstransaSensbCRAPSDA             CONSTANT VARCHAR2(4000) := 'Sensibilizacao do Saldo (CRAPSDA) por script - INC0136573';
  vc_dtinicioCRAPSDA                  CONSTANT DATE           := to_date('26/04/2022','dd/mm/yyyy');
  ...
  CURSOR cr_crapsld is
    SELECT a.nrdconta
      ...
      from CECRED.crapsld a
          ,(select 10795383 as nrdconta, 17000 as valor from dual) contas
