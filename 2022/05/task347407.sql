DECLARE
  ...
  vr_cdcooper cecred.crappep.cdcooper%TYPE := 13;
  vr_nrdconta cecred.crappep.nrdconta%TYPE := 231592;
  vr_nrctremp cecred.crappep.nrctremp%TYPE := 134611;
  vr_nrparepr cecred.crappep.nrparepr%TYPE := 6;
    ...
    select pr_cdcooper as cdcooper
      ...
      from (select case cl.cdhistor
             ...
             where cl.cdcooper = pr_cdcooper
               ...
               and trunc(cl.dtmvtolt) = trunc(to_date('14/02/2022', 'dd/mm/yyyy'))
