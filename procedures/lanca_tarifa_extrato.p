...
Procedure: lanca_tarifa_extrato.p 
Objetivo : Lançar tarifa do extrato na C/C
Autor    : Lucas Lunelli
Data     : Ago 2015
...
DEFINE         VARIABLE tmp_vlposesp    AS INTEGER                  NO-UNDO.
...
RUN procedures/grava_log.p (INPUT "Lançando tarifa do extrato...").
...
DO:
    ...
    DO  WHILE TRUE:
        ...
        IF  xDoc:NUM-CHILDREN = 0  OR
            xRoot:NAME <> "TAA"    THEN
            DO:
                RUN procedures/grava_log.p (INPUT "Lançando tarifa do extrato - Sem comunicação com o servidor.").
        ...
        DO  aux_contador = 1 TO xRoot:NUM-CHILDREN:
            ...
            IF  xField:NAME = "DSCRITIC" THEN
                DO:
                    RUN procedures/grava_log.p (INPUT "Lançando tarifa do extrato - " + xText:NODE-VALUE).
...
RUN procedures/grava_log.p (INPUT "Informacoes do comprovante obtidas com sucesso.").
