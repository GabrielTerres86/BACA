/* ..............................................................................
 ...
 Procedure: confirma_update.p 
 Objetivo : Confirma ao Servidor que Update foi efetuado
 Autor    : Evandro
 Data     : Março 2011
...
DO:
    ...
    DO  WHILE TRUE:
        ...
        IF  xDoc:NUM-CHILDREN  = 0       OR
            xRoot:NAME        <> "TAA"  THEN
            DO:
                RUN procedures/grava_log.p (INPUT "Update - Sem comunicação com o servidor").
        ...
        DO  aux_contador = 1 TO xRoot:NUM-CHILDREN:
            ...
            IF  xField:NAME = "UPDATE"   AND
                xText:NODE-VALUE = "OK"  THEN
                glb_flreboot = NO.
            ELSE
                DO:
                    RUN procedures/grava_log.p (INPUT "Update - " + xText:NODE-VALUE). 
