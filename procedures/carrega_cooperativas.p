...
Procedure: carrega_cooperativas.p 
Objetivo : Obter as cooperativas
Autor    : Gabriel
Data     : Maio 2013
...
DEFINE TEMP-TABLE tt-crapcop NO-UNDO
...
RUN procedures/grava_log.p (INPUT "Obtendo cooperativas...").
...
RESPOSTA:
DO:
    DEFINE VARIABLE  aux_qtcooper AS INTEGER     NO-UNDO.
    DEFINE VARIABLE  aux_ifcooper AS INTEGER     NO-UNDO.
    ...
    DO  WHILE TRUE:
        ...
        DO  aux_qtcooper = 1 TO xRoot:NUM-CHILDREN:
            
            xRoot:GET-CHILD(xRoot2,aux_qtcooper).
            ...
            IF  xRoot2:NAME = "DSCRITIC"  THEN
                DO:
                    RUN procedures/grava_log.p (INPUT "Cooperativas - " + xText:NODE-VALUE).
           ...
           DO  aux_ifcooper = 1 TO xRoot2:NUM-CHILDREN:

               xRoot2:GET-CHILD(xField,aux_ifcooper).
                ...
                IF   xField:NAME = "NMRESCOP"   THEN
                     ASSIGN tt-crapcop.nmrescop = xText:NODE-VALUE.
                ELSE
                IF   xField:NAME = "CDAGECTL"   THEN
                     ASSIGN tt-crapcop.cdagectl = INTE(xText:NODE-VALUE).
...
RUN procedures/grava_log.p (INPUT "Cooperativas obtidas com sucesso.").
