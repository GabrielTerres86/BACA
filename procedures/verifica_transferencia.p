...
Procedure: verifica_transferencia.p 
...
Ultima alteração: 15/10/2010 - Ajustes para TAA compartilhado (Evandro).
                  ...
                  04/04/2011 - Ajustes devido ao agendamento (Henrique).
                  
                  15/05/2013 - Transferencia intercooperativa (Gabriel).
...
IF  par_flagenda THEN
    DO:
        RUN procedures/grava_log.p (INPUT "Verificando agendamento de transferência...").
        ...
        RUN mensagem.w (INPUT NO,
                        ...
                        INPUT "de Transferência.",
                        INPUT "").
    END.
ELSE
    DO:
        RUN procedures/grava_log.p (INPUT "Verificando transferência...").
    
        RUN mensagem.w (INPUT NO,
                        INPUT "  AGUARDE...",
                        INPUT "",
                        INPUT "",
                        INPUT "Verificando Transferência.",
                        INPUT "",
                        INPUT "").
    END.
...
IF  par_flagenda THEN
    RUN procedures/grava_log.p (INPUT "Agendamento de Transferencia autorizada.").
ELSE
    RUN procedures/grava_log.p (INPUT "Transferencia autorizada.").
