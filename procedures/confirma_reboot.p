/* ..............................................................................
 ...
 Procedure: confirma_reboot.p 
 Objetivo : Confirma ao Servidor que Reboot foi efetuado
 Autor    : Evandro
 Data     : Janeiro 2011
...
DO:
    ...
    DO  WHILE TRUE:
        ...
        IF  xDoc:NUM-CHILDREN  = 0       OR
            xRoot:NAME        <> "TAA"  THEN
            DO:
                RUN procedures/grava_log.p (INPUT "Reboot - Sem comunicação com o servidor").
        ...
        DO  aux_contador = 1 TO xRoot:NUM-CHILDREN:
            ...
            ELSE
                DO:
                    ...
                    RUN procedures/grava_log.p (INPUT "Reboot - " + xText:NODE-VALUE). 
