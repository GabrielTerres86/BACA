...
Procedure: exclui_telefone_sms_debaut.p
Objetivo : Desabilitar cadastro do telefone para SMS DEBAUT [PROJ320]
Autor    : Lucas Lunelli
Data     : Abril/2016
...
RUN procedures/grava_log.p (INPUT "Excluindo cadastro de SMS DEBAUT para o telefone...").
...
RUN mensagem.w (INPUT NO,
                ...
                INPUT "",
                INPUT "",
                INPUT "Excluindo cadastro de SMS para o telefone...",
                INPUT "",
                INPUT "").
...
DO:
    ...
    DO  WHILE TRUE:
        ...
        IF  xDoc:NUM-CHILDREN = 0  OR
            xRoot:NAME <> "TAA"    THEN
            DO:
                RUN procedures/grava_log.p (INPUT "Excluindo cadastro de SMS DEBAUT para o telefone - Sem comunicação com o servidor.").
        ...
        DO  aux_contador = 1 TO xRoot:NUM-CHILDREN:
            ...
            IF  xField:NAME = "DSCRITIC"  THEN
                DO:
                    RUN procedures/grava_log.p (INPUT "Excluindo cadastro de SMS DEBAUT para o telefone - " + xText:NODE-VALUE).
                ...
                END.
            ELSE
            IF  xField:NAME = "EXCLUSAO_SMS_DEBAUT"   AND
...
IF  NOT par_flgderro THEN
    DO:
        RUN procedures/grava_log.p (INPUT "Cadastro de SMS DEBAUT para o telefone excluído com sucesso.").

        RUN mensagem.w (INPUT NO,
                        INPUT "    ATENÇÃO",
                        INPUT "",
                        INPUT "Telefone pra SMS",
                        INPUT "excluído com sucesso.",
                        INPUT "",
                        INPUT "").
    END.
