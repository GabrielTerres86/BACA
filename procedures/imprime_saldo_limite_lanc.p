...
DEFINE  INPUT PARAM par_valaucre    AS DECIMAL                      NO-UNDO.
...
DEFINE  INPUT PARAM par_vlcreddeb   AS DECIMAL                      NO-UNDO.
...
par_tximpres = par_tximpres +
               ...
               "     CREDITOS PROGRAMADOS:    " + STRING(par_valaucre,"zz,zzz,zzz,zz9.99-") +
               ...
               "                              ------------------"                           +
               " SALDO CREDITOS E DEBITOS:    " + STRING(par_vlcreddeb,"zz,zzz,zzz,zz9.99-") +
               "                                                "                           +
