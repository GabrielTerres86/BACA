...
DEFINE  INPUT PARAMETER par_dsdgrup1    AS CHAR                     NO-UNDO.
DEFINE  INPUT PARAMETER par_dsdgrup2    AS CHAR                     NO-UNDO.
DEFINE  INPUT PARAMETER par_dsdgrup3    AS CHAR                     NO-UNDO.
...
/* codifica cada letra de cada grupo para nao ser possivel visualizar
   nos logs a tentativa de senha */

       /* grupo 1 */
ASSIGN tmp_dsdletr1 = ENCODE(ENTRY(1,par_dsdgrup1,"-"))
       tmp_dsdletr2 = ENCODE(ENTRY(2,par_dsdgrup1,"-"))
       tmp_dsdletr3 = ENCODE(ENTRY(3,par_dsdgrup1,"-"))
       par_dsdgrup1 = tmp_dsdletr1 + "-" + tmp_dsdletr2 + "-" + tmp_dsdletr3
    
       /* grupo 2 */
       tmp_dsdletr1 = ENCODE(ENTRY(1,par_dsdgrup2,"-"))
       tmp_dsdletr2 = ENCODE(ENTRY(2,par_dsdgrup2,"-"))
       tmp_dsdletr3 = ENCODE(ENTRY(3,par_dsdgrup2,"-"))
       par_dsdgrup2 = tmp_dsdletr1 + "-" + tmp_dsdletr2 + "-" + tmp_dsdletr3

       /* grupo 3 */
       tmp_dsdletr1 = ENCODE(ENTRY(1,par_dsdgrup3,"-"))
       tmp_dsdletr2 = ENCODE(ENTRY(2,par_dsdgrup3,"-"))
       tmp_dsdletr3 = ENCODE(ENTRY(3,par_dsdgrup3,"-"))
...
DO:
    ...
    /* ---------- */
    xDoc:CREATE-NODE(xField,"DSDGRUP1","ELEMENT").
    xRoot:APPEND-CHILD(xField).
    
    xDoc:CREATE-NODE(xText,"","TEXT").
    xText:NODE-VALUE = par_dsdgrup1.
    xField:APPEND-CHILD(xText).

    /* ---------- */
    xDoc:CREATE-NODE(xField,"DSDGRUP2","ELEMENT").
    xRoot:APPEND-CHILD(xField).
    
    xDoc:CREATE-NODE(xText,"","TEXT").
    xText:NODE-VALUE = par_dsdgrup2.
    xField:APPEND-CHILD(xText).

    /* ---------- */
    xDoc:CREATE-NODE(xField,"DSDGRUP3","ELEMENT").
    xRoot:APPEND-CHILD(xField).
