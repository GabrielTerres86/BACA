...
RUN procedures/grava_log.p (INPUT "Atualizando Data Telefone...").
...
RUN mensagem.w (INPUT NO,
                ...
                INPUT "",
                INPUT "",
                INPUT "Atualizando telefone de contato...",
                INPUT "",
                INPUT "").
...
DO:
    ...
    DO  WHILE TRUE:
        ...
        IF  xDoc:NUM-CHILDREN = 0  OR
            xRoot:NAME <> "TAA"    THEN
            DO:
                RUN procedures/grava_log.p (INPUT "Atualizacao Data de Telefone - Sem comunicação com o servidor.").
        ...
        DO  aux_contador = 1 TO xRoot:NUM-CHILDREN:
            ...
            IF  xField:NAME = "DSCRITIC"  THEN DO:
                ...
                RUN procedures/grava_log.p (INPUT "Atualizacao Data de Telefone - " + xText:NODE-VALUE).
...
IF  NOT par_flgderro THEN
    DO:
        RUN procedures/grava_log.p (INPUT "Telefone atualizado com sucesso.").

        RUN mensagem.w (INPUT NO,
                        INPUT "    ATENÇÃO",
                        INPUT "",
                        INPUT "Telefone atualizado com sucesso.",
                        INPUT "",
                        INPUT "",
                        INPUT "").
    END.
