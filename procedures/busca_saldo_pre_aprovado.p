/* ..............................................................................
 ...
 Procedure: busca_saldo_pre_aprovado.p 
 Objetivo : Busca o saldo disponivel para o Pre-Aprovado
...
DEFINE OUTPUT PARAMETER TABLE FOR tt-dados-cpa.
...
RUN procedures/grava_log.p (INPUT "Busca saldo disponivel pre-aprovado...").
...
DO:
    ...
    DO  WHILE TRUE:
        ...
        DO  aux_contador = 1 TO xRoot:NUM-CHILDREN:
            ...
            IF  xField:NAME = "VLDISCRD"  THEN
                DO:
                    ASSIGN tt-dados-cpa.vldiscrd = DECI(xText:NODE-VALUE).
                END.

            IF  xField:NAME = "TXMENSAL"  THEN
                DO:
                    ASSIGN tt-dados-cpa.txmensal = DECI(xText:NODE-VALUE).
                END.
...
RUN procedures/grava_log.p (INPUT "Busca saldo disponivel pre-aprovado com " +
                                  "sucesso.").
