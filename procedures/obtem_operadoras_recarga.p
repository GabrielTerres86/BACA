/* ..............................................................................
 ...
 Procedure: obtem_operadoras_recarga.p
 Objetivo : Obter operadoras/produtos para recarga de celular
 Autor    : Lucas Reinert
 Data     : Fevereiro 2017
...
DEFINE OUTPUT PARAMETER TABLE FOR tt-operadoras-recarga.
...
RUN procedures/grava_log.p (INPUT "Buscando operadoras de celular...").
    ...
    DO  WHILE TRUE:
        ...
        DO  aux_qtfavori = 1 TO xRoot:NUM-CHILDREN:
            ...
            IF  xRoot2:NAME = "DSCRITIC"  THEN
                DO:
                    RUN procedures/grava_log.p (INPUT "Operadoras Recarga - " + xText:NODE-VALUE).
               ...
               DO:               
                   ...
                   DO  aux_contador = 1 TO xRoot2:NUM-CHILDREN:
                       ...
                       IF   xField:NAME = "CDOPERADORA"   THEN
                            ASSIGN tt-operadoras-recarga.cdoperadora = INTE(xText:NODE-VALUE).
                       ELSE
                       IF   xField:NAME = "NMOPERADORA"   THEN
                            ASSIGN tt-operadoras-recarga.nmoperadora = xText:NODE-VALUE.
                       ELSE
                       IF   xField:NAME = "CDPRODUTO"   THEN
                            ASSIGN tt-operadoras-recarga.cdproduto = DECI(xText:NODE-VALUE).
                       ELSE
                       IF   xField:NAME = "NMPRODUTO"   THEN
                            ASSIGN tt-operadoras-recarga.nmproduto = xText:NODE-VALUE.
                   END.
               END.
...
RUN procedures/grava_log.p (INPUT "Operadoras buscadas com sucesso.").
