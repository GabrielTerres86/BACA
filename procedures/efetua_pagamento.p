...
Ultima alteração: 15/10/2010 - Ajustes para TAA compartilhado (Evandro).
                  ...
                  19/08/2015 - unificado os fontes efetua_pagamento_titulo e
...
IF par_idtpdpag = 1 THEN
  ASSIGN aux_dsoperac = "Convenio".
ELSE
  ASSIGN aux_dsoperac = "Título".
...
IF  NOT par_flagenda THEN
    DO:
        ...
        IF  par_flgderro   OR
            ...
            DO:
                RUN procedures/grava_log.p (INPUT "Pagamento de " + aux_dsoperac + 
                                                  " - Saldo Insuficiente").
        ...
        RUN procedures/grava_log.p (INPUT "Efetuando Pagamento de " + aux_dsoperac + "...").

        RUN mensagem.w (INPUT NO,
                        INPUT "  AGUARDE...",
                        INPUT "",
                        INPUT "Efetuando Pagamento",
                        INPUT "de " + aux_dsoperac + ".",
                        INPUT "",
                        INPUT "").
    END.
ELSE
    DO:
        ...
        RUN procedures/grava_log.p (INPUT "Efetuando Agendamento de " + aux_dsoperac + "...").
...
/* Para titulos   - Se é agendado TPDTRANS = 12, senão TPDTRANS = 9 */
/* Para Convenios - Se é agendado TPDTRANS = 11, senao TPDTRANS = 10 */

IF par_flagenda THEN
DO:
  IF par_idtpdpag = 1 THEN /* convenio */
    aux_tpdtrans = 11.
  ELSE IF par_idtpdpag = 2 THEN /* titulo */
    aux_tpdtrans = 12.
END.
  ELSE 
  DO:
...
DO:
    ...
    /* ------------------- */
    xDoc:CREATE-NODE(xField,"TPCPTDOC","ELEMENT").
    xRoot:APPEND-CHILD(xField).
...
DO:
    ...
    DO  WHILE TRUE:
        ...
        IF  xDoc:NUM-CHILDREN = 0  OR
            xRoot:NAME <> "TAA"    THEN
            DO:
                RUN procedures/grava_log.p (INPUT "Pagamento de " + aux_dsoperac + " - Sem comunicação com o servidor.").
...
DO:
    comando:CommandText = "UPDATE CRAPLTL SET CDSITATU = 1 " +
                            "WHERE CDCOOPER = " + STRING(glb_cdcooper)  + " AND " +
                                  ...
                                  "TPDTRANS = " + STRING(aux_tpdtrans)  + " AND " +
