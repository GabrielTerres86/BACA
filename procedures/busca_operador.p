...
Procedure: busca_operador.p 
Objetivo : Verifica e retorna o nome do operador
Autor    : Evandro
Data     : Janeiro 2010
...
DEFINE OUTPUT PARAMETER par_nmoperad    AS CHAR                     NO-UNDO.
...
DO:
    ...
    DO  WHILE TRUE:
        ...
        IF  xDoc:NUM-CHILDREN = 0  OR
             xRoot:NAME <> "TAA"   THEN
            DO:
                RUN procedures/grava_log.p (INPUT "Busca Operador - Sem comunicação com o servidor").
        ...
        DO  aux_contador = 1 TO xRoot:NUM-CHILDREN:
            ...
            IF  xField:NAME = "DSCRITIC"  THEN
                DO:
                    RUN procedures/grava_log.p (INPUT "Busca Operador - " + xText:NODE-VALUE).
                    par_flgderro = YES.
                ...
                END.
            ELSE
            IF  xField:NAME = "NMOPERAD"  THEN
                par_nmoperad = xText:NODE-VALUE.
