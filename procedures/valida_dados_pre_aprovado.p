...
Procedure: valida_dados_pre_aprovado.p
Objetivo : Valida os dados do Pre-Aprovado
...
RUN procedures/grava_log.p (INPUT "Valida os dados do pre-aprovado...").
...
RUN procedures/grava_log.p 
    (INPUT "Validado os dados do pre-aprovado com sucesso.").
