...
Procedure: altera_senha.p 
Objetivo : Alterar a senha do cartao
Autor    : Evandro
Data     : Janeiro 2010
...
Ultima alteração: 15/10/2010 - Ajustes para TAA compartilhado (Evandro).
                  ...
                  18/01/2012 - Codificar Senha (Evandro).
                  
                  27/08/2015 - Ajuste para enviar como parametro o tipo 
                               do cartao (James).
............................................................................... */
...
RUN procedures/grava_log.p (INPUT "Alterando a senha do cartão...").
...
DO:
    ...
    xDoc:CREATE-NODE(xText,"","TEXT").
    xText:NODE-VALUE = ENCODE(par_dssencar).
    xField:APPEND-CHILD(xText).
...
DO:
    ...
    DO  WHILE TRUE:
        ...
        IF  xDoc:NUM-CHILDREN = 0  OR
            xRoot:NAME <> "TAA"    THEN
            DO:
                RUN procedures/grava_log.p (INPUT "Alterar Senha - Sem comunicação com o servidor").
        ...
        DO  aux_contador = 1 TO xRoot:NUM-CHILDREN:
            ...
            IF  xField:NAME = "DSCRITIC"  THEN
                DO:
                    RUN procedures/grava_log.p (INPUT "Alterar Senha - "+ xText:NODE-VALUE).
...
RUN procedures/grava_log.p (INPUT "Senha alterada com sucesso.").
