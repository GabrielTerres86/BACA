/*...........................................................................
    ...
    Data    : Julho/2011                        Ultima Atualizacao: 05/07/2018
           ...
           DO:
              ...
              IF AVAIL craplcm THEN
               ...
               IF   par_nmdatela = "CMEDEP"   THEN
                    DO:
                        IF   craplcm.cdhistor <> 1    AND
                             craplcm.cdhistor <> 1590     /*-- Marcelo Telles Coelho - Projeto 420 - PLD*/
                        THEN
                             DO:
               ...
               IF   par_nmdatela = "CMESAQ"   THEN
                    DO:
                        IF   craplcm.cdhistor <> 21   AND
                             ...
                             craplcm.cdhistor <> 2692     /*-- Marcelo Telles Coelho - Projeto 420 - PLD*/
                        THEN
                             DO:
                                 ASSIGN aux_cdcritic = 83.
                                 LEAVE.
