/*.............................................................................
   ...
   Autor   : André (DB1)
   Data    : Maio/2011                     Ultima atualizacao: 18/04/2016
...
DEF VAR aux_cddsenha AS INTE                                           NO-UNDO.
DEF VAR aux_inassele AS INTE                                           NO-UNDO.
...
PROCEDURE valores_entrada:
    ...
    FOR EACH tt-param:
        ...
        CASE tt-param.nomeCampo:
            ...
            WHEN "inassele" THEN aux_inassele = INTE(tt-param.valorCampo).
...
PROCEDURE valida_senha_cooperado: 
    ...
    RUN valida_senha_cooperado IN hBO (INPUT aux_cdcooper,
                                       INPUT aux_cdagenci,
                                       INPUT aux_nrdcaixa,
                                       INPUT aux_cdoperad,
                                       INPUT aux_nmdatela,
...
PROCEDURE atualiza_inassele:
    ...
    RUN atualiza_inassele IN hBO ( INPUT aux_cdcooper,
                                   INPUT aux_cdagenci,
                                   INPUT aux_nrdcaixa,
                                   INPUT aux_cdoperad,
                                   INPUT aux_nmdatela,
