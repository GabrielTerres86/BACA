/*..............................................................................
   ...
   Autor   : Murilo/David
   Data    : 21/06/2007                        Ultima atualizacao: 19/04/2017
    ...
    DO ON ERROR UNDO, LEAVE:
       ...
       IF  par_idimpres = 3  THEN /** Proposta **/
           DO:         
               ...
               IF  par_cdcooper <> 3  THEN
                   DO:
                       FIND FIRST tt-ratings WHERE tt-ratings.tpctrrat = 1            AND
                                                   tt-ratings.nrctrrat = par_nrctrlim 
                                                   NO-LOCK NO-ERROR.
        ...
        DO:
            ...
            FOR EACH crapavt WHERE crapavt.cdcooper = par_cdcooper AND
                ...
                ASSIGN tt-repres-ctr.nmrepres = crapavt.nmdavali
                       ...
                       tt-repres-ctr.cdoedrep = crapavt.cdoeddoc.
                    ...
                    DO:
                        ...
                        IF  AVAILABLE crabass  THEN
                            ASSIGN tt-repres-ctr.nmrepres = crabass.nmprimtl
                                   ...
                                   tt-repres-ctr.cdoedrep = crabass.cdoedptl.
                    END.
