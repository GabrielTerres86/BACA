                   ...
                   IF  NOT AVAIL crapass THEN 
                    ...
                    ELSE
                        DO:
                             ...
                             IF  (crapdoc.tpdocmto = 4 AND crapass.inpessoa <> 1) OR 
                                 (crapdoc.tpdocmto = 12 AND crapass.inpessoa = 1) THEN
                                 NEXT.
        ...
        IF  par_tpdocmto = 102 THEN
            DO:
                FOR EACH crapadt FIELDS(cdcooper nrdconta nrctremp nraditiv 
                    ...
                    FIND FIRST crapepr WHERE crapepr.cdcooper = crapadt.cdcooper AND
                                        crapepr.nrdconta = crapadt.nrdconta AND
                                        crapepr.nrctremp = crapadt.nrctremp AND
                                        NOT CAN-DO("100,800,850,900,6901,6902,6903,6904,6905",
                                                  STRING(crapepr.cdlcremp)) NO-LOCK NO-ERROR.
                    ...
                    ASSIGN tt-documentos-liberados.tpdocmto = 102
                           ...
                           tt-documentos-liberados.vllanmto = crapepr.vlemprst WHEN AVAIL crapepr.
