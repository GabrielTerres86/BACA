/*.............................................................................
    ...
    Autor     : David
    Data      : Janeiro/2009                  Ultima Atualizacao: 14/07/2015
        ...
        DO WHILE TRUE ON  ERROR UNDO ARQUIVOS, LEAVE LOOP_IMPORTACAO 
            ...
            DO WHILE TRUE TRANSACTION 
                ...
                */
                ...
                CREATE crapdne.
                ASSIGN crapdne.nrceplog = INTE(ENTRY(1,aux_setlinha,"@"))
                       crapdne.cduflogr = CAPS(ENTRY(2,aux_setlinha,"@"))
                       crapdne.nmextlog = SUBSTR(CAPS(ENTRY(3,aux_setlinha,"@")),1,70)
                       crapdne.nmreslog = CAPS(ENTRY(4,aux_setlinha,"@"))
                       crapdne.dscmplog = CAPS(ENTRY(5,aux_setlinha,"@"))
                       crapdne.dstiplog = CAPS(ENTRY(6,aux_setlinha,"@"))
                       crapdne.nmextbai = CAPS(ENTRY(7,aux_setlinha,"@"))
                       crapdne.nmresbai = CAPS(ENTRY(8,aux_setlinha,"@"))
                       crapdne.nmextcid = CAPS(ENTRY(9,aux_setlinha,"@"))
                       crapdne.nmrescid = CAPS(ENTRY(10,aux_setlinha,"@"))
