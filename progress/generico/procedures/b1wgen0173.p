/*.............................................................................
    ...
    Data    : Agosto/2013                       Ultima Atualizacao: 05/08/2016

    Objetivo  : Possuir todas as regras de negocio da tela CLDSED.

    Alteracoes: 
               26/12/2013 - Adequaçao aos padroes CECRED de indentaçao e
               ...
               18/12/2014 - Remover a condiçao de crapass.cdagenci da 
                            Carrega_creditos. Adicionado a include das 
                            temp-table da BO173. Validaçao das funcionalidades
                            para conversao WEB (Douglas - Chamado 143945)

               05/08/2016 - Ajuste para utilizar corretamente as includes de cabecalho
							na geracao de relatorios
							(Adriano - SD 495725)

               09/08/2016 - Aumento no tamanho da linha impressa no arquivo, para comportar
                            o novo tamanho dos campos de justificativa (60 --> 1000).
                            Chamado 493179 (Heitor - RKAM)
.............................................................................*/
...
PROCEDURE Valida_fechamento:
    ...
    /* Validar se a data informada em tela é superior a data do sistema 
       Se for, nao deixa realizar o fechamento */
...
PROCEDURE Carrega_pesquisa:
	...
	DEFINE INPUT  PARAMETER par_nriniseq	AS INT	       NO-UNDO.
	DEFINE INPUT  PARAMETER par_nrregist    AS INT		   NO-UNDO.

	DEFINE OUTPUT PARAMETER par_qtregist AS INT            NO-UNDO.
    DEFINE OUTPUT PARAMETER TABLE FOR tt-pesquisa.
    DEFINE OUTPUT PARAMETER TABLE FOR tt-erro.

	DEFINE VAR aux_nrregist AS INT					       NO-UNDO.
...
PROCEDURE Gera_imprime_arq_pesquisa:
    ...
    IF par_tpdsaida = "A" THEN DO:
        ...
        FOR EACH tt-pesquisa NO-LOCK BY tt-pesquisa.cdagenci
            ...
            PUT STREAM str_1 aux_linharel FORMAT "x(1200)"
                SKIP.
    ...
    ELSE DO:
		...
		{ sistema/generico/includes/b1cabrel132.i "11" "610" }
...
PROCEDURE Gera_imprime_arq_atividade:
    ...
    ELSE
        DO:
            ...
            PUT STREAM str_1 aux_linharel FORMAT "x(3300)"
                SKIP.
...
PROCEDURE Carrega_atividade:
	...
	FOR EACH crapcld WHERE 
	    ...
	    IF NOT AVAIL crapass THEN
		 ...
		 IF NOT (crapass.tpvincul = "FU" OR   /* funcionario da cooperativa*/
