...
PROCEDURE busca_dados_limite:
    ...
    IF  NOT AVAILABLE crapprp   THEN                                   
        DO:
            ASSIGN aux_cdcritic = 0.
                   aux_dscritic = "Regisro de proposta de desconto de cheque nao encontrada.".
       ...
       FOR EACH crabcdb WHERE crabcdb.cdcooper = par_cdcooper       AND
           ...
           DO:
             ...
             IF aux_inpessoa = 1 THEN
               /* IOF Operacacao PF */
               aux_periofop = aux_qtdiaiof * const_txiofpf.
             ELSE
               /* IOF Operacacao PJ */
               aux_periofop = aux_qtdiaiof * const_txiofpj.
             ...
             IF  NOT AVAILABLE craplcm   THEN
                 DO:
                    ...
                    RUN verifica-imunidade-tributaria IN h-b1wgen0159(
                                                 ...
                                                 INPUT TRUE,
                                                 INPUT 3,
                                                 INPUT ROUND((aux_vlborder * tt-iof.txccdiof) + aux_vltotaliofsn, 2),
                                                OUTPUT aux_flgimune,
                                                OUTPUT TABLE tt-erro).
