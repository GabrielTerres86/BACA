...
DEF VAR aux_altagchq AS INTE                                           NO-UNDO.
...
PROCEDURE valida-conta-migrada:
    ...
    RUN valida-conta-migrada IN hBO (INPUT aux_cdcooper, 
                                     INPUT aux_cdagenci, 
                                     INPUT aux_nrdcaixa,
                                     INPUT aux_cdoperad,
                                     INPUT aux_nmdatela, 
    ...
    ELSE
        DO:
            RUN piXmlNew.
            RUN piXmlAtributo (INPUT "altagchq",INPUT STRING(aux_altagchq)).
            RUN piXmlSave.
        END.
...
PROCEDURE valida-agencia:
    ...
    RUN valida-agencia IN hBO (INPUT aux_cdcooper, 
                               INPUT aux_cdagenci, 
                               INPUT aux_nrdcaixa,
                               INPUT aux_cdoperad,
                               INPUT aux_nmdatela, 
