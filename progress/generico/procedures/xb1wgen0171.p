...
PROCEDURE gravames_alterar :
    ...
    RUN gravames_alterar IN hBO (INPUT aux_cdcooper,
                                 INPUT aux_cdfinemp,
    ...
    ELSE DO:
        ...
        RUN piXmlNew.
        RUN piXmlAtributo (INPUT "dssitfin",INPUT STRING(ret_dssitfin)).
        RUN piXmlSave.
...
PROCEDURE gravames_consultar :

    RUN gravames_consultar IN hBO (INPUT aux_cdcooper,
                                   INPUT aux_cdfinemp,
                                  OUTPUT TABLE tt-erro).
...
PROCEDURE gravames_cancelar :
    ...
    RUN gravames_cancelar IN hBO (INPUT aux_cdcooper,
                                  INPUT aux_cdfinemp,
                                 OUTPUT TABLE tt-erro).
...
PROCEDURE gravames_geracao_arquivo :
    ...
    RUN gravames_geracao_arquivo IN hBO (INPUT aux_cdcooper,
                                         INPUT aux_cdfinemp,
                                        OUTPUT TABLE tt-erro).
...
PROCEDURE gravames_processamento_retorno :

    RUN gravames_processamento_retorno IN hBO (INPUT aux_cdcooper,
                                               INPUT aux_cdfinemp,
                                              OUTPUT TABLE tt-erro).
...
PROCEDURE gravames_baixa_manual :
    ...
    RUN gravames_baixa_manual IN hBO (INPUT aux_cdcooper,
                                      INPUT aux_cdfinemp,
                                     OUTPUT TABLE tt-erro).
...
PROCEDURE gravames_inclusao_manual :
    ...
    RUN gravames_inclusao_manual IN hBO (INPUT aux_cdcooper,
                                         INPUT aux_cdfinemp,
                                        OUTPUT TABLE tt-erro).
...
PROCEDURE gravames_impressao_relatorio :
    ...
    RUN gravames_impressao_relatorio IN hBO (INPUT aux_cdcooper,
                                             INPUT aux_cdfinemp,
                                            OUTPUT TABLE tt-erro).
...
PROCEDURE valida_bens_alienados:
    ...
    RUN valida_bens_alienados IN hBO (INPUT aux_cdcooper,
                                      INPUT aux_cdfinemp,
                                     OUTPUT TABLE tt-erro).
...
PROCEDURE valida_eh_alienacao_fiduciaria:
    ...
    RUN valida_eh_alienacao_fiduciaria IN hBO (INPUT aux_cdcooper,
                                               INPUT aux_cdfinemp,
                                              OUTPUT TABLE tt-erro).
...
PROCEDURE solicita_baixa_automatica:
    ...
    RUN solicita_baixa_automatica IN hBO (INPUT aux_cdcooper,
                                          INPUT aux_cdfinemp,
                                         OUTPUT TABLE tt-erro).
