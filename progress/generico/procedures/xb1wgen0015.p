/*..............................................................................
   ...
   Autor   : David
   Data    : 12/02/2008                        Ultima atualizacao: 16/12/2014
...
/******************************************************************************/
/**            Procedure para consultar contas para TED pendentes            **/
/******************************************************************************/
PROCEDURE consulta-contas-pendentes:

    RUN consulta-contas-pendentes IN hBO (INPUT aux_cdcooper,
                                          INPUT aux_cdagenci,
                                          INPUT aux_nrdcaixa,
                                          INPUT aux_cdoperad,
                                          INPUT aux_nmdatela,
    ...
    ELSE
        DO:
            RUN piXmlNew.
            RUN piXmlExport (INPUT TEMP-TABLE tt-contas-pendentes:HANDLE,
                             INPUT "ContasPendentes").
...
/**            Procedure para consultar contas para TED pendentes            **/
/******************************************************************************/
PROCEDURE confirma-contas-pendentes:

    RUN confirma-contas-pendentes IN hBO (INPUT aux_cdcooper,
                                          INPUT aux_cdagenci,
                                          INPUT aux_nrdcaixa,
                                          INPUT aux_cdoperad,
                                          INPUT aux_nmdatela,
