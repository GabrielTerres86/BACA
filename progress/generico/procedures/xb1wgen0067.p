/*.............................................................................
    ...
    Programa: xb1wgen0067.p
    Autor   : Jose Luis
    Data    : Abril/2010                   Ultima atualizacao: 00/00/0000   

    Objetivo  : BO de Comunicacao XML x BO - CONTAS, FINANCEIRO (BANCOS)
...
DEF VAR aux_dstipope AS CHAR                                           NO-UNDO.
DEF VAR aux_vlropera AS DECI                                           NO-UNDO.
DEF VAR aux_garantia AS CHAR                                           NO-UNDO.
DEF VAR aux_dsvencto AS CHAR                                           NO-UNDO.
...
PROCEDURE valores_entrada:
    ...
    FOR EACH tt-param:
        ...
        CASE tt-param.nomeCampo:
            ...
            WHEN "nrdlinha" THEN aux_nrdlinha = INTE(tt-param.valorCampo).
            WHEN "cddbanco" THEN aux_cddbanco = INTE(tt-param.valorCampo).
            WHEN "dstipope" THEN aux_dstipope = tt-param.valorCampo.
            WHEN "vlropera" THEN aux_vlropera = DECI(tt-param.valorCampo).
            WHEN "garantia" THEN aux_garantia = tt-param.valorCampo.
            WHEN "dsvencto" THEN aux_dsvencto = tt-param.valorCampo.
...
PROCEDURE Busca_Dados:
    ...
    ELSE
        DO:
            RUN piXmlNew.
            RUN piXmlExport (INPUT TEMP-TABLE tt-banco:HANDLE,
                             INPUT "Banco").
            RUN piXmlAtributo (INPUT "nrlimmax", INPUT "5").
            RUN piXmlSave.
        END.
