...
&GLOBAL-DEFINE CampoDePesquisa1 crapidp.cdcooper
...
&GLOBAL-DEFINE CamposDisplay "<td class='txtNormal' height='22px'>&nbsp; &nbsp;" crapidp.nminseve FORMAT "x(20)" "</td>" "<td class='txtNormal' height='22px'>&nbsp; &nbsp;" aux_dsstatus "</td>"
&GLOBAL-DEFINE ListaDeCampos crapidp.nminseve crapidp.idevento crapidp.nrseqdig crapidp.idstains crapidp.cdcooper crapidp.cdagenci crapidp.cdevento
...
/* *** Linhas do cabecalho *** */
&GLOBAL-DEFINE LinhaDeCabecalho1 <td background="/cecred/images/menu/fnd_title.jpg" class="txtNormal" height="22px">&nbsp; &nbsp;Inscrito</td> <td background="/cecred/images/menu/fnd_title.jpg" class="txtNormal" height="22px">&nbsp; &nbsp;Situação</td>
              ...
              DO:
                  FIND FIRST {&TabelaPadrao} 
                      WHERE STRING({&CampoDePesquisa}) {&Criterio1} "*" + string(pesquisa) + "*" AND
                           {&TabelaPadrao}.cdcooper = gnapses.cdcooper AND
                           {&TabelaPadrao}.cdagenci = gnapses.cdagenci AND 
                           crapidp.nrseqeve = aux_nrseqeve NO-LOCK NO-ERROR.
              END.
              /* Gerentes */
              WHEN 3 THEN
              DO:
