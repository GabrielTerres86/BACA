...
&GLOBAL-DEFINE CamposDisplay "<td class='txtNormal' height='22px'>&nbsp; &nbsp;" string(gnapfdp.nrcpfcgc) FORMAT "x(20)" "</td><td class='txtNormal' height='22px'>&nbsp; &nbsp;" gnapfdp.nmfornec format "x(40)" "</td>"
