...
Alterações: 10/12/2008 - Melhoria de performance para a tabela gnapses (Evandro).
            ...
            18/05/2015 - Inclusão de novos campos conforme Projeto 229 (Vanessa)
          ...
          DO WITH FRAME {&FRAME-NAME}:
             IF opcao = "inclusao" THEN
                DO: 
                    ...
                    CREATE cratsdp.
                  ASSIGN cratsdp.cdagenci = INT(GET-VALUE("aux_cdagenci"))
                        ...
                        cratsdp.cdorisug = INT(INPUT ab_unmap.aux_cdorisug)
                         cratsdp.dssugeve = TRIM(CAPS(INPUT crapsdp.dssugeve))
                        cratsdp.dtanoage = ?
                        ...
                        cratsdp.nrmsgint = INT(ab_unmap.aux_nrseqeve)
                         cratsdp.nrseqdig = NEXT-VALUE(nrseqsdp)
           ...
           OTHERWISE
                DO:
                    ...
                    DO:
                        ...
                        IF ab_unmap.origem = "ava" THEN
                        DO:
                            /* Assumimos que o tipo de origem AVALIAÇÃO tem código 7 */
