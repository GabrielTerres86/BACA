       ...
       ELSE
        ...
        IF LAST-OF(ttCrapadp.Cdcooper) THEN DO: 
           ...
           {&out} '      <tr class="tdCab3">' SKIP
                  ...
                  '         <td align="center" title="Pré-Inscritos">'geralPorPac[8] FORMAT "zzzz9" '</td>' SKIP
                  '         <td align="center" title="Pendentes de confirmação">'geralPorPac[1] FORMAT "zzz9" '</td>' SKIP
                  '         <td align="center" title="Desistentes">' geralPorPac[3] FORMAT "zzz9" '</td>' SKIP   
                  '         <td align="center" title="Confirmadas">' geralPorPac[2] FORMAT "zzzz9" '</td>' SKIP
                  '         <td align="center" title="Faltantes">' geralPorPac[6] FORMAT "zzz9" '</td>' SKIP
                  '         <td align="center" title="Compareceram">' geralPorPac[7] FORMAT "zzzz9" '</td>' SKIP.
           ...
           {&out} '      <tr class="tdCab3">' SKIP
                  ...
                  '         <td align="center" title="Pré-Inscritos">'geralPorPacCanc[8] FORMAT "zzzz9" '</td>'             SKIP
                  '         <td align="center" title="Pendentes de confirmação">'geralPorPacCanc[1] FORMAT "zzz9" '</td>'   SKIP
                  '         <td align="center" title="Desistentes">' geralPorPacCanc[3] FORMAT "zzz9" '</td>'               SKIP   
                  '         <td align="center" title="Confirmadas">' geralPorPacCanc[2] FORMAT "zzzz9" '</td>'              SKIP
                  '         <td align="center" title="Faltantes">' geralPorPacCanc[6] FORMAT "zzz9" '</td>'                 SKIP
                  '         <td align="center" title="Compareceram">' geralPorPacCanc[7] FORMAT "zzzz9" '</td>'             SKIP.
           ...
           {&out} '      <tr class="tdCab3">' SKIP
                  ...
                  '         <td align="center" title="Pré-Inscritos">'geralPorPacReal[8] FORMAT "zzzz9" '</td>'             SKIP
                  '         <td align="center" title="Pendentes de confirmação">'geralPorPacReal[1] FORMAT "zzz9" '</td>'   SKIP
                  '         <td align="center" title="Desistentes">' geralPorPacReal[3] FORMAT "zzz9" '</td>'               SKIP   
                  '         <td align="center" title="Confirmadas">' geralPorPacReal[2] FORMAT "zzzz9" '</td>'              SKIP
                  '         <td align="center" title="Faltantes">' geralPorPacReal[6] FORMAT "zzz9" '</td>'                 SKIP
                  '         <td align="center" title="Compareceram">' geralPorPacReal[7] FORMAT "zzzz9" '</td>'             SKIP.
           ...
           {&out} '      <tr class="tdCab3">' SKIP
                  ...
                  '         <td align="center">&nbsp;</td>' SKIP
                  '         <td align="center">&nbsp;</td>' SKIP
                  '         <td align="center" title="Pré-Inscritos">'gerCoopPorPac[8] FORMAT "zzzz9" '</td>'   SKIP
                  '         <td align="center" title="Pendentes de confirmação">'gerCoopPorPac[1] FORMAT "zzz9" '</td>' SKIP
                  '         <td align="center" title="Desistentes">' gerCoopPorPac[3] FORMAT "zzz9" '</td>' SKIP   
                  '         <td align="center" title="Confirmadas">' gerCoopPorPac[2] FORMAT "zzzz9" '</td>' SKIP
                  '         <td align="center" title="Faltantes">' gerCoopPorPac[6] FORMAT "zzz9" '</td>' SKIP
                  '         <td align="center" title="Compareceram">' gerCoopPorPac[7] FORMAT "zzzz9" '</td>' SKIP
                  '      </tr>' SKIP.
           ...
           {&out} '      <tr class="tdCab3">' SKIP
                  ...
                  '         <td align="center">&nbsp;</td>' SKIP
                  '         <td align="center">&nbsp;</td>' SKIP
                  '         <td align="center" title="Pré-Inscritos">'gerComuPorPac[8] FORMAT "zzzz9" '</td>' SKIP
                  '         <td align="center" title="Pendentes de confirmação">'gerComuPorPac[1] FORMAT "zzz9" '</td>' SKIP
                  '         <td align="center" title="Desistentes">' gerComuPorPac[3] FORMAT "zzz9" '</td>' SKIP   
                  '         <td align="center" title="Confirmadas">' gerComuPorPac[2] FORMAT "zzzz9" '</td>' SKIP
                  '         <td align="center" title="Faltantes">' gerComuPorPac[6] FORMAT "zzz9" '</td>' SKIP
                  '         <td align="center" title="Compareceram">' gerComuPorPac[7] FORMAT "zzzz9" '</td>' SKIP
                  '      </tr>' SKIP.
...
ELSE DO:
   ...
   IF cdAgenci = 0  THEN /* Todos os PA´s */
      ...
      IF nrSeqEve = 0  THEN /* Todos os eventos */
         FOR EACH Crapadp WHERE Crapadp.IdEvento = idEvento  AND
             ...
             IF (Crapadp.DtFinEve >= dataInicial AND Crapadp.DtFinEve <= dataFinal) OR
      ...
      ELSE DO:
         ...
         FOR EACH bfCrapadp WHERE bfCrapadp.IdEvento = IdEvento          AND
             ...
             IF (bfCrapadp.DtFinEve >= dataInicial AND bfCrapadp.DtFinEve <= dataFinal) OR
         ...
         END.
      END.
   ELSE IF nrseqeve = 0 THEN /* Todos os eventos */
      FOR EACH Crapadp WHERE Crapadp.IdEvento = idEvento      AND
                             Crapadp.CdCooper = cdCooper      AND
