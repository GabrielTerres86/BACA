...
&Scoped-Define ENABLED-OBJECTS ab_unmap.aux_cdagenci ab_unmap.aux_cdcooper ab_unmap.aux_cddopcao ab_unmap.aux_dsendurl ab_unmap.aux_dtanoage ab_unmap.aux_idevento ab_unmap.aux_lspermis ab_unmap.aux_nrdrowid ab_unmap.aux_nrseqeve ab_unmap.aux_fechamen ab_unmap.aux_idstaeve ab_unmap.aux_nmarqimp ab_unmap.aux_dsabearq ab_unmap.aux_dsopearq ab_unmap.aux_dslocarq ab_unmap.aux_qtinsarq ab_unmap.aux_cdagearq ab_unmap.cdageins ab_unmap.cdarqsel ab_unmap.nmarqsel  ab_unmap.cdevesel
...
------------------------------------------------------------------------------*/
    ...
    ELSE                                    /* PROGRID */
        ASSIGN aux_nmarquiv = "/micros/" + crapcop.dsdircop + "/" + "*.PRG".
        ...
        IF  NOT AVAIL crapage THEN
            DO:
                IF  ab_unmap.aux_cddopcao = '' THEN
                    RUN RodaJavaScript("alert('962 - PA nao cadastrado.');").
