...
DEFINE VARIABLE ProgramaEmUso AS CHARACTER INITIAL ["wpgd0062b"].
DEFINE VARIABLE NmeDoPrograma AS CHARACTER INITIAL ["wpgd0062b.w"].
...
&Scoped-define WEB-FILE fontes/wpgd0062b.htm
            ...
            DO aux_contador = 1 TO NUM-ENTRIES(aux_dsdiaeve,","):
              IF CAN-DO(aux_dsdiapro,ENTRY(aux_contador,aux_dsdiaeve,",")) THEN
                DO:
                  ...
                  FOR FIRST crapedp FIELDS(nmevento) WHERE crapedp.idevento = crabadp.idevento AND crapedp.cdcooper = crabadp.cdcooper AND crapedp.dtanoage = 0 AND crapedp.cdevento = crabadp.cdevento AND crapedp.tpevento = 13 NO-LOCK. END.
