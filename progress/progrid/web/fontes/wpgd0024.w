...
Alterações: 10/12/2008 - Melhoria de performance para a tabela gnapses (Evandro).
                        ...
                        12/05/2009 - Incluir campo cargo (Gabriel).   
...
DEFINE TEMP-TABLE ab_unmap
	   ...
	   FIELD aux_flgconvi AS CHARACTER
       FIELD flgconvi AS CHARACTER
...
DEFINE VARIABLE ProgramaEmUso AS CHARACTER INITIAL ["wpgd0024"].
DEFINE VARIABLE NmeDoPrograma AS CHARACTER INITIAL ["wpgd0024.w"].
...
/*** Declaração de BOs ***/
DEFINE VARIABLE h-b1wpgd0024          AS HANDLE                         NO-UNDO.

/*** Temp Tables ***/
DEFINE TEMP-TABLE crataep             LIKE crapaep.
...
&Scoped-define WEB-FILE fontes/wpgd0024.htm

/* Name of first Frame and/or Browse and/or first Query                 */
&Scoped-define FRAME-NAME Web-Frame

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS crapaep.dsobserv crapaep.flgativo crapaep.nmabreve crapaep.dscrgabr 
&Scoped-define ENABLED-TABLES ab_unmap crapaep
&Scoped-define FIRST-ENABLED-TABLE ab_unmap
&Scoped-define SECOND-ENABLED-TABLE crapaep
&Scoped-Define ENABLED-OBJECTS ab_unmap.aux_nrseqdig ab_unmap.aux_cdagenci ab_unmap.aux_cdcooper ab_unmap.aux_cddopcao ab_unmap.aux_dsendurl ab_unmap.aux_dsretorn ab_unmap.aux_idevento ab_unmap.aux_lspermis ab_unmap.aux_nrdrowid ab_unmap.aux_stdopcao ab_unmap.cdcooper ab_unmap.cdagenci ab_unmap.aux_flgconvi ab_unmap.flgconvi
&Scoped-Define DISPLAYED-FIELDS crapaep.dsobserv crapaep.flgativo crapaep.nmabreve crapaep.dscrgabr 
&Scoped-define DISPLAYED-TABLES ab_unmap crapaep
&Scoped-define FIRST-DISPLAYED-TABLE ab_unmap
&Scoped-define SECOND-DISPLAYED-TABLE crapaep
&Scoped-Define DISPLAYED-OBJECTS ab_unmap.aux_nrseqdig ab_unmap.aux_cdagenci ab_unmap.aux_cdcooper ab_unmap.aux_cddopcao ab_unmap.aux_dsendurl ab_unmap.aux_dsretorn ab_unmap.aux_idevento ab_unmap.aux_lspermis ab_unmap.aux_nrdrowid ab_unmap.aux_stdopcao ab_unmap.cdcooper ab_unmap.cdagenci ab_unmap.aux_flgconvi ab_unmap.flgconvi
...
DEFINE FRAME Web-Frame
     ...
     ab_unmap.aux_stdopcao AT ROW 1 COL 1 HELP
          ...
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
	 ab_unmap.aux_flgconvi AT ROW 1 COL 1 HELP
          "" NO-LABEL
          VIEW-AS SELECTION-LIST SINGLE NO-DRAG 
          SIZE 20 BY 4	  
     ab_unmap.flgconvi AT ROW 1 COL 1 NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 20 BY 1		
     crapaep.dsobserv AT ROW 1 COL 1 NO-LABEL
          VIEW-AS EDITOR NO-WORD-WRAP
          SIZE 20 BY 4
     crapaep.flgativo AT ROW 1 COL 1
          LABEL "Ativo"
          VIEW-AS TOGGLE-BOX
          SIZE 20 BY 1
     crapaep.nmabreve AT ROW 1 COL 1 NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     crapaep.dscrgabr AT ROW 1 COL 1 NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
...
/* SETTINGS FOR FILL-IN ab_unmap.aux_stdopcao IN FRAME Web-Frame
   ALIGN-L EXP-LABEL EXP-FORMAT EXP-HELP                                */
/* SETTINGS FOR FILL-IN crapaep.cdagenci IN FRAME Web-Frame
   ALIGN-L EXP-LABEL                                                    */
/* SETTINGS FOR EDITOR crapaep.dsobserv IN FRAME Web-Frame
   EXP-LABEL                                                            */
/* SETTINGS FOR TOGGLE-BOX crapaep.flgativo IN FRAME Web-Frame
   EXP-LABEL                                                            */
/* SETTINGS FOR FILL-IN crapaep.nmabreve IN FRAME Web-Frame
   ALIGN-L EXP-LABEL                                                    */
/* SETTINGS FOR FILL-IN crapaep.dscrgabr IN FRAME Web-Frame
   ALIGN-L EXP-LABEL                                                    */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE CriaListaOpcao w-html 
PROCEDURE CriaListaOpcao :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
...
/* Cria a Seleção do Tipo de Avaliação (descritivo ou alternativo) */
ab_unmap.aux_flgconvi:LIST-ITEM-PAIRS IN FRAME {&FRAME-NAME} = "Nao,1,Sim,2".
...
------------------------------------------------------------------------------*/
    ...
    FIND LAST gnpapgd WHERE gnpapgd.idevento = INT(ab_unmap.aux_idevento)   AND
                            gnpapgd.cdcooper = INT(ab_unmap.cdcooper)
                            NO-LOCK NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  RUN htmAssociate
    ("aux_flgconvi":U,"ab_unmap.aux_flgconvi":U,ab_unmap.aux_flgconvi:HANDLE IN FRAME {&FRAME-NAME}).	
  RUN htmAssociate
    ("flgconvi":U,"ab_unmap.flgconvi":U,ab_unmap.flgconvi:HANDLE IN FRAME {&FRAME-NAME}).	
  RUN htmAssociate
  ...
  RUN htmAssociate
    ("dsobserv":U,"crapaep.dsobserv":U,crapaep.dsobserv:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
    ("flgativo":U,"crapaep.flgativo":U,crapaep.flgativo:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
    ("nmabreve":U,"crapaep.nmabreve":U,crapaep.nmabreve:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
    ("aux_dscrgabr":U,"crapaep.dscrgabr":U,crapaep.dscrgabr:HANDLE IN FRAME {&FRAME-NAME}).
END PROCEDURE.
...
RUN dbo/b1wpgd0024.p PERSISTENT SET h-b1wpgd0024.

/* Se BO foi instanciada */
IF VALID-HANDLE(h-b1wpgd0024) THEN
   DO:
      ...
      DO WITH FRAME {&FRAME-NAME}:
         IF opcao = "inclusao" THEN
            DO: 
                ...
                ASSIGN crataep.cdagenci = INT(ab_unmap.cdagenci)
                       crataep.idevento = INT(INPUT ab_unmap.aux_idevento)
                       crataep.cdcooper = INT(ab_unmap.cdcooper)
                       crataep.flgativo = INPUT crapaep.flgativo
                       crataep.nmabreve = INPUT crapaep.nmabreve
                                           crataep.dscrgabr = CAPS(INPUT crapaep.dscrgabr)
                       crataep.dsobserv = INPUT crapaep.dsobserv
					   crataep.flgconvi = IF   INT(ab_unmap.flgconvi) = 1  THEN
					                           FALSE
										  ELSE
										       TRUE.
                
				RUN inclui-registro IN h-b1wpgd0024(INPUT TABLE crataep, OUTPUT msg-erro, OUTPUT ab_unmap.aux_nrdrowid).
         ...
         ELSE  /* alteracao */
            DO:
                ...
                CREATE crataep.
                BUFFER-COPY crapaep TO crataep.

                ASSIGN crataep.flgativo = INPUT crapaep.flgativo
                       crataep.nmabreve = INPUT crapaep.nmabreve
                                           crataep.dscrgabr = CAPS(INPUT crapaep.dscrgabr)
                       crataep.dsobserv = INPUT crapaep.dsobserv
					   crataep.flgconvi = IF   INT(ab_unmap.flgconvi) = 1  THEN
                ...
                RUN altera-registro IN h-b1wpgd0024(INPUT TABLE crataep, OUTPUT msg-erro).
            END.    
      END. /* DO WITH FRAME {&FRAME-NAME} */
   
      /* "mata" a instância da BO */
      DELETE PROCEDURE h-b1wpgd0024 NO-ERROR.
   
   END. /* IF VALID-HANDLE(h-b1wpgd0024) */
...
IF VALID-HANDLE(h-b1wpgd0024) THEN
   DO:
      ...
      RUN exclui-registro IN h-b1wpgd0024(INPUT TABLE crataep, OUTPUT msg-erro).
...
DO:
    ASSIGN
        ...
        ab_unmap.cdcooper:SCREEN-VALUE IN FRAME {&FRAME-NAME} = string(crapaep.cdcooper).
...
ASSIGN opcao                    = GET-FIELD("aux_cddopcao")
	   ...
	   ab_unmap.flgconvi        = GET-VALUE("flgconvi").
...
IF REQUEST_METHOD = "POST":U THEN 
   DO:
      ...
      IF VALID-HANDLE(h-b1wpgd0024) THEN
         DO:
            RUN posiciona-registro IN h-b1wpgd0024(INPUT TO-ROWID(ab_unmap.aux_nrdrowid), OUTPUT msg-erro).
            DELETE PROCEDURE h-b1wpgd0024 NO-ERROR.
         END.
                           ...
                           IF AVAILABLE {&SECOND-ENABLED-TABLE} THEN
                              DO:
                                  ASSIGN ab_unmap.aux_nrdrowid = STRING(ROWID({&SECOND-ENABLED-TABLE}))
										 ...
										 ab_unmap.flgconvi     = IF   {&SECOND-ENABLED-TABLE}.flgconvi   THEN
										                              "2"
															     ELSE "1". 
