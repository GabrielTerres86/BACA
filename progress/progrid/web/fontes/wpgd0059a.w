...
DEFINE VARIABLE ProgramaEmUso AS CHARACTER INITIAL ["wpgd0059a"].
DEFINE VARIABLE NmeDoPrograma AS CHARACTER INITIAL ["wpgd0059a.w"].
...
&Scoped-define WEB-FILE fontes/wpgd0059a.htm
...
PROCEDURE CriaListaAvalia :
	...
	RUN RodaJavaScript("var mavalia = new Array();").
	...
	FOR EACH crapiap WHERE crapiap.cdcooper = 0 NO-LOCK, 
			...
			RUN RodaJavaScript("mavalia.push(~{tprelgru:'" + aux_tprelgru
