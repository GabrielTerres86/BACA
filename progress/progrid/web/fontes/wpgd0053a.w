...
DEFINE VARIABLE ProgramaEmUso         AS CHARACTER INITIAL ["wpgd0053a"].
DEFINE VARIABLE NmeDoPrograma         AS CHARACTER INITIAL ["wpgd0053a.w"].
...
&Scoped-define WEB-FILE fontes/wpgd0053a.htm
                        ...
                        IF NOT AVAILABLE crapeap THEN         
                          DO:
                            FIND crapedp WHERE crapedp.cdcooper = 0
                                           ...
                                           AND crapedp.flgativo = TRUE 
                                           AND (crapedp.tpevento = 7                                 
																						OR	crapedp.tpevento = 12) NO-LOCK NO-ERROR NO-WAIT.                   
