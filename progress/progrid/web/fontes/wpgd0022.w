       ...
       DO:
          DO WITH FRAME {&FRAME-NAME}:
             IF opcao = "inclusao" THEN
                DO:
                    IF  ab_unmap.aux_tpcuseve = "1" THEN /*custo direto atribui o valor ao pac e ao evento*/
                        DO:
                        ...
                        END.
                    ELSE  /* custo indireto não atribui o valor a um pac e nem a um evento específico*/
