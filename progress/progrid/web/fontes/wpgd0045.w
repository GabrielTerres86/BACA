...
DEFINE TEMP-TABLE ab_unmap
       ...
       FIELD aux_cdtiprel AS CHARACTER 
...
DEFINE VARIABLE ProgramaEmUso AS CHARACTER INITIAL ["wpgd0045"].
DEFINE VARIABLE NmeDoPrograma AS CHARACTER INITIAL ["wpgd0045.w"].
...
&Scoped-define WEB-FILE fontes/wpgd0045.htm
...
DEFINE FRAME Web-Frame
     ...
     ab_unmap.aux_dsendurl AT ROW 1 COL 1 HELP
          ...
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     ab_unmap.aux_cdtiprel AT ROW 1 COL 1 HELP
          "" NO-LABEL
          VIEW-AS SELECTION-LIST SINGLE NO-DRAG 
          SIZE 20 BY 4
...
/* SETTINGS FOR SELECTION-LIST ab_unmap.aux_cdtiprel IN FRAME Web-Frame
   EXP-LABEL EXP-FORMAT EXP-HELP                                        */
...
------------------------------------------------------------------------------*/
  ...
  RUN htmAssociate
    ("aux_cdtiprel":U,"ab_unmap.aux_cdtiprel":U,ab_unmap.aux_cdtiprel:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
...
ab_unmap.aux_cdtiprel:LIST-ITEM-PAIRS IN FRAME {&FRAME-NAME} = "Detalhado,1,Consolidado,2,Completo,3".
