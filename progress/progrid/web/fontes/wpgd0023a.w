      ...
      DO WITH FRAME {&FRAME-NAME}:
         ...
         DO: 
             DO i = 1 TO NUM-ENTRIES(ab_unmap.aux_lsevento):
                 ...
                 /* Cria o registro de Evento específico para a Cooperativa */
                 ...
                 /* Assembléia - cria um registro só com PAC = 0 */ 
                 ...
                 END. /* IF crapedp.tpevento = 7 */
                 ELSE DO:
                     /* Cria o registro de Informações da Agenda do Progrid por PAC */
                     FOR EACH crapage NO-LOCK WHERE
                         crapage.cdcooper = INT(ab_unmap.aux_cdcooper):
