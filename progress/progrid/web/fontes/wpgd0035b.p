  ...
  DO:
    ...
    FOR EACH Crapidp WHERE crapidp.cdcooper = cdCooper AND
      ...
      DO:
        ...
        {&out} '<div id="conteudo" name="conteudo" align="center" style="border: 0px solid orange; height:1240px;'.
        IF conta > 1 THEN
        DO:
          {&out} ' padding-top: 30px; ;'.
        END.
        
        {&out} 'float: left; position: relative; text-align: center; ">' SKIP.
        
        {&out} '<div style="position: absolute; height:1240px; border: 0px solid green; float:left; z-index:1; text-alig:center; padding-top: 10px; padding-left: 30px; "><img style=" height:1240px;" src="/cecred/images/certificados/' + (IF nomeDaCooperativa <> 'VIACREDI AV' THEN LOWER(nomeDaCooperativa) ELSE 'altovale') + '.jpg"/></div>' SKIP.
        ...
        {&out} '<div id="texto" name="texto" style="position: absolute; padding-top:420px; text-align:center; border: 0px solid red; z-index:2; width:1754px;" >'.
		...
		'   <a class="a5">' IF tipoDoEvento = "evento" THEN 'do evento' ELSE IF tipoDoEvento = "palestra" THEN 'da palestra' ELSE ('do ' + LC(tipoDoEvento)) ' </a>'
            ...
            {&out} '<div style="clear:both"><div id="data" name="data" style="position: relative; padding-left: 400px; border: 0px solid red; padding-top: 930px; z-index:3;">'
            '   <p align="LEFT"> <a CLASS="data">' nomedacidade ', ' DAY(TODAY) ' de ' ENTRY(MONTH(TODAY),mes) ' de ' YEAR(TODAY) '.</a> </p>'
