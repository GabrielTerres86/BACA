...
FUNCTION turmas RETURNS LOGICAL ():
    ...
    FOR EACH turmas NO-LOCK BY turmas.nmevento:

        {&out} '     <tr>' SKIP
               '       <td class="td2" align="left">' SKIP
                         turmas.nmevento SKIP
               '       </td>' SKIP
...
FUNCTION participantes RETURNS LOGICAL ():
    ...
    FOR EACH participantes NO-LOCK BY participantes.nmevento:

        {&out} '     <tr>' SKIP
               '       <td class="td2" align="left">' SKIP
                         participantes.nmevento SKIP
               '       </td>' SKIP
               '       <td class="tdDados2" align="center">' SKIP
...
FUNCTION montaTela RETURNS LOGICAL ():
    ...
    FOR EACH crapadp WHERE crapadp.idevento = idevento   AND
        ...
        /* Turmas */
        FIND turmas WHERE turmas.cdevento = crapadp.cdevento EXCLUSIVE-LOCK NO-ERROR.
        IF   NOT AVAILABLE turmas   THEN DO:
             CREATE turmas.
             ASSIGN turmas.cdevento = crapadp.cdevento.
        END.

        /* Participantes */
        FIND participantes WHERE participantes.cdevento = crapadp.cdevento EXCLUSIVE-LOCK NO-ERROR.
        IF   NOT AVAILABLE participantes   THEN DO:
        ...
        ASSIGN turmas.nmevento        = crapedp.nmevento
               participantes.nmevento = crapedp.nmevento.
    END.
    /* FIM - Eventos */
    ...
    {&out} '   <table border="0" cellspacing="0" cellpadding="0" width="100%" class="tab1">' SKIP
           ...
           '      </tr>' SKIP
           '      <tr>' SKIP
           '         <td class="tdTitulo2" colspan="6" align="center">POR EVENTO</td>' SKIP
           '      </tr>' SKIP
           '   </table>' SKIP. 
...
FUNCTION montaTela_detalhado RETURNS LOGICAL ():
    ...
    {&out} '   <table border="0" cellspacing="0" cellpadding="0" width="100%" class="tab1">' SKIP
           ...
           '      </tr>' SKIP
           '      <tr>' SKIP
           '         <td class="tdTitulo2" colspan="6" align="center">POR EVENTO - DETALHADO</td>' SKIP
           '      </tr>' SKIP
           '   </table>' SKIP
           '   <br>' SKIP. 
    ...
    FOR EACH crapadp  WHERE crapadp.idevento = idevento           AND
        ...
        IF   FIRST-OF(crapedp.nmevento)  /*OR
