...
&Scoped-Define ENABLED-OBJECTS ab_unmap.aux_cdevento ab_unmap.cdevento ab_unmap.pagina ab_unmap.cdagenci ab_unmap.aux_dtanoage ab_unmap.aux_cdagenci ab_unmap.aux_cdcooper ab_unmap.aux_cddopcao ab_unmap.aux_dsendurl ab_unmap.aux_dsretorn ab_unmap.aux_idevento ab_unmap.aux_lspermis ab_unmap.aux_nrdrowid ab_unmap.aux_stdopcao ab_unmap.aux_carregar ab_unmap.aux_reginils ab_unmap.aux_regfimls ab_unmap.aux_contarow ab_unmap.aux_maxrows
...
&Scoped-Define DISPLAYED-OBJECTS ab_unmap.aux_cdevento ab_unmap.cdevento ab_unmap.pagina ab_unmap.cdagenci ab_unmap.aux_dtanoage ab_unmap.aux_cdagenci ab_unmap.aux_cdcooper ab_unmap.aux_cddopcao ab_unmap.aux_dsendurl ab_unmap.aux_dsretorn ab_unmap.aux_idevento ab_unmap.aux_lspermis ab_unmap.aux_nrdrowid ab_unmap.aux_stdopcao ab_unmap.aux_carregar ab_unmap.aux_reginils ab_unmap.aux_regfimls ab_unmap.aux_contarow ab_unmap.aux_maxrows
...
------------------------------------------------------------------------------*/
    ...
    DEF QUERY q_crapadp FOR crapadp SCROLLING.


    /* Evento escolhido */
    IF   INT(ab_unmap.cdevento) <> 0   THEN
         OPEN QUERY q_crapadp FOR EACH crapadp WHERE crapadp.idevento = INT(ab_unmap.aux_idevento)   AND
                                                     ...
                                                     crapadp.cdevento = INT(ab_unmap.cdevento)
                                                     USE-INDEX crapadp4 NO-LOCK 
    ...
    IF int(ab_unmap.cdagenci) <> 0   THEN 
       OPEN QUERY q_crapadp FOR EACH crapadp WHERE crapadp.idevento = INT(ab_unmap.aux_idevento)   AND
                                                    crapadp.cdcooper = INT(ab_unmap.aux_cdcooper)   AND
                                                    crapadp.dtanoage = INT(ab_unmap.aux_dtanoage)   AND
                                                    crapadp.cdagenci = INT(ab_unmap.cdagenci)
                                                    USE-INDEX crapadp3 NO-LOCK 
                                                    INDEXED-REPOSITION MAX-ROWS aux_qtpagina.
    ELSE 
       OPEN QUERY q_crapadp FOR EACH crapadp WHERE crapadp.idevento = INT(ab_unmap.aux_idevento)   AND
                                                   crapadp.cdcooper = INT(ab_unmap.aux_cdcooper)   AND
                                                   crapadp.dtanoage = INT(ab_unmap.aux_dtanoage)   
                                                   USE-INDEX crapadp3 NO-LOCK 
                                                   INDEXED-REPOSITION MAX-ROWS aux_qtpagina.
            ...
            IF   AVAILABLE crapadp   THEN
                 DO:
                     ...
                     ELSE 
                         FIND FIRST crapldp WHERE crapldp.cdcooper = crapadp.cdcooper  AND
                                                  crapldp.idevento = 1 /* IDEVENTO é sempre 1 para locais */  AND
                                                 (crapldp.cdagenci = crapadp.cdagenci OR 
                                                  crapldp.cdagenci = 0 ) AND /*Todas as agencias */
                                                  crapldp.nrseqdig = crapadp.cdlocali  NO-LOCK NO-ERROR.
