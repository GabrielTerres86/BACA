...
DEFINE TEMP-TABLE ab_unmap
       ...
       FIELD aux_lstselec AS CHARACTER FORMAT "X(256)":U 
       FIELD aux_nrdcusto AS CHARACTER FORMAT "X(256)":U 
...
DEFINE VARIABLE ProgramaEmUso AS CHARACTER INITIAL ["wpgd0018e"].
DEFINE VARIABLE NmeDoPrograma AS CHARACTER INITIAL ["wpgd0018e.w"].
...
&Scoped-define WEB-FILE fontes/wpgd0018e.htm

/* Name of first Frame and/or Browse and/or first Query                 */
&Scoped-define FRAME-NAME Web-Frame

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS crapcdi.dscusind 
&Scoped-define ENABLED-TABLES ab_unmap crapcdi
&Scoped-define FIRST-ENABLED-TABLE ab_unmap
&Scoped-define SECOND-ENABLED-TABLE crapcdi
&Scoped-Define ENABLED-OBJECTS ab_unmap.aux_lstselec ab_unmap.aux_dtanoage ~
ab_unmap.aux_cdcooper ab_unmap.aux_lstcusto ab_unmap.aux_nrdcusto ~
...
&Scoped-Define DISPLAYED-FIELDS crapcdi.dscusind 
&Scoped-define DISPLAYED-TABLES ab_unmap crapcdi
&Scoped-define FIRST-DISPLAYED-TABLE ab_unmap
&Scoped-define SECOND-DISPLAYED-TABLE crapcdi
&Scoped-Define DISPLAYED-OBJECTS ab_unmap.aux_lstselec ~
ab_unmap.aux_dtanoage ab_unmap.aux_cdcooper ab_unmap.aux_lstcusto ~
ab_unmap.aux_nrdcusto ab_unmap.aux_cddopcao ab_unmap.aux_dsendurl ~
...
DEFINE FRAME Web-Frame
     ab_unmap.aux_lstselec AT ROW 1 COL 1 HELP
     ...
     ab_unmap.aux_lstcusto AT ROW 1 COL 1 HELP
          ...
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     ab_unmap.aux_nrdcusto AT ROW 1 COL 1 HELP
          "" NO-LABEL FORMAT "X(256)":U
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     ...
     ab_unmap.aux_stdopcao AT ROW 1 COL 1 HELP
          ...
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     crapcdi.dscusind AT ROW 1 COL 1 NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
...
/* SETTINGS FOR FILL-IN ab_unmap.aux_lstcusto IN FRAME Web-Frame
   ALIGN-L EXP-LABEL EXP-FORMAT EXP-HELP                                */
/* SETTINGS FOR FILL-IN ab_unmap.aux_lstselec IN FRAME Web-Frame
   ALIGN-L EXP-LABEL EXP-FORMAT EXP-HELP                                */
/* SETTINGS FOR FILL-IN ab_unmap.aux_nrdcusto IN FRAME Web-Frame
   ALIGN-L EXP-LABEL EXP-FORMAT EXP-HELP                                */
/* SETTINGS FOR FILL-IN ab_unmap.aux_nrdrowid IN FRAME Web-Frame
   ALIGN-L EXP-LABEL EXP-FORMAT EXP-HELP                                */
/* SETTINGS FOR FILL-IN ab_unmap.aux_stdopcao IN FRAME Web-Frame
   ALIGN-L EXP-LABEL EXP-FORMAT EXP-HELP                                */
/* SETTINGS FOR FILL-IN crapcdi.dscusind IN FRAME Web-Frame
   ALIGN-L EXP-LABEL                                                    */
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
DEF VAR aux_flgescol AS LOG NO-UNDO.
FOR EACH crapcdi NO-LOCK WHERE
    crapcdi.idevento = INT(ab_unmap.aux_idevento):
    ...
    FIND FIRST crapcdp WHERE
        ...
        crapcdp.tpcuseve = 2 /* custos indiretos */   AND
        crapcdp.cdcuseve = crapcdi.nrseqdig NO-LOCK NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  RUN htmAssociate
    ("aux_lstselec":U,"ab_unmap.aux_lstselec":U,ab_unmap.aux_lstselec:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
    ("aux_nrdcusto":U,"ab_unmap.aux_nrdcusto":U,ab_unmap.aux_nrdcusto:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
    ("aux_nrdrowid":U,"ab_unmap.aux_nrdrowid":U,ab_unmap.aux_nrdrowid:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
    ("aux_stdopcao":U,"ab_unmap.aux_stdopcao":U,ab_unmap.aux_stdopcao:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
    ("dscusind":U,"crapcdi.dscusind":U,crapcdi.dscusind:HANDLE IN FRAME {&FRAME-NAME}).
END PROCEDURE.
      ...
      DO WITH FRAME {&FRAME-NAME}:
         IF opcao = "inclusao" THEN
            DO: 
             ...
             DO i = 1 TO NUM-ENTRIES(ab_unmap.aux_lstcusto):
                 ...
                 FIND FIRST crapcdp NO-LOCK WHERE crapcdp.cdagenci = 0 AND
                                                  crapcdp.cdcooper = INT(ab_unmap.aux_cdcooper) AND
                                                  crapcdp.cdcuseve = int(ENTRY(i, ab_unmap.aux_lstcusto)) AND
                                                  crapcdp.cdevento = ? AND
                                                  crapcdp.dtanoage = INT(ab_unmap.aux_dtanoage) AND
                                                  crapcdp.idevento = INT(ab_unmap.aux_idevento) AND
                                                  crapcdp.tpcuseve = 2 NO-ERROR.

                 /* Situações em que não se faz nada:
                  Registro existe e está marcado
                  Registro não existe e não está marcado */

                 /* Se não existe o registro e ele foi marcado, inclui */
                 IF NOT AVAIL crapcdp AND ENTRY(i, ab_unmap.aux_lstselec) = "true" THEN
                 DO:
                     RUN inclui-registro IN h-b1wpgd0018(INPUT TABLE cratcdp, OUTPUT aux_msgderro, OUTPUT tmp_nrdrowid).
                 END.

                 /* Se o registro existe e ele foi desmarcado, exclui */
                 IF AVAIL crapcdp AND ENTRY(i, ab_unmap.aux_lstselec) <> "true" THEN
                 DO:
         ...
         ELSE  /* alteracao */
            DO:
                ...
                /*CREATE cratcdi.
                BUFFER-COPY crapcdi TO cratcdi.

                ASSIGN cratcdi.campo = INPUT crapcdi.campo.*/
...
ASSIGN opcao                    = GET-FIELD("aux_cddopcao")
       ...
       ab_unmap.aux_nrdcusto    = GET-VALUE("aux_nrdcusto")
       ab_unmap.aux_lstcusto    = GET-VALUE("aux_lstcusto")
       ab_unmap.aux_lstselec    = GET-VALUE("aux_lstselec")
