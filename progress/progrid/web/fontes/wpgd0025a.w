...
DEFINE TEMP-TABLE ab_unmap
       ...
       FIELD aux_idregist AS CHARACTER FORMAT "X(256)":U 
       FIELD aux_lspermis AS CHARACTER FORMAT "X(256)":U 
       FIELD aux_nrdrowid AS CHARACTER FORMAT "X(256)":U 
       FIELD aux_stdopcao AS CHARACTER FORMAT "X(256)":U 
       FIELD aux_tpdeitem AS CHARACTER FORMAT "X(256)":U .
...
DEFINE VARIABLE ProgramaEmUso AS CHARACTER INITIAL ["wpgd0025a"].
DEFINE VARIABLE NmeDoPrograma AS CHARACTER INITIAL ["wpgd0025a.w"].
...
/*** Declaração de BOs ***/
DEFINE VARIABLE h-b1wpgd0025          AS HANDLE                         NO-UNDO.

/*** Temp Tables ***/
DEFINE TEMP-TABLE cratkbq             LIKE crapkbq.
...
&Scoped-define WEB-FILE fontes/wpgd0025a.htm

/* Name of first Frame and/or Browse and/or first Query                 */
&Scoped-define FRAME-NAME Web-Frame

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS crapkbq.dtdenvio crapkbq.dtsolici ~
crapkbq.nmsolici crapkbq.qtdenvio crapkbq.qtsolici crapkbq.vlrenvio ~
crapkbq.vlrrefer 
&Scoped-define ENABLED-TABLES ab_unmap crapkbq
&Scoped-define FIRST-ENABLED-TABLE ab_unmap
&Scoped-define SECOND-ENABLED-TABLE crapkbq
&Scoped-Define ENABLED-OBJECTS ab_unmap.aux_dtanoage ab_unmap.aux_cdagenci ~
ab_unmap.aux_cdcooper ab_unmap.aux_tpdeitem ab_unmap.aux_cddopcao ~
ab_unmap.aux_dsendurl ab_unmap.aux_dsretorn ab_unmap.aux_idevento ~
ab_unmap.aux_idregist ab_unmap.aux_lspermis ab_unmap.aux_nrdrowid ~
ab_unmap.aux_stdopcao 
&Scoped-Define DISPLAYED-FIELDS crapkbq.dtdenvio crapkbq.dtsolici ~
crapkbq.nmsolici crapkbq.qtdenvio crapkbq.qtsolici crapkbq.vlrenvio ~
crapkbq.vlrrefer 
&Scoped-define DISPLAYED-TABLES ab_unmap crapkbq
&Scoped-define FIRST-DISPLAYED-TABLE ab_unmap
&Scoped-define SECOND-DISPLAYED-TABLE crapkbq
&Scoped-Define DISPLAYED-OBJECTS ab_unmap.aux_dtanoage ~
ab_unmap.aux_cdagenci ab_unmap.aux_cdcooper ab_unmap.aux_tpdeitem ~
ab_unmap.aux_cddopcao ab_unmap.aux_dsendurl ab_unmap.aux_dsretorn ~
ab_unmap.aux_idevento ab_unmap.aux_idregist ab_unmap.aux_lspermis ~
...
DEFINE FRAME Web-Frame
     ...
     ab_unmap.aux_cdcooper AT ROW 1 COL 1 HELP
          ...
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     ab_unmap.aux_tpdeitem AT ROW 1 COL 1 HELP
          "" NO-LABEL FORMAT "X(256)":U
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     ...
     ab_unmap.aux_idevento AT ROW 1 COL 1 HELP
          ...
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     ab_unmap.aux_idregist AT ROW 1 COL 1 HELP
          "" NO-LABEL FORMAT "X(256)":U
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     ...
     ab_unmap.aux_stdopcao AT ROW 1 COL 1 HELP
          ...
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     crapkbq.dtdenvio AT ROW 1 COL 1 NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     crapkbq.dtsolici AT ROW 1 COL 1 NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     crapkbq.nmsolici AT ROW 1 COL 1 NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     crapkbq.qtdenvio AT ROW 1 COL 1 NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     crapkbq.qtsolici AT ROW 1 COL 1 NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     crapkbq.vlrenvio AT ROW 1 COL 1 NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     crapkbq.vlrrefer AT ROW 1 COL 1 NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
...
/* SETTINGS FOR FILL-IN ab_unmap.aux_idevento IN FRAME Web-Frame
   ALIGN-L EXP-LABEL EXP-FORMAT EXP-HELP                                */
/* SETTINGS FOR FILL-IN ab_unmap.aux_idregist IN FRAME Web-Frame
   ALIGN-L EXP-LABEL EXP-FORMAT EXP-HELP                                */
...
/* SETTINGS FOR FILL-IN ab_unmap.aux_stdopcao IN FRAME Web-Frame
   ALIGN-L EXP-LABEL EXP-FORMAT EXP-HELP                                */
/* SETTINGS FOR FILL-IN ab_unmap.aux_tpdeitem IN FRAME Web-Frame
   ALIGN-L EXP-LABEL EXP-FORMAT EXP-HELP                                */
/* SETTINGS FOR FILL-IN crapkbq.dtdenvio IN FRAME Web-Frame
   ALIGN-L EXP-LABEL                                                    */
/* SETTINGS FOR FILL-IN crapkbq.dtsolici IN FRAME Web-Frame
   ALIGN-L EXP-LABEL                                                    */
/* SETTINGS FOR FILL-IN crapkbq.nmsolici IN FRAME Web-Frame
   ALIGN-L EXP-LABEL                                                    */
/* SETTINGS FOR FILL-IN crapkbq.qtdenvio IN FRAME Web-Frame
   ALIGN-L EXP-LABEL                                                    */
/* SETTINGS FOR FILL-IN crapkbq.qtsolici IN FRAME Web-Frame
   ALIGN-L EXP-LABEL                                                    */
/* SETTINGS FOR FILL-IN crapkbq.vlrenvio IN FRAME Web-Frame
   ALIGN-L EXP-LABEL                                                    */
/* SETTINGS FOR FILL-IN crapkbq.vlrrefer IN FRAME Web-Frame
   ALIGN-L EXP-LABEL                                                    */
...
------------------------------------------------------------------------------*/
  ...
  RUN htmAssociate
    ("aux_idregist":U,"ab_unmap.aux_idregist":U,ab_unmap.aux_idregist:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
  ...
  RUN htmAssociate
    ("aux_tpdeitem":U,"ab_unmap.aux_tpdeitem":U,ab_unmap.aux_tpdeitem:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
    ("dtdenvio":U,"crapkbq.dtdenvio":U,crapkbq.dtdenvio:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
    ("dtsolici":U,"crapkbq.dtsolici":U,crapkbq.dtsolici:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
    ("nmsolici":U,"crapkbq.nmsolici":U,crapkbq.nmsolici:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
    ("qtdenvio":U,"crapkbq.qtdenvio":U,crapkbq.qtdenvio:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
    ("qtsolici":U,"crapkbq.qtsolici":U,crapkbq.qtsolici:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
    ("vlrenvio":U,"crapkbq.vlrenvio":U,crapkbq.vlrenvio:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
    ("vlrrefer":U,"crapkbq.vlrrefer":U,crapkbq.vlrrefer:HANDLE IN FRAME {&FRAME-NAME}).
END PROCEDURE.
...
RUN dbo/b1wpgd0025.p PERSISTENT SET h-b1wpgd0025.

/* Se BO foi instanciada */
IF VALID-HANDLE(h-b1wpgd0025) THEN
   DO:
      DO WITH FRAME {&FRAME-NAME}:
         IF opcao = "inclusao" THEN
            DO: 
                CREATE cratkbq.
                ASSIGN
                    cratkbq.cdagenci = INT(ab_unmap.aux_cdagenci)
                    cratkbq.cdcooper = INT(ab_unmap.aux_cdcooper)
                    cratkbq.cdoperad = gnapses.cdoperad
                    cratkbq.dtanoage = INT(ab_unmap.aux_dtanoage)
                    cratkbq.dtdenvio = INPUT crapkbq.dtdenvio
                    cratkbq.dtmvtolt = TODAY
                    cratkbq.dtsolici = INPUT crapkbq.dtsolici
                    cratkbq.idevento = INT(ab_unmap.aux_idevento)
                    cratkbq.nmsolici = INPUT crapkbq.nmsolici
                    cratkbq.nrseqdig = 0
                    cratkbq.qtdenvio = INPUT crapkbq.qtdenvio
                    cratkbq.qtsolici = INPUT crapkbq.qtsolici
                    cratkbq.tpdeitem = INT(ab_unmap.aux_tpdeitem)
                    cratkbq.vlrenvio = INPUT crapkbq.vlrenvio
                    cratkbq.vlrrefer = INPUT crapkbq.vlrrefer.

                RUN inclui-registro IN h-b1wpgd0025(INPUT TABLE cratkbq, OUTPUT msg-erro, OUTPUT ab_unmap.aux_nrdrowid).
            END.
         ELSE  /* alteracao */
            DO:
                /* cria a temp-table e joga o novo valor digitado para o campo */
                CREATE cratkbq.
                BUFFER-COPY crapkbq TO cratkbq.
                ...
                RUN altera-registro IN h-b1wpgd0025(INPUT TABLE cratkbq, OUTPUT msg-erro).
            END.    
      END. /* DO WITH FRAME {&FRAME-NAME} */
   
      /* "mata" a instância da BO */
      DELETE PROCEDURE h-b1wpgd0025 NO-ERROR.
   
   END. /* IF VALID-HANDLE(h-b1wpgd0025) */
...
IF VALID-HANDLE(h-b1wpgd0025) THEN
   DO:
      ...
      RUN exclui-registro IN h-b1wpgd0025(INPUT TABLE cratkbq, OUTPUT msg-erro).
...
ASSIGN opcao                    = GET-FIELD("aux_cddopcao")
       ...
       ab_unmap.aux_tpdeitem    = GET-VALUE("aux_tpdeitem")
           ...
           OTHERWISE
                DO:
                    IF GET-VALUE("LinkRowid") <> "" THEN
                       ...
                       END.  
                    ELSE
                        FIND LAST crapkbq WHERE
                            crapkbq.cdcooper = INT(ab_unmap.aux_cdcooper) AND
                            crapkbq.cdagenci = INT(ab_unmap.aux_cdagenci) AND
                            crapkbq.dtanoage = INT(ab_unmap.aux_dtanoage) AND 
                            crapkbq.tpdeitem = INT(ab_unmap.aux_tpdeitem) NO-LOCK NO-ERROR.
