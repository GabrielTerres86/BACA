...
DEFINE VARIABLE ProgramaEmUso AS CHARACTER INITIAL ["wpgd0012a"].
DEFINE VARIABLE NmeDoPrograma AS CHARACTER INITIAL ["wpgd0012a.w"].
...
&Scoped-define WEB-FILE fontes/wpgd0012a.htm

/* Name of first Frame and/or Browse and/or first Query                 */
&Scoped-define FRAME-NAME Web-Frame

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS gnapcfp.cddddfor gnapcfp.dsdemail ~
gnapcfp.dsdepart gnapcfp.nmconfor gnapcfp.nrfonfor gnapcfp.nrseqdig 
&Scoped-define ENABLED-TABLES ab_unmap gnapcfp
&Scoped-define FIRST-ENABLED-TABLE ab_unmap
&Scoped-define SECOND-ENABLED-TABLE gnapcfp
&Scoped-Define ENABLED-OBJECTS ab_unmap.aux_nmfornec ab_unmap.aux_cddopcao ~
ab_unmap.aux_dsendurl ab_unmap.aux_dsretorn ab_unmap.aux_lspermis ~
ab_unmap.aux_nrcpfcgc ab_unmap.aux_nrdrowid ab_unmap.aux_stdopcao 
&Scoped-Define DISPLAYED-FIELDS gnapcfp.cddddfor gnapcfp.dsdemail ~
gnapcfp.dsdepart gnapcfp.nmconfor gnapcfp.nrfonfor gnapcfp.nrseqdig 
&Scoped-define DISPLAYED-TABLES ab_unmap gnapcfp
&Scoped-define FIRST-DISPLAYED-TABLE ab_unmap
&Scoped-define SECOND-DISPLAYED-TABLE gnapcfp
&Scoped-Define DISPLAYED-OBJECTS ab_unmap.aux_nmfornec ~
ab_unmap.aux_cddopcao ab_unmap.aux_dsendurl ab_unmap.aux_dsretorn ~
ab_unmap.aux_lspermis ab_unmap.aux_nrcpfcgc ab_unmap.aux_nrdrowid ~
...
DEFINE FRAME Web-Frame
     ...
     ab_unmap.aux_stdopcao AT ROW 1 COL 1 HELP
          ...
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     gnapcfp.cddddfor AT ROW 1 COL 1 NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     gnapcfp.dsdemail AT ROW 1 COL 1 NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     gnapcfp.dsdepart AT ROW 1 COL 1 NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     gnapcfp.nmconfor AT ROW 1 COL 1 NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     gnapcfp.nrfonfor AT ROW 1 COL 1 NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     gnapcfp.nrseqdig AT ROW 1 COL 1 NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
...
/* SETTINGS FOR FILL-IN ab_unmap.aux_stdopcao IN FRAME Web-Frame
   ALIGN-L EXP-LABEL EXP-FORMAT EXP-HELP                                */
/* SETTINGS FOR FILL-IN gnapcfp.cddddfor IN FRAME Web-Frame
   ALIGN-L EXP-LABEL                                                    */
/* SETTINGS FOR FILL-IN gnapcfp.dsdemail IN FRAME Web-Frame
   ALIGN-L EXP-LABEL                                                    */
/* SETTINGS FOR FILL-IN gnapcfp.dsdepart IN FRAME Web-Frame
   ALIGN-L EXP-LABEL                                                    */
/* SETTINGS FOR FILL-IN gnapcfp.nmconfor IN FRAME Web-Frame
   ALIGN-L EXP-LABEL                                                    */
/* SETTINGS FOR FILL-IN gnapcfp.nrfonfor IN FRAME Web-Frame
   ALIGN-L EXP-LABEL                                                    */
/* SETTINGS FOR FILL-IN gnapcfp.nrseqdig IN FRAME Web-Frame
   ALIGN-L EXP-LABEL                                                    */
...
------------------------------------------------------------------------------*/
  ...
  RUN htmAssociate
    ("cddddfor":U,"gnapcfp.cddddfor":U,gnapcfp.cddddfor:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
    ("dsdemail":U,"gnapcfp.dsdemail":U,gnapcfp.dsdemail:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
    ("dsdepart":U,"gnapcfp.dsdepart":U,gnapcfp.dsdepart:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
    ("nmconfor":U,"gnapcfp.nmconfor":U,gnapcfp.nmconfor:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
    ("nrfonfor":U,"gnapcfp.nrfonfor":U,gnapcfp.nrfonfor:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
    ("nrseqdig":U,"gnapcfp.nrseqdig":U,gnapcfp.nrseqdig:HANDLE IN FRAME {&FRAME-NAME}).
END PROCEDURE.
...
IF VALID-HANDLE(h-b1wpgd0012a) THEN
   DO:
      DO WITH FRAME {&FRAME-NAME}:
         IF opcao = "inclusao" THEN
            DO: 
                /*RUN RodaJavaScript("alert('incluindo');").*/
                CREATE gnatcfp.
                ASSIGN
                    gnatcfp.cdcooper = 0 /* Genérico - Sem cooperativa */
                    gnatcfp.cddddfor = INPUT gnapcfp.cddddfor
                    gnatcfp.dsdemail = INPUT gnapcfp.dsdemail
                    gnatcfp.dsdepart = INPUT gnapcfp.dsdepart
                    /*gnatcfp.flgativo = INPUT gnapcfp.flgativo*/
                    gnatcfp.idevento = 1 /* Somente PROGRID */
                    gnatcfp.nmconfor = INPUT gnapcfp.nmconfor
                    gnatcfp.nrcpfcgc = DEC(INPUT ab_unmap.aux_nrcpfcgc)
                    gnatcfp.nrfonfor = INPUT gnapcfp.nrfonfor.

                RUN inclui-registro IN h-b1wpgd0012a(INPUT TABLE gnatcfp, OUTPUT msg-erro, OUTPUT ab_unmap.aux_nrdrowid).
         ...
         ELSE  /* alteracao */
            DO:
                ...
                ASSIGN 
                    /*gnatcfp.cdcooper = INPUT gnapcfp.cdcooper*/
                    gnatcfp.cddddfor = INPUT gnapcfp.cddddfor
                    gnatcfp.dsdemail = INPUT gnapcfp.dsdemail
                    gnatcfp.dsdepart = INPUT gnapcfp.dsdepart
                    /*gnatcfp.flgativo = INPUT gnapcfp.flgativo*/
                    /*gnatcfp.idevento = int(INPUT ab_unmap.aux_idevento)*/
                    gnatcfp.nmconfor = INPUT gnapcfp.nmconfor
                    gnatcfp.nrcpfcgc = DEC(INPUT ab_unmap.aux_nrcpfcgc)
                    gnatcfp.nrfonfor = INPUT gnapcfp.nrfonfor.
                 
                RUN altera-registro IN h-b1wpgd0012a(INPUT TABLE gnatcfp, OUTPUT msg-erro).
            END.    
   ...
   END. /* IF VALID-HANDLE(h-b1wpgd0012a) */
   ELSE DO:
       ASSIGN msg-erro = msg-erro + "DBO não pode ser inicializada.".
   END.
...
IF  AVAIL gnapfdp  THEN 
    ASSIGN ab_unmap.aux_nmfornec = gnapfdp.nmfornec.
ELSE 
    ASSIGN ab_unmap.aux_nmfornec = "Não Encontrado.".
...
IF REQUEST_METHOD = "POST":U THEN 
   DO:
      ...
      RUN RodaJavaScript('document.form.aux_cddopcao.value = "";').
