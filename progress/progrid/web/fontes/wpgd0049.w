...
Alterações: 10/12/2008 - Melhoria de performance para a tabela gnapses (Evandro).
            18/03/2009 - Desabilitado o tratamento do campo tipoDeRelatorio (Martin).
...
DEFINE TEMP-TABLE ab_unmap
       ...
       FIELD pct_integ      AS DEC
       FIELD pct_kits       AS DEC
       FIELD pct_assembleia AS DEC
       FIELD pct_ppr1       AS DEC
       FIELD pct_ppr2       AS DEC.
...
DEFINE VARIABLE ProgramaEmUso         AS CHARACTER INITIAL ["wpgd0049"].
DEFINE VARIABLE NmeDoPrograma         AS CHARACTER INITIAL ["wpgd0049.w"].
...
&Scoped-define WEB-FILE fontes/wpgd0049.htm
...
ab_unmap.cdeixtem     ab_unmap.cdcooper     ab_unmap.periodo ~
ab_unmap.pct_integ    ab_unmap.pct_kits     ab_unmap.pct_assembleia ~
ab_unmap.pct_ppr1     ab_unmap.pct_ppr2      
...
/*     ab_unmap.consideraEventosForaDaAgenda AT ROW 1 COL 1 HELP
     ...
     ab_unmap.tipoDeRelatorio AT ROW 1 COL 1 HELP
          ...
          LIST-ITEM-PAIRS "Inscrições nos eventos por PA","3" 
          SIZE 20 BY 4
*/          
...
*/          
     ...
     ab_unmap.cdeixtem AT ROW 1 COL 1 HELP
          ...
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
    ab_unmap.periodo AT ROW 1 COL 1 HELP
         "" NO-LABEL 
         VIEW-AS SELECTION-LIST SINGLE NO-DRAG SORT
         LIST-ITEM-PAIRS "1o semestre","1",
                         "2o semestre","2"
         SIZE 20 BY 4
    ab_unmap.pct_integ AT ROW 1 COL 1 HELP
         "" NO-LABEL FORMAT ">9.99":U
         VIEW-AS FILL-IN 
         SIZE 20 BY 1
    ab_unmap.pct_kits AT ROW 1 COL 1 HELP
         "" NO-LABEL FORMAT ">9.99":U
         VIEW-AS FILL-IN 
         SIZE 20 BY 1
    ab_unmap.pct_assembleia AT ROW 1 COL 1 HELP
         "" NO-LABEL FORMAT ">9.99":U
         VIEW-AS FILL-IN 
         SIZE 20 BY 1
    ab_unmap.pct_ppr1 AT ROW 1 COL 1 HELP
         "" NO-LABEL FORMAT ">9.99":U
         VIEW-AS FILL-IN 
         SIZE 20 BY 1
    ab_unmap.pct_ppr2 AT ROW 1 COL 1 HELP
         "" NO-LABEL FORMAT ">9.99":U
         VIEW-AS FILL-IN 
         SIZE 20 BY 1
...
/* se informado o pa, lista cada evento dele */  
...
*/    
  ...
  RUN htmAssociate
    ("periodo":U,"ab_unmap.periodo":U,ab_unmap.periodo:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
    ("pct_integ":U,"ab_unmap.pct_integ":U,ab_unmap.pct_integ:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
    ("pct_kits":U,"ab_unmap.pct_kits":U,ab_unmap.pct_kits:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
    ("pct_assembleia":U,"ab_unmap.pct_assembleia":U,ab_unmap.pct_assembleia:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
    ("pct_ppr1":U,"ab_unmap.pct_ppr1":U,ab_unmap.pct_ppr1:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
    ("pct_ppr2":U,"ab_unmap.pct_ppr2":U,ab_unmap.pct_ppr2:HANDLE IN FRAME {&FRAME-NAME}).
/*  RUN htmAssociate
