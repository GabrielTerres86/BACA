...
DEFINE VARIABLE ProgramaEmUso         AS CHARACTER INITIAL ["wpgd0035"].
DEFINE VARIABLE NmeDoPrograma         AS CHARACTER INITIAL ["wpgd0035.w"].
...
&Scoped-define WEB-FILE fontes/wpgd0035.htm
...
------------------------------------------------------------------------------*/
    ...
    FOR EACH crapeap WHERE crapeap.idevento = INT(ab_unmap.aux_idevento)    AND
       ...
       FIRST crapedp WHERE crapedp.cdevento = crapeap.cdevento              AND
                           ...
                           crapedp.flgcerti = YES   /* Certifica */         NO-LOCK,
...
/*
/* gera lista de cooperativas */
ab_unmap.aux_cdcooper:LIST-ITEM-PAIRS IN FRAME {&FRAME-NAME} = "".
{includes/wpgd0098.i}
ab_unmap.aux_cdcooper:LIST-ITEM-PAIRS IN FRAME {&FRAME-NAME} = aux_crapcop.
/* ASSIGN ab_unmap.aux_cdcooper = ENTRY(1,aux_crapcop). */

/* gera lista de pac´s */
ab_unmap.aux_cdagenci:LIST-ITEM-PAIRS IN FRAME {&FRAME-NAME} = "".
{includes/wpgd0099.i &tipo=combo-box}
IF LENGTH(vetorPac) > 0 THEN ASSIGN vetorPac  = SUBSTRING(vetorPac,1,LENGTH(vetorPac) - 1).
ab_unmap.aux_cdagenci:LIST-ITEM-PAIRS IN FRAME {&FRAME-NAME} = vetorPac.
  */
