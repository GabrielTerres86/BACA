...
DEFINE VARIABLE ProgramaEmUso         AS CHARACTER INITIAL ["wpgd0052a"].
DEFINE VARIABLE NmeDoPrograma         AS CHARACTER INITIAL ["wpgd0052a.w"].
...
&Scoped-define WEB-FILE fontes/wpgd0052a.htm
...
PROCEDURE CriaListaEventos :
	...
	RUN RodaJavaScript("meventos.push(~{qtdcolun:'2',cdevento:'0',nmevento:'Evento'~});").
		
  /* Carrega o array com todos os Eventos Ativos e sugestões*/
  FOR EACH crapedp WHERE crapedp.cdcooper = 0                                 
										 AND crapedp.idevento = INTEGER(ab_unmap.aux_idevento)    
										 AND crapedp.dtanoage = 0                                 
										 AND crapedp.flgativo = TRUE                              
       ...
       DO WITH FRAME {&FRAME-NAME}:
          IF   opcao = "inclusao"   THEN
						DO: 
							...
							/* procura o evento de integração. Ele deve ser incorporado à lista */
             /* FIND FIRST crapedp WHERE crapedp.tpevento = 2 NO-LOCK NO-ERROR.
               ...
               */           
                ...
                /* Procura se o Evento já foi criado para a Cooperativa */
                ...
                IF   NOT AVAILABLE crapedp THEN
									DO: 
                   /* Busca o evento genérico e "copia" para a cooperativa 
                      eventos genéricos não possuem cooperativa nem ano de agenda */
                   ...
                   /* Apaga os registros da tabela temporária para não acumular os eventos */
                   ...
                   /* Se não teve problemas para criar o evento, cria também os registros de custos */
                   IF msg-erro = "" THEN
                   DO:
                       ...
                       DO aux_tpcuseve = 1 TO (NUM-ENTRIES(craptab.dstextab) / 2):
                           ...
                           /* Cria novo registro na tabela temporária, de acordo com o evento gravado */
                           CREATE cratcdp.
