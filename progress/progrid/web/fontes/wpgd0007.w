...
DEFINE VARIABLE ProgramaEmUso AS CHARACTER INITIAL ["wpgd0007"].
DEFINE VARIABLE NmeDoPrograma AS CHARACTER INITIAL ["wpgd0007.w"].
...
/*** Declaração de BOs ***/
DEFINE VARIABLE h-b1wpgd0007          AS HANDLE                         NO-UNDO.

/*** Temp Tables ***/
DEFINE TEMP-TABLE gnatetp             LIKE gnapetp.
...
&Scoped-define WEB-FILE fontes/wpgd0007.htm

/* Name of first Frame and/or Browse and/or first Query                 */
&Scoped-define FRAME-NAME Web-Frame

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS gnapetp.dseixtem gnapetp.cdeixtem 
&Scoped-define ENABLED-TABLES ab_unmap gnapetp
&Scoped-define FIRST-ENABLED-TABLE ab_unmap
&Scoped-define SECOND-ENABLED-TABLE gnapetp
&Scoped-Define ENABLED-OBJECTS ab_unmap.aux_idevento ab_unmap.aux_cddopcao ~
ab_unmap.aux_dsendurl ab_unmap.aux_dsretorn ab_unmap.aux_lspermis ~
ab_unmap.aux_nrdrowid ab_unmap.aux_stdopcao 
&Scoped-Define DISPLAYED-FIELDS gnapetp.dseixtem gnapetp.cdeixtem 
&Scoped-define DISPLAYED-TABLES ab_unmap gnapetp
&Scoped-define FIRST-DISPLAYED-TABLE ab_unmap
&Scoped-define SECOND-DISPLAYED-TABLE gnapetp
...
DEFINE FRAME Web-Frame
     ...
     ab_unmap.aux_stdopcao AT ROW 1 COL 1 HELP
          ...
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     gnapetp.dseixtem AT ROW 1 COL 1 NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     gnapetp.cdeixtem AT ROW 1 COL 1 NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
...
/* SETTINGS FOR FILL-IN ab_unmap.aux_stdopcao IN FRAME Web-Frame
   ALIGN-L EXP-LABEL EXP-FORMAT EXP-HELP                                */
/* SETTINGS FOR FILL-IN gnapetp.cdeixtem IN FRAME Web-Frame
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN gnapetp.dseixtem IN FRAME Web-Frame
   ALIGN-L EXP-LABEL                                                    */
...
------------------------------------------------------------------------------*/
  ...
  RUN htmAssociate
    ("cdeixtem":U,"gnapetp.cdeixtem":U,gnapetp.cdeixtem:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
    ("dseixtem":U,"gnapetp.dseixtem":U,gnapetp.dseixtem:HANDLE IN FRAME {&FRAME-NAME}).
END PROCEDURE.
...
RUN dbo/b1wpgd0007.p PERSISTENT SET h-b1wpgd0007.

/* Se BO foi instanciada */
IF VALID-HANDLE(h-b1wpgd0007) THEN
   DO:
      DO WITH FRAME {&FRAME-NAME}:
         IF opcao = "inclusao" THEN
            DO: 
                CREATE gnatetp.
                ASSIGN 
                    gnatetp.dseixtem = INPUT gnapetp.dseixtem
                    gnatetp.idevento = int(INPUT ab_unmap.aux_idevento).

                RUN inclui-registro IN h-b1wpgd0007(INPUT TABLE gnatetp, OUTPUT msg-erro, OUTPUT ab_unmap.aux_nrdrowid).
            END.
         ELSE  /* alteracao */
            DO:
                /* cria a temp-table e joga o novo valor digitado para o campo */
                CREATE gnatetp.
                BUFFER-COPY gnapetp TO gnatetp.

                ASSIGN 
                    gnatetp.dseixtem = INPUT gnapetp.dseixtem
                    gnatetp.idevento = int(INPUT ab_unmap.aux_idevento).
                 
                RUN altera-registro IN h-b1wpgd0007(INPUT TABLE gnatetp, OUTPUT msg-erro).
            END.    
      END. /* DO WITH FRAME {&FRAME-NAME} */
   
      /* "mata" a instância da BO */
      DELETE PROCEDURE h-b1wpgd0007 NO-ERROR.
   
   END. /* IF VALID-HANDLE(h-b1wpgd0007) */
...
IF VALID-HANDLE(h-b1wpgd0007) THEN
   DO:
      ...
      RUN exclui-registro IN h-b1wpgd0007(INPUT TABLE gnatetp, OUTPUT msg-erro).
...
IF REQUEST_METHOD = "POST":U THEN 
   DO:
      ...
      IF VALID-HANDLE(h-b1wpgd0007) THEN
      DO:
         RUN posiciona-registro IN h-b1wpgd0007(INPUT TO-ROWID(ab_unmap.aux_nrdrowid), OUTPUT msg-erro).
         DELETE PROCEDURE h-b1wpgd0007 NO-ERROR.
      END.
