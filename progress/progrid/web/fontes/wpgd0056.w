...
DEFINE VARIABLE ProgramaEmUso         AS CHARACTER INITIAL ["wpgd0056"].
DEFINE VARIABLE NmeDoPrograma         AS CHARACTER INITIAL ["wpgd0056.w"].
...
&Scoped-define WEB-FILE fontes/wpgd0056.htm
...
&Scoped-Define ENABLED-OBJECTS ab_unmap.aux_lsconsel ab_unmap.aux_lsevesel ab_unmap.aux_lsagesel ab_unmap.aux_lstqesel ab_unmap.aux_cdagenci ab_unmap.aux_cdcooper ab_unmap.aux_cddopcao ab_unmap.aux_dsendurl ab_unmap.aux_dsretorn ab_unmap.aux_dtanoage ab_unmap.aux_idevento ab_unmap.aux_lspermis ab_unmap.aux_nrdrowid ab_unmap.aux_stdopcao ab_unmap.cdagenci ab_unmap.aux_cdcopope ab_unmap.aux_cdoperad ab_unmap.aux_resposta ab_unmap.cbSelecTodos ab_unmap.aux_dsurlphp ab_unmap.cdevento
...
&Scoped-Define DISPLAYED-OBJECTS ab_unmap.aux_lsconsel ab_unmap.aux_lsevesel ab_unmap.aux_lsagesel ab_unmap.aux_lstqesel ab_unmap.aux_cdagenci ab_unmap.aux_cdcooper ab_unmap.aux_cddopcao ab_unmap.aux_dsendurl ab_unmap.aux_dsretorn ab_unmap.aux_dtanoage ab_unmap.aux_idevento ab_unmap.aux_lspermis ab_unmap.aux_nrdrowid ab_unmap.aux_stdopcao ab_unmap.cdagenci ab_unmap.aux_cdcopope ab_unmap.aux_cdoperad ab_unmap.aux_resposta ab_unmap.cbSelecTodos ab_unmap.aux_dsurlphp ab_unmap.cdevento
...
PROCEDURE CriaListaEventos :
  ...
  FOR EACH crapeap WHERE crapeap.idevento = INT(ab_unmap.aux_idevento)    AND
                         ...
                         crapeap.cdcooper = INT(ab_unmap.aux_cdcooper)    AND
                        (crapeap.cdagenci = INT(ab_unmap.cdagenci)        OR
                                       -1 = INT(ab_unmap.cdagenci)) NO-LOCK /*USE-INDEX crapeap1*/
    ...
    RUN RodaJavaScript("meventoAd.push(~{cdevento:'" + STRING(crapeap.cdevento)
																		+ "',nmevento:'" + STRING(crapedp.nmevento) + "'~});").
...
PROCEDURE local-assign-record :
	...
	FOR EACH crapagp WHERE crapagp.idevento = INT(ab_unmap.aux_idevento)
					   ...
					   AND (crapagp.cdageagr = INT(tmp_cdagenci)	    
					    OR INT(tmp_cdagenci)= -1)						
					   AND crapagp.idstagen = 2 
					   AND crapagp.cdageagr <> 0
					   AND crapagp.cdagenci <> 0 EXCLUSIVE-LOCK:
    ...
    DO aux_nrevesel = 1 TO NUM-ENTRIES(ab_unmap.aux_lsevesel, ";"):
      ...
      FIND FIRST crapeap WHERE crapeap.idevento = INT(ab_unmap.aux_idevento)
                           ...
                           AND crapeap.cdevento = INT(ENTRY(aux_nrevesel, ab_unmap.aux_lsevesel, ";"))
                           AND crapeap.cdagenci = INT(tmp_cdagenci) /*INT(ENTRY(aux_nrevesel, ab_unmap.aux_lsagesel, ";"))*/ EXCLUSIVE-LOCK NO-ERROR.
          ...
          WHEN "exe" THEN
            DO: 
              ...
              FOR EACH crapsde WHERE crapsde.idevento = INT(ab_unmap.aux_idevento)
                                 ...
                                 AND crapsde.cdagenci = INT(tmp_cdagenci)
                                 AND crapsde.dtanoage = INT(ab_unmap.aux_dtanoage)
