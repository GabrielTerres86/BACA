...
FUNCTION montaTela RETURNS LOGICAL ():
    ...
    {&out} '   <table border="0" cellspacing="0" cellpadding="0" width="100%" class="tab1">' SKIP
     ...
     /*ELSE
       {&out} '         <td class="tdTitulo1" colspan="4" align="center">' nomeDaCooperativa ' - ' aux_tldatela[tipoDeRelatorio] ' - ' aux_dtAnoAge '</td>' SKIP.
       */
    {&out} '         <td align="center"><img src="' imagemDaCooperativa '" border="0"></td>' SKIP
      ...
      /*IF tipoDeRelatorio = 2 AND aux_tprelato <> 0 THEN       
        DO:*/ 
          {&out} '<tr>' SKIP
