...
Alterações: 05/05/2009 - Utilizar cdcooper = 0 nas consultas (David).
...
DEFINE VARIABLE ProgramaEmUso AS CHARACTER INITIAL ["wpgd0015"].
DEFINE VARIABLE NmeDoPrograma AS CHARACTER INITIAL ["wpgd0015.w"].
...
/*** Declaração de BOs ***/
DEFINE VARIABLE h-b1wpgd0015          AS HANDLE                         NO-UNDO.

/*** Temp Tables ***/
DEFINE TEMP-TABLE gnatrdp             LIKE gnaprdp.
...
&Scoped-define WEB-FILE fontes/wpgd0015.htm

/* Name of first Frame and/or Browse and/or first Query                 */
&Scoped-define FRAME-NAME Web-Frame

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS gnaprdp.dsrecurs 
&Scoped-define ENABLED-TABLES ab_unmap gnaprdp
&Scoped-define FIRST-ENABLED-TABLE ab_unmap
&Scoped-define SECOND-ENABLED-TABLE gnaprdp
...
&Scoped-Define DISPLAYED-FIELDS gnaprdp.dsrecurs 
&Scoped-define DISPLAYED-TABLES ab_unmap gnaprdp
&Scoped-define FIRST-DISPLAYED-TABLE ab_unmap
&Scoped-define SECOND-DISPLAYED-TABLE gnaprdp
...
DEFINE FRAME Web-Frame
     ...
     ab_unmap.aux_stdopcao AT ROW 1 COL 1 HELP
          ...
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     gnaprdp.dsrecurs AT ROW 1 COL 1 NO-LABEL
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
...
/* SETTINGS FOR FILL-IN ab_unmap.aux_stdopcao IN FRAME Web-Frame
   ALIGN-L EXP-LABEL EXP-FORMAT EXP-HELP                                */
/* SETTINGS FOR FILL-IN gnaprdp.dsrecurs IN FRAME Web-Frame
   ALIGN-L EXP-LABEL                                                    */
...
------------------------------------------------------------------------------*/
  ...
  RUN htmAssociate
    ("dsrecurs":U,"gnaprdp.dsrecurs":U,gnaprdp.dsrecurs:HANDLE IN FRAME {&FRAME-NAME}).
END PROCEDURE.
...
RUN dbo/b1wpgd0015.p PERSISTENT SET h-b1wpgd0015.

/* Se BO foi instanciada */
IF VALID-HANDLE(h-b1wpgd0015) THEN
   DO:
      DO WITH FRAME {&FRAME-NAME}:
         IF opcao = "inclusao" THEN
            DO: 
                CREATE gnatrdp.
                ASSIGN gnatrdp.dsrecurs = INPUT gnaprdp.dsrecurs
                       gnatrdp.idevento = INTEGER(INPUT ab_unmap.aux_idevento).

                RUN inclui-registro IN h-b1wpgd0015(INPUT TABLE gnatrdp, OUTPUT msg-erro, OUTPUT ab_unmap.aux_nrdrowid).
            END.
         ELSE  /* alteracao */
            DO:
                /* cria a temp-table e joga o novo valor digitado para o campo */
                CREATE gnatrdp.
                BUFFER-COPY gnaprdp TO gnatrdp.

                ASSIGN gnatrdp.dsrecurs = INPUT gnaprdp.dsrecurs
                       gnatrdp.idevento = INTEGER(INPUT ab_unmap.aux_idevento).
                 
                RUN altera-registro IN h-b1wpgd0015(INPUT TABLE gnatrdp, OUTPUT msg-erro).
            END.    
      END. /* DO WITH FRAME {&FRAME-NAME} */
   
      /* "mata" a instância da BO */
      DELETE PROCEDURE h-b1wpgd0015 NO-ERROR.
   
   END. /* IF VALID-HANDLE(h-b1wpgd0015) */
...
IF VALID-HANDLE(h-b1wpgd0015) THEN
   DO:
      ...
      RUN exclui-registro IN h-b1wpgd0015(INPUT TABLE gnatrdp, OUTPUT msg-erro).
...
IF REQUEST_METHOD = "POST":U THEN 
   DO:
      ...
      IF VALID-HANDLE(h-b1wpgd0015) THEN
         DO:
            RUN posiciona-registro IN h-b1wpgd0015(INPUT TO-ROWID(ab_unmap.aux_nrdrowid), OUTPUT msg-erro).
            DELETE PROCEDURE h-b1wpgd0015 NO-ERROR.
         END.
