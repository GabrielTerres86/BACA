...
DEFINE VARIABLE ProgramaEmUso AS CHARACTER INITIAL ["wpgd0018d"].
DEFINE VARIABLE NmeDoPrograma AS CHARACTER INITIAL ["wpgd0018d.w"].
...
&Scoped-define WEB-FILE fontes/wpgd0018d.htm
...
RUN dbo/b1wpgd0018d.p PERSISTENT SET h-b1wpgd0018d.

/* Se BO foi instanciada */
IF VALID-HANDLE(h-b1wpgd0018d) THEN
   DO:
      DO WITH FRAME {&FRAME-NAME}:
         IF opcao = "inclusao" THEN
            DO: 
                CREATE cratcdi.
                ASSIGN 
                    cratcdi.dscusind = INPUT crapcdi.dscusind
                    cratcdi.idevento = INT(ab_unmap.aux_idevento).

                RUN inclui-registro IN h-b1wpgd0018d(INPUT TABLE cratcdi, OUTPUT msg-erro, OUTPUT ab_unmap.aux_nrdrowid).
         ...
         ELSE  /* alteracao */
            DO:
                ...
                RUN altera-registro IN h-b1wpgd0018d(INPUT TABLE cratcdi, OUTPUT msg-erro).

            END.    
      END. /* DO WITH FRAME {&FRAME-NAME} */
   
      /* "mata" a instância da BO */
      DELETE PROCEDURE h-b1wpgd0018d NO-ERROR.
   
   END. /* IF VALID-HANDLE(h-b1wpgd0018d) */
...
IF VALID-HANDLE(h-b1wpgd0018d) THEN
   DO:
      ...
      RUN exclui-registro IN h-b1wpgd0018d(INPUT TABLE cratcdi, OUTPUT msg-erro).
...
IF REQUEST_METHOD = "POST":U THEN 
   DO:
      ...
      IF VALID-HANDLE(h-b1wpgd0018d) THEN
         DO:
            RUN posiciona-registro IN h-b1wpgd0018d(INPUT TO-ROWID(ab_unmap.aux_nrdrowid), OUTPUT msg-erro).
            DELETE PROCEDURE h-b1wpgd0018d NO-ERROR.
         END.
