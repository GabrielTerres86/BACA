...
............................................................................ */
&SCOPED-DEFINE tttabela gtfacep
&SCOPED-DEFINE tabela   gnfacep
...
PROCEDURE valida-inclusao:
    ...
    */
    ...
    FIND FIRST gnappdp WHERE gnappdp.cdcooper = 0                    AND
                             gnappdp.nrpropos = {&tttabela}.nrpropos NO-LOCK NO-ERROR.
    ...
    /* Verifica se o facilitador existe */
    FIND FIRST gnapfep WHERE gnapfep.cdcooper = 0                    AND
                             gnapfep.cdfacili = {&tttabela}.cdfacili NO-LOCK NO-ERROR.
    IF NOT AVAIL gnapfep THEN
    DO:
        ASSIGN m-erros = m-erros + "Facilitador não encontrado.".
        RETURN "NOK".
    END.
...
PROCEDURE valida-alteracao:
    ...
    FIND FIRST {&tabela} WHERE {&tabela}.cdcooper = 0                    AND
                               ...
                               {&tabela}.cdfacili = {&tttabela}.cdfacili AND
