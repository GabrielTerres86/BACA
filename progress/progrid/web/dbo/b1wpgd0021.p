/* .............................................................................
   ...
   Frequencia: 
   Objetivo  : Criação/Alteração/Exclusão dos Parâmetros da Agenda
   
   Alterações:  06/02/2008 - Incluido tratamento na rotina de alteração ref.
                             aba de Fechamento da tela de Parâmetros das Agendas
							 (Diego).
...
PROCEDURE valida-inclusao:
    ...
    /* Valida a data da nova agenda, não pode fazer duas vezes para a mesma data */
    ...
    IF   AVAILABLE {&tabela}                         AND
         ...
         DO:
            ASSIGN m-erros = m-erros + "A agenda de " + STRING({&tabela}.dtanonov) + " já foi inicializada!".
            RETURN "NOK".
         END.
...
PROCEDURE valida-alteracao:
    ...
    /* Valida o ano da agenda para não poder voltar o ano */
    IF  {&tttabela}.dtanoage < {&tabela}.dtanoage   THEN
        DO:
           ASSIGN m-erros = m-erros + "O Ano atual não pode ser menor que o ano já atual".
           RETURN "NOK".
        END.
