...
var UrlSite     = window.location.protocol+"//"+window.location.host+"/"; // Url do site
...
$(document).ready(function() {
	...
	$("body").append('<div id="divAguardo" name="divAguardo"></div><div id="divError"></div><div id="divConfirm"></div><div id="divBloqueio"></div><div id="divF2"></div><div id="divUsoGenerico"></div>');
...
/*!
 * OBJETIVO: função para solicitar confirma??o da senha de Coordenador/Gerente para processo especial
 */
...
/*!
 * ALTERA??O : 008
 * OBJETIVO  : função similar ? format_number do php
...
/*!
 * ALTERA??O  : 012
 * OBJETIVO   : função que retorna uma string padr?o de aguardo para impress?o
 ...
 *              businobj [Obrigat?rio] -> Business Object da rotina que está sendo tratada
 */
...
$.fn.extend({ 
	...
	/*!
	 * ALTERA??O  : 034
	 * OBJETIVO   : função respons?vel por formatar o rodap? das pesquisas gen?ricas e pesquisa associado
	 */
