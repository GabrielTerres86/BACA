/* ...................................................................................
Include: wpgd0200.i
Objetivo: Criar um vetor de PACs, contendo código do PAC e
          nome abreviado do PAC, para que seja usado no arquivo HTML.
          Esta include agrupa os PACs (Lombardi)

Alterações: 01/07/2016 - Ajuste não trazer a opção todos quando não for super usuário (Vanessa).
                  
................................................................................... */

/* "200" para nao conflitar com outros fontes */
DEF VAR par_cdcooper100 AS INT             NO-UNDO.
...
IF   AVAILABLE gnapses   THEN
     DO: 
         IF   INT(GET-VALUE("aux_cdcooper")) <> 0   THEN
              par_cdcooper100 = INT(GET-VALUE("aux_cdcooper")).
         ELSE
              par_cdcooper100 = gnapses.cdcooper.
         ...
         IF   gnapses.nvoperad = 1   OR
              ...
              DO: 
                 ...
                 FIND crapagp WHERE crapagp.idevento = 1 /* PROGRID */    AND
                                    crapagp.cdcooper = par_cdcooper100     AND
                 ...
                 IF   AVAILABLE crapagp   THEN
                      DO:
                          ...
                          aux_cdagenci = aux_cdagenci + "," + STRING(aux_nmresage) + "," + TRIM(STRING(crapagp.cdageagr)).
