/* ..........................................................................
   ...
   Programa: Fontes/crps104.p
   Sistema : Conta-Corrente - Cooperativa de Credito
   Sigla   : CRED
   Autor   : Deborah/Edson
   Data    : Dezembro/94.                    Ultima atualizacao: 26/11/2010
...
RUN STORED-PROCEDURE pc_crps104 aux_handproc = PROC-HANDLE
   (INPUT glb_cdcooper,                                                  
...
CLOSE STORED-PROCEDURE pc_crps104 WHERE PROC-HANDLE = aux_handproc.

{ includes/PLSQL_altera_session_depois.i &dboraayl={&scd_dboraayl} }

ASSIGN glb_cdcritic = 0
       glb_dscritic = ""
       glb_cdcritic = pc_crps104.pr_cdcritic WHEN pc_crps104.pr_cdcritic <> ?
       glb_dscritic = pc_crps104.pr_dscritic WHEN pc_crps104.pr_dscritic <> ?
       glb_stprogra = IF pc_crps104.pr_stprogra = 1 THEN TRUE ELSE FALSE
       glb_infimsol = IF pc_crps104.pr_infimsol = 1 THEN TRUE ELSE FALSE. 
