/* ............................................................................
   ...
   Programa: Fontes/crps516.p
   Sistema : Conta-Corrente - Cooperativa de Credito
   Sigla   : CRED
   Autor   : Gabriel
   Data    : Setembro/2008                   Ultima Atualizacao: 23/05/2018
   ...
   Alteracoes: 04/11/2008 - Efetuar limpeza das tabelas crapris e crapvri
               ...
               23/05/2018 - Inclusao de log de fim de execucao do programa 
                            (Belli - Envolti - Chamado REQ0015033)
...
RUN STORED-PROCEDURE pc_crps516 aux_handproc = PROC-HANDLE
   (INPUT glb_cdcooper,                 
...
CLOSE STORED-PROCEDURE pc_crps516 WHERE PROC-HANDLE = aux_handproc.

{ includes/PLSQL_altera_session_depois.i &dboraayl={&scd_dboraayl} }

ASSIGN glb_cdcritic = 0
       glb_dscritic = ""
       glb_cdcritic = pc_crps516.pr_cdcritic WHEN pc_crps516.pr_cdcritic <> ?
       glb_dscritic = pc_crps516.pr_dscritic WHEN pc_crps516.pr_dscritic <> ?
       glb_stprogra = IF  pc_crps516.pr_stprogra = 1 THEN
                          TRUE
                      ELSE
                          FALSE
       glb_infimsol = IF  pc_crps516.pr_infimsol = 1 THEN
                          TRUE
                      ELSE
                          FALSE.
...
/* Inclusao de log de fim de execucao do programa -  23/05/2018 - Chamado REQ0015033 */
