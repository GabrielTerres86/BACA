/* .............................................................................
   ...
   Objetivo  : Processar a rotina de alteracao da tela CMESAQ.

   Alteracoes: 30/09/2003 - Nao registrar acima de R$ 100.000 quando pessoa
                            juridica (Margarete).

               23/03/2005 - Inclusao parametro bo imp ctr saques(Mirtes)
               ...
               20/05/2011 - Retirar campo Registrar.
                            Email para controle de movimento.
                            Incluir campo 'Inf. prestada pelo cooperado' 
                            (Gabriel).             
               ...
               16/09/2011 - Retirar campo 'Pessoa'. Obrigar tipo fisica.
                            Incluir campo 'Valor sendo levado'.
                            (Gabriel)             
...
DO WHILE TRUE:
   ...
   DO WHILE TRUE ON ENDKEY UNDO, LEAVE:
      ...
      IF   tt-crapcme.flinfdst   THEN /* Prencher destinatario */
           DO:
               DO WHILE TRUE ON ENDKEY UNDO, LEAVE:
      ...
      IF   tt-crapcme.vllanmto >= tt-crapcme.vlmincen   THEN
           DO:
               ...
               IF   tt-crapcme.dsdopera = "P"   THEN
                  ...
                  IF   tt-crapcme.vlretesp > tt-crapcme.vllanmto   THEN
                                DO:
                                    MESSAGE 
                "Valor digitado nao pode ser maior que o lancamento (R$ " +
                    TRIM(STRING(tt-crapcme.vllanmto,"zzz,zzz,zz9.99"))  + ").".
                                    NEXT.
                                 END.
