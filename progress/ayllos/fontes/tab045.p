...
/* .............................................................................
   ...
   Sigla   : CRED
   Autor   : Guilherme
   Data    : Agosto/2007                        Ultima alteracao: 24/03/2016
...
DEF VAR tel_vllimweb AS DECI FORMAT "z,zzz,zz9.99"    EXTENT 2        NO-UNDO.
DEF VAR tel_vllimtrf AS DECI FORMAT "z,zzz,zz9.99"    EXTENT 2        NO-UNDO.
DEF VAR tel_vllimpgo AS DECI FORMAT "z,zzz,zz9.99"    EXTENT 2        NO-UNDO.
DEF VAR tel_vllimted AS DECI FORMAT "z,zzz,zz9.99"    EXTENT 2        NO-UNDO.
DEF VAR tel_vlvrbole AS DECI FORMAT "z,zzz,zz9.99"    EXTENT 2        NO-UNDO.
...
FORM "Operacional"   AT 48
     "CECRED"        AT 67
     SKIP(1)
     "Valor Limite/Dia (Transf/Pagamentos):" AT 08
     tel_vllimweb[1] AT 47 NO-LABEL 
     ...
     SKIP
     "Valor Limite/Dia TED:" AT 24
     tel_vllimted[1] AT 47 NO-LABEL
         HELP "Informe o valor maximo para operacoes com TED."
     tel_vllimted[2] AT 61 NO-LABEL
         HELP "Informe o valor maximo para operacoes com TED."
     SKIP
     "Valor Limite VR Boletos:" AT 21
     tel_vlvrbole[1] AT 47 NO-LABEL
         HELP "Informe o valor maximo para operacoes com VR Boleto."
     tel_vlvrbole[2] AT 61 NO-LABEL
         HELP "Informe o valor maximo para operacoes com VR Boleto."
     SKIP
     "Limite de dias para primeiro acesso:"  AT 09
     tel_qtdiaace[1] AT 56 NO-LABEL 
        HELP "Informe o maximo de dias para efetuar primeiro acesso a internet."
     tel_qtdiaace[2] AT 70 NO-LABEL  
        HELP "Entre com o limite para o Operacional."
     SKIP
     "Prazo solicitacao de troca de senha:"  AT 09
     ...
     tel_qtdiatro[2] AT 70 NO-LABEL  
        HELP "Entre com o limite para o Operacional."
        VALIDATE(INPUT tel_qtdiatro[2] <> 0,"Valor deve ser maior que zero")
     SKIP
     "Prazo alteracao senha apos solicitacao:"  AT 06
     ...
     tel_qtdiaaso[2] AT 70 NO-LABEL  
        HELP "Entre com o limite para o Operacional."
        VALIDATE(INPUT tel_qtdiaaso[2] <> 0,"Valor deve ser maior que zero")
     SKIP
     "Prazo bloqueio acesso a conta:"  AT 15
...
FORM "Operacional"   AT 47
     "CECRED"        AT 66
     SKIP(1)
     "Valor Limite/Dia Transferencia:" AT 13
     tel_vllimtrf[1] AT 46 NO-LABEL 
        HELP "Informe o valor maximo para transferencias na internet."
     tel_vllimtrf[2] AT 60 NO-LABEL
        HELP "Entre com o limite para o Operacional." 
     SKIP
     "Valor Limite/Dia Pagamentos:"    AT 16
     tel_vllimpgo[1] AT 46 NO-LABEL 
        HELP "Informe o valor maximo para pagamentos na internet."
     tel_vllimpgo[2] AT 60 NO-LABEL
        HELP "Entre com o limite para o Operacional."
     SKIP   
     "Valor Limite/Dia TED:" AT 23
     tel_vllimted[1] AT 46 NO-LABEL
        HELP "Informe o valor maximo para operacoes com TED."
     tel_vllimted[2] AT 60 NO-LABEL
        HELP "Informe o valor maximo para operacoes com TED."
     SKIP
     "Valor Limite VR Boletos:" AT 20
     tel_vlvrbole[1] AT 46 NO-LABEL
        HELP "Informe o valor maximo para operacoes com VR Boleto."
     tel_vlvrbole[2] AT 60 NO-LABEL
        HELP "Informe o valor maximo para operacoes com VR Boleto."
     SKIP
     "Limite de dias para primeiro acesso:"  AT 08
     tel_qtdiaace[1] AT 55 NO-LABEL 
        HELP "Informe o maximo de dias para efetuar primeiro acesso a internet."
     tel_qtdiaace[2] AT 69 NO-LABEL  
        HELP "Entre com o limite para o Operacional."
     SKIP
     "Prazo solicitacao de troca de senha:"  AT 08
     tel_qtdiatro[1] AT 55 NO-LABEL 
        HELP "Informe o prazo de validade da senha. (em dias)"
        VALIDATE(INPUT tel_qtdiatro[1] <> 0,"Valor deve ser maior que zero")
     tel_qtdiatro[2] AT 69 NO-LABEL  
        HELP "Entre com o limite para o Operacional."
        VALIDATE(INPUT tel_qtdiatro[2] <> 0,"Valor deve ser maior que zero")
     SKIP
     "Prazo alteracao senha apos solicitacao:"  AT 05
     tel_qtdiaaso[1] AT 55 NO-LABEL 
       HELP "Informe o prazo apos vencimento da senha. (em dias) ."
       VALIDATE(INPUT tel_qtdiaaso[1] <> 0,"Valor deve ser maior que zero")
     tel_qtdiaaso[2] AT 69 NO-LABEL  
       HELP "Entre com o limite para o Operacional."
       VALIDATE(INPUT tel_qtdiaaso[2] <> 0,"Valor deve ser maior que zero")
     SKIP
     "Prazo bloqueio acesso a conta:"  AT 14
     tel_qtdiablo[1] AT 55 NO-LABEL 
        HELP "Informe o prazo de acesso a conta apos solicitacoes. (em dias) ."
        VALIDATE(INPUT tel_qtdiablo[1] <> 0,"Valor deve ser maior que zero")
     tel_qtdiablo[2] AT 69 NO-LABEL  
        HELP "Entre com o limite para o Operacional."
        VALIDATE(INPUT tel_qtdiablo[2] <> 0,"Valor deve ser maior que zero")
     SKIP
     "Limite tentativas senha errada:"       AT 13
     tel_nrderros[1] AT 56 NO-LABEL 
        HELP "Informe o maximo de tentavivas para senha errada na internet."
     tel_nrderros[2] AT 70 NO-LABEL
        HELP "Entre com o limite para o Operacional."
     SKIP
     "Valor para conferencia envio:"         AT 15
     tel_vlpconfe[1] AT 46 NO-LABEL 
        HELP "Informe o valor para conferencia envio"
     tel_vlpconfe[2] AT 60 NO-LABEL
        HELP "Entre com o limite para o Operacional."
     SKIP
     "Limite de meses para agendamento:"     AT 11
     tel_qtmesagd[1] AT 55 NO-LABEL
        HELP "Informe a quantidade maxima de meses para agendamento."
     tel_qtmesagd[2] AT 69 NO-LABEL
        HELP "Entre com o limite para o Operacional."
     WITH ROW 8 OVERLAY SIDE-LABELS NO-BOX WIDTH 78 CENTERED 
            ...
            DO:
               ...
               IF par_vllimweb[1] <> DECI(ENTRY(1,aux_dstextab,";"))  THEN
                  UNIX SILENT VALUE("echo "                                    +
                       ...
                       STRING(DECI(ENTRY(1,aux_dstextab,";")),"z,zzz,zz9.99")    +
                       " para R$ " + STRING(par_vllimweb[1],"z,zzz,zz9.99")    +
                       " >> log/tab045.log").
               ...
               IF par_vllimted[1] <> DECI(ENTRY(13,aux_dstextab,";"))  THEN
                  UNIX SILENT VALUE("echo "                                   + 
                       ...
                       " Pessoa " + aux_dspessoa + " do Operador de R$ "      +
                       STRING(DECI(ENTRY(13,aux_dstextab,";")),"z,zzz,zz9.99")  +
                       " para R$ " + STRING(par_vllimted[1],"z,zzz,zz9.99")     +
                       " >> log/tab045.log").
               ...
               IF par_vlvrbole[1] <> DECI(ENTRY(15,aux_dstextab,";"))  THEN
                   UNIX SILENT VALUE("echo "                                   +
                        ...
                        " Pessoa " + aux_dspessoa + " do Operador de R$ "      +
                        STRING(DECI(ENTRY(15,aux_dstextab,";")),"z,zzz,zz9.99")  +
                        " para R$ " + STRING(par_vlvrbole[1],"z,zzz,zz9.99") +
                        " >> log/tab045.log").
               ...
               IF par_vllimweb[2] <> DECI(ENTRY(7,aux_dstextab,";"))  THEN
                  UNIX SILENT VALUE("echo "                                   +
                       ...
                       STRING(DECI(ENTRY(7,aux_dstextab,";")),"z,zzz,zz9.99")   +
                       " para R$ " + STRING(par_vllimweb[2],"z,zzz,zz9.99")     +
                       " >> log/tab045.log").
               ...
               IF par_vllimted[2] <> DECI(ENTRY(14,aux_dstextab,";"))  THEN
                  UNIX SILENT VALUE("echo "                                  + 
                       ...
                       " alterou o Valor do limite de TED"                   +
                       " Pessoa " + aux_dspessoa + " da CECRED de R$ "       +
                       STRING(DECI(ENTRY(14,aux_dstextab,";")),"z,zzz,zz9.99") +
                       " para R$ " + STRING(par_vllimted[2],"z,zzz,zz9.99")    +
                       " >> log/tab045.log").
               ...
               IF par_vlvrbole[2] <> DECI(ENTRY(16,aux_dstextab,";"))  THEN
                   UNIX SILENT VALUE("echo "                                   + 
                        ...
                        " alterou o Valor VR Boleto "                          +
                        " Pessoa " + aux_dspessoa + " da CECRED de R$ "        +
                        STRING(DECI(ENTRY(16,aux_dstextab,";")),"z,zzz,zz9.99")  +
            ...
            DO:
               ...
               IF par_vllimtrf[1] <> DECI(ENTRY(1,aux_dstextab,";"))  THEN
                  UNIX SILENT VALUE("echo " + STRING(par_dtmvtolt,"99/99/9999") + 
                       ...
                       " do Operador de R$ "                                    +
                       STRING(DECI(ENTRY(1,aux_dstextab,";")),"z,zzz,zz9.99")     +
                       " para R$ " + STRING(par_vllimtrf[1],"z,zzz,zz9.99")       +
                       " >> log/tab045.log").
               ...
               IF par_vllimpgo[1] <> DECI(ENTRY(6,aux_dstextab,";"))  THEN
                  UNIX SILENT VALUE("echo " + STRING(par_dtmvtolt,"99/99/9999") + 
                       ...
                       " da internet de Pessoa " + aux_dspessoa                 + 
                       " do Operador de R$ "                                    + 
                       STRING(DECI(ENTRY(6,aux_dstextab,";")),"z,zzz,zz9.99")     +
                       " para R$ " + STRING(par_vllimpgo[1],"z,zzz,zz9.99")       +
                       " >> log/tab045.log").  
               ...
               IF par_vllimtrf[2] <> DECI(ENTRY(7,aux_dstextab,";"))  THEN
                  UNIX SILENT VALUE("echo " + STRING(par_dtmvtolt,"99/99/9999") +
                       ...
                       " da CECRED de R$ "                                      +
                       STRING(DECI(ENTRY(7,aux_dstextab,";")),"z,zzz,zz9.99")     +
                       " para R$ " + STRING(par_vllimtrf[2],"z,zzz,zz9.99")       +
                       " >> log/tab045.log").
               ...
               IF par_vllimpgo[2] <> DECI(ENTRY(12,aux_dstextab,";"))  THEN
                  UNIX SILENT VALUE("echo " + STRING(par_dtmvtolt,"99/99/9999") +
                       ...
                       " da internet de Pessoa " + aux_dspessoa                 +
                       " da CECRED de R$ "                                      +
                       STRING(DECI(ENTRY(12,aux_dstextab,";")),"z,zzz,zz9.99")    +
                       " para R$ " + STRING(par_vllimpgo[2],"z,zzz,zz9.99")       +
                       " >> log/tab045.log").
