/* .............................................................................
   Programa: Fontes/extenso.p
   Sistema : Conta-Corrente - Cooperativa de Credito
   Sigla   : CRED
   Autor   : Edson/Odair
   Data    : Agosto/95                          Ultima Atualizacao: 16/01/2003

   Dados referentes ao programa:

   Frequencia: Sempre que chamado por outros programas.
   Objetivo  : Converter valores no seu respectivo extenso.

   Alteracoes: 18/09/96 - Alterado para receber parametro para mostrar o extenso
                          de percentagem, moeda e valor (Odair).

             16/01/2003 - Acerto quando nas dezenas do percentual (Ze Eduardo).
   ...
   IF   CAN-DO("10,20,30,40,50,60,70,80,90",aux_vlint004)  AND
        ...
        aux_vlextens = aux_vlextens + 
                      (IF  aux_ingrandz = 5 THEN
                       ...
                       ELSE  
                         ENTRY(INTEGER(SUBSTR(aux_vlint004,1,1)),aux_dsextdz1)).
