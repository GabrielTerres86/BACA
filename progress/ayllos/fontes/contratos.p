/* .............................................................................
   ...
   Programa: Fontes/contratos.p
   Sistema : Conta-Corrente - Cooperativa de Credito
   Sigla   : CRED
   Autor   : Deborah/Edson
   Data    : Agosto/95.                          Ultima atualizacao: 20/01/2015
   ...
   Alteracoes: 19/11/96 - Alterado a mascara do campo nrctremp (Odair).
               ...
               07/04/2007 - Alterado formato do campo "qtpreemp" de "z9" para "zz9" 
                          - Kbase IT Solutions - Paulo Ricardo Maciel             
                          
               25/04/2014 - Aumento de format do campo cdlcremp de 3 para 4
...
DEF OUTPUT PARAM par_nrctremp AS INT                                 NO-UNDO.

{ includes/ctremp.i "NEW" }

DEF VAR tab_nrctremp     AS INT       EXTENT 100                     NO-UNDO.
...
ASSIGN s_chextent   = 0
       ...
       s_column   = 15
       s_hide     = TRUE
       s_title    = " Contratos De Emprestimo "
       s_dbfilenm = "crapepr"
       s_multiple = FALSE
       s_wide     = TRUE.
...
FOR EACH crapepr WHERE crapepr.cdcooper = par_cdcooper AND
    ...
    ASSIGN aux_nrctatos = aux_nrctatos + 1
           tab_nrctremp[aux_nrctatos] = crapepr.nrctremp

           s_chextent           = s_chextent + 1
           s_chlist[s_chextent] = STRING(crapepr.cdlcremp,"9999") + " " +
                                  ...
                                  STRING(crapepr.vlpreemp,"zzzzz,zz9.99").
...
FORM p_flag[p_recid] FORMAT "* /  " SPACE(0) s_chlist[p_recid] FORMAT "x(60)"
...
DO WHILE TRUE:
   ...
   IF   aux_nrctatos = 1   THEN
        DO:
            par_nrctremp = tab_nrctremp[aux_nrctatos].
            LEAVE.
        END.
...
IF   aux_nrctatos > 1   THEN
     IF   s_chcnt > 0   THEN
           par_nrctremp = tab_nrctremp[s_choice[s_chcnt]].
