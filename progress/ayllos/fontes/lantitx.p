/* .............................................................................
   ...
   Programa: Fontes/lantitx.p
   Sistema : Conta-Corrente - Cooperativa de Credito
   Sigla   : CRED
   Autor   : Edson
   Data    : Setembro/2000.                      Ultima atualizacao: 13/12/2013

   Dados referentes ao programa:

   Frequencia: Diario (on-line)
   Objetivo  : Processar a rotina de cancelamento de resgate da tela LANTIT.

   Alteracoes: 17/11/2000 - Alterar nrdolote p/6 posicoes (Margarete/Planner).
               ...
               04/07/2005 - Alimentado campo cdcooper da tabela craplcm (Diego).

               02/02/2006 - Unificacao dos Bancos - SQLWorks - Fernando.
               
               13/12/2013 - Inclusao de VALIDATE craplcm (Carlos)
..............................................................................*/
   ...
   DO WHILE TRUE TRANSACTION ON ERROR UNDO, LEAVE:
      ...
      IF   AVAILABLE craplau   THEN
           DO:
               ...
               IF   craplau.dtmvtopg <= glb_dtmvtolt   THEN
                    DO:
                        DO WHILE TRUE:
                        ...
                        ASSIGN craplcm.dtmvtolt = craplot.dtmvtolt
                               ...
                               craplcm.nrdctitg = STRING(craplau.nrdconta,
                                                        "99999999")
