/* .............................................................................
   ...
   Objetivo  : Tratar arq. de retorno BB - C/C INTEGRACAO - SALDOS DISPONIVEIS
               Arquivo COO504 - Saldos disponiveis                
   ...
   Alteracoes: 06/04/2005 - Gravar os erros no log da tela PRCITG;
               ...
               28/12/2005 - Gerar erro de tipo de conta somente se a "flgctitg"
                            estiver 2 - cta integr. cadastrada/ativa (Evandro).
               ...
               22/03/2007 - Nao critica se cooperado tem conta BANCOOB e conta
                            integracao (Elton).
               ...
               17/12/2012 - Envio de emails referente ao COO500 a COO509 para
...
DEF    VAR      tot_qtdcriti AS INT                                NO-UNDO.
...
DO WHILE TRUE ON ERROR UNDO, LEAVE ON ENDKEY UNDO, LEAVE:
   ...
   ASSIGN aux_contador = aux_contador + 1
          aux_nmarqdat = "integra/coo504" + STRING(DAY(glb_dtmvtolt),"99") +
                                            STRING(MONTH(glb_dtmvtolt),"99") +
...
FIND crabtab WHERE crabtab.cdcooper = glb_cdcooper  AND
                   ...
                   crabtab.tpregist = 404           NO-ERROR NO-WAIT.
...
FIND craptab WHERE craptab.cdcooper = glb_cdcooper  AND
                   ...
                   craptab.tpregist = 504           NO-ERROR NO-WAIT.
...
PROCEDURE p_imprime_rejeitados:
   ...
   FORM cratrej.cdagenci AT 01 FORMAT "zz9"            LABEL "PA" 
        cratrej.nrdconta AT 05 FORMAT "zzzzz,zzz,9"    LABEL "CONTA/DV"
   ...
   ASSIGN aux_nmarqimp = "rl/crrl419_" + STRING(TIME) + ".lst". 
