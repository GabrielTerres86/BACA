/* .............................................................................
   ...
   Programa: Fontes/poupanca.p
   Sistema : Conta-Corrente - Cooperativa de Credito
   Sigla   : CRED
   Autor   : Odair
   Data    : Fevereiro/99.                      Ultima atualizacao: 13/02/2006

   Dados referentes ao programa:

   Frequencia: Sempre que chamado por outros programas (on-line)
   Objetivo  : Mostrar a lista de poupancas programadas.

   Alteracoes: 28/09/2004 - Alterado nro digitos nrctrrpp(Mirtes)
...
DEF VAR tab_nraplica     AS INT       EXTENT 100                     NO-UNDO.
...
ASSIGN s_chextent   = 0
       ...
       s_column   = 15
       s_hide     = TRUE
       s_title    = " Poupancas Programadas "
       s_dbfilenm = "craprpp"
       s_multiple = FALSE
       s_wide     = TRUE.

/*  Leitura das poupancas programadas  */
...
FOR EACH craprpp WHERE craprpp.cdcooper = par_cdcooper AND
    ...
    ASSIGN aux_nrctatos = aux_nrctatos + 1
           tab_nraplica[aux_nrctatos] = craprpp.nrctrrpp

           s_chextent           = s_chextent + 1
           s_chlist[s_chextent] = STRING(craprpp.dtmvtolt,"99/99/9999") +
                               " " +
                               STRING(craprpp.nrctrrpp,"z,zzz,zz9") + "     " +
                               STRING(DAY(craprpp.dtdebito),"99") +  "   " +
                               STRING(craprpp.vlprerpp,"zzzzz,zz9.99").
