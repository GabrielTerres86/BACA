/* .............................................................................
   ...
   Objetivo  : Mostrar a tela TAB056 - Mensagens de erro SERASA.

   Alteracoes: 15/07/2010 - tab CDERROSSER sera mantida na CECRED (Guilherme)
...
DEF        VAR tel_dsdoerro LIKE craptab.dstextab                    NO-UNDO.
...
DEF BROWSE mensag-b QUERY mensag-q
      DISP SPACE(5)
           ...
           SPACE(3)
           craptab.dstextab              COLUMN-LABEL "Descricao do Erro"
           SPACE(5)
           WITH  9 DOWN OVERLAY TITLE "Mensagens de Erro - Sistema SERASA".
...
DO WHILE TRUE:
   ...
   IF   KEYFUNCTION(LASTKEY) = "END-ERROR"   THEN     /*   F4 OU FIM   */
        DO:
            ...
            IF   CAPS(glb_nmdatela) <> "TAB056"   THEN
                 DO:
                     HIDE FRAME f_opcao.
                     HIDE FRAME f_dados.   
                     RETURN.
   ...
   IF   INPUT glb_cddopcao = "A" THEN
        DO:
            ...
            DO TRANSACTION ON ENDKEY UNDO, LEAVE:
               ...
               MESSAGE "Descricao de erro alterado com sucesso!".
               NEXT.   
                  ...
                  DO:            
                      ...
                      DO TRANSACTION ON ENDKEY UNDO, LEAVE:
                         ...
                         ASSIGN tel_cddoerro = INT("")
                                tel_dsdoerro = "".
                         DISPLAY tel_cddoerro tel_dsdoerro WITH FRAME f_dados.
                         MESSAGE "Mensagem de erro excluida com sucesso!".  
