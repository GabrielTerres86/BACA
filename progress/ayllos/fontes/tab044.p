/* .............................................................................
   ...
   Programa: Fontes/tab044.p
   Sistema : Conta-Corrente - Cooperativa de Credito
   Sigla   : CRED
   Autor   : Elton        
   Data    : Marco/2007                            Ultima alteracao: 07/12/2016

   Dados referentes ao programa:

   Frequencia: Diario (on-line)
   Objetivo  : Mostrar a tela TAB044 - Mensagens de erro BANCOOB.
...
DEF BROWSE mensag-b QUERY mensag-q
      DISP SPACE(5)
           ...
           SPACE(5)
           WITH  9 DOWN OVERLAY TITLE "Mensagens de Erro - Sistema BANCOOB".
...
DO WHILE TRUE:
   ...
   IF   KEYFUNCTION(LASTKEY) = "END-ERROR"   THEN     /*   F4 OU FIM   */
        DO:
            ...
            IF   CAPS(glb_nmdatela) <> "TAB044"   THEN
                 DO:
                     HIDE FRAME f_opcao.
                     HIDE FRAME f_dados.   
                     RETURN.
                                 ...
                                 OPEN QUERY mensag-q 
                                      FOR EACH craptab WHERE 
                                               craptab.cdcooper =
                                                ...
                                                craptab.tptabela = "GENERI"  AND
                                                craptab.cdempres = 00        AND
                                                craptab.cdacesso = "CDERROSBCB"                                                NO-LOCK.
