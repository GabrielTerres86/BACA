...
/* .............................................................................
   ...
   Sigla   : CRED
   Autor   : Margarete
   Data    : Julho/2004.                     Ultima atualizacao: 07/12/2015
...
UNIX SILENT VALUE ("/usr/bin/find /usr/coop/" + crapcop.dsdircop + "/log/cash/* ! -name . -prune -a -mtime +30 -a -exec rm -f \{\} +").
UNIX SILENT VALUE ("/usr/bin/find /usr/coop/" + crapcop.dsdircop + "/compbb/salva/* ! -name . -prune -a -mtime +7 -a -exec rm -f \{\} +").

IF glb_cdcooper = 3 THEN
    DO:         
        UNIX SILENT VALUE ("/usr/bin/find /usr/coop/cecred/log/TAA/TAA_autorizador*.log ! -name . -prune -a -mtime +30 -a -exec rm -f \{\} +"). 
    END.                                                                                                                                       
/*****************************   FIM - COMENTAR   *****************************/
