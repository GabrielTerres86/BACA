/* .............................................................................
   ...
   Objetivo  : Processar a rotina de consulta da tela lanbdc.
...
DO WHILE TRUE ON ENDKEY UNDO, LEAVE:
   ...
   IF   glb_cdcritic > 0 THEN
        DO:
            ...
            DISPLAY tel_nrcustod tel_nmcustod tel_dtlibera tel_vlcheque 
                    tel_nrseqdig WITH FRAME f_lanbdc.        
   ...
   DO WHILE TRUE:    
      ...
      FIND crapcdb WHERE crapcdb.cdcooper = glb_cdcooper   AND 
                         ...
                         crapcdb.nrcheque = tel_nrcheque   NO-LOCK NO-ERROR.
                    ...
                    DO:
                        ...
                        IF   AVAILABLE craptrf THEN
                             DO:
                                 ...
                                 DISPLAY tel_nrctachq WITH FRAME f_lanbdc.
                                 NEXT.
                             END.
                    END.
      ...
      DISPLAY tel_nrcustod tel_nmcustod tel_dtlibera 
              tel_vlcheque tel_nrseqdig tel_nrborder
              WITH FRAME f_lanbdc.
...
PROCEDURE proc_lista:
    ...
    FOR EACH crapcdb WHERE crapcdb.cdcooper = glb_cdcooper   AND 
        ...
        DISPLAY crapcdb.cdcmpchq  crapcdb.cdbanchq 
                crapcdb.cdagechq  crapcdb.nrddigc1
                crapcdb.nrctachq  crapcdb.nrddigc2
                crapcdb.nrcheque  crapcdb.nrddigc3
                crapcdb.vlcheque  crapcdb.nrseqdig
