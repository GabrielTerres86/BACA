/* .............................................................................
   ...
   Programa: Fontes/implis.p
   Sistema : Conta-Corrente - Cooperativa de Credito
   Sigla   : CRED
   Autor   : Odair
   Data    : Fevereiro/96.                   Ultima atualizacao: 12/09/2006

   Dados referentes ao programa:

   Frequencia: Diario (on-line)
   Objetivo  : Mostrar a tela IMPLIS.

   Alteracoes: 20/06/2000 - Nova tela IMPTAX (Odair)

               17/08/2000 - Novo item de Menu: etiquetas de jornal IMPETJ
                            (Deborah).
...
DEF        VAR cmd          AS CHAR    FORMAT "x(40)" EXTENT 4       NO-UNDO.
DEF        VAR proglist     AS CHAR    EXTENT 4                      NO-UNDO.
DEF        VAR cmdlist      AS CHAR    INIT "12"
                                                                     NO-UNDO.
DEF        VAR lastchoice   AS INT     INIT 1                        NO-UNDO.
DEF        VAR qgo          AS LOGICAL INIT FALSE                    NO-UNDO.

ASSIGN proglist[1]  = "IMPREL"
       proglist[2]  = "IMPRES"
       proglist[3]  = "IMPTAX"
       proglist[4]  = "IMPETJ"

       cmd[1]  = "1. IMPREL - Impressao Rel. do Sistema   "
       cmd[2]  = "2. IMPRES - Impressao de Extratos       "
       cmd[3]  = "3. IMPTAX - Impressao Taxas  Aplicacao  "
       cmd[4]  = "4. IMPETJ - Etiquetas Jornal CrediHering".

FORM SKIP(3)
     cmd[1]  FORMAT "x(40)" AT 21   SKIP(1)
     cmd[2]  FORMAT "x(40)" AT 21   SKIP(1)
     cmd[3]  FORMAT "x(40)" AT 21   SKIP(1)
     cmd[4]  FORMAT "x(40)" AT 21   SKIP(6) /* para moldura */
