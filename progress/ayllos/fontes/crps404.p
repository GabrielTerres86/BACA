...
/* ..........................................................................
   ...
   Alteracoes: 01/07/2005 - Alimentado campo cdcooper da tabela craplot 
               ...
               25/03/2015 - Conversão Progress >> Oracle (Jean Michel).
...
RUN STORED-PROCEDURE pc_crps404 aux_handproc = PROC-HANDLE
   (INPUT glb_cdcooper,
...
CLOSE STORED-PROCEDURE pc_crps404 WHERE PROC-HANDLE = aux_handproc.

{ includes/PLSQL_altera_session_depois.i &dboraayl={&scd_dboraayl} }

ASSIGN glb_cdcritic = 0
       glb_dscritic = ""
       glb_cdcritic = pc_crps404.pr_cdcritic WHEN pc_crps404.pr_cdcritic <> ?
       glb_dscritic = pc_crps404.pr_dscritic WHEN pc_crps404.pr_dscritic <> ?
       glb_stprogra = IF pc_crps404.pr_stprogra = 1 THEN TRUE ELSE FALSE
       glb_infimsol = IF pc_crps404.pr_infimsol = 1 THEN TRUE ELSE FALSE. 
