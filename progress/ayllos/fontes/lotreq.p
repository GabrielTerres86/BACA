...
FORM SKIP (1)
     ...
     SKIP (1)
     "Total de Requisicoes           :" AT 2
     craptrq.qtinforq AT 39 NO-LABEL AUTO-RETURN
     craptrq.qtcomprq AT 56 NO-LABEL
     tel_qtdiferq     AT 71 NO-LABEL
     SKIP (1)
...
DO WHILE TRUE:
        ...
        REPEAT ON ENDKEY UNDO, LEAVE:
               ...
               PROMPT-FOR glb_cddopcao tel_cdagelot tel_nrdolote 
                          WITH FRAME f_lotreq.
