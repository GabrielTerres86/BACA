/* ...........................................................................
   ...
   Alteracoes: 18/03/97 - Alterado para tratar FINANCIAMENTO COM HIPOTECA
               ...
               06/06/97 - Alterado para tratar novo layout dos contratos de
                          emprestimo (Edson).

               19/08/97 - Alterado para tratar nova regra para impressao da
                          proposta de emprestimo (Edson).

               25/06/97 - Alterado para emitir quantidade de promissorias
                          variavel (Edson).
               ...
               10/03/2000 - Alterado para tratar tabela de configuracao
                            de uso do numero de contrato de emprestimo
                            (Edson).

               08/06/2000 - Tratar emancipacao, nao mostrar idade (Odair)

               26/07/2000 - Tratar menor de 21 e nao de 18 (Odair)

                   03/08/2000 - Avisar quando precisa de seguro prestamista
                            (Deborah).
               ...
               28/05/2002 - Colocar como "OK" a flag de pendencias de seguro
                            para categorias dispensadas do seguro (Deborah).

               25/06/2002 - Buscar o salario do cadastro (Deborah)

               19/08/2002 - Buscar observacao de outro contrato (Margarete).

               18/09/2002 - Proposta obrigatoria para todos os contratos.
                            Liberado emprestimo com menos de 1 ano p/Rodeio
                            (Deborah).

               31/10/2002 - Criado tabela com contas que tem emprestimo
                            liberado antes do prazo minimo
                            Liberado emprestimo para pagamento em 29/12 - decimo
                            terceiro salario em 2002  (Deborah).
               ...
               17/01/2003 - Habilitar por default a impressao da nota promis-
                            soria (Deborah).
               ...
               28/10/2003 - Tratar nova numeracao de contratos (Edson).
               ...
               19/03/2004 - Acessar tab. parametros propostas  emprestimo a fim
                            de obter dias minimos p/abertura emprestimo(Mirtes)

               03/06/2004 - Tratar linha com carencia da Viacredi

               11/06/2004 -Incluido campo tel_nivcalcu(Risco Calculado(Evandro)
               ...
               26/08/2004 - Tratamento para linha de credito de consignacao
                            de emprestimo (Julio)
               ...
               01/03/2005 - Alterada critica 26 para 842(Mirtes)
               ...
               05/07/2005 - Alimentado campo cdcooper das tabelas crapavt e
                            crawepr (Diego).
               ...
               06/09/2005 - Liberar prazo minimo de socio para a CREDIFIESC
                            (Edson).
               ...
               03/04/2006 - Criticar se o novo contrato ja existe tambem na
                            microfilmagem (Magui).
              ...
              26/06/2007 - Criticar quantidade dia liberados linha nao
                           creditar em conta(Mirtes)
              12/09/2007 - Carencias para linhas de credito 4 e 5(Credelesc)
                           (Mirtes)
              ...
              10/04/2008 - Alterado o formato do campo "crawepr.qtpreemp" de
                           "9" para "zz9"
             ...
             15/05/2008 -  Nao efetuado chamada programa proepr_l.p - para
                           conta 594-0 - Concredi(Mirtes).
             ...
             25/06/2008 - Carencia 270 para linha 8 da Credicomin (Magui).
             ...
             28/07/2008 - Na Credifiesc carencia de 280 linha 4 (Magui).
             ...
             12/06/2009 - Preencher como default a variavel ali_tpchassi = 2
                          (Fernando).
             ...
             17/08/2009 - Padronizar o Prazo Minimo de Admissco para Concessao
                          de Credito (Ze).

             29/09/2009 - Arrumar atribuicao ao valor dos rendimentos na
                          crawepr (Gabriel).

             15/12/2009 - Ajuste para geracao do rating, incluir campo
                          Qualif. Operacao (Gabriel).
                        - Alterar inhabmen da crapass para crapttl(Guilherme).
                        - Grava campos do rating nas tabelas crapttl se pessoa
                          fisica ou na crapjur se pessoa juridica;
                        - Mostra valor da campo Qualif. Operacao
             ...
             01/06/2010 - Obter o risco a partir da BO 43 (Gabriel).
                          Carencia 60dd para linha 32 (Magui).

             01/07/2010 - Bloquear linhas de credito 700 701 702 703 para o PAC
                          5 da Creditextil - Migracao de PAC (Guilherme).

             21/07/2010 - Carencia de 190 dias, linha 30 Credifiesc(Magui).

             06/08/2010 - Projeto de melhorias de propostas (Gabriel).
             ...
             24/10/2012 - Incluir tratamento para chamar browse b-ge-epr,
                          Tratamento para mostrar frame f_ge_economico
                          Projeto GE (Lucas R.)

             28/03/2013 - Ajuste realizados:
                          - Retirado todas as chamadas da procedure
                            alerta_fraude;
                          - Ajuste no layout dos frames g_ge_epr,f_ge_economico
                           (Adriano).

             22/05/2013 - Alterações para GED Fase II (Lucas).

             27/06/2013 - Evitar passar na validacao do valida dados gerais
                          quando pressionado <F4> / END-ERROR (Gabriel).

             28/06/2013 - Abrir tela de liquidacoes dependendo da linha
                          de credito (Gabriel).

             08/01/2014 - Ajuste para desabilitar opcao "Imprimir" do campo
                          flgimpnp quando qtd de notas promissorias for 0.
                        - Mostrar formulario de avalistas mesmo quando for
                          "Nao Imprimir" de notas promissorias. (Jorge)
             ...
             17/07/2014 - Adicionado tratamento para novos campos inpessoa e
             ...
             12/09/2014 - Ajuste na procedure monta_registros_proposta. (James)

            18/11/2014 - Inclusao do parametro nrcpfope na
                         procedure "valida-dados-gerais". (Jaison)
                         
            16/12/2014 - Retirado a solicitaçãodo numero de contrato para tplcremp = 1
                         conforme solicitado no chamado 229867. (Jean Reddiga - RKAM)
                         
            20/01/2015 - Adicionado campo dstipbem "Tipo Veiculo".
            ...
            30/06/2015 - Projeto para Alterar forma de calculo de provisao.
                         (James)
...
ASSIGN tt-proposta-epr.dtdpagto = aux_dtdpagto.
...
DO WHILE TRUE ON ENDKEY UNDO, LEAVE:
   ...
   DO WHILE TRUE ON ENDKEY UNDO, LEAVE:
      ...
      UPDATE tt-proposta-epr.vlemprst
             tt-proposta-epr.qtpreemp             
             tt-proposta-epr.cdfinemp
             tt-proposta-epr.cdlcremp
             tt-proposta-epr.qtdialib
             tt-proposta-epr.flgpagto
             tt-proposta-epr.dtdpagto
             tt-proposta-epr.flgimppr
             tt-proposta-epr.flgimpnp WHEN tt-proposta-epr.qtpromis <> 0
             WITH FRAME f_proepr
...
IF   FRAME-FIELD = "cdfinemp"  THEN
            ...
            DO:
                ...
                IF   NOT tt-dados-assoc.flgpagto   AND
                     ...
                     DO:
                         ...
                         DISPLAY tt-proposta-epr.flgpagto WITH FRAME f_proepr.
                     END.
            ...
            DO:
                IF   INPUT tt-proposta-epr.vlemprst >
                     ...
                     DO:
                         ...
                         DISPLAY tt-proposta-epr.flgimppr WITH FRAME f_proepr.
      ...
      DO WHILE TRUE ON ENDKEY UNDO,LEAVE:
        ...
        DISP tt-proposta-epr.vlpreemp WITH FRAME f_proepr.
        ...
        RUN calcula_cet_novo IN h-b1wgen0002(
         ...
         DISP tt-proposta-epr.percetop WITH FRAME f_proepr.

         LEAVE.

      END. /* Fim DO WHILE TRUE , validacao */
      ...
      DISPLAY tt-proposta-epr.vlpreemp
              tt-proposta-epr.dslcremp
              tt-proposta-epr.dsfinemp WITH FRAME f_proepr.
      ...
      RUN Obrigacao_Consulta IN h-b1wgen0191 (INPUT glb_cdcooper,
                                              INPUT 1,
      ...
      IF   CAN-DO("N,C",aux_inobriga)  THEN
           DO:
      ...
      DO WHILE TRUE ON ENDKEY UNDO, LEAVE:
         ...
         ASSIGN aux_nrctrobs = 0.

         MESSAGE COLOR NORMAL "   Copiar observacao do contrato numero: "
                 UPDATE aux_nrctrobs.

         IF   aux_nrctrobs <> 0   THEN
              DO:
                  RUN sistema/generico/procedures/b1wgen0002.p
                      PERSISTENT SET h-b1wgen0002.

                  tt-proposta-epr.dsobserv = DYNAMIC-FUNCTION("trazObservacao"
                                                              IN h-b1wgen0002 ,
                         ...
                         DO:
                             ...
                             IF   NOT CAN-FIND
                                 (tt-bens-alienacao WHERE
                                  tt-bens-alienacao.idalibem = aux_contador + 1)  THEN
      ...
      DO WHILE TRUE ON ENDKEY UNDO, LEAVE:
         ...
         RUN verifica-outras-propostas IN h-b1wgen0002
                                     (INPUT glb_cdcooper,
                                      ...
                                      INPUT glb_dtmvtopr,
                                      INPUT tt-proposta-epr.vlemprst,
                                      INPUT 0, /* Nao existe valor anterior*/
         ...
         IF  RETURN-VALUE <> "OK"  THEN
             DO:
                 ...
                 ELSE
                     glb_dscritic = "Erro no carregamento do " +
                                    "Grupo Economico.".
         ...
         IF TEMP-TABLE tt-grupo:HAS-RECORDS THEN
            DO:
                ...
                DO WHILE TRUE ON ENDKEY UNDO, LEAVE:
                   ...
                   OPEN QUERY q-ge-epr FOR EACH tt-grupo NO-LOCK.
...
RUN grava-proposta-completa IN h-b1wgen0002
                               (INPUT glb_cdcooper,
                                ...
                                INPUT glb_dtmvtolt,
                                INPUT tt-rendimento.inpessoa,
                                INPUT tt-proposta-epr.nrctremp, /* Contrato */
                                INPUT 0, /* Tipo Empréstimo */
                                INPUT tt-dados-coope.flgcmtlc,  /* Com.Local*/
                                INPUT par_vlutiliz,
                                INPUT tt-dados-coope.vllimapv,
                                INPUT "I", /* Inclusao */
                                INPUT tt-proposta-epr.vlemprst,
                                INPUT 0, /* sem valor prestacao anterior*/
                                INPUT tt-proposta-epr.vlpreemp,
                                INPUT tt-proposta-epr.qtpreemp,
...
IF   RETURN-VALUE <> "OK"   THEN
     DO:
         ...
         IF   AVAIL tt-erro   THEN
              MESSAGE tt-erro.dscritic.
         ELSE
              MESSAGE "Erro na inclusao da proposta de emprestimo.".
                        ...
                        EDITING:
                            ...
                            IF  LASTKEY = KEYCODE("F7")  THEN
                                DO:
                                    ...
                                    tt-interv-anuentes.dsnacion = shr_dsnacion.

                                    DISPLAY tt-interv-anuentes.dsnacion
                                            WITH FRAME f_interveniente.
...
PROCEDURE Valida_Interv:
    ...
    DO WITH FRAME f_interveniente:
        ASSIGN tt-interv-anuentes.nrctaava
