/* .............................................................................
   ...
   Objetivo  : Processar a rotina de alteracao da tela LANPLA.

   Alteracoes: 21/03/95 - Alterado para corrigir rombo da tela. Nao estava
                          atualizando o crapcot.vldcotas (Edson).
   ...
   DO TRANSACTION:
      ...
      IF   glb_cdcritic = 0   THEN
           DO WHILE TRUE:
              ...
              /*FIND crapcot OF craplct EXCLUSIVE-LOCK NO-ERROR NO-WAIT.*/
      ...
      DO WHILE TRUE ON ENDKEY UNDO, LEAVE:
         ...
         SET tel_vllanmto WITH FRAME f_lanpla
         ...
         IF   tel_vllanmto = 0   THEN
              DO:
                  glb_cdcritic = 91.
                  NEXT-PROMPT tel_vllanmto WITH FRAME f_lanpla.
              END.
      ...
      IF   aux_vllanmto <> tel_vllanmto   THEN
           ASSIGN craplot.vlcompcr = craplot.vlcompcr -
                                             aux_vllanmto + tel_vllanmto
                  crappla.vlprepag = crappla.vlprepag -
                                             aux_vllanmto + tel_vllanmto
                  crappla.vlpagmes = crappla.vlpagmes -
                                             aux_vllanmto + tel_vllanmto
