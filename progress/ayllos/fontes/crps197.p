/* ..........................................................................
   ...
   Programa: Fontes/crps197.p
   Sistema : Conta-Corrente - Cooperativa de Credito
   Sigla   : CRED
   Autor   : Edson
   Data    : Maio/97                          Ultima atualizacao: 20/02/2019
...
RUN STORED-PROCEDURE pc_crps197 aux_handproc = PROC-HANDLE
   (INPUT glb_cdcooper,                                                  
...
CLOSE STORED-PROCEDURE pc_crps197 WHERE PROC-HANDLE = aux_handproc.

{ includes/PLSQL_altera_session_depois.i &dboraayl={&scd_dboraayl} }

ASSIGN glb_cdcritic = 0                           
       glb_dscritic = ""
       glb_cdcritic = pc_crps197.pr_cdcritic WHEN pc_crps197.pr_cdcritic <> ?
       glb_dscritic = pc_crps197.pr_dscritic WHEN pc_crps197.pr_dscritic <> ?
       glb_stprogra = IF pc_crps197.pr_stprogra = 1 THEN TRUE ELSE FALSE
       glb_infimsol = IF pc_crps197.pr_infimsol = 1 THEN TRUE ELSE FALSE. 
