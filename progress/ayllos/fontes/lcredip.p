/* .............................................................................
   ...
   Objetivo  : Processar a rotina de consulta de prestacoes da tela LCREDI.
   ...
   Alteracoes: 14/10/94 - Alterado para inclusao de novos parametros para as
             ...
             30/06/2004 - Tratamento para tipo de desconto de emprestimo
                          (Julio)
             ...
             24/06/2009 - Incuido campo Operacao (Gabriel).
             ...
             09/10/2012 - Incluir campos de modalidade e submodalidades
                          (Gabriel).  
...
DO aux_qtpresta = tel_nrinipre TO tel_nrfimpre:
   /* Busca coeficiente da tabela crapccp */
   FIND FIRST crapccp WHERE crapccp.cdcooper = craplcr.cdcooper AND
                            crapccp.cdlcremp = craplcr.cdlcremp AND
                            crapccp.nrparcel = aux_qtpresta NO-LOCK NO-ERROR.

   IF   AVAIL crapccp THEN 
        DO: 
            ASSIGN aux_contador = aux_contador + 1
                   tel_dsindice = tel_dsindice + STRING(aux_qtpresta,"zz9") + "  " +
                                                 STRING(crapccp.incalpre,
                                                               "9.999999") + "    ".
                
            IF   aux_contador = 4              OR
                 aux_qtpresta = tel_nrfimpre   THEN
                 DO:
                     aux_contalin = aux_contalin + 1.
                 
                     DISPLAY tel_dsindice WITH FRAME f_presta.
                 
                     IF   aux_contalin = 8   THEN
                          DO WHILE TRUE ON ENDKEY UNDO, LEAVE INDICES:
                     ...
                     ELSE
                          DOWN WITH FRAME f_presta.
                 
                     IF   aux_qtpresta = tel_nrfimpre   THEN
                          LEAVE.
   ...
   ELSE 
        DO:
            MESSAGE "Coeficiente de prestacao nao calculado para este limite!".
            LEAVE.
        END.
END.  /*  Fim do DO .. TO - Indices de prestacoes  */
