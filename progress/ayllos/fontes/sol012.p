/* .............................................................................
   ...
   Objetivo  : Mostrar a tela SOL012.
...
DEF        VAR aux_nrsolici AS INT     FORMAT "z9" INIT 12           NO-UNDO.
...
FORM SKIP (4)
     ...
     WITH ROW 4 COLUMN 1 OVERLAY TITLE COLOR MESSAGE tel_dstitulo
          SIDE-LABELS NO-ATTR-SPACE WIDTH 80 FRAME f_sol012.

glb_cddopcao = "I".

FIND craprel WHERE craprel.cdcooper = glb_cdcooper  AND
                   craprel.cdrelato = 22            NO-LOCK NO-ERROR.
...
DO WHILE TRUE:
        ...
        DISPLAY glb_cddopcao WITH FRAME f_sol012.
        NEXT-PROMPT tel_nrseqsol WITH FRAME f_sol012.

        DO WHILE TRUE ON ENDKEY UNDO, LEAVE:

           PROMPT-FOR glb_cddopcao tel_nrseqsol WITH FRAME f_sol012.
           LEAVE.
        ...
        IF   KEYFUNCTION(LASTKEY) = "END-ERROR"   THEN     /*   F4 OU FIM   */
             DO:
                 ...
                 IF   CAPS(glb_nmdatela) <> "SOL012"   THEN
                      DO:
                          HIDE FRAME f_sol012.
                          RETURN.
                      END.
                 ...
                 DO TRANSACTION ON ENDKEY UNDO, LEAVE:
                    ...
                    IF   aux_contador <> 0   THEN
                         DO:
                             ...
                             DISPLAY tel_nrseqsol WITH FRAME f_sol012.
                             NEXT.
                         END.

                    ASSIGN tel_nrdevias = crapsol.nrdevias.

                    DISPLAY tel_nrdevias WITH FRAME f_sol012.

                    DO WHILE TRUE:

                       SET  tel_nrdevias WITH FRAME f_sol012.
