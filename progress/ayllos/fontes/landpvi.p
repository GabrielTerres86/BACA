                  ...
                  IF   NOT AVAILABLE crablot   THEN
                       IF   LOCKED crablot   THEN
                            DO:
                                ...
                                ASSIGN aux_dadosusr = 
                                "077.1 - Tabela sendo alterada p/ outro terminal.".
                                ...
                                ASSIGN aux_dadosusr = "Operador.1: " + par_loginusr +
                                                          " - " + par_nmusuari + ".".
                       ...
                       IF aux_indebcre = "D" THEN
                          DO:
                             ...
                             IF tel_vllanmto > aux_vlsddisp THEN
                                DO:
                                    MESSAGE "Valor insuficiente para pagamento. Saldo disponivel: " +
                                             STRING(aux_vlsddisp,"zzz,zzz,zz9.99-").
                                    PAUSE.
                                    NEXT-PROMPT tel_vllanmto WITH FRAME f_landpv.
                                    UNDO, NEXT INICIO.
                                END.
       ...
       IF   NOT AVAIL  crablot   THEN
            IF  LOCKED crablot   THEN
                DO:
                    ...
                    ASSIGN aux_dadosusr = 
                    "077.2 - Tabela sendo alterada p/ outro terminal.".
                    ...
                    ASSIGN aux_dadosusr = "Operador.2: " + par_loginusr +
                                  " - " + par_nmusuari + ".".
       ...
       IF   NOT AVAIL  crablot   THEN
            IF  LOCKED crablot   THEN
                DO:
                    ...
                    ASSIGN aux_dadosusr = 
                    "077.3 - Tabela sendo alterada p/ outro terminal.".
                    ...
                    ASSIGN aux_dadosusr = "Operador.3: " + par_loginusr +
                                  " - " + par_nmusuari + ".".
