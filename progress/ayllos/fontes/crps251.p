...
RUN STORED-PROCEDURE pc_crps251 aux_handproc = PROC-HANDLE
   (INPUT glb_cdcooper,
...
CLOSE STORED-PROCEDURE pc_crps251 WHERE PROC-HANDLE = aux_handproc.

{ includes/PLSQL_altera_session_depois.i &dboraayl={&scd_dboraayl} }

ASSIGN glb_cdcritic = 0                           
       glb_dscritic = ""
       glb_cdcritic = pc_crps251.pr_cdcritic WHEN pc_crps251.pr_cdcritic <> ?
       glb_dscritic = pc_crps251.pr_dscritic WHEN pc_crps251.pr_dscritic <> ?
       glb_stprogra = IF pc_crps251.pr_stprogra = 1 THEN TRUE ELSE FALSE
       glb_infimsol = IF pc_crps251.pr_infimsol = 1 THEN TRUE ELSE FALSE. 
