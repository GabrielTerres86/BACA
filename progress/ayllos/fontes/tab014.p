/* .............................................................................
   ...
   Objetivo  : Mostrar a tela TAB014.
...
DEF        VAR aux_vltar105 AS DECIMAL FORMAT "zzz,zzz,zz9.99"       NO-UNDO.
...
FORM SKIP (3)
     ...
     SKIP(2)
     aux_vltar105 AT 05 LABEL "Valor da tarifa de credito de ferias"
                  HELP "Entre com o valor da tarifa para essa empresa."
     WITH ROW 6 COLUMN 2 OVERLAY SIDE-LABELS NO-BOX FRAME f_tab014.
...
DO WHILE TRUE:
        ...
        DISPLAY glb_cddopcao WITH FRAME f_tab014.

        NEXT-PROMPT aux_cdempres WITH FRAME f_tab014.
        ...
        IF   KEYFUNCTION(LASTKEY) = "END-ERROR"   THEN     /*   F4 OU FIM   */
             DO:
                 ...
                 IF   CAPS(glb_nmdatela) <> "tab014"   THEN
                      DO:
                          HIDE FRAME f_tab014.
                 ...
                 DO TRANSACTION ON ENDKEY UNDO, LEAVE:
                    ...
                    DO  aux_contador = 1 TO 10:
                        ...
                        FIND craptab WHERE craptab.cdcooper = glb_cdcooper   AND
                                           ...
                                           craptab.cdacesso = "VLTARIF105"   AND
                   ...
                   aux_vltar105 = DECIMAL(craptab.dstextab).

                   DISPLAY aux_dsempres aux_vltar105  WITH FRAME f_tab014.

                   DO WHILE TRUE:

                      UPDATE aux_vltar105 WITH FRAME f_tab014.
                      craptab.dstextab = STRING(aux_vltar105,"999999999.99").
                      LEAVE.
        ...
        IF   INPUT glb_cddopcao = "C" THEN
             DO:
                 ...
                 IF   AVAILABLE craptab   THEN
                      DO:
                          ASSIGN aux_vltar105 = DECIMAL(craptab.dstextab).
