/* .............................................................................
   ...
   Objetivo  : Mostrar a tela sol023.
   ...
   Alteracoes: 05/07/94 - Alterado para eliminar o tipo de debito e o valor
               ...
               22/05/95 - Alterado para na hora da solicitacao verificar se a
                          empresa posssui debito automatico ou nao. (Odair).
...
DEF        VAR aux_nrsolici AS INT     INIT 23                       NO-UNDO.

FORM SPACE(1) WITH ROW 4 COLUMN 1 OVERLAY 16 DOWN WIDTH 80
                   TITLE COLOR MESSAGE " Geracao dos Debitos de Capital "
                   FRAME f_moldura.
...
FORM SKIP(1)
     ...
     WITH ROW 6 COLUMN 2 OVERLAY SIDE-LABELS NO-BOX FRAME f_sol023.
...
DO WHILE TRUE:
   ...
   NEXT-PROMPT tel_nrseqsol WITH FRAME f_sol023.

   DO WHILE TRUE ON ENDKEY UNDO, LEAVE:

      UPDATE glb_cddopcao tel_nrseqsol WITH FRAME f_sol023.
      LEAVE.
   ...
   IF   KEYFUNCTION(LASTKEY) = "END-ERROR"   THEN     /*   F4 OU FIM   */
        DO:
            ...
            IF   CAPS(glb_nmdatela) <> "sol023"   THEN
                 DO:
                     HIDE FRAME f_sol023.
        ...
        DO:
            DO TRANSACTION ON ENDKEY UNDO, LEAVE:
               ...
               DISPLAY tel_cdempres tel_dsempres tel_intipsai tel_dstipsai
                       ...
                       tel_cdcalcul WITH FRAME f_sol023.
               ...
               DO WHILE TRUE:
                  ...
                  UPDATE tel_cdempres tel_cdcalcul tel_intipsai tel_nrdevias
                         tel_inexecut WITH FRAME f_sol023.
                  ...
                  IF   (tel_intipsai = 1 AND tel_nrdevias > 0) OR
                       ...
                       DO:
                           glb_cdcritic = 119.
                           NEXT-PROMPT tel_nrdevias WITH FRAME f_sol023.
                           NEXT.
                       END.
   ...
   IF   glb_cddopcao = "I"   THEN
        DO:
            ...
            CLEAR FRAME f_sol023 NO-PAUSE.
            DISPLAY glb_cddopcao tel_nrseqsol WITH FRAME f_sol023.
