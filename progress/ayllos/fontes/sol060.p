/* .............................................................................
   ...
   Programa: Fontes/sol060.p
   Sistema : Conta-Corrente - Cooperativa de Credito
   Sigla   : CRED
   Autor   : Odair
   Data    : Abril/95                            Ultima atualizacao: 02/02/2006

   Dados referentes ao programa:

   Frequencia: Diario (on-line)
   Objetivo  : Mostrar a tela SOL060 que faz a manutencao das solicitacoes do
               resumo de pagamentos e liberacoes de emprestimos.
...
DEF        VAR aux_nrsolici AS INT     FORMAT "zz9" INIT 060         NO-UNDO.
...
DO WHILE TRUE:
   ...
   NEXT-PROMPT tel_nrseqsol WITH FRAME f_sol060.

   DO WHILE TRUE ON ENDKEY UNDO, LEAVE:

      UPDATE glb_cddopcao tel_nrseqsol WITH FRAME f_sol060.
   ...
   IF   KEYFUNCTION(LASTKEY) = "END-ERROR"   THEN     /*   F4 OU FIM   */
        DO:
            ...
            IF   CAPS(glb_nmdatela) <> "SOL060" THEN
                 DO:
                     HIDE FRAME f_sol060.
                     RETURN.
                 END.
   ...
   IF   glb_cddopcao = "A"   THEN
        DO:
            DO TRANSACTION ON ERROR UNDO, LEAVE:
               ...
               DISPLAY tel_dtmesano  tel_dssitsol    WITH FRAME f_sol060.
               ...
               DO WHILE TRUE ON ENDKEY UNDO, LEAVE:
                  ...
                  UPDATE tel_dtmesano  WITH FRAME f_sol060.
                  ...
                  IF   MONTH(glb_dtmvtolt) = 1 THEN
                         aux_dtmvtolt = DATE(12, 1, YEAR(glb_dtmvtolt) - 1).
                  ELSE
                         aux_dtmvtolt = DATE(MONTH(glb_dtmvtolt) - 1,1,
                                             YEAR(glb_dtmvtolt)).

                  aux_dtgerref = DATE(aux_dtmesref,aux_dtdiaref,
                                             aux_dtanoref).

                  IF   (aux_dtgerref < aux_dtmvtolt)        OR
                       (aux_dtgerref > glb_dtmvtolt)        THEN
                       DO:
                          glb_cdcritic = 13.
                          NEXT.
                       END.
