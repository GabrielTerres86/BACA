/* .............................................................................
   ...
   Objetivo  : Processar a rotina de inclusao da tela LANPLA.
...
DEF SHARED VAR aux_nrmesant AS INT                                      NO-UNDO.
...
DO WHILE TRUE:
   ...
   DO TRANSACTION:
                    ...
                    IF   glb_cdcritic = 0   THEN
                         DO:
                             ...
                             FOR EACH crappla WHERE 
                                 ...
                                 IF   crappla.cdsitpla = 2   THEN
                                      IF   MONTH(crapass.dtdemiss) =
                                                 MONTH(tel_dtmvtolt) OR
                                           MONTH(crapass.dtdemiss) =
                                                 aux_nrmesant      THEN
                                           glb_cdcritic = 0.
                                      ELSE
                                           DO:
                                 ...
                                 IF   crappla.dtinipla > tel_dtmvtolt   THEN
                                      glb_cdcritic = 207.
                                 ELSE
                                 /*
                                 IF   crappla.vlprepla <> tel_vllanmto   THEN
                                      DO:
                                          glb_cdcritic = 208.
                                 ...
                                 ELSE
                                 */
                                 IF   crappla.qtpremin = crappla.qtpremax   THEN
                                      glb_cdcritic = 209.
                                 ELSE
                                 IF   crappla.dtultpag = 01/01/0001   THEN
                                      aux_flgsomar = TRUE.
                                 ELSE
                                 IF   MONTH(glb_dtmvtolt) =
                                            MONTH(crappla.dtultpag) THEN
                                      aux_flgsomar = TRUE.
                                 ELSE
                                      aux_flgsomar = FALSE.
      ...
      CREATE craplct.
      ASSIGN craplct.dtmvtolt = tel_dtmvtolt
             ...
             crappla.vlpagmes = IF aux_flgsomar
                                   THEN crappla.vlpagmes + tel_vllanmto
                                   ELSE tel_vllanmto
             crappla.dtultpag = tel_dtmvtolt
