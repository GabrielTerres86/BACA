        ...
        DO WHILE TRUE ON ERROR UNDO, RETURN:
           ...
           IF   aux_flgestou   THEN
                DO:
                    ...
                    ASSIGN aux_dtexecde = aux_dtintegr + 1.
                    
                    /* Se o dia da dtintegr for anterior ao dia limite para debitos */
                    IF   DAY(aux_dtexecde) <= crapemp.dtlimdeb   THEN
                         DO:
						    /* Montar data com base no dia de corte + mes e ano da dtexecde */
							aux_dtexecde = date(month(aux_dtexecde),crapemp.dtlimdeb,year(aux_dtexecde)).
                            ...
                            RUN STORED-PROCEDURE pc_valida_dia_util
                              aux_handproc = PROC-HANDLE NO-ERROR
                                            ...
                                            ,INPUT-OUTPUT aux_dtexecde  /* pr_dtmvtolt */
                                            ,INPUT "P"                  /* pr_tipo */
