/* .............................................................................
   ...
   Objetivo  : Rotina para tratamento da alteracao da poupanca programada.

   Alteracoes: 15/04/98 - Tratamento para milenio e troca para V8 (Margarete).
   
               16/11/00 - Alterar nrdolote p/6 posicoes (Margarete/Planner).

               16/06/2003 - Critica de valor maximo permitido (Margarete).

               16/09/2004 - Alterado alinhamento dos campos e incluida exibicao
                            dos campos CI e Resgate (Evandro).

               05/07/2005 - Alimentado campo cdcooper da tabela crawrpp (Diego).

               31/01/2006 - Unificacao dos Bancos - SQLWorks - Fernando. 
               
               22/04/2008 - Vencimento de poupanca programada (Guilherme).
               
               27/04/2010 - Utilizar browse dinamico. 
                            Adaptado para usar a BO b1wgen0006 (Gabriel).
...
DO WHILE TRUE:
   ...
   RUN obtem-dados-alteracao IN h-b1wgen0006 (INPUT glb_cdcooper,
                                              INPUT 0,
                                              INPUT 0,
                                              INPUT glb_cdoperad,
                                              INPUT glb_nmdatela,
   ...
   DO WHILE TRUE ON ENDKEY UNDO, LEAVE:
      ...
      UPDATE tel_vlprerpp WITH FRAME f_rdcapp.
           
      RUN sistema/generico/procedures/b1wgen0006.p
                           PERSISTENT SET h-b1wgen0006.

      RUN validar-dados-alteracao IN h-b1wgen0006 (INPUT glb_cdcooper,
                                                   INPUT 0,
                                                   INPUT 0,
                                                   INPUT glb_cdoperad,
                                                   INPUT glb_nmdatela,
   ...
   RUN alterar-poupanca-programada IN h-b1wgen0006 (INPUT glb_cdcooper,
                                                    INPUT 0,
                                                    INPUT 0,
                                                    INPUT glb_cdoperad,
                                                    INPUT glb_nmdatela,
