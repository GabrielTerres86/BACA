/* ..........................................................................
   ...
   Programa: Fontes/lislot_4.p
   Sistema : Conta-Corrente - Cooperativa de Credito
   Sigla   : CRED
   Autor   : James Prust Junior
   Data    : Agosto/2012                      Ultima atualizacao: 25/06/2014
   ...
   Alteracoes: 05/11/2013 - Incluido o historico 889 para listar no relatorio
                            "LOTE P/PA". (James)
                            
               14/01/2014 - Ajuste leitura craplcm (Daniel).  
               
               28/03/2014 - Adaptado para a B1wgen0184.p - JÈssica Laverde (DB1)     
...
DEF   VAR tot_vlpalcto   AS DEC   INIT 0                             NO-UNDO.
DEF   VAR tot_vllanmto   AS DEC   INIT 0                             NO-UNDO.
DEF   VAR tot_registro   AS INT   INIT 0                             NO-UNDO.
...
/* Variaveis impressao do Arquivo  */
...
IF par_cddopcao = "T" THEN
   RUN lislot_terminal(INPUT par_cdhistor,
                       INPUT par_dtinicio,
                       INPUT par_dttermin).
ELSE
   IF par_cddopcao = "I" THEN
      RUN gera_impressao_lislot(INPUT par_cdhistor,
                                INPUT par_dtinicio,
                                INPUT par_dttermin).
...
PROCEDURE lislot_terminal.
   ...
   DEF QUERY q-historico FOR tt-craplcm.
   
   DEF BROWSE b-historico QUERY q-historico
       DISPLAY tt-craplcm.dtmvtolt COLUMN-LABEL "Data"
               tt-craplcm.cdagenci COLUMN-LABEL "PA"
               tt-craplcm.nrdconta COLUMN-LABEL "Conta/Dv."
               tt-craplcm.cdbccxlt COLUMN-LABEL "Banco/Caixa"  FORMAT "zz9"
               tt-craplcm.nrdolote COLUMN-LABEL "Lote"         FORMAT "zzz,zz9"
               tt-craplcm.vllanmto COLUMN-LABEL "Valor"        
                                   FORMAT "zzz,zzz,zzz,zz9.99"
               tt-craplcm.cdhistor COLUMN-LABEL "Historico"    FORMAT "zzz9"
               WITH WIDTH 78 5 DOWN SCROLLBAR-VERTICAL.

   FORM b-historico HELP "Use as SETAS para navegar ou <F4> para sair." 
        SKIP
...
/***********************************************************************************
Gera impressao das informacoes consultadas na tela lislot referente ao lotep/pa
***********************************************************************************/
PROCEDURE gera_impressao_lislot.
   ...
   FORM "Diretorio:   "     AT 5
        ...
        WITH FRAME f_diretorio OVERLAY ROW 10 NO-LABEL NO-BOX COLUMN 2.
...
/* -------------------------------------------------------------------------- */
/*                      EFETUA A IMPRESS„O DOS HISTORICOS                     */
/* -------------------------------------------------------------------------- */
