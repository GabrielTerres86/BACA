/* .............................................................................
   ...
   Objetivo  : Mostrar a tela SOL011.
   
   Alteracoes: 05/07/2005 - Alimentado campo cdcooper da tabela crapsol (Diego).

               01/01/2006 - Unificacao dos Bancos - SQLWorks - Fernando.
............................................................................. */
...
DEF        VAR aux_nrsolici AS INT     FORMAT "z9" INIT 11           NO-UNDO.
...
FORM SKIP (4)
     ...
     WITH ROW 4 COLUMN 1 OVERLAY TITLE COLOR MESSAGE tel_dstitulo
          SIDE-LABELS NO-ATTR-SPACE WIDTH 80 FRAME f_sol011.

glb_cddopcao = "I".

FIND craprel WHERE craprel.cdcooper = glb_cdcooper  AND 
                   craprel.cdrelato = 21            NO-LOCK NO-ERROR.
...
DO WHILE TRUE:
        ...
        DISPLAY glb_cddopcao WITH FRAME f_sol011.
        NEXT-PROMPT tel_nrseqsol WITH FRAME f_sol011.

        DO WHILE TRUE ON ENDKEY UNDO, LEAVE:

           PROMPT-FOR glb_cddopcao tel_nrseqsol WITH FRAME f_sol011.
           LEAVE.
        ...
        IF   KEYFUNCTION(LASTKEY) = "END-ERROR"   THEN     /*   F4 OU FIM   */
             DO:
                 ...
                 IF   CAPS(glb_nmdatela) <> "SOL011"   THEN
                      DO:
                          HIDE FRAME f_sol011.
                          RETURN.
                      END.
                 ...
                 DO TRANSACTION ON ENDKEY UNDO, LEAVE:
                    ...
                    IF   aux_contador <> 0   THEN
                         DO:
                             ...
                             DISPLAY tel_nrseqsol WITH FRAME f_sol011.
                             NEXT.
                         END.

                    ASSIGN tel_nrdevias = crapsol.nrdevias.

                    DISPLAY tel_nrdevias WITH FRAME f_sol011.

                    DO WHILE TRUE:

                       SET  tel_nrdevias WITH FRAME f_sol011.
