/* Define as variaveis compartilhas para fontes/aplrda.p */
...
DEFINE {1} SHARED VARIABLE s_chlist   AS CHARACTER EXTENT 500        NO-UNDO.
DEFINE {1} SHARED VARIABLE s_choice   AS INTEGER   EXTENT 50         NO-UNDO.
