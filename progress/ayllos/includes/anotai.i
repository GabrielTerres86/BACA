...
DO WHILE TRUE:
        ...
        DO:
            ...
            IF  RETURN-VALUE = "NOK"  THEN
                DO:
                    ...
                    HIDE FRAME f_observacoes NO-PAUSE.
    ...
    ELSE
        DO:
            ...
            ASSIGN btn-incluir:HIDDEN  = FALSE
                   btn-visualiz:HIDDEN = TRUE
                   btn-imprimir:HIDDEN = TRUE.
            ...
            DO WHILE TRUE ON ENDKEY UNDO, LEAVE:
                UPDATE anota-b btn-incluir btn-sair WITH FRAME f_anotacoes. 
                LEAVE.
            END.
