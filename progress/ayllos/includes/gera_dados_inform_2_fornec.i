/* ...........................................................................
   ...
   Programa: includes/gera_dados_inform_2_fornec.i
   Sistema : Conta-Corrente - Cooperativa de Credito
   Sigla   : CRED
   Autor   : Julio
   Data    : Setembro/2006                     Ultima atualizacao: 10/12/2013
   ...
   Alteracoes: 03/01/2007 - Quebrar arquivo em varios quando for muito grande,
               ...
               07/02/2008 - Incluido campo cratext.complend para Cartas (Diego).
   
               27/03/2008 - Contabilizar quantidade de documentos em cada
                            arquivo e criar registro em gndcimp (Gabriel).
                            
               04/03/2009 - Nao contabilizar o documento criado somente para
                            completar a folha (lado direito zerado) (Evandro).
                            
               25/08/2009 - Alterado o nome da includes para 
                            gera_dados_informa_2_fornec (Fernando).
...
FOR EACH cratext WHERE cratext.dsladopg = "E" NO-LOCK BY cratext.nrpagina:
    ...
    IF   cratext.indespac = 1   THEN /***** CORREIO *******/
         DO:
            PUT STREAM str_1 
                       cratext.nmprimtl                FORMAT "x(51)" SKIP
    ...
    IF   cratext_dir.indespac = 1   THEN /* CORREIO */
         DO:
            PUT STREAM str_1 
                       cratext_dir.nmprimtl           FORMAT "x(51)"       SKIP
                       cratext_dir.dsender1           FORMAT "x(50)"       SKIP
                       "COMPLEMENTO:" cratext_dir.complend 
                                                      FORMAT "x(50)"       SKIP
    ...
    ELSE     
         DO: /******** SECAO ***********/
            PUT STREAM str_1 cratext_dir.nmempres         FORMAT "x(20)"
                             ...
                             FORMAT "x(10)"                               SKIP
                             FILL(" ", 50)                                SKIP
                             STRING(cratext_dir.nmprimtl,"x(47)") 
                             FORMAT "x(47)"                               SKIP
                             "EMISSAO:" 
                             STRING(cratext_dir.dtemissa, "99/99/9999")   
                             FORMAT "x(10)"                               SKIP
    ...
    /* Nao contabiliza o documento criado somente para completar a folha
       (lado direito zerado) */
    IF   cratext_dir.dsintern[1] = "#"   THEN
         aux_numberdc = aux_numberdc + 1.
    ELSE
         aux_numberdc = aux_numberdc + 2.
