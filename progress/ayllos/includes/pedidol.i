/* .............................................................................
   ...
   Objetivo  : Processar a rotina de liberacao da tela PEDIDO.

   Alteracoes: 03/04/98 - Tratamento para milenio e troca para V8 (Margarete).
   
               28/06/99 - Criar tabela para pedidos roubados e nao mostrar na 
                          tela (Odair)
...
DO WHILE TRUE ON ENDKEY UNDO, LEAVE:
           ...
           DO:  
               ...
               FOR EACH crapfdc WHERE crapfdc.cdcooper = glb_cdcooper    AND
                                      ...
                                      BREAK BY crapfdc.nrdctitg 
                                               BY crapfdc.nrseqems                                                               BY crapfdc.nrcheque:
   ...
   OUTPUT STREAM str_1 TO arq/pedido.lib.
   ...
   FOR EACH crapfdc WHERE crapfdc.cdcooper = glb_cdcooper   AND
       ...
       IF   crapfdc.dtemschq = ?   AND
            crapfdc.dtretchq = ?   THEN
            DO:
                ASSIGN crapfdc.dtemschq = glb_dtmvtolt
                       aux_ctpsqitg = crapfdc.nrdctabb.
       ...
       IF   aux_contatal > 9   THEN
            DO:
                ...
                MESSAGE COLOR NORMAL "Aguarde...Liberando talao" aux_qtlibblq
                                     "de" crapped.nrfinchq "...".
                aux_contatal = 0.
            END.
   ...
   FOR EACH crapped WHERE crapped.cdcooper = glb_cdcooper   AND
       ...
       ASSIGN crapped.dtrecped = glb_dtmvtolt
              crapped.insitped = 1.
    ...
    ELSE 
         DO:
             ...
             ELSE 
                  DO:       
                      CREATE crapcch.
                      ASSIGN crapcch.dtmvtolt = glb_dtmvtolt
                             crapcch.nrdconta = crapfdc.nrdconta
                             crapcch.nrdctabb = crapfdc.nrdctabb
                             crapcch.nrdctitg = crapfdc.nrdctitg
                             crapcch.nrtalchq = crapfdc.nrseqems
                             crapcch.cdhistor = 0
                             crapcch.nrchqini = aux_nrchqini
                             crapcch.nrchqfim = aux_nrchqfim
                             crapcch.tpopelcm = "1" /*inc*/
                             crapcch.cdcooper = glb_cdcooper
                             crapcch.cdbanchq = crapfdc.cdbanchq
                             crapcch.cdagechq = crapfdc.cdagechq
                             crapcch.nrctachq = crapfdc.nrctachq.
                  END.
...
PROCEDURE proc_le_cch.

    aux_nrchqfim = INT(STRING(crapfdc.nrcheque) + STRING(crapfdc.nrdigchq)).
