/* .............................................................................
   ...
   Programa: Includes/riscoa.i
   Sistema : Conta-Corrente - Cooperativa de Credito
   Sigla   : CRED
   Autor   : Margarete
   Data    : Junho/2001                      Ultima Atualizacao: 22/10/2008

   Dados referentes ao programa:

   Frequencia: Diario (on-line)
   Objetivo  : Processar a rotina de alteracao da tela RISCO.

   Alteracoes: 13/11/2001 - Gerar uma unica transacao (Margarete).
   
               09/04/2003 - Deixar alterar pessoas fisicas na Concredi(Deborah)
               ...
               01/12/2004 - Somente Viacredi/Creditextil poderao alterar(qdo
...
ASSIGN    tel_vlvec30   = 0   tel_vlvec60   = 0
   ...
   FIND FIRST crapris WHERE crapris.cdcooper  = glb_cdcooper  AND
                            ...
                            crapris.cdmod    >= tel_cdmodali  AND
                            crapris.nrctremp >= tel_nrctremp  AND
                            crapris.nrseqctr >= tel_nrseqctr  AND
   ...
   DO TRANSACTION:
      FIND FIRST crapris WHERE crapris.cdcooper = glb_cdcooper  AND
                               ...
                               crapris.innivris = tel_innivris  AND
                               crapris.inddocto = 1             AND
                               crapris.cdmodali = tel_cdmodali  AND
                               crapris.nrctremp = tel_nrctremp  AND
                               crapris.cdorigem = 3 
      ...
      ASSIGN  crapris.vldivida = aux_vldivida
