/* .............................................................................
   ...
   Programa: Includes/cabrel080_2.i
...
IF   glb_cdrelato[2] > 0   THEN
     DO:
         ...
         IF   NOT AVAILABLE craprel   THEN
              ASSIGN rel_nmrelato[2] = FILL("?",16)
                     rel_nrmodulo    = 1.
         ELSE
              ASSIGN rel_nmrelato[2] = craprel.nmrelato
         ...
         FORM HEADER
              ...
              "-"                        AT  13
              rel_nmrelato[2]            AT  15 FORMAT "x(16)"
              "REF."                     AT  32
              glb_dtmvtolt               AT  36 FORMAT "99/99/9999"
              glb_cdrelato[2]            AT  47 FORMAT "999"
              "/"                        AT  50
              ...
              "PAG:"                     AT  74
              PAGE-NUMBER(str_2)         AT  78 FORMAT "zz9"
              SKIP(1)
              glb_nmdestin[2]                   FORMAT "x(40)"
              SKIP(1)
              
         WITH PAGE-TOP NO-BOX NO-ATTR-SPACE WIDTH 80 FRAME f_cabrel080_2.
