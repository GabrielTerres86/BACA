/* .............................................................................
   ...
   Programa: siscaixa/web/crap057a1.w
...
DEF VAR h-b1crap57       AS HANDLE  NO-UNDO.
...
&Scoped-define WEB-FILE F:/web/crap057a1.htm
                   ...
                   ELSE DO:
                        ...
                        IF  RETURN-VALUE = "OK" THEN DO:
                            ...
                            IF  GET-VALUE("ok") <> " " THEN DO:
                                ...
                                IF  p-mensagem-saldo <> " "  THEN
                                    ASSIGN v_mensagem1 =
                                           v_mensagem1 + p-mensag~em-saldo.                                 END.
                        END.
                        IF  RETURN-VALUE = "NOK"  THEN DO:
                            {include/i-erro.i}
                        END.
                        ELSE DO:
                            IF  GET-VALUE("ok") <> " " THEN DO:
                                ...
                                IF  de-saldo-cheque = DEC(v_valor1) THEN DO:
                                    ...
                                    "crap057c.w?v_pconta=" +                                                        "'GET-VALUE("v_pconta")'" +
                                    "&v_pnome=" + 
                                    "' GET-VALUE("v_pnome") '" +
                                    "&v_ppoup=" +
                                    "' GET-VALUE("v_ppoup") '" +
                                ...
                                ELSE DO:
                                    ...
                                    {&OUT}
                                    '<script>window.location=
                                    "crap057a.w?v_pconta=" +                                                          "'GET-VALUE("v_pconta")'" +
                                     "&v_pnome=" +
                                     "'GET-VALUE("v_pnome")'" +
                                     "&v_ppoup=" +
                                     "'GET-VALUE("v_ppoup")'" +
