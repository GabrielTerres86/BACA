/*..............................................................................
   ...
   Programa: siscaixa/web/crap083.w
   ...
   Objetivo  :  Estorno GPS - Guias Previdencia Social

   Alteracoes:  29/08/2008 - Incluido cddpagto nos FIND's da crapcgp e da
                             craplgp; 
                           - Passado como parametro codigo de pagamento para 
                             as procedures valida-existencia-lancamento e 
                             estorna-pagamento (Elton).
                    
                09/01/2008 - Executa a procedure valida-existencia-lancamento
                             toda vez que for dado o "OK" na tela (Elton).
...
DEF VAR h-b1crap83 AS HANDLE          NO-UNDO.
...
DEF VAR p_valorins      AS DEC        NO-UNDO.
DEF VAR p_valorjur      AS DEC        NO-UNDO.
DEF VAR p_valorout      AS DEC        NO-UNDO.
DEF VAR p_valortot      AS DEC        NO-UNDO.
DEF VAR p_mes           AS INTE       NO-UNDO.
DEF VAR p_ano           AS INTE       NO-UNDO.
...
&Scoped-define WEB-FILE F:/web/crap083.htm

/* Name of first Frame and/or Browse and/or first Query                 */
&Scoped-define FRAME-NAME Web-Frame

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS ab_unmap.ok ab_unmap.vh_foco ab_unmap.v_ano ab_unmap.v_caixa ab_unmap.v_codigo ab_unmap.v_conta ab_unmap.v_coop ab_unmap.v_data ab_unmap.v_identificador ab_unmap.v_mes ab_unmap.v_msg ab_unmap.v_nome ab_unmap.v_operador ab_unmap.v_pac ab_unmap.v_valorins ab_unmap.v_valorjur ab_unmap.v_valorout ab_unmap.v_valortot 
&Scoped-Define DISPLAYED-OBJECTS ab_unmap.ok ab_unmap.vh_foco ab_unmap.v_ano ab_unmap.v_caixa ab_unmap.v_codigo ab_unmap.v_conta ab_unmap.v_coop ab_unmap.v_data ab_unmap.v_identificador ab_unmap.v_mes ab_unmap.v_msg ab_unmap.v_nome ab_unmap.v_operador ab_unmap.v_pac ab_unmap.v_valorins ab_unmap.v_valorjur ab_unmap.v_valorout ab_unmap.v_valortot 
     ...
     * Set any values that need to be set, then display them. */
     ...
     ELSE DO:
         ...
         ELSE DO:
             ...
             ELSE DO:  
                 ASSIGN ok = " ".
                 RUN dbo/b1crap83.p PERSISTENT SET h-b1crap83.
                 
                 IF  ok = " " THEN DO:
                     RUN valida-existencia-lancamento
                     IN h-b1crap83(INPUT v_coop,
                                   INPUT  INT(v_pac),  
                                   INPUT  INT(v_caixa),
                                   ...
                                   OUTPUT p_valorout). 
                     ASSIGN
                        v_valorins = STRING(p_valorins,"zzz,zzz,zzz,zz9.99") 
                        v_valorjur = STRING(p_valorjur,"zzz,zzz,zzz,zz9.99") 
                        v_valorout = STRING(p_valorout,"zzz,zzz,zzz,zz9.99").
