/***************************************************************************
    ...
    Alteracoes: 16/04/2013 - Adicionado verificacao de sangria de caixa no
...
DEF VAR h-b1crap58 AS HANDLE          NO-UNDO.
...
&Scoped-define WEB-FILE F:/web/crap058.htm
     ...
     ELSE DO:
         ...
         ELSE DO:
             ...
             ELSE DO:
                 ...
                 RUN dbo/b1crap58.p PERSISTENT SET h-b1crap58.
                 RUN valida-conta-contrato    
                     IN h-b1crap58(INPUT v_coop,
                                   INPUT  INT(v_pac),
                                   INPUT  INT(v_caixa),
                                   INPUT  INT(v_conta),
