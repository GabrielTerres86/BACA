/* .............................................................................
   ...
   Programa: siscaixa/web/crap012.w
   ...
   Objetivo  : Executa a rotina 12 do Caixa on-line 
               (FECHAMENTO BOLETIM DE CAIXA).

   Alteracoes: 16/05/2008 - Executa BO "executa-pendencias-fechamento" se
                            houver relacionamento do PAC com o COBAN
                            (crapage.vercoban = TRUE) (Elton).
...
DEFINE TEMP-TABLE ab_unmap
       ...
       FIELD v_autent AS CHARACTER FORMAT "X(256)":U 
...
DEF VAR h-b2crap01   AS HANDLE  NO-UNDO.
DEF VAR p-autentica  AS CHAR    NO-UNDO.
...
&Scoped-define WEB-FILE crap012.htm

/* Name of first Frame and/or Browse and/or first Query                 */
&Scoped-define FRAME-NAME Web-Frame

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS ab_unmap.vh_foco ab_unmap.v_msg ab_unmap.v_autent ab_unmap.v_caixa ab_unmap.v_coop ab_unmap.v_data ab_unmap.v_lacre ab_unmap.v_operador ab_unmap.v_pac ab_unmap.v_saldofin ab_unmap.v_saldoini 
&Scoped-Define DISPLAYED-OBJECTS ab_unmap.vh_foco ab_unmap.v_msg ab_unmap.v_autent ab_unmap.v_caixa ab_unmap.v_coop ab_unmap.v_data ab_unmap.v_lacre ab_unmap.v_operador ab_unmap.v_pac ab_unmap.v_saldofin ab_unmap.v_saldoini 
...
DEFINE FRAME Web-Frame
     ...
     ab_unmap.v_msg AT ROW 1 COL 1 HELP
          ...
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     ab_unmap.v_autent AT ROW 1 COL 1 HELP
          "" NO-LABEL FORMAT "X(256)":U
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
...
/* SETTINGS FOR FILL-IN ab_unmap.v_autent IN FRAME Web-Frame
   ALIGN-L EXP-LABEL EXP-FORMAT EXP-HELP                                */
...
------------------------------------------------------------------------------*/
  ...
  RUN htmAssociate
    ("v_autent":U,"ab_unmap.v_autent":U,ab_unmap.v_autent:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
...
------------------------------------------------------------------------*/
  ...
  {include/i-global.i}
      ...
      /*"<frameset cols='*' framespacing='0' border='0' frameborder='0' scrolling='auto'>"
              "<frame name='pane' src='crap007.w' scrolling='auto' noresize>"
              "<frame name='menu' src='menu.r' scrolling='auto' noresize disabled>".
              "</frameset>".
              */
