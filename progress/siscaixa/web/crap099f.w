/* .............................................................................
   ...
   Programa: Web/crap099f.w
   Sistema : Conta-Corrente - Cooperativa de Credito
   Sigla   : CRED
   Autor   : Margarete
   Data    : Agosto/2003                     Ultima atualizacao: 13/10/2006 
...
&Scoped-define WEB-FILE crap099f.htm

/* Name of first Frame and/or Browse and/or first Query                 */
&Scoped-define FRAME-NAME Web-Frame

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS ab_unmap.v_nrccdrcb ab_unmap.v_nmpesrcb ab_unmap.v_inpesrcb ab_unmap.v_cpfcgrcb ab_unmap.v_nridercb ab_unmap.vh_foco ab_unmap.v_caixa ab_unmap.v_dtnasrcb ab_unmap.v_desenrcb ab_unmap.v_data ab_unmap.v_nmcidrcb ab_unmap.v_operador ab_unmap.v_pac ab_unmap.v_cdufdrcb ab_unmap.v_nrceprcb ab_unmap.Ilicita ab_unmap.v_recursos ab_unmap.v_nrccddst ab_unmap.v_nmpesdst ab_unmap.v_inpesdst ab_unmap.v_cpfcgdst ab_unmap.v_nridedst ab_unmap.v_dtnasdst ab_unmap.v_desendst ab_unmap.v_nmciddst ab_unmap.v_cdufddst ab_unmap.v_nrcepdst ab_unmap.v_coop ab_unmap.v_msg ab_unmap.v_dstrecur 
&Scoped-Define DISPLAYED-OBJECTS ab_unmap.v_nrccdrcb ab_unmap.v_nmpesrcb ab_unmap.v_inpesrcb ab_unmap.v_cpfcgrcb ab_unmap.v_nridercb ab_unmap.vh_foco ab_unmap.v_caixa ab_unmap.v_dtnasrcb ab_unmap.v_desenrcb ab_unmap.v_data ab_unmap.v_nmcidrcb ab_unmap.v_operador ab_unmap.v_pac ab_unmap.v_cdufdrcb ab_unmap.v_nrceprcb ab_unmap.Ilicita ab_unmap.v_recursos ab_unmap.v_nrccddst ab_unmap.v_nmpesdst ab_unmap.v_inpesdst ab_unmap.v_cpfcgdst ab_unmap.v_nridedst ab_unmap.v_dtnasdst ab_unmap.v_desendst ab_unmap.v_nmciddst ab_unmap.v_cdufddst ab_unmap.v_nrcepdst ab_unmap.v_coop ab_unmap.v_msg ab_unmap.v_dstrecur 
...
DEFINE FRAME Web-Frame
     ...
     ab_unmap.v_nmpesrcb AT ROW 1 COL 1 HELP
          ...
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     ab_unmap.v_inpesrcb AT ROW 1 COL 1 HELP
          "" NO-LABEL FORMAT "X(256)":U
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     ...
     ab_unmap.v_dstrecur AT ROW 1 COL 1 HELP
          ...
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     ab_unmap.v_nrccddst AT ROW 1 COL 1 HELP
          "" NO-LABEL FORMAT "X(256)":U
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     ab_unmap.v_nmpesdst AT ROW 1 COL 1 HELP
          "" NO-LABEL FORMAT "X(256)":U
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     ab_unmap.v_inpesdst AT ROW 1 COL 1 HELP
          "" NO-LABEL FORMAT "X(256)":U
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     ab_unmap.v_cpfcgdst AT ROW 1 COL 1 HELP
          "" NO-LABEL FORMAT "X(256)":U
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     ab_unmap.v_nridedst AT ROW 1 COL 1 HELP
          "" NO-LABEL FORMAT "X(256)":U
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     ab_unmap.v_dtnasdst AT ROW 1 COL 1 HELP
          "" NO-LABEL FORMAT "X(256)":U
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     ab_unmap.v_desendst AT ROW 1 COL 1 HELP
          "" NO-LABEL FORMAT "X(256)":U
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     ab_unmap.v_cdufddst AT ROW 1 COL 1 HELP
          "" NO-LABEL FORMAT "X(256)":U
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     ab_unmap.v_cdufdrcb AT ROW 1 COL 1 HELP
          ...
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     ab_unmap.v_nmciddst AT ROW 1 COL 1 HELP
          "" NO-LABEL FORMAT "X(256)":U
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     ab_unmap.v_nrcepdst AT ROW 1 COL 1 HELP
          "" NO-LABEL FORMAT "X(256)":U
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     ab_unmap.Ilicita AT ROW 1 COL 1 HELP
          "" NO-LABEL 
...
/* SETTINGS FOR FILL-IN ab_unmap.v_caixa IN FRAME Web-Frame
   ALIGN-L EXP-LABEL EXP-FORMAT EXP-HELP                                */
/* SETTINGS FOR FILL-IN ab_unmap.Ilicita IN FRAME Web-Frame
   ALIGN-L EXP-LABEL EXP-FORMAT EXP-HELP                                */
...
/* SETTINGS FOR FILL-IN ab_unmap.v_nmpesrcb IN FRAME Web-Frame
   ALIGN-L EXP-LABEL EXP-FORMAT EXP-HELP                                */
/* SETTINGS FOR FILL-IN ab_unmap.v_inpesrcb IN FRAME Web-Frame
   ALIGN-L EXP-LABEL EXP-FORMAT EXP-HELP                                */
...
------------------------------------------------------------------------------*/
  ...
  RUN htmAssociate
    ("Ilicita":U,"ab_unmap.Ilicita":U,ab_unmap.Ilicita:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
  ...
  RUN htmAssociate
    ("v_inpesrcb":U,"ab_unmap.v_inpesrcb":U,ab_unmap.v_inpesrcb:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
  ...
  RUN htmAssociate
    ("v_nrccddst":U,"ab_unmap.v_nrccddst":U,ab_unmap.v_nrccddst:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
    ("v_nmpesdst":U,"ab_unmap.v_nmpesdst":U,ab_unmap.v_nmpesdst:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
    ("v_inpesdst":U,"ab_unmap.v_inpesdst":U,ab_unmap.v_inpesdst:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
    ("v_cpfcgdst":U,"ab_unmap.v_cpfcgdst":U,ab_unmap.v_cpfcgdst:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
    ("v_nridedst":U,"ab_unmap.v_nridedst":U,ab_unmap.v_nridedst:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
    ("v_dtnasdst":U,"ab_unmap.v_dtnasdst":U,ab_unmap.v_dtnasdst:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
    ("v_desendst":U,"ab_unmap.v_desendst":U,ab_unmap.v_desendst:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
    ("v_nmciddst":U,"ab_unmap.v_nmciddst":U,ab_unmap.v_nmciddst:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
    ("v_cdufddst":U,"ab_unmap.v_cdufddst":U,ab_unmap.v_cdufddst:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
    ("v_nrcepdst":U,"ab_unmap.v_nrcepdst":U,ab_unmap.v_nrcepdst:HANDLE IN FRAME {&FRAME-NAME}).
...
IF REQUEST_METHOD = 'POST':U   THEN
   DO:
      ...
      IF get-value('cancela') <> ''   THEN
         DO:
            ASSIGN vh_foco     = '9'     ilicita     = 'N'
                   v_nrccdrcb  = ''      v_nmpesrcb  = ''
                   v_inpesrcb  = ''      v_cpfcgrcb  = ''
                   v_nridercb  = ''      v_dtnasrcb  = ''
                   v_desenrcb  = ''      v_nmcidrcb  = ''
                   v_cdufdrcb  = ''      v_nrceprcb  = ''
                   v_recursos  = ''      v_nrccddst  = ''
                   v_nmpesdst  = ''      v_inpesdst  = ''
                   v_cpfcgdst  = ''      v_nridedst  = ''
                   v_dtnasdst  = ''      v_desendst  = ''
                   v_nmciddst  = ''      v_cdufddst  = ''
                   v_nrcepdst  = ''      v_dstrecur  = ''.
         END.
      ELSE 
         DO:
            ASSIGN v_nrccdrcb = REPLACE(v_nrccdrcb,'.','')
                   v_nrccddst = REPLACE(v_nrccddst,'.','')
                   v_cpfcgrcb = REPLACE(v_cpfcgrcb,'/','')
                   v_cpfcgrcb = REPLACE(v_cpfcgrcb,'.','')
                   v_cpfcgrcb = REPLACE(v_cpfcgrcb,'-','')
                   v_cpfcgdst = REPLACE(v_cpfcgdst,'/','')
                   v_cpfcgdst = REPLACE(v_cpfcgdst,'.','')
                   v_cpfcgdst = REPLACE(v_cpfcgdst,'-','')
                   v_dtnasrcb = REPLACE(v_dtnasrcb,'/','')
                   v_dtnasdst = REPLACE(v_dtnasdst,'/','').
            ...
            DO:
               ...
               ELSE
               DO:
                   IF (DEC(v_valor) >= v_vlmincen  AND
                       crapass.inpessoa <> 2     ) OR /* fora juridica */
                      ilicita = "S"                THEN
                      DO:
                          IF v_nrccddst <> ''   THEN DO:
                             RUN dbo/bo_controla_depositos.p
                                 PERSISTENT SET h-bo-depos.
                             RUN retorna-origem-destinatario
                                 IN h-bo-depos(INPUT v_coop,
                                               INPUT INTE(v_pac),
                                               INPUT INTE(v_caixa),
                                               INPUT INTE(v_nrccddst),
                                               OUTPUT v_nmpesdst,
                                               OUTPUT v_cpfcgdst,
                                               OUTPUT v_inpesdst,
                                               OUTPUT v_nridedst,
                          ...
                          END.
                          ELSE
                             IF   v_nmpesdst <> ''   THEN DO:
                                  RUN dbo/bo_controla_depositos.p
                                      PERSISTENT SET h-bo-depos.
                                  RUN valida-origem-destinatario
                                        IN h-bo-depos (INPUT v_coop,
                                                       INPUT INTE(v_pac),
                                                       INPUT INTE(v_caixa),
                                                       INPUT v_nmpesdst,
                          ...
                          IF RETURN-VALUE = 'NOK'   THEN
                             DO: /*Mais um para usar a mesma rotina do depos*/
                                 ASSIGN l-houve-erro = YES
                                        vh_foco      = 
                                           STRING(INTE(aux_focoerro) + 1).
                                 {include/i-erro.i}
                             END.
                      END.
               END.      
               ...
               IF get-value('Ok') <> '' AND 
                  ...
                  DO:
                      ...
                      DO TRANSACTION ON ERROR UNDO:
                         ...
                         RUN atualiza-crapcme
                                   IN  h-bo-saque(INPUT v_coop,
                                                  ...
                                                  INPUT v_inpesdst,
                                                  INPUT v_nridedst,
                                                  INPUT DATE(v_dtnasdst),
                                                  INPUT v_desendst,
                                                  INPUT v_nmciddst,
                                                  INPUT v_cdufddst,
                                                  INPUT INTE(v_nrcepdst)).
                         DELETE PROCEDURE h-bo-saque.
                      ...
                      ELSE
                         DO:
                             ASSIGN p-nrdolote = 11000 + INTE(v_caixa).
                             
                             RUN dbo/bo_controla_saques.p
                                 PERSISTENT SET h-bo-saque.
                             RUN bo_imp_ctr_saques
                                      IN h-bo-saque (INPUT v_coop,
                                                     INPUT v_operador,
                                                     INPUT INTE(v_pac),
                                                     INPUT INTE(v_caixa),
