/* Alteracoes: 21/06/2018 - Alteracoes para usar as rotinas mesmo com o processo 
...
DEFINE VARIABLE h-b1crap17 AS HANDLE     NO-UNDO.
...
&Scoped-define WEB-FILE crap017.htm

/* Name of first Frame and/or Browse and/or first Query                 */
&Scoped-define FRAME-NAME Web-Frame

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS ab_unmap.v_msg ab_unmap.v_caixa ab_unmap.v_coop ab_unmap.v_data ab_unmap.v_lote ab_unmap.v_operador ab_unmap.v_pac 
&Scoped-Define DISPLAYED-OBJECTS ab_unmap.v_msg ab_unmap.v_caixa ab_unmap.v_coop ab_unmap.v_data ab_unmap.v_lote ab_unmap.v_operador ab_unmap.v_pac 
         ...
         ELSE   DO:
             ...
             ELSE DO:
                 ...
                 DO TRANSACTION ON ERROR UNDO:
                    ...
                    RUN dbo/b1crap17.p PERSISTENT SET h-b1crap17. 
                    RUN estorno-associacao  IN h-b1crap17 (INPUT v_coop,
                                                           INPUT int(v_pac),
                                                           INPUT int(v_caixa),
                                                           INPUT v_operador,
                                                           INPUT v_lote,
                    ...
                    IF  RETURN-VALUE = "OK"  THEN  DO:
                        RUN grava-autenticacao  
                          IN h-b1crap00 (INPUT v_coop,
                                         ...
                                         INPUT dec(p-valor),
                                         INPUT dec(p-docto),
                                         INPUT YES,   /* Pagamento(PG) */
                                         INPUT "1",   /* On-line       */                                               INPUT yes,    /* Estorno   */
                                         INPUT p-histor,
                                         INPUT ?, /* Data off-line */
