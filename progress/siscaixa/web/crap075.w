...
DEF VAR h-b1crap77 AS HANDLE            NO-UNDO.
...
&Scoped-define WEB-FILE F:/web/crap075.htm

/* Name of first Frame and/or Browse and/or first Query                 */
&Scoped-define FRAME-NAME Web-Frame

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS ab_unmap.vh_foco ab_unmap.v_caixa ab_unmap.v_conta ab_unmap.v_coop ab_unmap.v_data ab_unmap.v_docto ab_unmap.v_identifica ab_unmap.v_msg ab_unmap.v_nome ab_unmap.v_operador ab_unmap.v_pac ab_unmap.v_poupanca ab_unmap.v_valor ab_unmap.v_valor1 
&Scoped-Define DISPLAYED-OBJECTS ab_unmap.vh_foco ab_unmap.v_caixa ab_unmap.v_conta ab_unmap.v_coop ab_unmap.v_data ab_unmap.v_docto ab_unmap.v_identifica ab_unmap.v_msg ab_unmap.v_nome ab_unmap.v_operador ab_unmap.v_pac ab_unmap.v_poupanca ab_unmap.v_valor ab_unmap.v_valor1 
  ...
  IF REQUEST_METHOD = "POST":U THEN DO:
    ...
    ELSE DO:
        ...
        ELSE DO:
            ...
            RUN dbo/b1crap77.p PERSISTENT SET h-b1crap77.
            RUN valida-cheque-com-captura IN h-b1crap77(INPUT  v_coop,
                                                        INPUT  v_pac,    
                                                        INPUT  v_caixa,
                                                        INPUT  v_conta,
                                                        INPUT  v_docto,
            ...
            ASSIGN v_valor1 = STRING(DEC(v_valor1),"zzz,zzz,zzz,zz9.99")
                   v_valor  = STRING(DEC(v_valor),"zzz,zzz,zzz,zz9.99").
                ...
                IF  GET-VALUE("ok") <> "" THEN DO:
                    ...
                    IF  l-houve-erro = NO THEN do:     
                       ...
                       {&OUT}
                           ...
                           "&v_pseq=" + "' p-ult-sequencia '" + "&v_prec=" + "N~O"  + "&v_psetcook=" + "yes","waut","width=250,height=145,scrollbars=auto,alway~sRaised=true")
                           </script>'.
