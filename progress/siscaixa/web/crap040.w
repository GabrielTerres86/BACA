...
&Scoped-define WEB-FILE crap040.htm

/* Name of first Frame and/or Browse and/or first Query                 */
&Scoped-define FRAME-NAME Web-Frame

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS ab_unmap.v_msg ab_unmap.v_caixa ab_unmap.v_coop ab_unmap.v_data ab_unmap.v_operador ab_unmap.v_pac 
&Scoped-Define DISPLAYED-OBJECTS ab_unmap.v_msg ab_unmap.v_caixa ab_unmap.v_coop ab_unmap.v_data ab_unmap.v_operador ab_unmap.v_pac 
  ...
  IF REQUEST_METHOD = "POST":U THEN DO:
    ...
    ELSE DO:
       ...
       ELSE do:    
           ...
           RUN dbo/b1crap40.p PERSISTENT SET h-b1crap40.

           RUN importacao IN h-b1crap40(INPUT v_coop,
                                        INPUT v_pac,
                                        INPUT v_caixa).
           IF RETURN-VALUE = "NOK" THEN DO:
              {include/i-erro.i}
