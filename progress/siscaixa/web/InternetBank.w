...
/*------------------------------------------------------------------------------
   ...
   Sigla   : CRED
   Autor   : Junior
   Data    : Julho/2004.                       Ultima atualizacao: 26/06/2018
...
DEF VAR aux_iddirarq AS INTE                                           NO-UNDO.
...
------------------------------------------------------------------------*/
  ...
  ELSE DO:
    ...
    DO:
        ...
        ELSE
            IF  aux_operacao = 190 THEN /* Detalhamento de cheque depositado */
                RUN proc_operacao190.                
        ELSE
...
PROCEDURE proc_operacao9:
    ...
    FOR EACH xml_operacao9 NO-LOCK: 
        ...
        {&out} xml_operacao9.dscabini 
               ...
               xml_operacao9.cdtiptra
               xml_operacao9.idlstdom
               xml_operacao9.idlancto
               xml_operacao9.incancel
...
PROCEDURE proc_operacao69:
    ...
    ASSIGN aux_nmarquiv = GET-VALUE("nmarquiv")
           ...
           aux_iddirarq = INTE(GET-VALUE("iddirarq")).
...
PROCEDURE proc_operacao190:	

	ASSIGN aux_dtmvtolt = DATE(GET-VALUE("dtmvtolt"))
         aux_nrdocmto = INTE(GET-VALUE("nrdocmto")).

	RUN sistema/internet/fontes/InternetBank190.p (INPUT aux_cdcooper,
                                                 INPUT aux_nrdconta,
                                                 INPUT aux_idseqttl,
												                         INPUT aux_dtmvtolt,
                                                 INPUT aux_nrdocmto,
...
/** Identificar/retornar o tipo de pagamento do Codigo de Barras **/
PROCEDURE proc_operacao218:

    ASSIGN aux_cdbarras = GET-VALUE("cdbarras").
    
    
    RUN sistema/internet/fontes/InternetBank218.p (INPUT aux_cdcooper,
	                                               INPUT 90,
                                                   INPUT aux_cdcanal,
												   INPUT aux_nrdconta,
                                                   INPUT aux_cdbarras,
...
/** Retornar lista com horários limite de todos os tipos de pagamento **/
PROCEDURE proc_operacao219:
    
    RUN sistema/internet/fontes/InternetBank219.p (INPUT aux_cdcooper,
	                                               INPUT 90,
                                                   INPUT aux_cdcanal,
												   INPUT aux_nrdconta,
                                                  OUTPUT TABLE xml_operacao).
