...
------------------------------------------------------------------------------*/
  ...
  {&OUT}
    ...
    "<TITLE>MENSAGEM ERRO</TITLE>":U SKIP
    "</HEAD>":U SKIP
    '<BODY background="/images/moeda.jpg" bgproperties="fixed" class=fundo onLoad="Javascript:onTop();click();" onKeyDown="JavaScript:onKey(event)">':U SKIP
    '<form method=post>' SKIP.

  /*onBlur="Javascript:onTop()"*/
  /* Output your custom HTML to WEBSTREAM here (using {&OUT}).                */
   {&OUT}
       ...
       "    <tr>"
       "        <td class=titulo style='BACKGROUND-COLOR:#2D862D; border=0'>Seq.</td>"
       "        <td class=titulo style='BACKGROUND-COLOR:#2D862D; border=0'>C&oacute;d.</td>"
       "        <td class=titulo style='BACKGROUND-COLOR:#2D862D; border=0'>Descri&ccedil;&atilde;o</td>"
       "    </tr>".
  ...
  FOR EACH craperr WHERE craperr.cdcooper = crapcop.cdcooper   AND
   ...
   {&OUT}
       "    <tr>"
       '        <td class=campos align="right" readonly>' craperr.nrsequen '</td>'
       '        <td class=campos align="right" readonly>' craperr.cdCritic '</td>'
       '        <td class=campos align="left" readonly>' craperr.dsCritic '</td>'
       "    </tr>".
  END.
