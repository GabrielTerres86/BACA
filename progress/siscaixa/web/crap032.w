...
DEFINE VARIABLE h-b1crap32  AS HANDLE     NO-UNDO.
...
&Scoped-define WEB-FILE crap032.htm

/* Name of first Frame and/or Browse and/or first Query                 */
&Scoped-define FRAME-NAME Web-Frame

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS ab_unmap.vh_arquivo ab_unmap.v_msg ab_unmap.v_lote ab_unmap.v_caixa ab_unmap.v_coop ab_unmap.v_data ab_unmap.v_operador ab_unmap.v_pac 
&Scoped-Define DISPLAYED-OBJECTS ab_unmap.vh_arquivo ab_unmap.v_msg ab_unmap.v_lote ab_unmap.v_caixa ab_unmap.v_coop ab_unmap.v_data ab_unmap.v_operador ab_unmap.v_pac 
...
------------------------------------------------------------------------*/
  ...
  IF REQUEST_METHOD = "POST":U THEN DO:
    ...
    v_lote = STRING(16000 + INT(v_caixa)).
     ...
     ELSE DO:
         ...
         ELSE DO:
            ...
            ELSE DO:
                ...
                RUN dbo/b1crap32.p PERSISTENT SET h-b1crap32.                           
                IF  get-value("botao1") = "Visualizar"  THEN  
                    ASSIGN l-imprime = no.
                ELSE 
                    ASSIGN l-imprime = yes.

                RUN impressao IN h-b1crap32 (INPUT v_coop,
                                             INPUT  v_operador,
                                             INPUT  int(v_pac),
                                             INPUT  INT(v_caixa),
                                             INPUT  INT(v_lote),
