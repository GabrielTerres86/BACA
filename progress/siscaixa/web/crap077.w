...
&Scoped-define WEB-FILE F:/web/crap077.htm
       ...
       ELSE DO:
           ...
           ELSE DO:
               ...
               RUN valida-cheque-com-captura IN h-b1crap77(INPUT  v_coop,
                                                           ...
                                                           OUTPUT v_nome,
                                                           OUTPUT p-poupanca).
               ASSIGN v_valor  = STRING(DEC(v_valor),"zzz,zzz,zzz,z~z9.99")
                      v_valor1 = STRING(DEC(v_valor1),"zzz,zzz,zzz,~zz9.99").
                  ...
                  ELSE DO:
                      ...
                      IF  GET-VALUE("ok") <> "" THEN DO:
                          ...
                          IF  l-houve-erro = NO THEN DO:     
                              ...
                              scrollbars=auto,alwaysRaised=true,left=0,top=0")
                              </script>'.
