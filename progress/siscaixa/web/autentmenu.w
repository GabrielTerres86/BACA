/* .............................................................................
   ...
   Programa: web/autentmenu.w
   Sistema : Conta-Corrente - Cooperativa de Credito
   Sigla   : CRED
   Autor   : 
   Data    :           .                    Ultima atualizacao: 10/04/2015
   ...
   10/12/2009 - Adicionados parametros na chamada da procedure
     ...
     04/08/2011 - Retirar impressao de saque / deposito (Gabriel).           
     
     23/12/2014 - Remover caracter # da variavel p-literal para evitar problemas
                  na geração da impressão do comprovante (Chamado 273217 - Douglas)
...
&Scoped-define WEB-FILE autentmenu.htm

/* Name of first Frame and/or Browse and/or first Query                 */
&Scoped-define FRAME-NAME Web-Frame

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS ab_unmap.v_caixa ab_unmap.v_coop ab_unmap.v_data ab_unmap.v_msg ab_unmap.v_operador ab_unmap.v_pac ab_unmap.v_sequencia 
&Scoped-Define DISPLAYED-OBJECTS ab_unmap.v_caixa ab_unmap.v_coop ab_unmap.v_data ab_unmap.v_msg ab_unmap.v_operador ab_unmap.v_pac ab_unmap.v_sequencia 
                 ...
                 DO:
                     ...
                     {&OUT}
                         '<script>window.open("autentica.html?v_plit=" + "' p-literal '" + 
                          "&v_pseq=" + "' get-value("v_sequencia") '" + "&v_prec=" + "' p-rec '"  + "&v_psetcook=" + "no","waut","width=250,height=145,scrollbars=auto,alwaysRaised=true")
                         </script>'.
