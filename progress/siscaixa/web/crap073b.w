/* .............................................................................
   ...
   Programa: siscaixa/web/crap073b.w
...
&Scoped-define WEB-FILE crap073b.htm
    ...
    ASSIGN   
     ...
     ELSE DO:
         IF  get-value("estorno") <> "" THEN DO:
             {&OUT}
             '<script>window.location = "crap073.html?v_valor=" + "'get-value("v_valor")'" + "&v_cmc7=" + "'get-value("v_cmc7")'" + "&v_codigo=" + "'get-value("v_codigo")'"
              </script>'.
         END.
         ELSE DO:
              ...
              ELSE DO:
                  RUN dbo/b1crap73.p PERSISTENT SET h-b1crap73.
                  RUN valida-estorno-pagto-cheque IN h-b1crap73(
                                                       INPUT v_coop,          
                                                       INPUT int(v_pac),
                                                       INPUT int(v_caixa),
                                                       INPUT v_cmc7,
                                                       INPUT " ",
                                                       INPUT INT(v_comp),
                                                       INPUT INT(v_banco),                                                            INPUT INT(v_agenc),
                                                       INPUT INT(v_c1),
                                                       INPUT DEC(v_conta),
                                                       INPUT INT(v_c2),
                                                       INPUT INT(v_conta1),
