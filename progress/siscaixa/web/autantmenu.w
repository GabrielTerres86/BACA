/* .............................................................................
   ...
   Programa: web/autantmenu.w
   Sistema : Conta-Corrente - Cooperativa de Credito
   Sigla   : CRED
   Autor   : 
   Data    :           .                    Ultima atualizacao: 23/12/2014
   ...
   10/12/2009 - Adicionados parametros na chamada da procedure
                bo imp ctr saques da bo_controle_saques (Fernando).  
   
   04/05/2010 - Ajustar passagem de parametros para a bo_controla_saques.
                (Fernando)               
                
   04/08/2011 - Retirar impressao de saques e depositos (Gabriel).
   
   23/12/2014 - Filtro de # para a variavel p-literal para evitar problemas
                na geração da impressão do comprovante - (Jean - RKAM)
...
DEFINE TEMP-TABLE ab_unmap
       ...
       FIELD v_datainf AS CHARACTER FORMAT "X(256)":U 
...
DEFINE VARIABLE p-rec      AS LOGICAL    NO-UNDO.
DEFINE VARIABLE p-ctrmovto AS INTE       NO-UNDO.
DEFINE VARIABLE p-nrdolote AS INTE       NO-UNDO.
DEFINE VARIABLE p-nrdocmto AS INTE       NO-UNDO.
DEFINE VARIABLE p-nmarqimp AS CHAR       NO-UNDO.
...
&Scoped-define WEB-FILE /web/autantmenu.html

/* Name of first Frame and/or Browse and/or first Query                 */
&Scoped-define FRAME-NAME Web-Frame

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS ab_unmap.v_caixa ab_unmap.v_coop ab_unmap.v_data ab_unmap.v_datainf ab_unmap.v_msg ab_unmap.v_operador ab_unmap.v_pac ab_unmap.v_sequencia 
&Scoped-Define DISPLAYED-OBJECTS ab_unmap.v_caixa ab_unmap.v_coop ab_unmap.v_data ab_unmap.v_datainf ab_unmap.v_msg ab_unmap.v_operador ab_unmap.v_pac ab_unmap.v_sequencia 
...
DEFINE FRAME Web-Frame
     ...
     ab_unmap.v_data AT ROW 1 COL 1 HELP
          ...
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     ab_unmap.v_datainf AT ROW 1 COL 1 HELP
          "" NO-LABEL FORMAT "X(256)":U
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
...
/* SETTINGS FOR fill-in ab_unmap.v_data IN FRAME Web-Frame
   ALIGN-L EXP-LABEL EXP-FORMAT EXP-HELP                                */
/* SETTINGS FOR fill-in ab_unmap.v_datainf IN FRAME Web-Frame
   ALIGN-L EXP-LABEL EXP-FORMAT EXP-HELP                                */
...
------------------------------------------------------------------------------*/
  ...
  RUN htmAssociate
    ("v_datainf":U,"ab_unmap.v_datainf":U,ab_unmap.v_datainf:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
     ...
     ELSE  DO:
         ...
         ELSE DO:
             ...
             DO:
                 ...
                 RUN obtem-reautenticacao
                     IN h-b1crap00(INPUT v_coop,
                                   INPUT INT(v_pac),
                                   INPUT INT(v_caixa),
                                   INPUT v_operador,
                                   INPUT INT(GET-VALUE("v_sequencia")),
                                   INPUT INT(GET-VALUE("v_datainf")),
                                   OUTPUT p-ctrmovto,
                                   OUTPUT p-nrdolote,
                                   OUTPUT p-nrdocmto,
                                   OUTPUT p-literal,
                 ...
                 ELSE
                 DO:
                     ASSIGN p-literal = REPLACE(p-literal,"#"," ").

                     IF  LENGTH(p-literal) > 1900 /* 2400 */ THEN DO:
                         ASSIGN p-literal = " ".

                     END.

                     {&OUT}
                         '<script>window.open("autentica_ant.html?v_plit=" +
                         "' p-literal '" + 
                         "&v_pseq=" + 
                         "' get-value("v_sequencia") '" +
                     
                             "&v_pdata=" + 
                         "' get-value("v_datainf") '" +
                      
                         "&v_prec=" + "' p-rec '"  + 
                         "&v_psetcook=" + "no","waut","width=250,height=145,scrollbars=auto,alwaysRaised=true")
                         </script>'.
                 END.
             END.
         END.
