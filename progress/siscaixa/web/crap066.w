/* .............................................................................
   ...
   Programa: siscaixa/web/crap066.w
   Sistema : Caixa On-line
   Autor   : Guilherme
   Sigla   : CRED                            Ultima atualizacao: 29/07/2011.
...
&Scoped-define WEB-FILE F:/web/crap066.htm
...
ab_unmap.v_conta ab_unmap.v_coop ab_unmap.v_data ~
ab_unmap.v_log ab_unmap.v_mensagem ab_unmap.v_msg ab_unmap.v_nome ~
ab_unmap.v_operador ab_unmap.v_pac ab_unmap.v_poupanca ~
     ...
     ELSE  DO:
        ...
        ELSE DO:    
          ...
          ELSE DO: 
              ...
              RUN valida-conta IN h-b1crap66(INPUT v_coop,
                                             INPUT INT(v_pac),
                                             INPUT INT(v_caixa),
                                             INPUT INT(v_conta),
                                             OUTPUT v_nome,
                      ...
                      IF  GET-VALUE("ok") <> " "   THEN DO: 
                          ...
                          ELSE DO:
                              IF l_achou_crapmdw THEN DO:
                                 {&OUT} "<script>window.location='crap066b.w"         +
                                        "?v_pconta="      + GET-VALUE("v_conta")      + 
                                        "&v_pnome="       + c-nome                    +
                                        "&v_ppoup="       + c-poup                    +
                                        "&v_pvalor1="     + GET-VALUE("v_valor1")     +
