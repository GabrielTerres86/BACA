...
Alteracoes: 22/03/2010 - Repassar o parametro v_nrsequni e v_dtenvelo
     ...
     '<center>' SKIP
      '<table width="100%" class=cabtab>' SKIP
       ' <tr>' SKIP
         ...
         '  <td width="21%" class=programa align="right">P.051b&nbsp; V.1.00</td>' SKIP
       ' </tr>' SKIP
      '</table>' SKIP
     '</center>' SKIP
    '</div>' SKIP.
         ...
         '<div align="center">'
          '<table width="100%">'
            '<tr><td align="right" class="linhaform">'
              '<input type="button" value="Depósito" name="inclui" class="button" onClick=~'JavaScript:window.location = "crap051.w?v_pconta=" + "'get-value("v_pconta")'" + "&v_pnome=" + "' get-value("v_pnome") '" +
 "&v_ppoup=" + "' get-value("v_ppoup") '" +
 "&v_pidentifica=" + "' get-value("v_pidentifica") '" +
  "&v_pvalor=" + "'get-value("v_pvalor")'" + "&v_pvalor1=" + "'get-value("v_pvalor1")'"~'>'
             '</td>'
            '</tr>' 
          '</table>'
         '</div>' SKIP
