/* .............................................................................
   ...
   Programa: siscaixa/web/logingerente.w
   Sistema : Caixa On-line
   Sigla   : CRED   
   Autor   : Mirtes.
   Data    : Marco/2001                      Ultima atualizacao: 08/12/2010.
   ...
   Alteracoes: 09/08/2005 - Passar codigo da cooperativa como parametro para
               ...
               08/12/2010 - Tratamento para acesso através da Rotina 18 (Elton).
...
&Scoped-define WEB-FILE F:/web/logingerente.html
  ...
  IF REQUEST_METHOD = "POST":U THEN DO:
     ...
     * RUN assignFields. */
     ...
     ELSE DO:
          ...
          RUN valida-gerente  IN h-b1crap01 (INPUT crapcop.nmrescop,
         ...
         IF  RETURN-VALUE = "NOK" THEN DO:
             ...
             IF AVAIL craperr THEN DO:
                {&out} "<script>window.open('mensagem.p','werro','height=220,wi~dth=400,scrollbars=yes,alwaysRaised=true')</script>".
             END.
         END.
         ELSE DO:

             IF  GET-VALUE("v_prog") = "crap018.htm" THEN 
                 {&out} '<script>location="'"crap018.htm?preativa=" + STRING(GET-VALUE("preativa")) + " "'"; </script>'.
             ELSE   
