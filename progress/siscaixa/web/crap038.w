...
DEFINE TEMP-TABLE ab_unmap       
       ...
       FIELD v_dtini AS CHARACTER FORMAT "X(256)":U 
       FIELD v_dtfim AS CHARACTER FORMAT "X(256)":U 
       FIELD v_cdagenci AS CHARACTER FORMAT "X(256)":U 
       FIELD v_dsagenci AS CHARACTER FORMAT "X(256)":U.
...
DEF VAR  h-b1crap38 AS HANDLE     NO-UNDO.
...
&Scoped-define WEB-FILE crap038.htm

/* Name of first Frame and/or Browse and/or first Query                 */
&Scoped-define FRAME-NAME Web-Frame

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS ab_unmap.vh_arquivo ab_unmap.vh_foco ab_unmap.v_msg ab_unmap.v_data ab_unmap.v_caixa ab_unmap.v_coop ab_unmap.v_operador ab_unmap.v_pac ab_unmap.v_dtini ab_unmap.v_dtfim ab_unmap.v_cdagenci ab_unmap.v_dsagenci 
&Scoped-Define DISPLAYED-OBJECTS ab_unmap.vh_arquivo ab_unmap.vh_foco ab_unmap.v_msg ab_unmap.v_data  ab_unmap.v_caixa ab_unmap.v_coop ab_unmap.v_operador ab_unmap.v_pac ab_unmap.v_dtini ab_unmap.v_dtfim ab_unmap.v_cdagenci ab_unmap.v_dsagenci 
...
DEFINE FRAME Web-Frame
     ...
     ab_unmap.v_pac AT ROW 1 COL 1 HELP
          ...
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     ab_unmap.v_dtini AT ROW 1 COL 1 HELP
          "" NO-LABEL FORMAT "X(256)":U
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     ab_unmap.v_dtfim AT ROW 1 COL 1 HELP
          "" NO-LABEL FORMAT "X(256)":U
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     ab_unmap.v_cdagenci AT ROW 1 COL 1 HELP
          "" NO-LABEL FORMAT "X(256)":U
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     ab_unmap.v_dsagenci AT ROW 1 COL 1 HELP
          "" NO-LABEL FORMAT "X(256)":U
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
...
------------------------------------------------------------------------------*/
  ...
  RUN htmAssociate
    ("v_dtini":U,"ab_unmap.v_dtini":U,ab_unmap.v_dtini:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
    ("v_dtfim":U,"ab_unmap.v_dtfim":U,ab_unmap.v_dtfim:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
    ("v_cdagenci":U,"ab_unmap.v_cdagenci":U,ab_unmap.v_cdagenci:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
    ("v_dsagenci":U,"ab_unmap.v_dsagenci":U,ab_unmap.v_dsagenci:HANDLE IN FRAME {&FRAME-NAME}).  
END PROCEDURE.
...
------------------------------------------------------------------------*/
    ...
    IF  get-value("cancela") = "" THEN DO:
        ...
        ELSE DO:
            ...
            ELSE DO:   
                ...
                RUN dbo/b1crap38.p PERSISTENT SET h-b1crap38.
                RUN busca-nome-pa IN h-b1crap38(INPUT v_coop,
                                                INPUT INTEGER(v_cdagenci),
                                                OUTPUT v_dsagenci).
                DELETE PROCEDURE h-b1crap38.
                
                IF  get-value("botao") = "Visualizar"  THEN DO:              
                END. /* Visualizar */
                
                
                IF  get-value("botao") = "Impressao"  THEN DO:
                
                    RUN dbo/b1crap38.p PERSISTENT SET h-b1crap38.
                    
                    RUN gera-arquivo-texto IN h-b1crap38(INPUT v_coop,
                                                         INPUT v_pac,
                                                         INPUT v_caixa,
                                                         INPUT v_dtini,
                                                         INPUT v_dtfim,
  ...
  ELSE DO:
    ...
    ASSIGN vh_foco = "7"
           v_dtini = STRING(TODAY)
           v_dtfim = STRING(TODAY)
           v_cdagenci = "0".
