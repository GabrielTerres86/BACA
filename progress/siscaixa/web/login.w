/* .............................................................................
   ...
   Programa: siscaixa/web/login.w
   Sistema : Caixa On-line
   Sigla   : CRED   
   Autor   : Mirtes.
   Data    : Marco/2001                      Ultima atualizacao: 17/10/2006.
   ...
   Alteracoes: 09/08/2005 - Passar codigo da cooperativa como parametro para
               ...
               17/10/2006 - Leitura da crapcop de acordo com o cookie (Evandro)
...
&Scoped-define WEB-FILE login.htm

/* Name of first Frame and/or Browse and/or first Query                 */
&Scoped-define FRAME-NAME Web-Frame

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS ab_unmap.v_nome ab_unmap.v_senha 
&Scoped-Define DISPLAYED-OBJECTS ab_unmap.v_nome ab_unmap.v_senha 
  ...
  IF REQUEST_METHOD = "POST":U THEN DO:
     ...
     *     setAddMode(TRUE).   */
     ...
     ELSE DO:
         ...
         END.
         ELSE DO:
            {&out} '<script>location="'get-value("v_prog")'"; </script>'.
         END.
     END.
