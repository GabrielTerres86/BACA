...
DEF VAR h-b1crap79 AS HANDLE          NO-UNDO.
...
&Scoped-define WEB-FILE F:/web/crap079.htm

/* Name of first Frame and/or Browse and/or first Query                 */
&Scoped-define FRAME-NAME Web-Frame

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS ab_unmap.vh_foco ab_unmap.v_caixa ab_unmap.v_conta ab_unmap.v_coop ab_unmap.v_data ab_unmap.v_docto ab_unmap.v_msg ab_unmap.v_nome ab_unmap.v_operador ab_unmap.v_pac ab_unmap.v_mensagem ab_unmap.v_valor 
&Scoped-Define DISPLAYED-OBJECTS ab_unmap.vh_foco ab_unmap.v_caixa ab_unmap.v_conta ab_unmap.v_coop ab_unmap.v_data ab_unmap.v_docto ab_unmap.v_msg ab_unmap.v_nome ab_unmap.v_operador ab_unmap.v_pac ab_unmap.v_mensagem ab_unmap.v_valor 
...
------------------------------------------------------------------------*/
  ...
  IF REQUEST_METHOD = "POST":U THEN DO:
   ...
   RUN valida-transacao2 IN h-b1crap00(INPUT v_coop, /* 20/06/2018 - Alterado para a procedeure valida-transacao2 - Everton Deserto(AMCOM).*/
                                      INPUT v_pac,
                                      INPUT v_caixa).
   ...
   ELSE DO:
       ...
       ELSE DO:
           ...
           END.
           ELSE DO:
                RUN dbo/b1crap79.p PERSISTENT SET h-b1crap79.
                
                RUN valida-estorno IN h-b1crap79(INPUT v_coop,
                                                 INPUT  INT(v_pac), 
                                                 INPUT  INT(v_caixa),
                                                 INPUT  INT(v_conta),
                                                 INPUT  INT(v_docto),
                ...
                ASSIGN  v_valor = STRING(DEC(p-valor),"zzz,zzz,zzz,zz9.99").
                             ...
                             IF  RETURN-VALUE = "OK" THEN  DO:
                                 RUN grava-autenticacao 
                                  IN h-b1crap00 (INPUT v_coop,
                                                 ...
                                                 INPUT 0, /* Seq.org.Off-line*/                                                 OUTPUT p-literal,
