...
DEF TEMP-TABLE ab_unmap
    ...
    FIELD v_vlcomput  AS CHAR
    FIELD v_vlenvelo  AS CHAR
    FIELD v_nrterfin  AS CHAR.
...
------------------------------------------------------------------------------*/
  ...
  IF GET-VALUE("inclui") <> "" THEN DO:
     ...
     ELSE DO:
         {&OUT} "<script>window.location='crap061.w"           +
                ...
                "&v_valor1="      + GET-VALUE("v_vlenvelo")    +
                "&v_valor2="      + GET-VALUE("v_valor2")      +
                "&v_nrsequniC="   + GET-VALUE("v_nrsequni")    +
                "&v_dtmvtoltC="   + GET-VALUE("v_dtenvelo")    +
                "&p-flg-cta-migrada=" + GET-VALUE("p-flg-cta-migrada") +
                "&p-flg-coop-host="   + GET-VALUE("p-flg-coop-host")   +
                "&p-coop-migrada="    + GET-VALUE("p-coop-migrada")    +
                "&v_nrterfin="    + GET-VALUE("v_nrterfin")    +
                "&v_valorcomput=" + GET-VALUE("v_vlcomput")    +
                "'</script>".
     END.
  END.
  ...
  {&OUT}
    '<div align="center">' SKIP
     '<center>' SKIP
      '<table width="100%" class=cabtab>' SKIP
       ' <tr>' SKIP
         '  <td class=titulo>DEPÓSITO COM CAPTURA</td>' SKIP
         '  <td width="21%" class=programa align="right">P.061b&nbsp; V.1.00</td>' SKIP
       ' </tr>' SKIP
      '</table>' SKIP
     '</center>' SKIP
    '</div>' SKIP.
  ...
  {&OUT}
   '<div align="center">' SKIP
    ...
    '<p align="left">'
    '<input type="text" name="v_identifica" size="52" class="input" 
     maxlength="52" 
      value="' get-value("v_pidentifica") '" 
      ...
      disabled></p>'
            ...
            '<tr>'
              '<td align="right" class="linhaform" width="23%">Cheque Computado:</td>'
              '<td align="left" class="linhaform" width="77%">'
         ...
         '<div align="center">'
          '<table width="100%">'
            '<tr><td align="right" class="linhaform">'
              '<input type="button" value="Depósito" name="inclui" class="button" onClick=~'JavaScript:window.location = "crap061.w?v_pconta=" + "'get-value("v_pconta")'" + 
                     "&v_pnome="       + "' get-value("v_pnome") '" + 
                     "&v_ppoup="       + "' get-value("v_ppoup") '" + 
                     "&v_pidentifica=" + "' get-value("v_pidentifica") '" + 
                     "&v_valorcomput=" + "'get-value("v_vlcomput")'" + 
                     "&v_valorproc="   + "'get-value("v_saldo")'" + 
                     "&v_nrterfin="    + "'get-value("v_nrterfin")'" + 
                     "&v_nrsequniC="   + "'get-value("v_nrsequni")'" + 
                     "&v_dtmvtoltC="   + "'get-value("v_dtenvelo")'" +
                     "&p-flg-cta-migrada=" + "'get-value("p-flg-cta-migrada")'" +
