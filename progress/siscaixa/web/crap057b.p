...
------------------------------------------------------------------------------*/
  ...
  IF get-value("inclui") <> "" THEN
  DO:
      RUN critica-saldo-cheque IN h-b1crap57(INPUT v_coop,
                                             INPUT INT(v_pac),
                                             INPUT INT(v_caixa),
      ...
      DO:
          ...
          {&OUT}
          '<script>window.location="crap057a.w?v_pconta=" + "'get-value("v_pconta")'" + "&v_pnome=" + "' get-value("v_pnome") '" + "&v_ppoup=" + "' get-value("v_ppoup") '" +
  "&v_pidentifica=" + "'get-value("v_pidentifica")'" +
  "&v_pvalor=" + "'get-value("v_pvalor")'" +
  "&v_pvalor1=" + "'get-value("v_pvalor1")'"</script>'.
      END.
  END.
  IF get-value("exclui") <> "" THEN
  DO:
  ...
  DO:
      ...
      DO:
          ...
          {&OUT}
          '<script>window.location="crap057c.w?v_pconta=" + "'get-value("v_pconta")'" + "&v_pnome=" + "' get-value("v_pnome") '" + "&v_ppoup=" + "' get-value("v_ppoup") '" +
  "&v_pidentifica=" + "'get-value("v_pidentifica")'" +
 "&v_pvalor=" + "'get-value("v_pvalor")'" +
  "&v_pvalor1=" + "'get-value("v_pvalor1")'"</script>'.
      END.
  ...
  {&OUT}
    '<div align="center">' SKIP
     '<center>' SKIP
      '<table width="100%" class=cabtab>' SKIP
       ' <tr>' SKIP
         '  <td class=titulo>CHEQUE LIBERADO DIVERSOS</td>' SKIP
         '  <td width="21%" class=programa align="right">P.057b&nbsp; V.1.00</td>' SKIP
       ' </tr>' SKIP
      '</table>' SKIP
     '</center>' SKIP
    '</div>' SKIP.
     ...
     '<table width=100% cellspacing = 0 cellpadding = 0>' SKIP
      '<tr>' SKIP
       '  <td width="100%" valign="middle" align="center">' SKIP
        ...
        '<p align="left">'
        '<input type="text" name="v_identifica" size="50" class="input" 
         maxlength="50" value="'get-value("v_pidentifica") '"   
         disabled></p>'
         '</td>'
            '</tr>'
     ...
     {&OUT}
         ...
         '<div align="center">'
          '<table width="100%">'
              ...
              '<input type="button" value="Depósito" name="inclui" class="butto~n" onClick=~'JavaScript:window.location = "crap057.w?v_pconta=" + "'get-value("~v_pconta")'" + "&v_pnome=" + "' get-value("v_pnome") '" + "&v_ppoup=" + "' get-~value("v_ppoup") '" +
 "&v_pvalor=" + "'get-value("v_pvalor")'" +
 "&v_pidentifica=" + "'get-value("v_pidentifica")'" +
