...
&Scoped-define WEB-FILE F:/web/crap081.html

/* Name of first Frame and/or Browse and/or first Query                 */
&Scoped-define FRAME-NAME Web-Frame

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS ab_unmap.radio ab_unmap.vh_foco ab_unmap.v_caixa ab_unmap.v_codbarras ab_unmap.v_coop ab_unmap.v_data ab_unmap.v_msg ab_unmap.v_operador ab_unmap.v_pac 
&Scoped-Define DISPLAYED-OBJECTS ab_unmap.radio ab_unmap.vh_foco ab_unmap.v_caixa ab_unmap.v_codbarras ab_unmap.v_coop ab_unmap.v_data ab_unmap.v_msg ab_unmap.v_operador ab_unmap.v_pac 
         ...
         ELSE DO:
             ...
             ELSE DO:
                 IF  get-value("manual") <> "" THEN DO:
                     ...
                     IF  get-value("radio") = "1" THEN DO:
                         {&OUT}
                        '<script>window.location =
                                "crap081a.html?v_pradio=" +  
                                "'get-value("radio")'"    + 
                                "&v_pbarras="             +
