/* .............................................................................
   ...
   Programa: siscaixa/web/crap057a2.w
...
&Scoped-define WEB-FILE F:/web/crap057a2.htm

/* Name of first Frame and/or Browse and/or first Query                 */
&Scoped-define FRAME-NAME Web-Frame

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS ab_unmap.vh_foco ab_unmap.v_agenc ab_unmap.v_banco ab_unmap.v_c1 ab_unmap.v_c2 ab_unmap.v_c3 ab_unmap.v_caixa ab_unmap.v_cheque ab_unmap.v_cmc7 ab_unmap.v_cod1 ab_unmap.v_cod2 ab_unmap.v_cod3 ab_unmap.v_comp ab_unmap.v_conta ab_unmap.v_conta1 ab_unmap.v_coop ab_unmap.v_data ab_unmap.v_identifica ab_unmap.v_mensagem1 ab_unmap.v_mensagem2 ab_unmap.v_msg ab_unmap.v_nome ab_unmap.v_operador ab_unmap.v_pac ab_unmap.v_poupanca ab_unmap.v_valor ab_unmap.v_valor1 ab_unmap.v_valor2 
...
------------------------------------------------------------------------*/
  ...
  ASSIGN c-cmc-7      = GET-VALUE("v_cmc7").
  ASSIGN c-cod-1      = SUBSTR(c-cmc-7,2,8).
  ASSIGN c-cod-2      = SUBSTR(c-cmc-7,11,10).
  ASSIGN c-cod-3      = SUBSTR(c-cmc-7,22,12).

  ASSIGN v_mensagem1        =  GET-VALUE("p-mensagem") + 
                               GET-VALUE("p-mensagem1")
         v_mensagem2        =  GET-VALUE("p-mensagem2")
         p-mensagem-saldo   =  GET-VALUE("p-mensagem")
         p-valor-disponivel =  GET-VALUE("p-valor-disponivel").
           
  ASSIGN i-cdcmpchq  =  GET-VALUE("v_cdcmpchq").           
  ASSIGN i-cdbanchq  =  GET-VALUE("v_cdbanchq").
  ASSIGN i-cdagechq  =  GET-VALUE("v_cdagechq").
  ASSIGN i-nrddigc1  =  GET-VALUE("v_nrddigc1").
  ASSIGN de-nrctabdb =  GET-VALUE("v_nrctabdb").
  ASSIGN i-nrddigc2  =  GET-VALUE("v_nrddigc2").
  ASSIGN i-nrcheque  =  GET-VALUE("v_nrcheque").
  ASSIGN i-nrddigc3  =  GET-VALUE("v_nrddigc3").
  ...
  IF REQUEST_METHOD = "POST":U THEN DO:
    ...
    ASSIGN v_valor2   = 
                    STRING(DEC(GET-VALUE("v_pvalor2")),"zzz,zzz,zzz,zz9.99").

    ASSIGN substr(c-cmc-7,34,1) = ":".
    ASSIGN v_cmc7    =  c-cmc-7
           v_cod1    =  c-cod-1
           v_cod2    =  c-cod-2
           v_cod3    =  c-cod-3
           v_comp    =  i-cdcmpchq          
    ...
    DO:
         ...
         RUN critica-codigo-cheque-dig IN h-b1crap57(INPUT v_coop,
                                                     INPUT v_pac,
                                                     INPUT v_caixa,
                                                     INPUT c-cmc-7).
             ...
             ELSE DO:
                 ...
                 RUN valida-deposito-com-captura 
                              IN h-b1crap57(INPUT v_coop,
                                            ...
                                            INPUT c-cmc-7,
                                            INPUT " ",
                                            INPUT INT(v_comp),                                                              INPUT INT(v_banco),       
                                            INPUT INT(v_agenc),       
                                            INPUT INT(v_c1),       
                                            INPUT DEC(v_conta1),       
                                            INPUT INT(v_c2),       
                     ...
                     IF  GET-VALUE("ok") <> " " THEN DO:
                         ...
                         RUN valida-deposito-com-captura
                                IN h-b1crap57(INPUT v_coop,
                                              ...
                                              OUTPUT de-valor-disponivel).
                         IF  p-mensagem-saldo <> " "  THEN
                             ASSIGN v_mensagem1 = v_mensagem1 +
                                                 p-mensagem-saldo.                                            
                     END.
                 END.  /* return-value = "OK" */
  ...
  ELSE DO:
    ...
    ASSIGN v_nome        = GET-VALUE("v_pnome").
    ASSIGN v_poupanca    = GET-VALUE("v_ppoup").
    ASSIGN v_pidentifica = GET-VALUE("v_pidentifica").
    ASSIGN v_valor    =
                    STRING(DEC(GET-VALUE("v_pvalor")),"zzz,zzz,zzz,zz9.99").
    ASSIGN v_valor1   = 
                    STRING(DEC(GET-VALUE("v_pvalor1")),"zzz,zzz,zzz,zz9.99").
