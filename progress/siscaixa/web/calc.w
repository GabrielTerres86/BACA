...
DEFINE TEMP-TABLE ab_unmap
       FIELD answer AS CHARACTER FORMAT "X(256)":U 
       FIELD mem AS CHARACTER FORMAT "X(256)":U .
...
&Scoped-define WEB-FILE calc.htm

/* Name of first Frame and/or Browse and/or first Query                 */
&Scoped-define FRAME-NAME Web-Frame

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS ab_unmap.answer ab_unmap.mem 
&Scoped-Define DISPLAYED-OBJECTS ab_unmap.answer ab_unmap.mem 
...
DEFINE FRAME Web-Frame
     ab_unmap.answer AT ROW 1 COL 1 HELP
          "" NO-LABEL FORMAT "X(256)":U
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     ab_unmap.mem AT ROW 1 COL 1 HELP
          "" NO-LABEL FORMAT "X(256)":U
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
...
/* SETTINGS FOR FRAME Web-Frame
   UNDERLINE                                                            */
/* SETTINGS FOR fill-in ab_unmap.answer IN FRAME Web-Frame
   ALIGN-L EXP-LABEL EXP-FORMAT EXP-HELP                                */
/* SETTINGS FOR fill-in ab_unmap.mem IN FRAME Web-Frame
   ALIGN-L EXP-LABEL EXP-FORMAT EXP-HELP                                */
...
------------------------------------------------------------------------------*/
  ...
  RUN htmAssociate
    ("answer":U,"ab_unmap.answer":U,ab_unmap.answer:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
    ("mem":U,"ab_unmap.mem":U,ab_unmap.mem:HANDLE IN FRAME {&FRAME-NAME}).
END PROCEDURE.
