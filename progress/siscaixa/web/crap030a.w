/*..............................................................................
   ...
   Programa: siscaixa/web/crap030a.w
   Sistema : Caixa On-Line
   Sigla   : CRED
   Autor   : Lucas Lunelli
   Data    : Maio/2016                          Ultima atualizacao:

   Dados referentes ao programa: [PROJ320]
...
DEFINE TEMP-TABLE ab_unmap
       ...
       FIELD inflgsms    AS CHARACTER FORMAT "X(256)":U 
...
DEFINE VARIABLE aux_nrdddtfc      AS INTE                        NO-UNDO.
DEFINE VARIABLE aux_nrtelefo      AS INTE                        NO-UNDO.
...
&Scoped-define WEB-FILE F:/web/crap030a.htm
...
&Scoped-Define ENABLED-OBJECTS ab_unmap.inflgsms ab_unmap.vh_foco ab_unmap.v_caixa  ab_unmap.v_coop ab_unmap.v_data ab_unmap.v_msg ab_unmap.v_operador ab_unmap.v_pac
&Scoped-Define DISPLAYED-OBJECTS ab_unmap.inflgsms ab_unmap.vh_foco ab_unmap.v_caixa ab_unmap.v_coop ab_unmap.v_data ab_unmap.v_msg ab_unmap.v_operador ab_unmap.v_pac
...
DEFINE FRAME Web-Frame    
    ab_unmap.inflgsms AT ROW 1 COL 1 HELP
          "" NO-LABEL
...
------------------------------------------------------------------------------*/
  ...
  RUN htmAssociate
    ("inflgsms":U,"ab_unmap.inflgsms":U,ab_unmap.inflgsms:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
...
------------------------------------------------------------------------*/
   ...
   */
    ...
    IF  GET-VALUE("cancela") <> "" THEN
        DO:
            ...
            {&OUT} '<script> window.location = "crap030.html" </script>'. 
        END.
     ELSE
        DO:
            ASSIGN aux_foco = "".
            ...
            IF  inflgsms = "1" THEN
                DO:
                    {&OUT} '<script> window.location = "crap062.htm"</script>'.
                END.
            ELSE
                DO:
                    {&OUT} '<script> window.location = "crap030.html" </script>'. 
  ...
  ELSE DO:
    ...
    IF  INTE(aux_nrdddtfc) <> 0 OR
        INTE(aux_nrtelefo) <> 0 THEN
        DO:
