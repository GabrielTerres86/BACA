/*----------------------------------------------------------------------------
    13/12/2013 - Adiocionado validate para tabela craperr (Tiago).
----------------------------------------------------------------------------*/
...
DEFINE TEMP-TABLE ab_unmap
       ...
       FIELD v_nro_docto AS CHARACTER FORMAT "X(256)":U 
...
DEF VAR h-b1crap74 AS HANDLE            NO-UNDO.
...
DEF VAR v_histor        AS INTE         NO-UNDO.
...
&Scoped-define WEB-FILE crap074.htm

/* Name of first Frame and/or Browse and/or first Query                 */
&Scoped-define FRAME-NAME Web-Frame

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS ab_unmap.vh_foco ab_unmap.v_caixa ab_unmap.v_conta ab_unmap.v_coop ab_unmap.v_data ab_unmap.v_msg ab_unmap.v_nome ab_unmap.v_nro_docto ab_unmap.v_operador ab_unmap.v_pac ab_unmap.v_valor 
&Scoped-Define DISPLAYED-OBJECTS ab_unmap.vh_foco ab_unmap.v_caixa ab_unmap.v_conta ab_unmap.v_coop ab_unmap.v_data ab_unmap.v_msg ab_unmap.v_nome ab_unmap.v_nro_docto ab_unmap.v_operador ab_unmap.v_pac ab_unmap.v_valor 
...
DEFINE FRAME Web-Frame
     ...
     ab_unmap.v_nome AT ROW 1 COL 1 HELP
          ...
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     ab_unmap.v_nro_docto AT ROW 1 COL 1 HELP
          "" NO-LABEL FORMAT "X(256)":U
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
...
/* SETTINGS FOR FILL-IN ab_unmap.v_nome IN FRAME Web-Frame
   ALIGN-L EXP-LABEL EXP-FORMAT EXP-HELP                                */
/* SETTINGS FOR FILL-IN ab_unmap.v_nro_docto IN FRAME Web-Frame
   ALIGN-L EXP-LABEL EXP-FORMAT EXP-HELP                                */
...
------------------------------------------------------------------------------*/
  ...
  RUN htmAssociate
    ("v_nro_docto":U,"ab_unmap.v_nro_docto":U,ab_unmap.v_nro_docto:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
   ...
   ELSE DO:
       ...
       ELSE DO:
           ...
           ELSE DO:
               ...
               RUN dbo/b1crap74.p PERSISTENT SET h-b1crap74.
               
               RUN valida-cheque-avulso IN h-b1crap74(INPUT   v_coop,
                                                      INPUT   v_pac,    
                                                      INPUT   v_caixa,
                                                      INPUT   v_conta,
                                                      INPUT   v_nro_docto,
               ...
               ELSE DO:
                   ...
                   IF  get-value("ok") <> "" THEN DO:
                       ...
                       DO TRANSACTION ON ERROR UNDO:
                          ...
                          RUN estorna-cheque-avulso 
                          IN h-b1crap74(INPUT v_coop,
                                        INPUT  int(v_pac),    
                                        INPUT  int(v_caixa),
                                        INPUT  v_operador,
                                        INPUT  int(v_conta),
                                        INPUT  int(v_nro_docto),
                                        INPUT  dec(v_valor)).
                          ASSIGN v_valor =
                          ...
                          IF  RETURN-VALUE = "OK" THEN DO:
                              RUN grava-autenticacao  
                               IN h-b1crap00 (INPUT v_coop,
                                              ...
                                              INPUT dec(v_valor),
                                              INPUT dec(v_nro_doc),
                                              INPUT yes, /* YES (PG),NO (REC) */                                               INPUT "1",  /* On-line        */ 
                                              INPUT yes,    /* Estorno       */
                                              INPUT v_histor, /*Hist¢rico */ 
                                              INPUT ?, /* Data off-line */
