/* .............................................................................
   ...
   Programa: siscaixa/web/crap073a.w
   ...
   Alteracoes: 30/08/2005 - Tratamentos para unificacao dos bancos, passar
               ...
               26/02/2007 - Passar o banco e agencia do cheque para a procedure
                            estorna-pagto-cheque (Evandro).
...
DEFINE VARIABLE h-b1crap73 AS HANDLE     NO-UNDO.
...
DEF VAR p-docto          AS INT     NO-UNDO.
DEF VAR p-histor         AS INT     NO-UNDO.
...
&Scoped-define WEB-FILE crap073a.htm

/* Name of first Frame and/or Browse and/or first Query                 */
&Scoped-define FRAME-NAME Web-Frame

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS ab_unmap.vh_foco ab_unmap.v_agenc ab_unmap.v_banco ab_unmap.v_c1 ab_unmap.v_c2 ab_unmap.v_c3 ab_unmap.v_caixa ab_unmap.v_cmc7 ab_unmap.v_cod1 ab_unmap.v_cod2 ab_unmap.v_cod3 ab_unmap.v_comp ab_unmap.v_conta ab_unmap.v_conta1 ab_unmap.v_coop ab_unmap.v_data ab_unmap.v_msg ab_unmap.v_operador ab_unmap.v_pac ab_unmap.v_valor 
    ...
    {include/assignfields.i}
     ...
     ELSE DO:
         IF  get-value("estorno") <> "" THEN DO:
             {&OUT}
             '<script>window.location = "crap073.w?v_cmc7=" +
              "'get-value("v_cmc7")'" + "&v_codigo=" + "'get-value("v_codigo")'"
              </script>'.
         END.
         ELSE DO:
             ...
             RUN dbo/b1crap73.p PERSISTENT SET h-b1crap73.
             RUN critica-codigo-cheque-dig IN h-b1crap73(INPUT v_coop,
                                                         INPUT v_pac,
                                                         INPUT v_caixa,
                                                         INPUT p-cmc-7-dig).
             DELETE PROCEDURE h-b1crap73.
             ...
             ELSE DO:
                 ...
                 RUN dbo/b1crap73.p PERSISTENT SET h-b1crap73.
                 RUN valida-codigo-cheque IN h-b1crap73(INPUT v_coop,       
                                                        INPUT v_pac,
                                                        INPUT v_caixa,
                                                        INPUT " ",
                                                        INPUT p-cmc-7-dig,
                ...
                ELSE DO:
                     ...
                     RUN dbo/b1crap73.p PERSISTENT SET h-b1crap73.
                     RUN valida-estorno-pagto-cheque
                            IN h-b1crap73(INPUT v_coop,      
                                          INPUT INT(v_pac),
                                          INPUT INT(v_caixa),
                                          INPUT " ",
                                          INPUT p-cmc-7-dig,
                    ...
                    ELSE DO:
                        ...
                        DO:
                            ...
                            DO  TRANSACTION ON ERROR UNDO:
                                ...
                                RUN dbo/b1crap73.p PERSISTENT SET h-b1crap73.
                                RUN estorna-pagto-cheque  IN h-b1crap73(
                                                          INPUT v_coop,    
                                                          INPUT INT(v_pac),
                                                          INPUT INT(v_caixa),
                                                          INPUT v_operador,
                                ...
                                IF  RETURN-VALUE = "NOK" THEN DO:
                                    ...
                                    FOR EACH craperr NO-LOCK WHERE
                                        ...
                                        CREATE w-craperr.
                                        ASSIGN 
                                         w-craperr.cdcooper = craperr.cdcooper
                            ...
                            IF  l-houve-erro = YES  THEN DO:
                                FOR EACH w-craperr NO-LOCK:
                                    CREATE craperr.
                                    ASSIGN 
                                       craperr.cdcooper = w-craperr.cdcooper
                            ...
                            '<script>window.open("autentica.html?v_plit="
                             + "' p-literal '" + 
                                      "&v_pseq=" + 
                                      "' p-ult-sequencia '" +
                                       "&v_prec=" + "NO"  + "&v_psetcook=" + "yes","waut","width=250,height=145,scrollbars=auto,alwaysRaised=true")
                                 </script>'.

                                {&OUT}
                                       '<script>window.location = "crap073.html"
                                       </script>'.
                            END.
                        END.
                    END.
