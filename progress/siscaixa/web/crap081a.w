...
Alterações: 05/09/2013 - Nova forma de chamar as agências, de PAC agora 
            ...
            29/11/2013 - Adicionado "DO TRANSACTION" no CREATE craperr
                         na procedure estorna-titulos. (Reinert)                         
...
DEFINE VARIABLE c-codigo-barras AS CHARACTER  NO-UNDO.
...
&Scoped-define WEB-FILE F:/web/crap081a.html
...
------------------------------------------------------------------------*/
  ...
  IF REQUEST_METHOD = "POST":U THEN DO:
    ...
    ELSE DO:
        ...
        END.
        ELSE DO:
           ASSIGN de-tit1 = dec(get-value("v_tit1"))
                  de-tit2 = dec(get-value("v_tit2"))
                  de-tit3 = dec(get-value("v_tit3"))
                  de-tit4 = dec(get-value("v_tit4"))
                  de-tit5 = dec(get-value("v_tit5"))
                  c-codigo-barras = "".
           ...
           RUN retorna-valores-titulo 
                 IN h_b1crap81 (INPUT v_coop,
                                ...
                                INPUT int(v_pac),
                                INPUT INT(v_caixa),
                                INPUT-OUTPUT de-tit1,
                                INPUT-OUTPUT de-tit2,
                                INPUT-OUTPUT de-tit3,
                                INPUT-OUTPUT de-tit4,
                                INPUT-OUTPUT de-tit5,
                                INPUT-OUTPUT c-codigo-barras,
                                OUTPUT de-valor-pago,
                                OUTPUT de-valordoc,
                                OUTPUT p_autchave,
                                OUTPUT p_cdchave).
           ...
           ASSIGN v_valordoc  = STRING(DEC(de-valordoc),"zzz,zzz,zzz,zz9.99")
                  v_valorpago =            
                    STRING(DEC(de-valor-pago),"zzz,zzz,zzz,zz9.99").
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE estorna-titulos w-html 
PROCEDURE estorna-titulos :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>                       
  Notes:       
