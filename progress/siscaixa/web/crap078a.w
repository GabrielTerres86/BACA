...
DEF VAR de-sequencia AS CHAR NO-UNDO.
...
&Scoped-define WEB-FILE crap078a.htm

/* Name of first Frame and/or Browse and/or first Query                 */
&Scoped-define FRAME-NAME Web-Frame

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS ab_unmap.vh_foco ab_unmap.v_agenc ab_unmap.v_banco ab_unmap.v_c1 ab_unmap.v_c2 ab_unmap.v_c3 ab_unmap.v_caixa ab_unmap.v_sequencia ab_unmap.v_cmc7 ab_unmap.v_cod1 ab_unmap.v_cod2 ab_unmap.v_cod3 ab_unmap.v_comp ab_unmap.v_conta ab_unmap.v_conta1 ab_unmap.v_coop ab_unmap.v_data ab_unmap.v_msg ab_unmap.v_operador ab_unmap.v_pac /*ab_unmap.v_valor*/ 
...
------------------------------------------------------------------------*/
  ...
  ASSIGN de-sequencia    = get-value("v_sequencia").
  ASSIGN v_sequencia = STRING(INTE(v_sequencia),"zzzzz9").
  ...
  IF REQUEST_METHOD = "POST":U THEN DO:
    ...
    DO:
        IF   get-value("estorno") <> ""   THEN
             DO:
                 {&OUT}
             '<script>window.location = "crap078.w?v_cmc7=" + "'get-value("v_cmc7")'" + "&v_codigo=" + "'get-value("v_codigo")'"
                 </script>'.
             END.
        ELSE 
        DO:
           ...
           DO:  
              ...
              RUN dbo/b1crap78.p PERSISTENT SET h-b1crap78.
              RUN valida-codigo-cheque-valor IN h-b1crap78(INPUT v_coop,
                                                           INPUT v_pac,
                                                           INPUT v_caixa,
                                                           INPUT v_sequencia,
                                                           INPUT " ",
                                                           INPUT p-cmc-7-dig,
                                                           OUTPUT v_comp,    
                                                           OUTPUT v_banco,                                                                 OUTPUT v_agenc,                                                                OUTPUT v_c1,       
                                                           OUTPUT v_conta,                                                                OUTPUT v_c2,       
                                                           OUTPUT v_conta1,                                                                OUTPUT v_c3).                    DELETE PROCEDURE h-b1crap78.
  ...
  ELSE DO:
     ...
     * STEP 2a -
     * Set any values that need to be set, then display them. */
    ASSIGN v_sequencia = de-sequencia.
    ASSIGN v_sequencia = STRING(DEC(v_sequencia),"zzzzz9").
    ASSIGN vh_foco = "9".
