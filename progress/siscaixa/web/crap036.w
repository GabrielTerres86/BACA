/*-----------------------------------------------------------------------------
 Alteracoes: 26/06/2018 - Alterado para chamar a procedure valida-transacao2 e assim permitir
...
DEFINE VARIABLE h-b1crap36  AS HANDLE     NO-UNDO.
...
&Scoped-define WEB-FILE F:/web/crap036.htm
  ...
  IF REQUEST_METHOD = "POST":U THEN DO:
     ...
     * RUN assignFields. */
     ...
     ELSE DO:
         ...
         v_lote = STRING(24000 + INT(v_caixa)).
        
         RUN dbo/b1crap00.p PERSISTENT SET h-b1crap00.
         RUN valida-transacao2 IN h-b1crap00(INPUT v_coop, /* 26/06/2018 - Alterado para a procedure valida-transacao2 - Everton Deserto(AMCOM).*/
                                            INPUT v_pac,
                                            INPUT v_caixa).
         ...
         ELSE DO:
            ...
            ELSE DO:
                ...
                RUN dbo/b1crap36.p PERSISTENT SET h-b1crap36.                   
                ...
                RUN impressao IN h-b1crap36 (INPUT  v_coop,
                                             INPUT  v_operador,
                                             INPUT  int(v_pac),
                                             INPUT  INT(v_caixa),
                                             INPUT  INT(v_lote),
