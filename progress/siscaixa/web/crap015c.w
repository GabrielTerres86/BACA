...
DEFINE VARIABLE p-cdseqfat AS DECIMAL    NO-UNDO.
DEFINE VARIABLE p-vlfatura AS DECIMAL    NO-UNDO.
DEFINE VARIABLE p-nrdigfat AS INTEGER    NO-UNDO.
DEFINE VARIABLE p-iptu     AS LOGICAL    NO-UNDO.
...
------------------------------------------------------------------------*/
 ...
 {include/i-global.i}
  ...
  ASSIGN c-codigo-barras                            = get-value("v_codbarras").
  ASSIGN vh_foco                                    = "11".
  ...
  IF REQUEST_METHOD = "POST":U THEN DO:
    ...
    DO:
        ...
        RUN valida-codigo-barras IN h_b1crap15(INPUT v_coop,
                                               INPUT v_operador,
                                               INPUT INT(v_pac),
                                               INPUT INT(v_caixa),
            ...
            DO:
                ...
                RUN retorna-valores-fatura 
                   IN h_b1crap15(INPUT v_coop,
                                 ...
                                 INPUT int(v_pac),
                                 INPUT int(v_caixa),
                                 INPUT dec(get-value("v-fat1")),
                                 INPUT dec(get-value("v-fat2")),
                                 INPUT dec(get-value("v-fat3")),
                                 INPUT dec(get-value("v-fat4")),
                ...
                ASSIGN v_valordoc  =
                       STRING(DEC(v_valordoc),"zzz,zzz,zzz,zz9.99")
                       v_valorpago =
                       STRING(DEC(v_valorpago),"zzz,zzz,zzz,zz9.99")
                       v_seq       = STRING(p-cdseqfat)
                       v_dig       = STRING(p-nrdigfat).
            END.
            ELSE /* IPTU */
            DO:
                ASSIGN de-tit1 = 0
                ...
                RUN retorna-valores-titulo-iptu 
                    IN h_b2crap15(INPUT v_coop,
                                  ...
                                  INPUT YES,
                                  INPUT v_cadastro,
                                  INPUT v_cadastro_conf,
                                  OUTPUT de-valor-pago,
                                  OUTPUT de-valordoc).
                DELETE PROCEDURE h_b2crap15.

                ASSIGN v_valordoc  = STRING(de-valordoc,"zzz,zzz,zzz,zz9.99").
                ASSIGN v_valorpago = STRING(de-valor-pago,"zzz,zzz,zzz,zz9.99").
            END.
                    ...
                    DO:
                        ...
                        DO  TRANSACTION ON ERROR UNDO:
                            ...
                            DO:
                                ...
                                ASSIGN v_valordoc =
                                    STRING(de-valordoc,"zzz,zzz,zzz,zz9.99").
                                ASSIGN v_valorpago =
                                    STRING(de-valor-pago,"zzz,zzz,zzz,zz9.99").
