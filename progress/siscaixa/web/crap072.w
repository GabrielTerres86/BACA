...
DEF VAR h-b1crap72 AS HANDLE          NO-UNDO.
...
DEF VAR p-data1         AS DATE.
DEF VAR p-data2         AS DATE.
DEF VAR p-data3         AS DATE.
DEF VAR p-data4         AS DATE.
DEF VAR p-dsidenti      AS CHAR.
...
------------------------------------------------------------------------*/
  ...
  IF REQUEST_METHOD = "POST":U THEN DO:
     ...
     * RUN assignFields. */
     ...
     {include/assignfields.i} 
         /* Colocado a chamada do assignFields dentro da in~clude */
   ...
   ELSE DO:
       ...
       ELSE DO:
           ...
           END.
           ELSE DO:
               RUN dbo/b1crap72.p PERSISTENT SET h-b1crap72.
               RUN valida-cheque-sem-captura 
                           IN h-b1crap72(INPUT v_coop,
                                         INPUT  INT(v_pac), 
                                         INPUT  INT(v_caixa),
                                         INPUT  INT(v_conta),
                                         INPUT  INT(v_docto),
                                         ...
                                         OUTPUT p-poupanca,
                                         OUTPUT p-dsidenti).
               ASSIGN v_identifica = p-dsidenti.
               ASSIGN v_chequesmenores =
                  ...
                  ELSE DO:
                      ...
                      IF  get-value("ok") <> "" THEN DO:
                          ...
                          DO TRANSACTION ON ERROR UNDO:
                             RUN estorna-cheque-sem-captura
                                 IN h-b1crap72 (INPUT v_coop,
                                                INPUT  INT(v_pac),    
                                                INPUT  INT(v_caixa),
                                                INPUT  v_operador,
                          ...
                          IF  l-houve-erro = NO THEN do:     
                              ...
                              {&OUT}
                                  ...
                                  "&v_pseq=" + "' p-ult-sequencia '" + "&v_prec~=" + "NO"  + "&v_psetcook=" + "yes","waut","width=250,height=145,scrollbars=aut~o,alwaysRaised=true")
                                   </script>'.
  ...
  ELSE DO:
     ...
     * Set any values that need to be set, then display them. */
     ...
     /*  Monta a Data de Libera‡Æo  para Dep¢sitos da Pra‡a e Fora da Pra‡a */
     ASSIGN dt-menor-praca  = ?
            dt-maior-praca  = ?
            dt-menor-fpraca = ?
            dt-maior-fpraca = ?
