/* .............................................................................
   ...
   Programa: siscaixa/web/crap051a2.w
   ...
   Alteracoes: 11/08/2005 - Tratamentos para unificacao dos bancos, passar
               ...
               14/01/2013 - Acerto na chamada da procedure 
                            valida-deposito-com-captura-migrado-host (Elton).
               ...
               23/10/2013 - Passar o parametro "crap051a2" para procedure
                            valida-permissao-saldo-conta (Diego).
...
&Scoped-define WEB-FILE F:/web/crap051a2.htm

/* Name of first Frame and/or Browse and/or first Query                 */
&Scoped-define FRAME-NAME Web-Frame

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS   ab_unmap.vh_foco ab_unmap.v_agenc ab_unmap.v_banco ab_unmap.v_c1 ab_unmap.v_c2 ab_unmap.v_c3 ab_unmap.v_caixa ab_unmap.v_cheque ab_unmap.v_cmc7 ab_unmap.v_cod ab_unmap.v_cod1 ab_unmap.v_cod2 ab_unmap.v_cod3 ab_unmap.v_comp ab_unmap.v_conta ab_unmap.v_copdst ab_unmap.v_conta1 ab_unmap.v_coop ab_unmap.v_data ab_unmap.v_identifica ab_unmap.v_mensagem1 ab_unmap.v_mensagem2 ab_unmap.v_msg ab_unmap.v_nome ab_unmap.v_operador ab_unmap.v_pac ab_unmap.v_poupanca ab_unmap.v_senha ab_unmap.v_valor ab_unmap.v_valor1 ab_unmap.v_valor2 ab_unmap.v_nrsequni ab_unmap.v_dtenvelo ab_unmap.v_flg-cta-migrada ab_unmap.v_coop-migrada ab_unmap.v_flg-coop-host ab_unmap.v_nro-conta-nova ab_unmap.v_nro-conta-anti ab_unmap.nrterfin ab_unmap.vlcomput ab_unmap.vlenvelo
                 ...
                 IF  RETURN-VALUE = "OK" THEN DO:
                     ...
                     IF  GET-VALUE("ok") <> " " THEN DO:
                         ...
                         FOR  EACH crapmdw WHERE
                              ...
                              crapmdw.nrcheque = INT(v_cheque) AND
                              crapmdw.nrctabdb = INT(v_conta1) EXCLUSIVE-LOCK:

                              IF crapmdw.flgautor = FALSE THEN
                                    ASSIGN crapmdw.flgautor = TRUE.
                         END.    
                 ...
                 ELSE DO: 
                     ...
                     IF  GET-VALUE("ok") <> " " THEN DO: 
                         ...
                         IF  de-saldo-cheque = DEC(v_valor1) THEN DO:
                           IF  GET-VALUE("v_pnrsequni") = ""  THEN  DO:
                                               ...
                                               IF   NOT (crapmdw.dsmensa1 = " " AND
                                                   ...
                                                   IF crapmdw.flgautor = FALSE  THEN
                                                      ...
                                                      {&OUT} "<script>window.location='crap051a2.w"             +
                                                            ...
                                                            "&v_cmc7="             + STRING(crapmdw.dsdocmc7)   +
                           ...
                           END.
                           ELSE
                                /*Aqui se fizer o processar automatico*/
                               {&OUT} "<script>window.location='crap061.w"       +
                                  ...
                                  /*"&v_valor2="      + GET-VALUE("v_pvalor2")      +*/
                                  "&v_nrsequniC="   + GET-VALUE("v_pnrsequni")   +
                                  "&v_dtmvtoltC="   + GET-VALUE("v_pdtenvelo")   +
                                  "&p-flg-cta-migrada=" + GET-VALUE("v_flg-cta-migrada") +
                                  "&p-flg-coop-host="   + GET-VALUE("v_flg-coop-host") +
                                  "&p-coop-migrada="    + GET-VALUE("v_coop-migrada") +
                                  "&v_nrterfin="    + GET-VALUE("v_pnrterfin")   +
                         ...
                         ELSE DO:
                            ...
                            ELSE
                                    /*Aqui se for colocar o processar automatico*/
                                    {&OUT} "<script>window.location='crap061.w"          +
                                           "?v_pconta="      + GET-VALUE("v_pconta")      +
                                           "&v_pcopdst="     + GET-VALUE("v_pcopdst")     +
                                           "&v_pnome="       + GET-VALUE("v_pnome")       +
