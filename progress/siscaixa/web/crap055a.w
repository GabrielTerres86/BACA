...
DEFINE VARIABLE p-programa      AS CHAR INITIAL "CRAP055".

DEFINE VARIABLE de-valor AS CHARACTER  NO-UNDO.
DEFINE VARIABLE de-valor1 AS CHARACTER NO-UNDO.
DEFINE VARIABLE p-cmc-7-dig AS CHARACTER  NO-UNDO.
...
&Scoped-define WEB-FILE F:/web/crap055a.htm
...
------------------------------------------------------------------------*/
  ...
  IF REQUEST_METHOD = "POST":U THEN DO:
    ...
    ASSIGN v_conta = get-value("v_pconta")
           ...
           v_poupanca = get-value("v_ppoupanca")
     ...
     ELSE DO:
         IF  get-value("inclui") <> "" THEN DO:
             ...
             {&OUT}
             '<script>window.location = "crap055.w?v_valor1=" + 
                  "'get-value("v_valor1")'" +   
                  "&v_valor=" +
                  "'get-value("v_valor")'" +
         ...
         ELSE DO:
             ...
             RUN critica-cheque-liberado IN h-b1crap55(INPUT v_coop,
                                                       INPUT INT(v_pac),
                                                       INPUT INT(v_caixa),
                                                       INPUT INT(v_conta),
                                                       INPUT "",
             ...
             ELSE DO:
                 ...
                 RUN valida-codigo-cheque IN h-b1crap55(INPUT v_coop,
                                                        INPUT INT(v_pac),
                                                        INPUT INT(v_caixa),
                                                        INPUT "",
                                                        INPUT p-cmc-7-dig,
                 ...
                 ELSE
                 DO:
                     ASSIGN v_comp   = string(p_cdcmpchq).
                     ASSIGN v_banco  = string(p_cdbanchq).
                     ASSIGN v_agenc  = string(p_cdagechq).
                     ASSIGN v_c1     = string(p_nrddigc1).
                     ASSIGN v_conta1 = string(p_nrctabdb).
                     ASSIGN v_c2     = string(p_nrddigc2).
                     ASSIGN v_cheque = string(p_nrcheque).
                     ASSIGN v_c3     = string(p_nrddigc3).
                     ...
                     RUN valida-pagto-cheque-liberado 
                       IN h-b1crap55(INPUT v_coop,
                                     ...
                                     INPUT p_cdagechq,
                                     INPUT p_nrddigc1,
                                     INPUT p_nrctabdb,                                                                INPUT p_nrddigc2,
                                     INPUT p_nrcheque,
                                     INPUT p_nrddigc3,
                                     INPUT DEC(v_valor),
...
"yes","waut","width=250,height=145,scrollbars=~auto,alwaysRaised=true")
                    ...
                    IF  l-houve-erro = NO THEN DO:
                                      ...
                                      DO:
                                          IF  DEC(v_valor1) >= 
                                              ...
                                              DO:
                                               ...
                                               IF   VALID-HANDLE(h-b1crap55)
                                                    THEN
                                                       DELETE PROCEDURE
                                                              h-b1crap55.
                  
                                               IF   VALID-HANDLE(h-b1crap00)
                                                    THEN
                                                       DELETE PROCEDURE 
                                                              h-b1crap00.
                        ...
                        "&v_pnome=" + "' get-value("v_pnome") '" +
                         "&v_ppoup=" + "'
 get-value("v_ppoup") '" + "&v_pvalor=" + "' get-value("v_pvalor1") '" +
  "&v_pvalor1=" + "' get-value("v_pvalor") '" + 
