/* Alteracoes: 20/06/2018 - Alteracoes para usar as rotinas mesmo com o processo 
...
DEFINE VARIABLE h-b1crap16 AS HANDLE     NO-UNDO.
...
&Scoped-define WEB-FILE crap016.htm

/* Name of first Frame and/or Browse and/or first Query                 */
&Scoped-define FRAME-NAME Web-Frame

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS ab_unmap.vh_foco ab_unmap.v_valor ab_unmap.v_msg ab_unmap.v_caixa ab_unmap.v_coop ab_unmap.v_data ab_unmap.v_lote ab_unmap.v_operador ab_unmap.v_pac 
&Scoped-Define DISPLAYED-OBJECTS ab_unmap.vh_foco ab_unmap.v_valor ab_unmap.v_msg ab_unmap.v_caixa ab_unmap.v_coop ab_unmap.v_data ab_unmap.v_lote ab_unmap.v_operador ab_unmap.v_pac 
     ...
     ELSE DO:
         ...
         ELSE   DO:
            ...
            ELSE DO:
                 ...
                 RUN dbo/b1crap16.p PERSISTENT SET h-b1crap16.
                 RUN retorna-valor-lote IN h-b1crap16(INPUT v_coop,
                                                      INPUT int(v_pac),
                                                      INPUT int(v_caixa),
                                                      INPUT v_operador,
                                                      INPUT INT(v_lote),
                                                      OUTPUT v_valor).
                 DELETE PROCEDURE h-b1crap16.    
                 IF  RETURN-VALUE = "NOK" THEN  DO:
                     {include/i-erro.i}
                 END.
                 ELSE DO:
