...
&Scoped-define WEB-FILE crap076.htm

/* Name of first Frame and/or Browse and/or first Query                 */
&Scoped-define FRAME-NAME Web-Frame

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS ab_unmap.vh_foco ab_unmap.v_poupanca ab_unmap.v_caixa ab_unmap.v_conta ab_unmap.v_coop ab_unmap.v_data ab_unmap.v_documento ab_unmap.v_historico ab_unmap.v_liberacao ab_unmap.v_msg ab_unmap.v_nome ab_unmap.v_operador ab_unmap.v_pac ab_unmap.v_valor 
&Scoped-Define DISPLAYED-OBJECTS ab_unmap.vh_foco ab_unmap.v_poupanca ab_unmap.v_caixa ab_unmap.v_conta ab_unmap.v_coop ab_unmap.v_data ab_unmap.v_documento ab_unmap.v_historico ab_unmap.v_liberacao ab_unmap.v_msg ab_unmap.v_nome ab_unmap.v_operador ab_unmap.v_pac ab_unmap.v_valor 
  ...
  IF REQUEST_METHOD = "POST":U THEN DO:
    ...
    ELSE DO:
        ...
        ELSE DO:
            ...
            END.
            ELSE DO:
                RUN dbo/b1crap76.p PERSISTENT SET h_b1crap76.

                RUN valida-outros IN h_b1crap76(INPUT  v_coop,
                                                INPUT  v_pac,      
                                                INPUT  v_caixa,  
                                                INPUT  v_conta,
                                                INPUT  v_documento,
                                                ...
                                                OUTPUT v_valor,
                                                OUTPUT p-liberacao).
                ASSIGN v_liberacao = IF p-liberacao  <> ? THEN STRING(p-liberacao,"99/99/9999")  ELSE "".

                ASSIGN v_valor    = TRIM(STRING(DEC(v_valor),"zzz,zzz,zz9.99")).
                ...
                ELSE DO:
                    ...
                    IF  get-value("ok") <> "" THEN   DO:
                        ...
                        DO  TRANSACTION ON ERROR undo:
                            ...
                            RUN estorna-outros  IN h_b1crap76
                                (INPUT v_coop,
                                 INPUT INT(v_pac),
                                 INPUT INT(v_caixa),
                                 INPUT v_operador,
                            ...
                            IF  RETURN-VALUE = "OK" THEN DO:
                                RUN grava-autenticacao  IN h_b1crap00
                                 (INPUT v_coop,
                                  ...
                                  INPUT v_operador,
                                  INPUT dec(v_valor),
                                  INPUT dec(v_documento), 
                                  INPUT p-pg, /* YES (PG), NO (REC) */
                                  INPUT "1",  /* On-line            */         
                                  INPUT yes,   /* NÆo estorno        */
                                  INPUT v_historico, 
                                  INPUT ?, /* Data off-line */
                                  INPUT p-autestorno, /* Sequencia off-line */
