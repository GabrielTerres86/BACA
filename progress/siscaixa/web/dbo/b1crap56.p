    ...
    IF   craphis.inavisar = 1   THEN  
         DO:
             ...
             ASSIGN crapavs.cdcooper = crapcop.cdcooper
                    ...
                    crapavs.dtdebito = (IF crapdat.inproces = 1 THEN crapdat.dtmvtolt ELSE crapdat.dtmvtocd)
                    crapavs.dtmvtolt = (IF crapdat.inproces = 1 THEN crapdat.dtmvtolt ELSE crapdat.dtmvtocd)
                    crapavs.dtrefere = (IF crapdat.inproces = 1 THEN crapdat.dtmvtolt ELSE crapdat.dtmvtocd)
                    crapavs.insitavs = 0
                   ...
                   IF   CAN-DO("3,4,5",STRING(craphis.inhistor))   THEN 
                        DO:
                           ...
                           ASSIGN 
                             ...
                             crapdpb.dtmvtolt = (IF crapdat.inproces = 1 THEN crapdat.dtmvtolt ELSE crapdat.dtmvtocd)
    ...
    IF  p-cdhistor = 561 THEN
        DO:
           ...
           ASSIGN craplcs.cdcooper = crapcop.cdcooper
                  craplcs.dtmvtolt = (IF crapdat.inproces = 1 THEN crapdat.dtmvtolt ELSE crapdat.dtmvtocd)
    ...
    IF   p-cdhistor = 5   OR            
         ...
         DO:
             ...
             ASSIGN c-literal-compr[01] = TRIM(crapcop.nmrescop) +  " - " +
                    ...
                    c-literal-compr[02] = " "
                    c-literal-compr[03] = STRING((IF crapdat.inproces = 1 THEN crapdat.dtmvtolt ELSE crapdat.dtmvtocd),"99/99/99")
