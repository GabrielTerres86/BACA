...
Objetivo  : Estorno Pagamento de Emprestimos (Sem Conta-Corrente)
...
DEF VAR h-b1crap91 AS HANDLE          NO-UNDO.
...
&Scoped-define WEB-FILE F:/web/crap091.htm
  ...
  IF REQUEST_METHOD = "POST":U THEN DO:
   ...
   ELSE DO:
       ...
       ELSE DO:
           ...
           END.
           ELSE DO:
                RUN dbo/b1crap91.p PERSISTENT SET h-b1crap91.
                
                RUN valida-estorno IN h-b1crap91(INPUT v_coop,
                                                 INPUT  INT(v_pac), 
                                                 INPUT  INT(v_caixa),
                                                 INPUT  INT(v_conta),
                                                 INPUT  INT(v_docto),
               ...
               ELSE DO:
                  ...
                  IF  get-value("ok") <> "" THEN DO:
                      ...
                      DO TRANSACTION ON ERROR UNDO:
                         ...
                         MESSAGE "CRAP091 - Voltou - "
                                 "p-ult-sequencia: " p-ult-sequencia
                                 "p-valor: " p-valor
                      ...
                      IF  l-houve-erro = NO THEN do:     
                          ...
                          {&OUT}
                     '<script>window.open("autentica.html?v_pseq=" + 
                      "' p-ult-sequencia '" + 
                      "&v_prec=" +
                      "NO"  + "&v_psetcook=" + 
                      "yes&v_plit=" +
