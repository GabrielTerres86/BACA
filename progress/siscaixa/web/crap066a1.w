/* .............................................................................
   ...
   Programa: siscaixa/web/crap066a1.w
   Sistema : Caixa On-line
   Sigla   : CRED   
   Autor   : Guilherme
   Data    : Marco/2001                      Ultima atualizacao: 19/01/2012.
...
DEFINE VARIABLE v_mensagem1 AS CHARACTER   NO-UNDO.
DEFINE VARIABLE v_mensagem2 AS CHARACTER   NO-UNDO.
...
&Scoped-define WEB-FILE F:/web/crap066a1.htm

/* Name of first Frame and/or Browse and/or first Query                 */
&Scoped-define FRAME-NAME Web-Frame

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS ab_unmap.vh_foco ab_unmap.v_agenc ab_unmap.v_banco ab_unmap.v_c1 ab_unmap.v_c2 ab_unmap.v_c3 ab_unmap.v_caixa ab_unmap.v_cheque ab_unmap.v_cmc7 ab_unmap.v_cod1 ab_unmap.v_cod2 ab_unmap.v_cod3 ab_unmap.v_comp ab_unmap.v_conta ab_unmap.v_conta1 ab_unmap.v_coop ab_unmap.v_data ab_unmap.v_msg ab_unmap.v_nome ab_unmap.v_operador ab_unmap.v_pac ab_unmap.v_poupanca ab_unmap.v_valor1 ab_unmap.v_valor2 ab_unmap.v_nrsequni ab_unmap.v_dtenvelo ab_unmap.nrterfin ab_unmap.vlcomput ab_unmap.vlenvelo
...
*****************************************/                   
    ...
    ELSE DO:
        ...
        RUN critica-codigo-cheque-dig IN h-b1crap66(INPUT v_coop,
                                                    INPUT v_pac,
                                                    INPUT v_caixa,
                                                    INPUT p-cmc-7-dig).
        ...
        ELSE DO:
            ...
            RUN dbo/b1crap66.p PERSISTENT SET h-b1crap66.
            RUN critica-contra-ordem IN h-b1crap66(INPUT v_coop,
                                                   INPUT INT(v_pac),           
                                                   INPUT INT(v_caixa),         
                                                   INPUT v_operador,           
                                                   INPUT INT(v_conta),         
