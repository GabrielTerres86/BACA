...
DEFINE VARIABLE c_codbarras AS CHAR      NO-UNDO.
...
&Scoped-define WEB-FILE F:/web/crap081b.html
...
------------------------------------------------------------------------*/
  ...
  IF REQUEST_METHOD = "POST":U THEN DO:
    ...
    ELSE DO:
        ...
        ASSIGN v_tit1 =
                    STRING(DEC(get-value("v_ptit1")),"99999,99999").
        ASSIGN v_tit2 =
                    STRING(DEC(get-value("v_ptit2")),"99999,999999").
        ASSIGN v_tit3 =
                    STRING(DEC(get-value("v_ptit3")),"99999,999999").
        ASSIGN v_tit4 = 
                    STRING(DEC(get-value("v_ptit4")),"9").
        ASSIGN v_tit5 =
                    STRING(DEC(get-value("v_ptit5")),"zz,zzz,zzz,zzz999").
        ...
        IF  get-value("ok") <> "" THEN  DO:
            ...
            ASSIGN c_codbarras = v_codbarras.
