...
&Scoped-define WEB-FILE index.htm

/* Name of first Frame and/or Browse and/or first Query                 */
&Scoped-define FRAME-NAME Web-Frame

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS ab_unmap.v_msg 
&Scoped-Define DISPLAYED-OBJECTS ab_unmap.v_msg 
...
------------------------------------------------------------------------*/
  ...
  /* Verifica se deve excluir os cookies, procedimento este para reconfigurar o caixa */
  IF   GET-VALUE("excluir") <> ""   THEN
	   DO:
           RUN DeleteCookie in web-utilities-hdl("User_coop").
           RUN DeleteCookie in web-utilities-hdl("User_cx").
           RUN DeleteCookie in web-utilities-hdl("User_pac").
           RUN DeleteCookie in web-utilities-hdl("operador").
           RUN DeleteCookie in web-utilities-hdl("user_log").
           RUN DeleteCookie in web-utilities-hdl("Autenticacao").
       END.
  ...
  ELSE DO:
	...
	*/
    ...
    /* Se excluiu os cookies, fecha a janela */
	IF   GET-VALUE("excluir") <> ""   THEN
	     DO:
		     {&OUT} "<br><br><br><center><b>Os cookies foram excluídos.<br><br>" SKIP
			        "Feche todas as janelas e abra o Caixa On-Line "
					"através do link da intranet.</b></center>" SKIP.
			 LEAVE.
		 END.
    
    /* Verifica o parametro da cooperativa */
    FIND crapcop WHERE crapcop.cdcooper = INT(GET-VALUE("aux_cdcooper"))
                       NO-LOCK NO-ERROR.

    /* Monta a mensagem de erro e encerra */
    IF   NOT AVAILABLE crapcop   THEN
         DO:
		     {&OUT} "<form>" SKIP
			        "<font color=red><b><center>" SKIP
                    "ATENÇÃO - Verifique as configurações do seu caixa.<BR><BR>" 
					"</center></b></font>" SKIP
					...
					"número do caixa, operador ~"888~" e a senha ~"siscaixa~".<br><br>" SKIP
					"Dúvidas deverão ser tratadas através de chamado no 0800net, "
					"com o produto Caixa On-Line.<br><br>" SKIP
