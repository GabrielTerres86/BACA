/* .............................................................................
   ...
   Programa: siscaixa/web/crap073.w
   Sistema : Caixa On-line
   Sigla   : CRED   
   Autor   : Mirtes.
   Data    : Marco/2001                      Ultima atualizacao: 25/10/2006.
...
&Scoped-define WEB-FILE crap073.htm

/* Name of first Frame and/or Browse and/or first Query                 */
&Scoped-define FRAME-NAME Web-Frame

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS ab_unmap.vh_foco ab_unmap.v_caixa ab_unmap.v_cmc7 ab_unmap.v_coop ab_unmap.v_data ab_unmap.v_msg ab_unmap.v_operador ab_unmap.v_pac 
&Scoped-Define DISPLAYED-OBJECTS ab_unmap.vh_foco ab_unmap.v_caixa ab_unmap.v_cmc7 ab_unmap.v_coop ab_unmap.v_data ab_unmap.v_msg ab_unmap.v_operador ab_unmap.v_pac 
            ...
            ELSE DO:    
                ...
                ELSE DO:
                    IF  get-value("manual") <> "" THEN DO:
                            {&OUT}
                            '<script>window.location = "crap073a.w" </script>'.
                    END.
                    ELSE DO:

                         RUN dbo/b1crap73.p PERSISTENT SET h-b1crap73.
                         RUN critica-codigo-cheque-valor IN h-b1crap73(
                                                           INPUT v_coop,       
                                                           INPUT v_pac,
                                                           INPUT v_caixa,
                                                           INPUT v_cmc7,
                         ...
                         ELSE DO:
                             ...
                             RUN dbo/b1crap73.p PERSISTENT SET h-b1crap73.
                             RUN valida-codigo-cheque-valor IN h-b1crap73(
                                                            INPUT v_coop,      
                                                            INPUT v_pac,
                                                            INPUT v_caixa,
                                                            INPUT v_cmc7,
                                                            INPUT " ",
                                                            OUTPUT p-cdcmpchq,                                                               OUTPUT p-cdbanchq,
                                                            OUTPUT p-cdagechq,                                                               OUTPUT p-nrddigc1,
                                                            OUTPUT p-nrctabdb,                                                               OUTPUT p-nrddigc2,
                                                            OUTPUT p-nrcheque,
                                                            OUTPUT p-nrddigc3,
                                                            OUTPUT p-valor). 
                             DELETE PROCEDURE h-b1crap73.
                             ...
                             ELSE DO:
                                 ...
                                 {&OUT}
                                  '<script>window.location = "crap073b.html?v_cmc7=" + "'get-value("v_cmc7")'" 
