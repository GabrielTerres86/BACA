...
DEFINE TEMP-TABLE ab_unmap
       ...
       FIELD v_tela AS CHARACTER FORMAT "X(256)":U  .
...
&Scoped-define WEB-FILE crap002a.htm

/* Name of first Frame and/or Browse and/or first Query                 */
&Scoped-define FRAME-NAME Web-Frame

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS ab_unmap.vh_foco ab_unmap.v_nome ab_unmap.v_msg ab_unmap.v_caixa ab_unmap.v_coop ab_unmap.v_data ab_unmap.v_operador ab_unmap.v_pac ab_unmap.v_tela 
&Scoped-Define DISPLAYED-OBJECTS ab_unmap.vh_foco ab_unmap.v_nome ab_unmap.v_msg ab_unmap.v_caixa ab_unmap.v_coop ab_unmap.v_data ab_unmap.v_operador ab_unmap.v_pac ab_unmap.v_tela 
...
DEFINE FRAME Web-Frame
     ...
     ab_unmap.v_pac AT ROW 1 COL 1 HELP
          ...
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     ab_unmap.v_tela AT ROW 1 COL 1 HELP
          "" NO-LABEL FORMAT "X(256)":U
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
...
------------------------------------------------------------------------------*/
  ...
  RUN htmAssociate
    ("v_tela":U,"ab_unmap.v_tela":U,ab_unmap.v_tela:HANDLE IN FRAME {&FRAME-NAME}).
END PROCEDURE.
