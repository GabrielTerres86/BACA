/*..............................................................................
   ...
   Programa: siscaixa/web/crap082.w
   Sistema : Caixa On-Line
   Sigla   : CRED
   Autor   : 
   Data    :                                    Ultima atualizacao: 19/11/2014

   Dados referentes ao programa:

   Frequencia: 
   Objetivo  :  Pagamento GPS - Guias Previdencia Social

   Alteracoes:  26/12/2007 - Incluido campo CPF/CNPJ e alterado para passar
                             como paramentros os campos Conta, Nome, Codigo e
                             CPF/CNPJ na BO valida-identificador (Elton).

                12/06/2008 - Criada  chamadas da BO dbo/b1crap82.p para
                             verificar campos "Mes/Ano Competencia", "Valor
                             Outras Entidades" e "ATM/Multa e Juros" (Elton). 
                              
                14/07/2008 - Preenche os campos "Conta", "Nome" e "CPF/CNPJ"
                             automaticamente com as informacoes do campo
                             "Identifcador" na tabela crapcgp (Elton).
                             
                29/08/2008 - Incluido cddpagto nos FIND's da crapcgp e da
                             craplgp; 
                           - Incluido novos parametros nas procedures
                             valida-valor-entidades e valida-atm-juros (Elton).
                
                13/12/2013 - Adicionado validate para tabela craperr (Tiago).
                
                19/11/2014 - #219595 Bloqueio do pagamento a partir do dia 
...
DEF VAR p_valortot      AS DEC        NO-UNDO.

DEF VAR l-houve-erro    AS LOG        NO-UNDO.   
DEF VAR v_verdbaut      AS LOG        NO-UNDO. 
DEF VAR v_dsobserv      AS CHAR       NO-UNDO. 
...
DEF VAR h_b1crap82 AS HANDLE          NO-UNDO.
DEF VAR aux_datadia AS DATE NO-UNDO.
...
&Scoped-define WEB-FILE F:/web/crap082.htm

/* Name of first Frame and/or Browse and/or first Query                 */
&Scoped-define FRAME-NAME Web-Frame

/* Standard List Definitions                                            */
&Scoped-Define ENABLED-OBJECTS ab_unmap.ok ab_unmap.vh_foco ab_unmap.v_ano ab_unmap.v_caixa ab_unmap.v_codigo ab_unmap.v_conta ab_unmap.v_coop ab_unmap.v_data ab_unmap.v_identificador ab_unmap.v_nrcpfcgc ab_unmap.v_mes ab_unmap.v_msg ab_unmap.v_nome ab_unmap.v_operador ab_unmap.v_pac ab_unmap.v_valorins ab_unmap.v_valorjur ab_unmap.v_valorout ab_unmap.v_valortot
&Scoped-Define DISPLAYED-OBJECTS ab_unmap.ok ab_unmap.vh_foco ab_unmap.v_ano ab_unmap.v_caixa ab_unmap.v_codigo ab_unmap.v_conta ab_unmap.v_coop ab_unmap.v_data ab_unmap.v_identificador ab_unmap.v_nrcpfcgc ab_unmap.v_mes ab_unmap.v_msg ab_unmap.v_nome ab_unmap.v_operador ab_unmap.v_pac ab_unmap.v_valorins ab_unmap.v_valorjur ab_unmap.v_valorout ab_unmap.v_valortot 
...
DEFINE FRAME Web-Frame
     ...
     ab_unmap.vh_foco AT ROW 1 COL 1 HELP
          ...
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     ab_unmap.v_ano AT ROW 1 COL 1 HELP
          "" NO-LABEL FORMAT "X(256)":U
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
     ...
     ab_unmap.v_nrcpfcgc AT ROW 1 COL 1 HELP    
          ...
          VIEW-AS FILL-IN 
          SIZE 20 BY 1                
     ab_unmap.v_mes AT ROW 1 COL 1 HELP
          "" NO-LABEL FORMAT "X(256)":U
          VIEW-AS FILL-IN 
          SIZE 20 BY 1
...
/* SETTINGS FOR fill-in ab_unmap.v_identificador IN FRAME Web-Frame
   ALIGN-L EXP-LABEL EXP-FORMAT EXP-HELP                                */
/* SETTINGS FOR fill-in ab_unmap.v_nrcpfcgc IN FRAME Web-Frame
   ALIGN-L EXP-LABEL EXP-FORMAT EXP-HELP                                */   
...
------------------------------------------------------------------------------*/
  ...
  RUN htmAssociate
    ("v_ano":U,"ab_unmap.v_ano":U,ab_unmap.v_ano:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
    ("v_caixa":U,"ab_unmap.v_caixa":U,ab_unmap.v_caixa:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
    ("v_codigo":U,"ab_unmap.v_codigo":U,ab_unmap.v_codigo:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
  ...
  RUN htmAssociate
    ("v_mes":U,"ab_unmap.v_mes":U,ab_unmap.v_mes:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
  ...
  RUN htmAssociate
    ("v_valorins":U,"ab_unmap.v_valorins":U,ab_unmap.v_valorins:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
    ("v_valorjur":U,"ab_unmap.v_valorjur":U,ab_unmap.v_valorjur:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
    ("v_valorout":U,"ab_unmap.v_valorout":U,ab_unmap.v_valorout:HANDLE IN FRAME {&FRAME-NAME}).
  RUN htmAssociate
    ("v_valortot":U,"ab_unmap.v_valortot":U,ab_unmap.v_valortot:HANDLE IN FRAME {&FRAME-NAME}).
END PROCEDURE.
   ...
   ELSE DO:     
      ...
      ELSE DO:  
         ...
         ELSE DO:   
            ...
            FIND crapcgp WHERE crapcgp.cdcooper = crapcop.cdcooper      AND
                               crapcgp.cdidenti = DEC(v_identificador)  AND
                               crapcgp.cddpagto = INT(v_codigo) 
                               NO-LOCK NO-ERROR.
                      
            IF AVAIL crapcgp THEN
               ASSIGN  v_nome     = crapcgp.nmprimtl 
                       v_conta    = STRING(crapcgp.nrdconta)      
                       v_nrcpfcgc = STRING(crapcgp.nrcpfcgc).
...
/* Se a data atual for maior/igual que 28/11/2014 e
   cooper concredi, exibir msg de bloqueio da tela.
   #TODO Este if poderá ser removido depois da incorporacao */
aux_datadia = DATE(INT(SUBSTR(ab_unmap.v_data,4,2)), INT(SUBSTR(ab_unmap.v_data,1,2)), INT(SUBSTR(ab_unmap.v_data,7,4))).
IF  aux_datadia >= DATE(11,28,2014)  AND 
    STRING(ab_unmap.v_coop) = "CONCREDI"  THEN
DO: 
    RUN dbo/b1crap82.p PERSISTENT SET h_b1crap82.

    RUN msg-inicial IN h_b1crap82 (INPUT STRING(ab_unmap.v_coop),
                                   INPUT INTE(ab_unmap.v_pac), 
                                   INPUT INTE(ab_unmap.v_caixa)).

    IF  RETURN-VALUE = "MSG" THEN
    DO:
        {include/i-erro.i}
    END.

    IF  VALID-HANDLE(h_b1crap82) THEN
        DELETE PROCEDURE h_b1crap82.
...
DO:
                  ...
                  RUN valida-identificador 
                      IN h-b1crap82(INPUT  v_coop,
                                    INPUT  INT(v_pac),  
                                    INPUT  INT(v_caixa),
                                    INPUT  DEC(v_identificador),
                                    INPUT  v_conta,
                                    INPUT  v_nome,
                                    INPUT  v_codigo,
                                    INPUT  DEC(v_nrcpfcgc)).
                           ...
                           ELSE DO: 
                              RUN valida-valores
                                  IN h-b1crap82( INPUT  v_coop,
                                                 ...
                                                 INPUT  DEC(v_identificador),
                                                 INPUT  v_codigo, 
                                                 INPUT  DEC(v_valorins),  
                                                 INPUT  DEC(v_valorjur),
                                                 INPUT  DEC(v_valorout),
                                                 INPUT  DEC(v_valortot)).
