...
/*..............................................................................
   ...
   Autor   : David
   Data    : 14/07/2006                        Ultima atualizacao: 03/02/2016
...
PROCEDURE gera-dados:
    ...
    FOR EACH  crapcco WHERE crapcco.cdcooper = par_cdcooper AND
                             ...
                             NO-LOCK
       ,FIRST  crapceb WHERE crapceb.cdcooper = crapcco.cdcooper AND
                             crapceb.nrdconta = par_nrdconta     AND
        ...
        IF crapceb.flserasa = TRUE THEN
          ASSIGN aux_flserasa = crapceb.flserasa.
            ...
            IF  NOT AVAILABLE crapsnh  THEN
                DO:
                    IF  LOCKED crapsnh  THEN
                        DO:
                            aux_dscritic = "Registro de instrucoes esta sendo" +
                                           " alterado. Tente novamente.".
                            PAUSE 1 NO-MESSAGE.
                            NEXT.
                        END.
                    ELSE
                        aux_dscritic = "Conta sem permissao para emitir/" +
                                  "consultar boleto.\nAssine o termo de " +
                                  "adesao na Cooperativa.".
                END.
            ELSE
                DO:
                    ASSIGN old_dsdinstr = crapsnh.dsdinstr.
