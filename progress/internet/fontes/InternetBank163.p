...
/*..............................................................................
   ...
   Programa: sistema/internet/fontes/InternetBank163.p
   Sistema : Internet - Cooperativa de Credito
   Sigla   : CRED
   Autor   : Jean Michel
   Data    : Janeiro/2016                        Ultima atualizacao: 13/01/2016
   
   Dados referentes ao programa:

   Frequencia: Sempre que for chamado (On-Line)
   Objetivo  : Reprovacao de transacoes dos operadores de internet
...
DEF VAR aux_cdcritic AS INTE                        NO-UNDO.
    ...
    RUN STORED-PROCEDURE pc_reprova_trans_pend
    ...
    CLOSE STORED-PROC pc_reprova_trans_pend 
    ...
    ASSIGN aux_cdcritic = 0
           aux_dscritic = ""
           aux_cdcritic = pc_reprova_trans_pend.pr_cdcritic 
                            WHEN pc_reprova_trans_pend.pr_cdcritic <> ?
           aux_dscritic = pc_reprova_trans_pend.pr_dscritic
                            WHEN pc_reprova_trans_pend.pr_dscritic <> ?. 
    ...
    ASSIGN aux_dscritic = "Reprovacao efetuada com sucesso.".
