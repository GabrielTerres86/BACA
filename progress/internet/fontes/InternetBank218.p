/*..............................................................................
   ...
   Objetivo  : Identificar o tipo de pagamento do codigo de barras
...
DEF VAR xml_ret AS CHAR                                                                                    NO-UNDO.
  ...
  RUN STORED-PROCEDURE pc_identif_tppagamento_car aux_handproc = PROC-HANDLE NO-ERROR
                          ( INPUT par_cdcooper,
                            INPUT par_cdagenci,
                            INPUT par_cdcanal,
                            INPUT par_nrdconta,
  ...
  CLOSE STORED-PROC pc_identif_tppagamento_car aux_statproc = PROC-STATUS
          WHERE PROC-HANDLE = aux_handproc.
        
  { includes/PLSQL_altera_session_depois_st.i &dboraayl={&scd_dboraayl} }
   
        ASSIGN xml_ret = pc_identif_tppagamento_car.pr_xml_ret.
