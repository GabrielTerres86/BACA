/*..............................................................................
   ...
   Programa: sistema/internet/fontes/InternetBank197.p
   ...
   Objetivo  : Detalhe Comprovante Recebido
...
DEF INPUT  PARAM par_nrdocmto  AS INTEGER            NO-UNDO.
DEF INPUT  PARAM par_cdhistor  AS INTEGER            NO-UNDO.
...
RUN STORED-PROCEDURE pc_detalhe_compr_recebido
...
CLOSE STORED-PROC pc_detalhe_compr_recebido
    aux_statproc = PROC-STATUS WHERE PROC-HANDLE = aux_handproc. 
    
/* Status da Chamada (OK / NOK) */
ASSIGN aux_dsstatus     = pc_detalhe_compr_recebido.pr_dsretorn
       aux_xml_operacao = pc_detalhe_compr_recebido.pr_retxml.        
