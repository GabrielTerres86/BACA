...
{ includes/PLSQL_altera_session_antes.i &dboraayl={&scd_dboraayl}}
  ...
  RUN STORED-PROCEDURE pc_detalhe_agendamento
        aux_handproc = PROC-HANDLE NO-ERROR(INPUT par_cdtiptra
                                           ,INPUT par_idlancto
                                           ,OUTPUT ""   /* Retorno XML*/
    ...
    CLOSE STORED-PROC pc_detalhe_agendamento
        aux_statproc = PROC-STATUS WHERE PROC-HANDLE = aux_handproc. 
        
    /* Status da Chamada (OK / NOK) */
    ASSIGN aux_dsstatus     = pc_detalhe_agendamento.pr_dsretorn
           aux_xml_operacao = pc_detalhe_agendamento.pr_retxml.        
