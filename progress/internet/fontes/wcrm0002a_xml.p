/* .............................................................................
   ...
   Sigla   : CRED
   Autor   : Evandro
   Data    : Junho/2006                      Ultima Atualizacao: 19/10/2012
...
IF   AVAILABLE crapadp   THEN
     DO:
                       ...
                       DO:
                           ...
                           IF   AVAILABLE gnappdp    THEN
                                DO:
                                    ...
                                    ELSE
                                         /* Tira o ultimo ";" */
                                         aux_nmfacili = SUBSTRING(aux_nmfacili,1,LENGTH(aux_nmfacili) - 1).
         ...
         criaCampo("QTMAXTUR",STRING(crapedp.qtmaxtur) + " VAGAS").
