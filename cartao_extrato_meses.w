...
IMAGE-36 IMAGE-43 Btn_A Btn_E Btn_B Btn_F Btn_C Btn_G Btn_H 
...
ON ANY-KEY OF Btn_A IN FRAME f_cartao_extrato_meses /* 1 mês */
DO:
    RUN tecla.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL Btn_A w_cartao_extrato_meses
ON CHOOSE OF Btn_A IN FRAME f_cartao_extrato_meses /* 1 mês */
DO:
    ...
    IF  NOT aux_flgderro  THEN
        RUN impressao.w (INPUT "Extrato " + aux_nomedmes[MONTH(aux_dtextrat)] + "...",
                         INPUT tmp_tximpres).
...
ON ANY-KEY OF Btn_B IN FRAME f_cartao_extrato_meses /* 3 meses */
DO:
    RUN tecla.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL Btn_B w_cartao_extrato_meses
ON CHOOSE OF Btn_B IN FRAME f_cartao_extrato_meses /* 3 meses */
DO:
    ASSIGN aux_msextrat = MONTH(glb_dtmvtolt) - 3.  
    IF aux_msextrat <= 0 THEN
       ASSIGN aux_dtextrat = ((DATE(12 + aux_msextrat,28,YEAR(glb_dtmvtolt) - 1) + 4) - 
                                DAY(DATE(12 + aux_msextrat,28,YEAR(glb_dtmvtolt) - 1) + 4)).
    ELSE
        ASSIGN aux_dtextrat = ((DATE(MONTH(glb_dtmvtolt) - 3,28,YEAR(glb_dtmvtolt)) + 4) - 
                                DAY(DATE(MONTH(glb_dtmvtolt) - 3,28,YEAR(glb_dtmvtolt)) + 4)).
...
ON ANY-KEY OF Btn_C IN FRAME f_cartao_extrato_meses /* 5 meses */
DO:
    RUN tecla.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL Btn_C w_cartao_extrato_meses
ON CHOOSE OF Btn_C IN FRAME f_cartao_extrato_meses /* 5 meses */
DO:
    ASSIGN aux_msextrat = MONTH(glb_dtmvtolt) - 5.  
    IF aux_msextrat <= 0 THEN
       ASSIGN aux_dtextrat = ((DATE(12 + aux_msextrat,28,YEAR(glb_dtmvtolt) - 1) + 4) - 
                                DAY(DATE(12 + aux_msextrat,28,YEAR(glb_dtmvtolt) - 1) + 4)).
    ELSE
        ASSIGN aux_dtextrat = ((DATE(MONTH(glb_dtmvtolt) - 5,28,YEAR(glb_dtmvtolt)) + 4) - 
                                DAY(DATE(MONTH(glb_dtmvtolt) - 5,28,YEAR(glb_dtmvtolt)) + 4)).
...
ON ANY-KEY OF Btn_E IN FRAME f_cartao_extrato_meses /* 2 meses */
DO:
    RUN tecla.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL Btn_E w_cartao_extrato_meses
ON CHOOSE OF Btn_E IN FRAME f_cartao_extrato_meses /* 2 meses */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL Btn_F w_cartao_extrato_meses
ON ANY-KEY OF Btn_F IN FRAME f_cartao_extrato_meses /* 4 meses */
DO:
    RUN tecla.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL Btn_F w_cartao_extrato_meses
ON CHOOSE OF Btn_F IN FRAME f_cartao_extrato_meses /* 4 meses */
DO:
    ASSIGN aux_msextrat = MONTH(glb_dtmvtolt) - 4.  
    IF aux_msextrat <= 0 THEN
       ASSIGN aux_dtextrat = ((DATE(12 + aux_msextrat,28,YEAR(glb_dtmvtolt) - 1) + 4) - 
                                DAY(DATE(12 + aux_msextrat,28,YEAR(glb_dtmvtolt) - 1) + 4)).
    ELSE
        ASSIGN aux_dtextrat = ((DATE(MONTH(glb_dtmvtolt) - 4,28,YEAR(glb_dtmvtolt)) + 4) - 
                                DAY(DATE(MONTH(glb_dtmvtolt) - 4,28,YEAR(glb_dtmvtolt)) + 4)).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL Btn_G w_cartao_extrato_meses
ON ANY-KEY OF Btn_G IN FRAME f_cartao_extrato_meses /* 6 meses */
DO:
    RUN tecla.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL Btn_G w_cartao_extrato_meses
ON CHOOSE OF Btn_G IN FRAME f_cartao_extrato_meses /* 6 meses */
DO:
    ASSIGN aux_msextrat = MONTH(glb_dtmvtolt) - 6.  
    IF aux_msextrat <= 0 THEN
       ASSIGN aux_dtextrat = ((DATE(12 + aux_msextrat,28,YEAR(glb_dtmvtolt) - 1) + 4) - 
                                DAY(DATE(12 + aux_msextrat,28,YEAR(glb_dtmvtolt) - 1) + 4)).
    ELSE
        ASSIGN aux_dtextrat = ((DATE(MONTH(glb_dtmvtolt) - 6,28,YEAR(glb_dtmvtolt)) + 4) - 
                                DAY(DATE(MONTH(glb_dtmvtolt) - 6,28,YEAR(glb_dtmvtolt)) + 4)).
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    ELSE
        Btn_A:LABEL = aux_nomedmes[MONTH(glb_dtmvtolt) - 1] + "/" +
    ...
    IF aux_msextrat <= 0 THEN
        Btn_B:LABEL = aux_nomedmes[12 + aux_msextrat] + "/" +
                      STRING(YEAR(glb_dtmvtolt) - 1,"9999").
    ELSE
        Btn_B:LABEL = aux_nomedmes[MONTH(glb_dtmvtolt) - 3] + "/" +
                      STRING(YEAR(glb_dtmvtolt),"9999").
    ...
    IF aux_msextrat <= 0 THEN
        Btn_C:LABEL = aux_nomedmes[12 + aux_msextrat] + "/" +
                      STRING(YEAR(glb_dtmvtolt) - 1,"9999").
    ELSE
        Btn_C:LABEL = aux_nomedmes[MONTH(glb_dtmvtolt) - 5] + "/" +
                      STRING(YEAR(glb_dtmvtolt),"9999").

    ASSIGN aux_msextrat = MONTH(glb_dtmvtolt) - 2.
    IF aux_msextrat <= 0 THEN
        Btn_E:LABEL = aux_nomedmes[12 + aux_msextrat] + "/" +
                      STRING(YEAR(glb_dtmvtolt) - 1,"9999").
    ELSE
        Btn_E:LABEL = aux_nomedmes[MONTH(glb_dtmvtolt) - 2] + "/" +
                      STRING(YEAR(glb_dtmvtolt),"9999").

    ASSIGN aux_msextrat = MONTH(glb_dtmvtolt) - 4.
    IF aux_msextrat <= 0 THEN
        Btn_F:LABEL = aux_nomedmes[12 + aux_msextrat] + "/" +
                      STRING(YEAR(glb_dtmvtolt) - 1,"9999").
    ELSE
        Btn_F:LABEL = aux_nomedmes[MONTH(glb_dtmvtolt) - 4] + "/" +
                      STRING(YEAR(glb_dtmvtolt),"9999").

    ASSIGN aux_msextrat = MONTH(glb_dtmvtolt) - 6.
    IF aux_msextrat <= 0 THEN
        Btn_G:LABEL = aux_nomedmes[12 + aux_msextrat] + "/" +
                      STRING(YEAR(glb_dtmvtolt) - 1,"9999").
    ELSE
        Btn_G:LABEL = aux_nomedmes[MONTH(glb_dtmvtolt) - 6] + "/" +
                      STRING(YEAR(glb_dtmvtolt),"9999").
...
OCXFile = SEARCH( "cartao_extrato_meses.wrx":U ).
IF OCXFile = ? THEN
...
END.
ELSE MESSAGE "cartao_extrato_meses.wrx":U SKIP(1)
...
------------------------------------------------------------------------------*/
  RUN control_load.
  ENABLE IMAGE-34 IMAGE-38 IMAGE-40 IMAGE-35 IMAGE-39 IMAGE-36 IMAGE-43 Btn_A 
...
chtemporizador:t_cartao_extrato_meses:INTERVAL = 0.
    ...
    IF  KEY-FUNCTION(LASTKEY) = "F"                      AND
        Btn_F:SENSITIVE IN FRAME f_cartao_extrato_meses  THEN
