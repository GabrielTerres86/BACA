...
SPOOL servcore-ng-dml_V002C001R444.log
...
INSERT INTO TB_SCRIPT_HIST (SCRIPT_FILE_NAME, TS_CREATED, STATUS) VALUES ('servcore-ng-dml_V002C001R444.sql', SYSTIMESTAMP, '*');

--  ATM - FIX - AJUSTE COMPROVANTE DE PAGAMENTO DE TITULO - BANCOOB
...
-----------------------------------------------
'||
'#if (' || CHR(36) || 'PAGAMENTO.get("canalRelacionamento").get("codigo")=="2")
...
'||
'#else
Canal de Recebimento:' || CHR(36) || 'STRING_UTIL.padLeft(' || CHR(36) || 'PAGAMENTO.get("canalRelacionamento").get("descricao").toString().substring(0, 23), 27, ".")
'||
'#end
