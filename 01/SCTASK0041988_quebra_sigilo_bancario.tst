...
BEGIN
  ...
  */
  ...
  vr_referencia := 'RITM0039679';
  -- Data que deve ocorrer a quebra de sigilo bancário
  vr_dtinicio   := TO_DATE('01/01/2015','DD/MM/YYYY');
  vr_dtfim      := TO_DATE('30/06/2018','DD/MM/YYYY'); 
  
  vr_tbconta_investigar('014_0000018910_000003919248937').cdcooper := 14;
  vr_tbconta_investigar('014_0000018910_000003919248937').nrdconta := 18910;
  vr_tbconta_investigar('014_0000018910_000003919248937').nrcpfcgc := 03919248937;   
