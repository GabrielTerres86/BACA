...
declare 
  ...
  -- ALTERAR
  NOME_DA_ACAO VARCHAR2(40) := 'SEGEMP_CONS_SUB';
  PROCEDURE_DA_ACAO VARCHAR2(100) := 'pc_consulta_subsegmento';
  PACKAGE_DA_ACAO VARCHAR2(100) := 'TELA_SEGEMP';
  PARAMETROS_DA_ACAO VARCHAR2(1000):= 'pr_idsegmento, pr_idsubsegmento';
  -- FIM ALTERAR
