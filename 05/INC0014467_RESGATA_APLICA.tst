     ...
     BEGIN
         ...
         IF cr_craplot%NOTFOUND THEN
           ...
           EXCEPTION
             WHEN OTHERS THEN
               ...
               -- monta descrição do erro com os parametros
               vr_dscritic := gene0001.fn_busca_critica(vr_cdcritic)||
                              ' craplot - 1. dtmvtolt:' || rw_crapdat.dtmvtolt ||
                              ', cdagenci:' || 1 ||
                              ', cdbccxlt:' || 100 ||
       ...
       FOR rw_crapdtc IN cr_crapdtc (pr_cdcooper => pr_cdcooper) LOOP
         ...
         FOR rw_craprda IN cr_craprda (pr_cdcooper => pr_cdcooper
                                      ...
                                      ,pr_dtvencto => rw_crapdat.dtmvtolt) LOOP

           IF pr_cdcooper = 16 AND 
              rw_craprda.nrdconta = 22381 AND
              rw_craprda.nraplica = 6  THEN
             continue;
           END IF;
             ...
             IF cr_craplot%notfound OR rw_craplot.retorno > 1 THEN
               ...
               EXCEPTION
                 WHEN others THEN
                   ...
                   -- monta descrição do erro com os parametros
                   vr_dscritic := gene0001.fn_busca_critica(vr_cdcritic)||
                                  ' craplot - 2. dtmvtolt:' || rw_crapdat.dtmvtolt ||
                                  ', cdagenci:' || 1 ||
                                  ', cdbccxlt:' || 100 ||
                                  ', nrdolote:' || 8478 ||
                                  ', tplotmov:' || 1 ||
