...
IMAGE-41 RECT-6 ed_dsdsenan ed_nrcpf ed_dsdsennv ed_dsdsencf Btn_G Btn_H ~
ed_label_cpf 
&Scoped-Define DISPLAYED-OBJECTS ed_dsdsenan ed_nrcpf ed_dsdsennv ~
ed_dsdsencf ed_label_cpf 
...
DEFINE FRAME f_cartao_alterar_senha
     ed_dsdsenan AT ROW 6.95 COL 111.4 COLON-ALIGNED NO-LABEL WIDGET-ID 142 PASSWORD-FIELD 
     ed_nrcpf AT ROW 9.86 COL 111.2 COLON-ALIGNED NO-LABEL WIDGET-ID 166
     ed_dsdsennv AT ROW 12.91 COL 111.4 COLON-ALIGNED NO-LABEL WIDGET-ID 146 PASSWORD-FIELD 
     ed_dsdsencf AT ROW 16 COL 111.4 COLON-ALIGNED NO-LABEL WIDGET-ID 144 PASSWORD-FIELD 
     Btn_G AT ROW 19.1 COL 94.4 WIDGET-ID 130
     Btn_H AT ROW 24.1 COL 94.4 WIDGET-ID 132
     ed_label_cpf AT ROW 10.33 COL 7 COLON-ALIGNED NO-LABEL WIDGET-ID 184
     "  SENHA ATUAL:" VIEW-AS TEXT
          SIZE 62 BY 2.38 AT ROW 6.76 COL 41 WIDGET-ID 152
          FGCOLOR 1 FONT 13
     ":" VIEW-AS TEXT
          SIZE 4 BY 2.05 AT ROW 10.05 COL 98.4 WIDGET-ID 188
          FGCOLOR 1 FONT 13
     ...
     "         NOVA SENHA:" VIEW-AS TEXT
          ...
          FGCOLOR 1 FONT 13
     RECT-3 AT ROW 6.71 COL 111.6 WIDGET-ID 136
     RECT-4 AT ROW 12.67 COL 111.6 WIDGET-ID 138
     RECT-5 AT ROW 15.76 COL 111.6 WIDGET-ID 140
     ...
     RECT-6 AT ROW 9.57 COL 111.6 WIDGET-ID 182
...
ASSIGN 
       ed_label_cpf:READ-ONLY IN FRAME f_cartao_alterar_senha        = TRUE.
...
DO:
    ...
    /* valida a senha atual com cpf, ainda nao possui letras */
    RUN procedures/valida_senha_cpf.p (INPUT ENCODE(ed_dsdsenan:SCREEN-VALUE),
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL ed_nrcpf w_cartao_alterar_senha
ON ANY-KEY OF ed_nrcpf IN FRAME f_cartao_alterar_senha
DO:
    RUN tecla.
...
OCXFile = SEARCH( "cartao_alterar_senha_cpf.wrx":U ).
IF OCXFile = ? THEN
...
END.
ELSE MESSAGE "cartao_alterar_senha_cpf.wrx":U SKIP(1)
...
------------------------------------------------------------------------------*/
  RUN control_load.
  DISPLAY ed_dsdsenan ed_nrcpf ed_dsdsennv ed_dsdsencf ed_label_cpf 
      WITH FRAME f_cartao_alterar_senha.
  ENABLE RECT-3 RECT-4 RECT-5 RECT-2 IMAGE-40 IMAGE-41 RECT-6 ed_dsdsenan 
         ed_nrcpf ed_dsdsennv ed_dsdsencf Btn_G Btn_H ed_label_cpf 
      WITH FRAME f_cartao_alterar_senha.
...
------------------------------------------------------------------------------*/
    ASSIGN  ed_dsdsenan:SCREEN-VALUE IN FRAME f_cartao_alterar_senha = ""
            ...
            ed_nrcpf:SCREEN-VALUE    IN FRAME f_cartao_alterar_senha = ""
            tmp_nrcpf = "".
