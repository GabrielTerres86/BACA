DECLARE
  ...
  vr_nmdir          VARCHAR2(4000) := CECRED.gene0001.fn_param_sistema('CRED',3,'ROOT_MICROS')||'cpd/bacas/RITM0336354';
  vr_nmarq          VARCHAR2(100)  := 'ROLLBACK_RITM0336354.sql';
  vr_exc_saida      EXCEPTION;

  CURSOR cr_principal IS
    SELECT c.progress_recid
          ,c.nrctacns
      FROM CECRED.crapass c
     WHERE c.nrctacns <> 0;
  ...
  BEGIN
      ...
      FOR rw_principal IN cr_principal LOOP
        ...
        vr_texto := ' UPDATE CECRED.crapass '
