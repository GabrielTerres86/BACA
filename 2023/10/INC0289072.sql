DECLARE
 ...
 vc_dstransa CONSTANT VARCHAR2(4000) := 'Ajuste no saldo bloqueado através do INC0289072';
  ...
  LOOP
	 ...
	 if vr_dscritic is null then
        ...
        CECRED.GENE0001.pc_gera_log_item(pr_nrdrowid => vr_nrdrowid,
                                        pr_nmdcampo => 'crapsld.vlsdbloq',
                                        pr_dsdadant => contas.vlsdbloq,
                                        pr_dsdadatu => 0);
		
		update cecred.crapsld set vlsdbloq = 0
