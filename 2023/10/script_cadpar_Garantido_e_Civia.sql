BEGIN
  ...
  INSERT INTO cecred.crappco(CDPARTAR
                            ...
                            ,DSCONTEU)
    VALUES
      ((SELECT a.cdpartar FROM CREDITO.crappat a WHERE a.nmpartar LIKE 'HISTORICOS_BOLETO_IQ_CRED/GARANTIDO/PF/PJ/%')
      ,3
  ...
  INSERT INTO crappat
    ...
    INSERT INTO crappco
      ...
      ,DSCONTEU)
    VALUES
      ((SELECT a.cdpartar FROM CREDITO.crappat a WHERE a.nmpartar LIKE 'HISTORICOS_TEDIQ_GARANTIDO/%')
      ,3
      ,'4272,4275,4276,4277');
    ...
    INSERT INTO crappco
      ...
      ,DSCONTEU)
    VALUES
      ((SELECT a.cdpartar FROM CREDITO.crappat a WHERE a.nmpartar LIKE 'HISTORICOS_CABINE_TEDIQ_GARANTIDO\%')
      ,3
      ,'4274');
