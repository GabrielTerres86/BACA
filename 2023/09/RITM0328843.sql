DECLARE
 ...
 CURSOR cr_crapass (i_cdcooper number,i_nrdconta number) is
  ...
  vr_arq_path            VARCHAR2(1000):= cecred.gene0001.fn_param_sistema('CRED',0,'ROOT_MICROS') || 'cpd/bacas/RITM0328843';
  vr_nmarquiv            VARCHAR2(100) := 'base_conta_credifoz.txt';
  vr_nmarqbkp            VARCHAR2(100) := 'RITM0328843_script_rollback_test.sql';
  vr_nmarqcri            VARCHAR2(100) := 'RITM0328843_script_log_test.txt';
  ...
  vr_lgrowid             ROWID;
  vr_vldcotas            NUMBER;
  vr_dstransa            VARCHAR2(100) := 'Reversão encerramento de conta em massa RITM0328843';
