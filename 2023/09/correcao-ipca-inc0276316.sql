DECLARE
  ...
  vr_cdprograma tbgen_prglog.cdprograma%type := 'INC0276316';
  ...
  CURSOR cr_craprac IS
    SELECT  rac.cdcooper
     ...
     WHERE rac.cdprodut = 1057
       AND rac.cdcooper = 1
       AND ((nrdconta = 7163045  and nraplica = 20) or
            (nrdconta = 9640380  and nraplica =  4) or
            (nrdconta = 11581859 and nraplica =  9) or
            (nrdconta = 14683768 and nraplica =  1));
