DECLARE
  ...
  vr_arq_path            VARCHAR2(1000):= cecred.gene0001.fn_param_sistema('CRED',0,'ROOT_MICROS') || 'cpd/bacas/RITM0335076';
  vr_nmarquiv            VARCHAR2(100) := 'Contas_viacredi_PROD_L2.txt';
  vr_nmarqbkp            VARCHAR2(100) := 'RITM0335076_script_rollback_test.sql';
  vr_nmarqcri            VARCHAR2(100) := 'RITM0335076_script_log_test.txt';
  ...
  procedure encerraConta(pr_cdcooper  IN  crapass.cdcooper%TYPE
    ...
    BEGIN
      ...
      SISTEMA.geraLog(pr_cdcooper => pr_cdcooper
                     ...
                     ,pr_dscritic => NULL
                     ,pr_dsorigem => 'AIMARO'
                     ,pr_dstransa => 'Conta encerrada por script - RITM0335076 '
