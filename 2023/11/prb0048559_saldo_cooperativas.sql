Declare 
  ...
  vc_dstransaSensbCRAPSLD             CONSTANT VARCHAR2(4000) := 'Sensibilizacao do Saldo (CRAPSLD) por script - prb0048559_cooperativas';
  vc_dstransaSensbCRAPSDA             CONSTANT VARCHAR2(4000) := 'Sensibilizacao do Saldo (CRAPSDA) por script - prb0048559_cooperativas';
  ...
  CURSOR cr_crapsld is
    SELECT a.nrdconta
      ...
      from CECRED.crapsld a
          ,(
SELECT 5 AS cdcooper, 125237 AS nrdconta, 5000 AS valor FROM dual UNION ALL
SELECT 2 AS cdcooper, 550400 AS nrdconta, 4635 AS valor FROM dual UNION ALL
SELECT 2 AS cdcooper, 550400 AS nrdconta, 4635 AS valor FROM dual UNION ALL
SELECT 2 AS cdcooper, 748870 AS nrdconta, 5290.7 AS valor FROM dual UNION ALL
SELECT 10 AS cdcooper, 116904 AS nrdconta, 2760 AS valor FROM dual UNION ALL
SELECT 11 AS cdcooper, 100560 AS nrdconta, 600 AS valor FROM dual UNION ALL
SELECT 16 AS cdcooper, 647250 AS nrdconta, 1965 AS valor FROM dual UNION ALL
SELECT 9 AS cdcooper, 18627 AS nrdconta, 495.98 AS valor FROM dual UNION ALL
SELECT 9 AS cdcooper, 126195 AS nrdconta, 580 AS valor FROM dual UNION ALL
SELECT 14 AS cdcooper, 46671 AS nrdconta, 15000 AS valor FROM dual UNION ALL
SELECT 14 AS cdcooper, 167045 AS nrdconta, 800 AS valor FROM dual
			) contas
