DECLARE
  ...
  vr_arq_path            VARCHAR2(1000):= cecred.gene0001.fn_param_sistema('CRED',0,'ROOT_MICROS') || 'cpd/bacas/RITM0339688';
  vr_nmarquiv            VARCHAR2(100) := 'contas_credcrea_HML.txt';
  vr_nmarqbkp            VARCHAR2(100) := 'RITM0339688_script_rollback_test.sql';
  vr_nmarqcri            VARCHAR2(100) := 'RITM0339688_script_log_test.txt';
  ...
  PROCEDURE TrocaPA(pr_cdcooper  IN  crapass.cdcooper%TYPE
    ...
    vr_cdagenew    CONSTANT NUMBER := 95;
  ...
  if cr_crapass%found THEN
     BEGIN 
         UPDATE CECRED.crapass t SET t.cdagenci = vr_cdagenew
     ...
     EXCEPTION
       ...
       ELSE
          ...
          BEGIN
            UPDATE cecred.crapalt SET dsaltera = rg_altera.dsaltera||'PA '||conta.cdagenci||'-'||vr_cdagenew||','
