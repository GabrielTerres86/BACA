DECLARE
  ...
  vc_dstransaStatusCC             CONSTANT VARCHAR2(4000) := 'Alteracao da situacao de conta por script - INC0281974';
  vc_dstransaDevCotas             CONSTANT VARCHAR2(4000) := 'Alteração de Cotas e devolução - INC0281974';
  vc_dstransaDevDepVista          CONSTANT VARCHAR2(4000) := 'Alteracao da devolução do Depósito a Vista - INC0281974';
  ...
  CURSOR cr_crapass is
    SELECT t.cdagenci
      ...
      FROM CECRED.CRAPASS t
         ,(select 6 as cdcooper, 
            decode(vr_globalname, vc_bdprod, 121967,99877970) as nrdconta, 
              vc_cdsitdctProcesDemis as cdsitdct, 
          null as dtdemiss, 
          null as dtelimin, 
          null as dtasitct, 
          null as  cdmotdem from dual) a
     WHERE 1=1
