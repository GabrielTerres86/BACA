begin
  insert into tbseg_parametros_prst (IDSEQPAR, CDCOOPER, TPPESSOA, CDSEGURA, TPDPAGTO, MODALIDA, QTPARCEL, PIEDIAS, PIEPARCE, PIELIMIT, PIETAXA, IFTTDIAS, IFTTPARC, IFTTLIMI, IFTTTAXA, LMPSELEG, TPCUSTEI, VLCOMISS, TPADESAO, LIMITDPS, NRAPOLIC, ENDERFTP, LOGINFTP, SENHAFTP, FLGELEPF, FLGINDEN, IDADEDPS, PAGSEGU, SEQARQU, DTINIVIGENCIA, DTFIMVIGENCIA, LMINSOCI, DTCTRMISTA)
