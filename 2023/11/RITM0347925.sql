DECLARE
  ...
  vr_arq_path            VARCHAR2(1000):= cecred.gene0001.fn_param_sistema('CRED',0,'ROOT_MICROS') || 'cpd/bacas/RITM0347925';
  vr_nmarquiv            VARCHAR2(100) := 'contas_viacredi_HML.txt';
  vr_nmarqbkp            VARCHAR2(100) := 'RITM0347925_script_rollback_test.sql';
  vr_nmarqcri            VARCHAR2(100) := 'RITM0347925_script_log_test.txt';
