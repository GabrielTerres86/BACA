  ...
  CURSOR cr_crapsld is
    SELECT a.nrdconta
      ...
      from CECRED.crapsld a
          ,(
SELECT 1 AS cdcooper, 99999927 AS nrdconta, 1000 AS valor FROM dual UNION ALL
SELECT 1 AS cdcooper, 99999919 AS nrdconta, (1000-115.67) AS valor FROM dual UNION ALL
SELECT 1 AS cdcooper, 99999900 AS nrdconta, 1000 AS valor FROM dual UNION ALL
SELECT 1 AS cdcooper, 99999846 AS nrdconta, (1000+486.40) AS valor FROM dual
			) contas
