...
Begin
  ...
  delete from CECRED.tbcc_lancamentos_pendentes t
   where t.nrdconta = 984302
     and t.cdcooper = 2
     and t.dtmvtolt = to_date('03/11/2023', 'DD/MM/RRRR')
     and t.nrdcmto = 2003;
     
  delete from CECRED.tbcc_lancamentos_pendentes t
   where t.nrdconta = 984302
     and t.cdcooper = 2
     and t.dtmvtolt = to_date('07/11/2023', 'DD/MM/RRRR')
     and t.nrdcmto = 2003;     
