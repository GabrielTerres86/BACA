...
BEGIN
  ...
  VALUES (aux_cdpartar_add, 'HABNEUROCONSIG - Habilita Neurotech para subprodutos de empréstimo (S/N)', 2, 13);

  INSERT INTO cecred.crapbat (CDBATTAR, NMIDENTI, CDPROGRA, TPCADAST, CDCADAST)
  VALUES ('HABNEUROCONSIG', 'HABNEUROCONSIG - Habilita Neurotech para subprodutos de empréstimo (S/N)', ' ', 2, aux_cdpartar_add);
  ...
  INSERT INTO cecred.crappat (CDPARTAR, NMPARTAR, TPDEDADO, CDPRODUT)
  VALUES (aux_cdpartar_add, 'HABNEURORENEG - Habilita Neurotech para subprodutos de empréstimo (S/N)', 2, 13);

  INSERT INTO cecred.crapbat (CDBATTAR, NMIDENTI, CDPROGRA, TPCADAST, CDCADAST)
  VALUES ('HABNEURORENEG', 'HABNEURORENEG - Habilita Neurotech para subprodutos de empréstimo (S/N)', ' ', 2, aux_cdpartar_add);
  ...
  INSERT INTO cecred.crappat (CDPARTAR, NMPARTAR, TPDEDADO, CDPRODUT)
  VALUES (aux_cdpartar_add, 'HABNEUROIMOB - Habilita Neurotech para subprodutos de empréstimo (S/N)', 2, 13);

  INSERT INTO cecred.crapbat (CDBATTAR, NMIDENTI, CDPROGRA, TPCADAST, CDCADAST)
  VALUES ('HABNEUROIMOB', 'HABNEUROIMOB - Habilita Neurotech para subprodutos de empréstimo (S/N)', ' ', 2, aux_cdpartar_add);
