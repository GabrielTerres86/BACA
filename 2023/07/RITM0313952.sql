DECLARE
  ...
  vr_arq_path            VARCHAR2(1000):= cecred.gene0001.fn_param_sistema('CRED',0,'ROOT_MICROS') || 'cpd/bacas/RITM0313952';
  vr_nmarquiv            VARCHAR2(100) := 'contas_RITM0313952_DEV.txt';
  vr_nmarqbkp            VARCHAR2(100) := 'RITM0313952_script_rollback_DEV.sql';
  vr_nmarqcri            VARCHAR2(100) := 'RITM0313952_script_log_DEV.txt';
