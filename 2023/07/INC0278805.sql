Declare 
  ...
  vc_dstransaSensbCRAPSLD             CONSTANT VARCHAR2(4000) := 'Sensibilizacao do Saldo (CRAPSLD) por script - INC0278805';
  vc_dstransaSensbCRAPSDA             CONSTANT VARCHAR2(4000) := 'Sensibilizacao do Saldo (CRAPSDA) por script - INC0278805';
  vc_dtinicioCRAPSDA                  CONSTANT DATE           := to_date('29/05/2023','dd/mm/yyyy');
  ...
  CURSOR cr_crapsld is
    SELECT a.nrdconta
      ...
      from CECRED.crapsld a
          ,(select 1 as cdcooper, 10679057 as nrdconta, 836.22  as valor from dual
            union all
            select 1 as cdcooper, 7247249 as nrdconta, 2815.38 as valor from dual
            union all
            select 1 as cdcooper, 10643087 as nrdconta, 391.11  as valor from dual
            union all
            select 1 as cdcooper, 10874356 as nrdconta, 118.15  as valor from dual
            union all 
            select 1 as cdcooper, 11237457 as nrdconta, 122.2   as valor from dual            
      ) contas
