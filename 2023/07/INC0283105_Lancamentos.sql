...
BEGIN
  ...
  BEGIN
    UPDATE CECRED.TBDOMIC_LIQTRANS_ARQUIVO
       SET NMARQUIVO_RETORNO = NMARQUIVO_GERADO || '_RET'
          ,DHARQUIVO_RETORNO = SYSDATE
     WHERE IDARQUIVO IN (767842,
                         767843,
                         767844,
                         767870,
                         767880,
  ...
  BEGIN
    UPDATE CECRED.TBDOMIC_LIQTRANS_PDV
       SET DHRETORNO = SYSDATE
          ,DSERRO    = NULL
     WHERE IDCENTRALIZA IN (SELECT IDCENTRALIZA
                              FROM CECRED.TBDOMIC_LIQTRANS_CENTRALIZA TLC
