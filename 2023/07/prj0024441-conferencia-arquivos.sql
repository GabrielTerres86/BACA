...
BEGIN
  ...
  LOOP
    ...
    VALUES ('PCRARQ', 5, 'C,A,M', 'CONCILIACAO ACMP', 'CONCILIACAO ACMP', 0, 1, ' ', 'CONSULTAR,ALTERAR,MANUTENCAO', 1, pr_cdcooper, 1, 0, 1, 1, ' ', 2);
    
    
    
    INSERT INTO crapace(nmdatela, cddopcao, cdoperad, nmrotina, cdcooper, nrmodulo, idevento, idambace) 
    VALUES ('PCRARQ', 'C', 't0034369', ' ', pr_cdcooper, 1, 0, 2);
    ...
    VALUES ('CRED', 'PCRARQ', 'Monitor de Arquivos ACMP', null, null, null, 1, 998, 1, 0, 0, 0, 0, 0, 0, pr_cdcooper, null);

  END LOOP;
    
  
  INSERT INTO craprdr (nmprogra, dtsolici)
       VALUES ('TELA_PCRARQ',SYSDATE);

  INSERT INTO crapaca (NMDEACAO, NMPACKAG, NMPROCED, LSTPARAM, NRSEQRDR)
       VALUES ('LISTA_ARQUIVOS_ACMP', 'TELA_PCRARQ', 'pc_lista_arquivos', 'pr_dtmovimento', (select nrseqrdr from craprdr where nmprogra = 'TELA_PCRARQ'));
