DECLARE
  ...
  CURSOR cr_crapass is
    SELECT a.nrdconta,
     ...
     WHERE a.progress_recid = 1676294;
  ...
  vr_arq_path    VARCHAR2(1000):= cecred.gene0001.fn_param_sistema('CRED',0,'ROOT_MICROS') || 'cpd/bacas/RITM0313970'; 

  vr_nmarqrol    VARCHAR2(100) := 'RITM0313970b_script_rollback.sql';
  vr_nmarqlog    VARCHAR2(100) := 'RITM0313970b_script_log.txt';  

  vr_flarqrol    utl_file.file_type;
  vr_flarqlog    utl_file.file_type;
  
  vr_lgrowid     ROWID;
  vr_dstransa    VARCHAR2(100) := 'Alterada situacao de conta por script. RITM0313970b.';
