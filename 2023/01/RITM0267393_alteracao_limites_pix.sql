DECLARE
  ...
  CURSOR cr_rollback(pr_cdcooper IN NUMBER,
    ...
    SELECT coalesce(snh.vllimite_pix,0) vllimite_pix,
           coalesce(snh.vllimite_pix_cooperado,0) vllimite_pix_cooperado,
           (SELECT MAX(vllimite)
...
BEGIN
  ...
  END LOOP;
  gene0001.pc_escr_linha_arquivo(pr_utlfileh => vr_handle_log,
                                 pr_des_text => 'Coop;Conta;Titular;Valor_Limite;Valor_Limite_Noturno');
