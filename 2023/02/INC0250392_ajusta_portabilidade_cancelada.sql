DECLARE                                 
  ...
  SELECT t.nrnu_portabilidade,
   ...
   WHERE T.NRNU_PORTABILIDADE = '202301020000249298973';                                 
  ...
  vc_dtcancel                    CONSTANT DATE         := to_date('02/01/2023','dd/mm/yyyy');
  vc_nmarquiv                    CONSTANT VARCHAR2(60) := 'APCS106_05463212_20230102_00068';
...
BEGIN
  ...
  vr_dstransa := 'Alteracao da situacao portabilidade - INC0250392 - ' || vr_tabela;
