...
BEGIN
	...
	v_dados(v_dados.last()).vr_vllanmto := 275.58;
	...
	v_dados(v_dados.last()).vr_vllanmto := 138.36;
	v_dados(v_dados.last()).vr_cdhistor := 3883;
	...
	v_dados(v_dados.last()).vr_vllanmto := 65.84;
	v_dados(v_dados.last()).vr_cdhistor := 3883;
	...
	v_dados(v_dados.last()).vr_vllanmto := 173.78;
	v_dados(v_dados.last()).vr_cdhistor := 3883;
	...
	v_dados(v_dados.last()).vr_vllanmto := 189.48;
	v_dados(v_dados.last()).vr_cdhistor := 3883;

	v_dados.extend();
	v_dados(v_dados.last()).vr_cdcooper := 16;
	v_dados(v_dados.last()).vr_nrdconta := 313394;
	v_dados(v_dados.last()).vr_nrctremp := 526047;
	v_dados(v_dados.last()).vr_vllanmto := 109.38;
	v_dados(v_dados.last()).vr_cdhistor := 3883;
	...
	v_dados(v_dados.last()).vr_vllanmto := 165.96;
	v_dados(v_dados.last()).vr_cdhistor := 3883;
	...
	v_dados(v_dados.last()).vr_vllanmto := 147.76;
	v_dados(v_dados.last()).vr_cdhistor := 3883;
	...
	v_dados(v_dados.last()).vr_vllanmto := 161.44;
	v_dados(v_dados.last()).vr_cdhistor := 3883;
	...
	v_dados(v_dados.last()).vr_vllanmto := 66.32;
	v_dados(v_dados.last()).vr_cdhistor := 3883;

	v_dados.extend();
	v_dados(v_dados.last()).vr_cdcooper := 16;
	v_dados(v_dados.last()).vr_nrdconta := 2473585;
	v_dados(v_dados.last()).vr_nrctremp := 540419;
	...
	v_dados(v_dados.last()).vr_vllanmto := 56.36;
	v_dados(v_dados.last()).vr_cdhistor := 3883;
	...
	v_dados(v_dados.last()).vr_vllanmto := 89.64;
	v_dados(v_dados.last()).vr_cdhistor := 3883;

	v_dados.extend();
	v_dados(v_dados.last()).vr_cdcooper := 16;
	v_dados(v_dados.last()).vr_nrdconta := 15312143;
	v_dados(v_dados.last()).vr_nrctremp := 535878;
	...
	v_dados(v_dados.last()).vr_vllanmto := 107.52;
	v_dados(v_dados.last()).vr_cdhistor := 3883;
