DECLARE
  ...
  vr_nmarqrol    VARCHAR2(100) := 'INC0248555_Viacredi_script_rollback.sql';
  vr_nmarqlog    VARCHAR2(100) := 'INC0248555_Viacredi_script_log.txt';  
