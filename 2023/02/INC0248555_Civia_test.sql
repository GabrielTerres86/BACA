DECLARE
  ...
  vr_arq_path    VARCHAR2(1000):= cecred.gene0001.fn_param_sistema('CRED',0,'ROOT_MICROS') || 'cpd/bacas/INC0248555'; 

  vr_nmarqrol    VARCHAR2(100) := 'INC0248555_Civia_script_rollback.sql';
  vr_nmarqlog    VARCHAR2(100) := 'INC0248555_Civia_script_log.txt';  
  ...
  vr_cdagenew    CONSTANT NUMBER := 08;
