DECLARE
  vr_cdcooper  craplim.cdcooper%TYPE := 11;
  vr_nrdconta  craplim.nrdconta%TYPE := 472026;
  vr_nrctrlim  craplim.nrctrlim%TYPE := 105310;
  vr_nrcpf     crapass.nrcpfcgc%TYPE := '28032164000110'; 
