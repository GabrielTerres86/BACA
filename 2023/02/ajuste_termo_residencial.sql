DECLARE texto CLOB := '{
    ...
    {
       "conteudo": "1. Ao finalizar esta jornada, o Cooperado está solicitando a contratação do Seguro Residencial, nos termos e condições apresentadas na simulação realizada por meio do acesso aos Canais Digitais."
    },
    {
       "conteudo": "2. As Condições Gerais do Seguro, bem como as condições de assistência residencial, poderão ser visualizadas no site da seguradora contratada."
    },
    {
    ...
    },
  {
    ...
    {
       "conteudo": "3.6. A contratação desse seguro foi realizada por meio de Canal Digital, escolhido por ele;"
    },
    {
    ...
    {
       "conteudo": "5. A apólice do seguro será enviada ao Cooperado através do e-mail informado no momento da solicitação do seguro (dados de contato), após a confirmação da contratação pela Seguradora. A vigência do seguro iniciará às 00hrs do dia do recebimento da confirmação. Para solicitação dos Serviços de Assistência ou em caso de Sinistro, você poderá contatar a Seguradora através dos números informados na Apólice."
    },
  {
...
BEGIN
  UPDATE SEGURO.tbseg_template_documento SET dtfim = trunc(sysdate) WHERE tpdocumento = 1;
  INSERT INTO SEGURO.tbseg_template_documento(tpdocumento,dtinicio,dtfim,obtemplate) VALUES (1,TRUNC(SYSDATE) + 1,NULL, texto);
  COMMIT;
