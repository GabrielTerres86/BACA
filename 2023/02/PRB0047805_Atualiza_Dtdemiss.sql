    ...
    SELECT t.cdcooper
      ...
      FROM CECRED.CRAPASS t
         ,(select 1 as cdcooper, decode(pr_globalname, vc_bdprod, 11828510,88171426) as nrdconta, to_date('13/07/2021','dd/mm/yyyy') as dtdemiss, 11 as  cdmotdem from dual union all
           ...
           select 2 as cdcooper, decode(pr_globalname, vc_bdprod, 950165,99049775) as nrdconta, to_date('13/05/2020','dd/mm/yyyy')  as dtdemiss, 11 as  cdmotdem from dual union all
           select 2 as cdcooper, decode(pr_globalname, vc_bdprod, 1019600,98980335) as nrdconta, to_date('12/02/2021','dd/mm/yyyy')  as dtdemiss, 11 as  cdmotdem from dual union all
           select 2 as cdcooper, decode(pr_globalname, vc_bdprod, 986658,99013282) as nrdconta, to_date('30/07/2020','dd/mm/yyyy')  as dtdemiss, 11 as  cdmotdem from dual union all
           ...
           select 10 as cdcooper, decode(pr_globalname, vc_bdprod, 180602,99819333) as nrdconta, to_date('15/12/2015','dd/mm/yyyy')  as dtdemiss, 11 as  cdmotdem from dual union all
           ...
           select 11 as cdcooper, decode(pr_globalname, vc_bdprod, 876194,99123746) as nrdconta, to_date('18/02/2021','dd/mm/yyyy')  as dtdemiss, 11 as  cdmotdem from dual union all
           select 11 as cdcooper, decode(pr_globalname, vc_bdprod, 655244,99344696) as nrdconta, to_date('27/05/2016','dd/mm/yyyy')  as dtdemiss, 11 as  cdmotdem from dual
           ) a
     WHERE 1=1
