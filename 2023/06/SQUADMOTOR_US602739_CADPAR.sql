...
BEGIN
  ...
  values (aux_cdpartar_add, 'US602739 - Variaveis JSON (1-Ligado/0-Desligado)', 2, 13);
  insert into crapbat (CDBATTAR, NMIDENTI, CDPROGRA, TPCADAST, CDCADAST)
  values ('US602739', 'US602739 - Variaveis JSON (1-Ligado/0-Desligado)', ' ', 2, aux_cdpartar_add);
