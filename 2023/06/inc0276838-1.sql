...
BEGIN
  ...
  v_dados(v_dados.last()).vr_nrctremp := 290916;
  ...
  v_dados(v_dados.last()).vr_nrctremp := 230976;
  v_dados(v_dados.last()).vr_vllanmto := 44657.54;
  v_dados(v_dados.last()).vr_cdhistor := 3918;

  v_dados.extend();
  v_dados(v_dados.last()).vr_cdcooper := 13;
  v_dados(v_dados.last()).vr_nrdconta := 14625660;
  v_dados(v_dados.last()).vr_nrctremp := 262833;
  v_dados(v_dados.last()).vr_vllanmto := 3812.42;
  v_dados(v_dados.last()).vr_cdhistor := 3918;
