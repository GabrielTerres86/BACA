...
BEGIN
  ...
  v_dados(v_dados.last()).vr_vllanmto := 84.29;
  v_dados(v_dados.last()).vr_cdhistor := 3919;
  
  v_dados.extend();
  v_dados(v_dados.last()).vr_cdcooper := 2;
  v_dados(v_dados.last()).vr_nrdconta := 1123130;
  v_dados(v_dados.last()).vr_nrctremp := 419241;
  v_dados(v_dados.last()).vr_vllanmto := 9076.67;
  v_dados(v_dados.last()).vr_cdhistor := 3918;
  
  v_dados.extend();
  v_dados(v_dados.last()).vr_cdcooper := 2;
  v_dados(v_dados.last()).vr_nrdconta := 1126300;
  v_dados(v_dados.last()).vr_nrctremp := 442270;
  ...
  v_dados(v_dados.last()).vr_vllanmto := 28.58;
  v_dados(v_dados.last()).vr_cdhistor := 3918;
