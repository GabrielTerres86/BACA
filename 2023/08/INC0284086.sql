...
BEGIN
  ...
  vr_nmdireto := cecred.gene0001.fn_param_sistema('CRED',3,'ROOT_MICROS') || 'cpd/bacas/INC0284086';
  vr_nmarqrbk := 'ROLLBACK_INC0284086_'||to_char(sysdate,'ddmmyyyy_hh24miss')||'.sql';
  ...
  IF cr_crapass%FOUND THEN
    ...
    gene0002.pc_escreve_xml(vr_dados_rollback
                           ,vr_texto_rollback
                           ,'UPDATE cecred.tbrisco_operacoes o ' || chr(13) || 
                            '   SET o.inrisco_rating = '|| risc0004.fn_traduz_nivel_risco('HH') || chr(13) ||
                            '      ,o.inrisco_inclusao = '|| risc0004.fn_traduz_nivel_risco('HH') || chr(13) ||
                            ' WHERE o.cdcooper = ' || vr_cdcooper  || chr(13) ||
                            '   AND o.nrdconta = ' || vr_nrdconta  || chr(13) ||
                            '   AND o.nrctremp = ' || vr_nrctremp  || chr(13) ||
                            '   AND o.tpctrato = 90;' ||chr(13)||chr(13), FALSE);    
