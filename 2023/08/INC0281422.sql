DECLARE
  ...
  vr_cdcooper       cecred.crapepr.cdcooper%TYPE := 11;
  vr_nrctremp       cecred.crapepr.nrctremp%TYPE := 137109;
  vr_progress_recid cecred.crapass.progress_recid%TYPE := 1111512;
