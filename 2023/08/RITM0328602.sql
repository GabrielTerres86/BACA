DECLARE
 ...
 CURSOR cr_crapass (i_cdcooper number,i_nrdconta number) is
  ...
  vr_arq_path            VARCHAR2(1000):= cecred.gene0001.fn_param_sistema('CRED',0,'ROOT_MICROS') || 'cpd/bacas/RITM0328602';
  vr_nmarquiv            VARCHAR2(100) := 'base_contas_reversao.txt';
  vr_nmarqbkp            VARCHAR2(100) := 'RITM0328602_script_rollback_test.sql';
  vr_nmarqcri            VARCHAR2(100) := 'RITM0328602_script_log_test.txt';
