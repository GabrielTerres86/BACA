Declare 
  ...
  vc_dstransaSensbCRAPSLD             CONSTANT VARCHAR2(4000) := 'Sensibilizacao do Saldo (CRAPSLD) por script - INC0283744';
  vc_dstransaSensbCRAPSDA             CONSTANT VARCHAR2(4000) := 'Sensibilizacao do Saldo (CRAPSDA) por script - INC0283744';
  ...
  CURSOR cr_crapsld is
    SELECT a.nrdconta
      ...
      from CECRED.crapsld a
          ,(select 1 as cdcooper,  9090770 as nrdconta, 51.57  as valor from dual
            union all
            select 1 as cdcooper, 13391526 as nrdconta, 106.43 as valor from dual
           ) contas
