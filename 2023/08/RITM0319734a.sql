DECLARE
  ...
  vr_nmarquiv            VARCHAR2(100) := 'base_contas_prodA.txt';
  vr_nmarqbkp            VARCHAR2(100) := 'RITM0319734a_script_rollback_test.sql';
  vr_nmarqcri            VARCHAR2(100) := 'RITM0319734a_script_log_test.txt';
