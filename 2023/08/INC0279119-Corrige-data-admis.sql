DECLARE
  ...
  vr_nmarquiv           VARCHAR2(50) := 'INC0279119_dados.csv';
  vr_input_file         UTL_FILE.FILE_TYPE;
  vr_nmarqbkp           VARCHAR2(50) := 'INC0279119_script_ROLLBACK';
  vr_ind_arquiv         utl_file.file_type;
  vr_nmarqlog           VARCHAR2(50) := 'INC0279119_relatorio_exec.txt';
...
BEGIN
  ...
  vr_nmdireto := gene0001.fn_param_sistema('CRED',3,'ROOT_MICROS') || 'cpd/bacas/INC0279119';
  ...
  BEGIN
    ...
    UPDATE CECRED.Crapass a
      SET a.dtadmiss = TO_DATE('24/05/2022', 'DD/MM/RRRR')
    ...
    gene0001.pc_escr_linha_arquivo(vr_ind_arquiv, ' UPDATE CECRED.Crapass a SET a.dtadmiss = NULL ' 
                                                  || ' WHERE cdcooper = ' || vr_cdcooper 
                                                  || '   and nrdconta = ' || vr_nrdconta 
                                                  || '   and nrcpfcgc = ' || vr_nrcpfcgc || ';');
