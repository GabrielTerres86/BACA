DECLARE
  ...
  vc_dstransaStatusCC             CONSTANT VARCHAR2(4000) := 'Alteracao da situacao de conta por script - INC0282754';
  vc_dstransaDevCotas             CONSTANT VARCHAR2(4000) := 'Alteração de Cotas e devolução - INC0282754';
  vc_dstransaDevDepVista          CONSTANT VARCHAR2(4000) := 'Alteracao da devolução do Depósito a Vista - INC0282754';
  ...
  CURSOR cr_crapass is
    SELECT t.cdagenci
      ...
      FROM CECRED.CRAPASS t
         ,(select 16 as cdcooper, decode(vr_globalname, vc_bdprod, 1064738,98935208) as nrdconta, vc_cdsitdctEncerrada as cdsitdct, sysdate as dtdemiss, sysdate as dtelimin, sysdate as dtasitct, 11 as  cdmotdem from dual)
           a
     WHERE 1=1
