DECLARE
  ...
  vr_nmarquiv            VARCHAR2(100) := 'base_contas_viacred1.txt';
  vr_nmarqbkp            VARCHAR2(100) := 'RITM0323075a_script_rollback_test.sql';
  vr_nmarqcri            VARCHAR2(100) := 'RITM0323075a_script_log_test.txt';
