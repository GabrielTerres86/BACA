DECLARE
  ...
  vr_nmarquiv            VARCHAR2(100) := 'base_contas_prod.txt';
  vr_nmarqbkp            VARCHAR2(100) := 'RITM0319734c_script_rollback_test.sql';
  vr_nmarqcri            VARCHAR2(100) := 'RITM0319734c_script_log_test.txt';
