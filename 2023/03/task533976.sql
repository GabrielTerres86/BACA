...
BEGIN
  ...
  v_dados(v_dados.last()).vr_vllanmto := 746.28;
  ...
  v_dados(v_dados.last()).vr_vllanmto := 91.82;
  ...
  v_dados(v_dados.last()).vr_vllanmto := 733.34;
  v_dados(v_dados.last()).vr_cdhistor := 3919;
  ...
  v_dados(v_dados.last()).vr_vllanmto := 89.15;
  v_dados(v_dados.last()).vr_cdhistor := 3918;
  ...
  v_dados(v_dados.last()).vr_vllanmto := 184.88;
  v_dados(v_dados.last()).vr_cdhistor := 3883;
  ...
  v_dados(v_dados.last()).vr_vllanmto := 154.44;
  v_dados(v_dados.last()).vr_cdhistor := 3883;
  ...
  v_dados(v_dados.last()).vr_vllanmto := 748.48;
  v_dados(v_dados.last()).vr_cdhistor := 3919;
