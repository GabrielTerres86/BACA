DECLARE
  ...
  TYPE typ_reg_arq IS RECORD(nrproposta CECRED.tbseg_prestamista.nrproposta%TYPE,
                             cdcooper   CECRED.tbseg_prestamista.cdcooper%TYPE,
                             cpf        CECRED.tbseg_prestamista.nrcpfcgc%TYPE,
                             pa         CECRED.crapseg.cdagenci%TYPE,
                             tiporecus  CECRED.tbseg_prestamista.tprecusa%TYPE,
                             motivorec  CECRED.tbseg_prestamista.cdmotrec%TYPE,
                             ...
                             nrctrseg   CECRED.tbseg_prestamista.nrctrseg%TYPE,
                             vlrsegur   CECRED.tbseg_prestamista.vlsdeved%TYPE,
