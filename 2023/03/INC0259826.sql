DECLARE
  ...
  vr_nmarquiv           VARCHAR2(50) := 'INC0259826_dados.csv';
  vr_nmarqbkp           VARCHAR2(50) := 'INC0259826_script_ROLLBACK.sql';
  vr_nmarqlog           VARCHAR2(50) := 'INC0259826_relatorio_exec.txt';
