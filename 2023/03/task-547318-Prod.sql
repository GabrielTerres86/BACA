DECLARE
  ...
  CURSOR cr_craprac IS
    select  16 cdcooper,  187399   nrdconta,  26 nraplica,  0.78 vllanmto from dual union all
    select  1  cdcooper,  13923463 nrdconta,  5  nraplica, 58.82 vllanmto from dual union all
    select  1  cdcooper,  2575728  nrdconta,  4  nraplica, 16.40 vllanmto from dual union all    
    select  1  cdcooper,  7663625  nrdconta,  43 nraplica, 18.90 vllanmto from dual union all
    select  1  cdcooper,  6797954  nrdconta,  72 nraplica,  1.88 vllanmto from dual union all    
    select  1  cdcooper,  14405903 nrdconta,  11 nraplica,  0.70 vllanmto from dual union all        
    select  1  cdcooper,  13306030 nrdconta,  1  nraplica,  9.28 vllanmto from dual union all
    select  1  cdcooper,  12021741 nrdconta,  34 nraplica,  2.14 vllanmto from dual ;
