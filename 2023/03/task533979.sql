...
BEGIN
  ...
  v_dados(v_dados.last()).vr_vllanmto := 438.09;
  ...
  v_dados.extend();
  v_dados(v_dados.last()).vr_cdcooper := 14;
  v_dados(v_dados.last()).vr_nrdconta := 332755;
  v_dados(v_dados.last()).vr_nrctremp := 87319;
  v_dados(v_dados.last()).vr_vllanmto := 119.73;
  v_dados(v_dados.last()).vr_cdhistor := 3919;
  ...
  v_dados(v_dados.last()).vr_vllanmto := 511.46;
  v_dados(v_dados.last()).vr_cdhistor := 3919;
  ...
  v_dados(v_dados.last()).vr_vllanmto := 151.9;
  v_dados(v_dados.last()).vr_cdhistor := 3919;

  v_dados.extend();
  v_dados(v_dados.last()).vr_cdcooper := 14;
  v_dados(v_dados.last()).vr_nrdconta := 16052811;
  v_dados(v_dados.last()).vr_nrctremp := 93223;
  v_dados(v_dados.last()).vr_vllanmto := 241.08;
  v_dados(v_dados.last()).vr_cdhistor := 3919;
