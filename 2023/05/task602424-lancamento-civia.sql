DECLARE
  ...
  vr_nrdconta cecred.crapass.nrdconta%TYPE := 218847;
  vr_nrctremp cecred.craplem.nrctremp%TYPE := 182279;
  vr_nrparepr cecred.craplem.nrparepr%TYPE := 12;
  vr_vllanmto cecred.craplem.vllanmto%TYPE := 2.44;
  vr_cdhistor cecred.craplem.cdhistor%TYPE := 1044;
