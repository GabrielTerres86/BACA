...
BEGIN
  ...
  v_dados(v_dados.last()).vr_nrdconta := 7489498;
  v_dados(v_dados.last()).vr_nrctremp := 6283892;
  ...
  v_dados(v_dados.last()).vr_nrdconta := 14518414;
  v_dados(v_dados.last()).vr_nrctremp := 76423;
