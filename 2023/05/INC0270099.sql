DECLARE
  ...
  vr_nmarquiv           VARCHAR2(50) := 'INC0270099_dados.csv';
  vr_nmarqbkp           VARCHAR2(50) := 'INC0270099_script_ROLLBACK.sql';
  vr_nmarqlog           VARCHAR2(50) := 'INC0270099_relatorio_exec.txt';
...
BEGIN
  ...
  vr_nmdireto := gene0001.fn_param_sistema('CRED',3,'ROOT_MICROS') || 'cpd/bacas/INC0270099';
