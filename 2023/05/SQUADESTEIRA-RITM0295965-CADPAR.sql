...
BEGIN
  ...
  values (aux_cdpartar_add, 'RITM0295965 - Envia resultado motor para Esteira (0-Desligado/1-Ligado)', 2, 13);

  insert into crapbat (CDBATTAR, NMIDENTI, CDPROGRA, TPCADAST, CDCADAST)
  values ('RITM0295965', 'RITM0295965 - Envia resultado motor para Esteira (0-Desligado/1-Ligado)', ' ', 2, aux_cdpartar_add);
