...
BEGIN
  ...
  vr_nmdireto := vr_dsdireto||'cpd/bacas/INC0270264'; 
  vr_nmarqbkp := 'INC0270264_'||to_char(sysdate,'ddmmyyyy_hh24miss')||'.sql';
  ...
  CECRED.GENE0001.pc_gera_log(pr_cdcooper => 9
                             ,pr_cdoperad => 1
                             ,pr_dscritic => vr_dscritic
                             ,pr_dsorigem => 'AIMARO'
  ...
  gene0002.pc_escreve_xml(vr_dados_rollback
                         ...
                         ,'UPDATE cecred.tbrisco_operacoes o' || chr(13) || 
                          ...
                          ' WHERE o.cdcooper = 9' || chr(13) || 
                          '   AND o.nrdconta = ' || vr_nrdconta     || chr(13) || 
                          '   AND o.nrctremp = 76954' || 
                          ';' ||chr(13)||chr(13), FALSE); 
  ...
  gene0002.pc_escreve_xml(vr_dados_rollback
                         ...
                         ,'UPDATE cecred.crawepr w' || chr(13) || 
                          ...
                          ' WHERE w.cdcooper = 9'|| chr(13) || 
                          '   AND w.nrdconta = ' || vr_nrdconta     || chr(13) || 
                          '   AND w.nrctremp = 76954' || 
                          ';' ||chr(13)||chr(13), FALSE); 
