begin
      ...
      BEGIN
        ...
        OPEN cr_seg_parametro_prst(pr_cdcooper => pr_cdcooper,
          ...
          IF cr_seg_parametro_prst%NOTFOUND THEN
            ...
            vr_dscritic := 'N&atilde;o foi poss&iacute;vel localizar taxa de pagamento da seguradora. PC_PARAMETROS_PRST';          
            RAISE vr_exc_saida;
          END IF;           
        CLOSE cr_seg_parametro_prst;
  ...
  pc_valida_direto(pr_nmdireto => vr_nmdireto || '/INC0270223',
                   pr_dscritic => vr_dscritic);
  ...
  vr_nmdireto := vr_nmdireto || '/INC0270223';
    ...
    vr_nmarqbkp := 'ROLLBACK_INC0270223' || to_char(sysdate, 'hh24miss') ||'.sql';     
