DECLARE
        ...
        vr_nmarq  VARCHAR2(100)  := 'ROLLBACK_INC0270109_arq_fat_fevereiro.sql';
        ...
        CURSOR cr_prestamista(pr_cdcooper IN cecred.crapcop.cdcooper%TYPE,
          ...
          SELECT p.idseqtra
           ...
           WHERE p.cdcooper = pr_cdcooper    
             ...
             AND p.tpcustei = 1 
             AND p.tpregist = 1  
             AND p.nrdconta = 597481
             AND p.nrctremp = 183461
  ...
  BEGIN
    ...
    FOR rw_crapcop IN cr_crapcop LOOP
      ...
      ELSE
        ...
        vr_ultimoDia := ADD_MONTHS(trunc(sysdate,'MONTH'),-2)-1; 
