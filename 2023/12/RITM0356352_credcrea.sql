DECLARE
  ...
  vr_nmarquiv            VARCHAR2(100) := 'contas_credcrea_PROD.txt';
  vr_nmarqbkp            VARCHAR2(100) := 'RITM0356352_credcrea_script_rollback.sql';
  vr_nmarqcri            VARCHAR2(100) := 'RITM0356352_credcrea_script_log.txt';
  ...
  PROCEDURE TrocaPA(pr_cdcooper  IN  crapass.cdcooper%TYPE
    ...
    vr_cdagenew    CONSTANT NUMBER := 23;
