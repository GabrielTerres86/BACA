begin
    delete from tbepr_cdc_usuario where idusuario in (select idusuario from tbepr_cdc_usuario_vinculo where idcooperado_cdc in (select idcooperado_cdc from tbsite_cooperado_cdc where cdcooper = 1 and nrdconta = 92426590));
