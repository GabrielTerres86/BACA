...
BEGIN
  ...
  vr_nmdireto := cecred.gene0001.fn_param_sistema('CRED',3,'ROOT_MICROS') || 'cpd/bacas/INC0307171';
  vr_nmarqrbk := 'ROLLBACK_INC0307171_'||to_char(sysdate,'ddmmyyyy_hh24miss')||'.sql';
  ...
  vr_conta := cecred.GENE0002.fn_quebra_string(pr_string  => '1;735832;7648316;B;C|'||
                                                             '1;735832;7680910;B;C'
                                                             ,
                                               pr_delimit => '|');
