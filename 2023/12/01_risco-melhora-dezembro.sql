  ...
  BEGIN     
    ...
    LOOP
      ...
      IF utl_file.IS_OPEN(vr_ind_arquiv) THEN
        ...
        vr_inrisco_atraso_novo     := cecred.risc0004.fn_traduz_nivel_risco(REPLACE(TRIM(vr_vet_dados(5)), CHR(13), ''));
        ...
        gene0002.pc_escreve_xml(vr_dados_rollback
                               ...
                               ,'UPDATE cecred.tbrecup_acordo_contrato o' || chr(13) || 
                                ...
                                ' WHERE o.nracordo = ' || vr_vet_dados(4) || chr(13) || 
                                '   AND o.nrctremp = ' || vr_vet_dados(3) || 
                                ';' ||chr(13)||chr(13), FALSE); 
