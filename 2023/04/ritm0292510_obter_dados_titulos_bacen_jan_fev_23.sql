DECLARE
  ...
  CURSOR cr_consulta_tit(pr_cdcooper IN craptit.cdcooper%TYPE,
                         pr_dtmvtolt IN craptit.dtmvtolt%TYPE,
                         pr_nrdconta IN craptit.nrdconta%TYPE,
                         pr_vllanmto IN craptit.vltitulo%TYPE) IS
  SELECT tit.cdctrlcs 
  ...
  CURSOR cr_consulta_pro(pr_cdcooper IN crappro.cdcooper%TYPE,
                         ...
                         pr_vllanmto IN crappro.vldocmto%TYPE) IS
  SELECT pro.dttransa
  ...
  vr_nmarquivo_entrada VARCHAR(200) := 'bacen_jan_fev_2023.csv';
    ...
    LOOP
      ...
      BEGIN    
        ...
        IF cr_cop%FOUND THEN                
          CLOSE cr_cop;            
          OPEN cr_consulta_tit(TO_NUMBER(rw_cop.cdcooper), 
