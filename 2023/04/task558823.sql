...
BEGIN
  ...
  v_dados(v_dados.last()).vr_vllanmto := 35.45;
  v_dados(v_dados.last()).vr_cdhistor := 3883;

  v_dados.extend();
  v_dados(v_dados.last()).vr_cdcooper := 16;
  v_dados(v_dados.last()).vr_nrdconta := 893870;
  v_dados(v_dados.last()).vr_nrctremp := 445485;
  v_dados(v_dados.last()).vr_vllanmto := 213.5;
  ...
  v_dados(v_dados.last()).vr_vllanmto := 4297.73;
  v_dados(v_dados.last()).vr_cdhistor := 3918;
