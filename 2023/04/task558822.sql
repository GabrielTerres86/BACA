...
BEGIN
  ...
  v_dados(v_dados.last()).vr_vllanmto := 106.33;
  ...
  v_dados(v_dados.last()).vr_vllanmto := 1094.16;
  ...
  v_dados(v_dados.last()).vr_vllanmto := 78.88;
  v_dados(v_dados.last()).vr_cdhistor := 3918;
  ...
  v_dados.extend();
  v_dados(v_dados.last()).vr_cdcooper := 2;
  v_dados(v_dados.last()).vr_nrdconta := 16156064;
  v_dados(v_dados.last()).vr_nrctremp := 436918;
  v_dados(v_dados.last()).vr_vllanmto := 265.54;
  ...
  v_dados(v_dados.last()).vr_vllanmto := 515.5;
  v_dados(v_dados.last()).vr_cdhistor := 3919;
