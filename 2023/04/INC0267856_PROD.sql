DECLARE
  ...
  vr_arq_path            VARCHAR2(1000):= cecred.gene0001.fn_param_sistema('CRED',0,'ROOT_MICROS') || 'cpd/bacas/INC0267856';


  vr_nmarquiv            VARCHAR2(100) := 'Contas_INC0267856.txt';
  vr_nmarqbkp            VARCHAR2(100) := 'INC0267856_script_rollback.sql';
  vr_nmarqcri            VARCHAR2(100) := 'INC0267856_script_log.txt';
  ...
  vr_lgrowid             ROWID;
  vr_dstransa            VARCHAR2(100) := 'Alterada situacao de conta por script. INC0267856.';
      ...
      LOOP
        ...
        FOR rg_crapass IN cr_crapass(pr_cdcooper => vr_cdcooper
          ...
          BEGIN
            ...
            cecred.gene0001.pc_gera_log_item(pr_nrdrowid => vr_lgrowid
            ...
            vr_nrdocmto_lct := cecred.fn_sequence('CRAPLCT','NRDOCMTO', rg_crapass.cdcooper || ';' || TRIM(to_char( vr_dtmvtolt,'DD/MM/YYYY')) ||';'||rg_crapass.cdagenci||';100;600040');            
            vr_nrseqdig := cecred.fn_sequence('CRAPLOT','NRSEQDIG', rg_crapass.cdcooper || ';' ||to_char(vr_dtmvtolt,'DD/MM/YYYY') || ';'||rg_crapass.cdagenci||';100;600040');
            ...
            vr_nrdocmto_lcm := cecred.fn_sequence('CRAPLCM','NRDOCMTO', rg_crapass.cdcooper || ';' || TRIM(to_char( vr_dtmvtolt,'DD/MM/YYYY')) ||';'||rg_crapass.cdagenci||';100;600040');
