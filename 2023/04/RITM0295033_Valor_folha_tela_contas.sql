DECLARE
  ...
  vr_nmarquiv           VARCHAR2(50) := 'RITM0295033_dados.csv';
  vr_nmarqbkp           VARCHAR2(50) := 'RITM0295033_script_ROLLBACK.sql';
  vr_nmarqlog           VARCHAR2(50) := 'RITM0295033_relatorio_exec.txt';
...
BEGIN
  ...
  vr_nmdireto := gene0001.fn_param_sistema('CRED',3,'ROOT_MICROS') || 'cpd/bacas/RITM0295033';
  ...
  LOOP
    ...
    IF NVL(vr_vlref, 0) > 0 AND NVL(vr_vlref, 0) > NVL(rg_colab.vlsalari, 0) THEN
      ...
      CECRED.GENE0001.pc_gera_log( pr_cdcooper => rg_colab.cdcooper,
                                   ...
                                   pr_dscritic => null,
                                   pr_dsorigem => 'Script',
                                   pr_dstransa => 'RITM0295033 - Atualização do valor da renda conforme rendas automáticas.',
      ...
      vr_msgalt := 'carga renda principal com renda auto ' 
      ...
      IF cr_crapalt%NOTFOUND THEN
        ...
        EXCEPTION
          WHEN OTHERS THEN
            ...
            vr_dscritic_out := 'Erro ao Inserir atualização cadastral para conta ' || rg_colab.nrdconta || ' / ' || rg_colab.cdcooper
                           || ' - ' || SQLERRM;
      ...
      ELSE 
        ...
        EXCEPTION
          WHEN OTHERS THEN
            ...
            vr_dscritic_out := 'Erro ao Complementar atualização cadastral para conta ' || rg_colab.nrdconta || ' / ' || rg_colab.cdcooper
                           || ' - ' || SQLERRM;
