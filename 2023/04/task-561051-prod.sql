DECLARE
  ...
  CURSOR cr_craprac IS
    select  1  cdcooper, 9798544  nrdconta,   2 nraplica,   2.98 vllanmto from dual union all
    select  1  cdcooper, 13956680 nrdconta,   4 nraplica,  50.32 vllanmto from dual union all
    select  1  cdcooper, 15175570 nrdconta,  19 nraplica,   0.02 vllanmto from dual union all    
    select  1  cdcooper, 12040916 nrdconta,  49 nraplica,   8.24 vllanmto from dual union all
    select  1  cdcooper, 3876063  nrdconta, 122 nraplica, 325.82 vllanmto from dual union all
    select  1  cdcooper, 2729130  nrdconta,  57 nraplica,  16.04 vllanmto from dual union all        
    select  1  cdcooper, 11250658 nrdconta,  19 nraplica,   1.42 vllanmto from dual;
