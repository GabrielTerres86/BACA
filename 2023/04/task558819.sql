...
BEGIN
  ...
  v_dados.extend();
  v_dados(v_dados.last()).vr_cdcooper := 5;
  v_dados(v_dados.last()).vr_nrdconta := 302694;
  v_dados(v_dados.last()).vr_nrctremp := 56507;
  v_dados(v_dados.last()).vr_vllanmto := 11135.48;
  ...
  v_dados(v_dados.last()).vr_vllanmto := 131.75;
  v_dados(v_dados.last()).vr_cdhistor := 3883;
