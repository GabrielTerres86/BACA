...
CREATE OR REPLACE PROCEDURE CECRED.pc_quebra_sigilo_bancario IS 
  ...
  vr_dtfim      DATE;
  vr_contador   NUMBER;
  vr_dacaojud  crapicf.dacaojud%TYPE := '041-TST-006553-63'; -- INFORMAR_DESC_ACAO_JUD Informar descrição da ação judicial (este campo é utilizado na tabela CRAPICF)
...
*/
        ...
        FOR rw_lancamento IN cr_lancamentos (pr_cdcooper     => rw_conta.cdcooper
          ...
          IF rw_lancamento.cdhistor IN (570, 22, 614, 1030, 271, 1, 359) THEN 
            -- Atualizar os sequenciais 
            vr_nrsequen := vr_nrsequen + 1;
            vr_idx_origem_destino := pr_tbarq_origem_destino.COUNT + 1;
...
BEGIN 
  ...
  */
  ...
  vr_referencia := 'RITM0029522';
  -- Data que deve ocorrer a quebra de sigilo bancário
  vr_dtinicio   := TO_DATE('01/01/2004','DD/MM/YYYY');
  vr_dtfim      := TO_DATE('17/06/2019','DD/MM/YYYY'); 

  --13	191850	16154636822
  vr_tbconta_investigar('013_0000191850_000016154636822').cdcooper := 13;
  vr_tbconta_investigar('013_0000191850_000016154636822').nrdconta := 191850;
  vr_tbconta_investigar('013_0000191850_000016154636822').nrcpfcgc := 16154636822;
