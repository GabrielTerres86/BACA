...
CREATE OR REPLACE PROCEDURE CECRED.pc_quebra_sigilo_bancario IS 
  ...
  vr_dtfim      DATE;
  vr_contador   NUMBER;
  vr_dacaojud  crapicf.dacaojud%TYPE := '041-TST-006405-01'; -- INFORMAR_DESC_ACAO_JUD Informar descrição da ação judicial (este campo é utilizado na tabela CRAPICF)
...
BEGIN 
  ...
  */
  ...
  vr_referencia := 'RITM0027827';
  -- Data que deve ocorrer a quebra de sigilo bancário
  vr_dtinicio   := TO_DATE('01/01/2018','DD/MM/YYYY');
  vr_dtfim      := TO_DATE('04/06/2019','DD/MM/YYYY'); 

  vr_tbconta_investigar('007_0000136034_076193838000100').cdcooper := 07;
  vr_tbconta_investigar('007_0000136034_076193838000100').nrdconta := 136034;
  vr_tbconta_investigar('007_0000136034_076193838000100').nrcpfcgc := 76193838000100;
