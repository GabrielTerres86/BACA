...
CREATE OR REPLACE PROCEDURE CECRED.pc_quebra_sigilo_bancario IS 
  ...
  vr_dtfim      DATE;
  vr_contador   NUMBER;
  vr_dacaojud  crapicf.dacaojud%TYPE := '041-TST-005257-45'; -- INFORMAR_DESC_ACAO_JUD Informar descrição da ação judicial (este campo é utilizado na tabela CRAPICF)
...
EXTRATO => Historico nao mapeado: 1222(D) - ACERTO.COB.DB  104
EXTRATO => Historico nao mapeado: 49(C) - ESTORN.CHEQUE    204
EXTRATO => Historico nao mapeado: 1267(D) - TR.SAQ PRE PJ  105
*/
...
vr_tbdoc(1).nrcpfdeb := 20153345000192;
vr_tbdoc(1).nrdconta := 17760;
vr_tbdoc(1).nrctadeb := 130005655;
vr_tbdoc(1).dtmvtolt := TO_DATE('21/11/2017','DD/MM/RRRR');
vr_tbdoc(1).cdbancod := 33;
vr_tbdoc(1).nmclideb := 'WALDETE APARECIDA DAVID ME';
vr_tbdoc(1).valordoc := 4000;
...
*/
        ...
        FOR rw_lancamento IN cr_lancamentos (pr_cdcooper     => rw_conta.cdcooper
          ...
          IF rw_lancamento.cdhistor = 1289 THEN
            NULL;
          END IF;
...
BEGIN 
  ...
  */
  ...
  vr_referencia := 'RITM0024196';
  -- Data que deve ocorrer a quebra de sigilo bancário
  vr_dtinicio   := TO_DATE('01/01/2015','DD/MM/RRRR');
  vr_dtfim      := TO_DATE('07/02/2019','DD/MM/RRRR'); 

/*
13	27979	1	66563631991
13	17760	2	85204949000166
*/
  vr_tbconta_investigar('013_0000027979_000066563631991').cdcooper := 13;
  vr_tbconta_investigar('013_0000027979_000066563631991').nrdconta := 27979;
  vr_tbconta_investigar('013_0000027979_000066563631991').nrcpfcgc := 66563631991;

  vr_tbconta_investigar('013_0000017760_085204949000166').cdcooper := 13;
  vr_tbconta_investigar('013_0000017760_085204949000166').nrdconta := 17760;
  vr_tbconta_investigar('013_0000017760_085204949000166').nrcpfcgc := 85204949000166;
