...
CREATE OR REPLACE PROCEDURE CECRED.pc_quebra_sigilo_bancario IS 
  ...
  vr_dtfim      DATE;
  vr_contador   NUMBER;
  vr_dacaojud  crapicf.dacaojud%TYPE := '041-TST-005067-91'; -- INFORMAR_DESC_ACAO_JUD Informar descrição da ação judicial (este campo é utilizado na tabela CRAPICF)
...
BEGIN 
  ...
  */
  ...
  vr_referencia := 'RITM0024195_B';
  -- Data que deve ocorrer a quebra de sigilo bancário
  vr_dtinicio   := TO_DATE('22/01/2014','DD/MM/YYYY');
  vr_dtfim      := TO_DATE('22/01/2019','DD/MM/YYYY'); 

  vr_tbconta_investigar('009_0000021873_010996597000120').cdcooper := 09;
  vr_tbconta_investigar('009_0000021873_010996597000120').nrdconta := 21873;
  vr_tbconta_investigar('009_0000021873_010996597000120').nrcpfcgc := 10996597000120;
