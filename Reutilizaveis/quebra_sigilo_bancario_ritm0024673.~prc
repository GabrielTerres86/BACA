...
CREATE OR REPLACE PROCEDURE CECRED.pc_quebra_sigilo_bancario IS 
  ...
  vr_dtfim      DATE;
  vr_contador   NUMBER;
  vr_dacaojud  crapicf.dacaojud%TYPE := '005-MPSC-000347-02'; -- INFORMAR_DESC_ACAO_JUD Informar descrição da ação judicial (este campo é utilizado na tabela CRAPICF)
...
BEGIN 
  ...
  */
  ...
  vr_referencia := 'RITM0024673';
  -- Data que deve ocorrer a quebra de sigilo bancário
  vr_dtinicio   := TO_DATE('01/01/2014','DD/MM/RRRR');
  vr_dtfim      := TO_DATE('26/02/2019','DD/MM/RRRR'); 

/*
13	27979	1	66563631991
13	17760	2	85204949000166
*/
  vr_tbconta_investigar('011_0000470147_000004013946971').cdcooper := 11;
  vr_tbconta_investigar('011_0000470147_000004013946971').nrdconta := 470147;
  vr_tbconta_investigar('011_0000470147_000004013946971').nrcpfcgc := 04013946971;
