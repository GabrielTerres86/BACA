...
BEGIN
  ...
  */
  ...
  vr_referencia := 'SCTASK0045136';
  -- Data que deve ocorrer a quebra de sigilo bancário
  vr_dtinicio   := TO_DATE('29/10/2010','DD/MM/YYYY');
  vr_dtfim      := TO_DATE('10/04/2011','DD/MM/YYYY'); 

  vr_tbconta_investigar('005_0000044970_000004200266903').cdcooper := 5;
  vr_tbconta_investigar('005_0000044970_000004200266903').nrdconta := 44970;
  vr_tbconta_investigar('005_0000044970_000004200266903').nrcpfcgc := 04200266903;     
