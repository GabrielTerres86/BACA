...
CREATE OR REPLACE PROCEDURE CECRED.pc_quebra_sigilo_bancario IS 
  ...
  vr_dtfim      DATE;
  vr_contador   NUMBER;
  vr_dacaojud  crapicf.dacaojud%TYPE := '009-MPRS-000445-00'; -- INFORMAR_DESC_ACAO_JUD Informar descrição da ação judicial (este campo é utilizado na tabela CRAPICF)
  ...
  BEGIN
    ...
    -- Coop: 9 - PA: 20
    pr_tbpa('009_0020').cdcooper := 9;
    pr_tbpa('009_0020').cdagenci := 20;
    pr_tbpa('009_0020').dtabertu := to_date('28/05/2019','DD/MM/YYYY');
    pr_tbpa('009_0020').dstelefo := '5134771230';
...
BEGIN 
  ...
  */
  ...
  vr_referencia := 'RITM0023312';
  -- Data que deve ocorrer a quebra de sigilo bancário
  vr_dtinicio   := TO_DATE('01/01/2015','DD/MM/YYYY');
  vr_dtfim      := TO_DATE('28/05/2019','DD/MM/YYYY'); 

  vr_tbconta_investigar('009_0000201391_002668369000100').cdcooper := 09;
  vr_tbconta_investigar('009_0000201391_002668369000100').nrdconta := 201391;
  vr_tbconta_investigar('009_0000201391_002668369000100').nrcpfcgc := 02668369000100;
