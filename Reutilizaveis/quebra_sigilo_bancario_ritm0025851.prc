...
CREATE OR REPLACE PROCEDURE CECRED.pc_quebra_sigilo_bancario IS 
  ...
  vr_dtfim      DATE;
  vr_contador   NUMBER;
  vr_dacaojud  crapicf.dacaojud%TYPE := '005-MPSC-000357-76'; -- INFORMAR_DESC_ACAO_JUD Informar descrição da ação judicial (este campo é utilizado na tabela CRAPICF)
...
BEGIN 
  ...
  */
  ...
  vr_referencia := 'RITM0025851';
  -- Data que deve ocorrer a quebra de sigilo bancário
  vr_dtinicio   := TO_DATE('01/01/2018','DD/MM/YYYY');
  vr_dtfim      := TO_DATE('08/04/2019','DD/MM/YYYY'); 

  --11	347000	8761591000121
  vr_tbconta_investigar('011_0000347000_008761591000121').cdcooper := 11;
  vr_tbconta_investigar('011_0000347000_008761591000121').nrdconta := 347000;
  vr_tbconta_investigar('011_0000347000_008761591000121').nrcpfcgc := 8761591000121;

  --11	343692	51558750991
  vr_tbconta_investigar('011_0000343692_000051558750991').cdcooper := 11;
  vr_tbconta_investigar('011_0000343692_000051558750991').nrdconta := 343692;
  vr_tbconta_investigar('011_0000343692_000051558750991').nrcpfcgc := 51558750991;

  --11	489468	9154158958
  vr_tbconta_investigar('011_0000489468_000009154158958').cdcooper := 11;
  vr_tbconta_investigar('011_0000489468_000009154158958').nrdconta := 489468;
  vr_tbconta_investigar('011_0000489468_000009154158958').nrcpfcgc := 9154158958;
  
/*
  vr_tbconta_investigar('008_0000008850_000034210806900').cdcooper := 8;
  vr_tbconta_investigar('008_0000008850_000034210806900').nrdconta := 8850;
  vr_tbconta_investigar('008_0000008850_000034210806900').nrcpfcgc := 34210806900;

  vr_tbconta_investigar('008_0000000620_000022391533934').cdcooper := 8;
  vr_tbconta_investigar('008_0000000620_000022391533934').nrdconta := 620;
  vr_tbconta_investigar('008_0000000620_000022391533934').nrcpfcgc := 22391533934; */
