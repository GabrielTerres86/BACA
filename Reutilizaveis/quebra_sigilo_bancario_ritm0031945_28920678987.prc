...
CREATE OR REPLACE PROCEDURE CECRED.pc_quebra_sigilo_bancario IS 
  ...
  vr_dtfim      DATE;
  vr_contador   NUMBER;
  vr_dacaojud  crapicf.dacaojud%TYPE := '005-MPSC-000304-64'; -- INFORMAR_DESC_ACAO_JUD Informar descrição da ação judicial (este campo é utilizado na tabela CRAPICF)
...
--vr_referencia := 'RITM0031945_84641258953';
  vr_referencia := 'RITM0031945_28920678987';
  -- Data que deve ocorrer a quebra de sigilo bancário
/*
  vr_dtinicio   := TO_DATE('01/01/2008','DD/MM/YYYY'); --01/01/2008 até 31/12/2009
  vr_dtfim      := TO_DATE('31/12/2009','DD/MM/YYYY'); 
*/
  vr_dtinicio   := TO_DATE('01/01/2008','DD/MM/YYYY'); --01/01/2008 até 31/12/2013
  vr_dtfim      := TO_DATE('31/12/2013','DD/MM/YYYY'); 

/*
  --1 2571730 846.412.589-53;
  vr_tbconta_investigar('001_0002571730_000084641258953').cdcooper := 1;
  vr_tbconta_investigar('001_0002571730_000084641258953').nrdconta := 2571730;
  vr_tbconta_investigar('001_0002571730_000084641258953').nrcpfcgc := 84641258953;
*/
  --1	9227628 289.206.789-87;
  vr_tbconta_investigar('001_0009227628_000028920678987').cdcooper := 1;
  vr_tbconta_investigar('001_0009227628_000028920678987').nrdconta := 9227628;
  vr_tbconta_investigar('001_0009227628_000028920678987').nrcpfcgc := 28920678987;
