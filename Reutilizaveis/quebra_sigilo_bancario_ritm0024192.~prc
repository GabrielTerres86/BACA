...
CREATE OR REPLACE PROCEDURE CECRED.pc_quebra_sigilo_bancario IS 
  ...
  vr_dtfim      DATE;
  vr_contador   NUMBER;
  vr_dacaojud  crapicf.dacaojud%TYPE := '041-TST-005070-97'; -- INFORMAR_DESC_ACAO_JUD Informar descrição da ação judicial (este campo é utilizado na tabela CRAPICF)
...
/*    
EXTRATO => Historico nao mapeado: 2308(D) - IOF S/EMPREST
EXTRATO => Historico nao mapeado: 2418(C) - CR COTAS PARC
EXTRATO => Historico nao mapeado: 2230(D) - RECARGA OI */
...
BEGIN 
  ...
  */
  ...
  vr_referencia := 'RITM0024192';
  -- Data que deve ocorrer a quebra de sigilo bancário
  vr_dtinicio   := TO_DATE('01/10/2018','DD/MM/YYYY');
  vr_dtfim      := TO_DATE('15/01/2019','DD/MM/YYYY'); 

  vr_tbconta_investigar('009_0000046760_007781766000108').cdcooper := 09;
  vr_tbconta_investigar('009_0000046760_007781766000108').nrdconta := 46760;
  vr_tbconta_investigar('009_0000046760_007781766000108').nrcpfcgc := 07781766000108;
