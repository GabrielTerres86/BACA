...
CREATE OR REPLACE PROCEDURE CECRED.pc_quebra_sigilo_bancario IS 
  ...
  vr_dtfim      DATE;
  vr_contador   NUMBER;
  vr_dacaojud  crapicf.dacaojud%TYPE := '005-MPSC-000332-18'; -- INFORMAR_DESC_ACAO_JUD Informar descrição da ação judicial (este campo é utilizado na tabela CRAPICF)
  ...
  BEGIN
    ...
    WHILE TRIM(vr_idx_cta_investigar) IS NOT NULL LOOP
      ...
      FOR rw_conta IN cr_contas (pr_cdcooper => pr_tbconta_investigar(vr_idx_cta_investigar).cdcooper
        ...
        vr_tbdoc(1).nrcpfdeb := 03178348000161;
        vr_tbdoc(1).nrdconta := 704601;
        vr_tbdoc(1).nrctadeb := 53961;
        vr_tbdoc(1).dtmvtolt := TO_DATE('07/04/15','DD/MM/RRRR');
        vr_tbdoc(1).cdbancod := 1;
        vr_tbdoc(1).nmclideb := 'E SCHAEFER YACHTS LTDA';
        vr_tbdoc(1).valordoc := 644;
        vr_tbdoc(1).flgativo := 0;
        
        vr_tbdoc(2).cdagenci := 1;
        vr_tbdoc(2).nrcpfdeb := 03178348000161;
        vr_tbdoc(2).nrdconta := 704601;
        vr_tbdoc(2).nrctadeb := 53961;
        vr_tbdoc(2).dtmvtolt := TO_DATE('08/04/15','DD/MM/RRRR');
        vr_tbdoc(2).cdbancod := 1;
        vr_tbdoc(2).nmclideb := 'E SCHAEFER YACHTS LTDA';
        vr_tbdoc(2).valordoc := 353.52;
        vr_tbdoc(2).flgativo := 0;
        
        vr_tbdoc(3).cdagenci := 1;
        vr_tbdoc(3).nrcpfdeb := 03178348000161;
        vr_tbdoc(3).nrdconta := 704601;
        vr_tbdoc(3).nrctadeb := 53961;
        vr_tbdoc(3).dtmvtolt := TO_DATE('02/06/15','DD/MM/RRRR');
        vr_tbdoc(3).cdbancod := 1;
        vr_tbdoc(3).nmclideb := 'E SCHAEFER YACHTS LTDA';
        vr_tbdoc(3).valordoc := 126.73;
        vr_tbdoc(3).flgativo := 0;
        
        vr_tbdoc(4).cdagenci := 1;
        vr_tbdoc(4).nrcpfdeb := 00100997000151;
        vr_tbdoc(4).nrdconta := 704601;
        vr_tbdoc(4).nrctadeb := 97701;
        vr_tbdoc(4).dtmvtolt := TO_DATE('18/06/15','DD/MM/RRRR');
        vr_tbdoc(4).cdbancod := 341;
        vr_tbdoc(4).nmclideb := 'VENDOR COM.PROD.INFORM.LTDA ME';
        vr_tbdoc(4).valordoc := 285.64;
        vr_tbdoc(4).flgativo := 0;
        
        vr_tbdoc(5).cdagenci := 1;
        vr_tbdoc(5).nrcpfdeb := 00100997000151;
        vr_tbdoc(5).nrdconta := 704601;
        vr_tbdoc(5).nrctadeb := 97701;
        vr_tbdoc(5).dtmvtolt := TO_DATE('29/07/15','DD/MM/RRRR');
        vr_tbdoc(5).cdbancod := 341;
        vr_tbdoc(5).nmclideb := 'VENDOR COM.PROD.INFORM.LTDA ME';
        vr_tbdoc(5).valordoc := 330;
        vr_tbdoc(5).flgativo := 0;
        
        vr_tbdoc(6).cdagenci := 1;
        vr_tbdoc(6).nrcpfdeb := 02012862000160;
        vr_tbdoc(6).nrdconta := 704580;
        vr_tbdoc(6).nrctadeb := 130019285;
        vr_tbdoc(6).dtmvtolt := TO_DATE('15/04/16','DD/MM/RRRR');
        vr_tbdoc(6).cdbancod := 33;
        vr_tbdoc(6).nmclideb := 'TAM LINHAS AEREAS S/A';
        vr_tbdoc(6).valordoc := 1152.27;
        vr_tbdoc(6).flgativo := 0;
        
        vr_tbdoc(7).cdagenci := 1;
        vr_tbdoc(7).nrcpfdeb := 00048486132991;
        vr_tbdoc(7).nrdconta := 704580;
        vr_tbdoc(7).nrctadeb := 362638;
        vr_tbdoc(7).dtmvtolt := TO_DATE('26/12/17','DD/MM/RRRR');
        vr_tbdoc(7).cdbancod := 1;
        vr_tbdoc(7).nmclideb := 'IEDA MARISA ARCEGA';
        vr_tbdoc(7).valordoc := 340;
...
BEGIN 
  ...
  */
  ...
  vr_referencia := 'RITM0024164';
  -- Data que deve ocorrer a quebra de sigilo bancário
  vr_dtinicio   := TO_DATE('01/01/2015','DD/MM/YYYY');
  vr_dtfim      := TO_DATE('17/12/2018','DD/MM/YYYY'); 

--09641484000122 704601; 89032128949 704580

  vr_tbconta_investigar('002_0000704601_009641484000122').cdcooper := 02;
  vr_tbconta_investigar('002_0000704601_009641484000122').nrdconta := 704601;
  vr_tbconta_investigar('002_0000704601_009641484000122').nrcpfcgc := 09641484000122;

  vr_tbconta_investigar('002_0000704580_000089032128949').cdcooper := 02;
  vr_tbconta_investigar('002_0000704580_000089032128949').nrdconta := 704580;
  vr_tbconta_investigar('002_0000704580_000089032128949').nrcpfcgc := 89032128949;
/*
