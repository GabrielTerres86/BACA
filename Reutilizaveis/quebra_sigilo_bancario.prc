...
BEGIN 
  ...
  */
  ...
  vr_referencia := 'RITM0018750';
  -- Data que deve ocorrer a quebra de sigilo bancário
  vr_dtinicio   := TO_DATE('01/01/2018','DD/MM/YYYY');
  vr_dtfim      := TO_DATE('14/03/2019','DD/MM/YYYY'); 

  vr_tbconta_investigar('012_0000114570_000096353880987').cdcooper := 12;
  vr_tbconta_investigar('012_0000114570_000096353880987').nrdconta := 114570;
  vr_tbconta_investigar('012_0000114570_000096353880987').nrcpfcgc := 96353880987;
