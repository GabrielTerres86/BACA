...
CREATE OR REPLACE PROCEDURE CECRED.pc_quebra_sigilo_bancario IS 
  ...
  BEGIN
    ...
    -- Coop: 13 - PA: 8
    pr_tbpa('013_0008').cdcooper := 13;
    pr_tbpa('013_0008').cdagenci := 8;
    pr_tbpa('013_0008').dtabertu := to_date('09/11/2017','DD/MM/YYYY');
    pr_tbpa('013_0008').dstelefo := '47996937656';
...
BEGIN 
  ...
  */
  ...
  vr_referencia := 'RITM0014955';
  -- Data que deve ocorrer a quebra de sigilo bancário
  vr_dtinicio   := TO_DATE('10/08/2018','DD/MM/YYYY');
  vr_dtfim      := TO_DATE('14/02/2019','DD/MM/YYYY'); 

  vr_tbconta_investigar('013_0000000744_000098624326915').cdcooper := 13;
  vr_tbconta_investigar('013_0000000744_000098624326915').nrdconta := 744;
  vr_tbconta_investigar('013_0000000744_000098624326915').nrcpfcgc := 98624326915;
