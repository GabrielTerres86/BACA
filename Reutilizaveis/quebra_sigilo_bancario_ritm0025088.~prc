...
CREATE OR REPLACE PROCEDURE CECRED.pc_quebra_sigilo_bancario IS 
  ...
  vr_dtfim      DATE;
  vr_contador   NUMBER;
  vr_dacaojud  crapicf.dacaojud%TYPE := '005-MPSC-000308-98'; -- INFORMAR_DESC_ACAO_JUD Informar descrição da ação judicial (este campo é utilizado na tabela CRAPICF)
...
BEGIN 
  ...
  */
  ...
  vr_referencia := 'RITM0025088';
  -- Data que deve ocorrer a quebra de sigilo bancário
  vr_dtinicio   := TO_DATE('09/07/2015','DD/MM/YYYY');
  vr_dtfim      := TO_DATE('09/07/2018','DD/MM/YYYY'); 

  vr_tbconta_investigar('001_0000758310_000064957373949').cdcooper := 01;
  vr_tbconta_investigar('001_0000758310_000064957373949').nrdconta := 758310;
  vr_tbconta_investigar('001_0000758310_000064957373949').nrcpfcgc := 64957373949;
