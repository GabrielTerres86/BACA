...
CREATE OR REPLACE PROCEDURE CECRED.pc_quebra_sigilo_bancario IS 
  ...
  vr_dtfim      DATE;
  vr_contador   NUMBER;
  vr_dacaojud  crapicf.dacaojud%TYPE := '041-TST-006341-02'; -- INFORMAR_DESC_ACAO_JUD Informar descrição da ação judicial (este campo é utilizado na tabela CRAPICF)
  ...
  BEGIN
    ...
    WHILE TRIM(vr_idx_cta_investigar) IS NOT NULL LOOP
      ...
      FOR rw_conta IN cr_contas (pr_cdcooper => pr_tbconta_investigar(vr_idx_cta_investigar).cdcooper
        ...
        vr_tbdoc(1).nrcpfdeb := 90400888000142;
        vr_tbdoc(1).nrdconta := 269123;
        vr_tbdoc(1).nrctadeb := 678993;
        vr_tbdoc(1).dtmvtolt := TO_DATE('18/06/18','DD/MM/RRRR');
        vr_tbdoc(1).cdbancod := 33;
        vr_tbdoc(1).nmclideb := 'BANCO SANTANDER S.A';
        vr_tbdoc(1).valordoc := 2160;
        vr_tbdoc(1).flgativo := 0;

        vr_tbdoc(2).cdagenci := 1;
        vr_tbdoc(2).nrcpfdeb := 00089100620963;
        vr_tbdoc(2).nrdconta := 641529;
        vr_tbdoc(2).nrctadeb := 2311941;
        vr_tbdoc(2).dtmvtolt := TO_DATE('16/08/18','DD/MM/RRRR');
        vr_tbdoc(2).cdbancod := 237;
        vr_tbdoc(2).nmclideb := 'HIRLANDO JOSE GESSER';
        vr_tbdoc(2).valordoc := 865.3;
        vr_tbdoc(2).flgativo := 0;

        vr_tbdoc(3).cdagenci := 1;
        vr_tbdoc(3).nrcpfdeb := 00089100620963;
        vr_tbdoc(3).nrdconta := 641529;
        vr_tbdoc(3).nrctadeb := 2311941;
        vr_tbdoc(3).dtmvtolt := TO_DATE('17/09/18','DD/MM/RRRR');
        vr_tbdoc(3).cdbancod := 237;
        vr_tbdoc(3).nmclideb := 'HIRLANDO JOSE GESSER';
        vr_tbdoc(3).valordoc := 865.3;
        vr_tbdoc(3).flgativo := 0;

        vr_tbdoc(4).cdagenci := 1;
        vr_tbdoc(4).nrcpfdeb := 00010818234962;
        vr_tbdoc(4).nrdconta := 641529;
        vr_tbdoc(4).nrctadeb := 13000090868;
        vr_tbdoc(4).dtmvtolt := TO_DATE('13/11/18','DD/MM/RRRR');
        vr_tbdoc(4).cdbancod := 104;
        vr_tbdoc(4).nmclideb := 'EDNA SAROT';
        vr_tbdoc(4).valordoc := 3000;
        vr_tbdoc(4).flgativo := 0;

        vr_tbdoc(5).cdagenci := 1;
        vr_tbdoc(5).nrcpfdeb := 00010818234962;
        vr_tbdoc(5).nrdconta := 641529;
        vr_tbdoc(5).nrctadeb := 13000090868;
        vr_tbdoc(5).dtmvtolt := TO_DATE('26/11/18','DD/MM/RRRR');
        vr_tbdoc(5).cdbancod := 104;
        vr_tbdoc(5).nmclideb := 'EDNA SAROT';
        vr_tbdoc(5).valordoc := 2279;
        vr_tbdoc(5).flgativo := 0;

        vr_tbdoc(6).cdagenci := 1;
        vr_tbdoc(6).nrcpfdeb := 00000684497980;
        vr_tbdoc(6).nrdconta := 641529;
        vr_tbdoc(6).nrctadeb := 352645;
        vr_tbdoc(6).dtmvtolt := TO_DATE('14/01/19','DD/MM/RRRR');
        vr_tbdoc(6).cdbancod := 341;
        vr_tbdoc(6).nmclideb := 'EDSON SAROT';
        vr_tbdoc(6).valordoc := 3500;
        vr_tbdoc(6).flgativo := 0;

        vr_tbdoc(7).cdagenci := 1;
        vr_tbdoc(7).nrcpfdeb := 00000684497980;
        vr_tbdoc(7).nrdconta := 641529;
        vr_tbdoc(7).nrctadeb := 352645;
        vr_tbdoc(7).dtmvtolt := TO_DATE('07/02/19','DD/MM/RRRR');
        vr_tbdoc(7).cdbancod := 341;
        vr_tbdoc(7).nmclideb := 'EDSON SAROT';
        vr_tbdoc(7).valordoc := 2670;
...
BEGIN 
  ...
  */
  ...
  vr_tbconta_investigar('002_0000641529_000000684497980').cdcooper := 02;
  vr_tbconta_investigar('002_0000641529_000000684497980').nrdconta := 641529;
  vr_tbconta_investigar('002_0000641529_000000684497980').nrcpfcgc := 00684497980;

  vr_tbconta_investigar('002_0000269123_000004065647959').cdcooper := 02;
  vr_tbconta_investigar('002_0000269123_000004065647959').nrdconta := 269123;
  vr_tbconta_investigar('002_0000269123_000004065647959').nrcpfcgc := 04065647959;
/*
