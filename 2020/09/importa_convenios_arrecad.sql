...
AGUAS ARIQUEMES - MT;8261493;1493;2;0,48;0,30;0,30;4
AGUAS BARR GARCA-MT;8261413;1413;2;0,48;0,30;0,30;4
AGUAS CAMPO VERDE MT;8260732;732;2;0,30;0,30;0,30;4
AGUAS DE BURITIS RO;8261446;1446;2;0,48;0,30;0,30;4
AGUAS DE CAMBORIU SC;8261473;1473;2;0,48;0,30;0,30;4
AGUAS DE ITAPEMA SC;8260910;910;2;0,48;0,30;0,30;4
AGUAS DE JUARA MT;8260536;536;2;0,72;0,72;0,00;4
AGUAS DE MATAO SP;8261387;1387;2;0,40;0,40;0,27;4
AGUAS DE SORRISO MT;8260527;527;2;0,30;0,30;0,30;4
AGUAS DE TERESINA PI;8261535;1535;2;0,48;0,30;0,30;4
...
AGUAS PIMEN BUENO-RO;8261474;1474;2;0,48;0,30;0,30;4
AGUAS PRIMAVERA MT;8260762;762;2;0,30;0,30;0,30;4
AGUAS ROLIM MOURA RO;8261491;1491;2;0,48;0,30;0,30;4
...
CEB DISTRIBUICAO DF;8360005;5;3;0,30;0,21;0,18;3
...
CELG DISTRIBUICAO GO;8360009;9;3;0,38;0,38;0,22;3
...
CLARO MOVEL;8480162;162;4;0,48;0,36;0,18;4
...
DAE JOAO MONLEVAD-MG;8260418;418;2;0,96;0,90;0,90;4
DAE SANTA BARBARA SP;8260033;33;2;0,57;0,53;0,39;4
DAE VG - MT;8260382;382;2;0,48;0,48;0,48;3
DAEMO OLIMPIA SP;8260039;39;2;0,54;0,48;0,30;4
DAEP PENAPOLIS SP;8260704;704;2;0,53;0,42;0,33;4
DAEPA MG;8260349;349;2;0,66;0,66;0,66;4
DAERP SP;8260040;40;2;0,90;0,64;0,32;3
DAP AGUA PARECIS MT;8260632;632;2;0,35;0,35;0,35;4
...
FCT TIMBO SC;8570608;608;5;1,32;1,24;1,12;4
FMDDD DE TIMBO SC;8570607;607;5;1,32;1,24;1,12;4
...
FUMTUR TIMBO SC;8570753;753;5;1,39;1,27;1,18;4
...
NET SERV COMUNICAC;8460296;296;4;0,54;0,42;0,30;4
...
SAAE GARCA SP;8270068;68;2;1,14;0,91;0,52;4
SAAE ITAPEMIRIM ES;8260333;333;2;0,47;0,47;0,60;4
SAAE LENCS PAULIS-SP;8260077;77;2;0,42;0,42;0,42;4
...
SAAE SAO CARLOS SP;8260089;89;2;0,72;0,54;0,45;4
SAAE SOROCABA SP;8260091;91;2;0,30;0,30;0,21;4
SAAE VICOSA MG;8260094;94;2;1,02;0,54;0,41;4
...
SAAESP SAO PEDRO SP;8260918;918;2;0,90;0,90;0,42;4
...
SAMAE ARARANGUA SC;8260533;533;2;0,63;0,63;0,54;4
...
SAMAE PALHOCA SC;8261295;1295;2;0,66;0,66;0,51;4
...
SAMAE TIMBO SC;8260816;816;2;1,32;1,24;1,12;4
SAMAR ARACATUBA SP;8261345;1345;2;0,57;0,48;0,48;5
...
TUBARAO SANEA - SC;8261330;1330;2;0,57;0,50;0,41;4
...
VIVO PARTICIPACOES;8460064;64;4;0,24;0,24;0,12;3
...
ZAP TELECOM MG;8460440;440;4;0,57;0,45;0,36;4';
  ...
  vr_flgsicre        INTEGER;
  vr_flgbancb        INTEGER;
  vr_clob_conv_migra CLOB := '########################### CONVENIOS MIGRADOS SICREDI -> BANCOOB ###########################' ||
                             CHR(10) || CHR(10);
  vr_clob_conv_inclb CLOB := '################################ CONVENIOS BANCOOB INCLUIDOS ################################' ||
                             CHR(10) || CHR(10);
  vr_clob_conv_incla CLOB := '######################### CONVENIOS BANCOOB INCLUIDOS (ARR. AILOS) ##########################' ||
                             CHR(10) || CHR(10);
  vr_clob_conv_sicca CLOB := '################################ CONVENIOS SICREDI CANCELADOS ###############################' ||
                             CHR(10) || CHR(10);
  vr_clob_erros      CLOB := '########################################### ERROS ###########################################' ||
                             CHR(10) || CHR(10);
  ...
  CURSOR cr_crapcon_scn(pr_cdempcon IN crapcon.cdempcon%TYPE
                       ,pr_cdempco2 IN crapcon.cdempcon%TYPE
                       ,pr_cdempco3 IN crapcon.cdempcon%TYPE
                       ,pr_cdempco4 IN crapcon.cdempcon%TYPE
                       ,pr_cdempco5 IN crapcon.cdempcon%TYPE
                       ,pr_cdsegmto IN crapcon.cdsegmto%TYPE
                       ,pr_cdcooper IN crapcon.cdcooper%TYPE) IS
    SELECT con.tparrecd
          ,con.nmrescon
          ...
          ,con.cdsegmto
      FROM crapcon con
     WHERE (con.cdempcon = pr_cdempcon OR con.cdempcon = pr_cdempco2 OR
           con.cdempcon = pr_cdempco3 OR con.cdempcon = pr_cdempco4 OR
           con.cdempcon = pr_cdempco5)
       AND con.cdsegmto = pr_cdsegmto
       AND con.cdcooper = pr_cdcooper;
  ...
  BEGIN
    ...
    gene0001.pc_set_modulo(pr_module => NULL
                          ,pr_action => 'GENE0002.fn_quebra_string');
  ...
  BEGIN
    FOR rw_crapcop IN cr_crapcop LOOP
      ...
      FETCH cr_tbconv_liberacao
        INTO rw_tbconv_liberacao;
      ...
      IF cr_tbconv_liberacao%NOTFOUND THEN
        ...
        EXCEPTION
          WHEN OTHERS THEN
            vr_clob_erros := vr_clob_erros ||
                             to_clob('Erro ao atualizar liberacao de convenio Bancoob -> cdempcon: ' ||
                                     pr_cdempcon || ', cdsegmto: ' ||
                                     pr_cdsegmto || ', cdempres: ' ||
                                     pr_cdempres || ', cdcooper: ' ||
                                     rw_crapcop.cdcooper || ', dscritic: ' ||
                                     SQLERRM || CHR(10));
            RAISE vr_exc_null;
        END;
      END IF;
      ...
      FOR rw_tbgen_canal_entrada IN cr_tbgen_canal_entrada LOOP
        ...
        FETCH cr_tbconv_canalcoop_liberado
          INTO rw_tbconv_canalcoop_liberado;
        ...
        IF cr_tbconv_canalcoop_liberado%NOTFOUND THEN
          ...
          EXCEPTION
            WHEN OTHERS THEN
              vr_clob_erros := vr_clob_erros ||
                               to_clob('Erro ao inserir canal de liberacao de convenio Bancoob -> cdempcon: ' ||
                                       pr_cdempcon || ', cdsegmto: ' ||
                                       pr_cdsegmto || ', cdempres: ' ||
                                       pr_cdempres || ', cdcooper: ' ||
                                       rw_crapcop.cdcooper ||
        ...
        IF rw_tbconv_canalcoop_liberado.flgliberado = 0 THEN
          ...
          EXCEPTION
            WHEN OTHERS THEN
              vr_clob_erros := vr_clob_erros ||
                               to_clob('Erro ao atualizar canal de liberacao de convenio Bancoob -> cdempcon: ' ||
                                       pr_cdempcon || ', cdsegmto: ' ||
                                       pr_cdsegmto || ', cdempres: ' ||
                                       pr_cdempres || ', cdcooper: ' ||
                                       rw_crapcop.cdcooper ||
...
BEGIN
  ...
  FOR i IN 1 .. vr_linhascsv.count LOOP
    ...
    FETCH cr_tbconv_arrecadacao
      INTO rw_tbconv_arrecadacao;
    ...
    IF cr_crapcon%FOUND THEN
      ...
      IF rw_crapcon.tparrecd = 2 AND vr_flgbancb = 1 THEN
        BEGIN
          ...
          UPDATE crapcon con
             SET con.nmextcon = vr_nmconven
                ,con.nmrescon = SUBSTR(vr_nmconven, 1, 15)
           WHERE con.cdempcon = vr_cdempcon
             AND con.cdsegmto = vr_cdsegmto;
        EXCEPTION
          WHEN OTHERS THEN
            vr_clob_erros := vr_clob_erros ||
                             to_clob('Erro ao atualizar convenio Bancoob -> cdempcon: ' ||
                                     vr_cdempcon || ', cdsegmto: ' ||
                                     vr_cdsegmto || ', cdempres: ' ||
                                     rw_tbconv_arrecadacao.cdempres ||
                                     ', dscritic: ' || SQLERRM || CHR(10));
        END;
        CONTINUE;
      ELSIF rw_crapcon.tparrecd = 3 THEN
        ...
        IF vr_flgbancb = 0 THEN
          vr_clob_conv_incla := vr_clob_conv_incla ||
                                to_clob('Convênio: ' || vr_nmconven ||
                                        CHR(10) || 'Cod. Empresa: ' ||
                                        vr_cdempres || CHR(10) ||
                                        'Cod. Febaban: ' || vr_cdempcon ||
                                        CHR(10) || 'Cod. Segmto: ' ||
                                        vr_cdsegmto || CHR(10) ||
                                        '------------------------------------------' ||
                                        CHR(10));
          ...
          tela_conven.pc_grava_conv_parceiros(pr_cddopcao           => 'I'
                                             ...
                                             ,pr_flgacsic           => 0
                                             ,pr_flgacbcb           => 1
                                             ,pr_forma_arrecadacao  => rw_crapcon.tparrecd
                                             , --> Ailos
          ...
          IF vr_cdcritic > 0 OR TRIM(vr_dscritic) IS NOT NULL THEN
            vr_clob_erros := vr_clob_erros ||
                             to_clob('Erro ao inserir convenio Bancoob -> cdempcon: ' ||
                                     vr_cdempcon || ', cdsegmto: ' ||
                                     vr_cdsegmto || ', cdempres: ' ||
                                     vr_cdempres || ', dscritic: ' ||
                                     vr_dscritic || CHR(10));
            CONTINUE;
          END IF;
      ...
      ELSE
        ...
        IF vr_flgbancb = 1 THEN
          vr_clob_conv_migra := vr_clob_conv_migra ||
                                to_clob('Convênio: ' || vr_nmconven ||
                                        CHR(10) || 'Cod. Empresa: ' ||
                                        vr_cdempres || CHR(10) ||
                                        'Cod. Febaban: ' || vr_cdempcon ||
          ...
          tela_conven.pc_grava_conv_parceiros(pr_cddopcao           => 'A'
                                             ,pr_tparrecd           => 2
                                             ,pr_cdconven           => vr_cdempres
                                             ,pr_nmfantasia         => SUBSTR(vr_nmconven
                                                                             ,1
                                                                             ,15)
        ...
        ELSE
          vr_clob_conv_inclb := vr_clob_conv_inclb ||
                                to_clob('Convênio: ' || vr_nmconven ||
                                        CHR(10) || 'Cod. Empresa: ' ||
                                        vr_cdempres || CHR(10) ||
                                        'Cod. Febaban: ' || vr_cdempcon ||
    ...
    ELSE
      CLOSE cr_crapcon;
      vr_clob_conv_inclb := vr_clob_conv_inclb ||
                            to_clob('Convênio: ' || vr_nmconven || CHR(10) ||
                                    'Cod. Empresa: ' || vr_cdempres ||
                                    CHR(10) || 'Cod. Febaban: ' ||
                                    vr_cdempcon || CHR(10) ||
                                    'Cod. Segmto: ' || vr_cdsegmto ||
                                    CHR(10) ||
                                    '------------------------------------------' ||
                                    CHR(10));
      -- Cadastrar novo convênio no Bancoob
  ...
  FOR rw_crapscn IN cr_crapscn LOOP
    ...
    -- Não migraremos tributos neste momento
    IF rw_crapscn.cdempres IN
       ('147', '149', '609', 'K0', 'A0', 'D0', 'C06') THEN
      CONTINUE;
    END IF;
    ...
    FOR rw_crapcon_scn IN cr_crapcon_scn(pr_cdempcon => rw_crapscn.cdempcon
                                        ,pr_cdempco2 => rw_crapscn.cdempco2
                                        ,pr_cdempco3 => rw_crapscn.cdempco3
                                        ,pr_cdempco4 => rw_crapscn.cdempco4
                                        ,pr_cdempco5 => rw_crapscn.cdempco5
      ...
      /*  BEGIN  
       vr_clob_conv_sicca := vr_clob_conv_sicca || to_clob(
                  'Convênio: ' || rw_crapcon_scn.nmrescon || CHR(10) ||
                  'Cod. Empresa: ' || rw_crapscn.cdempres || CHR(10) ||
                  'Cod. Febaban: ' || rw_crapcon_scn.cdempcon || CHR(10) ||
                  'Cod. Segmto: ' || rw_crapcon_scn.cdsegmto || CHR(10) ||
                  '------------------------------------------' || CHR(10));
       UPDATE crapscn
       ...
       UPDATE crapcon
         SET flgacsic = 0
        WHERE crapcon.cdempcon = rw_crapcon_scn.cdempcon
         AND crapcon.cdsegmto = rw_crapcon_scn.cdsegmto;
      EXCEPTION
       WHEN OTHERS THEN
        vr_clob_erros := vr_clob_erros || to_clob('Erro ao cancelar convenio Sicredi -> cdempcon: ' || rw_crapcon_scn.cdempcon || 
                             ', cdsegmto: ' || rw_crapcon_scn.cdsegmto ||
      ...
      */
      ...
      IF rw_crapcon_scn.tparrecd = 2 OR rw_crapcon_scn.tparrecd = 3 THEN
        CONTINUE;
      END IF;
    
      OPEN cr_tbconv_arrecadacao(pr_cdempcon => rw_crapcon_scn.cdempcon
                                ,pr_cdsegmto => rw_crapcon_scn.cdsegmto);
      FETCH cr_tbconv_arrecadacao
        INTO rw_tbconv_arrecadacao;
      ...
      IF cr_tbconv_arrecadacao%FOUND THEN
        ...
        vr_clob_conv_migra := vr_clob_conv_migra ||
                              to_clob('Convênio: ' ||
                                      rw_crapcon_scn.nmrescon || CHR(10) ||
                                      'Cod. Empresa: ' ||
                                      rw_tbconv_arrecadacao.cdempres ||
                                      CHR(10) || 'Cod. Febaban: ' ||
        ...
        tela_conven.pc_grava_conv_parceiros(pr_cddopcao           => 'A'
                                           ...
                                           ,pr_dtcancel           => NULL
                                           ,pr_layout_arrecadacao => rw_tbconv_arrecadacao.nrlayout
                                           ,pr_flgaccec           => rw_crapcon_scn.flgaccec
                                           ,pr_flgacsic           => 0
                                           ,pr_flgacbcb           => 1
                                           ,pr_forma_arrecadacao  => 2
                                           ,pr_nrlayout_debaut    => 0
  ...
  gene0002.pc_clob_para_arquivo(pr_clob     => vr_clob_conv_migra ||
                                               vr_clob_conv_inclb ||
                                               vr_clob_conv_incla ||
                                               vr_clob_conv_sicca ||
                                               vr_clob_erros
