...
--
  ...
  vr_nrdconta    craplem.nrdconta%type := 308749; -- Alterar aqui
  vr_dtmvtolt    craplem.dtmvtolt%type := to_date('09/09/2020', 'dd/mm/yyyy'); -- Alterar aqui
  vr_nrctremp    craplem.nrctremp%type := 51995; -- Alterar aqui
  vr_vlpreemp    craplem.vlpreemp%type := 225.67; -- Alterar aqui
