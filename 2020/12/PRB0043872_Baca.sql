...
BEGIN
  ...
  values (aux_cdpartar_add, 'Tempo de aguardo em segundos para acionamento da mesma conta ao motor.', 2, 12);

  insert into crapbat (CDBATTAR, NMIDENTI, CDPROGRA, TPCADAST, CDCADAST)
  values ('MOTORTMPAG', 'Tempo de aguardo em segundos para acionamento da mesma conta ao motor.', ' ', 2, aux_cdpartar_add);
           
  insert into crappco (CDPARTAR, CDCOOPER, DSCONTEU)
  values (aux_cdpartar_add, 17, '15');

  insert into crappco (CDPARTAR, CDCOOPER, DSCONTEU)
  values (aux_cdpartar_add, 1, '15');
