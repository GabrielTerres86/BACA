...
values (6, 7, 8460004, '03/12/2020', 1, 2, '3232-EF00000100000000846000420201203.CNV', 1, 0);
insert into gncontr (cdcooper, tpdcontr, cdconven, dtmvtolt, nrsequen, cdsitret, nmarquiv, qtdoctos, vldoctos)
values (1, 7, 8460004, '03/12/2020', 9, 2, '3239-EF00000900000000846000420201203.CNV', 37, 0);
insert into gncontr (cdcooper, tpdcontr, cdconven, dtmvtolt, nrsequen, cdsitret, nmarquiv, qtdoctos, vldoctos)
values (1, 7, 8460464, '03/12/2020', 25, 2, '3239-EF00002500000000846046420201203.CNV', 22, 0);
insert into gncontr (cdcooper, tpdcontr, cdconven, dtmvtolt, nrsequen, cdsitret, nmarquiv, qtdoctos, vldoctos)
values (2, 7, 8460004, '03/12/2020', 2, 2, '3265-EF00000200000000846000420201203.CNV', 1, 0);
insert into gncontr (cdcooper, tpdcontr, cdconven, dtmvtolt, nrsequen, cdsitret, nmarquiv, qtdoctos, vldoctos)
values (5, 7, 8460464, '03/12/2020', 2, 2, '3318-EF00000200000000846046420201203.CNV', 1, 0);
insert into gncontr (cdcooper, tpdcontr, cdconven, dtmvtolt, nrsequen, cdsitret, nmarquiv, qtdoctos, vldoctos)
values (7, 7, 8460004, '03/12/2020', 2, 2, '4416-EF00000200000000846000420201203.CNV', 1, 0);
insert into gncontr (cdcooper, tpdcontr, cdconven, dtmvtolt, nrsequen, cdsitret, nmarquiv, qtdoctos, vldoctos)
values (11, 7, 8460004, '03/12/2020', 3, 2, '4438-EF00000300000000846000420201203.CNV', 3, 0);
insert into gncontr (cdcooper, tpdcontr, cdconven, dtmvtolt, nrsequen, cdsitret, nmarquiv, qtdoctos, vldoctos)
values (11, 7, 8460464, '03/12/2020', 5, 2, '4438-EF00000500000000846046420201203.CNV', 3, 0);
insert into gncontr (cdcooper, tpdcontr, cdconven, dtmvtolt, nrsequen, cdsitret, nmarquiv, qtdoctos, vldoctos)
values (13, 7, 8460004, '03/12/2020', 2, 2, '4457-EF00000200000000846000420201203.CNV', 1, 0);
update crapcon c
...
insert into gncontr (cdcooper, tpdcontr, cdconven, dtmvtolt, nrsequen, cdsitret, nmarquiv, qtdoctos, vldoctos)
values (1, 7, 8460004, '03/12/2020', 10, 2, '3239-EF00001000000000846000420201203.CNV', 8, 0);
insert into gncontr (cdcooper, tpdcontr, cdconven, dtmvtolt, nrsequen, cdsitret, nmarquiv, qtdoctos, vldoctos)
values (1, 7, 8460464, '03/12/2020', 26, 2, '3239-EF00002600000000846046420201203.CNV', 3, 0);
update crapcon c
   set c.nrseqatu = c.nrseqatu + 1
