...
declare 
  ...
  vr_nrdconta  NUMBER := 9041605;
  vr_nrctremp  NUMBER := 1258438;
  vr_dtmvtolt_ext DATE := to_date('28/02/2020','DD/MM/RRRR');
...
EXCEPTION
    WHEN vr_exc_erro THEN
      ...
      raise_application_error(-20501,vr_cdcritic);  
      
end;
0
1
 vr_tab_historicos(r_craplem.cdhistor).cdhistor
