    ...
    DO TRANSACTION WHILE TRUE:
       ...
       FOR EACH crapavt WHERE crapavt.cdcooper = par_cdcooper        AND
        ...
        FOR EACH crapadt WHERE crapadt.cdcooper = par_cdcooper   AND
            ...
            IF  crapadt.cdaditiv = 2 THEN /* Aplicaçoes da própria conta da proposta */
                aux_nrdconta = crapadt.nrdconta.
            ELSE IF crapadt.cdaditiv = 3 THEN /* Aplicaçoes de interveniente garantidor */
...
PROCEDURE executa_programa:
  ...
  DEF VAR crapepr_cdcooper AS INT NO-UNDO.
  DEF VAR crapepr_nrdconta AS INT NO-UNDO.
  DEF VAR crapepr_nrctremp AS INT NO-UNDO.
  
  
  crapepr_cdcooper = 1.
  crapepr_nrdconta = 10863591.
  crapepr_nrctremp = 2256032.

      RUN desfaz_efetivacao_emprestimo(INPUT crapepr_cdcooper, /*par_cdcooper*/
                                       INPUT 1,  /*par_cdagenci*/
                                       INPUT 1, /*par_nrdcaixa*/
                                       INPUT 1, /*par_cdoperad*/
                                       INPUT "ATENDA", /*par_nmdatela*/
                                       INPUT 5, /*par_idorigem*/
                                       INPUT crapepr_nrdconta, /*par_nrdconta*/
                                       INPUT 1, /*par_idseqttl*/
                                       INPUT crapdat.dtmvtolt, /*par_dtmvtolt*/
                                       INPUT crapdat.dtmvtopr, /*par_dtmvtopr*/
                                       INPUT TRUE,  /*par_flgerlog 1 ou TRUE*/
                                       INPUT crapepr_nrctremp, /*par_nrctremp*/
      ...
      IF AVAIL tt-erro THEN
         DO:
             MESSAGE "Erro desfaz efetiva: " tt-erro.dscritic.
         END.

      RUN excluir-proposta (INPUT crapepr_cdcooper, /*par_cdcooper*/ 
                            INPUT 1, /*par_cdagenci*/ 
                            INPUT 1, /*par_nrdcaixa*/ 
                            INPUT 1, /*par_cdoperad*/ 
                            INPUT "ATENDA", /*par_nmdatela*/ 
      ...
      IF AVAIL tt-erro THEN
         DO:
             MESSAGE "Erro excluir :" tt-erro.dscritic.
         END.
