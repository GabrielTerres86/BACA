...
--RITM0067752 - Ana Volles - 27/03/2020
DECLARE 
  vr_arq_path  VARCHAR2(1000):= '/microsd1/cpd/bacas/RITM0067752'; --> Diretorio que sera criado o relatorio  --\\pkgdesen1\micros\cpd\bacas\RITM0067752

  vr_nmarquiv  VARCHAR2(100) := 'contas_ana.txt';
  vr_nmarqbkp  VARCHAR2(100) := 'RITM0067752_ROLLBACK.sql';
