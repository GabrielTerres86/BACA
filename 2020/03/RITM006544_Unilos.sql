--RITM006544 - Miguel - 13/03/2020 -- Unilos
DECLARE 
 
  vr_arq_path  VARCHAR2(1000):= gene0001.fn_diretorio(pr_tpdireto => 'M', 
                                                      pr_cdcooper => 0, 
                                                      pr_nmsubdir => 'cpd/bacas/ritm006544/unilos'); 


  vr_nmarquiv  VARCHAR2(100) := 'Unilos_ITG.txt';
  vr_nmarqbkp  VARCHAR2(100) := 'ROLLBACK_Unilos_ITG.txt';
