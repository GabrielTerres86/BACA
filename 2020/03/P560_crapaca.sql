...
declare 
  ...
  -- ALTERAR
  NOME_DA_ACAO VARCHAR2(40)         := 'RET_HONORARIO_RECUP';
  PROCEDURE_DA_ACAO VARCHAR2(100)   := 'pc_ret_honorario_recup_web';
  PACKAGE_DA_ACAO VARCHAR2(100)     := 'RECP0004';
  PARAMETROS_DA_ACAO VARCHAR2(1000) := 'pr_nrdconta, pr_nrctremp, pr_cdorigem';
  -- FIM ALTERAR
