...
PROCEDURE executa_programa:
  ...
  FOR EACH crapepr WHERE crapepr.inliquid = 0  AND
      ...
      RUN desfaz_efetivacao_emprestimo(INPUT crapepr.cdcooper, /*par_cdcooper*/
                                       INPUT crapepr.cdagenci,  /*par_cdagenci*/
                                       INPUT 1, /*par_nrdcaixa*/
                                       INPUT 1, /*par_cdoperad*/
                                       INPUT "ATENDA", /*par_nmdatela*/
                                       INPUT crapepr.cdorigem, /*par_idorigem*/
                                       ...
                                       INPUT crapepr.nrctremp, /*par_nrctremp*/
      ...
      RUN excluir-proposta (INPUT tbcrd_cessao_credito.cdcooper, /*par_cdcooper*/ 
                            INPUT 1, /*par_cdagenci*/ 
                            INPUT 1, /*par_nrdcaixa*/ 
                            INPUT 1, /*par_cdoperad*/ 
                            INPUT "ATENDA", /*par_nmdatela*/ 
                            INPUT 5, /*par_idorigem*/ 
                            INPUT tbcrd_cessao_credito.nrdconta, /*par_nrdconta*/ 
                            INPUT 1, /*par_idseqttl*/ 
                            INPUT crapdat.dtmvtolt, /*par_dtmvtolt*/ 
                            INPUT tbcrd_cessao_credito.nrctremp, /*par_nrctremp*/ 
