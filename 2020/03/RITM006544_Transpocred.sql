--RITM006544 - Miguel - 13/03/2020 -- Transpocred
DECLARE 
 
  vr_arq_path  VARCHAR2(1000):= gene0001.fn_diretorio(pr_tpdireto => 'M', 
                                                      pr_cdcooper => 0, 
                                                      pr_nmsubdir => 'cpd/bacas/ritm006544/transpocred'); 


  vr_nmarquiv  VARCHAR2(100) := 'Transpocred_ITG.txt';
  vr_nmarqbkp  VARCHAR2(100) := 'ROLLBACK_Transpocred_ITG.txt';
