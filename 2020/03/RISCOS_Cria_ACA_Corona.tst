...
DECLARE
  ...
  -- ALTERAR
  NOME_DA_ACAO       VARCHAR2(40)  := 'VALIDA_RENEG_CORONA';
  PROCEDURE_DA_ACAO  VARCHAR2(100) := 'pc_valida_reneg_corona';
  PACKAGE_DA_ACAO    VARCHAR2(100) := 'ATENDA';
  PARAMETROS_DA_ACAO VARCHAR2(1000):= 'pr_cdfinemp,pr_idquaprc';
  -- FIM ALTERAR
