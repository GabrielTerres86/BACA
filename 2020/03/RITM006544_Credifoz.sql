--RITM006544 - Miguel - 13/03/2020 -- Credifoz
DECLARE 
 
  vr_arq_path  VARCHAR2(1000):= gene0001.fn_diretorio(pr_tpdireto => 'M', 
                                                      pr_cdcooper => 0, 
                                                      pr_nmsubdir => 'cpd/bacas/ritm006544/credifoz'); 


  vr_nmarquiv  VARCHAR2(100) := 'Credifoz_ITG.txt';
  vr_nmarqbkp  VARCHAR2(100) := 'ROLLBACK_Credifoz_ITG.txt';
