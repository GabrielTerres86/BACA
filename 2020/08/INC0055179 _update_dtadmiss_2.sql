begin
  ...
  update crapass c 
     set c.dtadmiss = to_date('07/05/2004', 'dd/mm/yyyy')
       , c.dtmvtolt = to_date('07/05/2004', 'dd/mm/yyyy')
  ...
  update crapass c 
     set c.dtadmiss = to_date('31/03/2000', 'dd/mm/yyyy')
       , c.dtmvtolt = to_date('31/03/2000', 'dd/mm/yyyy')
   where c.nrdconta = 7239530 
     and c.cdcooper = 2;
  ...
  update crapass c 
     set c.dtadmiss = to_date('31/03/2004', 'dd/mm/yyyy')
       , c.dtmvtolt = to_date('31/03/2004', 'dd/mm/yyyy')
   where c.nrdconta = 7239530 
     and c.cdcooper = 6;
  ...
  update crapass c 
     set c.dtadmiss = to_date('28/11/2003', 'dd/mm/yyyy')
       , c.dtmvtolt = to_date('28/11/2003', 'dd/mm/yyyy')
   where c.nrdconta = 7239530 
     and c.cdcooper = 5;
  ...
  update crapass c 
     set c.dtadmiss = to_date('18/06/2008', 'dd/mm/yyyy')
       , c.dtmvtolt = to_date('18/06/2008', 'dd/mm/yyyy')
   where c.nrdconta = 7239530 
     and c.cdcooper = 10;
