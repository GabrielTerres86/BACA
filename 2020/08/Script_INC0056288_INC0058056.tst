...
---------------------------------------------------
  -- INC0056288 - Viacredi: 1 - Conta: 7769946
  -- => Solução: Efetuar um 2721 no valor de R$ 183,99.
  vr_incidente := 'INC0056288';
  vr_cdcooper  := 1;
  vr_nrdconta  := 7769946;
  vr_vllanmto  := 183.99;
  vr_cdhistor  := 2721;
...
---------------------------------------------------
  -- INC0058056 - Civia: 13 - Conta: 190438 
  -- => Solução: Efetuar um 2721 no valor de R$ 0,24.
  vr_incidente := 'INC0058056';
  vr_cdcooper  := 13;
  vr_nrdconta  := 190438;
  vr_vllanmto  := 0.24;
  vr_cdhistor  := 2721;
