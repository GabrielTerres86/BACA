...
---------------------------------------------------
  ...
  -- => Solução: Fazer um 2721 de R$ 2,35 e outro de R$ 0,71.
...
---------------------------------------------------
  ...
  -- => Solução: Fazer um 2721 no valor de R$ 0,18.
...
---------------------------------------------------
  ...
  -- => Solução: Fazer um 2721 de 3,60 e outro de 45,44.
  ...
  prc_atlz_prejuizo(prm_cdcooper => vr_cdcooper
                   ...
                   ,prm_vllanmto => vr_vllanmto
                   ,prm_cdhistor => vr_cdhistor
                   ,prm_tipoajus => 'I'); --[I] Inclusao Lançamento / [E] Exclusao Lançamento
  dbms_output.put_line('-------- '|| vr_incidente || ' - FIM --------');
  dbms_output.put_line(' ');
---------------------------------------------------
...
---------------------------------------------------
  ...
  -- => Solução: Efetuar um 2721 no valor de 0,03. Deverá atualizar o saldo de prejuízo.
...
----------------------------------------------------
  ...
  -- => Solução: Solução: Lançar um 2408 de R$ 10,00 para prejuízo.
...
----------------------------------------------------
  ...
  -- => Solução: Lancar 122.67 - Historico
