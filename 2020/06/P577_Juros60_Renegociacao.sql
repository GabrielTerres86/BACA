/*****************************************************************
19/06/2020 - P577 - INC0049010 - Contas Juros60 Negativo. 
             Corrigir Valores de Juros Negativos na Renegociação.
*****************************************************************/

/*
Analisado em 19/06/2020
Importante: Não existem casos de PP com na tbepr_renegociao_saldo os 
valores de vljura60 e vljuremu estejam diferentes. No PP estes valores
são sempre iguais.
...
BEGIN
  ...
  FOR rw_reneg_saldo_jurneg IN cr_reneg_saldo_jurneg LOOP         
    ...
    IF  Nvl(vr_qt_lido,0) = 1 THEN       
      ...
      dbms_output.put_line('Tipo;Cooperativa;Conta;Contrato;vljura60_old;vljura60_new;vljuremu_old;vljuremu_new');            
    END IF; 
    */
