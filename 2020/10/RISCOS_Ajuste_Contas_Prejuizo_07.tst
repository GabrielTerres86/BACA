...
---------------------------------------------------
  -- INC0060830 - CREDIFOZ: 11 - Conta: 169358
  -- => Solução: Ajustar saldo dev. com 2408 R$ 273,25

  vr_incidente := 'INC0060830';
  vr_cdcooper  := 11;
  vr_nrdconta  := 169358;
  vr_vllanmto  := 273.25;
  vr_cdhistor  := 2408;
...
---------------------------------------------------
  -- INC0061632 - Civia - Conta: 66842
  -- => Solução: Lancar 135,43  - Conta Transitoria
   -- Gerar acerto na transitoria, e o valor de crédito,
   -- Operador deve transferir para C/C

  vr_incidente := 'INC0061632';
  vr_cdcooper  := 13;
  vr_nrdconta  := 66842;
  vr_vllanmto  := 135.43;
  dbms_output.put_line('  ');
