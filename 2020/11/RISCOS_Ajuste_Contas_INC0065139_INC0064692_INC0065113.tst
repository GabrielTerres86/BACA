...
---------------------------------------------------
  -- INC0065139 - VIACREDI AV - Conta: 2358131 
  -- => Solução: gerar um 2408 de R$ 1.421,40 para zerar a transitória.
  vr_incidente := 'INC0065139';
  vr_cdcooper  := 16;
  vr_nrdconta  := 2358131;
  vr_vllanmto  := 1421.40;
  vr_cdhistor  := 2408;
...
---------------------------------------------------
  -- INC0065113 - Transpocred - C/C 12.433-8 - R$ 78,19 - 9
  vr_incidente := 'INC0065113';
  vr_cdcooper  := 9;
  vr_nrdconta  := 124338;
  vr_vllanmto  := 78.19;
  vr_cdhistor  := 2721;
  ...
  -- INC0065113 - Credifoz - C/C 39.898-5  - R$ 3,26
  vr_incidente := 'INC0065113';
  vr_cdcooper  := 11;
  vr_nrdconta  := 398985;
  vr_vllanmto  := 3.26;
  ...
  -- INC0065113 - Credifoz  - C/C 47.374-0 - R$ 2,04
  vr_incidente := 'INC0065113';
  vr_cdcooper  := 11;
  vr_nrdconta  := 473740;
  vr_vllanmto  := 2.04;
