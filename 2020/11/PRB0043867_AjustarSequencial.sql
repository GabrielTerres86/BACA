...
values (1, 7, 67561, '24/11/2020', 9, 2, '3239-EF00000900000000006756120201124.CNV', 5, 153.06)
/
insert into gncontr (cdcooper, tpdcontr, cdconven, dtmvtolt, nrsequen, cdsitret, nmarquiv, qtdoctos, vldoctos)
...
/
insert into tbconv_deb_nao_efetiv values ( 1, 7757999,  82, 4, 0, 'F8999357515668            3239000000077579992020112300000000001587330667905450                                                                       0', trunc(sysdate), 8460082)
/
insert into tbconv_deb_nao_efetiv values ( 1, 7174136,  82, 4, 0, 'F8999769595065            3239000000071741362020112300000000000738430667907288                                                                       0', trunc(sysdate), 8460082)
/
