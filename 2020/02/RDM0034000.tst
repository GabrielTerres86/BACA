DECLARE 
  ...
  vr_arq_path  VARCHAR2(1000):= gene0001.fn_diretorio(pr_tpdireto => 'M', 
                                                      pr_cdcooper => 0, 
                                                      pr_nmsubdir => 'cpd/bacas/RITM0059653/');
--vr_arq_path  VARCHAR2(1000):= '/usr/coopd1/sistemad1/equipe/ramon/'; --> Diretorio que sera criado o relatorio
--vr_arq_path  VARCHAR2(1000):= '/micros/cecred/ramon/RITM0034000'; --> Diretorio que sera criado o relatorio  
  vr_nmarquiv  VARCHAR2(100) := 'contas_ramon.txt';
  vr_nmarqbkp  VARCHAR2(100) := 'RDM0034000_ROLLBACK.sql';
...
BEGIN 
  ...
  IF utl_file.IS_OPEN(vr_hutlfile) THEN
    ...
    /*    IF vr_contador = 1 THEN
        ...
        --Procurar o operador 
        FOR rw_crapass IN cr_crapass(pr_cdcooper => 1
          ...
          BEGIN
            ...
            INSERT INTO tbcc_hist_param_pessoa_prod( cdcooper
                                          ...
                                          VALUES ( 1
                                                 ...
                                                 , rw_crapass.inpessoa
                                                 , vr_nrcpfcnpj_base
                                                 , to_date('05/02/2020 16:00:00','DD/MM/YYYY HH24:MI:SS')
                                                 , 25
                                                 , 1
                                                 , 1
                                                 , 19
