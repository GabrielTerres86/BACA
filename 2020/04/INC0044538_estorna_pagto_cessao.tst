...
1330
-- Created on 29/04/2020 by F0030250 
declare 
...
--           AND (nvl(pr_dtultest,SYSDATE) = SYSDATE OR craplem.dtmvtolt >= pr_dtultest) comentado por Faba
  ...
  BEGIN
    /* .............................................................................
     ...
     Sigla   : LIMI
     Autor   : James Prust Junior
     Data    : Setembro/15.                    Ultima atualizacao: 01/08/2019
     ...
     Alteracoes:  01/08/2019 - P437.Consignado. Controle para não executar se for estorno de
                  Contrato de Consignado. (Fernanda Kelli - AMcom)
     ..............................................................................*/
...
begin
  ...
  if nvl(vr_cdcritic, 0) = 0 then
    ...
    pc_tela_estornar_pagamentos(pr_cdcooper => 1        --> Cooperativa conectada
                               ...
                               ,pr_idorigem => 5        --> Id do módulo de sistema (5 = Ayllos Web)
                               ,pr_nrdconta => 420301                              --> Número da conta
                               ,pr_idseqttl => 1                                   --> Seq titular
                               ,pr_dtmvtolt => rw_crapdat.dtmvtolt --> Movimento atual
                               ,pr_dtmvtopr => rw_crapdat.dtmvtopr --> Movimento atual
                               ,pr_nrctremp => 2222400  --> Número do contrato de empréstimo
                               ,pr_dsjustificativa => 'INC0044538 - Liminar Judicial' --> Justificativa
