--Atualiza flag libera para as contas
--RITM0069429 - Ana Volles - 23/04/2020
DECLARE 
--Pasta com o arquivo a ser lido - pode ser em um desses caminhos
--PROD
  vr_arq_path  VARCHAR2(1000):= '/micros/cpd/bacas/RITM0069429'; --> Diretorio que sera criado o relatorio  --\\pkgprod\micros\cpd\bacas\RITM0069429

--DEV1
--  vr_arq_path  VARCHAR2(1000):= '/microsd1/cpd/bacas/RITM0069429'; --> Diretorio que sera criado o relatorio  --\\pkgdesen1\micros\cpd\bacas\RITM0069429

  vr_nmarquiv  VARCHAR2(100) := 'contas_ana.txt';
  vr_nmarqbkp  VARCHAR2(100) := 'RITM0069429_ROLLBACK.sql';
