...
DECLARE 
  ...
  -- ALTERAR
  NOME_DA_ACAO VARCHAR2(40)        := 'CONSULTARCONSIG';
  PROCEDURE_DA_ACAO VARCHAR2(100)  := 'PC_BUSCA_ERROS_INTEGRACAO_WEB';
  PACKAGE_DA_ACAO VARCHAR2(100)    := 'TELA_RCONSI';
  PARAMETROS_DA_ACAO VARCHAR2(1000):= 'pr_cdcooper, pr_tpintegracao, pr_nrdconta, pr_nrctremp, pr_nrparepr, pr_nriniseq, pr_nrregist, pr_nmopcao';
  -- FIM ALTERAR 
