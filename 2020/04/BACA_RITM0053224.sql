...
BEGIN
  ...
  values (vr_idcampo, 'A', 1, 'DTDARQUI', 'D', 'DD/MM/RRRR HH24:MI', null, null, null, 'DATA DO ARQUIVO', null);
  ...
  insert into tbgen_layout_campo (IDLAYOUT, TPREGISTRO, NRSEQUENCIA_CAMPO, NMCAMPO, TPDADO, DSFORMATO, NRPOSICAO_INICIAL, QTDPOSICOES, QTDDECIMAIS, DSOBSERVACAO, DSIDENTIFICADOR_REGISTRO)
  values (15, 'A', 10, 'VLVAZIO', 'T', NULL, null, null, null, 'CAMPO PARA SUPRIR O REGISTRO VAZIO DO FIM DO ARQUIVO', null);
  ...
  insert into tbgen_layout_campo (IDLAYOUT, TPREGISTRO, NRSEQUENCIA_CAMPO, NMCAMPO, TPDADO, DSFORMATO, NRPOSICAO_INICIAL, QTDPOSICOES, QTDDECIMAIS, DSOBSERVACAO, DSIDENTIFICADOR_REGISTRO)
  values (vr_idcampo, 'H', 10, 'VLVAZIO', 'T', NULL, null, null, null, 'CAMPO PARA SUPRIR O REGISTRO VAZIO DO FIM DO ARQUIVO', null);
