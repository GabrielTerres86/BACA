...
CURSOR cr_crapseg IS  
	...
	FROM crapseg seg
     ...
     WHERE seg.cdcooper IN (7,9,11,14) /*Migracao 31/01: 7, 9, 11, 14 */   
...
BEGIN
  ...
  /* CANCELAR SEGUROS VIDA */ 
   ...
   WHERE crapseg.cdcooper IN (7,9,11,14) /* Ajustar - conforme cada migracao */ 
  ...
  DBMS_XSLPROCESSOR.CLOB2FILE(vr_dslobdev, '/micros/cecred/diego/', 'ICATU_cancelados_31012020' || '_2.txt', NLS_CHARSET_ID('UTF8'));    
