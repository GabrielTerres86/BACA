declare
--CCR30204407703581211201975632390118220005127070246617666CLAUDINEI AZEVEDO      08071972202010182526265991    000100                                                                                               000732DD3895C4F71235863129        SSPSCCLAUDINEI AZEVEDO                                                               7563239000006044743N
...
begin
  BEGIN
    vr_des_text := 'CCR30204407703581211201975632390118220005127070246617666CLAUDINEI AZEVEDO      08071972202010182526265991    000100                                                                                               000732DD3895C4F71235863129        SSPSCCLAUDINEI AZEVEDO                                                               7563239000006044743N';
    ...
    IF substr(vr_des_text,5,2) = '02'  THEN
      ...
      vr_cdgraupr := 0;
      vr_dtlibera := NULL;
      vr_dtcancel := '10/01/2020';
      vr_nrcpfcpj := 82526265991;
      --
      ...
      vr_dddebito:= 11;--rw_crawcrd_ant.dddebito;
      vr_vllimcrd:= 500; -- Informação está no sipag
