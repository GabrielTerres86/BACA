...
BEGIN
  DECLARE
    ...
    vr_cdopptel_add VARCHAR(2000) := ',C,H,D';                     -- Novos cdopcao para permis
    vr_lsopptel_add VARCHAR(2000) := ',CONSULTA,HABILITAR,DESABILITAR'; -- Novos descritivos da permis
    vr_nmdatela     VARCHAR(10) := 'PRMRFN'; -- Tela que será aplicada a permissao
  BEGIN
