...
declare 
  ...
  -- ALTERAR
  NOME_DA_ACAO VARCHAR2(40) := 'REG_ANTECIP_PRESTACAO';
  PROCEDURE_DA_ACAO VARCHAR2(100) := 'pc_aprov_antecip_prest';
  PACKAGE_DA_ACAO VARCHAR2(100) := 'TELA_ATENDA_PRESTACOES';
  PARAMETROS_DA_ACAO VARCHAR2(1000):= 'pr_nrdconta, pr_tipoaute';
  -- FIM ALTERAR
