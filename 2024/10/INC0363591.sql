...
BEGIN
 ...
 pc_gera_extrato_cnab(pr_cdcooper => 1
                      ,pr_nrdconta => 7765061  
                      ,pr_dtrefere => to_date('01/10/2024','dd/mm/yyyy'));
 
  pc_gera_extrato_cnab(pr_cdcooper => 1
                      ,pr_nrdconta => 7765061  
                      ,pr_dtrefere => to_date('02/10/2024','dd/mm/yyyy'));
					  
   pc_gera_extrato_cnab(pr_cdcooper => 1
                      ,pr_nrdconta => 7765061  
                      ,pr_dtrefere => to_date('03/10/2024','dd/mm/yyyy'));
					  
	 pc_gera_extrato_cnab(pr_cdcooper => 1
                      ,pr_nrdconta => 7765061  
                      ,pr_dtrefere => to_date('04/10/2024','dd/mm/yyyy'));
					  
	 pc_gera_extrato_cnab(pr_cdcooper => 1
                      ,pr_nrdconta => 7765061  
                      ,pr_dtrefere => to_date('07/10/2024','dd/mm/yyyy'));
					  
	 pc_gera_extrato_cnab(pr_cdcooper => 1
                      ,pr_nrdconta => 7765061  
                      ,pr_dtrefere => to_date('08/10/2024','dd/mm/yyyy'));
