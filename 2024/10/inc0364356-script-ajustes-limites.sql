      ...
      CURSOR cr_lcto_border(pr_cdcooper craplim.cdcooper%TYPE
          ...
          SELECT a.rowid AS id,
           ...
           WHERE a.cdcooper = pr_cdcooper
             ...
             AND a.dtmvtolt = to_date('16/10/2024','DD/MM/RRRR')
      ...
      CURSOR cr_craplcm(pr_cdcooper craplim.cdcooper%TYPE
          ...
          SELECT a.rowid AS id,
           ...
           WHERE a.cdcooper = pr_cdcooper
             ...
             AND a.dtmvtolt BETWEEN to_date('15/10/2024','DD/MM/RRRR') AND to_date('16/10/2024','DD/MM/RRRR')
             AND a.cdhistor = 2386;
    ...
    CURSOR cr_crapcob(pr_cdcooper craptdb.cdcooper%TYPE
      ...
      SELECT tdb.rowid AS id,
       ...
       WHERE tdb.cdcooper = pr_cdcooper
         ...
         AND tdb.dtdpagto BETWEEN to_date('15/10/2024','DD/MM/RRRR') AND to_date('16/10/2024','DD/MM/RRRR');
       ...
       BEGIN
            FOR rw_crapcob IN cr_crapcob (pr_cdcooper => pr_cdcooper
                ...
                IF rw_crapcob.incobran = 0 AND
                   ...
                   rw_crapcob.dtdpagto BETWEEN to_date('15/10/2024','DD/MM/RRRR') AND to_date('16/10/2024','DD/MM/RRRR') THEN 
