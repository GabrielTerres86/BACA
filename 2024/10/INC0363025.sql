DECLARE
  ...
  vc_dstransaDevCotas             CONSTANT VARCHAR2(4000) := 'Devolucao de Cotas Capital - INC0363025';
  vc_dstransaDevDepVista          CONSTANT VARCHAR2(4000) := 'Devolucao de Cotas Capital - INC0363025';
  ...
  CURSOR cr_crapass is
    SELECT t.cdagenci
      ...
      FROM CECRED.CRAPASS t
         ,(select 11 as cdcooper, decode(vr_globalname, vc_bdprod, 604488 ,99395452) as nrdconta, vc_cdsitdctProcesDemis as cdsitdct, null as dtdemiss, null as dtelimin, null as dtasitct, null as  cdmotdem from dual) a
     WHERE 1=1
