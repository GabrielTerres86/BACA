DECLARE 
  ...
  vr_nmprograma  tbgen_prglog.cdprograma%TYPE := 'Alterar Limite Web - RITM0425318';
  ...
  vr_dsdireto  VARCHAR2(50) := '/micros/cpd/bacas/RITM0425318';
  vr_nmarquivo VARCHAR(200) := 'Limites.CSV';
         ...
         WHEN OTHERS THEN
           ...
           CECRED.pc_internal_exception(pr_cdcooper => 3
                                       ,pr_compleme => ' Script: => ' || vr_nmprograma     ||
                                                       ...
                                                       ';vllimweb:'   || vr_vllimweb||' Erro: '||SQLERRM);
        END;
      END LOOP;
    EXCEPTION
      WHEN NO_DATA_FOUND THEN
