DECLARE
  ...
  vr_nmarquiv           VARCHAR2(50) := 'RITM0369545_dados.csv';
  vr_nmarqbkp           VARCHAR2(50) := 'RITM0369545_script_ROLLBACK.sql';
  vr_nmarqlog           VARCHAR2(50) := 'RITM0369545_relatorio_exec.txt';
...
BEGIN
  ...
  vr_nmdireto := gene0001.fn_param_sistema('CRED',3,'ROOT_MICROS') || 'cpd/bacas/RITM0369545';
    ...
    IF NVL(vr_vlref, 0) > 0 AND NVL(vr_vlref, 0) > NVL(rg_colab.vlsalari, 0) THEN
      ...
      BEGIN
        ...
        VALUES(rg_colab.cdcooper
          ...
          ,NULL
          ,'Script'
          ,'RITM0369545 - Atualização do valor da renda conforme rendas automáticas.'
          ,vr_dtmvtolt
          ,1
          ,vr_hrtransa
          ,1
      ...
      vr_msgalt := 'RITM0369545 - carga renda principal com renda auto ' 
