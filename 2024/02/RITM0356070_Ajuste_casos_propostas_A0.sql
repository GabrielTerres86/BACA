...
BEGIN
  ...
  FOR rw_crapcop IN cr_crapcop LOOP
    ...
    FOR rw_principal_fat IN cr_principal_fat(pr_cdcooper => rw_crapcop.cdcooper) LOOP
      ...
      vr_linha := 'update cecred.tbseg_prestamista p set p.cdmotrec = '|| nvl(rw_principal_fat.cdmotrec,null) || ', p.nrproposta = ''' ||  rw_principal_fat.nrproposta_tbseg ||
    ...
    FOR rw_principal_crawseg_fat IN cr_principal_crawseg_fat(pr_cdcooper => rw_crapcop.cdcooper) LOOP
      ...
      vr_linha := 'update cecred.tbseg_prestamista p set p.cdmotrec = '|| nvl(rw_principal_crawseg_fat.cdmotrec,null) || ', p.nrproposta = ''' ||  rw_principal_crawseg_fat.nrproposta_tbseg ||
