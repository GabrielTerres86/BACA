  ...
  CURSOR cr_craplem_jrsremu(pr_cdcooper craplem.cdcooper%TYPE,
    ...
    SELECT SUM(a.vllanmto) vllanmto
     ...
     WHERE cdcooper = pr_cdcooper
           ...
           AND a.dtmvtolt BETWEEN to_date('28/12/2023', 'dd/mm/yyyy') AND
    ...
    LOOP
      ...
      IF utl_file.IS_OPEN(vr_ind_arquiv) THEN
        ...
        IF nvl(rw_craplem_jrsremu.vllanmto, 0) > 0 THEN
          ...
          vr_dtdpagto := to_date('28/12/2023', 'DD/MM/RRRR');
          ...
          vr_vlsdeved_up := vr_vlsdeved_up -
                            nvl(rw_craplem_jrsremu.vllanmto, 0);
          ...
          gene0001.pc_gera_log_item(pr_nrdrowid => vr_nrdrowid,
                                    pr_nmdcampo => 'vlsdeved apos atualizacao.',
                                    pr_dsdadant => ' ',
