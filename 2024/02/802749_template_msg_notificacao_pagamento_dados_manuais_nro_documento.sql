...
BEGIN
    ...
    values (13, 62, 'PIX - Confirmação de pagamento agendado Pix', codigoMensagem, '#nomeresumido,<br><br> Seu pagamento Pix que estava agendado para hoje foi realizado com sucesso.<br><br> Beneficiário: #beneficiario<br> CPF/CNPJ : #documentorecebedor<br> Valor: #valorpix <br><br>Para consultar mais informações acesse a opção ver comprovante.', 1, 0, null, null, null, null, null, null, null);
    commit;
END;
