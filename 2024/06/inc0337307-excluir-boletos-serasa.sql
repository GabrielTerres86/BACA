  ...
  BEGIN
    ...
    FOR rw_boleto IN (SELECT cob.rowid idrowid_crapcob
                       ...
                       WHERE (cob.cdcooper, cob.cdbandoc, cob.nrdctabb, cob.nrcnvcob, cob.nrdconta,
                              cob.nrdocmto) IN
                             ((1, 85, 101002, 101002, 7250258, 2456)
                             ,(1, 85, 101002, 101002, 7250258, 2468)
                             ,(1, 85, 101002, 101002, 11564377, 197)
                             ,(1, 85, 101002, 101002, 11564377, 211)
                             ,(1, 85, 101002, 101002, 11564377, 213))) LOOP
