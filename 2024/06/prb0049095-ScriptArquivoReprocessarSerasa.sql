    ...
    IF pr_tab_lcm.EXISTS(vr_index) THEN
      ...
      LOOP
        ...
        vr_dstexto := '"pr_tab_lcm";"' || pr_tab_lcm(vr_index).cdcooper || '";"' || pr_tab_lcm(vr_index).nrdconta || '";"' || pr_tab_lcm(vr_index).nrconven ||
                      ...
                      '";"' || pr_tab_lcm(vr_index).vllancto || '";"' || pr_tab_lcm(vr_index).qtdregis || '";"' || pr_tab_lcm(vr_index).cdfvlcop ||
                      '";"' || pr_tab_lcm(vr_index).nrctremp || '";"' || pr_tab_lcm(vr_index).nrdocmto || '";"' || pr_tab_lcm(vr_index).cdpesqbb ||
                      '";"' || pr_tab_lcm(vr_index).cdmotivo || '";"' || pr_tab_lcm(vr_index).idtabcob || '"';
    ...
    IF pr_tab_lat_consolidada.EXISTS(vr_index) THEN
      ...
      LOOP
        ...
        vr_dstexto := '"pr_tab_lat_consolidada";"' || pr_tab_lat_consolidada(vr_index).cdcooper || '";"' || pr_tab_lat_consolidada(vr_index).nrdconta ||
                      ...
                      '";"' || pr_tab_lat_consolidada(vr_index).cdmotivo || '";"' || pr_tab_lat_consolidada(vr_index).vllanmto ||
