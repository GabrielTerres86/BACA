Declare 
  ...
  vc_dstransaSensbCRAPSLD             CONSTANT VARCHAR2(4000) := 'Sensibilizacao do Saldo (CRAPSLD) por script - INC0335473';
  ...
  CURSOR cr_crapsld is
    SELECT a.nrdconta
      ...
      from CECRED.crapsld a
          ,(select 1 as cdcooper,	6311954	as nrdconta, 100.00	as valor from dual 
            union
            select 1 as cdcooper,	6941478	as nrdconta, 287.60	as valor from dual 
            union
            select 6 as cdcooper,	117935	as nrdconta, 15.69	as valor from dual 
            union
            select 6 as cdcooper,	118001	as nrdconta, 513.59	as valor from dual 
            union
            select 1 as cdcooper,	12447684 as nrdconta, 100.00	as valor from dual
            union
            select 1 as cdcooper,	7767668	as nrdconta, 10.00	as valor from dual) contas 
