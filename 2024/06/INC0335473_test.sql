  ...
  CURSOR cr_crapsld is
    SELECT a.nrdconta
      ...
      from CECRED.crapsld a
          ,(select 1 as cdcooper,	93687982	as nrdconta, 100.00	as valor from dual 
            union
            select 1 as cdcooper,	93058462	as nrdconta, 287.60	as valor from dual 
            union
            select 6 as cdcooper,	99882000	as nrdconta, 15.69	as valor from dual 
            union
            select 6 as cdcooper,	99881934	as nrdconta, 513.59	as valor from dual 
            union
            select 1 as cdcooper,	87552256 as nrdconta   , 100.00	as valor from dual
            union
            select 1 as cdcooper,	92232272	as nrdconta, 10.00	as valor from dual) contas 
