Declare 
  ...
  vc_dstransaSensbCRAPSLD             CONSTANT VARCHAR2(4000) := 'Sensibilizacao do Saldo (CRAPSLD) por script - INC0338451';
  ...
  CURSOR cr_crapsld is
    SELECT a.nrdconta
      ...
      from CECRED.crapsld a
          ,(select 1 as cdcooper,	11519266	as nrdconta, 100.00	as valor from dual 
            union
            select 1 as cdcooper,	12322300	as nrdconta, 1630.00	as valor from dual 
            union
