DECLARE
  CURSOR cr_crapass is
    SELECT a.cdcooper
     ...
     WHERE a.progress_recid IN (60783,
62719,
83521,
142067,
162164,
...
2150651);
  ...
  vr_arq_path    VARCHAR2(1000):= CECRED.gene0001.fn_param_sistema('CRED',0,'ROOT_MICROS') || 'cpd/bacas/INC0311702'; 
  vr_nmarqrol    VARCHAR2(100) := 'INC0311702_script_rollback.sql';
  vr_nmarqlog    VARCHAR2(100) := 'INC0311702_script_log.txt';  
  vr_flarqrol    utl_file.file_type;
  vr_flarqlog    utl_file.file_type;
  
  vr_dsdrowid    VARCHAR2(50);
  vr_dtinicio    DATE := to_date('22/01/2022','dd/mm/yyyy');
  vr_vldsaldo    NUMBER;
  vr_vllamnto    NUMBER;
  vr_cdcritic    NUMBER;
