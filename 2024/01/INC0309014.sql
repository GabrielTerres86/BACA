...
BEGIN
  ...
  vr_nmdireto := cecred.gene0001.fn_param_sistema('CRED',3,'ROOT_MICROS') || 'cpd/bacas/RISCO/INC0309014';
  vr_nmarqrbk := 'ROLLBACK_INC0309014_'||to_char(sysdate,'ddmmyyyy_hh24miss')||'.sql';
  ...
  vr_conta := cecred.GENE0002.fn_quebra_string(pr_string  => '13;647310;334397;C;D|'||
                                                             '1;1321057;7719932;C;F|'||
                                                             '1;1321057;7720108;C;F'
                                                             ,
                                               pr_delimit => '|');
