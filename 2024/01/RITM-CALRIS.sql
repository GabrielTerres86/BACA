DECLARE
  ...
  vr_nmarqimp  VARCHAR2(100) := 'RITM-CALRIS.csv';
...
BEGIN
  ...
  LOOP
   ...
   BEGIN 
     ...
     VALUES (vr_cdcooper, vr_cpf, vr_nome, vr_cdvaga, vr_tpcolaborador, vr_valor, vr_valorvaga, vr_relac, vr_dsrelac, vr_cidade, vr_UF, vr_data, 'A');
   EXCEPTION               
   WHEN OTHERS THEN
