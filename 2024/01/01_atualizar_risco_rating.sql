DECLARE
  ...
  vr_dtvencimento     DATE:='10/01/2024';
...
BEGIN
  ...
  vr_nmarquiv := 'RISCO_RATING_2024.csv';
    ...
    LOOP
      ...
      IF utl_file.IS_OPEN(vr_ind_arquiv) THEN
        ...
        IF cr_crapris%FOUND THEN
          ...
          rati0005.pc_grava_rating_detalhes(pr_cdcooper                => vr_vet_dados(1),
                                            pr_nrdconta                => vr_vet_dados(2),
                                            pr_tpctrato                => rw_crapris.tpctrato,
                                            pr_nrctrato                => vr_vet_dados(3),
                                            pr_inrisco_rating_proposta => rw_crapris.inrisco_rating,
                                            pr_inrisco_rating_manual   => NULL,
                                            pr_inrisco_rating          => vr_vet_dados(4),
                                            pr_dtrisco_rating          => vr_dtvencimento,
                                            pr_dtvencto_rating         => NULL,
                                            pr_insituacao_rating       => 4,
                                            pr_inorigem_rating         => 1,
                                            pr_cdoperad_rating         => '1',
                                            pr_innivel_rating          => NULL,
                                            pr_inpontos_rating         => vr_vet_dados(5),
                                            pr_insegmento_rating       => TRIM(vr_vet_dados(6)),
                                            pr_flintegrar_sas          => 0,
                                            pr_flencerrado             => NULL,
                                            pr_flpermite_alterar       => NULL,
                                            pr_inmodelo                => NULL,
                                            pr_intipo_rating           => NULL,
