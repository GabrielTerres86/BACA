DECLARE
  ...
  vc_dstransaStatusCC             CONSTANT VARCHAR2(4000) := 'Alteracao da situacao de conta por script - INC0308771';
  vc_dstransaDevCotas             CONSTANT VARCHAR2(4000) := 'Alteração de Cotas e devolução - INC0308771';
  vc_dstransaDevDepVista          CONSTANT VARCHAR2(4000) := 'Alteracao da devolução do Depósito a Vista - INC0308771';
  ...
  CURSOR cr_crapass is
    SELECT t.cdagenci
      ...
      FROM CECRED.CRAPASS t
         ,(select 16 as cdcooper, decode(vr_globalname, vc_bdprod,2135280,97864650) as nrdconta, vc_cdsitdctProcesDemis as cdsitdct, null as dtdemiss, null as dtelimin, null as dtasitct, null as  cdmotdem from dual) a
     WHERE 1=1
