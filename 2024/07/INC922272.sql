DECLARE
  ...
  vc_dstransaStatusCC             CONSTANT VARCHAR2(4000) := 'Correção atuação ROB006 ( CREDITO ).';
  vc_dstransaDevCotas             CONSTANT VARCHAR2(4000) := 'Correção atuação ROB006 ( CREDITO ).';
  vc_dstransaDevDepVista          CONSTANT VARCHAR2(4000) := 'Correção atuação ROB006 ( CREDITO ).';
