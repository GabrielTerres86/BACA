  ...
  FOR rw_principal IN cr_principal LOOP
    BEGIN
      INSERT INTO cecred.crapopf(nrcpfcgc, dtrefere, qtopesfn, qtifssfn, qtsbjsfn, vlsbjsfn, percdocp,
                                 ...
                                 vlrisinv, vlcoorcc)
      VALUES(rw_principal.nrcpfcgc, rw_principal.dtrefere, rw_principal.qtopesfn, rw_principal.qtifssfn, rw_principal.qtsbjsfn, rw_principal.vlsbjsfn, rw_principal.percdocp,
    ...
    EXCEPTION
      WHEN OTHERS THEN
        dbms_output.put_line('Erro ao inserir crapopf - nrcpfcgc: ' || rw_principal.nrcpfcgc);
    END;
    
    FOR rw_crapvop IN cr_crapvop(pr_nrcpfcgc => rw_principal.nrcpfcgc
                                ,pr_dtrefere => rw_principal.dtrefere) LOOP
      BEGIN
        INSERT INTO cecred.crapvop(nrcpfcgc, dtrefere, cdvencto, vlvencto, cdmodali, flgmoest)
        VALUES (rw_crapvop.nrcpfcgc, rw_crapvop.dtrefere, rw_crapvop.cdvencto, rw_crapvop.vlvencto, rw_crapvop.cdmodali, rw_crapvop.flgmoest);
      EXCEPTION
        WHEN OTHERS THEN
