DECLARE
   ...
   vr_aux_diretor     VARCHAR2(100) := 'RITM0422575';     
  ...
  PROCEDURE pc_majoracao_limite_cred_manual(pr_cdcooper IN crapcop.cdcooper%TYPE                
  ...
  EXCEPTION
    ...
    WHEN OTHERS THEN
      pr_cdcritic := vr_cdcritic;
      pr_dscritic := 'Erro geral pc_majoracao_limite_cred_manual: '|| SQLERRM;
    END;

  END pc_majoracao_limite_cred_manual;
...
BEGIN
    ...
    FOR vr_idx1 IN vr_tab_carga.first .. vr_tab_carga.last LOOP
        IF vr_tab_carga.exists(vr_idx1) THEN
         ...
         pc_majoracao_limite_cred_manual(pr_cdcooper => vr_tab_carga(vr_idx1).cdcooper
