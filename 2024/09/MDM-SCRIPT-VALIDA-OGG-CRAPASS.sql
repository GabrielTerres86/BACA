  ...
  LOOP
    ...
    BEGIN
      ...
      UPDATE CECRED.CRAPASS ASS
        SET ASS.DTDEMISS = CASE WHEN ASS.DTDEMISS IS NULL THEN TO_DATE( TO_CHAR(SYSDATE, 'DD/MM/RRRR'), 'DD/MM/RRRR' ) ELSE ASS.DTDEMISS END
          , ASS.CDAGENCI = ASS.CDAGENCI + 2
          , ASS.NMPAIPTL = 'TST CARGA MDM 07-DTDEMISS:' || TO_CHAR(SYSDATE, 'DD/MM/RRRR')
