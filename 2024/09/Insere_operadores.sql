declare
  ...
  TYPE TP_OPE IS VARRAY(60) OF tp_rec;
  vr_operads  TP_OPE;
...
begin
  ...
  vr_operad.operador := 'f0034973';
  vr_operad.nmoperad := 'MARCOS GABRIEL';
  vr_operads.EXTEND(1);
  vr_operads(40) := vr_operad;
  
  vr_operad.operador := 'f0033821';
  vr_operad.nmoperad := 'f0033821';
  vr_operads.EXTEND(1);
  vr_operads(41) := vr_operad;
  
  vr_operad.operador := 'f0034800';
  vr_operad.nmoperad := 'f0034800';
  vr_operads.EXTEND(1);
  vr_operads(42) := vr_operad;
  
  vr_operad.operador := 'f0034977';
  vr_operad.nmoperad := 'f0034977';
  vr_operads.EXTEND(1);
  vr_operads(43) := vr_operad;
