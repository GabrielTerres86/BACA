   ...
   FOR rw_cdcooper IN (SELECT c.cdcooper
      ...
      OPEN cr_icatu_pj(pr_cdcooper => rw_cdcooper.cdcooper);
        ...
        IF cr_icatu_pj%NOTFOUND THEN
          INSERT INTO CECRED.crapprm(nmsistem, cdcooper, cdacesso, dstexprm, dsvlrprm)
            VALUES ('CRED', rw_cdcooper.cdcooper, 'PROPOSTA_API_ICATU_JURID', 'Quantidade de número de proposta disponível até a próxima carga', 'S');
        END IF;
      CLOSE cr_icatu_pj;
      ...
      OPEN cr_icatu_qntd(pr_cdcooper => rw_cdcooper.cdcooper);
        ...
        IF cr_icatu_qntd%NOTFOUND THEN
          INSERT INTO CECRED.crapprm(nmsistem, cdcooper, cdacesso, dstexprm, dsvlrprm)
            VALUES ('CRED', rw_cdcooper.cdcooper, 'PROPOSTA_API_ICATU_QNTDJ', 'Quantidade de número de proposta disponível até a próxima carga', 15);
        END IF;
      CLOSE cr_icatu_qntd;
   END LOOP;
   COMMIT;
