Declare 
  ...
  vc_dstransaSensbCRAPSLD             CONSTANT VARCHAR2(4000) := 'Sensibilizacao do Saldo (CRAPSLD) por script - INC0329476a';
  ...
  CURSOR cr_crapsld is
    SELECT a.nrdconta
      ...
      from CECRED.crapsld a
          ,(select 1 as cdcooper, 84325062 as nrdconta, 0.61 as valor from dual
            union
            select 1 as cdcooper, 82870691 as nrdconta, 1.06  as valor from dual
            union
            select 1 as cdcooper, 83886702 as nrdconta, 0.69   as valor from dual
            union
            select 1 as cdcooper, 84201517 as nrdconta, 0.22   as valor from dual
            union
            select 1 as cdcooper, 84289210 as nrdconta, 0.69   as valor from dual
			union
			select 1 as cdcooper, 82008590 as nrdconta, 0.69
			as valor from dual
            )  contas
