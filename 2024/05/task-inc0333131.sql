    ...
    SELECT a.*,(vldcotas - vllanmto)
      ...
      SELECT cot.CDCOOPER, lct.nrdconta, SUM(decode(his.indebcre, 'D', -1, 1) * lct.vllanmto)vllanmto, cot.vldcotas
       ...
       WHERE his.cdhistor = lct.cdhistor
         ...
         AND ((lct.cdcooper = 1  and lct.nrdconta in (2674580,7699891,9676392,9870296,11372150))or
              (lct.cdcooper = 16 and lct.nrdconta = 60186)or
              (lct.cdcooper = 9 and lct.nrdconta = 219711)or
              (lct.cdcooper = 13 and lct.nrdconta = 482005)or
              (lct.cdcooper = 5 and lct.nrdconta = 173088))
