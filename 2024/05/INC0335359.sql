...
BEGIN
  ...
  vr_nmarqrbk := 'ROLLBACK_INC0335359_'||to_char(sysdate,'ddmmyyyy_hh24miss')||'.sql';
  ...
  vr_conta := cecred.GENE0002.fn_quebra_string(pr_string  => '13;450642;306242;B;C'
                                                             ,
                                               pr_delimit => '|');
