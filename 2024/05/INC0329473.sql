  ...
  CURSOR cr_crapsld is
    SELECT a.nrdconta
      ...
      from CECRED.crapsld a
          ,(select 1 as cdcooper, 9870296 as nrdconta, -1050.00 as valor from dual
            union
            select 1 as cdcooper, 11177969 as nrdconta, 280.15  as valor from dual
            union
            select 1 as cdcooper, 11372150 as nrdconta, -200.00 as valor from dual
            union
            select 1 as cdcooper, 2792265 as nrdconta, -103.11  as valor from dual
            union
            select 1 as cdcooper, 3019462 as nrdconta, -629.72  as valor from dual
			union
			select 1 as cdcooper, 6398650 as nrdconta, 0.70     as valor from dual)  contas
