  ...
  CURSOR cr_crapsld is
    SELECT a.nrdconta
      ...
      from CECRED.crapsld a
          ,(select 1 as cdcooper, 99993767   as nrdconta, 1.94        as valor from dual
            union
            select 1 as cdcooper, 99983044  as nrdconta, 2.93        as valor from dual
            union
            select 1 as cdcooper, 99058600 as nrdconta, 0.22        as valor from dual
            union
            select 1 as cdcooper, 98161903 as nrdconta, 0.12        as valor from dual
            union
            select 1 as cdcooper, 98014935 as nrdconta, 1170.00   as valor from dual
)  contas
