Declare 
  ...
  vc_dstransaSensbCRAPSLD             CONSTANT VARCHAR2(4000) := 'Sensibilizacao do Saldo (CRAPSLD) por script - INC0329473';
  ...
  CURSOR cr_crapsld is
    SELECT a.nrdconta
      ...
      from CECRED.crapsld a
          ,(select 1 as cdcooper, 90129644 as nrdconta, -1050.00 as valor from dual
            union
            select 1 as cdcooper, 88821978 as nrdconta, 280.15  as valor from dual
            union
            select 1 as cdcooper, 88627780 as nrdconta, -200.00 as valor from dual
            union
            select 1 as cdcooper, 97207675 as nrdconta, -103.11  as valor from dual
            union
            select 1 as cdcooper, 96980478 as nrdconta, -629.72  as valor from dual
			union
			select 1 as cdcooper, 93601280 as nrdconta, 0.70     as valor from dual)  contas
