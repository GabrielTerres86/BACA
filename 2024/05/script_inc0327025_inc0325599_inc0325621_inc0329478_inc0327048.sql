DECLARE
  ...
  BEGIN
    ...
    IF pr_cdhistor = 2721 or pr_cdhistor = 2719 or pr_cdhistor = 360 THEN
      prc_gera_lct(prm_cdcooper => pr_cdcooper,
                   prm_nrdconta => pr_nrdconta,
                   prm_vllanmto => pr_vllanmto,
                   prm_cdhistor => pr_cdhistor);
    ...
    IF NVL(pr_flgconta, 0) = 1 OR pr_cdhistor IN (2720) THEN
      OPEN cecred.BTCH0001.cr_crapdat(pr_cdcooper);
      FETCH cecred.BTCH0001.cr_crapdat
        INTO rw_crapdat;
      CLOSE cecred.BTCH0001.cr_crapdat;
...
BEGIN
  ...
  vr_conta := cecred.GENE0002.fn_quebra_string(pr_string  => '1;1551660;2721;1501,32;0;0|',
                                                             '11;677961;2721;2890,09;0;0|',
                                                             '13;946282;2721;45,00;0;0|',
                                                             '13;1854538;2721;59,00;0;0|',
                                                             '13;1649652;2721;59,00;0;0|',
                                                             '13;1580086;2721;59,0;0;0|',
                                                             '13;1878090;2721;69,84;0;0|',
                                                             '13;1808807;2721;118,00;0;0|',
                                                             '16;674565;2721;3765,43;0;0|',
                                                             '16;1015567;2721;1484,2;0;0|',
                                                             '16;667658;2721;383,74;0;0|',
                                                             '16;1189973;2721;239,86;0;0|',
                                                             '16;942435;2721;263,37;0;0|',
                                                             '16;1260166;2721;102;0;0|'
                                              ,pr_delimit => '|');
