...
BEGIN
  ...
  values (aux_cdpartar_add, 'RITM0370682 - PRONAMPE gerar arquivo na pasta temp', 2, 0);

  insert into crapbat (CDBATTAR, NMIDENTI, CDPROGRA, TPCADAST, CDCADAST)
  values ('RITM0370682T', 'RITM0370682 - PRONAMPE gerar arquivo na pasta temp', ' ', 2, aux_cdpartar_add);
