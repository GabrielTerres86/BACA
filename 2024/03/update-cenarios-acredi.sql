...
BEGIN
  ...
  UPDATE crawepr SET insitapr = 1 WHERE cdcooper = 2 AND nrdconta = 17858305 AND nrctremp = 501932;
  UPDATE crawlim SET insitest = 3, insitapr = 1, insitlim = 2 WHERE cdcooper = 2 AND nrdconta = 17856744 AND nrctrlim = 174278;
