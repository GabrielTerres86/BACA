DECLARE
  ...
  CURSOR cr_craprda IS
    SELECT a.cdcooper,
           ...
           a.dtmvtolt,
           a.rowid,
           (CASE WHEN a.nrdconta = 2066190 THEN 98 ELSE 93 END) taxafixa
      FROM cecred.craprda a
     WHERE a.cdcooper = 1
       AND ((a.nrdconta = 2066190 AND nraplica =  167087) OR
            (a.nrdconta = 2023180 AND nraplica in (244856, 163391, 148888,188035)));
