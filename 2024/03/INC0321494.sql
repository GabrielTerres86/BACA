...
BEGIN
  ...
  vr_nmarqrbk := 'ROLLBACK_INC0321494_'||to_char(sysdate,'ddmmyyyy_hh24miss')||'.sql';
  ...
  vr_conta := cecred.GENE0002.fn_quebra_string(pr_string  => '14;1344031;148015;E;F|'||
                                                             '1;1326877;8027303;C;D|'||
                                                             '1;217635;1031996;C;D'
                                                             ,
                                               pr_delimit => '|');
