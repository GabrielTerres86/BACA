DECLARE
  ...
  CURSOR cr_crapass is
    SELECT t.cdagenci
	  ...
	  ,(select 7   as cdcooper, decode(vr_globalname, vc_bdprod,114618    ,000) as nrdconta, vc_cdsitdctEncerrada as cdsitdct, null as dtdemiss, null as dtelimin, null as dtasitct, null as  cdmotdem from dual
        union
        select 14 as cdcooper, decode(vr_globalname, vc_bdprod,61930     ,000) as nrdconta, vc_cdsitdctEncerrada as cdsitdct, null as dtdemiss, null as dtelimin, null as dtasitct, null as  cdmotdem from dual
        union
        select 1   as cdcooper, decode(vr_globalname, vc_bdprod,11191384  ,000) as nrdconta, vc_cdsitdctEncerrada as cdsitdct, null as dtdemiss, null as dtelimin, null as dtasitct, null as  cdmotdem from dual
        union
        select 5   as cdcooper, decode(vr_globalname, vc_bdprod,176869    ,000) as nrdconta, vc_cdsitdctEncerrada as cdsitdct, null as dtdemiss, null as dtelimin, null as dtasitct, null as  cdmotdem from dual
        union
        select 2   as cdcooper, decode(vr_globalname, vc_bdprod,1013777   ,000) as nrdconta, vc_cdsitdctEncerrada as cdsitdct, null as dtdemiss, null as dtelimin, null as dtasitct, null as  cdmotdem from dual
        union
        select 13 as cdcooper, decode(vr_globalname, vc_bdprod,8850,000) as nrdconta, vc_cdsitdctEncerrada as cdsitdct, null as dtdemiss, null as dtelimin, null as dtasitct, null as  cdmotdem from dual
        union
        select 13 as cdcooper, decode(vr_globalname, vc_bdprod,147273    ,000) as nrdconta, vc_cdsitdctEncerrada as cdsitdct, null as dtdemiss, null as dtelimin, null as dtasitct, null as  cdmotdem from dual
        union
        select 7   as cdcooper, decode(vr_globalname, vc_bdprod,114618    ,000) as nrdconta, vc_cdsitdctEncerrada as cdsitdct, null as dtdemiss, null as dtelimin, null as dtasitct, null as  cdmotdem from dual
        union
        select 14 as cdcooper, decode(vr_globalname, vc_bdprod,61930     ,000) as nrdconta, vc_cdsitdctEncerrada as cdsitdct, null as dtdemiss, null as dtelimin, null as dtasitct, null as  cdmotdem from dual
        union
        select 1   as cdcooper, decode(vr_globalname, vc_bdprod,10009507  ,89990439) as nrdconta, vc_cdsitdctEncerrada as cdsitdct, null as dtdemiss, null as dtelimin, null as dtasitct, null as  cdmotdem from dual
        union
        select 1   as cdcooper, decode(vr_globalname, vc_bdprod,11191384  ,88808556) as nrdconta, vc_cdsitdctEncerrada as cdsitdct, null as dtdemiss, null as dtelimin, null as dtasitct, null as  cdmotdem from dual 
        union
        select 1   as cdcooper, decode(vr_globalname, vc_bdprod,9932062   ,90067878) as nrdconta, vc_cdsitdctEncerrada as cdsitdct, null as dtdemiss, null as dtelimin, null as dtasitct, null as  cdmotdem from dual
        union
        select 1   as cdcooper, decode(vr_globalname, vc_bdprod,9088580   ,90911350) as nrdconta, vc_cdsitdctEncerrada as cdsitdct, null as dtdemiss, null as dtelimin, null as dtasitct, null as  cdmotdem from dual
        union
        select 1   as cdcooper, decode(vr_globalname, vc_bdprod,11081538  ,88918408) as nrdconta, vc_cdsitdctEncerrada as cdsitdct, null as dtdemiss, null as dtelimin, null as dtasitct, null as  cdmotdem from dual
        union
        select 1   as cdcooper, decode(vr_globalname, vc_bdprod,9667849   ,90332091) as nrdconta, vc_cdsitdctEncerrada as cdsitdct, null as dtdemiss, null as dtelimin, null as dtasitct, null as  cdmotdem from dual
        union
        select 1   as cdcooper, decode(vr_globalname, vc_bdprod,8547408   ,91452538) as nrdconta, vc_cdsitdctEncerrada as cdsitdct, null as dtdemiss, null as dtelimin, null as dtasitct, null as  cdmotdem from dual
      ) a
   WHERE 1=1
