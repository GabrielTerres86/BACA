DECLARE
  ...
  VR_NRCTRCRD CECRED.CECRED.CRAWCRD.NRCTRCRD%TYPE := NULL;
  VR_NRSEQCRD CECRED.CECRED.CRAWCRD.NRSEQCRD%TYPE := NULL;
...
BEGIN
  ...
  BEGIN
    UPDATE CECRED.TBCRD_CONTA_CARTAO
  ...
  BEGIN
    INSERT INTO CECRED.TBCRD_CONTA_CARTAO
      (CDCOOPER
      ,NRDCONTA
      ,NRCONTA_CARTAO
      ,VLLIMITE_GLOBAL
  ...
  BEGIN
    ...
    vr_nrseqcrd := CECRED.CCRD0003.fn_sequence_nrseqcrd(2);
