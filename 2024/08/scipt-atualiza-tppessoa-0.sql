DECLARE
  ...
  vr_nmdireto        VARCHAR2(4000) := vr_rootmicros||'cpd/bacas/BACACDC';
  vr_nmarqimp        VARCHAR2(100)  := 'CDCLINHAS.csv';
  vr_nmarqimpr       VARCHAR2(100)  := 'ERROS_CDCLINHAS.csv';
...
BEGIN
  ...
  LOOP
      ...
      EXCEPTION
        WHEN OTHERS THEN
        ROLLBACK;
        vr_dscritic := 'Erro ao atualizar linha tppessoa';         
      END; 
