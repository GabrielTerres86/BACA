DECLARE
  ...
  vc_dstransaStatusCC             CONSTANT VARCHAR2(4000) := 'Correcao atuacao ROB006 (CREDITO)';
  vc_dstransaDevCotas             CONSTANT VARCHAR2(4000) := 'Correcao atuacao ROB006 (CREDITO)';
  vc_dstransaDevDepVista          CONSTANT VARCHAR2(4000) := 'Correcao atuacao ROB006 (CREDITO)';
  ...
  CURSOR cr_crapass is
    SELECT t.cdagenci
      ...
      FROM CECRED.CRAPASS t
         ,(select 9   as cdcooper, decode(vr_globalname, vc_bdprod,  447714  ,99552221) as nrdconta, vc_cdsitdctProcesDemis as cdsitdct, null as dtdemiss, null as dtelimin, null as dtasitct, null as  cdmotdem from dual) a
     WHERE 1=1
