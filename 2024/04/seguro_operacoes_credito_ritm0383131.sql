DECLARE
  ...
  vr_nmdir          VARCHAR2(4000) := CECRED.gene0001.fn_param_sistema('CRED',3,'ROOT_MICROS')||'cpd/bacas/RITM0383131';
  vr_nmarq          VARCHAR2(100)  := 'ROLLBACK_RITM0383131.sql';
  ...
  CURSOR cr_principal(pr_cdcooper CECRED.crapseg.cdcooper%TYPE) IS
    SELECT p.idseqtra,
     ...
     WHERE p.cdcooper = 1
       AND p.nrdconta = 80023185
       AND p.nrctrseg = 1743097
