DECLARE
  vr_cdprograma VARCHAR2(15) := 'INC0333131';
    ...
    SELECT a.*,(vldcotas - vllanmto)
      ...
      SELECT cot.CDCOOPER, lct.nrdconta, SUM(decode(his.indebcre, 'D', -1, 1) * lct.vllanmto)vllanmto, cot.vldcotas
       ...
       WHERE his.cdhistor = lct.cdhistor
         ...
         AND ((lct.cdcooper = 1  and lct.nrdconta in (90323548,90129644,88627780,97325350,92300049))or
              (lct.cdcooper = 16 and lct.nrdconta = 99939754)or
              (lct.cdcooper = 9 and lct.nrdconta = 99780224)or
              (lct.cdcooper = 13 and lct.nrdconta = 99517930)or
              (lct.cdcooper = 5 and lct.nrdconta = 99826852))
