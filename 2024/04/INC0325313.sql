...
BEGIN
  ...
  vr_nmarqrbk := 'ROLLBACK_INC0325313_'||to_char(sysdate,'ddmmyyyy_hh24miss')||'.sql';
  ...
  vr_conta := cecred.GENE0002.fn_quebra_string(pr_string  => '9;1558275;104417;D;E|'||
                                                             '10;1443870;54719;E;F'
                                                             ,
                                               pr_delimit => '|');
