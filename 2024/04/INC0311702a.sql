Declare 
  ...
  vc_dstransaSensbCRAPSLD             CONSTANT VARCHAR2(4000) := 'Sensibilizacao do Saldo (CRAPSLD) por script - INC0311702a';
  ...
  CURSOR cr_crapsld is
    SELECT a.nrdconta
      ...
      from CECRED.crapsld a
          ,(select 1 as cdcooper, 1995251  as nrdconta, -1367.62   as valor from dual
            union all
            select 1 as cdcooper, 2223589  as nrdconta,  -104.79   as valor from dual
			union all
			select 1 as cdcooper, 2858096  as nrdconta,  -60.6   as valor from dual
         ) contas
