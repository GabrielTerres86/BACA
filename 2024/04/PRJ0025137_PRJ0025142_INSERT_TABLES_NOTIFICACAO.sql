...
BEGIN
  ...
  dbms_output.put_line('Codigo da Mensagem, para insert na tabela CECRED.tbgen_notif_msg_cadastro, para Notificacao da V4: ' || v_cdmensagem);
  ...
  ,'Cooperado, você possui um Consentimento de Pagamento Pix via OpenFinance pendente de aprovação. Acesse #urlopenfinance para saber mais.'
  ,'Cooperado,<br /><br /> você possui um Consentimento de Pagamento Pix via OpenFinance pendente de aprovação.<br /><br /> Acesse #urlopenfinance no menu Meus Pagamentos, Pix para saber mais.'
  ,16
  ,0
  ,0
  ,1);
