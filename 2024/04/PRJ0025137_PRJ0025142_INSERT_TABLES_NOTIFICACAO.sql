...
BEGIN
  ...
  (v_cdmensagem
  ,17
  ,'Consentimento Transferencias Inteligentes Pendente Aprovacao'
  ,'Cooperado, você possui um Consentimento de Transferencias Inteligentes OpenFinance pendente de aprovação. Acesse #urlopenfinance para saber mais.'
