...
begin
  ...
  OPEN cr_crapaca(pr_nmdeacao => 'BUSCA_DADOS_RISCO_CENTRAL'
                 ,pr_nmpackag => 'TELA_ATENDA_OCORRENCIAS'
                 ,pr_nmproced => 'pc_busca_dados_risco_central'
  ...
  IF cr_crapaca%NOTFOUND THEN
    ...
    INSERT INTO crapaca(nmdeacao, 
                        ...
                        lstparam, 
                        nrseqrdr) 
                 VALUES('BUSCA_DADOS_RISCO_CENTRAL',
                        'TELA_ATENDA_OCORRENCIAS',
                        'pc_busca_dados_risco_central',
                        'pr_cpf_cnpj, pr_cdcooper',
                        rw_craprdr.nrseqrdr);
                             
    dbms_output.put_line('Insere CRAPACA -> BUSCA_DADOS_RISCO_CENTRAL -> TELA_ATENDA_OCORRENCIAS.pc_busca_dados_risco_central');
