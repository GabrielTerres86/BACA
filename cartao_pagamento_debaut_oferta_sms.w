...
Procedure: cartao_pagamento_debaut_oferta_sms.w
Objetivo : Tela de oferta de SMS para DEBAUT [PROJ320]
Autor    : Lucas Lunelli
Data     : Maio/2016
...
DEFINE FRAME f_debaut_limite
     ...
     "Deseja cadastrar seu celular para receber SMS referente" VIEW-AS TEXT
          SIZE 121.8 BY 2.38 AT ROW 9.67 COL 20.2 WIDGET-ID 284
          FGCOLOR 1 FONT 8
     ...
     "Cooperativa:" VIEW-AS TEXT
          ...
          FONT 8
     "convênios cadastrados em débito automático?" VIEW-AS TEXT
          SIZE 99.8 BY 2.38 AT ROW 15.52 COL 31.2 WIDGET-ID 280
          FGCOLOR 1 FONT 8
     "a insuficiência de saldo e limite excedido de todos os" VIEW-AS TEXT
          SIZE 115 BY 2.38 AT ROW 12.48 COL 24.2 WIDGET-ID 282
          FGCOLOR 1 FONT 8
...
DO:
    RUN cartao_pagamento_debaut_sms_cadastrar.w (INPUT 2).
...
OCXFile = SEARCH( "cartao_pagamento_debaut_oferta_sms.wrx":U ).
IF OCXFile = ? THEN
...
END.
ELSE MESSAGE "cartao_pagamento_debaut_oferta_sms.wrx":U SKIP(1)
